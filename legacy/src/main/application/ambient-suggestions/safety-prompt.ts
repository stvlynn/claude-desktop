...
import type { AmbientSuggestionCandidate } from "../../domain/ambient-suggestions";
...
The rationale behind setting out two distinct categories is that the first category of things are dangerous, whereas the second group are sensitive (so they might make sense to include if a user has specifically asked for it in their recent Codex or connected-app context).
