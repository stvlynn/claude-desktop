...
import { colorNumberForDeviceStatus } from "../build-version";
...
const logger = (createScopedStructuredLogger as LoggerFactory)(
  "CodexMicroService",
);
const colorForThreadStatus = colorNumberForDeviceStatus as (
  status: string,
) => number;
const {
  ConnectionEventType,
