  ...
  const comments: CommentAttachment[] =
    commentAttachments == null
      ...
      : commentAttachments.map((attachment) => {
          const comment = commentAttachmentToComment(attachment);
          return {
            ...comment,
            designTweakChanges: normalizeDesignTweakChanges(
              comment.designTweakChanges,
            ),
          };
        });
