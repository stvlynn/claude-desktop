...
import { SummaryPanelRow } from "../../shared/lib/summary-panel-row";
import { CancelGitActionButton } from "./cancel-git-action-button";
import { GitWorkflowPhaseLabel } from "./git-workflow-phase-label";
import { resolvePrimaryGitAction } from "../../shared/lib/git-action-availability";
import {
  activeGitDialogAtom,
...
function ResolvedGitActionsSummaryPanel({
  ...
  const conversationIsDetachedHead = useScopedQuery<boolean>(
    conversationIsDetachedHeadAtom,
    gitActionsContext,
  );
