...
import {
  ...
  initGitHubIcon,
} from "../../../shared/icons/github-mark-icon";
...
import {
  ...
  useHeadBranchQuery,
} from "../../../shared/conversations/local-conversation-thread-parts/pull-request-git-summary-runtime";
import {
  getPullRequestMergeVisualState,
  getPullRequestVisualState,
  initPullRequestVisualStateChunk,
} from "../../../shared/lib/pull-request-visual-state";
import {
  DiffStats,
  initDiffStatsChunk,
...
export function LocalConversationGitSummary({
  ...
  let scope = useScope<Parameters<typeof openPullRequestSidePanelTab>[0]>(
      localConversationRouteScope,
    ),
