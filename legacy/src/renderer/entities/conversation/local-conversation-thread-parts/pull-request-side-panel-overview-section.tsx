...
import { GitBranchIcon, initGitBranchIcon } from "../../../shared/icons/git-branch-icon";
import { initGitHubIcon } from "../../../shared/icons/github-mark-icon";
import { once } from "../../../shared/runtime/commonjs-interop";
import { initSpinnerComponent, Spinner } from "../../../shared/ui/spinner";
import { initTooltipPrimitives, Tooltip } from "../../../shared/ui/tooltip-b/index";
import { classNames, initClassNameRuntime } from "../../../shared/lib/class-names";
import { getGithubAvatarUrl } from "../../../shared/lib/github-avatar-url";
import { PullRequestCheckStatusIcon as PullRequestMergeStatusIcon } from "../../../features/github/pull-request-status";
import { XCircleFilledIcon as ErrorStatusIcon } from "../../../shared/icons/x-circle-filled-icon";
import {
  initPullRequestCommentIconChunk,
  PullRequestCommentIcon,
} from "../../../shared/icons/pull-request-comment-icon";
import {
  initPullRequestChecksStatusLabelChunk,
  PullRequestChecksSummary,
  pullRequestChecksStatusLabel,
} from "../../../features/github/pull-request-checks-summary";
import { DiffStats, initDiffStatsChunk } from "../../../features/git/git-review-primitives";
import { initTeamIconChunk, TeamIcon } from "../../../shared/icons/team-icon";
import { FormattedMessage, initIntlRuntime } from "../../../shared/runtime/react-intl";
import {
  initSummaryPanelRowChunk,
  SummaryPanelRow,
} from "../../../shared/lib/summary-panel-row";
import { getPullRequestCommentActivityItems } from "../../../shared/conversations/local-conversation-thread-parts/pull-request-comment-activity-items";
import {
