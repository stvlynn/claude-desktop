...
import { AppWindowIcon } from "../../../../shared/icons/app-window-icon";
import { ChevronIcon as ChevronDownIcon } from "../../../../shared/icons/chevron-icon";
import { CopyIcon as CopyLinkIcon } from "../../../../shared/icons/copy-icon";
import { Button } from "../../../../shared/ui/main-button";
import {
  OpenTargetsPrefetch,
  useOpenTargets,
...
} from "../../../../shared/runtime/open-target-menu-builders";
import {
  OpenTargetDropdownMenu,
  OpenTargetMenu,
} from "../../../../shared/runtime/open-target-menu-primitives";
import type { EndResourceOpenInMenuProps } from "../../../conversation-thread/end-resource-open-actions/types";
...
export function EndResourceOpenInMenu({
  ...
  const menuItems = buildOpenTargetMenuItems({
    targets,
    availableTargets,
