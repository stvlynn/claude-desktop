...
import { useResizeObserverRef } from "../../../../shared/lib/use-resize-observer";
import type { ImageAssetResolver } from "../../../../features/image-side-panel/use-image-asset-download";
import {
  conversationTitleAtom,
  useScopedAtomValue,
} from "../../../../shared/runtime/onboarding-commons-externals.facade";
import { IMAGE_GAP_PX } from "../../../conversation-thread/generated-image-gallery/constants";
import { formatGeneratedImageAlt } from "./image-alt";
import { aspectRatioFromDimensions, computeGalleryLayout } from "../../../conversation-thread/generated-image-gallery/layout";
...
import type { GeneratedImage, SidePanelImage } from "../../../automation-schedule/types";
