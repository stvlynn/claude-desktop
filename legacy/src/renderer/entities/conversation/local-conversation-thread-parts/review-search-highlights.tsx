...
} from "../../../shared/runtime/dynamic-module-preload";
...
import { initSearchIcon } from "../../../../main/infrastructure/git-worker-review/search";
import {
...
} from "../../../shared/conversations/local-conversation-thread-parts/conversation-search-runtime";
import { threadUserMessageNavigationRailDeps } from "../../conversation-thread/thread-user-message-navigation-rail-deps";
import type {
  NavigationRailItem,
  ThreadUserMessageNavigationRailProps,
} from "../../thread/thread-user-message-navigation-rail";
...
export function useReviewSearchHighlights(props: ReviewSearchHighlightsProps) {
  ...
  let applySearchHighlightsEffectEvent = useStableCallback(
      applySearchHighlights,
    ),
...
let LazyThreadUserMessageNavigationRail: React.ComponentType<ThreadUserMessageNavigationRailProps>;
        ...
        await preloadDynamicImport(
          async () => {
            let { ThreadUserMessageNavigationRail } = await import(
              "../../thread/thread-user-message-navigation-rail/index"
            );
            return {
