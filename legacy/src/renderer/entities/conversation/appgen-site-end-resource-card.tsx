...
import { ThreadResourceCardHeader } from "../../shared/ui/thread-resource-card";
...
} from "../../shared/lib/appgen-access-state-messages";
import { summarizeAppgenAccessPolicy } from "../../shared/lib/appgen-access";
import {
  HOVER_REVEAL_CLASS_NAME,
  OVERLAY_BUTTON_CLASS_NAME,
} from "../../shared/conversations/end-resource-card-shared";
import {
  AppgenSiteIcon,
