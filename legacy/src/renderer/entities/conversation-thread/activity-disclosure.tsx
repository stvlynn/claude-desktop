...
import { ChevronRightIcon } from "../../shared/icons/chevron-right-icon";
import {
  initThinkingShimmerChunk,
  ShimmerText,
  ThinkingShimmerMessage,
} from "../../shared/ui/thinking-shimmer";
import { getResizeObserverEntrySize } from "../../shared/lib/get-resize-observer-entry-size";
import { useResizeObserverRef } from "../../shared/lib/use-resize-observer";

export const defaultLayoutTransition: Transition = {
  duration: 0.2,
  ease: [0.4, 0, 0.2, 1],
};
