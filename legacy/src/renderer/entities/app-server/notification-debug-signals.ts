...
import { formatDebugParamsPreview } from "../../shared/runtime/thread-context-inputs.facade";
...
function createAppServerNotificationDebugEntry({
  ...
  const paramsPreview = (formatDebugParamsPreview as (params: unknown) => unknown)(
    params,
  ) as string;
