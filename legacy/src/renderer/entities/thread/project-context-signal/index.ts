...
import * as threadContextInputs from "../../../shared/runtime/thread-context-inputs.facade";
import { routeScope } from "../../../shared/runtime/persisted-signal";
import {
...
import { gitCurrentBranchByMetadataQuerySignal } from "../../../shared/lib/git-current-branch-query";
import { gitAvailabilityQuery } from "../../../shared/lib/git-availability-query";
type AppScopeGetter = {
