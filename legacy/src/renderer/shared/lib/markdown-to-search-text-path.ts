...
// Lodash-style path parsing helpers used by iteratee helpers.

import type { PathSegment, PropertyPath } from "./markdown-to-search-text-types";
import { isSymbol, toStringValue } from "./markdown-to-search-text-values";
...
export function castPath(value: PropertyPath | unknown, object?: unknown) {
...
export function baseGet(object: unknown, path: PropertyPath | unknown) {
...
export function hasIn(object: unknown, path: PropertyPath | unknown) {
