...
// Current-ref producer for dialog layout and thread sidebar helpers shared by
// projects, remote conversation, and hotkey-window thread chunks.
export {
...
export { WithWindow } from "./with-window";
...
} from "../../entities/automation/heartbeat-automation-eligibility/index";
