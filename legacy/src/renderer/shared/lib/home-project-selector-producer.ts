...
// Boundary for the current home/project selector producer aliases used by restored app-main splits.
import { ProjectIcon } from "../../features/composer/project-selector";
...
export {
  ...
  ProjectIcon,
} from "../../features/composer/project-selector";
export type {
...
} from "../../features/remote/local-remote-selection/selection-state";

export {
  initUseIsRemoteHostChunk,
  useIsRemoteHost,
} from "./use-is-remote-host";
