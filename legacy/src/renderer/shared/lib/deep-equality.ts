// Restored from ref/webview/assets/isEqual-DoHfEcx2.js
// Deep-equality implementation used by the bundled lodash compatibility layer.
...
function hasSeenPair(stack: SeenPairs, leftObject: object, rightObject: object) {
