...
// Resolves keyboard characters using an optional navigator layout map.

const FALLBACK_KEY_BY_CODE = new Map<string, string>([
  ["Backquote", "`"],
  ["Minus", "-"],
  ["Equal", "="],
  ["BracketLeft", "["],
...
export const initKeyboardLayoutMapChunk = undefined as never;
