...
export { initReasoningEffortLabelChunk as appMainCurrentCompatSlotUpperXLowerR } from "../../../features/composer/reasoning-effort-label";
...
export { OPENAI_PLUGINS_GITHUB_URL as appMainCurrentCompatSlotUpperXLowerC } from "../../lib/links-bd-mmkun-d";
export { initMoveThreadToWorktreeChunk as appMainCurrentCompatSlotUpperXLowerA } from "../../../entities/conversation/move-thread-to-worktree";
export { AppBrandLogo as appMainCurrentCompatSlotUpperXLowerF } from "../../ui/app-brand-logo";
export { applyThreadFindBrowserStatus as appMainCurrentCompatSlotUpperXLowerG } from "../../../features/find/thread-find-store";

export { setThreadPreferredNonFullAccessModeFromDefault as appMainCurrentCompatSlotUpperXLowerY } from "../../../features/sidebar/flat-project-sidebar-state/state";
export {
