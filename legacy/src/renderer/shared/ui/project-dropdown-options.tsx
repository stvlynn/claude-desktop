...
import { normalizeProjectRoot } from "../runtime/src-l0hb-mz-p";
import { FormattedMessage, useIntl } from "../vendor/react-intl";
import { Button } from "./main-button";
import { CheckMdIcon } from "../icons/check-md-icon";
import { Tooltip } from "./tooltip-b";
import { ChevronIcon } from "../icons/chevron-icon";
import { useSelectableRemoteConnectionsState } from "../../features/remote/remote-connection-visibility";
import { ChatsIcon } from "../icons/chats-icon";
import { InfoIcon } from "../icons/info-icon";
import { FolderIcon } from "../icons/folder-icon";
import { Dropdown, DropdownMenu } from "./dropdown";
import { WorktreeIcon } from "../icons/worktree-icon";
import { useConnectedRemoteConnections } from "../../features/remote/use-connected-remote-connections";
