...
// Scope and signal primitives used by Claude app state factories.
...
const scopeContext = React.createContext<ScopeContext<any> | undefined>(
  undefined,
);
let nextSignalId = 0;
...
export function createSignal<TValue>(
  ...
  const signal = createAppScopeSignal(
    scope,
    defaultValue,
  ) as unknown as Signal<TValue>;
  signal.kind = "signal";
  return signal;
}
