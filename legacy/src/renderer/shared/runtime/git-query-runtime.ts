...
import { useHostQuery } from "./host-query-runtime";
...
export function useGitAvailabilityQuery(
  ...
  return useHostQuery<{ root?: string | null }>("git-availability", {
    params: { cwd, hostConfig, operationSource },
    queryConfig: { enabled: cwd.length > 0 },
  });
}
