...
} from "../../features/find/dom-content-search";
import {
  findCaseInsensitiveMatchOffsets,
  sliceMatchWithContext,
} from "../lib/find-match-offsets";
import {
  Bo as conversationSearchResultSignalRaw,
  Ho as activeConversationSearchMatchSignalRaw,
...
export const conversationSearchResultSignal: unknown =
  conversationSearchResultSignalRaw;
export const activeConversationSearchMatchSignal: unknown =
  activeConversationSearchMatchSignalRaw;
