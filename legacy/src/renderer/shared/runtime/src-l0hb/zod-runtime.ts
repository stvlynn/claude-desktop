...
export const srcNa = z.string as unknown as typeof z.string;
export const srcOa = z.record;
export const srcPa = z.array;
export const _srcPa = z.array;
export const srcMa = z.unknown as unknown as typeof z.string;
export const _srcMa = z.unknown;
export const srcFa = z.string as unknown as typeof z.string;
export const srcA = z.discriminatedUnion;
export const srcBa = z.unknown as unknown as typeof z.string;
export const srcIa = (
  z as unknown as {
