...
import { vscodeApiL as VscodeFetchBridge } from "./vscode-api-runtime";

export type HostRequestParams = Record<string, unknown> | object;
export type HostRequestOptions<
  TResponse = unknown,
  TParams extends HostRequestParams = HostRequestParams,
