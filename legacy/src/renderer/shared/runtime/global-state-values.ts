// Restored from ref/webview/assets/app-initial~app-main~worktree-init-v2-page~remote-conversation-page~plugin-detail-page~new-thread-panel-page~o~bj5tp28r-Dcs9S3fj.js
// Default-value and compatibility normalization for global-state query results.
import { globalSettingKeys as GLOBAL_STATE_KEYS } from "./global-setting-keys";
