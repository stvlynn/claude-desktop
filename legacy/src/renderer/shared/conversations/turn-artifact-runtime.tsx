...
import { TurnDiff as TurnDiffView } from "../../entities/conversation/local-conversation-thread-parts/turn-diff-card";
import { GeneratedImageGallery as GeneratedImagesGrid } from "../../entities/conversation/local-conversation-thread-parts/generated-image-gallery/index";
import { parseCodeCommentDirectives } from "../../features/github/diff-comments/use-diff-comment-sources/directive-comments";
import type { ReviewComment } from "../../entities/conversation/navigate-to-review-comments";
import {
  computeEndResources,
  getEndResourcePaths,
  shouldHideTurnDiff,
...
export function focusReviewSidePanel(store: StoreLike): void {
  void import("../../features/review/review-side-panel-tab-commands").then(
    ({ openReviewTab }) => {
