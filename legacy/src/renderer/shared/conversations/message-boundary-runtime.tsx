...
import { FormattedMessage } from "../runtime/react-intl";
import { DiffStats } from "../../features/git/git-review-primitives/diff-stats";
import { SentAtTimestamp } from "../../entities/conversation/user-message-timestamp";
import { summarizeUnifiedDiff } from "../../entities/conversation/local-conversation-thread-parts/turn-diff-summaries";
