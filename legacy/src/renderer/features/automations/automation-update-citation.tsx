...
import type { IntlShape } from "../../shared/runtime/react-intl";
...
import { getAutomationDirectiveActionMode } from "../plugins/mcp-app-tool-labels/shared";
import {
  openAutomationTab,
  openAutomationSuggestionTab,
} from "./automation-side-panel-tabs";
import { useConversationIdFromRoute } from "../../entities/conversation/use-conversation-id-from-route";
import {
  useAppScope,
  useAtomValue,
  useFeatureGate,
