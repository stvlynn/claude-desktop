...
import { vscodeApiU as TimeConstants } from "../../shared/runtime/vscode-api";
import {
  ...
  codexHostRequest,
  resolveFileIcon,
} from "../../shared/runtime/user-message-attachments.facade";
import { AttachmentPill } from "./attachment-pill";
import type { AttachmentLayout, IconComponent } from "../../shared/lib/attachment-pill-types";
