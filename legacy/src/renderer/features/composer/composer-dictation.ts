...
import { useDictation } from "../use-dictation/use-dictation";
import type {
  StopDictation,
  UseDictationOptions,
} from "../../entities/automation-schedule/types";
import { isComposerFocusedForDictation } from "../../shared/lib/composer-dictation-focus";
import { defineMessages, useIntl, type IntlShape } from "../../shared/runtime/react-intl";
import type { ToastController } from "../../entities/automation-schedule/types";
import {
  composerScope,
