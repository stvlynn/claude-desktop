...
import { materializeThreadGoalDraft } from "../../entities/thread/pending-worktree-store/thread-goal-materialize";
import type { CreatePendingWorktreeInput } from "../../entities/automation-schedule/types";
import {
