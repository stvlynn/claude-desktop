...
} from "../appgen/publication-terms/index";
import type { FileContentKind } from "../../shared/lib/resource-opener-types";
import { readFileContentSampleByteLimit } from "../../shared/runtime/publication-terms-runtime";
import { findMcpCapabilityFileViewerForPathInScope } from "../app-shell/thread-background-processes/side-panel-tabs";
