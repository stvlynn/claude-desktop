...
import { DropdownMenu, MenuChrome } from "../../shared/ui/dropdown/index";
import { Tooltip } from "../../shared/ui/tooltip-b/index";
import { CheckCircleIcon } from "../../shared/icons/check-circle-icon";
import { CodeIcon } from "../../shared/icons/code-icon";
import { CollapseAllLinesIcon } from "../../shared/icons/collapse-all-lines-icon";
import { DocumentLinesIcon } from "../../shared/icons/document-lines-icon";
import { DocumentSearchIcon } from "../../shared/icons/document-search-icon";
import { EllipsisHorizontalIcon } from "../../shared/icons/ellipsis-horizontal-icon";
import { ExpandAllLinesIcon } from "../../shared/icons/expand-all-lines-icon";
import { GitApplyClipboardIcon } from "../../shared/icons/git-apply-clipboard-icon";
import { GitBranchIcon } from "../../shared/icons/git-branch-icon";
import { RefreshIcon } from "../../shared/icons/refresh-icon";
import { SplitDiffIcon } from "../../shared/icons/split-diff-icon";
import { ThreeDotsIcon } from "../../shared/icons/three-dots-icon";
import { UnifiedDiffIcon } from "../../shared/icons/unified-diff-icon";
import { WhitespaceEyeIcon } from "../../shared/icons/whitespace-eye-icon";
import { WordDiffIcon } from "../../shared/icons/word-diff-icon";
import { XCircleFilledIcon } from "../../shared/icons/x-circle-filled-icon";
