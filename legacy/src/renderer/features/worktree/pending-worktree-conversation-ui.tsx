...
import { Navigate, useParams } from "../../shared/runtime/react-router";
import {
  FormattedMessage,
  initIntlRuntime,
  type IntlShape,
...
import { appLogger, initAppLoggerRuntime } from "../../shared/runtime/app-logger";
import { useScope } from "../../shared/runtime/app-scope-hooks";
import {
  appScopeRoot,
...
import { useCommandRegistration } from "../../shared/runtime/command-registration-runtime";
import { Button, initButtonComponentPrimitives } from "../../shared/ui/button";
import { ProgressStepRow } from "../../shared/ui/progress-step-row";
import { ThreadScrollLayout } from "../../shared/lib/thread-scroll-layout";
import { sendAppServerRequest } from "../../shared/runtime/use-host-config.facade";
import { formatUnknownError } from "../../shared/runtime/src-l0hb-mz-p";
import { buildLocalEnvironmentCreateRoute } from "../environments/local-environment-create-route";
import { getPersistedAtomValue } from "../../shared/runtime/persisted-atom-store";
import { readServiceTierForRequest } from "../../shared/lib/read-service-tier-for-request";
import {
...
} from "../../entities/thread/pending-worktree-store/pending-worktree-store";
import type {
  PendingWorktree,
...
} from "../../shared/vendor/projects-app-shared-runtime";
import {
  buildPendingWorktreeRoute,
  extractPullRequestNumber,
} from "../../shared/runtime/pending-worktree-route-runtime";
import {
  Vu as setActiveLocalEnvironmentSettingsHostRaw,
  oa as UserMessageBubbleRaw,
  zt as PullRequestNumberBadgeRaw,
} from "../../shared/vendor/profile-page-runtime";
import {
