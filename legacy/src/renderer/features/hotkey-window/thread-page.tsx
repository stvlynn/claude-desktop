...
} from "../../shared/lib/use-hotkey-window-detail-layout";
import {
...
} from "../../entities/conversation/local-conversation-stream-role-product-event";
import {
  initLocalConversationThreadChunk,
  usePinnedSummaryPanelLayout,
  initLocalConversationArtifacts,
  LocalConversationThread,
} from "../../entities/conversation/local-conversation-thread";
