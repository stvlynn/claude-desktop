...
import { useLayer, useStatsigClient } from "../../shared/vendor/statsig-current-runtime";
import {
...
import { appIdentity, appIdentityId } from "../../shared/lib/app-identity";
import { OpenaiBlossomIcon } from "../../shared/icons/openai-blossom-icon";
import { codexAppGaLogo } from "../../shared/lib/codex-app-ga-logo";
import { openExternalUrl } from "../../shared/legacy-current-app-initial/worktree-new-thread-query-runtime";
...
import { iconChatgpt } from "../../shared/lib/icon-chatgpt";
