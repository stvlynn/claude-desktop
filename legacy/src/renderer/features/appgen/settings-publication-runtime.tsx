...
} from "../composer/mention-item/index";
import { AppsIcon } from "../../shared/icons/apps-icon";
import { ChromeIcon } from "../../shared/icons/chrome-icon";
...
import { PluginIcon } from "../../shared/icons/plugin-icon";
import {
  filesystemMediaPath,
  filesystemMediaSrc,
} from "../../shared/runtime/filesystem-media-src";
import { getSkillIcon } from "../../shared/lib/get-skill-icon";
import { scoreQueryMatch } from "../../shared/lib/score-query-match/index";
