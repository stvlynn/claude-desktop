...
import { worktreeNewThreadOrchestratorCompatSlotUpperJLowerO as useCurrentHostManager } from "../../shared/legacy-current-app-initial/worktree-new-thread-orchestrator-runtime";
import {
  Button,
  classNames,
  LoadingSpinnerIcon,
...
import { NotebookPlusIcon } from "../../shared/icons/notebook-plus-icon";
import {
