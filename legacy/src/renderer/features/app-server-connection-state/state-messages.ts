...
// App-server connection status message descriptors for the status badge and row.

import { defineMessages } from "react-intl";

export const appServerConnectionStateMessages = defineMessages({
  connecting: {
  ...
  "update-required": {
    ...
    description:
      "Label shown when a remote connection needs a newer Codex version",
  },
  "restart-required": {
    id: "threadPage.remoteConnectionStatusBadge.restartRequired",
    defaultMessage: "Restart required",
    description:
      "Label shown when a remote connection needs a restart to use a newer Codex version",
  },
  connected: {
