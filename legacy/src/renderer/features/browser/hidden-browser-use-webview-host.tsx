...
import { browserUseEnabledForConversationSignal } from "../../shared/runtime/thread-context-inputs.facade";
import {
...
} from "../app-shell/app-shell-tab-controller/index";
import type { BrowserPanelLocation } from "../../shared/runtime/persisted-signal/index";
import { getBrowserTabIdsForEnabledPanels } from "../../shared/runtime/thread-browser-panel-tabs";
import { useWindowZoom } from "../../shared/lib/window-zoom-context";
