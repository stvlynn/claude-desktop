...
import { KeyboardShortcutHint } from "../../shared/runtime/onboarding-commons-externals.facade";
import { COMMENT_SURFACE_STYLE_VARS } from "../../shared/lib/browser-comment-overlay-constants";
