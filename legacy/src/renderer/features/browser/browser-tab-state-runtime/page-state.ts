...
import { clearBrowserSidebarOpenSource } from "../../../../main/infrastructure/git-worker-review/metadata";
import {
...
import type { BrowserOpenSourceOptions, StoreLike } from "../../../entities/automation-schedule/types";
