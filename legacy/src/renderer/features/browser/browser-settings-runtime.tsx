...
import { appScopeS } from "../plugins/eval-control/app-scope";
import { LOCAL_HOST_ID } from "../../shared/runtime/use-host-config.facade";
import { useNavigate as useRouterNavigate } from "../../shared/conversations/local-conversation-route-runtime";
import { ArrowRotateCcwIcon } from "../../shared/icons/arrow-rotate-ccw-icon";
import { useInAppBrowserUseAvailability } from "../plugins/use-is-plugins-enabled/index";
import {
