...
import { lazyLoadWithSuspense } from "../../shared/runtime/appgen-library-hot-producer-runtime";
...
const LazyAppPrefetchImpl = lazyLoadWithSuspense(async () => {
  const loadedModule = await preloadDynamicImport(
    () =>
      import(
        "../../shared/runtime/current-app-initial/app-prefetch-impl-current-runtime"
      ),
    [],
    import.meta.url,
  );
