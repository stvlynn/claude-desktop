...
import { rightAppShellTabController } from "./app-shell-tab-controller/index";
import { setRightPanelOpen, rightPanelOpenSignal } from "./app-shell-state/index";
import { useMotionValueEvent } from "../../shared/lib/use-motion-value-event";
import {
  createMotionValue,
  useTransform as useMotionTransform,
  type MotionValue,
} from "../../shared/lib/use-transform";
import {
  appStoreScope,
