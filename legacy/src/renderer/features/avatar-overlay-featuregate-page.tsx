...
import { currentAppInitialSharedCompatSlotLowerALowerR as initCurrentSharedLazyPreloadRuntime } from "../shared/runtime/current-app-initial/current-app-initial-shared-runtime";
import {
...
const LazyAvatarOverlayNativePage = lazy(async () => {
  const { AvatarOverlayNativePage } = await import(
    "../shared/runtime/current-app-initial/avatar-overlay-native-page-current-runtime"
  );
...
const LazyAvatarOverlayPage = lazy(async () => {
  const { AvatarOverlayPage } = await import(
    "../shared/runtime/current-app-initial/avatar-overlay-page-current-runtime"
  );
