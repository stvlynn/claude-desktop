...
import { worktreeNewThreadOrchestratorCompatSlotUpperK as WorktreesSettingsIcon } from "../../../shared/runtime/current-app-initial/worktree-new-thread-orchestrator-runtime";
import {
...
import { projectsIndexCurrentCompatSlotDollar as DataControlsSettingsIcon } from "../../../shared/runtime/current-app-initial/projects-index-current-runtime";
import { AppgenPlugIcon } from "../../../shared/icons/appgen-plug-icon";
import { AppgenPublicationTermsFallbackIcon } from "../../../shared/runtime/current-app-initial/appgen-settings-publication-runtime";
import { BrowserWindowIcon } from "../../../shared/icons/browser-window-icon";
import { CloudTerminalIcon } from "../../../shared/icons/cloud-terminal-icon";
import { DockIcon } from "../../../shared/icons/dock-icon";
import { SunIcon } from "../../../shared/vendor/automations-page-current-runtime";
import { UsageGaugeIcon } from "../../../shared/icons/usage-gauge-icon";
import {
