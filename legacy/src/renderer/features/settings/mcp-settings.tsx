...
import { sendAppServerRequest } from "../../shared/boundaries/use-host-config.facade";
import { mcpLoginResultSignal } from "../../shared/boundaries/thread-context-inputs.facade";
import {
...
import { uniq } from "../../shared/lib/uniq";
import { sortBy } from "../../shared/lib/sort-by";
...
export function McpSettings() {
  ...
  const handleMcpLoginResult = (
    React as typeof React & {
      useEffectEvent: <TCallback extends (...args: never[]) => unknown>(
        callback: TCallback,
      ) => TCallback;
    }
  ).useEffectEvent((serverName: string, success: boolean) => {
      setAuthorizationUrlsByName((currentAuthorizationUrls) => {
