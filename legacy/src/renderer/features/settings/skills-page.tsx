...
} from "../../shared/lib/use-element-in-view";
import {
  pluginDetailPageB,
  pluginDetailPageG,
  pluginDetailPageI,
...
export function SkillsPage() {
  ...
  if (
    ...
    return React.createElement(pluginsPageT, {});
  }
  return React.createElement(SkillsPageContent, {});
}
...
function renderLearnMoreLink(chunks) {
  return (
    <a
...
function InstalledSkillsList(installedSkillsProps) {
  let {
    hostId,
    isLoading,
    uniqueSkillCount,
...
function ScopeBadgeLabel(scopeBadgeProps) {
  let { label } = scopeBadgeProps;
  return <span className="text-token-description-foreground">{label}</span>;
}
function $e(recommendedSkillsProps) {
  let {
      hostId,
      isLoading,
      errorMessage,
...
export const initSkillsPageChunk = once(() => {
