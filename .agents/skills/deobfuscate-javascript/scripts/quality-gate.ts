...
const PUBLIC_NPM_VENDOR_SHIMS: Record<string, PublicNpmVendorSpecifiers> = {
  ...
  "d3-array-min": "d3-array",
  "d3-format-default-locale": "d3-format",
  "d3-hierarchy": ["d3-hierarchy", "d3-scale-chromatic"],
  "d3-hierarchy-treemap": "d3-hierarchy",
  "d3-interpolate-string": ["d3-color", "d3-interpolate"],
  "d3-interpolate-transform": "d3-interpolate",
  "d3-path": "d3-path",
  "d3-sankey": "d3-sankey",
  ...
  "d3-shape-curve-cardinal": "d3-shape",
  "d3-shape-curve-catmull-rom": "d3-shape",
  "d3-shape-curve-context": "d3-shape",
  "d3-shape-curve-linear": "d3-shape",
  "d3-shape-curves": "d3-shape",
  "d3-shape-line": "d3-shape",
  "d3-shape-pie": "d3-shape",
  "d3-shape-stack": "d3-shape",
...
> = {
  ...
  "dagre-5oTtyBe6": "dagre",
  "dagre-Ba2O9HBx": "dagre",
  "dagre-BqhzN4_p": "dagre",
  "dagre-Bz3drg_2": "dagre",
  "dagre-bCFXQEZA": "dagre",
  "dagre-D3FnCVRr": "dagre",
  "dagre-DgCFaaOE": "dagre",
  "dist-BO3qvbGN": "@braintree/sanitize-url",
  "dist-CD74BDfk": "@braintree/sanitize-url",
  "dist-Kh8ku4yn": "@braintree/sanitize-url",
  "dist-WEF1yh7f": "@braintree/sanitize-url",
  "docx-preview-dx1eKBjU": "docx-preview",
  ...
  "line-DIsP-Yv_": "d3-shape",
  "linear-C3CxBvdt": ["d3-array", "d3-scale"],
  "min-BVs4UoI0": "d3-array",
  "monotone-DKOUTWfZ": "d3-shape",
  "path-BiIEs4Yy": "d3-path",
  "path-DSoH76MG": "d3-path",
  "pdf-BMUvP2KZ": "pdfjs-dist",
  "pdf-CaT3Fa-k": "pdfjs-dist",
  "pdf-c2WnNMiD": "pdfjs-dist",
  "pdf-CEc0zmuq": "pdfjs-dist",
  "pie-ChHHloNp": "d3-shape",
...
const PUBLIC_NPM_VENDOR_API_FINGERPRINTS: Array<{
  ...
  },
  {
    ...
    apiNames: ["interpolateTransformCss", "interpolateTransformSvg"],
  ...
  {
    specifiers: "@braintree/sanitize-url",
    apiNames: ["sanitizeUrl"],
    minimumUniqueApiNames: 1,
  },
  {
