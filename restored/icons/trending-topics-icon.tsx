...
export function initTrendingTopicsIconChunk() {}

export function TrendingTopicsIcon(props: IconProps) {
  return (
    <svg
      width={20}
      height={20}
