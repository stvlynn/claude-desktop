...
export const AutomationDescription =
  AutomationDescriptionRaw as ComponentType<Record<string, unknown>>;
export const SideChatHeader =
  SideChatHeaderRaw as ComponentType<Record<string, unknown>>;
export const EmptyPageState =
  EmptyPageStateRaw as ComponentType<Record<string, unknown>>;

export function getSidePanelTargetStore(
  target: unknown,
): SidePanelTargetStore {
