...
// DeDE chunk restored from the Codex webview bundle.
import { once } from "../runtime/commonjs-interop";
var deDEGreeting, deDEDefault;
once(() => {
  deDEGreeting = "Ersatz";
  deDEDefault = {
    ...
    "appUpdate.installProgress.progressLabel":
      "Update-Installationsfortschritt",
    ...
    "appgenSettings.danger.delete.description":
      "Diese Website dauerhaft löschen",
    ...
    "artifactDocxPreview.commentMarkerLabel":
      "Dokumentanmerkung {commentNumber}",
    ...
    "avatarOverlay.sendNotificationFollowUp":
      "Folgenachricht an {title} senden",
    ...
    "codex.announcementModalStory.dismiss":
      "Mit dem aktuellen Modell fortfahren",
    ...
    "codex.archiveInfo.extension":
      "Archivierte Chats im Ordner .codex anzeigen.",
    ...
    "codex.commandMenu.noChatsEmptyState":
      "Erstelle einen Chat, um zu beginnen!",
    ...
    "codex.legal.cloud.taskOne.title":
      "Repository einem neuen Designer erklären",
    ...
    "codex.stories.toast.showPluginAdded":
      "Toast „Plugin hinzugefügt“ anzeigen",
    ...
    "codex.story.icons.count":
      "{visibleIconCount} von {totalIconCount} Symbolen",
    ...
    "codex.unifiedDiff.revertPatchPartial":
      "Einige Änderungen wiederhergestellt",
    ...
    "codex.windowsSandboxBanner.backupCta":
      "Sandbox ohne Adminrechte verwenden",
    "codex.windowsSandboxBanner.dismiss":
      "Sandbox-Einrichtungsstatus ausblenden",
    ...
    "codexAppHomeBeaconAnnouncement.dismiss":
      "{appName}-Beacon-Banner schließen",
    ...
    "codexAppgenAnnouncementModal.title":
      "Mach aus deinen Ideen echte Websites",
    ...
    "composer.cloudTaskError.v2":
      "Fehler beim Erstellen der Aufgabe{br}{error}",
    ...
    "composer.connectorAuth.reconnect.title":
      "{connectorName} erneut verbinden",
    ...
    "composer.feedbackSlashCommand.description":
      "Feedback zu diesem Chat senden",
    ...
    "composer.pastedTextAttachment.adding":
      "Eingefügter Text wird hinzugefügt …",
    ...
    "composer.richLinkPopover.invalidLink":
      "Gib einen HTTP- oder HTTPS-Link ein",
    ...
    "composer.submit.noWorkspace":
      "Füge ein Projekt hinzu, um Codex zu nutzen.",
    ...
    "globalDictation.waveformAriaLabel":
      "Globale Wellenform der Diktierfunktion",
    ...
    "home.artifactTemplates.attachError":
      "Vorlage konnte nicht angehängt werden",
    ...
    "home.newChatPageSuggestions.dismiss":
      "Vorschläge für neuen Chat schließen",
    ...
    "plugins.detail.removeDialog.title":
      "Plugin {name} aus Codex deinstallieren",
    ...
    "plugins.marketplace.removeError":
      "Marketplace konnte nicht entfernt werden",
    "plugins.marketplace.removeSuccess":
      "{marketplaceName}-Marketplace entfernt",
    ...
    "pullRequests.copyPullRequestUrlError":
      "PR-URL konnte nicht kopiert werden.",
    ...
    "settings.browserUse.install.empty":
      "In-App-Browser-Plugin nicht verfügbar",
    ...
    "settings.mcp.appConnectModal.loading":
      "Verbindungsdetails werden geladen…",
    ...
    "settings.memory.resetMemoriesDescription":
      "Alle Codex-Erinnerungen löschen",
    ...
    "settings.openSourceLicenses.notSupported":
      "Auf diesem Host nicht verfügbar",
    ...
    "settings.remoteConnections.remoteControlDiscoveryDialog.refresh":
      "Aktualisieren",
    "settings.remoteConnections.remoteControlDiscoveryDialog.save":
      "Hinzufügen",
    ...
    "settings.remoteConnections.save.success":
      "Remote-Verbindungen gespeichert",
    ...
    "settings.remoteConnections.ssh.loading":
      "SSH-Verbindungen werden geladen …",
    ...
    "settings.usage.daily.error":
      "Tägliche Nutzung konnte nicht geladen werden",
    ...
    "sidebarElectron.externalAgentImportComplete":
      "Claude-Import abgeschlossen",
    "sidebarElectron.externalAgentImportDismiss":
      "Claude-Importstatus schließen",
    ...
    "sidebarElectron.interruptThreadError":
      "Chat konnte nicht gestoppt werden.",
    ...
    "skills.page.filteredEmpty":
      "Keine Fähigkeiten entsprechen deinen Filtern.",
    ...
    "toolSummaryForCmd.exploringFiles":
      "Dateien <verb>werden aufgelistet</verb>",
    ...
    "worktreeInitV2.activity.setup.skipped":
      "Umgebungseinrichtung übersprungen",
...
export { deDEDefault as default, deDEGreeting as greeting };
