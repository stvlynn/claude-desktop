...
// MrIN chunk restored from the Codex webview bundle.
import { once } from "../runtime/commonjs-interop";
var mrINGreeting, mrINDefault;
once(() => {
  mrINGreeting = "बॅकअप";
  mrINDefault = {
    ...
    "appgenPage.openSharingSettings":
      ", {siteTitle} साठी शेअरिंग सेटिंग्ज उघडा",
    ...
    "assistantMessageContent.goalAchieved":
      "ध्येय {totalTime} मध्ये पूर्ण झाले",
    ...
    "avatarOverlay.collapseNotificationStack":
      "ॲक्टिव्हिटी स्टॅक संक्षिप्त करा",
    ...
    "codex.command.toggleMaximizeSidePanel":
      "साइड पॅनेल कमाल आकारात/पूर्ववत करा",
    ...
    "codex.legal.powered.details":
      "तुमच्या योजनेच्या दर मर्यादा आणि {link} च्या",
    ...
    "codex.review.fileDiff.viewed.tooltip":
      "फाइल 'पाहिले' म्हणून चिन्हांकित करा",
    ...
    "codex.story.icons.count":
      "{totalIconCount} पैकी {visibleIconCount} आयकॉन्स",
    ...
    "codex.windowsSandboxBanner.updateError":
      "एजंट सँडबॉक्स अपडेट करता आला नाही",
    ...
    "codexFastModeAnnouncementModal.heroLabel":
      "पुढारलेली बुद्धिमत्ता, 1.5x वेग",
    ...
    "composer.connectorAuth.reconnect.title":
      "{connectorName} पुन्हा कनेक्ट करा",
    "composer.connectorAuth.startError":
      "कनेक्टर प्रमाणीकरण सुरू करता आले नाही",
    ...
    "composer.dictation.tooltip":
      "लिहिण्यासाठी किंवा धरून ठेवण्यासाठी क्लिक करा",
    ...
    "composer.mcpStatus.emptyValue":
      "कोणतेही MCP सर्व्हर कॉन्फिगर केलेले नाहीत",
    ...
    "composer.projectSlashCommand.description":
      "नवीन चॅट्ससाठी प्रोजेक्ट निवडा",
    ...
    "composer.queuedMessage.retryTooltip":
      "रांगेतील हा संदेश पुन्हा पाठवून पहा",
    ...
    "composer.remote.startingPoint":
      "हे काम कोणत्या कोडपासून सुरू झाले पाहिजे?",
    ...
    "composer.threadGoal.editSaveError":
      "ध्येयाचे उद्दिष्ट सेव्ह करता आले नाही",
    ...
    "composer.threadReferences.readFailed":
      "संदर्भ दिलेले चॅट लोड करता आले नाही",
    ...
    "connectedApps.googleDrive.openInSheets":
      "Google Sheets मध्ये एक्सपोर्ट करा",
    "connectedApps.googleDrive.openInSlides":
      "Google Slides मध्ये एक्सपोर्ट करा",
    ...
    "diffStatsStory.inlineReconnectProgress":
      "पुन्हा कनेक्ट होत आहे {progress}",
    ...
    "electron.onboarding.workspace.empty":
      "सुरू ठेवण्यासाठी एक प्रोजेक्ट जोडा.",
    ...
    "globalDictation.orb.dismissWithError":
      "डिक्टेशन डिसमिस करा: {errorMessage}",
    ...
    "inbox.automations.search.emptyTitle":
      "कोणतेही नियोजित टास्क्स सापडले नाहीत",
    ...
    "localConversationPage.pushNothingToPush":
      "पुश करण्यासाठी नवीन कमिट्स नाहीत",
    ...
    "plugins.detail.updateSharedVersionSuccess":
      "शेअर केलेली आवृत्ती अपडेट झाली",
    ...
    "plugins.manage.updateSharedVersionSuccess":
      "शेअर केलेली आवृत्ती अपडेट केली",
    ...
    "profile.stats.dayStreakValue":
      "{days, plural, one {# दिवस} other {# दिवस}}",
    ...
    "review.commit.generate.failed":
      "कमिट मेसेज जनरेट करण्यात अयशस्वी: {error}",
    ...
    "settings.agent.dependencies.diagnose.ok":
      "Codex डिपेंडन्सीज ठीक दिसत आहेत",
    ...
    "settings.browserUse.profileImport.title":
      "तुमच्या ब्राउझरमधून इम्पोर्ट करा",
    ...
    "settings.cloudEnvironments.create.title":
      "क्लाउड एन्व्हायर्नमेंट तयार करा",
    ...
    "settings.cloudEnvironments.edit.title":
      "क्लाउड एन्व्हायर्नमेंट संपादित करा",
    ...
    "settings.hooks.emptyHooks.description":
      "कॉन्फिगर केलेले हुक्स येथे दिसतील",
    ...
    "settings.hooks.event.stop.description":
      "Codex ची पाळी संपण्याच्या अगदी आधी",
    ...
    "settings.usage.autoTopUp.update.success":
      "ऑटो टॉप-अप सेटिंग्ज अपडेट केल्या",
    ...
    "settings.workMode.coding.description":
      "अधिक तांत्रिक प्रतिसाद आणि नियंत्रण",
    ...
    "thread.browser.notSecureSiteInformation":
      "सुरक्षित नाही, साइटची माहिती पहा",
    ...
    "toolSummaryForCmd.ranGenericCommand":
      "<status>कमांड चालवली</status>{timer}",
...
export { mrINDefault as default, mrINGreeting as greeting };
