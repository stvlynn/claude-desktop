...
// ZhCN chunk restored from the Codex webview bundle.
import { once } from "../runtime/commonjs-interop";
var zhCNGreeting, zhCNDefault;
once(() => {
  zhCNGreeting = "备用";
  zhCNDefault = {
    ...
    "profile.tokenUsage.weekTooltip":
      "{weekStart} 当周使用了 {tokens} 个 Token",
...
export { zhCNDefault as default, zhCNGreeting as greeting };
