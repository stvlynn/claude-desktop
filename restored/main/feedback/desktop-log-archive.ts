// Restored from ref/.vite/build/feedback-desktop-log-archive-C5uB_-XF.js
// feedback-desktop-log-archive-C5uB_-XF chunk restored from the Codex webview bundle.
