...
export const commandDescriptionMessages = reactIntlRuntime.libI({
  ...
  "codex.commandDescription.quickChat": {
    ...
    description: "Description for the New quick chat command",
  },
  ...
  "codex.commandDescription.toggleSidePanel": {
  ...
  "codex.commandDescription.realtimeVoice": {
    id: "codex.commandDescription.realtimeVoice",
    defaultMessage: "Start realtime voice from anywhere on desktop",
    description: "Description for the realtime voice hotkey",
  },
  ...
  "codex.commandDescription.searchChats": {
    ...
    description: "Description for the Search Chats shortcut",
  },
