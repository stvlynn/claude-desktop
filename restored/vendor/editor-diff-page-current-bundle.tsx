...
// Current EditorDiffPage backing bundle rewritten from the current ref chunk.
...
const initEditorDiffPageCurrentBundle = runOnce(() => {
...
initEditorDiffPageCurrentBundle();
