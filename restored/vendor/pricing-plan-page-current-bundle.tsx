...
import {
  worktreeNewThreadOrchestratorCompatSlotLowerFLowerT as appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKg2pu5rsFt,
  worktreeNewThreadOrchestratorCompatSlotLowerPLowerT as AppInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKg2pu5rsPt,
...
import {
  ...
  worktreeNewThreadQueryCompatSlotLowerRLowerS as appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwRs,
...
import {
  ...
  currentAppInitialSharedMember0449 as appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dF,
...
import {
  updateSubscriptionPlan as appInitialAppMainRemoteConversationPageNewThreadPanelPageAppgenLibraryPageHotFjhbmao5Dollar,
  ...
  initCustomCheckoutExperimentRuntime as appInitialAppMainRemoteConversationPageNewThreadPanelPageAppgenLibraryPageHotFjhbmao5G,
  ...
  cancelPendingSubscriptionUpdate as appInitialAppMainRemoteConversationPageNewThreadPanelPageAppgenLibraryPageHotFjhbmao5X,
  initUsageSettingsBillingQueriesRuntime as appInitialAppMainRemoteConversationPageNewThreadPanelPageAppgenLibraryPageHotFjhbmao5Z,
  ...
  initPurchaseLoginHintRuntime as appInitialAppMainRemoteConversationPageNewThreadPanelPageAppgenLibraryPageHotFjhbmao5Mt,
  addLoginHintToPurchaseUrl as appInitialAppMainRemoteConversationPageNewThreadPanelPageAppgenLibraryPageHotFjhbmao5Pt,
  logCheckoutStarted as _appInitialAppMainRemoteConversationPageNewThreadPanelPageAppgenLibraryPageHotFjhbmao5Q,
...
import {
  initTrendingTopicsIconChunk as trendingTopicsN,
  TrendingTopicsIcon as trendingTopicsT,
} from "../icons/trending-topics-icon";
import {
  initSubscriptionUpdatePlanDialogChunk as subscriptionUpdatePlanA,
  SubscriptionUpdatePlanDialog as subscriptionUpdatePlanI,
  subscriptionPlanIdToSku as subscriptionUpdatePlanN,
  PlanBillingPeriodSegmentedControl as subscriptionUpdatePlanO,
  initSubscriptionPlanIdChunk as subscriptionUpdatePlanR,
  initPlanBillingPeriodSegmentedControlChunk as subscriptionUpdatePlanS,
  skuToSubscriptionPlanId as subscriptionUpdatePlanT,
} from "../settings/subscription-update-plan/index";
import {
  formatPlanPriceParts as planPricingN,
  initPlanPricingChunk as planPricingR,
} from "../utils/plan-pricing";
var pricingPlanPageValue1,
  pricingPlanPageValue2,
  pricingPlanPageValue3 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue1 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue2 = (pricingPlanPageParam19) =>
        (0, pricingPlanPageValue1.jsx)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `currentColor`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam19,
          children: (0, pricingPlanPageValue1.jsx)(`path`, {
  ...
  pricingPlanPageValue4,
  pricingPlanPageValue5,
  pricingPlanPageValue6 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue4 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue5 = (pricingPlanPageParam42) =>
        (0, pricingPlanPageValue4.jsxs)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `none`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam42,
          children: [
            (0, pricingPlanPageValue4.jsx)(`path`, {
  ...
  pricingPlanPageValue7,
  pricingPlanPageValue8,
  pricingPlanPageValue9 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue7 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue8 = (pricingPlanPageParam24) =>
        (0, pricingPlanPageValue7.jsxs)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `none`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam24,
          children: [
            (0, pricingPlanPageValue7.jsx)(`path`, {
  ...
  pricingPlanPageValue10,
  pricingPlanPageValue11,
  pricingPlanPageValue12 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue10 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue11 = (pricingPlanPageParam6) =>
        (0, pricingPlanPageValue10.jsx)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `none`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam6,
          children: (0, pricingPlanPageValue10.jsx)(`path`, {
  ...
  pricingPlanPageValue13,
  pricingPlanPageValue14,
  pricingPlanPageValue15 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue13 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue14 = (pricingPlanPageParam1) =>
        (0, pricingPlanPageValue13.jsx)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `none`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam1,
          children: (0, pricingPlanPageValue13.jsx)(`path`, {
  ...
  pricingPlanPageValue16,
  pricingPlanPageValue17,
  pricingPlanPageValue18 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue16 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue17 = (pricingPlanPageParam17) =>
        (0, pricingPlanPageValue16.jsx)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `currentColor`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam17,
          children: (0, pricingPlanPageValue16.jsx)(`path`, {
  ...
  pricingPlanPageValue19,
  pricingPlanPageValue20,
  pricingPlanPageValue21 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue19 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue20 = (pricingPlanPageParam41) =>
        (0, pricingPlanPageValue19.jsx)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `currentColor`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam41,
          children: (0, pricingPlanPageValue19.jsx)(`path`, {
  ...
  pricingPlanPageValue22,
  pricingPlanPageValue23,
  $e = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue22 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue23 = (pricingPlanPageParam32) =>
        (0, pricingPlanPageValue22.jsxs)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `none`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam32,
          children: [
            (0, pricingPlanPageValue22.jsx)(`path`, {
  ...
  pricingPlanPageValue24,
  pricingPlanPageValue25,
  pricingPlanPageValue26 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue24 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue25 = (pricingPlanPageParam20) =>
        (0, pricingPlanPageValue24.jsx)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `currentColor`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam20,
          children: (0, pricingPlanPageValue24.jsx)(`path`, {
  ...
  pricingPlanPageValue27,
  pricingPlanPageValue28,
  pricingPlanPageValue29 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue27 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue28 = (pricingPlanPageParam36) =>
        (0, pricingPlanPageValue27.jsxs)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `none`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam36,
          children: [
            (0, pricingPlanPageValue27.jsx)(`path`, {
  ...
  pricingPlanPageValue30,
  at,
  pricingPlanPageValue31 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue30 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (at = (pricingPlanPageParam40) =>
        (0, pricingPlanPageValue30.jsxs)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `none`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam40,
          children: [
            (0, pricingPlanPageValue30.jsx)(`path`, {
              fillRule: `evenodd`,
              clipRule: `evenodd`,
  ...
  pricingPlanPageValue32,
  pricingPlanPageValue33,
  pricingPlanPageValue34 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue32 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue33 = (pricingPlanPageParam14) =>
        (0, pricingPlanPageValue32.jsxs)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `none`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam14,
          children: [
            (0, pricingPlanPageValue32.jsx)(`path`, {
  ...
  pricingPlanPageValue35,
  pricingPlanPageValue36,
  pricingPlanPageValue37 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue35 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue36 = (pricingPlanPageParam35) =>
        (0, pricingPlanPageValue35.jsxs)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `none`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam35,
          children: [
            (0, pricingPlanPageValue35.jsx)(`path`, {
            ...
            (0, pricingPlanPageValue35.jsx)(`circle`, {
              cx: 7.5,
              cy: 13.5,
              r: 1,
              fill: `currentColor`,
  ...
  pricingPlanPageValue38,
  pricingPlanPageValue39,
  pricingPlanPageValue40 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue38 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue39 = (pricingPlanPageParam16) =>
        (0, pricingPlanPageValue38.jsx)(`svg`, {
          xmlns: `http://www.w3.org/2000/svg`,
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `none`,
          ...pricingPlanPageParam16,
          children: (0, pricingPlanPageValue38.jsx)(`path`, {
  ...
  pricingPlanPageValue41,
  pricingPlanPageValue42,
  pricingPlanPageValue43 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue41 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue42 = (pricingPlanPageParam30) =>
        (0, pricingPlanPageValue41.jsx)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `currentColor`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam30,
          children: (0, pricingPlanPageValue41.jsx)(`path`, {
  ...
  _t,
  pricingPlanPageValue44,
  pricingPlanPageValue45 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (_t =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue44 = (pricingPlanPageParam13) =>
        (0, _t.jsx)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `currentColor`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam13,
          children: (0, _t.jsx)(`path`, {
  ...
  pricingPlanPageValue46,
  pricingPlanPageValue47,
  pricingPlanPageValue48 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue46 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue47 = (pricingPlanPageParam15) =>
        (0, pricingPlanPageValue46.jsxs)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `none`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam15,
          children: [
            (0, pricingPlanPageValue46.jsx)(`circle`, {
              cx: 8.9118,
              cy: 10.0221,
              r: 1.25,
            ...
            (0, pricingPlanPageValue46.jsx)(`path`, {
  ...
  pricingPlanPageValue49,
  pricingPlanPageValue50,
  pricingPlanPageValue51 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue49 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue50 = (pricingPlanPageParam5) =>
        (0, pricingPlanPageValue49.jsxs)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `currentColor`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam5,
          children: [
            (0, pricingPlanPageValue49.jsx)(`path`, {
  ...
  pricingPlanPageValue52,
  pricingPlanPageValue53,
  pricingPlanPageValue54 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue52 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue53 = (pricingPlanPageParam10) =>
        (0, pricingPlanPageValue52.jsx)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `currentColor`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam10,
          children: (0, pricingPlanPageValue52.jsx)(`path`, {
  ...
  pricingPlanPageValue55,
  pricingPlanPageValue56,
  pricingPlanPageValue57 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue55 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue56 = (pricingPlanPageParam21) =>
        (0, pricingPlanPageValue55.jsx)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `currentColor`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam21,
          children: (0, pricingPlanPageValue55.jsx)(`path`, {
  ...
  pricingPlanPageValue58,
  pricingPlanPageValue59,
  pricingPlanPageValue60 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue58 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue59 = (pricingPlanPageParam12) =>
        (0, pricingPlanPageValue58.jsxs)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `currentColor`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam12,
          children: [
            (0, pricingPlanPageValue58.jsx)(`path`, {
  ...
  pricingPlanPageValue61,
  pricingPlanPageValue62,
  pricingPlanPageValue63 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue61 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue62 = (pricingPlanPageParam43) =>
        (0, pricingPlanPageValue61.jsxs)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `none`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam43,
          children: [
            (0, pricingPlanPageValue61.jsx)(`path`, {
  ...
  pricingPlanPageValue64,
  pricingPlanPageValue65,
  pricingPlanPageValue66 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue64 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue65 = (pricingPlanPageParam44) =>
        (0, pricingPlanPageValue64.jsx)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `none`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam44,
          children: (0, pricingPlanPageValue64.jsx)(`path`, {
  ...
  pricingPlanPageValue67,
  pricingPlanPageValue68,
  pricingPlanPageValue69 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue67 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue68 = (pricingPlanPageParam25) =>
        (0, pricingPlanPageValue67.jsx)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `currentColor`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam25,
          children: (0, pricingPlanPageValue67.jsx)(`path`, {
  ...
  pricingPlanPageValue70,
  pricingPlanPageValue71,
  pricingPlanPageValue72 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue70 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue71 = (pricingPlanPageParam37) =>
        (0, pricingPlanPageValue70.jsxs)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `none`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam37,
          children: [
            (0, pricingPlanPageValue70.jsx)(`path`, {
  ...
  pricingPlanPageValue73,
  pricingPlanPageValue74,
  pricingPlanPageValue75 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue73 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue74 = (pricingPlanPageParam22) =>
        (0, pricingPlanPageValue73.jsxs)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `none`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam22,
          children: [
            (0, pricingPlanPageValue73.jsx)(`path`, {
  ...
  pricingPlanPageValue76,
  pricingPlanPageValue77,
  pricingPlanPageValue78 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue76 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue77 = (pricingPlanPageParam23) =>
        (0, pricingPlanPageValue76.jsx)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `currentColor`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam23,
          children: (0, pricingPlanPageValue76.jsx)(`path`, {
  ...
  pricingPlanPageValue79,
  pricingPlanPageValue80,
  pricingPlanPageValue81 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue79 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue80 = (pricingPlanPageParam18) =>
        (0, pricingPlanPageValue79.jsxs)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `none`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam18,
          children: [
            (0, pricingPlanPageValue79.jsx)(`path`, {
  ...
  pricingPlanPageValue82,
  pricingPlanPageValue83,
  pricingPlanPageValue84 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue82 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue83 = (pricingPlanPageParam11) =>
        (0, pricingPlanPageValue82.jsxs)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `none`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam11,
          children: [
            (0, pricingPlanPageValue82.jsx)(`path`, {
  ...
  $t,
  pricingPlanPageValue85,
  pricingPlanPageValue86 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      ($t =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue85 = (pricingPlanPageParam39) =>
        (0, $t.jsxs)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
  ...
  pricingPlanPageValue87,
  pricingPlanPageValue88,
  pricingPlanPageValue89 = rolldownRuntimeN(() => {
    (rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
    ),
      (pricingPlanPageValue87 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
      (pricingPlanPageValue88 = (pricingPlanPageParam51) =>
        (0, pricingPlanPageValue87.jsx)(`svg`, {
          width: 20,
          height: 20,
          viewBox: `0 0 20 20`,
          fill: `currentColor`,
          xmlns: `http://www.w3.org/2000/svg`,
          ...pricingPlanPageParam51,
          children: (0, pricingPlanPageValue87.jsx)(`path`, {
...
function on(pricingPlanPageParam2) {
  switch (pricingPlanPageParam2) {
    case `free`:
      return [
        {
          icon: pricingPlanPageValue77,
          label: (0, pricingPlanPageValue90.jsx)(
...
function pricingPlanPageHelper1(pricingPlanPageParam7) {
  return pricingPlanPageParam7 === `business_chatgpt_codex`
    ? [
        {
          icon: pricingPlanPageValue77,
          label: (0, pricingPlanPageValue90.jsx)(
...
var pricingPlanPageValue90,
  pricingPlanPageValue91 = rolldownRuntimeN(() => {
    (appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dIy(),
      pricingPlanPageValue3(),
      pricingPlanPageValue6(),
      pricingPlanPageValue9(),
      pricingPlanPageValue12(),
      pricingPlanPageValue15(),
      pricingPlanPageValue18(),
      pricingPlanPageValue21(),
      $e(),
      pricingPlanPageValue26(),
      pricingPlanPageValue29(),
      pricingPlanPageValue31(),
      pricingPlanPageValue34(),
      pricingPlanPageValue37(),
      pricingPlanPageValue40(),
      pricingPlanPageValue43(),
      pricingPlanPageValue45(),
      pricingPlanPageValue48(),
      pricingPlanPageValue51(),
      pricingPlanPageValue54(),
      pricingPlanPageValue57(),
      pricingPlanPageValue60(),
      pricingPlanPageValue63(),
      pricingPlanPageValue66(),
      pricingPlanPageValue69(),
      pricingPlanPageValue72(),
      pricingPlanPageValue75(),
      pricingPlanPageValue78(),
      pricingPlanPageValue81(),
      pricingPlanPageValue84(),
      pricingPlanPageValue86(),
      trendingTopicsN(),
      pricingPlanPageValue89(),
      (pricingPlanPageValue90 =
        appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()));
  });
function pricingPlanPageHelper2(
  pricingPlanPageParam47,
  pricingPlanPageParam48,
) {
  let pricingPlanPageValue225 = [];
  return (
    pricingPlanPageParam47 ===
      appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwLd.FREE &&
      pricingPlanPageValue225.push({
        action: `current`,
        highlighted: !1,
        id: `free`,
        targetPlan:
    ...
    pricingPlanPageValue225.push(
      {
        action:
          appInitialAppMainRemoteConversationPageNewThreadPanelPageAppgenLibraryPageHotFjhbmao5J(
            {
              currentPlan: pricingPlanPageParam47,
              targetPlan:
      ...
      },
      {
        action:
          appInitialAppMainRemoteConversationPageNewThreadPanelPageAppgenLibraryPageHotFjhbmao5J(
            {
              currentPlan: pricingPlanPageParam47,
              targetPlan: pricingPlanPageParam48,
            },
          ),
        highlighted:
          pricingPlanPageParam47 ===
...
function pricingPlanPageHelper4(pricingPlanPageParam56) {
  ...
  switch (pricingPlanPageParam56) {
    ...
    case appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwLd.PRO:
      pricingPlanPageValue243 = `pro`;
      break;
  }
  return {
    action: `current`,
    highlighted: !1,
    id: pricingPlanPageValue243,
    targetPlan: pricingPlanPageParam56,
  };
}
function pricingPlanPageHelper5(
  pricingPlanPageParam57,
  pricingPlanPageParam58,
) {
  switch (pricingPlanPageParam58) {
    case appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwLd.GO:
    case appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwLd.FREE:
    case appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwLd.PLUS:
    case appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwLd.PROLITE:
    case appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwLd.PRO:
      return appInitialAppMainRemoteConversationPageNewThreadPanelPageAppgenLibraryPageHotFjhbmao5N(
        {
          currentPlan: pricingPlanPageParam57,
          targetPlan: pricingPlanPageParam58,
        },
      );
...
var pricingPlanPageValue92,
  pricingPlanPageValue93 = rolldownRuntimeN(() => {
...
function PricingPlanPageIcon() {
  let pricingPlanPageValue146 =
  ...
  if (
    ((0, pricingPlanPageValue95.useEffect)(() => {
      pricingPlanPageValue154 != null &&
        appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dBl(
          pricingPlanPageValue146,
          appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dF,
          {
            defaultTab: pricingPlanPageValue155,
            source: pricingPlanPageValue153,
          },
        );
    }, [
      pricingPlanPageValue154,
      pricingPlanPageValue155,
      pricingPlanPageValue146,
      pricingPlanPageValue153,
    ]),
    data == null || pricingPlanPageValue154 == null)
  )
    return isLoading
      ? (0, $.jsx)(`main`, {
  ...
  let pricingPlanPageValue162 = (
      pricingPlanPageParam59,
      pricingPlanPageParam60,
    ) => {
      if (pricingPlanPageParam60 != null) {
        appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwIs(
          {
            event: pricingPlanPageParam60,
            href: pricingPlanPageParam59,
    ...
    pricingPlanPageValue163 = async (
      pricingPlanPageParam27,
      pricingPlanPageParam28,
      pricingPlanPageParam29,
    ) => {
      let pricingPlanPageValue200 = pricingPlanPageHelper5(
        pricingPlanPageValue154,
        pricingPlanPageParam28,
      );
      if (pricingPlanPageValue200 == null) return;
      let pricingPlanPageValue201 =
        appInitialAppMainRemoteConversationPageNewThreadPanelPageAppgenLibraryPageHotFjhbmao5Pt(
          {
            loginHint: email,
            statsigClient: pricingPlanPageValue151,
            url: pricingPlanPageValue200,
          },
        );
      if (
        (pricingPlanPageParam28 ===
          appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwLd.SELF_SERVE_BUSINESS_USAGE_BASED &&
          _appInitialAppMainRemoteConversationPageNewThreadPanelPageAppgenLibraryPageHotFjhbmao5Q(
            pricingPlanPageValue146,
            {
              audience: `workspace`,
        ...
        appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dBl(
          pricingPlanPageValue146,
          appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dGf,
          {
            ctaAction: pricingPlanPageParam27,
            source: pricingPlanPageValue153,
            targetPlan: pricingPlanPageParam28,
          },
        ),
        ...
        pricingPlanPageValue162(
          pricingPlanPageValue201,
          pricingPlanPageParam29,
        );
        return;
      }
      ...
      let pricingPlanPageValue202 = subscriptionUpdatePlanT(
          pricingPlanPageParam28,
        ),
        pricingPlanPageValue203 =
          pricingPlanPageValue154 ===
          appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwLd.GO,
        pricingPlanPageValue204 =
          pricingPlanPageValue154 ===
            appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwLd.PLUS &&
          (pricingPlanPageParam28 ===
            appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwLd.PROLITE ||
            pricingPlanPageParam28 ===
              appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwLd.PRO),
        pricingPlanPageValue205 =
          pricingPlanPageValue154 ===
            appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwLd.PRO &&
          pricingPlanPageParam28 ===
            appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwLd.PROLITE,
        pricingPlanPageValue206 =
          pricingPlanPageValue154 ===
            appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwLd.PROLITE &&
          pricingPlanPageParam28 ===
            appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwLd.PRO;
      ...
      pricingPlanPageValue159(pricingPlanPageParam28);
      try {
        let pricingPlanPageValue223 = await pricingPlanPageValue150.fetchQuery(
          appInitialAppMainRemoteConversationPageNewThreadPanelPageAppgenLibraryPageHotFjhbmao5Q(
            {
              accountId: data.id,
              updatedPlan: pricingPlanPageValue202,
            },
          ),
        );
        if (pricingPlanPageValue205) {
          pricingPlanPageValue157({
            kind: `scheduled_downgrade`,
            preview: pricingPlanPageValue223,
            updatedPlan: `chatgptprolite`,
            webUrl: pricingPlanPageValue201,
          });
          return;
        }
        let pricingPlanPageValue224 =
          pricingPlanPageValue223.default_payment_method;
        if (
          !pricingPlanPageValue224?.card_last4?.trim() ||
          __data?.minorUnitExponent == null ||
          __data.currencyCode.toUpperCase() !==
            pricingPlanPageValue223.currency.toUpperCase()
        ) {
          pricingPlanPageValue162(
            pricingPlanPageValue201,
            pricingPlanPageParam29,
        ...
        pricingPlanPageValue157({
          ...
          paymentMethod: pricingPlanPageValue224,
          preview: pricingPlanPageValue223,
          updatedPlan: pricingPlanPageValue202,
          webUrl: pricingPlanPageValue201,
        });
        ...
        pricingPlanPageValue159(null);
      }
    },
    pricingPlanPageValue164 = (pricingPlanPageParam61) => {
      pricingPlanPageValue156 != null &&
        appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dBl(
          pricingPlanPageValue146,
          appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dGf,
          {
            ctaAction: pricingPlanPageParam61,
            modalType: pricingPlanPageValue156.kind,
            source: pricingPlanPageValue153,
            targetPlan: subscriptionUpdatePlanN(
              pricingPlanPageValue156.updatedPlan,
            ),
          },
        );
    },
    pricingPlanPageValue165 = async () => {
      if (pricingPlanPageValue156 != null) {
        pricingPlanPageValue161(!0);
        try {
          let pricingPlanPageValue220 =
            await appInitialAppMainRemoteConversationPageNewThreadPanelPageAppgenLibraryPageHotFjhbmao5Dollar(
              {
                accountId: data.id,
                updatedPlan: pricingPlanPageValue156.updatedPlan,
              },
            );
          if (
            pricingPlanPageValue220.status == null ||
            pricingPlanPageValue220.status === `pending`
          ) {
            (pricingPlanPageValue157(null),
              pricingPlanPageValue220.status == null &&
                pricingPlanPageValue156.kind === `saved_card_upgrade` &&
                (pricingPlanPageValue146
                  .get(
                    appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwGp,
                  )
                  .success(
                    pricingPlanPageValue147.formatMessage({
                ...
                pricingPlanPageValue149(
                  pricingPlanPageValue152?.returnPath ?? `/`,
                )),
              await Promise.all([
                pricingPlanPageValue150.invalidateQueries({
          ...
          (await appInitialAppMainRemoteConversationPageNewThreadPanelPageAppgenLibraryPageHotFjhbmao5X(
            {
              accountId: data.id,
            },
          ),
            pricingPlanPageValue162(pricingPlanPageValue156.webUrl),
            pricingPlanPageValue157(null));
        } catch {
          (pricingPlanPageValue162(pricingPlanPageValue156.webUrl),
            pricingPlanPageValue157(null));
        } finally {
          pricingPlanPageValue161(!1);
        }
      }
    };
  return (0, $.jsxs)($.Fragment, {
    children: [
      (0, $.jsx)(
        pricingPlanPageHelper6,
        {
          currentPlan: pricingPlanPageValue154,
          defaultTab: pricingPlanPageValue155,
          loadingTargetPlan: pricingPlanPageValue158,
          pricingInfo: __data ?? null,
          onBack: () => {
            pricingPlanPageValue149(pricingPlanPageValue152?.returnPath ?? `/`);
          },
          onCtaClick: (
            pricingPlanPageParam74,
            pricingPlanPageParam75,
            pricingPlanPageParam76,
          ) => {
            pricingPlanPageValue163(
              pricingPlanPageParam74,
              pricingPlanPageParam75,
              pricingPlanPageParam76,
            );
      ...
      pricingPlanPageValue156 == null
        ? null
        : (0, $.jsx)(subscriptionUpdatePlanI, {
            isUpdating: pricingPlanPageValue160,
            pricingInfo: __data ?? null,
            subscriptionUpdate: pricingPlanPageValue156,
            onCancel: () => {
              (pricingPlanPageValue164(`cancel`),
                pricingPlanPageValue157(null));
            },
            onConfirm: () => {
              (pricingPlanPageValue164(
                pricingPlanPageValue156.kind === `saved_card_upgrade` &&
                  pricingPlanPageValue156.preview.amount_due.amount > 0
                  ? `pay_now`
                  : `confirm`,
              ),
                pricingPlanPageValue165());
            },
            onGoToWeb: (pricingPlanPageParam67) => {
              (pricingPlanPageValue164(`go_to_web`),
                pricingPlanPageValue162(
                  pricingPlanPageValue156.webUrl,
                  pricingPlanPageParam67,
                ),
                pricingPlanPageValue157(null));
            },
            onOpenChange: (pricingPlanPageParam68) => {
              pricingPlanPageParam68 ||
                (pricingPlanPageValue164(`dismiss`),
                pricingPlanPageValue160 || pricingPlanPageValue157(null));
            },
          }),
    ],
  });
}
function pricingPlanPageHelper6(pricingPlanPageParam3) {
  let pricingPlanPageValue102 = (0, pricingPlanPageValue94.c)(32),
    {
    ...
    } = pricingPlanPageParam3,
    pricingPlanPageValue103 = defaultTab === void 0 ? `personal` : defaultTab,
    pricingPlanPageValue104 =
      loadingTargetPlan === void 0 ? null : loadingTargetPlan,
    pricingPlanPageValue105 =
      appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dVy(),
    [pricingPlanPageValue106, pricingPlanPageValue107] = (0,
    pricingPlanPageValue95.useState)(pricingPlanPageValue103),
    pricingPlanPageValue108;
  pricingPlanPageValue102[0] === currentPlan
    ? (pricingPlanPageValue108 = pricingPlanPageValue102[1])
    : ((pricingPlanPageValue108 = pricingPlanPageHelper3(currentPlan)),
      (pricingPlanPageValue102[0] = currentPlan),
      (pricingPlanPageValue102[1] = pricingPlanPageValue108));
  let [pricingPlanPageValue109, pricingPlanPageValue110] = (0,
    pricingPlanPageValue95.useState)(pricingPlanPageValue108),
    pricingPlanPageValue111 =
      AppInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKg2pu5rsPt(),
    pricingPlanPageValue112 = Math.max(pricingPlanPageValue111.left, 8),
    pricingPlanPageValue113;
  pricingPlanPageValue102[2] === pricingPlanPageValue112
    ? (pricingPlanPageValue113 = pricingPlanPageValue102[3])
    : ((pricingPlanPageValue113 = {
        paddingInlineStart: pricingPlanPageValue112,
      }),
      (pricingPlanPageValue102[2] = pricingPlanPageValue112),
      (pricingPlanPageValue102[3] = pricingPlanPageValue113));
  let pricingPlanPageValue114, pricingPlanPageValue115;
  pricingPlanPageValue102[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((pricingPlanPageValue114 = (0, $.jsx)(
        appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwYs,
        {
          className: `icon-xs`,
        },
      )),
      (pricingPlanPageValue115 = (0, $.jsx)(
        appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dZy,
        {
          id: `settings.usage.pricingPlanPage.back`,
          defaultMessage: `Back`,
          description: `Button returning from the full page upgrade experience to the originating Codex app route`,
        },
      )),
      (pricingPlanPageValue102[4] = pricingPlanPageValue114),
      (pricingPlanPageValue102[5] = pricingPlanPageValue115))
    : ((pricingPlanPageValue114 = pricingPlanPageValue102[4]),
      (pricingPlanPageValue115 = pricingPlanPageValue102[5]));
  let pricingPlanPageValue116;
  pricingPlanPageValue102[6] === onBack
    ? (pricingPlanPageValue116 = pricingPlanPageValue102[7])
    : ((pricingPlanPageValue116 = (0, $.jsxs)(
        appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwTm,
        {
          color: `ghostMuted`,
          size: `default`,
          onClick: onBack,
          children: [pricingPlanPageValue114, pricingPlanPageValue115],
        },
      )),
      (pricingPlanPageValue102[6] = onBack),
      (pricingPlanPageValue102[7] = pricingPlanPageValue116));
  let pricingPlanPageValue117;
  pricingPlanPageValue102[8] !== pricingPlanPageValue113 ||
  pricingPlanPageValue102[9] !== pricingPlanPageValue116
    ? ((pricingPlanPageValue117 = (0, $.jsx)(`header`, {
        className: `draggable flex h-toolbar w-full shrink-0 items-center pe-2`,
        style: pricingPlanPageValue113,
        children: pricingPlanPageValue116,
      })),
      (pricingPlanPageValue102[8] = pricingPlanPageValue113),
      (pricingPlanPageValue102[9] = pricingPlanPageValue116),
      (pricingPlanPageValue102[10] = pricingPlanPageValue117))
    : (pricingPlanPageValue117 = pricingPlanPageValue102[10]);
  let pricingPlanPageValue118;
  pricingPlanPageValue102[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((pricingPlanPageValue118 = (0, $.jsx)(`h1`, {
        className: `text-[19px] font-medium [@container_(min-width:44rem)]:text-[24px]`,
        children: (0, $.jsx)(
          appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dZy,
          {
      ...
      (pricingPlanPageValue102[11] = pricingPlanPageValue118))
    : (pricingPlanPageValue118 = pricingPlanPageValue102[11]);
  let pricingPlanPageValue119;
  pricingPlanPageValue102[12] === pricingPlanPageValue105
    ? (pricingPlanPageValue119 = pricingPlanPageValue102[13])
    : ((pricingPlanPageValue119 = pricingPlanPageValue105.formatMessage({
        id: `settings.usage.pricingPlanPage.audienceSelector`,
        defaultMessage: `Plan audience`,
        description: `Accessible label for choosing personal or business upgrade plans`,
      })),
      (pricingPlanPageValue102[12] = pricingPlanPageValue105),
      (pricingPlanPageValue102[13] = pricingPlanPageValue119));
  let pricingPlanPageValue120;
  pricingPlanPageValue102[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((pricingPlanPageValue120 = {
        id: `personal`,
        label: (0, $.jsx)(
          appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dZy,
          {
      ...
      (pricingPlanPageValue102[14] = pricingPlanPageValue120))
    : (pricingPlanPageValue120 = pricingPlanPageValue102[14]);
  let pricingPlanPageValue121;
  pricingPlanPageValue102[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((pricingPlanPageValue121 = [
        pricingPlanPageValue120,
        {
          id: `business`,
          label: (0, $.jsx)(
      ...
      (pricingPlanPageValue102[15] = pricingPlanPageValue121))
    : (pricingPlanPageValue121 = pricingPlanPageValue102[15]);
  let pricingPlanPageValue122;
  pricingPlanPageValue102[16] !== pricingPlanPageValue106 ||
  pricingPlanPageValue102[17] !== pricingPlanPageValue119
    ? ((pricingPlanPageValue122 = (0, $.jsx)(subscriptionUpdatePlanO, {
        ariaLabel: pricingPlanPageValue119,
        options: pricingPlanPageValue121,
        selectedId: pricingPlanPageValue106,
        onSelect: pricingPlanPageValue107,
      })),
      (pricingPlanPageValue102[16] = pricingPlanPageValue106),
      (pricingPlanPageValue102[17] = pricingPlanPageValue119),
      (pricingPlanPageValue102[18] = pricingPlanPageValue122))
    : (pricingPlanPageValue122 = pricingPlanPageValue102[18]);
  let pricingPlanPageValue123;
  pricingPlanPageValue102[19] !== currentPlan ||
  pricingPlanPageValue102[20] !== pricingPlanPageValue104 ||
  pricingPlanPageValue102[21] !== onCtaClick ||
  pricingPlanPageValue102[22] !== pricingInfo ||
  pricingPlanPageValue102[23] !== pricingPlanPageValue109 ||
  pricingPlanPageValue102[24] !== pricingPlanPageValue106
    ? ((pricingPlanPageValue123 =
        pricingPlanPageValue106 === `personal`
          ? (0, $.jsx)(`div`, {
              className:
              ...
              children: pricingPlanPageHelper2(
                currentPlan,
                pricingPlanPageValue109,
              ).map((item) =>
                (0, $.jsx)(
                  _n,
                  {
                    card: item,
                    isLoading: pricingPlanPageValue104 === item.targetPlan,
                    pricingInfo: pricingInfo,
                    proPlan: pricingPlanPageValue109,
                    showProPlanSelector: !0,
                    onCtaClick: onCtaClick,
                    onSelectProPlan: pricingPlanPageValue110,
                  },
                  item.id,
                ),
              ),
          ...
          : (0, $.jsxs)(`div`, {
              className: `grid w-full grid-cols-[minmax(0,29.25rem)] justify-center gap-4 [@container_(min-width:44rem)]:grid-cols-[repeat(2,minmax(0,29.25rem))] [@container_(min-width:64rem)]:gap-6 [@container_(min-width:76rem)]:grid-cols-[repeat(3,minmax(0,29.25rem))]`,
              children: [
                (0, $.jsx)(_n, {
                  card: pricingPlanPageHelper4(currentPlan),
                  isLoading: !1,
                  pricingInfo: pricingInfo,
                  proPlan: pricingPlanPageValue109,
                  showProPlanSelector: !1,
                  onCtaClick: onCtaClick,
                  onSelectProPlan: pricingPlanPageValue110,
                }),
                pricingPlanPageValue92.map((item) =>
                  (0, $.jsx)(
                    pricingPlanPageHelper7,
                    {
                      card: item,
                      pricingInfo: pricingInfo,
                      onCtaClick: onCtaClick,
      ...
      (pricingPlanPageValue102[23] = pricingPlanPageValue109),
      (pricingPlanPageValue102[24] = pricingPlanPageValue106),
      (pricingPlanPageValue102[25] = pricingPlanPageValue123))
    : (pricingPlanPageValue123 = pricingPlanPageValue102[25]);
  let pricingPlanPageValue124;
  pricingPlanPageValue102[26] !== pricingPlanPageValue122 ||
  pricingPlanPageValue102[27] !== pricingPlanPageValue123
    ? ((pricingPlanPageValue124 = (0, $.jsx)(`section`, {
        className: `@container flex min-h-0 flex-1 flex-col overflow-y-auto px-4 pb-8 sm:px-8`,
        children: (0, $.jsxs)(`div`, {
          className: `flex w-full flex-col items-center gap-4 [@container_(min-width:64rem)]:gap-5`,
          children: [
            pricingPlanPageValue118,
            pricingPlanPageValue122,
            pricingPlanPageValue123,
          ],
        }),
      })),
      (pricingPlanPageValue102[26] = pricingPlanPageValue122),
      (pricingPlanPageValue102[27] = pricingPlanPageValue123),
      (pricingPlanPageValue102[28] = pricingPlanPageValue124))
    : (pricingPlanPageValue124 = pricingPlanPageValue102[28]);
  let pricingPlanPageValue125;
  return (
    pricingPlanPageValue102[29] !== pricingPlanPageValue124 ||
    pricingPlanPageValue102[30] !== pricingPlanPageValue117
      ? ((pricingPlanPageValue125 = (0, $.jsxs)(`main`, {
          className: `flex h-full min-h-0 flex-col bg-token-main-surface-primary text-token-text-primary [--cursor-interaction:pointer] [--pricing-plan-highlight:#635ef4]`,
          children: [pricingPlanPageValue117, pricingPlanPageValue124],
        })),
        (pricingPlanPageValue102[29] = pricingPlanPageValue124),
        (pricingPlanPageValue102[30] = pricingPlanPageValue117),
        (pricingPlanPageValue102[31] = pricingPlanPageValue125))
      : (pricingPlanPageValue125 = pricingPlanPageValue102[31]),
    pricingPlanPageValue125
  );
}
function _n(pricingPlanPageParam4) {
  let pricingPlanPageValue126 = (0, pricingPlanPageValue94.c)(50),
    {
      card: card,
      isLoading: isLoading,
      onCtaClick: onCtaClick,
    ...
    } = pricingPlanPageParam4,
    pricingPlanPageValue127 =
      appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dVy(),
    pricingPlanPageValue128;
  pricingPlanPageValue126[0] !== card.targetPlan ||
  pricingPlanPageValue126[1] !== pricingPlanPageValue127 ||
  pricingPlanPageValue126[2] !== pricingInfo
    ? ((pricingPlanPageValue128 =
        pricingInfo == null
          ? null
          : planPricingN({
              ...
              intl: pricingPlanPageValue127,
              minorUnitExponent: pricingInfo.minorUnitExponent,
            })),
      (pricingPlanPageValue126[0] = card.targetPlan),
      (pricingPlanPageValue126[1] = pricingPlanPageValue127),
      (pricingPlanPageValue126[2] = pricingInfo),
      (pricingPlanPageValue126[3] = pricingPlanPageValue128))
    : (pricingPlanPageValue128 = pricingPlanPageValue126[3]);
  let pricingPlanPageValue129 = pricingPlanPageValue128,
    pricingPlanPageValue130 = card.highlighted,
    pricingPlanPageValue131;
  pricingPlanPageValue126[4] === card.id
    ? (pricingPlanPageValue131 = pricingPlanPageValue126[5])
    : ((pricingPlanPageValue131 = (0, $.jsx)(pricingPlanPageHelper12, {
        cardId: card.id,
      })),
      (pricingPlanPageValue126[4] = card.id),
      (pricingPlanPageValue126[5] = pricingPlanPageValue131));
  let pricingPlanPageValue132;
  pricingPlanPageValue126[6] === card.highlighted
    ? (pricingPlanPageValue132 = pricingPlanPageValue126[7])
    : ((pricingPlanPageValue132 = card.highlighted
        ? (0, $.jsx)(
            appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dZy,
            {
        ...
        : null),
      (pricingPlanPageValue126[6] = card.highlighted),
      (pricingPlanPageValue126[7] = pricingPlanPageValue132));
  let pricingPlanPageValue133;
  pricingPlanPageValue126[8] !== card.id ||
  pricingPlanPageValue126[9] !== pricingPlanPageValue129
    ? ((pricingPlanPageValue133 =
        pricingPlanPageValue129 == null
          ? null
          : (0, $.jsxs)(`span`, {
              ...
              children: [
                card.id === `pro`
                  ...
                  : null,
                (0, $.jsx)(pricingPlanPageHelper8, {
                  price: pricingPlanPageValue129,
                  cadence: (0, $.jsx)(
                    appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dZy,
                    {
      ...
      (pricingPlanPageValue126[8] = card.id),
      (pricingPlanPageValue126[9] = pricingPlanPageValue129),
      (pricingPlanPageValue126[10] = pricingPlanPageValue133))
    : (pricingPlanPageValue133 = pricingPlanPageValue126[10]);
  let pricingPlanPageValue134, pricingPlanPageValue135;
  pricingPlanPageValue126[11] === card.id
    ? ((pricingPlanPageValue134 = pricingPlanPageValue126[12]),
      (pricingPlanPageValue135 = pricingPlanPageValue126[13]))
    : ((pricingPlanPageValue134 = (0, $.jsx)(pricingPlanPageHelper13, {
        cardId: card.id,
      })),
      (pricingPlanPageValue135 = (0, $.jsx)(pricingPlanPageHelper14, {
        cardId: card.id,
      })),
      (pricingPlanPageValue126[11] = card.id),
      (pricingPlanPageValue126[12] = pricingPlanPageValue134),
      (pricingPlanPageValue126[13] = pricingPlanPageValue135));
  let pricingPlanPageValue136;
  pricingPlanPageValue126[14] !== card.id ||
  pricingPlanPageValue126[15] !== pricingPlanPageValue127 ||
  pricingPlanPageValue126[16] !== onSelectProPlan ||
  pricingPlanPageValue126[17] !== proPlan ||
  pricingPlanPageValue126[18] !== showProPlanSelector
    ? ((pricingPlanPageValue136 =
        showProPlanSelector && card.id === `pro`
          ? (0, $.jsx)(subscriptionUpdatePlanO, {
              ariaLabel: pricingPlanPageValue127.formatMessage({
      ...
      (pricingPlanPageValue126[17] = proPlan),
      (pricingPlanPageValue126[18] = showProPlanSelector),
      (pricingPlanPageValue126[19] = pricingPlanPageValue136))
    : (pricingPlanPageValue136 = pricingPlanPageValue126[19]);
  let pricingPlanPageValue137;
  pricingPlanPageValue126[20] === card.id
    ? (pricingPlanPageValue137 = pricingPlanPageValue126[21])
    : ((pricingPlanPageValue137 = on(card.id)),
      (pricingPlanPageValue126[20] = card.id),
      (pricingPlanPageValue126[21] = pricingPlanPageValue137));
  let pricingPlanPageValue138 = card.highlighted && pricingPlanPageValue96,
    pricingPlanPageValue139;
  pricingPlanPageValue126[22] === pricingPlanPageValue138
    ? (pricingPlanPageValue139 = pricingPlanPageValue126[23])
    : ((pricingPlanPageValue139 =
        appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwMh(
          pricingPlanPageValue97,
          pricingPlanPageValue138,
        )),
      (pricingPlanPageValue126[22] = pricingPlanPageValue138),
      (pricingPlanPageValue126[23] = pricingPlanPageValue139));
  let pricingPlanPageValue140 =
      card.action === `current` ? `outline` : `primary`,
    pricingPlanPageValue141 = card.action === `current`,
    pricingPlanPageValue142;
  pricingPlanPageValue126[24] !== card.action ||
  pricingPlanPageValue126[25] !== card.targetPlan ||
  pricingPlanPageValue126[26] !== onCtaClick
    ? ((pricingPlanPageValue142 = (pricingPlanPageParam65) => {
        card.action !== `current` &&
          onCtaClick(card.action, card.targetPlan, pricingPlanPageParam65);
      }),
      (pricingPlanPageValue126[24] = card.action),
      (pricingPlanPageValue126[25] = card.targetPlan),
      (pricingPlanPageValue126[26] = onCtaClick),
      (pricingPlanPageValue126[27] = pricingPlanPageValue142))
    : (pricingPlanPageValue142 = pricingPlanPageValue126[27]);
  let pricingPlanPageValue143;
  pricingPlanPageValue126[28] !== card.action ||
  pricingPlanPageValue126[29] !== card.id ||
  pricingPlanPageValue126[30] !== isLoading
    ? ((pricingPlanPageValue143 = isLoading
        ? (0, $.jsx)(
            appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dZy,
            {
      ...
      (pricingPlanPageValue126[29] = card.id),
      (pricingPlanPageValue126[30] = isLoading),
      (pricingPlanPageValue126[31] = pricingPlanPageValue143))
    : (pricingPlanPageValue143 = pricingPlanPageValue126[31]);
  let pricingPlanPageValue144;
  pricingPlanPageValue126[32] !== isLoading ||
  pricingPlanPageValue126[33] !== pricingPlanPageValue139 ||
  pricingPlanPageValue126[34] !== pricingPlanPageValue140 ||
  pricingPlanPageValue126[35] !== pricingPlanPageValue141 ||
  pricingPlanPageValue126[36] !== pricingPlanPageValue142 ||
  pricingPlanPageValue126[37] !== pricingPlanPageValue143
    ? ((pricingPlanPageValue144 = (0, $.jsx)(
        appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwTm,
        {
          className: pricingPlanPageValue139,
          color: pricingPlanPageValue140,
          disabled: pricingPlanPageValue141,
          loading: isLoading,
          size: `default`,
          onClick: pricingPlanPageValue142,
          children: pricingPlanPageValue143,
        },
      )),
      (pricingPlanPageValue126[32] = isLoading),
      (pricingPlanPageValue126[33] = pricingPlanPageValue139),
      ...
      (pricingPlanPageValue126[36] = pricingPlanPageValue142),
      (pricingPlanPageValue126[37] = pricingPlanPageValue143),
      (pricingPlanPageValue126[38] = pricingPlanPageValue144))
    : (pricingPlanPageValue144 = pricingPlanPageValue126[38]);
  let pricingPlanPageValue145;
  return (
    pricingPlanPageValue126[39] !== card.highlighted ||
    pricingPlanPageValue126[40] !== showProPlanSelector ||
    pricingPlanPageValue126[41] !== pricingPlanPageValue144 ||
    pricingPlanPageValue126[42] !== pricingPlanPageValue131 ||
    pricingPlanPageValue126[43] !== pricingPlanPageValue132 ||
    pricingPlanPageValue126[44] !== pricingPlanPageValue133 ||
    pricingPlanPageValue126[45] !== pricingPlanPageValue134 ||
    pricingPlanPageValue126[46] !== pricingPlanPageValue135 ||
    pricingPlanPageValue126[47] !== pricingPlanPageValue136 ||
    pricingPlanPageValue126[48] !== pricingPlanPageValue137
      ? ((pricingPlanPageValue145 = (0, $.jsx)(pricingPlanPageHelper10, {
          highlighted: pricingPlanPageValue130,
          title: pricingPlanPageValue131,
          badge: pricingPlanPageValue132,
          price: pricingPlanPageValue133,
          description: pricingPlanPageValue134,
          footer: pricingPlanPageValue135,
          headerControl: pricingPlanPageValue136,
          reserveHeaderControlSpace: showProPlanSelector,
          features: pricingPlanPageValue137,
          cta: pricingPlanPageValue144,
        })),
        (pricingPlanPageValue126[39] = card.highlighted),
        (pricingPlanPageValue126[40] = showProPlanSelector),
        (pricingPlanPageValue126[41] = pricingPlanPageValue144),
        ...
        (pricingPlanPageValue126[47] = pricingPlanPageValue136),
        (pricingPlanPageValue126[48] = pricingPlanPageValue137),
        (pricingPlanPageValue126[49] = pricingPlanPageValue145))
      : (pricingPlanPageValue145 = pricingPlanPageValue126[49]),
    pricingPlanPageValue145
  );
}
function pricingPlanPageHelper7(pricingPlanPageParam8) {
  let pricingPlanPageValue166 = (0, pricingPlanPageValue94.c)(34),
    {
      card: card,
      onCtaClick: onCtaClick,
      pricingInfo: pricingInfo,
    } = pricingPlanPageParam8,
    pricingPlanPageValue167 =
      appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dVy(),
    pricingPlanPageValue168;
  pricingPlanPageValue166[0] !== card.id ||
  pricingPlanPageValue166[1] !== pricingPlanPageValue167 ||
  pricingPlanPageValue166[2] !== pricingInfo
    ? ((pricingPlanPageValue168 =
      ...
      (pricingPlanPageValue166[1] = pricingPlanPageValue167),
      (pricingPlanPageValue166[2] = pricingInfo),
      (pricingPlanPageValue166[3] = pricingPlanPageValue168))
    : (pricingPlanPageValue168 = pricingPlanPageValue166[3]);
  let pricingPlanPageValue169 = pricingPlanPageValue168,
    pricingPlanPageValue170 = card.highlighted,
    pricingPlanPageValue171;
  pricingPlanPageValue166[4] === card.id
    ? (pricingPlanPageValue171 = pricingPlanPageValue166[5])
    : ((pricingPlanPageValue171 = (0, $.jsx)(pricingPlanPageHelper21, {
        cardId: card.id,
      })),
      (pricingPlanPageValue166[4] = card.id),
      (pricingPlanPageValue166[5] = pricingPlanPageValue171));
  let pricingPlanPageValue172;
  pricingPlanPageValue166[6] !== pricingPlanPageValue169 ||
  pricingPlanPageValue166[7] !== card.id
    ? ((pricingPlanPageValue172 =
        card.id === `business_codex`
          ...
          : pricingPlanPageValue169 == null
            ? null
            : (0, $.jsx)(pricingPlanPageHelper8, {
                price: pricingPlanPageValue169,
                cadence: (0, $.jsx)(
                  appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dZy,
                  {
      ...
      (pricingPlanPageValue166[6] = pricingPlanPageValue169),
      (pricingPlanPageValue166[7] = card.id),
      (pricingPlanPageValue166[8] = pricingPlanPageValue172))
    : (pricingPlanPageValue172 = pricingPlanPageValue166[8]);
  let pricingPlanPageValue173, pricingPlanPageValue174, pricingPlanPageValue175;
  pricingPlanPageValue166[9] === card.id
    ? ((pricingPlanPageValue173 = pricingPlanPageValue166[10]),
      (pricingPlanPageValue174 = pricingPlanPageValue166[11]),
      (pricingPlanPageValue175 = pricingPlanPageValue166[12]))
    : ((pricingPlanPageValue173 = (0, $.jsx)(pricingPlanPageHelper25, {
        cardId: card.id,
      })),
      (pricingPlanPageValue174 = (0, $.jsx)(pricingPlanPageHelper19, {
        cardId: card.id,
      })),
      (pricingPlanPageValue175 = pricingPlanPageHelper1(card.id)),
      (pricingPlanPageValue166[9] = card.id),
      (pricingPlanPageValue166[10] = pricingPlanPageValue173),
      (pricingPlanPageValue166[11] = pricingPlanPageValue174),
      (pricingPlanPageValue166[12] = pricingPlanPageValue175));
  let pricingPlanPageValue176;
  pricingPlanPageValue166[13] !== card.id ||
  pricingPlanPageValue166[14] !== pricingPlanPageValue167
    ? ((pricingPlanPageValue176 =
        card.id === `business_chatgpt_codex`
          ? pricingPlanPageValue167.formatMessage({
      ...
      (pricingPlanPageValue166[13] = card.id),
      (pricingPlanPageValue166[14] = pricingPlanPageValue167),
      (pricingPlanPageValue166[15] = pricingPlanPageValue176))
    : (pricingPlanPageValue176 = pricingPlanPageValue166[15]);
  let pricingPlanPageValue177 = card.highlighted && pricingPlanPageValue96,
    pricingPlanPageValue178;
  pricingPlanPageValue166[16] === pricingPlanPageValue177
    ? (pricingPlanPageValue178 = pricingPlanPageValue166[17])
    : ((pricingPlanPageValue178 =
        appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwMh(
          pricingPlanPageValue97,
          pricingPlanPageValue177,
        )),
      (pricingPlanPageValue166[16] = pricingPlanPageValue177),
      (pricingPlanPageValue166[17] = pricingPlanPageValue178));
  let pricingPlanPageValue179;
  pricingPlanPageValue166[18] !== card.targetPlan ||
  pricingPlanPageValue166[19] !== onCtaClick
    ? ((pricingPlanPageValue179 = (pricingPlanPageParam73) => {
        onCtaClick(`upgrade`, card.targetPlan, pricingPlanPageParam73);
      }),
      (pricingPlanPageValue166[18] = card.targetPlan),
      (pricingPlanPageValue166[19] = onCtaClick),
      (pricingPlanPageValue166[20] = pricingPlanPageValue179))
    : (pricingPlanPageValue179 = pricingPlanPageValue166[20]);
  let pricingPlanPageValue180;
  pricingPlanPageValue166[21] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((pricingPlanPageValue180 = (0, $.jsx)(
        appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dZy,
        {
      ...
      (pricingPlanPageValue166[21] = pricingPlanPageValue180))
    : (pricingPlanPageValue180 = pricingPlanPageValue166[21]);
  let pricingPlanPageValue181;
  pricingPlanPageValue166[22] !== pricingPlanPageValue178 ||
  pricingPlanPageValue166[23] !== pricingPlanPageValue179 ||
  pricingPlanPageValue166[24] !== pricingPlanPageValue176
    ? ((pricingPlanPageValue181 = (0, $.jsx)(
        appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwTm,
        {
          "aria-label": pricingPlanPageValue176,
          className: pricingPlanPageValue178,
          color: `primary`,
          size: `default`,
          onClick: pricingPlanPageValue179,
          children: pricingPlanPageValue180,
        },
      )),
      (pricingPlanPageValue166[22] = pricingPlanPageValue178),
      (pricingPlanPageValue166[23] = pricingPlanPageValue179),
      (pricingPlanPageValue166[24] = pricingPlanPageValue176),
      (pricingPlanPageValue166[25] = pricingPlanPageValue181))
    : (pricingPlanPageValue181 = pricingPlanPageValue166[25]);
  let pricingPlanPageValue182;
  return (
    pricingPlanPageValue166[26] !== card.highlighted ||
    pricingPlanPageValue166[27] !== pricingPlanPageValue181 ||
    pricingPlanPageValue166[28] !== pricingPlanPageValue171 ||
    pricingPlanPageValue166[29] !== pricingPlanPageValue172 ||
    pricingPlanPageValue166[30] !== pricingPlanPageValue173 ||
    pricingPlanPageValue166[31] !== pricingPlanPageValue174 ||
    pricingPlanPageValue166[32] !== pricingPlanPageValue175
      ? ((pricingPlanPageValue182 = (0, $.jsx)(pricingPlanPageHelper10, {
          highlighted: pricingPlanPageValue170,
          title: pricingPlanPageValue171,
          price: pricingPlanPageValue172,
          description: pricingPlanPageValue173,
          footer: pricingPlanPageValue174,
          features: pricingPlanPageValue175,
          cta: pricingPlanPageValue181,
        })),
        (pricingPlanPageValue166[26] = card.highlighted),
        (pricingPlanPageValue166[27] = pricingPlanPageValue181),
        (pricingPlanPageValue166[28] = pricingPlanPageValue171),
        ...
        (pricingPlanPageValue166[31] = pricingPlanPageValue174),
        (pricingPlanPageValue166[32] = pricingPlanPageValue175),
        (pricingPlanPageValue166[33] = pricingPlanPageValue182))
      : (pricingPlanPageValue182 = pricingPlanPageValue166[33]),
    pricingPlanPageValue182
  );
}
function pricingPlanPageHelper8(pricingPlanPageParam34) {
  let pricingPlanPageValue209 = (0, pricingPlanPageValue94.c)(15),
    { cadence: cadence, price: price } = pricingPlanPageParam34,
    pricingPlanPageValue210;
  pricingPlanPageValue209[0] === price.formatted
    ? (pricingPlanPageValue210 = pricingPlanPageValue209[1])
    : ((pricingPlanPageValue210 = (0, $.jsx)(`span`, {
        className: `sr-only`,
        children: price.formatted,
      })),
      (pricingPlanPageValue209[0] = price.formatted),
      (pricingPlanPageValue209[1] = pricingPlanPageValue210));
  let pricingPlanPageValue211;
  pricingPlanPageValue209[2] === price.parts
    ? (pricingPlanPageValue211 = pricingPlanPageValue209[3])
    : ((pricingPlanPageValue211 = price.parts.map(pricingPlanPageHelper9)),
      (pricingPlanPageValue209[2] = price.parts),
      (pricingPlanPageValue209[3] = pricingPlanPageValue211));
  let pricingPlanPageValue212;
  pricingPlanPageValue209[4] === pricingPlanPageValue211
    ? (pricingPlanPageValue212 = pricingPlanPageValue209[5])
    : ((pricingPlanPageValue212 = (0, $.jsx)(`span`, {
        "aria-hidden": `true`,
        className: `leading-none whitespace-nowrap`,
        children: pricingPlanPageValue211,
      })),
      (pricingPlanPageValue209[4] = pricingPlanPageValue211),
      (pricingPlanPageValue209[5] = pricingPlanPageValue212));
  let pricingPlanPageValue213;
  pricingPlanPageValue209[6] === price.currencyCodeLabel
    ? (pricingPlanPageValue213 = pricingPlanPageValue209[7])
    : ((pricingPlanPageValue213 =
      ...
      (pricingPlanPageValue209[6] = price.currencyCodeLabel),
      (pricingPlanPageValue209[7] = pricingPlanPageValue213));
  let pricingPlanPageValue214;
  pricingPlanPageValue209[8] !== cadence ||
  pricingPlanPageValue209[9] !== pricingPlanPageValue213
    ? ((pricingPlanPageValue214 = (0, $.jsxs)(`span`, {
        className: `mb-0.5 text-[10px] text-token-text-secondary [@container_(min-width:44rem)]:text-[11px]`,
        children: [pricingPlanPageValue213, cadence],
      })),
      (pricingPlanPageValue209[8] = cadence),
      (pricingPlanPageValue209[9] = pricingPlanPageValue213),
      (pricingPlanPageValue209[10] = pricingPlanPageValue214))
    : (pricingPlanPageValue214 = pricingPlanPageValue209[10]);
  let pricingPlanPageValue215;
  return (
    pricingPlanPageValue209[11] !== pricingPlanPageValue210 ||
    pricingPlanPageValue209[12] !== pricingPlanPageValue212 ||
    pricingPlanPageValue209[13] !== pricingPlanPageValue214
      ? ((pricingPlanPageValue215 = (0, $.jsxs)(`span`, {
          className: `flex items-end gap-1.5`,
          children: [
            pricingPlanPageValue210,
            pricingPlanPageValue212,
            pricingPlanPageValue214,
          ],
        })),
        (pricingPlanPageValue209[11] = pricingPlanPageValue210),
        (pricingPlanPageValue209[12] = pricingPlanPageValue212),
        (pricingPlanPageValue209[13] = pricingPlanPageValue214),
        (pricingPlanPageValue209[14] = pricingPlanPageValue215))
      : (pricingPlanPageValue215 = pricingPlanPageValue209[14]),
    pricingPlanPageValue215
  );
}
function pricingPlanPageHelper9(
  pricingPlanPageParam52,
  pricingPlanPageParam53,
) {
  return pricingPlanPageParam52.type === `currency`
    ? (0, $.jsx)(
        `span`,
        {
          ...
          children: pricingPlanPageParam52.value,
        },
        pricingPlanPageParam53,
      )
    : (0, $.jsx)(
...
function pricingPlanPageHelper10(pricingPlanPageParam9) {
  let pricingPlanPageValue183 = (0, pricingPlanPageValue94.c)(33),
    {
      badge: badge,
      cta: cta,
      ...
      title: title,
    } = pricingPlanPageParam9,
    pricingPlanPageValue184 =
      reserveHeaderControlSpace === void 0 ? !1 : reserveHeaderControlSpace,
    pricingPlanPageValue185 = highlighted
    ...
    pricingPlanPageValue186;
  pricingPlanPageValue183[0] === pricingPlanPageValue185
    ? (pricingPlanPageValue186 = pricingPlanPageValue183[1])
    : ((pricingPlanPageValue186 =
        appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwMh(
          ...
          pricingPlanPageValue185,
        )),
      (pricingPlanPageValue183[0] = pricingPlanPageValue185),
      (pricingPlanPageValue183[1] = pricingPlanPageValue186));
  let pricingPlanPageValue187 = pricingPlanPageValue184
      ? `min-h-10`
      : `min-h-6`,
    pricingPlanPageValue188;
  pricingPlanPageValue183[2] === pricingPlanPageValue187
    ? (pricingPlanPageValue188 = pricingPlanPageValue183[3])
    : ((pricingPlanPageValue188 =
        appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwMh(
          `flex items-start justify-between gap-2 text-[19px] font-medium [@container_(min-width:44rem)]:text-[24px]`,
          pricingPlanPageValue187,
        )),
      (pricingPlanPageValue183[2] = pricingPlanPageValue187),
      (pricingPlanPageValue183[3] = pricingPlanPageValue188));
  let pricingPlanPageValue189;
  pricingPlanPageValue183[4] !== badge ||
  pricingPlanPageValue183[5] !== headerControl
    ? ((pricingPlanPageValue189 =
        headerControl ??
        (badge == null
          ? null
          : (0, $.jsx)(`span`, {
      ...
      (pricingPlanPageValue183[4] = badge),
      (pricingPlanPageValue183[5] = headerControl),
      (pricingPlanPageValue183[6] = pricingPlanPageValue189))
    : (pricingPlanPageValue189 = pricingPlanPageValue183[6]);
  let pricingPlanPageValue190;
  pricingPlanPageValue183[7] !== pricingPlanPageValue188 ||
  pricingPlanPageValue183[8] !== pricingPlanPageValue189 ||
  pricingPlanPageValue183[9] !== title
    ? ((pricingPlanPageValue190 = (0, $.jsxs)(`div`, {
        className: pricingPlanPageValue188,
        children: [title, pricingPlanPageValue189],
      })),
      (pricingPlanPageValue183[7] = pricingPlanPageValue188),
      (pricingPlanPageValue183[8] = pricingPlanPageValue189),
      (pricingPlanPageValue183[9] = title),
      (pricingPlanPageValue183[10] = pricingPlanPageValue190))
    : (pricingPlanPageValue190 = pricingPlanPageValue183[10]);
  let pricingPlanPageValue191;
  pricingPlanPageValue183[11] === price
    ? (pricingPlanPageValue191 = pricingPlanPageValue183[12])
    : ((pricingPlanPageValue191 = (0, $.jsx)(`div`, {
        className: `mt-3 flex h-12 items-center`,
        children: price,
      })),
      (pricingPlanPageValue183[11] = price),
      (pricingPlanPageValue183[12] = pricingPlanPageValue191));
  let pricingPlanPageValue192;
  pricingPlanPageValue183[13] === description
    ? (pricingPlanPageValue192 = pricingPlanPageValue183[14])
    : ((pricingPlanPageValue192 = (0, $.jsx)(`div`, {
      ...
      (pricingPlanPageValue183[13] = description),
      (pricingPlanPageValue183[14] = pricingPlanPageValue192));
  let pricingPlanPageValue193;
  pricingPlanPageValue183[15] !== pricingPlanPageValue190 ||
  pricingPlanPageValue183[16] !== pricingPlanPageValue191 ||
  pricingPlanPageValue183[17] !== pricingPlanPageValue192
    ? ((pricingPlanPageValue193 = (0, $.jsxs)(`div`, {
        className: `[@container_(min-width:44rem)]:min-h-36`,
        children: [
          pricingPlanPageValue190,
          pricingPlanPageValue191,
          pricingPlanPageValue192,
        ],
      })),
      (pricingPlanPageValue183[15] = pricingPlanPageValue190),
      (pricingPlanPageValue183[16] = pricingPlanPageValue191),
      (pricingPlanPageValue183[17] = pricingPlanPageValue192),
      (pricingPlanPageValue183[18] = pricingPlanPageValue193))
    : (pricingPlanPageValue193 = pricingPlanPageValue183[18]);
  let pricingPlanPageValue194;
  pricingPlanPageValue183[19] === cta
    ? (pricingPlanPageValue194 = pricingPlanPageValue183[20])
    : ((pricingPlanPageValue194 = (0, $.jsx)(`div`, {
      ...
      (pricingPlanPageValue183[19] = cta),
      (pricingPlanPageValue183[20] = pricingPlanPageValue194));
  let pricingPlanPageValue195;
  pricingPlanPageValue183[21] === features
    ? (pricingPlanPageValue195 = pricingPlanPageValue183[22])
    : ((pricingPlanPageValue195 = features.map(pricingPlanPageHelper11)),
      (pricingPlanPageValue183[21] = features),
      (pricingPlanPageValue183[22] = pricingPlanPageValue195));
  let pricingPlanPageValue196;
  pricingPlanPageValue183[23] === pricingPlanPageValue195
    ? (pricingPlanPageValue196 = pricingPlanPageValue183[24])
    : ((pricingPlanPageValue196 = (0, $.jsx)(`div`, {
        ...
        children: pricingPlanPageValue195,
      })),
      (pricingPlanPageValue183[23] = pricingPlanPageValue195),
      (pricingPlanPageValue183[24] = pricingPlanPageValue196));
  let pricingPlanPageValue197;
  pricingPlanPageValue183[25] === footer
    ? (pricingPlanPageValue197 = pricingPlanPageValue183[26])
    : ((pricingPlanPageValue197 = (0, $.jsx)(`div`, {
      ...
      (pricingPlanPageValue183[25] = footer),
      (pricingPlanPageValue183[26] = pricingPlanPageValue197));
  let pricingPlanPageValue198;
  return (
    pricingPlanPageValue183[27] !== pricingPlanPageValue193 ||
    pricingPlanPageValue183[28] !== pricingPlanPageValue194 ||
    pricingPlanPageValue183[29] !== pricingPlanPageValue196 ||
    pricingPlanPageValue183[30] !== pricingPlanPageValue197 ||
    pricingPlanPageValue183[31] !== pricingPlanPageValue186
      ? ((pricingPlanPageValue198 = (0, $.jsxs)(`article`, {
          className: pricingPlanPageValue186,
          children: [
            pricingPlanPageValue193,
            pricingPlanPageValue194,
            pricingPlanPageValue196,
            pricingPlanPageValue197,
          ],
        })),
        (pricingPlanPageValue183[27] = pricingPlanPageValue193),
        (pricingPlanPageValue183[28] = pricingPlanPageValue194),
        ...
        (pricingPlanPageValue183[30] = pricingPlanPageValue197),
        (pricingPlanPageValue183[31] = pricingPlanPageValue186),
        (pricingPlanPageValue183[32] = pricingPlanPageValue198))
      : (pricingPlanPageValue198 = pricingPlanPageValue183[32]),
    pricingPlanPageValue198
  );
}
function pricingPlanPageHelper11(
  pricingPlanPageParam54,
  pricingPlanPageParam55,
) {
  return (0, $.jsxs)(
    `div`,
    {
      ...
      children: [
        (0, pricingPlanPageValue95.createElement)(pricingPlanPageParam54.icon, {
          className: `size-4 shrink-0 [@container_(min-width:44rem)]:size-5`,
        }),
        (0, $.jsx)(`span`, {
          children: pricingPlanPageParam54.label,
        }),
      ],
    },
    pricingPlanPageParam55,
...
function pricingPlanPageHelper12(pricingPlanPageParam33) {
  let pricingPlanPageValue208 = (0, pricingPlanPageValue94.c)(4),
    { cardId: cardId } = pricingPlanPageParam33;
  switch (cardId) {
    case `free`: {
      let pricingPlanPageValue238;
      return (
        pricingPlanPageValue208[0] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((pricingPlanPageValue238 = (0, $.jsx)(
              appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dZy,
              {
            ...
            (pricingPlanPageValue208[0] = pricingPlanPageValue238))
          : (pricingPlanPageValue238 = pricingPlanPageValue208[0]),
        pricingPlanPageValue238
      );
    }
    case `go`: {
      let pricingPlanPageValue241;
      return (
        pricingPlanPageValue208[1] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((pricingPlanPageValue241 = (0, $.jsx)(
              appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dZy,
              {
            ...
            (pricingPlanPageValue208[1] = pricingPlanPageValue241))
          : (pricingPlanPageValue241 = pricingPlanPageValue208[1]),
        pricingPlanPageValue241
      );
    }
    case `plus`: {
      let pricingPlanPageValue239;
      return (
        pricingPlanPageValue208[2] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((pricingPlanPageValue239 = (0, $.jsx)(
              appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dZy,
              {
            ...
            (pricingPlanPageValue208[2] = pricingPlanPageValue239))
          : (pricingPlanPageValue239 = pricingPlanPageValue208[2]),
        pricingPlanPageValue239
      );
    }
    case `pro`: {
      let pricingPlanPageValue240;
      return (
        pricingPlanPageValue208[3] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((pricingPlanPageValue240 = (0, $.jsx)(
              appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dZy,
              {
            ...
            (pricingPlanPageValue208[3] = pricingPlanPageValue240))
          : (pricingPlanPageValue240 = pricingPlanPageValue208[3]),
        pricingPlanPageValue240
      );
    }
  }
}
function pricingPlanPageHelper13(pricingPlanPageParam26) {
  let pricingPlanPageValue199 = (0, pricingPlanPageValue94.c)(4),
    { cardId: cardId } = pricingPlanPageParam26;
  switch (cardId) {
    case `free`: {
      let pricingPlanPageValue237;
      return (
        pricingPlanPageValue199[0] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((pricingPlanPageValue237 = (0, $.jsx)(
              appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dZy,
              {
            ...
            (pricingPlanPageValue199[0] = pricingPlanPageValue237))
          : (pricingPlanPageValue237 = pricingPlanPageValue199[0]),
        pricingPlanPageValue237
      );
    }
    case `go`: {
      let pricingPlanPageValue236;
      return (
        pricingPlanPageValue199[1] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((pricingPlanPageValue236 = (0, $.jsx)(
              appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dZy,
              {
            ...
            (pricingPlanPageValue199[1] = pricingPlanPageValue236))
          : (pricingPlanPageValue236 = pricingPlanPageValue199[1]),
        pricingPlanPageValue236
      );
    }
    case `plus`: {
      let pricingPlanPageValue234;
      return (
        pricingPlanPageValue199[2] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((pricingPlanPageValue234 = (0, $.jsx)(
              appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dZy,
              {
            ...
            (pricingPlanPageValue199[2] = pricingPlanPageValue234))
          : (pricingPlanPageValue234 = pricingPlanPageValue199[2]),
        pricingPlanPageValue234
      );
    }
    case `pro`: {
      let pricingPlanPageValue235;
      return (
        pricingPlanPageValue199[3] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((pricingPlanPageValue235 = (0, $.jsx)(
              appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dZy,
              {
            ...
            (pricingPlanPageValue199[3] = pricingPlanPageValue235))
          : (pricingPlanPageValue235 = pricingPlanPageValue199[3]),
        pricingPlanPageValue235
      );
    }
  }
}
function pricingPlanPageHelper14(pricingPlanPageParam31) {
  let pricingPlanPageValue207 = (0, pricingPlanPageValue94.c)(3),
    { cardId: cardId } = pricingPlanPageParam31;
  switch (cardId) {
    case `free`: {
      let pricingPlanPageValue232;
      return (
        pricingPlanPageValue207[0] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((pricingPlanPageValue232 = (0, $.jsx)(
              appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dZy,
              {
                ...
                values: {
                  link: pricingPlanPageHelper17,
                },
              },
            )),
            (pricingPlanPageValue207[0] = pricingPlanPageValue232))
          : (pricingPlanPageValue232 = pricingPlanPageValue207[0]),
        pricingPlanPageValue232
      );
    }
    case `go`: {
      let pricingPlanPageValue233;
      return (
        pricingPlanPageValue207[1] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((pricingPlanPageValue233 = (0, $.jsx)(
              appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dZy,
              {
                ...
                values: {
                  link: pricingPlanPageHelper16,
                },
              },
            )),
            (pricingPlanPageValue207[1] = pricingPlanPageValue233))
          : (pricingPlanPageValue233 = pricingPlanPageValue207[1]),
        pricingPlanPageValue233
      );
    }
    case `plus`:
      return null;
    case `pro`: {
      let pricingPlanPageValue231;
      return (
        pricingPlanPageValue207[2] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((pricingPlanPageValue231 = (0, $.jsx)(
              appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dZy,
              {
                ...
                values: {
                  link: pricingPlanPageHelper15,
                },
              },
            )),
            (pricingPlanPageValue207[2] = pricingPlanPageValue231))
          : (pricingPlanPageValue231 = pricingPlanPageValue207[2]),
        pricingPlanPageValue231
      );
    }
  }
}
function pricingPlanPageHelper15(pricingPlanPageParam69) {
  return (0, $.jsx)(pricingPlanPageHelper24, {
    href: pricingPlanPageValue101,
    children: pricingPlanPageParam69,
  });
}
function pricingPlanPageHelper16(pricingPlanPageParam70) {
  return (0, $.jsx)(pricingPlanPageHelper24, {
    href: pricingPlanPageValue98,
    children: pricingPlanPageParam70,
  });
}
function pricingPlanPageHelper17(pricingPlanPageParam71) {
  return (0, $.jsx)(pricingPlanPageHelper24, {
    href: pricingPlanPageValue99,
    children: pricingPlanPageParam71,
  });
}
function pricingPlanPageHelper18(pricingPlanPageParam38) {
  let pricingPlanPageValue216 = (0, pricingPlanPageValue94.c)(4),
    { action: action, cardId: cardId } = pricingPlanPageParam38;
  if (action === `current`) {
    let pricingPlanPageValue242;
    return (
      pricingPlanPageValue216[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((pricingPlanPageValue242 = (0, $.jsx)(
            appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dZy,
            {
          ...
          (pricingPlanPageValue216[0] = pricingPlanPageValue242))
        : (pricingPlanPageValue242 = pricingPlanPageValue216[0]),
      pricingPlanPageValue242
    );
  }
  let pricingPlanPageValue217;
  return (
    pricingPlanPageValue216[1] !== action ||
    pricingPlanPageValue216[2] !== cardId
      ? ((pricingPlanPageValue217 =
          action === `upgrade`
            ? (0, $.jsx)(
                appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dZy,
                {
                  ...
                  values: {
                    plan: (0, $.jsx)(pricingPlanPageHelper12, {
                      cardId: cardId,
                    }),
                  },
                },
        ...
        (pricingPlanPageValue216[1] = action),
        (pricingPlanPageValue216[2] = cardId),
        (pricingPlanPageValue216[3] = pricingPlanPageValue217))
      : (pricingPlanPageValue217 = pricingPlanPageValue216[3]),
    pricingPlanPageValue217
  );
}
function pricingPlanPageHelper19(pricingPlanPageParam50) {
  let pricingPlanPageValue229 = (0, pricingPlanPageValue94.c)(1),
    { cardId: cardId } = pricingPlanPageParam50;
  if (cardId === `business_codex`) return null;
  let pricingPlanPageValue230;
  return (
    pricingPlanPageValue229[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((pricingPlanPageValue230 = (0, $.jsx)(
          appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dZy,
          {
            ...
            values: {
              link: pricingPlanPageHelper20,
            },
          },
        )),
        (pricingPlanPageValue229[0] = pricingPlanPageValue230))
      : (pricingPlanPageValue230 = pricingPlanPageValue229[0]),
    pricingPlanPageValue230
  );
}
function pricingPlanPageHelper20(pricingPlanPageParam72) {
  return (0, $.jsx)(pricingPlanPageHelper24, {
    href: pricingPlanPageValue100,
    children: pricingPlanPageParam72,
  });
}
function pricingPlanPageHelper21(pricingPlanPageParam45) {
  let pricingPlanPageValue218 = (0, pricingPlanPageValue94.c)(2),
    { cardId: cardId } = pricingPlanPageParam45,
    pricingPlanPageValue219;
  return (
    pricingPlanPageValue218[0] === cardId
      ? (pricingPlanPageValue219 = pricingPlanPageValue218[1])
      : ((pricingPlanPageValue219 =
          cardId === `business_chatgpt_codex`
            ? (0, $.jsx)(`span`, {
                children: (0, $.jsx)(
                  appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dZy,
                  {
                    ...
                    values: {
                      product: pricingPlanPageHelper23,
                    },
                  },
                ),
              })
            : (0, $.jsx)(`span`, {
                children: (0, $.jsx)(
                  appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dZy,
                  {
                    ...
                    values: {
                      product: pricingPlanPageHelper22,
                    },
                  },
                ),
              })),
        (pricingPlanPageValue218[0] = cardId),
        (pricingPlanPageValue218[1] = pricingPlanPageValue219)),
    pricingPlanPageValue219
  );
}
function pricingPlanPageHelper22(pricingPlanPageParam63) {
  return (0, $.jsx)(`span`, {
    className: `text-token-text-secondary`,
    children: pricingPlanPageParam63,
  });
}
function pricingPlanPageHelper23(pricingPlanPageParam62) {
  return (0, $.jsx)(`span`, {
    className: `text-[var(--pricing-plan-highlight)]`,
    children: pricingPlanPageParam62,
  });
}
function pricingPlanPageHelper24(pricingPlanPageParam49) {
  let pricingPlanPageValue226 = (0, pricingPlanPageValue94.c)(6),
    { children: children, href: href } = pricingPlanPageParam49,
    pricingPlanPageValue227;
  pricingPlanPageValue226[0] === href
    ? (pricingPlanPageValue227 = pricingPlanPageValue226[1])
    : ((pricingPlanPageValue227 = (pricingPlanPageParam64) => {
        appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwIs(
          {
            event: pricingPlanPageParam64,
            href: href,
            initiator: `open_in_browser_bridge`,
          },
        );
      ...
      (pricingPlanPageValue226[0] = href),
      (pricingPlanPageValue226[1] = pricingPlanPageValue227));
  let pricingPlanPageValue228;
  return (
    pricingPlanPageValue226[2] !== children ||
    pricingPlanPageValue226[3] !== href ||
    pricingPlanPageValue226[4] !== pricingPlanPageValue227
      ? ((pricingPlanPageValue228 = (0, $.jsx)(`a`, {
          className: `cursor-interaction whitespace-nowrap underline underline-offset-2`,
          href: href,
          target: `_blank`,
          rel: `noreferrer`,
          onClick: pricingPlanPageValue227,
          children: children,
        })),
        (pricingPlanPageValue226[2] = children),
        (pricingPlanPageValue226[3] = href),
        (pricingPlanPageValue226[4] = pricingPlanPageValue227),
        (pricingPlanPageValue226[5] = pricingPlanPageValue228))
      : (pricingPlanPageValue228 = pricingPlanPageValue226[5]),
    pricingPlanPageValue228
  );
}
function pricingPlanPageHelper25(pricingPlanPageParam46) {
  let pricingPlanPageValue221 = (0, pricingPlanPageValue94.c)(2),
    { cardId: cardId } = pricingPlanPageParam46,
    pricingPlanPageValue222;
  return (
    pricingPlanPageValue221[0] === cardId
      ? (pricingPlanPageValue222 = pricingPlanPageValue221[1])
      : ((pricingPlanPageValue222 =
          cardId === `business_chatgpt_codex`
            ? (0, $.jsx)(
                appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dZy,
        ...
        (pricingPlanPageValue221[0] = cardId),
        (pricingPlanPageValue221[1] = pricingPlanPageValue222)),
    pricingPlanPageValue222
  );
}
var pricingPlanPageValue94,
  pricingPlanPageValue95,
  $,
  pricingPlanPageValue96,
  pricingPlanPageValue97,
  pricingPlanPageValue98,
  pricingPlanPageValue99,
  pricingPlanPageValue100,
  pricingPlanPageValue101;
rolldownRuntimeN(() => {
  ((pricingPlanPageValue94 =
    ...
    (pricingPlanPageValue95 = rolldownRuntimeS(
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wC(),
      1,
    )),
    appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dIy(),
    ...
    appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKg2pu5rsFt(),
    ...
    appInitialAppMainRemoteConversationPageNewThreadPanelPageAppgenLibraryPageHotFjhbmao5G(),
    ...
    appInitialAppMainRemoteConversationPageNewThreadPanelPageAppgenLibraryPageHotFjhbmao5Mt(),
    appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwRd(),
    appInitialAppMainRemoteConversationPageNewThreadPanelPageAppgenLibraryPageHotFjhbmao5P(),
    planPricingR(),
    pricingPlanPageValue91(),
    pricingPlanPageValue93(),
    subscriptionUpdatePlanA(),
    subscriptionUpdatePlanR(),
    ($ =
      appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageAutomationsPageThBnlvjk3wLc()),
    (pricingPlanPageValue96 = `!border-transparent !bg-[var(--pricing-plan-highlight)] !text-white enabled:hover:!bg-[color-mix(in_srgb,var(--pricing-plan-highlight)_90%,transparent)] data-[state=open]:!bg-[color-mix(in_srgb,var(--pricing-plan-highlight)_90%,transparent)]`),
    (pricingPlanPageValue97 = `w-full justify-center py-1 [@container_(min-width:44rem)]:min-h-11`),
    (pricingPlanPageValue98 = `https://help.openai.com/en/articles/20001047`),
    (pricingPlanPageValue99 = `https://help.openai.com/en/collections/3943089-billing`),
    (pricingPlanPageValue100 = `https://help.openai.com/en/articles/8792828-what-is-chatgpt-team`),
    (pricingPlanPageValue101 = `https://help.openai.com/en/articles/9793128-what-is-chatgpt-pro`));
})();
export { PricingPlanPageIcon as PricingPlanPage };
