...
// MatrixDark chunk restored from the Codex webview bundle.
import { once } from "../runtime/commonjs-interop";
var matrixDarkBg,
  matrixDarkColors,
  matrixDarkChromeTheme,
  matrixDarkFg,
  matrixDarkName,
  matrixDarkSettings,
  matrixDarkType,
...
once(() => {
  ...
  matrixDarkDefault = {
    ...
    chromeTheme: matrixDarkChromeTheme,
    fg: matrixDarkFg,
    name: matrixDarkName,
    settings: matrixDarkSettings,
    type: matrixDarkType,
  };
})();
export {
  matrixDarkBg as bg,
  matrixDarkChromeTheme as chromeTheme,
  matrixDarkColors as colors,
  matrixDarkDefault as default,
  matrixDarkFg,
  matrixDarkName as name,
  matrixDarkSettings as settings,
  matrixDarkType as type,
};
