...
export function lockSpacingAxis(
  state: DesignEditorState,
  property: SpacingGroupProperty,
  axis: SpacingAxis,
): DesignEditorState {
...
export function setSpacingValueLinked(
  state: DesignEditorState,
  property: SpacingGroupProperty,
...
export function setDimensionValueLinked(
  state: DesignEditorState,
...
export function resetTextValue(state: DesignEditorState): DesignEditorState {
  const text = getTextEdit(state);
...
export function resetSpacingValueLinked(
  state: DesignEditorState,
  property: SpacingGroupProperty,
  declarationProperty: string,
): DesignEditorState {
...
export function getTextEdit(state: DesignEditorState): TextEdit | null {
...
export function groupDeclarationsIntoSections(
  declarations: DesignDeclaration[],
): DesignSection[] {
...
export function getSectionKey(section: DesignSection): string {
  switch (section.kind) {
    case "declaration":
...
export function isLayoutSection(section: DesignSection | undefined): boolean {
  return (
...
export function getSpacingGroupForProperty(
  property: string,
...
export function findSpacingDeclaration(
  declarations: DesignDeclaration[],
  property: string,
  side: string,
...
export function spacingRelationshipKey(property: string, axis: string): string {
  return `${property}-${axis}`;
}

export function computeInitialLockedRelationships(
  state: DesignEditorState,
): LockedRelationships {
  return {
    dimensions: false,
...
export function isSpacingValueLocked(
...
export function spacingAxisProperties(
  property: string,
  axis: string,
): [string, string] {
...
export function oppositeSpacingProperty(
  property: string,
  declarationProperty: string,
): string | null {
  return declarationProperty === `${property}-top`
...
export function parsePixelNumber(value: string): number | null {
  const pixels = extractPixelValue(value);
  return pixels == null ? null : Number(pixels);
}

export function normalizeGapValue(
  property: string,
  value: string,
): string | null {
...
export function extractPixelValue(value: string): string | null {
...
export function isLengthLikeDeclaration(
  declaration: DesignDeclaration,
): boolean {
  return (
...
export function isGapProperty(property: string): boolean {
  return (
    property === "column-gap" || property === "gap" || property === "row-gap"
  );
}

export function resolveScrubBaseValue(
  value: string,
...
export function toHexColor(value: string | null | undefined): string {
...
export function getPropertyLabel(intl: IntlShape, property: string): string {
  switch (property) {
    case "color":
...
export function getDeclarationSuggestions(
  intl: IntlShape,
  declaration: DesignDeclaration,
): SuggestionOption[] {
