...
export function DesignRowDivider() {
  return (
    <span
      aria-hidden="true"
...
export type DesignTextRowProps = {
  isEditable: boolean;
  isEdited: boolean;
  value: string;
  onReset: () => void;
...
export type DesignSectionGroupRowsProps = {
  dropdownPortalContainer?: HTMLElement | null;
...
export function DesignSectionGroupRows({
  dropdownPortalContainer,
...
export type DesignDragHandleProps = {
...
export function DesignDragHandle({
  editorState,
  onPointerCancel,
  onPointerDown,
  onPointerMove,
