...
// Partitions a conversation turn's raw items into the per-role buckets the
// thread renderer consumes (user / agent / assistant / tool-output / system
// event / diff / plan / elicitation / per-type metadata groups), and trims the
