...
import { n as E, r as D } from "./plan-pricing-DANGBAbm.js";
function O(e) {
  let t = (0, k.c)(18),
...
function N(e) {
  ...
  let h = m,
    ...
    w,
    T;
  if (c.kind === `saved_card_upgrade`) {
    let e;
    bb0: switch (c.updatedPlan) {
    ...
    let n;
    if (
      t[2] !== c.paymentMethod.card_brand ||
      t[3] !== c.paymentMethod.card_last4
    ) {
      let e = c.paymentMethod.card_brand?.trim() ?? ``,
        r;
      t[5] === c.paymentMethod.card_last4
        ? (r = t[6])
        : ((r = c.paymentMethod.card_last4?.trim() ?? ``),
          (t[5] = c.paymentMethod.card_last4),
          (t[6] = r));
      let i = r;
      ((n = e),
    ...
    t[11] !== l ||
    t[12] !== d.currency ||
    t[13] !== d.positive_line_item_total ||
    t[14] !== c.minorUnitExponent
      ? ((a = P(
          l,
          d.positive_line_item_total,
          d.currency,
          c.minorUnitExponent,
        )),
        (t[11] = l),
    ...
    let p;
    t[23] !== l ||
    t[24] !== d.amount_due.amount_excluding_tax ||
    t[25] !== d.amount_due.tax_amount ||
    t[26] !== d.currency ||
    t[27] !== c.minorUnitExponent
      ? ((p =
          d.amount_due.tax_amount > 0
            ? (0, I.jsxs)(I.Fragment, {
                children: [
                  (0, I.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, I.jsx)(`span`, {
                        children: P(
                          l,
                          d.amount_due.amount_excluding_tax,
                          d.currency,
                          c.minorUnitExponent,
                        ),
                      }),
        ...
        (t[28] = p))
      : (p = t[28]);
    let m = d.amount_due.tax_amount > 0 && `mt-2`,
      h;
    t[29] === m
      ? (h = t[30])
      : ((h = g(`flex justify-between gap-4 font-semibold`, m)),
        (t[29] = m),
        (t[30] = h));
    let _;
    ...
    let v;
    t[32] !== l ||
    t[33] !== d.amount_due.amount ||
    t[34] !== d.currency ||
    t[35] !== c.minorUnitExponent
      ? ((v = P(l, d.amount_due.amount, d.currency, c.minorUnitExponent)),
        (t[32] = l),
        (t[33] = d.amount_due.amount),
        (t[34] = d.currency),
        (t[35] = c.minorUnitExponent),
    ...
    let x;
    t[39] !== h || t[40] !== y
      ? ((x = (0, I.jsxs)(`div`, { className: h, children: [_, y] })),
        (t[39] = h),
        (t[40] = y),
        (t[41] = x))
      : (x = t[41]);
    ...
    t[44] === n
      ...
      : ((D = (0, I.jsxs)(`div`, {
        ...
        (t[45] = D));
    let O;
    (t[46] !== x || t[47] !== D || t[48] !== s || t[49] !== p
      ? ((O = (0, I.jsxs)(`div`, {
          className: `flex flex-col text-sm`,
          children: [s, u, f, p, x, S, D],
        })),
        (t[46] = x),
        (t[47] = D),
        (t[48] = s),
      ...
      (w = O));
    let k;
    (t[51] === d.amount_due.amount
      ? (k = t[52])
      : ((k =
          d.amount_due.amount > 0
            ? (0, I.jsx)(C, {
    ...
    t[53] !== l || t[54] !== s
      ? ((n =
          s == null
            ? null
            : E({
                amount: s.monthlyAmounts.prolite,
  ...
  t[70] === b
    ? (k = t[71])
    : ((k = (0, I.jsx)(p, {
        children: (0, I.jsx)(y, { title: O, subtitle: b }),
      })),
      (t[70] = b),
      (t[71] = k));
  let A;
  t[72] === w
    ? (A = t[73])
    : ((A = (0, I.jsx)(p, { children: w })), (t[72] = w), (t[73] = A));
  let j;
  ...
  t[75] !== n || t[76] !== r
    ...
    : (M = t[77]);
  let N;
  t[78] !== n || t[79] !== a || t[80] !== c.kind
    ? ((N =
        c.kind === `scheduled_downgrade`
          ? (0, I.jsx)(u, {
              color: `secondary`,
              disabled: n,
              type: `button`,
  ...
  t[85] !== M || t[86] !== N || t[87] !== L
    ? ((R = (0, I.jsx)(p, {
        children: (0, I.jsxs)(_, { children: [M, N, L] }),
      })),
      (t[85] = M),
      (t[86] = N),
      (t[87] = L),
    ...
    : (R = t[88]);
  let z;
  t[89] !== h || t[90] !== R || t[91] !== k || t[92] !== A
    ? ((z = (0, I.jsxs)(f, { as: `form`, onSubmit: h, children: [k, A, R] })),
      (t[89] = h),
      (t[90] = R),
      (t[91] = k),
      (t[92] = A),
...
//# sourceMappingURL=subscription-update-plan-C6ivP0af.js.map
