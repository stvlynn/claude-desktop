...
var p = class {
  ...
  m = {
    ...
    validation: { TreemapValidator: i(() => new p(), `TreemapValidator`) },
  };
function h(i = r) {
  let a = n(c(i), o),
    s = n(e({ shared: a }), t, m);
  return (a.ServiceRegistry.register(s), f(s), { shared: a, Treemap: s });
}
i(h, `createTreemapServices`);
export { h as n, m as t };
//# sourceMappingURL=chunk-LIHQZDEY-CgRZpBHs.js.map
