import { $ as e, it as t, tt as n } from "./runtime.worker-B4oXRaGJ.js";
function r(e) {
  if (e) throw e;
}
var i = e((e, t) => {
...
function o() {
  ...
  function n(...t) {
    ...
    function i(a, ...o) {
      ...
      for (; ++l < t.length; )
        (o[l] === null || o[l] === void 0) && (o[l] = t[l]);
      ((t = o), c ? s(c, i)(...o) : r(null, ...o));
    }
  }
  function r(n) {
...
((f.prototype.file = ``),
  ...
  (f.prototype.message = ``),
  (f.prototype.stack = ``),
  (f.prototype.column = void 0),
  (f.prototype.line = void 0),
  (f.prototype.ancestors = void 0),
  (f.prototype.cause = void 0),
  (f.prototype.fatal = void 0),
  (f.prototype.place = void 0),
  (f.prototype.ruleId = void 0),
  (f.prototype.source = void 0));
const p = { basename: m, dirname: h, extname: g, join: _, sep: `/` };
function m(e, t) {
...
function _(...e) {
  let t = -1,
    n;
  for (; ++t < e.length; )
    (b(e[t]), e[t] && (n = n === void 0 ? e[t] : n + `/` + e[t]));
  return n === void 0 ? `.` : v(n);
}
function v(e) {
  b(e);
...
const E = [`history`, `path`, `basename`, `stem`, `extname`, `dirname`];
var D = class {
  constructor(e) {
    let t;
    ((t = e
    ...
    let r;
    for (r in t) E.includes(r) || (this[r] = t[r]);
  }
  get basename() {
  ...
  set extname(e) {
    if ((O(e, `extname`), A(this.dirname, `extname`), e)) {
  ...
  set path(e) {
    (C(e) && (e = w(e)), k(e, `path`), this.path !== e && this.history.push(e));
  }
  get stem() {
...
function O(e, t) {
  if (e && e.includes(p.sep))
    throw Error("`" + t + "` cannot be a path: did not expect `" + p.sep + "`");
}
function k(e, t) {
...
const te = {}.hasOwnProperty,
  ne = new (class e extends j {
    ...
    copy() {
      ...
      return (t.data((0, M.default)(!0, {}, this.namespace)), t);
    }
    data(e, t) {
      return typeof e == `string`
        ? arguments.length === 2
          ? (F(`data`, this.frozen), (this.namespace[e] = t), this)
          : (te.call(this.namespace, e) && this.namespace[e]) || void 0
        : e
          ? (F(`data`, this.frozen), (this.namespace = e), this)
          : this.namespace;
    }
    freeze() {
    ...
    parse(e) {
      ...
      return (N(`parse`, n), n(String(t), t));
    }
    process(e, t) {
      let n = this;
      return (
        this.freeze(),
        N(`process`, this.parser || this.Parser),
        P(`process`, this.compiler || this.Compiler),
      ...
      function r(r, i) {
        ...
        n.run(o, a, function (e, t, r) {
          ...
          let i = t,
            a = n.stringify(i, r);
          (se(a) ? (r.value = a) : (r.result = a), s(e, r));
        });
        function s(e, n) {
    ...
    processSync(e) {
      ...
      return (
        this.freeze(),
        N(`processSync`, this.parser || this.Parser),
        P(`processSync`, this.compiler || this.Compiler),
        this.process(e, i),
        ie(`processSync`, `process`, t),
        n
      );
      function i(e, i) {
        ((t = !0), r(e), (n = i));
    ...
    runSync(e, t) {
      let n = !1,
        i;
      return (this.run(e, t, a), ie(`runSync`, `run`, n), i);
      function a(e, t) {
        (r(e), (i = t), (n = !0));
      }
    }
    stringify(e, t) {
      ...
      return (P(`stringify`, r), re(e), r(e, n));
    }
    use(e, ...t) {
      let n = this.attachers,
        r = this.namespace;
      if ((F(`use`, this.frozen), e != null))
        if (typeof e == `function`) c(e, t);
        else if (typeof e == `object`) Array.isArray(e) ? s(e) : o(e);
      ...
      function o(e) {
        ...
        (s(e.plugins),
          e.settings &&
            (r.settings = (0, M.default)(!0, r.settings, e.settings)));
      }
      function s(e) {
        let t = -1;
        if (e != null)
...
function de(e, t, n) {
  if (pe(e)) {
    ...
    if (`children` in e) return fe(e.children, t, n);
  }
  return Array.isArray(e) ? fe(e, t, n) : ``;
}
function fe(e, t, n) {
  let r = [],
    i = -1;
  for (; ++i < e.length; ) r[i] = de(e[i], t, n);
  return r.join(``);
}
function pe(e) {
  return !!(e && typeof e == `object`);
...
function _e(e) {
  let t = {},
    n = -1;
  for (; ++n < e.length; ) ve(t, e[n]);
  return t;
}
function ve(e, t) {
  let n;
  for (n in t) {
    let r = (ge.call(e, n) ? e[n] : void 0) || (e[n] = {}),
      i = t[n],
      a;
    if (i)
      for (a in i) {
...
function je(e) {
  ...
  function c(e) {
    if ((r++, t.containerState._closeFlow)) {
      ...
      return (
        I(t.events, a + 1, 0, t.events.slice(n)),
        (t.events.length = s),
        l(e)
      );
    }
...
const Pe = { name: `attention`, resolveAll: Fe, tokenize: Ie };
function Fe(e, t) {
  let n = -1,
    r,
    i,
      ...
      for (r = n; r--; )
        if (
          ...
          (Le(d, -c),
            ...
            (l = L(
              l,
              Ne(t.parser.constructs.insideSpan.null, e.slice(r + 1, n), t),
            )),
            (l = L(l, [
              [`exit`, a, t],
              [`enter`, s, t],
...
const Re = { name: `autolink`, tokenize: ze };
function ze(e, t, n) {
  let r = 0;
  return i;
  function i(t) {
...
const Be = { partial: !0, tokenize: Ve };
function Ve(e, t, n) {
  return r;
  function r(t) {
...
const Ke = { name: `characterEscape`, tokenize: qe };
function qe(e, t, n) {
  return r;
  function r(t) {
    return (
...
const Je = { name: `characterReference`, tokenize: Ye };
function Ye(e, t, n) {
  let r = this,
    i = 0,
    a,
  ...
  function c(t) {
    return t === 35
      ? (e.enter(`characterReferenceMarkerNumeric`),
        ...
        l)
      : (e.enter(`characterReferenceValue`), (a = 31), (o = B), u(t));
  }
  function l(t) {
    return t === 88 || t === 120
      ? (e.enter(`characterReferenceMarkerHexadecimal`),
        ...
        (o = we),
        u)
      : (e.enter(`characterReferenceValue`), (a = 7), (o = Ce), u(t));
  }
  function u(s) {
    if (s === 59 && i) {
      let i = e.exit(`characterReferenceValue`);
      return o === B && !he(r.sliceSerialize(i))
        ? n(s)
        : (e.enter(`characterReferenceMarker`),
          e.consume(s),
          e.exit(`characterReferenceMarker`),
...
const Xe = { partial: !0, tokenize: $e },
  Ze = { concrete: !0, name: `codeFenced`, tokenize: Qe };
function Qe(e, t, n) {
  let r = this,
    ...
    return t === s
      ...
      : o < 3
        ...
        : (e.exit(`codeFencedFenceSequence`),
          U(t) ? K(e, d, `whitespace`)(t) : d(t));
  }
  function d(n) {
    return n === null || V(n)
      ? (e.exit(`codeFencedFence`), r.interrupt ? t(n) : e.check(Xe, h, b)(n))
...
const et = { name: `codeIndented`, tokenize: nt },
  tt = { partial: !0, tokenize: rt };
function nt(e, t, n) {
  let r = this;
  return i;
  function i(t) {
...
const it = { name: `codeText`, previous: ot, resolve: at, tokenize: st };
function at(e) {
  let t = e.length - 4,
    n = 3,
    r,
...
var ct = class {
  ...
  pushMany(e) {
    (this.setCursor(1 / 0), lt(this.left, e));
  }
  unshift(e) {
...
function ut(e) {
  ...
  for (; ++n < u.length; ) {
    ...
    if (r[0] === `enter`)
      r[1].contentType && (Object.assign(t, dt(u, n)), (n = t[n]), (l = !0));
...
const ft = { resolve: mt, tokenize: ht },
  pt = { partial: !0, tokenize: gt };
function mt(e) {
  return (ut(e), e);
}
function ht(e, t) {
...
function vt(e, t, n, r, i, a) {
  ...
  function d(t) {
    return t === null || t === 91 || t === 93 || V(t) || s++ > 999
      ? (e.exit(`chunkString`), u(t))
      : (e.consume(t), (c ||= !U(t)), t === 92 ? f : d);
  }
  function f(t) {
...
function bt(e, t) {
  ...
  function r(i) {
    return V(i)
      ...
      : U(i)
        ? K(e, r, n ? `linePrefix` : `lineSuffix`)(i)
        : t(i);
  }
}
const xt = { name: `definition`, tokenize: Ct },
  St = { partial: !0, tokenize: wt };
function Ct(e, t, n) {
  let r = this,
    i;
  return a;
  ...
  function s(t) {
    return (
      (i = R(r.sliceSerialize(r.events[r.events.length - 1][1]).slice(1, -1))),
      t === 58
...
const Tt = { name: `hardBreakEscape`, tokenize: Et };
function Et(e, t, n) {
  return r;
  function r(t) {
...
const Dt = { name: `headingAtx`, resolve: Ot, tokenize: kt };
function Ot(e, t) {
  let n = e.length - 2,
    r = 3,
    i,
...
const At =
  ...
  jt = [`pre`, `script`, `style`, `textarea`],
  Mt = { concrete: !0, name: `htmlFlow`, resolveTo: Ft, tokenize: It },
  Nt = { partial: !0, tokenize: Rt },
  Pt = { partial: !0, tokenize: Lt };
function Ft(e) {
  let t = e.length;
...
function It(e, t, n) {
  ...
  function d(s) {
    return s === 33
      ...
      : s === 47
        ? (e.consume(s), (a = !0), h)
        : s === 63
          ? (e.consume(s), (i = 3), r.interrupt ? t : N)
          : z(s)
  ...
  function f(a) {
    return a === 45
      ...
      : a === 91
        ...
        : z(a)
          ? (e.consume(a), (i = 4), r.interrupt ? t : N)
          : n(a);
  }
  function p(i) {
  ...
  function g(s) {
    if (s === null || s === 47 || s === 62 || H(s)) {
      let c = s === 47,
        l = o.toLowerCase();
      return !c && !a && jt.includes(l)
        ? ((i = 1), r.interrupt ? t(s) : O(s))
        : At.includes(o.toLowerCase())
  ...
  function b(t) {
    return t === 45 || t === 46 || t === 58 || t === 95 || B(t)
      ? (e.consume(t), b)
      : x(t);
  }
  function x(t) {
        ...
        : t === 62 && i === 4
          ...
          : t === 63 && i === 3
            ...
            : t === 93 && i === 5
              ? (e.consume(t), ne)
              : V(t) && (i === 6 || i === 7)
                ? (e.exit(`htmlFlowData`), e.check(Nt, F, k)(t))
                : t === null || V(t)
                  ? (e.exit(`htmlFlowData`), k(t))
                  : (e.consume(t), O);
  }
  function k(t) {
    return e.check(Pt, A, F)(t);
  }
  function A(t) {
  ...
  function te(t) {
    if (t === 62) {
      let n = o.toLowerCase();
      return jt.includes(n) ? (e.consume(t), P) : O(t);
    }
    return z(t) && o.length < 8
      ? (e.consume(t), (o += String.fromCharCode(t)), te)
      : O(t);
  }
  function ne(t) {
...
const zt = { name: `htmlText`, tokenize: Bt };
function Bt(e, t, n) {
  let r = this,
    i,
    a,
...
const Vt = { name: `labelEnd`, resolveAll: Gt, resolveTo: Kt, tokenize: qt },
  Ht = { tokenize: Jt },
  Ut = { tokenize: Yt },
  Wt = { tokenize: Xt };
function Gt(e) {
...
function Kt(e, t) {
  ...
  return (
    ...
    (s = L(
      s,
      Ne(t.parser.constructs.insideSpan.null, e.slice(a + r + 4, o - 3), t),
    )),
...
function qt(e, t, n) {
    ...
    return a
      ? a._inactive
        ...
        : ((o = r.parser.defined.includes(
            R(r.sliceSerialize({ start: a.end, end: r.now() })),
          )),
          e.enter(`labelEnd`),
          e.enter(`labelMarker`),
          e.consume(t),
  ...
  function c(t) {
    return t === 40
      ? e.attempt(Ht, u, o ? u : d)(t)
      : t === 91
        ? e.attempt(Ut, u, o ? l : d)(t)
        : o
          ? u(t)
          : d(t);
  }
...
function Yt(e, t, n) {
  ...
  function a(e) {
    return r.parser.defined.includes(
      R(r.sliceSerialize(r.events[r.events.length - 1][1]).slice(1, -1)),
    )
      ? t(e)
      : n(e);
  }
...
const Zt = { name: `labelStartImage`, resolveAll: Vt.resolveAll, tokenize: Qt };
function Qt(e, t, n) {
  let r = this;
  return i;
  function i(t) {
...
const $t = { name: `labelStartLink`, resolveAll: Vt.resolveAll, tokenize: en };
function en(e, t, n) {
  let r = this;
  return i;
  function i(t) {
...
const tn = { name: `lineEnding`, tokenize: nn };
function nn(e, t) {
  return n;
  function n(n) {
    return (
...
const rn = { name: `thematicBreak`, tokenize: an };
function an(e, t, n) {
  let r = 0,
    i;
  return a;
...
const J = {
  ...
  on = { partial: !0, tokenize: fn },
  sn = { partial: !0, tokenize: un };
function cn(e, t, n) {
  let r = this,
    ...
    if (
      ...
      if (
        ...
        return (
          ...
          t === 42 || t === 45 ? e.check(rn, n, l)(t) : l(t)
        );
      if (!r.interrupt || t === 49)
  ...
  function l(t) {
    return (
      ...
      e.check(Be, r.interrupt ? n : u, e.attempt(on, f, d))
    );
  }
  function u(e) {
...
function ln(e, t, n) {
  ...
  function i(n) {
    return (
      ...
      K(e, t, `listItemIndent`, r.containerState.size + 1)(n)
    );
  }
  function a(n) {
    return r.containerState.furtherBlankLines || !U(n)
...
const pn = { name: `setextUnderline`, resolveTo: mn, tokenize: hn };
function mn(e, t) {
  let n = e.length,
    r,
    i,
  ...
  let t = this,
    n = e.attempt(
      ...
      e.attempt(
        ...
        K(
          e,
          e.attempt(this.parser.constructs.flow, i, e.attempt(ft, i)),
          `linePrefix`,
        ),
      ),
    );
...
const vn = { resolveAll: Sn() },
  yn = xn(`string`),
  bn = xn(`text`);
function xn(e) {
  return { resolveAll: Sn(e === `text` ? Cn : void 0), tokenize: t };
  function t(t) {
    let n = this,
...
function Pn(e, t, n) {
  ...
  function d(e) {
    return (
      ...
      g(),
      o[o.length - 1] === null
        ? (w(t, 0), (l.events = Ne(a, l.events, l)), l.events)
        : []
    );
  }
  function f(e, t) {
  ...
  function w(e, t) {
    (e.resolveAll && !a.includes(e) && a.push(e),
      e.resolve &&
        I(l.events, t, l.events.length - t, e.resolve(l.events.slice(t), l)),
...
function Un(e, t, n) {
  ...
  if (n.charCodeAt(0) === 35) {
    let e = n.charCodeAt(1),
      t = e === 120 || e === 88;
    return be(n.slice(t ? 2 : 1), t ? 16 : 10);
  }
  return he(n) || e;
}
...
function Kn(e) {
  ...
  function r(e) {
    ...
    for (l = -1; ++l < e.length; ) {
      let n = t[e[l][0]];
      Wn.call(n, e[l][1].type) &&
        n[e[l][1].type].call(
          Object.assign({ sliceSerialize: e[l][2].sliceSerialize }, a),
          e[l][1],
        );
    }
    if (a.tokenStack.length > 0) {
      let e = a.tokenStack[a.tokenStack.length - 1];
      (e[1] || Yn).call(a, void 0, e[0]);
    }
    for (
      r.position = {
        start: Y(
  ...
  function s(e, t, n) {
    (this.stack[this.stack.length - 1].children.push(e),
      ...
      (e.position = { start: Y(t.start), end: void 0 }));
  }
  function l(e) {
    return t;
    function t(t) {
  ...
  function u(e, t) {
    ...
    if (r)
      r[0].type !== e.type &&
        (t ? t.call(this, e, r[0]) : (r[1] || Yn).call(this, e, r[0]));
    else
      throw Error(
        "Cannot close `" +
          e.type +
    ...
    n.position.end = Y(e.end);
  }
  function d() {
    return ue(this.stack.pop());
  }
  function f() {
  ...
  function E(e) {
    ...
    ((!n || n.type !== `text`) &&
      ((n = we()),
      (n.position = { start: Y(e.start), end: void 0 }),
      t.push(n)),
      this.stack.push(n));
  }
  function D(e) {
    let t = this.stack.pop();
    ((t.value += this.sliceSerialize(e)), (t.position.end = Y(e.end)));
  }
  function O(e) {
    let n = this.stack[this.stack.length - 1];
    if (this.data.atHardBreak) {
      let t = n.children[n.children.length - 1];
      ((t.position.end = Y(e.end)), (this.data.atHardBreak = void 0));
      return;
    }
  ...
  function ae(e) {
    let t = this.resume(),
      n = this.stack[this.stack.length - 1];
    ((n.label = t),
      (n.identifier = R(this.sliceSerialize(e)).toLowerCase()),
  ...
  function se(e) {
    let t = this.sliceSerialize(e),
      ...
      r;
    n
      ? ((r = be(t, n === `characterReferenceMarkerNumeric` ? 10 : 16)),
...
const $n = function (e) {
  ...
  if (typeof e == `object`) return Array.isArray(e) ? er(e) : tr(e);
  if (typeof e == `string`) return nr(e);
...
function rr(e) {
  ...
  function t(t, n, r) {
    return !!(
      ar(t) && e.call(this, t, typeof n == `number` ? n : void 0, r || void 0)
    );
  }
}
function ir() {
...
function Tr(e, t, n, r, i) {
  ...
  if (
    !kr(i) ||
    (/^w/i.test(t) && ((n = t + n), (t = ``), (a = `http://`)), !Dr(n))
  )
    return !1;
  let o = Or(n + r);
  if (!o[0]) return !1;
...
function kr(e, t) {
  ...
  return (e.index === 0 || W(n) || Ee(n)) && (!t || n !== 47);
}
zr.peek = Rr;
function Ar() {
  this.buffer();
...
function Br() {
  return {
    enter: {
      gfmFootnoteCallString: Ar,
      gfmFootnoteCall: jr,
      gfmFootnoteDefinitionLabelString: Mr,
      gfmFootnoteDefinition: Nr,
    },
    exit: {
      gfmFootnoteCallString: Pr,
      gfmFootnoteCall: Fr,
      gfmFootnoteDefinitionLabelString: Ir,
      gfmFootnoteDefinition: Lr,
    },
  };
}
function Vr(e) {
  ...
  return (
    ...
    {
      handlers: { footnoteDefinition: n, footnoteReference: zr },
      unsafe: [
...
`
            : ` `) +
            r.indentLines(r.containerFlow(e, a.current()), t ? Ur : Hr),
        ))),
      s(),
      o
    );
...
function Kr() {
  return {
    unsafe: [{ character: `~`, inConstruct: `phrasing`, notInConstruct: Wr }],
    handlers: { delete: Yr },
  };
}
function qr(e) {
...
function Qr(e, t) {
  ...
  let d = -1;
  if (typeof r == `object` && `length` in r) for (; ++d < l; ) a[d] = ei(r[d]);
  else {
    let e = ei(r);
    for (; ++d < l; ) a[d] = e;
  }
...
function ti(e, t, n, r) {
  let i = n.enter(`blockquote`),
    a = n.createTracker(r);
  (a.move(`> `), a.shift(2));
  let o = n.indentLines(n.containerFlow(e, a.current()), ni);
  return (i(), o);
}
function ni(e, t, n) {
  return `>` + (n ? `` : ` `) + e;
...
function ri(e, t) {
  return ii(e, t.inConstruct, !0) && !ii(e, t.notInConstruct, !1);
}
function ii(e, t, n) {
...
function li(e, t, n, r) {
  ...
  if (si(e, n)) {
    let e = n.enter(`codeIndented`),
      t = n.indentLines(a, ui);
    return (e(), t);
  }
  let s = n.createTracker(r),
    c = i.repeat(Math.max(oi(a, i) + 1, 3)),
...
function gi(e, t, n, r) {
  let i = pi(n),
    ...
    l = c.charCodeAt(0),
    u = hi(r.before.charCodeAt(r.before.length - 1), l, i);
  u.inside && (c = mi(l) + c.slice(1));
  let d = c.charCodeAt(c.length - 1),
    f = hi(r.after.charCodeAt(0), d, i);
  f.inside && (c = c.slice(0, -1) + mi(d));
  let p = o.move(i);
  return (
    a(),
...
function yi(e, t) {
  ...
  return (
    ...
    !!((!e.depth || e.depth < 3) && ue(e) && (t.options.setext || n))
  );
}
function bi(e, t, n, r) {
...
`,
  ...
  return (
    /^[\t ]/.test(l) && (l = mi(l.charCodeAt(0)) + l.slice(1)),
    (l = l ? o + ` ` + l : o),
...
function Yi(e, t, n) {
  let r = (Li(n) + (n.options.ruleSpaces ? ` ` : ``)).repeat(Ji(n));
...
function Zi() {
  return {
    enter: { table: Qi, tableData: na, tableHeader: na, tableRow: ea },
    exit: {
      codeText: ra,
      table: $i,
      tableData: ta,
...
`),
  ...
  function l(e, t) {
    return Qr(e, { align: t, alignDelimiters: r, padding: n, stringLength: i });
  }
  function u(e, t, n) {
    let r = e.children,
      i = -1,
...
function ua(e, t, n, r) {
  let i = e.children[0],
    ...
    s = n.createTracker(r);
  a && s.move(o);
  let c = Xi.listItem(e, t, n, { ...r, ...s.current() });
...
function da() {
  return [gr(), Br(), Gr(), Zi(), oa()];
}
function fa(e) {
  return { extensions: [_r(), Vr(e), Kr(), aa(e), sa()] };
}
const pa = { tokenize: wa, partial: !0 },
  ma = { tokenize: Ta, partial: !0 },
  ha = { tokenize: Ea, partial: !0 },
  ga = { tokenize: Da, partial: !0 },
  _a = { tokenize: Oa, partial: !0 },
  va = { name: `wwwAutolink`, tokenize: Sa, previous: ka },
  ya = { name: `protocolAutolink`, tokenize: Ca, previous: Aa },
  X = { name: `emailAutolink`, tokenize: xa, previous: ja },
  Z = {};
function ba() {
  return { text: Z };
}
let Q = 48;
for (; Q < 123; ) ((Z[Q] = X), Q++, Q === 58 ? (Q = 65) : Q === 91 && (Q = 97));
((Z[43] = X),
  (Z[45] = X),
  (Z[46] = X),
  (Z[95] = X),
...
function xa(e, t, n) {
  ...
  return o;
  function o(t) {
    return !Ma(t) || !ja.call(r, r.previous) || Na(r.events)
      ? n(t)
      : (e.enter(`literalAutolink`), e.enter(`literalAutolinkEmail`), s(t));
  }
  function s(t) {
    return Ma(t) ? (e.consume(t), s) : t === 64 ? (e.consume(t), c) : n(t);
  }
  function c(t) {
    return t === 46
      ? e.check(_a, u, l)(t)
...
function Sa(e, t, n) {
  ...
  return i;
  function i(t) {
    return (t !== 87 && t !== 119) || !ka.call(r, r.previous) || Na(r.events)
      ? n(t)
      : (e.enter(`literalAutolink`),
        e.enter(`literalAutolinkWww`),
        e.check(pa, e.attempt(ma, e.attempt(ha, a), n), n)(t));
  }
  function a(n) {
...
function Ca(e, t, n) {
  ...
  return o;
  function o(t) {
    return (t === 72 || t === 104) && Aa.call(r, r.previous) && !Na(r.events)
      ? (e.enter(`literalAutolink`),
  ...
  function l(t) {
    return t === null || Se(t) || H(t) || W(t) || Ee(t)
      ? n(t)
      : e.attempt(ma, e.attempt(ha, u), n)(t);
  }
  function u(n) {
...
const Pa = { tokenize: Ha, partial: !0 };
function Fa() {
  return {
    document: {
      91: {
        ...
        tokenize: za,
        continuation: { tokenize: Ba },
        exit: Va,
      },
    },
    text: {
      91: { name: `gfmFootnoteCall`, tokenize: Ra },
      93: {
...
function Ia(e, t, n) {
  ...
  function s(i) {
    ...
    let s = R(r.sliceSerialize({ start: o.end, end: r.now() }));
...
function Ra(e, t, n) {
  ...
  function l(s) {
    if (a > 999 || (s === 93 && !o) || s === null || s === 91 || H(s))
      return n(s);
    if (s === 93) {
      e.exit(`chunkString`);
      let a = e.exit(`gfmFootnoteCallString`);
      return i.includes(R(r.sliceSerialize(a)))
        ? (e.enter(`gfmFootnoteCallLabelMarker`),
          e.consume(s),
          e.exit(`gfmFootnoteCallLabelMarker`),
    ...
    return (H(s) || (o = !0), a++, e.consume(s), s === 92 ? u : l);
  }
  function u(t) {
...
function za(e, t, n) {
  ...
  function u(t) {
    if (o > 999 || (t === 93 && !s) || t === null || t === 91 || H(t))
      return n(t);
    if (t === 93) {
      e.exit(`chunkString`);
      let n = e.exit(`gfmFootnoteDefinitionLabelString`);
      return (
        (a = R(r.sliceSerialize(n))),
        e.enter(`gfmFootnoteDefinitionLabelMarker`),
        e.consume(t),
        e.exit(`gfmFootnoteDefinitionLabelMarker`),
    ...
    return (H(t) || (s = !0), o++, e.consume(t), t === 92 ? d : u);
  }
  function d(t) {
  ...
  function f(t) {
    return t === 58
      ? (e.enter(`definitionMarker`),
        ...
        K(e, p, `gfmFootnoteDefinitionWhitespace`))
      : n(t);
  }
  function p(e) {
    return t(e);
...
function Ba(e, t, n) {
  return e.check(Be, t, e.attempt(Pa, t, n));
}
function Va(e) {
      ...
      if (
        ...
        for (; r--; )
          if (
            ...
            (s && I(o, o.length, 0, Ne(s, e.slice(r + 1, n), t)),
              I(o, o.length, 0, [
                [`exit`, a, t],
                [`enter`, e[n][1], t],
                [`exit`, e[n][1], t],
...
function qa() {
  return { flow: { null: { name: `table`, tokenize: Ja, resolveAll: Ya } } };
}
function Ja(e, t, n) {
  let r = this,
    i = 0,
...
function Ya(e, t) {
    ...
    p[0] === `enter`
      ...
      : m.type === `tableHead`
        ...
        : m.type === `tableRow` || m.type === `tableDelimiterRow`
          ? ((c = n),
            a[1] === 0
              ? o[1] !== 0 && (d = Xa(f, t, o, i, n, d))
              : ((o[0] = o[1]), (d = Xa(f, t, a, i, n, d))),
            (i = 0))
          : i &&
            (m.type === `data` ||
              m.type === `tableDelimiterMarker` ||
  ...
  for (
    c !== 0 && Za(f, t, c, l, u), f.consume(t.events), n = -1;
    ++n < t.events.length;
...
const Qa = { name: `tasklistCheck`, tokenize: eo };
function $a() {
  return { text: { 91: Qa } };
}
function eo(e, t, n) {
  ...
  function s(r) {
    return V(r) ? t(r) : U(r) ? e.check({ tokenize: to }, t, n)(r) : n(r);
  }
}
function to(e, t, n) {
...
function io(e) {
  ...
  (i.push(no(n)), a.push(da()), o.push(fa(n)));
}
const ao = `Markdown table`,
  oo = /\\|\/|\?|\*|\[|\]|:/g,
  so = /<br\s*\/?>/gi,
  co = `BPS_TABLE_BR_PLACEHOLDER`,
  lo = /:{1,3}contentReference\[[^\]]+\](?:\{[^}]*\})?/g,
  uo = /\u200b/g,
  fo = ne().use(Xn).use(io);
function po(e) {
  return ((e ?? ao).trim().replace(oo, ``).trim() || ao).slice(0, 31);
}
function mo(e) {
  return e.replace(so, co);
}
function ho(e) {
  return e
    .replace(/\u00a0/g, ` `)
...
function go(e) {
  let t = fo.parse(mo(e)).children.find((e) => e.type === `table`);
  if (!t)
    throw Error(`Unable to build workbook: no markdown table rows found.`);
  let n = [];
  for (let e of t.children) {
    let t = e.children.map((e) => ho(ue(e)));
...
export { _o as buildTableValuesFromMarkdown, po as sanitizeSheetName };
//# sourceMappingURL=workbook-from-markdown-6t79Mo_W.js.map
