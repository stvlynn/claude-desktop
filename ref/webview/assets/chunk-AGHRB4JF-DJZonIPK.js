...
var r = n((e, t) => {
  ...
  f = e(() => {
    ((i = t(r(), 1)),
      ...
      (o = (e, t) => a(e, `name`, { value: t, configurable: !0 })),
      (s = (e, t) => {
        for (var n in t) a(e, n, { get: t[n], enumerable: !0 });
      }),
      (c = { trace: 0, debug: 1, info: 2, warn: 3, error: 4, fatal: 5 }),
      (l = {
        trace: o((...e) => {}, `trace`),
        debug: o((...e) => {}, `debug`),
        info: o((...e) => {}, `info`),
      ...
      (u = o(function (e = `fatal`) {
        let t = c.fatal;
        (typeof e == `string`
          ? e.toLowerCase() in c && (t = c[e])
          : typeof e == `number` && (t = e),
          (l.trace = () => {}),
          (l.debug = () => {}),
          (l.info = () => {}),
          ...
          (l.fatal = () => {}),
          t <= c.fatal &&
            (l.fatal = console.error
              ? console.error.bind(console, d(`FATAL`), `color: orange`)
              : console.log.bind(console, `\x1B[35m`, d(`FATAL`))),
          t <= c.error &&
            (l.error = console.error
              ? console.error.bind(console, d(`ERROR`), `color: orange`)
              : console.log.bind(console, `\x1B[31m`, d(`ERROR`))),
          t <= c.warn &&
            (l.warn = console.warn
              ? console.warn.bind(console, d(`WARN`), `color: orange`)
              : console.log.bind(console, `\x1B[33m`, d(`WARN`))),
          t <= c.info &&
            (l.info = console.info
              ? console.info.bind(console, d(`INFO`), `color: lightblue`)
              : console.log.bind(console, `\x1B[34m`, d(`INFO`))),
          t <= c.debug &&
            (l.debug = console.debug
              ? console.debug.bind(console, d(`DEBUG`), `color: lightgreen`)
              : console.log.bind(console, `\x1B[32m`, d(`DEBUG`))),
          t <= c.trace &&
            (l.trace = console.debug
              ? console.debug.bind(console, d(`TRACE`), `color: lightgreen`)
              : console.log.bind(console, `\x1B[32m`, d(`TRACE`))));
      }, `setLogLevel`)),
      (d = o(
        (e) => `%c${(0, i.default)().format(`ss.SSS`)} : ${e} : `,
        `format`,
      )));
  });
export { u as a, l as i, o as n, r as o, f as r, s as t };
//# sourceMappingURL=chunk-AGHRB4JF-DJZonIPK.js.map
