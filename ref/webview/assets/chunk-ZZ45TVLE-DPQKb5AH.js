...
import { A as r, b as i, d as a } from "./chunk-ICPOFSXX-CPupJSsJ.js";
import { p as o, u as s } from "./chunk-5PVQY5BW-Qrvqj614.js";
async function c(e, n) {
  let r = e.getElementsByTagName(`img`);
  if (!r || r.length === 0) return;
  let s = n.replace(/<img[^>]*>/g, ``).trim() === ``;
  await Promise.all(
    [...r].map(
      (e) =>
        new Promise((n) => {
...
var l,
  u = e(() => {
    (s(),
      ...
      t(c, `configureLabelImages`));
  });
export { l as n, u as r, c as t };
//# sourceMappingURL=chunk-ZZ45TVLE-DPQKb5AH.js.map
