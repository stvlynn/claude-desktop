...
import { i as S, n as C, r as w, t as T } from "./src-BpCf56JJ.js";
import { t as E } from "./dist-D71-f2X0.js";
import { i as D, n as O, o as k, r as A } from "./chunk-AGHRB4JF-GvfWLS3X.js";
import {
  A as j,
  C as M,
  G as ee,
...
import { g as ce, u as le } from "./chunk-5PVQY5BW-Qrvqj614.js";
var ue = n((e, t) => {
    (function (n, r) {
    ...
    (Tt = {
      ...
      renderer: {
        ...
        draw: O(function (e, t, n, u) {
          ...
          ((Q = v.parentElement.offsetWidth),
            Q === void 0 && (Q = 1200),
            d.useWidth !== void 0 && (Q = d.useWidth));
          let T = u.db.getTasks(),
            E = [];
          ...
          if (
            ...
            for (let n of Object.keys(e)) {
              let r = wt(e[n], t) + 1;
              ((t += r), (A += r * (d.barHeight + d.barGap)), (k[n] = r));
            }
          } else {
            A += T.length * (d.barHeight + d.barGap);
            for (let e of E) k[e] = T.filter((t) => t.type === e).length;
          }
          v.setAttribute(`viewBox`, `0 0 ` + Q + ` ` + A);
          let j = h.select(`[id="${t}"]`),
            M = c()
              .domain([
                a(T, function (e) {
              ...
              .rangeRound([0, Q - d.leftPadding - d.rightPadding]);
          function ee(e, t) {
            let n = e.startTime,
              r = t.startTime,
              i = 0;
          ...
          function ne(e, n, r, i, a, o, s) {
            ...
            j.append(`g`)
              ...
              .enter();
            let l = j.append(`g`).selectAll(`rect`).data(e).enter(),
              f = u.db.getLinks();
            if (
              (l
                .append(`rect`)
                ...
                .attr(`height`, function (e) {
                  return e.vert
                    ? T.length * (d.barHeight + d.barGap) + d.barHeight * 2
                    : a;
                })
          ...
          function re(e, n, r, i, a, o, s, c) {
            ...
            for (let { startTime: e, endTime: t } of o)
              ((l === void 0 || e < l) && (l = e),
                (f === void 0 || t > f) && (f = t));
            if (!l || !f) return;
            if ((0, F.default)(f).diff((0, F.default)(l), `year`) > 5) {
              D.warn(
                `The difference between the min and max time is more than 5 years. This will cause performance issues. Skipping drawing exclude days.`,
              );
              return;
            }
            let p = u.db.getDateFormat(),
              m = [],
              h = null,
              g = (0, F.default)(l);
            for (; g.valueOf() <= f; )
              (u.db.isInvalidDate(g, p, s, c)
                ? h
                  ? (h.end = g)
                  : (h = { start: g, end: g })
                : (h &&= (m.push(h), null)),
            ...
            j.append(`g`)
              ...
              .attr(`height`, a - n - d.gridLineStartPadding)
...
//# sourceMappingURL=ganttDiagram-T4ZO3ILL-C4QX71ey.js.map
