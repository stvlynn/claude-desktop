const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      ...
      "./middleware-CVKpk5Wn.js",
      "./middleware-m1mRm6yO.js",
      "./query-string-rxmEnTXH.js",
      "./gracefulDecodeURIComponent-BpW7JPKu.js",
      "./routing-middleware-DNnHn-sA.js",
      "./ajs-destination-BeM_T5LQ.js",
      "./metric-helpers-DG5zp00d.js",
      "./load-script-BifiZc4M.js",
      "./is-plan-event-enabled-Bmz4BLlB.js",
      "./legacy-video-plugins-BzriPR2f.js",
      "./schema-filter-Dzj5Tjvi.js",
      "./remote-middleware-PCES0C24.js",
    ]),
) => i.map((i) => d[i]);
...
import {
  ...
  v as w,
  y as T,
} from "./esm-Bs7-NtHW.js";
import { n as ee, t as E } from "./gracefulDecodeURIComponent-BpW7JPKu.js";
import {
  c as te,
  d as ne,
  i as re,
...
import {
  ...
  t as ge,
  u as A,
} from "./metric-helpers-DG5zp00d.js";
import {
  _ as _e,
  a as ve,
  b as ye,
...
function ln(e, t, n) {
  ...
  function m(i) {
    return r(this, void 0, void 0, function () {
      ...
      return l(this, function (l) {
        return O()
          ? (a.push(i), J(s, a, h, J), [2, i])
          : (o.add(i),
            (r = i.event.type.charAt(0)),
            (c = ve(i.event).json()),
            i.event.type === `track` && delete c.traits,
            i.event.type === `alias` && (c = cn(e, c)),
            a.getAttempts(i) >= a.maxAttempts
              ? (o.delete(i), [2, i])
              : [
                  2,
                  p
                    .dispatch(`${d}/${r}`, rn(e, c, t, n, i))
                    .then(function () {
                      return i;
                    })
                    .catch(function (e) {
  ...
  var h = {
    metadata: { writeKey: i, apiHost: c, protocol: u },
    name: `Segment.io`,
    type: `destination`,
    version: `0.1.0`,
    isLoaded: function () {
                ...
                return (
                  ...
                  [
                    ...
                    this._dispatch(s, o).then(function (e) {
                      return (
                        c.emit(`track`, r, e.event.properties, e.event.options),
                        e
                      );
                    }),
                  ]
              ...
              return l(this, function (l) {
                return (
                  ...
                  [
                    2,
                    this._dispatch(s, o).then(function (e) {
                      return (c.emit(`alias`, r, i, e.event.options), e);
                    }),
                  ]
                );
              });
              ...
              return l(this, function (i) {
                switch (i.label) {
                  ...
                  case 1:
                    return (
                      (t = i.sent()),
                      [2, (r = t.link).call.apply(r, c([this], e, !1))]
                    );
                }
              });
            });
              ...
              return l(this, function (i) {
                switch (i.label) {
                  ...
                  case 1:
                    return (
                      (t = i.sent()),
                      [2, (r = t.form).call.apply(r, c([this], e, !1))]
                    );
                }
              });
            });
                  ...
                  case 0:
                    return this.options.useQueryString === !1
                      ...
                      : [
                          4,
                          n(
                            () => import(`./query-string-rxmEnTXH.js`),
      ...
      switch (c.label) {
        case 0:
          ...
          ((i = e.url.split(`/`)),
            ...
            (c.label = 1));
        case 1:
          return (c.trys.push([1, 3, , 5]), [4, ie(o.replace(n, r))]);
        case 2:
          return (c.sent(), [3, 5]);
        case 3:
          return (c.sent(), [4, ie(e.url.replace(n, r))]);
        case 4:
          return (c.sent(), [3, 5]);
        case 5:
          return [3, 8];
                  ...
                  switch (l.label) {
                    ...
                    case 3:
                      return (
                        (r = d),
                        r
                          ? ((f = n[e.name]), [4, r(o(o({}, e.settings), f))])
                          : [3, 5]
                      );
                    case 4:
                      ((p = l.sent()),
    ...
    r(this, void 0, void 0, function () {
      ...
      return l(this, function (E) {
        switch (E.label) {
            ...
            return (
              ...
              Hn(t)
                ? [
                    ...
                    n(
                      () =>
                        import(`./routing-middleware-DNnHn-sA.js`).then(
                          function (e) {
            ...
            return (
              ...
              Vn(t) || s.length > 0
                ? [
                    ...
                    n(
                      () =>
                        import(`./ajs-destination-BeM_T5LQ.js`).then(
                          function (n) {
            ...
            return (
              ...
              t.legacyVideoPluginsEnabled
                ? [
                    ...
                    n(
                      () =>
                        import(`./legacy-video-plugins-BzriPR2f.js`).then(
                          function (e) {
          ...
          case 8:
            return a.plan?.track
              ? [
                  ...
                  n(
                    () =>
                      import(`./schema-filter-Dzj5Tjvi.js`).then(function (e) {
          ...
          case 14:
            return [4, i.register.apply(i, c(c([], x, !1), d, !1))];
          case 15:
            ...
            return (
              ...
              Object.entries(t.enabledMiddleware ?? {}).some(function (e) {
                ...
                ? [
                    ...
                    n(
                      () =>
                        import(`./remote-middleware-PCES0C24.js`).then(
                          function (e) {
                            var n = e.remoteMiddlewares;
                            return r(ee, void 0, void 0, function () {
                              var e, r;
                              return l(this, function (o) {
                                switch (o.label) {
                                  case 0:
    ...
    r(this, void 0, void 0, function () {
      ...
      return l(this, function (l) {
        switch (l.label) {
          case 0:
            return t.disable === !0
              ...
              : (t.globalAnalyticsKey && ne(t.globalAnalyticsKey),
                ...
                (r = qn()),
                (a = e.cdnURL ?? re()),
                (i = e.cdnSettings) == null ? [3, 1] : ((c = i), [3, 3]));
          case 1:
          ...
          case 4:
            if (((u = l.sent()), u)) return [2, [new Q(), M.system()]];
            l.label = 5;
          case 5:
            return (
              (d = s.integrations[`Segment.io`]?.retryQueue ?? !0),
              (t = o({ retryQueue: d }, t)),
              (f = new Z(o(o({}, e), { cdnSettings: s, cdnURL: a }), t)),
              Rn(f),
              (p = e.plugins ?? []),
...
//# sourceMappingURL=pkg-DjWRq9pR.js.map
