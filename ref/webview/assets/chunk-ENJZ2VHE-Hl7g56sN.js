...
import { n as g, t as ee } from "./rough.esm-BmcJJgrn.js";
import { i as _, n as v, r as y } from "./chunk-AGHRB4JF-DVNPU_Qo.js";
import { A as b, b as x, w as S, y as C } from "./chunk-ICPOFSXX-CeJdw7BH.js";
import { g as w, l as te, u as ne } from "./chunk-5PVQY5BW-MckrTAit.js";
import { i as T, n as E } from "./chunk-U2HBQHQK-BfxUGRAz.js";
import {
  a as D,
  i as O,
  n as re,
  r as k,
  t as A,
} from "./chunk-BSJP7CBP-CrJpo2xF.js";
import { n as j, r as M } from "./chunk-ZZ45TVLE-DzHSn4eK.js";
import { a as N, n as P, r as ie } from "./chunk-X2U36JSP-sSeN7Tix.js";
import { i as ae, r as F } from "./chunk-5FUZZQ4R-B3jI2rZu.js";
function I(e, t) {
  S(x()) &&
    e &&
      ...
      (ue = v(function (e, h, g, v, y, b, S, C = !1) {
        ...
        (_.debug(`UIO intersect check`, h.points, k.x, O.x),
          k.intersect &&
            O.intersect &&
            !C &&
            ((T = T.slice(1, h.points.length - 1)),
            T.unshift(O.intersect(T[0])),
            _.debug(
              `Last point UIO`,
              h.start,
              `-->`,
              ...
              T[T.length - 1],
              k,
              k.intersect(T[T.length - 1]),
            ),
            T.push(k.intersect(T[T.length - 1]))));
        let j = btoa(JSON.stringify(T));
        (h.toCluster &&
          (_.info(`to cluster abc88`, g.get(h.toCluster)),
          (T = Q(h.points, g.get(h.toCluster).node)),
          (E = !0)),
          h.fromCluster &&
            (_.debug(
              `from cluster abc88`,
            ...
            (T = Q(T.reverse(), g.get(h.fromCluster).node).reverse()),
            (E = !0)));
        let M = T.filter((e) => !Number.isNaN(e.y)),
          N = oe(h.curve);
        N !== `rounded` && (M = ce(M));
        let P = i;
        switch (N) {
        ...
        if (h.look === `handDrawn`) {
          let t = ee.svg(e);
          Object.assign([], M);
          let n = t.path(H, { roughness: 0.3, seed: ne });
          ((L += ` transition`),
            (z = m(n)
              .select(`path`)
              .attr(`id`, `${S}-${h.id}`)
          ...
          let i = z.node(),
            ...
            o = D[h.arrowTypeStart] || 0,
            s = D[h.arrowTypeEnd] || 0;
          if (h.look === `neo` && !K) {
        ...
        let J = !K && h?.look === `neo`;
        V(z, h, q, S, v, J, W);
        let Y = Math.floor(T.length / 2),
          X = T[Y];
        w.isLabelCoordinateInPath(X, z.attr(`d`)) || (E = !0);
        let Z = {};
        return (E && (Z.updatedPath = T), (Z.originalPath = h.points), Z);
      }, `insertEdge`)),
...
//# sourceMappingURL=chunk-ENJZ2VHE-Hl7g56sN.js.map
