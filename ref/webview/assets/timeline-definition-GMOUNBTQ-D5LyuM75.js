...
import { f as i } from "./chunk-5PVQY5BW-DEldFBPA.js";
import { A as a } from "./runtime.worker-1YasDKq2.js";
import {
  $ as o,
  K as s,
  Q as c,
...
import { t as m } from "./chunk-426QAEUC-DSM9qwar.js";
...
` +
  ...
  return (n(d, `Parser`), (d.prototype = u), (u.Parser = d), new d());
})();
h.parser = h;
var g = h,
  _ = {};
...
var v = ``,
  ...
  w = n(() => d, `getCommonDb`),
  T = n(function () {
    ((x.length = 0), (S.length = 0), (v = ``), (C.length = 0), (b = `LR`), l());
  }, `clear`),
  E = n(function (e) {
    b = e;
  }, `setDirection`),
  ...
  N = n(function (e) {
    let t = { section: v, type: v, description: e, task: e, classes: [] };
    S.push(t);
  }, `addTaskOrg`),
  P = n(function () {
    let e = n(function (e) {
  ...
  te = n(function (e, t) {
    ...
    return (
      n(c, `ambivalent`),
      t.score > 3 ? o(i) : t.score < 3 ? s(i) : c(i),
      r
    );
  }, `drawFace`),
  ne = n(function (e, t) {
  ...
  e.each(function () {
    ...
    for (let r = 0; r < n.length; r++)
      ((i = n[n.length - 1 - r]),
        a.push(i),
        l.text(a.join(` `).trim()),
        (l.node().getComputedTextLength() > t || i === `<br>`) &&
          (a.pop(),
          l.text(a.join(` `).trim()),
          (a = i === `<br>` ? [``] : [i]),
          (l = e
...
n(H, `wrap`);
var ce = n(function (e, t, n, i, a, o = !1) {
    let { theme: s, look: c } = i,
      l = s?.includes(`redux`),
      u = (n % (i?.themeVariables?.THEME_COLOR_LIMIT ?? 12)) - 1,
      d = e.append(`g`);
    ((t.section = u),
      d.attr(
        `class`,
    ...
    let f = d.append(`g`),
      ...
      m = p
        ...
        .node()
        .getBBox(),
      h = i.fontSize?.replace ? i.fontSize.replace(`px`, ``) : i.fontSize;
    if (
      ...
      l &&
        p.attr(
          `transform`,
          `translate(${t.width / 2}, ${o ? t.padding / 2 + 3 : t.padding})`,
        ),
      ue(f, t, u, a, i),
      c === `neo` && (d.attr(`data-look`, `neo`), l))
    ) {
      let t = s.includes(`dark`),
        n = r(e.node()?.ownerSVGElement ?? e.node()),
        i = n.attr(`id`) ?? ``,
        a = i ? `${i}-drop-shadow` : `drop-shadow`;
      if (n.select(`#${a}`).empty()) {
        let e = n.select(`defs`);
  ...
  de = n(function (t, n, i, a) {
    let o = u(),
      { look: c, theme: l, themeVariables: d } = o,
      { useGradient: f, gradientStart: p, gradientStop: m } = d,
      h = o.timeline?.leftMargin ?? 50;
    e.debug(`timeline`, a.db);
    let g = o.securityLevel,
      _;
    g === `sandbox` && (_ = r(`#i` + n));
    let v = r(
      g === `sandbox` ? _.nodes()[0].contentDocument.body : `body`,
    ).select(`#` + n);
    v.append(`g`);
    let y = a.db.getTasks(),
      b = a.db.getCommonDb().getDiagramTitle();
    ...
    for (let [t, n] of y.entries()) {
      let r = {
        ...
        i = U.getVirtualNodeHeight(v, r, o);
      (e.debug(`taskHeight before draw`, i),
        (C = Math.max(C, i + 20)),
        (A = Math.max(A, n.events.length)));
      let a = 0;
      for (let e of n.events) {
        ...
        a += U.getVirtualNodeHeight(v, t, o);
      }
      (n.events.length > 0 && (a += (n.events.length - 1) * 10),
        (j = Math.max(j, a)));
    }
    (e.debug(`maxSectionHeight before draw`, S),
      e.debug(`maxTaskHeight before draw`, C),
      x && x.length > 0
        ? x.forEach((t) => {
            let r = y.filter((e) => e.section === t),
              i = {
                number: O,
                descr: t,
                section: O,
            ...
            let a = v.append(`g`),
              s = U.drawNode(a, i, O, o, n);
            (e.debug(`sectionNode output`, s),
              a.attr(`transform`, `translate(${E}, ${T})`),
              (D += S + 50),
              r.length > 0 && W(v, r, O, E, D, C, o, A, j, S, !1, n),
              (E += 200 * Math.max(r.length, 1)),
              (D = T),
              O++);
          })
    ...
    if (
      ...
      b &&
        v
          .append(`text`)
          .text(b)
          .attr(`x`, c === `neo` ? M.x * 2 + h : M.width / 2 - h)
          .attr(`font-size`, `4ex`)
      ...
      v
        ...
        .attr(`stroke-width`, 4)
        .attr(`stroke`, `black`)
        .attr(`marker-end`, `url(#${n}-arrowhead)`),
      c === `neo` && f && l !== `neutral`)
    ) {
      let e = v.select(`defs`),
    ...
    s(void 0, v, o.timeline?.padding ?? 50, o.timeline?.useMaxWidth ?? !1);
  }, `draw`),
  W = n(function (t, n, r, i, a, o, s, c, l, u, d, f) {
    for (let c of n) {
      let n = {
        descr: c.task,
        section: r,
      ...
      let u = t.append(`g`).attr(`class`, `taskWrapper`),
        p = U.drawNode(u, n, r, s, f).height;
      if (
        (e.debug(`taskHeight after draw`, p),
        u.attr(`transform`, `translate(${i}, ${a})`),
        (o = Math.max(o, p)),
        c.events)
      ) {
  ...
  fe = n(function (t, n, r, i, a, o, s) {
    ...
    for (let l of n) {
      ...
      e.debug(`eventNode`, n);
      let u = t.append(`g`).attr(`class`, `eventWrapper`),
        d = U.drawNode(u, n, r, o, s, !0).height;
      ((c += d),
        u.attr(`transform`, `translate(${i}, ${a})`),
        (a = a + 10 + d));
    }
  ...
  Z = 30,
  Q = 50,
  _e = n(function (t, n, r, a) {
    let o = u(),
      c = o.timeline?.leftMargin ?? 50;
    e.debug(`timeline`, a.db);
    let l = m(n);
    l.append(`g`);
    let d = a.db.getTasks(),
      f = a.db.getCommonDb().getDiagramTitle();
    (e.debug(`task`, d), U.initGraphics(l));
    let p = a.db.getSections();
    e.debug(`sections`, p);
    let h = 0,
      g = 0,
      _ = 50 + c,
    ...
    for (let [t, n] of d.entries()) {
      let r = {
        ...
        i = U.getVirtualNodeHeight(l, r, o);
      ...
      for (let e of n.events) {
        ...
        a += U.getVirtualNodeHeight(l, t, o);
      }
      (n.events.length > 0 && (a += (n.events.length - 1) * J),
        (O = Math.max(O, a) + ge));
    }
    (e.debug(`maxSectionHeight before draw`, h),
      e.debug(`maxTaskHeight before draw`, g));
    let k = Math.max(g, O) + Z;
    T
      ? p.forEach((t) => {
          let n = d.filter((e) => e.section === t),
            r = {
              number: w,
              descr: t,
              section: w,
    ...
    let [j] = i(o.fontSize),
      M = (j ?? 16) * 2,
      N = (j ?? 16) * 0.5 + 20,
      P = l.append(`g`).attr(`class`, `lineWrapper`);
    (P.append(`line`)
      .attr(`x1`, E)
      .attr(`y1`, y - M)
      .attr(`x2`, E)
      ...
      P.lower(),
      s(void 0, l, o.timeline?.padding ?? 50, o.timeline?.useMaxWidth ?? !1));
  }, `draw`),
  $ = n(function (t, n, r, i, a, o, s, c, l) {
    for (let u of n) {
      let n = {
        descr: u.task,
        section: r,
      ...
      let d = t.append(`g`).attr(`class`, `taskWrapper`),
        f = U.drawNode(d, n, r, s),
        p = f.height;
      e.debug(`taskHeight after draw`, p);
      let m = i - X - f.width;
      if (
        (d.attr(`transform`, `translate(${m}, ${a})`),
        (o = Math.max(o, p)),
  ...
  ve = n(function (t, n, r, i, a, o, s) {
    ...
    for (let o of n) {
      ...
      e.debug(`eventNode`, n);
      let l = t.append(`g`).attr(`class`, `eventWrapper`),
        u = U.drawNode(l, n, r, s).height;
    ...
    for (let t = 0; t < e.THEME_COLOR_LIMIT; t++)
      ((e[`lineColor` + t] = e[`lineColor` + t] || e[`cScaleInv` + t]),
        f(e[`lineColor` + t])
          ...
          : (e[`lineColor` + t] = c(e[`lineColor` + t], 20)));
...
//# sourceMappingURL=timeline-definition-GMOUNBTQ-D5LyuM75.js.map
