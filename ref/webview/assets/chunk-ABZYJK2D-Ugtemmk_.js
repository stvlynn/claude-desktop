...
import {
  ...
  r as o,
  t as s,
} from "./chunk-AGHRB4JF-DIvkCYtW.js";
import {
  a as c,
  l,
  n as u,
...
`,
      ...
      (Vt = a(async (e, t) => {
        if (!zt(e)) return e;
        if (!(Lt() || t.legacyMathML || t.forceLegacyMathML))
          return e.replace(Rt, `MathML is unsupported in this environment.`);
        {
          let { default: r } = await n(
            ...
            i =
              t.forceLegacyMathML || (!Lt() && t.legacyMathML)
                ? `htmlAndMathml`
                : `mathml`;
          return e
            .split(Y)
...
//# sourceMappingURL=chunk-ABZYJK2D-Ugtemmk_.js.map
