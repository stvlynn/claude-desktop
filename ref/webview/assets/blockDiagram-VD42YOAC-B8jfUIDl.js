...
import { U as r, W as i } from "./lodash-CsD3b1ni.js";
import { i as a, n as o, r as s } from "./chunk-AGHRB4JF-DIvkCYtW.js";
import { c, l, t as u } from "./dist-CPJPVGOt.js";
import {
  E as d,
  L as f,
  a as p,
...
import { n as b, t as x } from "./src-BpCf56JJ.js";
import { c as S, g as C, i as w, u as T } from "./chunk-S3R3BYOJ-BHdYahbs.js";
import { i as E, n as D, o as O } from "./chunk-JA3XYJ7Z-Co-9Jc82.js";
import { n as k, t as ee } from "./chunk-FMBD7UC4-DwMXVR8N.js";
import { n as A, t as te } from "./chunk-HN2XXSSU-BPyoUjyB.js";
import { n as ne, t as re } from "./chunk-CVBHYZKI-ucg-Wr6h.js";
import { n as ie, t as ae } from "./graphlib-CITVmEAN.js";
function oe(e) {
...
` +
    ...
    (Ie = o((e, t) => {
      let n = e.flat(),
        i = [],
        o = n.find((e) => e?.type === `column-setting`)?.columns ?? -1;
      for (let e of n) {
        if (
          (typeof o == `number` &&
            o > 0 &&
        ...
        if (e.type === `column-setting`) t.columns = e.columns ?? -1;
          ...
          if (
            (t === void 0
              ? L.set(e.id, e)
              : (e.type !== `na` && (t.type = e.type),
                e.label !== e.id && (t.label = e.label)),
            ...
            for (let n = 0; n < t; n++) {
              let t = r(e);
              ((t.id = t.id + `-` + n), L.set(t.id, t), i.push(t));
            }
...
`,
  ...
  node        : x:${e.x} y:${e.y} w:${e.width} h:${e.height}`);
    ...
    ($e = o(function (e, r, i, o, s, c, l) {
      let u = i.points;
      a.debug(`abc88 InsertEdge: edge=`, i, `e=`, r);
      let f = !1,
        p = c.node(r.v);
      var h = c.node(r.w);
      (h?.intersect &&
        p?.intersect &&
        ((u = u.slice(1, i.points.length - 1)),
        u.unshift(p.intersect(u[0])),
        u.push(h.intersect(u[u.length - 1]))),
        i.toCluster &&
          (a.debug(`to cluster abc88`, o[i.toCluster]),
          (u = Qe(i.points, o[i.toCluster].node)),
          (f = !0)),
        i.fromCluster &&
          (a.debug(`from cluster abc88`, o[i.fromCluster]),
          (u = Qe(u.reverse(), o[i.fromCluster].node).reverse()),
          (f = !0)));
      let g = u.filter((e) => !Number.isNaN(e.y)),
        _ = t;
      i.curve && (s === `graph` || s === `flowchart`) && (_ = i.curve);
      let { x: v, y } = te(i),
        b = n().x(v).y(y).curve(_),
        x;
      switch (i.thickness) {
      ...
      let S = e
          ...
          .attr(`d`, b(g))
          .attr(`id`, i.id)
          .attr(`class`, ` ` + x + (i.classes ? ` ` + i.classes : ``))
          .attr(`style`, i.style),
        C = ``;
      ((m().flowchart.arrowMarkerAbsolute || m().state.arrowMarkerAbsolute) &&
        ...
        Ge(S, i, C, l, s));
      let w = {};
      return (f && (w.updatedPath = u), (w.originalPath = i.points), w);
    }, `insertEdge`)),
    (et = o((e) => {
      let t = new Set();
      for (let n of e)
...
//# sourceMappingURL=blockDiagram-VD42YOAC-B8jfUIDl.js.map
