  ...
  ((t = `#02120c`),
    ...
    (a = [
      ...
      },
      {
        ...
        settings: { foreground: `#859419` },
      },
      {
        scope: [`keyword.operator`, `entity.other.attribute-name`],
        settings: { foreground: `#788617` },
      },
      {
        scope: [
          `punctuation`,
      ...
      },
      {
        ...
        settings: { foreground: `#c7e6da` },
      },
    ]),
    (o = `dark`),
    (s = { bg: t, colors: n, fg: r, name: i, settings: a, type: o }));
})();
export {
  t as bg,
  n as colors,
...
//# sourceMappingURL=temple-dark-CXWxQtiv.js.map
