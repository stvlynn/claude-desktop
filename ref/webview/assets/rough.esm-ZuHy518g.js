...
function r(e, r, i, a = 1) {
  let o = i,
    s = Math.max(r, 0.1),
    c = e[0] && e[0][0] && typeof e[0][0] == `number` ? [e] : e,
    l = [0, 0];
  if (o) for (let e of c) t(e, l, o);
  let u = (function (e, t, r) {
    let i = [];
    for (let t of e) {
      let e = [...t];
      (n(e[0], e[e.length - 1]) || e.push([e[0][0], e[0][1]]),
        e.length > 2 && i.push(e));
    }
    let a = [];
    t = Math.max(t, 0.1);
    ...
    for (; s.length || o.length; ) {
      if (o.length) {
        let e = -1;
        for (let t = 0; t < o.length && !(o[t].ymin > c); t++) e = t;
        o.splice(0, e + 1).forEach((e) => {
          s.push({ s: c, edge: e });
        });
      }
      if (
        ((s = s.filter((e) => !(e.edge.ymax <= c))),
        s.sort((e, t) =>
          e.edge.x === t.edge.x
            ? 0
            : (e.edge.x - t.edge.x) / Math.abs(e.edge.x - t.edge.x),
        ),
        (r !== 1 || l % t == 0) && s.length > 1)
      )
  ...
  if (o) {
    for (let e of c) t(e, l, -o);
    (function (e, n, r) {
      let i = [];
      (e.forEach((e) => i.push(...e)), t(i, n, r));
    })(u, l, -o);
  }
  return u;
}
...
function s(e) {
    ...
    n = (function (e) {
      ...
      for (; e !== ``; )
        if (e.match(/^([ \t\r\n,]+)/)) e = e.substr(RegExp.$1.length);
          ...
          ((t[t.length] = { type: K, text: RegExp.$1 }),
            (e = e.substr(RegExp.$1.length)));
        else {
          if (
            !e.match(
            ...
            return [];
          ((t[t.length] = { type: q, text: `${parseFloat(RegExp.$1)}` }),
            (e = e.substr(RegExp.$1.length)));
        }
      return ((t[t.length] = { type: J, text: `` }), t);
    })(e),
    r = `BOD`,
    i = 0,
    a = n[i];
  for (; !o(a, J); ) {
    let c = 0,
      l = [];
    if (r === `BOD`) {
      if (a.text !== `M` && a.text !== `m`) return s(`M0,0` + e);
      (i++, (c = Y[a.text]), (r = a.text));
    } else o(a, q) ? (c = Y[r]) : (i++, (c = Y[a.text]), (r = a.text));
    if (!(i + c < n.length)) throw Error(`Path data ended short`);
    for (let e = i; e < i + c; e++) {
      let t = n[e];
      if (!o(t, q)) throw Error(`Param not a number: ` + r + `,` + t.text);
      l[l.length] = +t.text;
    }
    if (typeof Y[r] != `number`) throw Error(`Bad segment: ` + r);
    {
      let e = { key: r, data: l };
      (t.push(e),
        (i += c),
    ...
    switch (l) {
      ...
      case `A`: {
        ...
        e === 0 || n === 0
          ...
          : (r !== c || i !== l) &&
            (d(r, i, c, l, e, n, a, o, s).forEach(function (e) {
              t.push({ key: `C`, data: e });
            }),
            (r = c),
            (i = l));
...
function d(e, t, n, r, i, a, o, s, c, l) {
  ...
  if (l) [h, g, _, v] = l;
    ...
    let p = i * i,
      ...
      y = p * m - p * l * l - m * o * o,
      b = p * l * l + m * o * o,
      x = (s === c ? -1 : 1) * Math.sqrt(Math.abs(y / b));
    ((_ = (x * i * l) / a + (e + n) / 2),
      (v = (x * -a * o) / i + (t + r) / 2),
      (h = Math.asin(parseFloat(((t - v) / a).toFixed(9)))),
      (g = Math.asin(parseFloat(((r - v) / a).toFixed(9)))),
      e < _ && (h = Math.PI - h),
      n < _ && (g = Math.PI - g),
      h < 0 && (h = 2 * Math.PI + h),
      g < 0 && (g = 2 * Math.PI + g),
  ...
  let b = Math.cos(h),
    ...
    k = [n + T * C, r - E * S],
    A = [n, r];
  if (((O[0] = 2 * D[0] - O[0]), (O[1] = 2 * D[1] - O[1]), l))
    return [O, k, A].concat(m);
  {
    m = [O, k, A].concat(m);
    let e = [];
    for (let t = 0; t < m.length; t += 3) {
      let n = u(m[t][0], m[t][1], f),
        r = u(m[t + 1][0], m[t + 1][1], f),
        i = u(m[t + 2][0], m[t + 2][1], f);
...
function f(e, t, n, r, i) {
  return { type: `path`, ops: E(e, t, n, r, i) };
}
function p(e, t, n) {
  let r = (e || []).length;
  if (r > 2) {
    let i = [];
    for (let t = 0; t < r - 1; t++)
      i.push(...E(e[t][0], e[t][1], e[t + 1][0], e[t + 1][1], n));
    return (
      t && i.push(...E(e[r - 1][0], e[r - 1][1], e[0][0], e[0][1], n)),
      { type: `path`, ops: i }
    );
  }
  return r === 2
    ? f(e[0][0], e[0][1], e[1][0], e[1][1], n)
    : { type: `path`, ops: [] };
}
...
function h(e, t) {
  if (e.length) {
    let n = typeof e[0][0] == `number` ? [e] : e,
      r = O(n[0], 1 * (1 + 0.2 * t.roughness), t),
      i = t.disableMultiStroke
        ? []
        : O(n[0], 1.5 * (1 + 0.22 * t.roughness), S(t));
    for (let e = 1; e < n.length; e++) {
      let a = n[e];
      if (a.length) {
        let e = O(a, 1 * (1 + 0.2 * t.roughness), t),
          n = t.disableMultiStroke
            ? []
            : O(a, 1.5 * (1 + 0.22 * t.roughness), S(t));
...
function _(e, t, n, r) {
  let [i, a] = A(
      ...
      r.ry,
      1,
      r.increment * w(0.1, w(0.4, 1, n), n),
      n,
    ),
    o = k(i, null, n);
  if (!n.disableMultiStroke && n.roughness !== 0) {
    let [i] = A(r.increment, e, t, r.rx, r.ry, 1.5, 0, n),
      a = k(i, null, n);
    o = o.concat(a);
  }
...
function v(e, t, n, r, i, a, o, s, c) {
  ...
  let h = (2 * Math.PI) / c.curveStepCount,
    ...
    _ = j(g, l, u, d, f, p, m, 1, c);
  if (!c.disableMultiStroke) {
    let e = j(g, l, u, d, f, p, m, 1.5, c);
    _.push(...e);
  }
  return (
    o &&
      (s
        ? _.push(
            ...E(l, u, l + d * Math.cos(p), u + f * Math.sin(p), c),
            ...E(l, u, l + d * Math.cos(m), u + f * Math.sin(m), c),
          )
        : _.push(
            { op: `lineTo`, data: [l, u] },
  ...
  for (let { key: e, data: o } of n)
    switch (e) {
      case `M`:
        ...
        break;
      case `L`:
        (r.push(...E(a[0], a[1], o[0], o[1], t)), (a = [o[0], o[1]]));
        break;
      case `C`: {
        let [e, n, i, s, c, l] = o;
        (r.push(...ee(e, n, i, s, c, l, a, t)), (a = [c, l]));
        break;
      }
      case `Z`:
        (r.push(...E(a[0], a[1], i[0], i[1], t)), (a = [i[0], i[1]]));
    }
  ...
  for (let r of e)
    if (r.length) {
      let e = t.maxRandomnessOffset || 0,
        i = r.length;
      if (i > 2) {
        n.push({ op: `move`, data: [r[0][0] + T(e, t), r[0][1] + T(e, t)] });
        for (let a = 1; a < i; a++)
          n.push({
            op: `lineTo`,
            data: [r[a][0] + T(e, t), r[a][1] + T(e, t)],
          });
      }
    }
    ...
    if (!W[n])
      switch (n) {
        ...
        case `zigzag-line`:
          ...
          break;
        default:
          ((n = `hachure`), W[n] || (W[n] = new R(t)));
      }
    return W[n];
  })(t, X).fillPolygons(e, t);
}
function S(e) {
...
function C(e) {
  return ((e.randomizer ||= new G(e.seed || 0)), e.randomizer.next());
}
function w(e, t, n, r = 1) {
  return n.roughness * r * (C(n) * (t - e) + e);
}
function T(e, t, n = 1) {
  return w(-e, e, t, n);
}
  ...
  return (
    a &&
      (o
        ...
        : h.push({
            op: `move`,
            data: [e + (v ? 0 : T(u, i, l)), t + (v ? 0 : T(u, i, l))],
          })),
    o
      ? h.push({
          op: `bcurveTo`,
...
function O(e, t, n) {
  if (!e.length) return [];
  let r = [];
  (r.push([e[0][0] + T(t, n), e[0][1] + T(t, n)]),
    r.push([e[0][0] + T(t, n), e[0][1] + T(t, n)]));
  for (let i = 1; i < e.length; i++)
    (r.push([e[i][0] + T(t, n), e[i][1] + T(t, n)]),
      i === e.length - 1 && r.push([e[i][0] + T(t, n), e[i][1] + T(t, n)]));
  return k(r, null, n);
}
function k(e, t, n) {
  let r = e.length,
  ...
  if (r > 3) {
    ...
    if (t && t.length === 2) {
      ...
      i.push({ op: `lineTo`, data: [t[0] + T(e, n), t[1] + T(e, n)] });
    }
  } else
    r === 3
      ? (i.push({ op: `move`, data: [e[1][0], e[1][1]] }),
      ...
      : r === 2 && i.push(...D(e[0][0], e[0][1], e[1][0], e[1][1], n, !0, !0));
  return i;
}
function A(e, t, n, r, i, a, o, s) {
  ...
  if (s.roughness === 0) {
    ...
    let u = T(0.5, s) - Math.PI / 2;
    l.push([
      T(a, s) + t + 0.9 * r * Math.cos(u - e),
      T(a, s) + n + 0.9 * i * Math.sin(u - e),
    ]);
    let d = 2 * Math.PI + u - 0.01;
    for (let o = u; o < d; o += e) {
      let e = [T(a, s) + t + r * Math.cos(o), T(a, s) + n + i * Math.sin(o)];
      (c.push(e), l.push(e));
    }
    (l.push([
      T(a, s) + t + r * Math.cos(u + 2 * Math.PI + 0.5 * o),
      T(a, s) + n + i * Math.sin(u + 2 * Math.PI + 0.5 * o),
    ]),
      l.push([
        T(a, s) + t + 0.98 * r * Math.cos(u + o),
        T(a, s) + n + 0.98 * i * Math.sin(u + o),
      ]),
      l.push([
        T(a, s) + t + 0.9 * r * Math.cos(u + 0.5 * o),
        T(a, s) + n + 0.9 * i * Math.sin(u + 0.5 * o),
      ]));
  }
  return [l, c];
}
function j(e, t, n, r, i, a, o, s, c) {
  let l = a + T(0.1, c),
    u = [];
  u.push([
    T(s, c) + t + 0.9 * r * Math.cos(l - e),
    T(s, c) + n + 0.9 * i * Math.sin(l - e),
  ]);
  for (let a = l; a <= o; a += e)
    u.push([T(s, c) + t + r * Math.cos(a), T(s, c) + n + i * Math.sin(a)]);
  return (
...
function ee(e, t, n, r, i, a, o, s) {
  ...
  for (let p = 0; p < d; p++)
    (p === 0
      ...
      : c.push({
          op: `move`,
          data: [o[0] + (f ? 0 : T(l[0], s)), o[1] + (f ? 0 : T(l[0], s))],
        }),
      (u = f ? [i, a] : [i + T(l[p], s), a + T(l[p], s)]),
      c.push({
        op: `bcurveTo`,
        data: [
          e + T(l[p], s),
...
function te(e, t = 0) {
  ...
  let r = [];
  if (n === 3) r.push(M(e[0]), M(e[1]), M(e[2]), M(e[2]));
  else {
    let n = [];
    n.push(e[0], e[0]);
...
function ne(e, t, n) {
  ...
  return ((i = Math.max(0, Math.min(1, i))), N(e, P(t, n, i)));
}
function P(e, t, n) {
...
function F(e, t, n, r) {
  ...
  if (
    ...
    let n = e[t + 0];
    (i.length
      ? ((a = i[i.length - 1]), (o = n), Math.sqrt(N(a, o))) > 1 && i.push(n)
      : i.push(n),
      i.push(e[t + 3]));
  } else {
    let r = 0.5,
      ...
      p = P(u, d, r),
      m = P(f, p, r);
    (F([a, l, f, m], 0, n, i), F([m, p, d, c], 0, n, i));
  }
  var a, o;
  return i;
}
function re(e, t) {
  return I(e, 0, e.length, t);
}
function I(e, t, n, r, i) {
  ...
  return (
    Math.sqrt(c) > r
      ? (I(e, t, l + 1, r, a), I(e, l, n, r, a))
      : (a.length || a.push(o), a.push(s)),
    a
  );
}
function L(e, t = 0.15, n) {
  let r = [],
    i = (e.length - 1) / 3;
  for (let n = 0; n < i; n++) F(e, 3 * n, t, r);
  return n && n > 0 ? I(r, 0, r.length, n) : r;
}
var R,
  z,
  B,
    ...
    ((R = class {
      ...
      (z = class extends R {
        fillPolygons(e, t) {
          ...
          let r = i(e, Object.assign({}, t, { hachureGap: n })),
            o = (Math.PI / 180) * t.hachureAngle,
            s = [],
            c = 0.5 * n * Math.cos(o),
            l = 0.5 * n * Math.sin(o);
          for (let [e, t] of r)
          ...
          return { type: `fillSketch`, ops: this.renderLines(s, t) };
        }
      }),
      (B = class extends R {
        fillPolygons(e, t) {
      ...
      (V = class {
        ...
        fillPolygons(e, t) {
          let n = i(e, (t = Object.assign({}, t, { hachureAngle: 0 })));
        ...
        dotsOnLines(e, t) {
          ...
          for (let s of e) {
            ...
            for (let e = 0; e < l; e++) {
              let a = f + u + e * r,
                s = d - o + 2 * Math.random() * o,
                c = a - o + 2 * Math.random() * o,
                l = this.helper.ellipse(s, c, i, i, t);
              n.push(...l.ops);
            }
          }
          ...
          return (
            e.forEach((e) => {
              let o = a(e),
                ...
                u = e[1];
              l[0] > u[0] && ((l = e[1]), (u = e[0]));
              let d = Math.atan((u[1] - l[1]) / (u[0] - l[0]));
              for (let e = 0; e < s; e++) {
                let a = e * (n + r),
                  o = a + n,
                  s = [
                    l[0] + a * Math.cos(d) + c * Math.cos(d),
                    l[1] + a * Math.sin(d) + c * Math.sin(d),
                  ],
                  u = [
                    l[0] + o * Math.cos(d) + c * Math.cos(d),
                    l[1] + o * Math.sin(d) + c * Math.sin(d),
                  ];
                i.push(...this.helper.doubleLineOps(s[0], s[1], u[0], u[1], t));
              }
            }),
            i
          );
      ...
      (U = class {
        ...
        fillPolygons(e, t) {
          let n = t.hachureGap < 0 ? 4 * t.strokeWidth : t.hachureGap,
            ...
            a = i(e, (t = Object.assign({}, t, { hachureGap: n + r })));
          return { type: `fillSketch`, ops: this.zigzagLines(a, r, t) };
        }
        zigzagLines(e, t, n) {
          let r = [];
          return (
            e.forEach((e) => {
              let i = a(e),
                ...
                c = e[1];
              s[0] > c[0] && ((s = e[1]), (c = e[0]));
              let l = Math.atan((c[1] - s[1]) / (c[0] - s[0]));
              for (let e = 0; e < o; e++) {
                let i = 2 * e * t,
                  a = 2 * (e + 1) * t,
                  o = Math.sqrt(2 * t ** 2),
                  c = [s[0] + i * Math.cos(l), s[1] + i * Math.sin(l)],
                  u = [s[0] + a * Math.cos(l), s[1] + a * Math.sin(l)],
                  d = [
                    c[0] + o * Math.cos(l + Math.PI / 4),
                    c[1] + o * Math.sin(l + Math.PI / 4),
                  ];
                r.push(
                  ...this.helper.doubleLineOps(c[0], c[1], d[0], d[1], n),
      ...
      (Q = class {
        ...
        line(e, t, n, r, i) {
          let a = this._o(i);
          return this._d(`line`, [f(e, t, n, r, a)], a);
        }
        rectangle(e, t, n, r, i) {
          let a = this._o(i),
            o = [],
          ...
          if (a.fill) {
            ...
            a.fillStyle === `solid` ? o.push(b([i], a)) : o.push(x([i], a));
          }
        ...
        ellipse(e, t, n, r, i) {
          ...
          if (a.fill)
            if (a.fillStyle === `solid`) {
              let n = _(e, t, a, s).opset;
              ((n.type = `fillPath`), o.push(n));
            } else o.push(x([c.estimatedPoints], a));
                ...
                for (let r of e)
                  r.length < 3
                    ...
                    : r.length === 3
                      ...
                      : t.push(...L(te(r), 10, (1 + n.roughness) / 2));
              }
              t.length && r.push(x([t], n));
            }
        ...
        polygon(e, t) {
          ...
          return (
            n.fill &&
              (n.fillStyle === `solid` ? r.push(b([e], n)) : r.push(x([e], n))),
            n.stroke !== Z && r.push(i),
            this._d(`polygon`, r, n)
          );
        }
        path(e, t) {
          ...
          e = (e || ``)
            ...
            .replace(/(-\s)/g, `-`)
            .replace(`/(ss)/g`, ` `);
          let i = n.fill && n.fill !== `transparent` && n.fill !== Z,
            a = n.stroke !== Z,
            ...
            u = (function (e, t, n) {
              let r = l(c(s(e))),
                ...
                u = [],
                d = () => {
                  (u.length >= 4 && a.push(...L(u, t)), (u = []));
                },
                f = () => {
                  (d(), a.length && (i.push(a), (a = [])));
                };
              for (let { key: e, data: t } of r)
                switch (e) {
                  case `M`:
                    (f(), (o = [t[0], t[1]]), a.push(o));
                    break;
                  case `L`:
                    (d(), a.push([t[0], t[1]]));
                    break;
              ...
              e,
              1,
              o ? 4 - 4 * (n.simplification || 1) : (1 + n.roughness) / 2,
            ),
            d = y(e, n);
          if (i)
            if (n.fillStyle === `solid`)
      ...
      (oe = {
        canvas: (e, t) => new ie(e, t),
        svg: (e, t) => new ae(e, t),
        generator: (e) => new Q(e),
        newSeed: () => Q.newSeed(),
      }));
  });
export { se as n, oe as t };
//# sourceMappingURL=rough.esm-ZuHy518g.js.map
