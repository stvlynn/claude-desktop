...
import { n as h, t as g } from "./src-CTe_6Jg1.js";
import { t as _ } from "./dist-CD74BDfk.js";
import { _ as v, n as y, t as b, u as x } from "./chunk-S3R3BYOJ-BBYtiirL.js";
import { c as S, i as C, o as w } from "./chunk-TZMSLE5B-DUO6_pDl.js";
function T(e, t, n, r, i) {
  if (!t[e].width)
    if (n)
      ((t[e].text = v(t[e].text, i, r)),
        (t[e].textLines = t[e].text.split(p.lineBreakRegex).length),
        (t[e].width = i),
        (t[e].height = b(t[e].text, r)));
    else {
      let n = t[e].text.split(p.lineBreakRegex);
...
function E(e, t, n, r, i) {
  let a = new Ie(i);
  a.data.widthLimit = n.data.widthLimit / Math.min(Fe, r.length);
  for (let [o, s] of r.entries()) {
    ...
    if (
      ((u.fontSize += 2),
      (u.fontWeight = `bold`),
      T(`label`, s, l, u, a.data.widthLimit),
      (s.label.Y = r + 8),
      (r = s.label.Y + s.label.height),
      s.type &&
        s.type.text !== `` &&
        ((s.type.text = `[` + s.type.text + `]`),
        T(`type`, s, l, ze(Q), a.data.widthLimit),
        (s.type.Y = r + 5),
      ...
      let e = ze(Q);
      ((e.fontSize -= 2),
        T(`descr`, s, l, e, a.data.widthLimit),
        (s.descr.Y = r + 20),
    ...
    (f.length > 0 && He(a, e, d, f), (t = s.alias));
    let p = i.db.getBoundaries(t);
    (p.length > 0 && E(e, t, a, p, i),
      s.alias !== `global` && Ve(e, s, a),
      ...
      (Me = Math.max(Me, n.data.stopx)),
      (Ne = Math.max(Ne, n.data.stopy)));
  }
}
var D,
  O,
            ...
            for (var C, w, T, E, D, O = {}, k, A, j, M; ; ) {
              if (
                ...
                this.defaultActions[T]
                  ? (E = this.defaultActions[T])
                  : ((C ??= S()), (E = s[T] && s[T][C])),
                E === void 0 || !E.length || !E[0])
              ) {
                var N = ``;
                for (k in ((M = []), s[T]))
                  this.terminals_[k] &&
                    k > p &&
                    M.push(`'` + this.terminals_[k] + `'`);
                ((N = g.showPosition
                  ? `Parse error on line ` +
                    (u + 1) +
                    `:
              ...
              switch (E[0]) {
                ...
                case 2:
                  if (
                    ...
                    b &&
                      (O._$.range = [
                        o[o.length - (A || 1)].range[0],
                        o[o.length - 1].range[1],
                      ]),
                    (D = this.performAction.apply(
                      O,
                      [l, d, u, _.yy, E[1], a, o].concat(h),
                    )),
                    D !== void 0)
                  )
                    return D;
...
` +
      ...
      return (n(le, `Parser`), (le.prototype = ce), (ce.Parser = le), new le());
    })()),
    (O.parser = O),
    (k = O),
    (A = []),
    ...
    (H = n(function (e, t, n, r, i, a, o, s, l) {
      if (e == null || t == null || n == null || r == null) return;
      let u = {},
        d = F.find((e) => e.from === t && e.to === n);
      if (
        (d ? (u = d) : F.push(u),
        (u.type = e),
        (u.from = t),
    ...
    (U = n(function (e, t, n, r, i, a, o) {
      if (t === null || n === null) return;
      let s = {},
        l = A.find((e) => e.alias === t);
      if (
        (l && t === l.alias ? (s = l) : ((s.alias = t), A.push(s)),
      ...
      ((s.typeC4Shape = { text: e }), (s.parentBoundary = M), (s.wrap = ge()));
    }, `addPersonOrSystem`)),
    (W = n(function (e, t, n, r, i, a, o, s) {
      if (t === null || n === null) return;
      let l = {},
        u = A.find((e) => e.alias === t);
      if (
        (u && t === u.alias ? (l = u) : ((l.alias = t), A.push(l)),
      ...
      ((l.wrap = ge()), (l.typeC4Shape = { text: e }), (l.parentBoundary = M));
    }, `addContainer`)),
    (te = n(function (e, t, n, r, i, a, o, s) {
      if (t === null || n === null) return;
      let l = {},
        u = A.find((e) => e.alias === t);
      if (
    ...
    (ne = n(function (e, t, n, r, i) {
      if (e === null || t === null) return;
      let a = {},
        o = P.find((t) => t.alias === e);
      if (
        (o && e === o.alias ? (a = o) : ((a.alias = e), P.push(a)),
      ...
      ((a.parentBoundary = M), (a.wrap = ge()), (N = M), (M = e), j.push(N));
    }, `addPersonOrSystemBoundary`)),
    (re = n(function (e, t, n, r, i) {
      if (e === null || t === null) return;
      let a = {},
        o = P.find((t) => t.alias === e);
      if (
    ...
    (G = n(function (e, t, n, r, i, a, o, s) {
      if (t === null || n === null) return;
      let l = {},
        u = P.find((e) => e.alias === t);
      if (
        (u && t === u.alias ? (l = u) : ((l.alias = t), P.push(l)),
        n == null ? (l.label = { text: `` }) : (l.label = { text: n }),
        r == null)
      )
        l.type = { text: `node` };
    ...
    (K = n(function () {
      ((M = N), j.pop(), (N = j.pop()), j.push(N));
    }, `popBoundaryParseStack`)),
    (q = n(function (e, t, n, r, i, a, o, s, l, u, d) {
      let f = A.find((e) => e.alias === t);
      if (
        !(f === void 0 && ((f = P.find((e) => e.alias === t)), f === void 0))
      ) {
        if (n != null)
          if (typeof n == `object`) {
            let [e, t] = Object.entries(n)[0];
    ...
    (J = n(function (e, t, n, r, i, a, o) {
      let s = F.find((e) => e.from === t && e.to === n);
      if (s !== void 0) {
        if (r != null)
          if (typeof r == `object`) {
            let [e, t] = Object.entries(r)[0];
    ...
    (ce = n(function (e) {
      return e == null ? A : A.filter((t) => t.parentBoundary === e);
    }, `getC4ShapeArray`)),
    (le = n(function (e) {
      return A.find((t) => t.alias === e);
    }, `getC4Shape`)),
    (ue = n(function (e) {
      return Object.keys(ce(e));
    }, `getC4ShapeKeys`)),
    (de = n(function (e) {
      return e == null ? P : P.filter((t) => t.parentBoundary === e);
    }, `getBoundaries`)),
    (fe = de),
    (pe = n(function () {
      return F;
    ...
    (ye = n(function (e, t, n, r, i, a) {
      let o = e.append(`image`);
      (o.attr(`width`, t), o.attr(`height`, n), o.attr(`x`, r), o.attr(`y`, i));
      let s = a.startsWith(`data:image/png;base64`) ? a : (0, D.sanitizeUrl)(a);
      o.attr(`xlink:href`, s);
    }, `drawImage`)),
    (be = n((e, t, n) => {
      let r = e.append(`g`),
      ...
      for (let e of t) {
        let t = e.textColor ? e.textColor : `#444444`,
          a = e.lineColor ? e.lineColor : `#444444`,
          o = e.offsetX ? parseInt(e.offsetX) : 0,
          s = e.offsetY ? parseInt(e.offsetY) : 0;
        if (i === 0) {
          let t = r.append(`line`);
          (t.attr(`x1`, e.startPoint.x),
            ...
            t.attr(`stroke`, a),
            t.style(`fill`, `none`),
            e.type !== `rel_b` && t.attr(`marker-end`, `url(#arrowhead)`),
            (e.type === `birel` || e.type === `rel_b`) &&
              t.attr(`marker-start`, `url(#arrowend)`),
            (i = -1));
        } else {
          let t = r.append(`path`);
          (t
    ...
    (X = (function () {
      ...
      n(e, `byText`);
      function t(e, t, n, r, a, o, s, l) {
        let { fontSize: u, fontFamily: d, fontWeight: f } = l,
          m = e.split(p.lineBreakRegex);
        for (let e = 0; e < m.length; e++) {
          let o = e * u - (u * (m.length - 1)) / 2,
            l = t
              .append(`text`)
              .attr(`x`, n + a / 2)
              .attr(`y`, r)
    ...
    (Z = {
      ...
      insertDynamicNumber: ke,
      insertArrowCrossHead: Ae,
    ...
    (Ve = n(function (e, t, n) {
      ...
      ((i.fontSize += 2),
        (i.fontWeight = `bold`),
        T(`label`, t, r, i, y(t.label.text, i)),
        Z.drawBoundary(e, t, Q));
    }, `drawBoundary`)),
    (He = n(function (e, t, n, r) {
      let i = 0;
      for (let a of r) {
        i = 0;
        let r = n[a],
          o = Re(Q, r.typeC4Shape.text);
        switch (
          ((o.fontSize -= 2),
        ...
        ((u.fontSize += 2),
          ...
          r.type && r.type.text !== ``
            ? ((r.type.text = `[` + r.type.text + `]`),
              T(`type`, r, s, Re(Q, r.typeC4Shape.text), l),
              (r.type.Y = i + 5),
              (i = r.type.Y + r.type.height))
            : r.techn &&
              r.techn.text !== `` &&
              ((r.techn.text = `[` + r.techn.text + `]`),
              T(`techn`, r, s, Re(Q, r.techn.text), l),
              (r.techn.Y = i + 5),
        ...
        (r.descr &&
          r.descr.text !== `` &&
          (T(`descr`, r, s, Re(Q, r.typeC4Shape.text), l),
          (r.descr.Y = i + 20),
    ...
    (We = n(function (e, t) {
      ...
      return (
        (n.x = e.x + e.width / 2),
        (n.y = e.y + e.height / 2),
        { startPoint: r, endPoint: Ue(t, n) }
      );
    }, `getIntersectPoints`)),
    (Ge = n(function (e, t, n, r) {
      let i = 0;
      for (let e of t) {
        i += 1;
        let t = e.wrap && Q.wrap,
        ...
        r.db.getC4Type() === `C4Dynamic` &&
          (e.label.text = i + `: ` + e.label.text);
        let o = y(e.label.text, a);
        (T(`label`, e, t, a, o),
          e.techn &&
            e.techn.text !== `` &&
            ((o = y(e.techn.text, a)), T(`techn`, e, t, a, o)),
          e.descr &&
            e.descr.text !== `` &&
            ((o = y(e.descr.text, a)), T(`descr`, e, t, a, o)));
        let s = We(n(e.from), n(e.to));
        ((e.startPoint = s.startPoint), (e.endPoint = s.endPoint));
      }
      Z.drawRels(e, t, Q);
    }, `drawRels`)),
    n(E, `drawInsideBoundary`),
    (Ke = {
      drawPersonOrSystemArray: He,
      drawBoundary: Ve,
      setConf: Le,
      draw: n(function (e, n, r, i) {
        ...
        let a = l().securityLevel,
          o;
        a === `sandbox` && (o = h(`#i` + n));
        let s = h(a === `sandbox` ? o.nodes()[0].contentDocument.body : `body`),
          d = i.db;
        (i.db.setWrap(Q.wrap),
          (Pe = d.getC4ShapeInRow()),
          (Fe = d.getC4BoundaryInRow()),
          t.debug(`C:${JSON.stringify(Q, null, 2)}`));
        let f = a === `sandbox` ? s.select(`[id="${n}"]`) : h(`[id="${n}"]`);
        (Z.insertComputerIcon(f),
          Z.insertDatabaseIcon(f),
          Z.insertClockIcon(f));
        let p = new Ie(i);
        (p.setData(
          Q.diagramMarginX,
          ...
          (Ne = Q.diagramMarginY));
        let m = i.db.getTitle();
        (E(f, ``, p, i.db.getBoundaries(``), i),
          Z.insertArrowHead(f),
          Z.insertArrowEnd(f),
          Z.insertArrowCrossHead(f),
          Z.insertArrowFilledHead(f),
          Ge(f, i.db.getRels(), i.db.getC4Shape, i),
          (p.data.stopx = Me),
          (p.data.stopy = Ne));
        let g = p.data,
...
`,
      ...
      init: n(({ c4: e, wrap: t }) => {
        (Ke.setConf(e), _e.setWrap(t));
      }, `init`),
    }));
})();
export { qe as diagram };
//# sourceMappingURL=c4Diagram-YG6GDRKO-Bm_tFvsQ.js.map
