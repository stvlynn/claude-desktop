...
import { Y as r } from "./runtime.worker-B4oXRaGJ.js";
import {
  B as i,
  C as a,
  K as o,
...
function w(e, t) {
  return E(e.source, t.source) || e.index - t.index;
}
function T(e, t) {
  return E(e.target, t.target) || e.index - t.index;
}
function E(e, t) {
  return e.y0 - t.y0;
}
...
function N() {
  ...
  function m() {
    ...
    return (v(e), y(e), b(e), S(e), F(e), M(e), e);
  }
  ((m.update = function (e) {
    return (M(e), e);
  }),
    (m.nodeId = function (e) {
      return arguments.length
        ? ((s = typeof e == `function` ? e : C(e)), m)
        : s;
    }),
    (m.nodeAlign = function (e) {
      return arguments.length
        ? ((c = typeof e == `function` ? e : C(e)), m)
        : c;
    }),
    ...
    (m.nodes = function (e) {
      return arguments.length
        ? ((d = typeof e == `function` ? e : C(e)), m)
        : d;
    }),
    (m.links = function (e) {
      return arguments.length
        ? ((f = typeof e == `function` ? e : C(e)), m)
        : f;
    }),
    ...
    (m.extent = function (i) {
      return arguments.length
        ? ((e = +i[0][0]), (n = +i[1][0]), (t = +i[0][1]), (r = +i[1][1]), m)
        : [
            [e, t],
            [n, r],
          ];
  ...
  function v({ nodes: e, links: t }) {
    ...
    for (let [e, r] of t.entries()) {
      ...
      (typeof t != `object` && (t = r.source = j(n, t)),
        typeof i != `object` && (i = r.target = j(n, i)),
        t.sourceLinks.push(r),
        i.targetLinks.push(r));
    }
    if (u != null)
      for (let { sourceLinks: t, targetLinks: n } of e) (t.sort(u), n.sort(u));
  }
  function y({ nodes: e }) {
    for (let t of e)
      t.value =
        t.fixedValue === void 0
          ? Math.max(_(t.sourceLinks, D), _(t.targetLinks, D))
          : t.fixedValue;
  }
  function b({ nodes: e }) {
    let t = e.length,
  ...
  function N({ nodes: t }) {
    ...
    for (let n of t) {
      ...
      ((n.layer = t),
        (n.x0 = e + t * a),
        (n.x1 = n.x0 + i),
        o[t] ? o[t].push(n) : (o[t] = [n]));
    }
    if (l) for (let e of o) e.sort(l);
    return o;
  }
  function P(e) {
    let n = g(e, (e) => (r - t - (e.length - 1) * o) / _(e, D));
    for (let i of e) {
      let e = t;
      for (let t of i) {
  ...
  function F(e) {
    let n = N(e);
    ((o = Math.min(a, (r - t) / (h(n, (e) => e.length) - 1))), P(n));
    for (let e = 0; e < p; ++e) {
      let t = 0.99 ** e,
        r = Math.max(1 - t, (e + 1) / p);
      (L(n, t, r), I(n, t, r));
    }
  }
  function I(e, t, n) {
  ...
  function H(e) {
    if (u === void 0)
      for (let { sourceLinks: t, targetLinks: n } of e) (t.sort(T), n.sort(w));
  }
  function U(e, t) {
...
R.prototype = z.prototype = {
    ...
    if (this._x1 === null)
      ...
      if (!(Math.abs(u * s - c * l) > I) || !i)
        ...
        var f = n - a,
          ...
          g = Math.sqrt(m),
          _ = Math.sqrt(d),
          v = i * Math.tan((P - Math.acos((m + d - h) / (2 * g * _))) / 2),
          y = v / _,
          b = v / g;
        (Math.abs(y - 1) > I &&
  ...
  arc: function (e, t, n, r, i, a) {
    ...
    (this._x1 === null
      ? (this._ += `M` + c + `,` + l)
      : (Math.abs(this._x1 - c) > I || Math.abs(this._y1 - l) > I) &&
        (this._ += `L` + c + `,` + l),
      n &&
        (d < 0 && (d = (d % F) + F),
        d > L
...
function K(e) {
  ...
  return (
    ...
    (o.x = function (e) {
      return arguments.length
        ? ((r = typeof e == `function` ? e : B(+e)), o)
        : r;
    }),
    (o.y = function (e) {
      return arguments.length
        ? ((i = typeof e == `function` ? e : B(+e)), o)
        : i;
    }),
  ...
  var t = e(function (e, t, n, r) {
    ...
    a = {
      ...
      performAction: e(function (e, t, n, r, i, a, o) {
        ...
        switch (i) {
          case 7:
            let e = r.findOrCreateNode(a[s - 4].trim().replaceAll(`""`, `"`)),
...
` +
  ...
  return (e(o, `Parser`), (o.prototype = a), (a.Parser = o), new o());
})();
q.parser = q;
var J = q,
  Y = [],
  ...
  le = {
    nodesMap: Z,
    getConfig: e(() => d().sankey, `getConfig`),
    getNodes: e(() => X, `getNodes`),
    getLinks: e(() => Y, `getLinks`),
    getGraph: e(
      () => ({
        nodes: X.map((e) => ({ id: e.ID })),
        links: Y.map((e) => ({
          source: e.source.ID,
          target: e.target.ID,
          value: e.value,
    ...
    addLink: se,
    findOrCreateNode: e((e) => {
      e = f.sanitizeText(e, d());
      let t = Z.get(e);
      return (t === void 0 && ((t = new ce(e)), Z.set(e, t), X.push(t)), t);
    }, `findOrCreateNode`),
    getAccTitle: m,
    setAccTitle: s,
    getAccDescription: l,
  ...
  $ = { left: y, right: b, center: S, justify: x },
  ue = {
    draw: e(function (i, a, s, c) {
      let { securityLevel: l, sankey: u } = d(),
        f = p.sankey,
        m;
      l === `sandbox` && (m = t(`#i` + a));
      let h = t(l === `sandbox` ? m.nodes()[0].contentDocument.body : `body`),
        g = l === `sandbox` ? h.select(`[id="${a}"]`) : t(`[id="${a}"]`),
        _ = u?.width ?? f.width,
        v = u?.height ?? f.width,
        y = u?.useMaxWidth ?? f.useMaxWidth,
        b = u?.nodeAlignment ?? f.nodeAlignment,
        x = u?.prefix ?? f.prefix,
        S = u?.suffix ?? f.suffix,
        C = u?.showValues ?? f.showValues,
        w = c.db.getGraph(),
        T = $[b];
      N()
        .nodeId((e) => e.id)
        .nodeWidth(10)
        .nodePadding(10 + (C ? 15 : 0))
        .nodeAlign(T)
        .extent([
          [0, 0],
          [_, v],
      ...
      g.append(`g`)
        ...
        .join(`g`)
        .attr(`class`, `node`)
        .attr(`id`, (e) => (e.uid = Q.next(`node-`)).id)
...
${x}${Math.round(t * 100) / 100}${S}`
      ...
      g.append(`g`)
        ...
        .data(w.nodes)
        .join(`text`)
        .attr(`x`, (e) => (e.x0 < _ / 2 ? e.x1 + 6 : e.x0 - 6))
        .attr(`y`, (e) => (e.y1 + e.y0) / 2)
        .attr(`dy`, `${C ? `0` : `0.35`}em`)
        .attr(`text-anchor`, (e) => (e.x0 < _ / 2 ? `start` : `end`))
        .text(D);
      let O = g
          .append(`g`)
          .attr(`class`, `links`)
        ...
        k = u?.linkColor ?? `gradient`;
      if (k === `gradient`) {
        let e = O.append(`linearGradient`)
          .attr(`id`, (e) => (e.uid = Q.next(`linearGradient-`)).id)
        ...
        (e
          .append(`stop`)
          .attr(`offset`, `0%`)
          .attr(`stop-color`, (e) => E(e.source.id)),
          e
            .append(`stop`)
            .attr(`offset`, `100%`)
            .attr(`stop-color`, (e) => E(e.target.id)));
      }
      let A;
      switch (k) {
        case `gradient`:
          A = e((e) => e.uid, `coloring`);
          break;
        case `source`:
          A = e((e) => E(e.source.id), `coloring`);
          break;
        case `target`:
          A = e((e) => E(e.target.id), `coloring`);
          break;
        default:
          A = k;
      }
...
`,
  ...
  pe = J.parse.bind(J);
J.parse = (e) => pe(de(e));
var me = { styles: fe, parser: J, db: le, renderer: ue };
export { me as diagram };
//# sourceMappingURL=sankeyDiagram-XADWPNL6-zd2yvcuO.js.map
