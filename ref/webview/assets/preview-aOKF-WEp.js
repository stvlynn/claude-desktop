const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ["./3Dmol-SSP7cBu0.js", "./rolldown-runtime-Czos8NxU.js"]),
) => i.map((i) => d[i]);
...
function W(e) {
  ...
  t[5] !== d || t[6] !== f
    ...
    : (p = t[7]);
  let { data: m, isError: h, isLoading: g } = c(`read-file`, p);
  if (!l) return r;
  if (g) {
    let e;
    t[8] === n
...
function G({ className: e, contents: n, filePath: r }) {
  let i = m(),
    ...
    R = L.find((e) => e.chainId === b) ?? L[0] ?? null,
    z = T?.modelIndex === o ? T : null,
        ...
        (async () => {
          try {
            let n = ce(
              await s(
                () =>
                  import(`./3Dmol-SSP7cBu0.js`).then((e) => t(e.default, 1)),
                __vite__mapDeps([0, 1]),
                import.meta.url,
              ),
            );
            ...
            e && (q(d, M.current), (M.current = null), g(`error`));
          }
        })(),
        () => {
...
function re(e) {
  ...
  let w = C,
    T;
  t[3] !== n || t[4] !== p || t[5] !== r || t[6] !== c.chainId
    ? ((T =
        n.length > 1
          ? (0, Q.jsx)(te, {
              align: `start`,
              ...
              children: n.map((e) =>
                (0, Q.jsx)(
                  ee.Item,
                  {
                    RightIcon: e.chainId === c.chainId ? u : void 0,
  ...
  t[20] === a
    ...
    : ((j = (e) => {
      ...
      (t[21] = j));
  let M;
  if (t[22] !== p || t[23] !== o || t[24] !== c.residues || t[25] !== b) {
    let e;
    (t[27] !== p || t[28] !== o || t[29] !== b
      ? ((e = (e, t) => {
...
//# sourceMappingURL=preview-aOKF-WEp.js.map
