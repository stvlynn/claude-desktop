...
import {
  n as z,
  t as B,
} from "./app-initial~app-main~first-run~new-thread-panel-page-Dmmp67Az.js";
import {
  i as V,
  n as ce,
  r as le,
...
function U() {
  ...
  e[0] !== l || e[1] !== n || e[2] !== t
    ? ((u = async () => {
        (await m(t, c.NUX_2025_09_15, !0),
          n === `2025-09-15-full-chatgpt-auth`
            ? await m(t, c.NUX_2025_09_15_FULL_CHATGPT_AUTH_VIEWED, !0)
            : n === `2025-09-15-apikey-auth` &&
              (await m(t, c.NUX_2025_09_15_APIKEY_AUTH_VIEWED, !0)),
          l(`/`));
      }),
      (e[0] = l),
      (e[1] = n),
...
function W(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = {
      ...
      (t[0] = l))
    : (l = t[0]);
  let { columns: u, rows: d, lines: f } = ce(l),
    [p, ne] = Y.useState(!1),
    m;
    ...
    ? ((P =
        ...
        (0, X.jsx)(
          oe.div,
          {
            ...
            animate: `active`,
            exit: `exit`,
            children: (0, X.jsx)(pe, { variant: D, isWideViewport: c }),
          },
          `slide-${o}`,
        )),
      (t[22] = D),
  ...
  t[26] === P
    ...
    : ((F = (0, X.jsx)(`div`, {
        ...
        children: (0, X.jsx)(`div`, {
          ...
          children: (0, X.jsx)(M, { initial: !1, mode: `wait`, children: P }),
        }),
      })),
      (t[26] = P),
      (t[27] = F));
  ...
  t[31] === I
    ...
    : ((L = (0, X.jsx)(`div`, {
        ...
        children: (0, X.jsx)(`h1`, {
          ...
          children: (0, X.jsx)(M, { initial: !1, mode: `wait`, children: I }),
        }),
      })),
      (t[31] = I),
      (t[32] = L));
  ...
  let K;
  t[58] !== F || t[59] !== G
    ? ((K = (0, X.jsxs)(ae, { transition: N, children: [F, G] })),
      (t[58] = F),
      (t[59] = G),
      (t[60] = K))
    : (K = t[60]);
...
//# sourceMappingURL=first-run-Dv_mcmnN.js.map
