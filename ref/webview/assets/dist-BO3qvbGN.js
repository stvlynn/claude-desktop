import { $ as e } from "./runtime.worker-1YasDKq2.js";
var t = e((e) => {
  ...
  n = e((e) => {
    ...
    function i(e) {
      return e
        ...
        .replace(n.htmlEntitiesRegex, function (e, t) {
    ...
    function s(e) {
      ...
      do
        ((s = i(s)
          ...
          (s = o(s)),
          (t =
            s.match(n.ctrlCharactersRegex) ||
            s.match(n.htmlEntitiesRegex) ||
            s.match(n.htmlCtrlEntityRegex) ||
            s.match(n.whitespaceEscapeCharsRegex)));
      while (t && t.length > 0);
      var c = s;
      if (!c) return n.BLANK_URL;
      if (r(c)) return c;
      var l = c.trimStart(),
        u = l.match(n.urlSchemeRegex);
      if (!u) return c;
...
export { n as t };
//# sourceMappingURL=dist-BO3qvbGN.js.map
