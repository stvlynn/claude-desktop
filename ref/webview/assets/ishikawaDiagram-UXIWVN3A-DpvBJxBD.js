...
import { f as t } from "./chunk-5PVQY5BW-VrOwugqI.js";
import {
  B as n,
  C as r,
  V as i,
...
import { t as p } from "./rough.esm-BDP__8iH.js";
var m = (function () {
  var t = e(function (e, t, n, r) {
    ...
    h = {
      ...
      table: [
        { 3: 1, 4: 2, 5: 3, 6: [1, 5], 8: n },
        { 1: [3] },
        { 1: [2, 1] },
        { 4: 6, 6: [1, 7], 7: [1, 8], 8: n },
        { 6: r, 7: [1, 10], 9: 9, 12: 11, 13: i, 14: a },
        t(o, [2, 3]),
        { 1: [2, 2] },
        t(o, [2, 4]),
        t(o, [2, 5]),
        { 1: [2, 6], 6: r, 12: 15, 13: i, 14: a },
        { 6: r, 9: 16, 12: 11, 13: i, 14: a },
        { 6: s, 7: c, 10: 17, 11: l },
        t(u, [2, 18], { 14: [1, 21] }),
        t(u, [2, 16]),
        t(u, [2, 17]),
        { 6: s, 7: c, 10: 22, 11: l },
        { 1: [2, 7], 6: r, 12: 15, 13: i, 14: a },
        t(d, [2, 14], { 7: f, 11: p }),
        t(m, [2, 8]),
        t(m, [2, 9]),
        t(m, [2, 10]),
...
var h = m,
  g = class {
    ...
    clear() {
      ((this.root = void 0), (this.stack = []), (this.baseLevel = void 0), s());
    }
    getRoot() {
      return this.root;
    }
    addNode(e, t) {
      let n = u.sanitizeText(t, c());
      if (!this.root) {
      ...
      let i = this.stack[this.stack.length - 1].node,
        o = { text: n, children: [] };
      (i.children.push(o), this.stack.push({ level: r, node: o }));
    }
    getAccTitle() {
      return d();
    }
  ...
  T = e((e, t, n) => {
    let r = e.node().getBBox(),
      i = r.width + t * 2,
      a = r.height + t * 2;
    (l(e, a, i, n), e.attr(`viewBox`, `${r.x - t} ${r.y - t} ${i} ${a}`));
  }, `applyPaddedViewBox`),
  E = e((e, n, r, i) => {
    let a = i.db.getRoot();
    if (!a) return;
    let o = c(),
      { look: s, handDrawnSeed: l, themeVariables: u } = o,
      d = t(o.fontSize)[0] ?? _,
      m = s === `handDrawn`,
      h = a.children ?? [],
      g = o.ishikawa?.diagramPadding ?? 20,
      y = o.ishikawa?.useMaxWidth ?? !1,
      b = f(n),
      x = b.append(`g`).attr(`class`, `ishikawa`),
      S = m ? p.svg(b.node()) : void 0,
      C = S
        ? {
            roughSvg: S,
            seed: l ?? 0,
    ...
    let E = 0,
      k = v,
      A = m ? void 0 : L(x, E, k, E, k, `ishikawa-spine`);
    if ((O(x, E, k, a.text, d, C), !h.length)) {
      (m && L(x, E, k, E, k, `ishikawa-spine`, C), T(b, g, y));
      return;
    }
    E -= 20;
    let j = h.filter((e, t) => t % 2 == 0),
      N = h.filter((e, t) => t % 2 == 1),
      P = D(j),
      F = D(N),
      I = P.total + F.total,
      R = v,
    ...
    if (I > 0) {
      let e = v * 2,
        t = v * 0.3;
      ((R = Math.max(t, e * (P.total / I))),
        (z = Math.max(t, e * (F.total / I))));
    }
    let B = d * 2;
    ((R = Math.max(R, P.max * B)),
      (z = Math.max(z, F.max * B)),
      (k = Math.max(R, v)),
      A && A.attr(`y1`, k).attr(`y2`, k),
      x.select(`.ishikawa-head-group`).attr(`transform`, `translate(0,${k})`));
    let V = Math.ceil(h.length / 2);
    for (let e = 0; e < V; e++) {
      let t = x.append(`g`).attr(`class`, `ishikawa-pair`);
      for (let [n, r, i] of [
        [h[e * 2], -1, R],
        [h[e * 2 + 1], 1, z],
      ])
    ...
    if (m) L(x, E, k, 0, k, `ishikawa-spine`, C);
    else {
      A.attr(`x1`, E);
      let e = `url(#${w})`;
      x.selectAll(`line.ishikawa-branch, line.ishikawa-sub-branch`).attr(
        `marker-start`,
        e,
      );
    }
  ...
  D = e((t) => {
    let n = e(
      (e) => e.children.reduce((e, t) => e + 1 + n(t), 0),
      `countDescendants`,
    );
    return t.reduce(
      (e, t) => {
  ...
  O = e((e, t, n, r, i, a) => {
    let o = Math.max(6, Math.floor(110 / (i * 0.6))),
      ...
      c = F(s, P(r, o), 0, 0, `ishikawa-head-label`, `start`, i),
      l = c.node().getBBox(),
      ...
      a = e((e, t, o) => {
        ...
        for (let e of s) {
          ...
          (r.push({
            ...
            o % 2 == 0
              ? (i.push(n), s.length && a(s, n, o + 1))
              : (s.length && a(s, n, o + 1), i.push(n)));
        }
      }, `walk`);
    return (a(t, -1, 2), { entries: r, yOrder: i });
  }, `flattenTree`),
  A = e((e, t, n, r, i, a, o) => {
    let s = e.append(`g`).attr(`class`, `ishikawa-label-group`),
      c = F(s, t, n, r + 11 * i, `ishikawa-label cause`, `middle`, a)
        .node()
        .getBBox();
    if (o) {
  ...
  M = e((e, t, n, r, i, a, o, s) => {
    let c = t.children ?? [],
      ...
      p = r + d;
    if (
      (L(e, n, r, f, p, `ishikawa-branch`, s),
      s && j(e, n, r, n - f, r - p, s),
      A(e, t.text, f, p, i, o, s),
      !c.length)
    )
      return;
    let { entries: m, yOrder: h } = k(c, i),
      g = m.length,
      _ = Array(g);
    ...
    let S = -C,
      T = w * i,
      E = i < 0 ? `ishikawa-label up` : `ishikawa-label down`;
    for (let [t, n] of m.entries()) {
      ...
      if (n.depth % 2 == 0) {
        let e = i.y1 - i.y0;
        ((c = I(i.x0, i.x1, e ? (r - i.y0) / e : 0.5)),
          (l = r),
          (u = c - (n.childCount > 0 ? b + n.childCount * x : y)),
          L(a, c, r, u, r, `ishikawa-sub-branch`, s),
          s && j(a, c, r, 1, 0, s),
          F(a, n.text, u, r, `ishikawa-label align`, `end`, o));
      } else {
        let e = i.childrenDrawn++;
        ((c = I(i.x0, i.x1, (i.childCount - e) / (i.childCount + 1))),
          (l = i.y0),
          (u = c + S * ((r - l) / T)),
          L(a, c, l, u, r, `ishikawa-sub-branch`, s),
          s && j(a, c, l, c - u, l - r, s),
          F(a, n.text, u, r, E, `end`, o));
      }
      n.childCount > 0 &&
        v.set(t, {
          x0: c,
...
export { R as diagram };
//# sourceMappingURL=ishikawaDiagram-UXIWVN3A-DpvBJxBD.js.map
