...
import {
  ...
  r as Pe,
  t as Fe,
} from "./artifact-analytics-DeyIRgFu.js";
import { n as Ie, t as Le } from "./artifact-preview-status-Bog-waeI.js";
function Re(e) {
  let t = (0, He.c)(19),
...
var He,
  ...
  Ge,
  Ke = e(() => {
    ((He = i()), (Ue = t(o(), 1)), (We = [0, 0.25, 0.5, 0.75, 1]), (Ge = 100));
  });
function qe(e) {
  let t = (0, Xe.c)(9),
    { fileDataUrl: n } = e,
...
function zt({
  ...
  let y = c(he),
    ...
    [I, R] = (0, Y.useState)(null),
    [z, B] = (0, Y.useState)(null),
    [V, H] = (0, Y.useState)(null),
    [te, U] = (0, Y.useState)(null),
    [W, G] = (0, Y.useState)(!1),
    [ne, re] = (0, Y.useState)(!1),
    ie = b.formatMessage({
    ...
    le = te == null ? null : (K.find((e) => rn(e) === te) ?? null),
    q = V == null ? null : (K.find((e) => rn(e) === V) ?? null),
    ue = q == null ? null : Yt(q),
    de = k ?? ue,
    J = (0, Y.useMemo)(
      () =>
        k == null
          ? ue == null || q == null || V == null
            ? null
            : Kt({
                anchor: ue,
                body: Xt(q),
      ...
      [o, k, M, ue, q, V, u, d, p, _],
    ),
    pe = de == null ? null : Zt({ anchor: de, layer: T, pageSize: d }),
    me = de != null,
    _e = (0, Y.useCallback)(() => {
      (k != null && i?.(u, !1),
        A(null),
    ...
    be = (0, Y.useCallback)(
      () =>
        J == null
          ? !1
          : J.target.mode === `create` && M.trim().length > 0
            ? W
              ? (_e(), !0)
              : (G(!0), ye(), !1)
            : (_e(), !0),
    ...
    xe = (0, Y.useEffectEvent)(() => {
      if (de == null) return;
      let e = Zt({ anchor: de, layer: T, pageSize: d });
      e != null && ee(x.current, e);
    });
  (0, Y.useEffect)(() => {
    if (!me || T == null) return;
  ...
  (0, Y.useEffect)(() => {
    if (t || J?.target.mode !== `create` || T == null) return;
    let e = T.ownerDocument,
      n = (e) => {
        Se(e);
      };
  ...
  let Ce = (0, Y.useEffectEvent)(() => {
    if (t || T == null) return;
    let e = T.parentElement;
    if (e == null) return;
    let n = ft({ pageElement: e, pageSize: d });
    if (n == null) {
      R(null);
      return;
    }
    ((k != null || V != null) && !be()) ||
      (R(n), A(null), N(``), H(null), U(null), B(null), G(!1));
  });
  (0, Y.useEffect)(() => {
    if (T == null || t) return;
    let e = T.parentElement;
  ...
  let we = (e, n, r) => {
    ...
    Ee = (0, Y.useEffectEvent)((e, t) => {
      if (k != null || V != null || !j(e)) return;
      let n =
        ft({ pageElement: t, pageSize: d }) ??
        (I?.selectionKind === `text` ? null : I);
      n != null &&
  ...
  let De = (e) => {
      ((k != null || V != null) && !be()) || Te(e, `annotation_mode_pointer`);
    },
    Oe = (e) => {
    ...
    Ae = (e) => {
      ...
      let n = {
        ...
        i = mt(n, r);
      if (!r) {
        let t = we(e.clientX, e.clientY, !0);
        if (t != null) {
          (F(null), De(t));
          return;
        }
      }
      if (k != null && i.kind === `point`) {
        (be(), F(null));
        return;
      }
      (Te(i, `annotation_mode_pointer`), F(null));
    },
    je = async (e, { submitDirectly: i = !1 } = {}) => {
      let c = e.body.trim();
      if (V != null) {
        if (c.length === 0 || ne) return;
        (r((e) =>
          e.map((e) =>
            rn(e) === V
      ...
      if (!(k == null || c.length === 0 || ne))
        try {
          re(!0);
          let h = qt({ anchor: k, pageSize: d }),
            v = crypto.randomUUID(),
            b;
          try {
            b = await Qt({
  ...
  return (0, X.jsxs)(`div`, {
    ref: E,
    className: ge(`absolute inset-0 z-[3]`, !t && `pointer-events-none`),
    "data-testid": `artifact-pdf-comment-layer`,
    style: t ? { cursor: S } : void 0,
    onPointerDown: Oe,
    onPointerMove: ke,
    onPointerUp: Ae,
    onPointerCancel: () => {
    ...
    children: [
      ...
      le == null || V != null
        ? null
        : (0, X.jsx)(Vt, { comment: le, layer: T }),
      z != null && k == null && V == null
        ? (0, X.jsx)(C, {
            paddingPx: 4,
            pageSize: d,
            rect: z.rect,
      ...
      I != null && k == null
        ? (0, X.jsx)(h, {
            anchor: I.askForEditAnchor,
            label: oe,
            pageSize: d,
            rect: I.rect,
            testId: `artifact-pdf-ask-for-edit-button`,
            onClick: () => Te(I, `ask_codex_button`),
          })
        : null,
      P == null
        ? null
        : (0, X.jsx)(Wt, { rect: gt(P.start, P.current), pageSize: d }),
      k == null ? null : (0, X.jsx)(Ht, { anchor: k, label: n, pageSize: d }),
      de == null || pe == null || J == null
        ? null
        : (0, X.jsx)(`div`, {
            ref: x,
            className: L,
            style: { left: pe.x, top: pe.y, height: O, width: 294 },
            ...
            children: (0, X.jsx)(
              D,
              {
                ...
                onCancel: _e,
                onDelete: (e) => {
                  (r((t) => t.filter((t) => rn(t) !== e)), _e());
                },
                onDirectSubmit: (e) => {
                  je(e, { submitDirectly: !0 });
                },
                onEscape: _e,
                onBodyChange: J.target.mode === `create` ? ve : void 0,
...
function Zt({ anchor: e, layer: t, pageSize: n }) {
  return e.kind === `region` && e.selectionKind != null
    ? g({ layer: t, pageSize: n, rect: e.rect })
    : A({
        layer: t,
    ...
    ((jn = i()),
      ...
      (Pn = (0, Mn.memo)(function (e) {
        ...
        t[26] !== m
          ...
          : (B = t[27]),
          (0, Mn.useEffect)(z, B));
        let ee = C == null ? void 0 : ``,
          V = S?.userUnit ?? 1,
          H;
        t[28] !== E.height || t[29] !== E.width || t[30] !== D || t[31] !== V
          ? ((H = {
              "--scale-factor": D,
              "--user-unit": V,
              height: E.height,
...
function In(e) {
  ...
  let x = b,
    S;
  t[8] !== x || t[9] !== a
    ? ((S = { onExternalLink: a, onPageChange: x }),
      (t[8] = x),
      (t[9] = a),
      (t[10] = S))
    : (S = t[10]);
  ...
  let M = j,
    N;
  t[21] !== M || t[22] !== x || t[23] !== A || t[24] !== r || t[25] !== i
    ? ((N = (e) => {
        if (e.key === `Escape`) {
          (e.preventDefault(), i());
          return;
  ...
  t[27] !== M || t[28] !== A
    ? ((F = (e) => {
        ...
        e.clientX < t.left + t.width / 2 ? A() : M();
      }),
      (t[27] = M),
      (t[28] = A),
      (t[29] = F))
  ...
  let I = F,
    L;
  t[30] !== o || t[31] !== m
    ? ((L = Ln({ pageViewportSize: o, presentationSize: m })),
      (t[30] = o),
      (t[31] = m),
      (t[32] = L))
    : (L = t[32]);
  let R;
  t[33] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((R = { kind: `page-width` }), (t[33] = R))
    : (R = t[33]);
  let z;
  t[34] !== O || t[35] !== C || t[36] !== o || t[37] !== s || t[38] !== L
    ? ((z = (0, Z.jsx)(`div`, {
  ...
  t[40] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ee = (0, Z.jsx)(q, { className: `icon-2xs rotate-180` })), (t[40] = ee))
    : (ee = t[40]);
  let V;
  t[41] !== A || t[42] !== T || t[43] !== B
    ? ((V = (0, Z.jsx)(re, {
        "aria-label": T,
        color: `ghost`,
        disabled: B,
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((U = (0, Z.jsx)(q, { className: `icon-2xs` })), (t[48] = U))
    : (U = t[48]);
  let W;
  t[49] !== M || t[50] !== D || t[51] !== te
    ? ((W = (0, Z.jsx)(re, {
        "aria-label": D,
        color: `ghost`,
        disabled: te,
  ...
  t[53] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((G = (0, Z.jsx)(`div`, { className: `mx-1 h-4 w-px bg-white/25` })),
      (t[53] = G))
    : (G = t[53]);
  let ne, ie;
  t[54] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ne = (0, Z.jsx)(ue, { className: `icon-2xs` })),
      (ie = (0, Z.jsx)(pe, {
...
function Zn(e) {
  ...
  t[1] === p.value
    ? (A = t[2])
    : ((A = H(p.value)), (t[1] = p.value), (t[2] = A));
  let j = A,
    N;
  t[3] === j
    ? (N = t[4])
    : ((N = j ?? le({ entrypoint: `home` })), (t[3] = j), (t[4] = N));
  let I = N,
    L = u(P, I),
    z;
  t[5] !== I || t[6] !== p
  ...
  if (t[8] !== L || t[9] !== s) {
    ...
    (t[11] === s
      ? (e = t[12])
      : ((e = (e) => m(e) && e.localPdfContext?.path === s),
        (t[11] = s),
        (t[12] = e)),
      (ee = L.filter(e)),
      (t[8] = L),
  ...
  t[13] === V
    ? (te = t[14])
    : ((te = Math.max(0, ...V.map(tr))), (t[13] = V), (t[14] = te));
  let G = te + 1,
    re,
    ie;
  (t[15] !== s || t[16] !== B
    ? ((re = () => () => {
        B((e) => {
          let t = e.filter((e) => !(m(e) && e.localPdfContext?.path === s));
  ...
  t[19] === r
    ? (ae = t[20])
    : ((ae = { fileDataUrl: r }), (t[19] = r), (t[20] = ae));
  let {
      loadedFileDataUrl: oe,
      loadState: se,
      numPages: K,
      pageViewportSize: q,
      pdfDocument: ue,
  ...
  t[21] === K
    ...
    : ((de = {
      ...
      (t[21] = K),
      (t[22] = de));
  let { currentPage: J, goToNextPage: pe, goToPreviousPage: me } = Re(de),
    he;
  ...
  let ge = he,
    _e;
  t[24] !== q || t[25] !== O
    ? ((_e = { onBeforeZoom: ge, pageViewportSize: q, pageWidth: O }),
      (t[24] = q),
      (t[25] = O),
      (t[26] = _e))
    : (_e = t[26]);
  let {
    ...
    Fe;
  t[27] !== J || t[28] !== Ee || t[29] !== Ae
    ? ((Fe = () => {
        let e =
          Ae.kind === `page-width`
            ? null
            : _.current?.querySelector(
                `[data-artifact-pdf-page][data-page-number="${J}"]`,
              );
        (Ee(),
          e != null &&
  ...
  t[31] === Se
    ...
    : ((ze = (e) => {
        ...
        let t = Math.max(0, Math.floor(e.contentRect.width) - 48),
          n = x.current;
        n !== t &&
          (n != null && (ge({ kind: `center` }), Se()), (x.current = t), k(t));
      }),
      (t[31] = Se),
      (t[32] = ze));
  let Be = Oe(ze),
  ...
  t[33] !== K || t[34] !== ue
    ? ((Ve = () => {
        ...
        e == null ||
          ...
          K < 1 ||
          (Un({
            anchorState: { ...e, pageNumber: Math.min(e.pageNumber, K) },
            container: t,
  ...
  (t[43] === r
    ? ((Ge = t[44]), (Ke = t[45]))
    : ((Ge = () => {
        b.current !== r && ((b.current = r), ge({ kind: `center` }));
      }),
      (Ke = [ge, r]),
      (t[43] = r),
      (t[44] = Ge),
  ...
  (t[49] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Xe = () => {
        let e = () => {
          document.fullscreenElement !== g.current && T(!1);
        };
        return (
  ...
  t[51] === De
    ...
    : ((Qe = (e) => {
        let t = _.current;
        t !== e &&
          (t?.removeEventListener(`wheel`, De),
          (_.current = e),
          e?.addEventListener(`wheel`, De, { passive: !1 }));
      }),
      (t[51] = De),
      (t[52] = Qe));
  let $e = Qe,
  ...
  t[53] !== K || t[54] !== p
    ? ((rt = () => {
        ((v.current = !0), ce(p, U, { pageCount: K }));
      }),
      (t[53] = K),
      (t[54] = p),
      (t[55] = rt))
    ...
    ? ((lt = (e, t) => {
        (T(!1),
          (document.fullscreenElement === g.current
            ...
            .catch($n)
            .finally(() => {
              be({ event: t, href: e, initiator: `open_in_browser_bridge` });
            }));
      }),
      (t[62] = lt))
    : (lt = t[62]);
  ...
  t[72] !== E || t[73] !== p || t[74] !== d || t[75] !== j
    ...
    : (xt = t[76]);
  let St;
  t[77] !== gt || t[78] !== vt || t[79] !== E || t[80] !== xt
    ? ((St = (0, $.jsx)(M, {
        active: E,
        activeLabel: vt,
        label: gt,
...
//# sourceMappingURL=pdf-preview-panel-CA-j3mcg.js.map
