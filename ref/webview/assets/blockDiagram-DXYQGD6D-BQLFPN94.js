...
import { C as r, c as i, h as a, i as o } from "./chunk-5PVQY5BW-DEldFBPA.js";
import { t as s } from "./clone-CDWul6Lw.js";
import { k as c } from "./runtime.worker-1YasDKq2.js";
import {
  D as l,
  L as u,
  a as d,
...
import { t as v } from "./channel-BlN9FjG1.js";
import "./dist-BO3qvbGN.js";
import { n as y } from "./chunk-U2HBQHQK-Di_FkPOF.js";
import { t as b } from "./chunk-FMBD7UC4-D9frSjxD.js";
import { n as x, t as S } from "./chunk-BSJP7CBP-DNK2-xIh.js";
import { n as C, t as w } from "./chunk-ZZ45TVLE-B85K-is4.js";
import { t as T } from "./graphlib-BnZ9Pn5Q.js";
var E = (function () {
      ...
      performAction: t(function (e, t, n, r, i, a, o) {
        ...
        switch (i) {
          ...
          case 24:
            (r
              .getLogger()
              .debug(`Rule: nodeStatement (abc88 node size) `, a[s - 1], a[s]),
              (this.$ = {
                id: a[s - 1].id,
                label: a[s - 1].label,
...
var D = E,
  ...
  N = new Map(),
  re = ``,
  ie = t((e) => h.sanitizeText(e, ne), `sanitizeText`),
  ae = t(function (e, t = ``) {
    let n = N.get(e);
    (n || ((n = { id: e, styles: [], textStyles: [] }), N.set(e, n)),
      t?.split(te).forEach((e) => {
  ...
  se = t(function (e, t) {
    e.split(`,`).forEach(function (e) {
      ...
      if (n === void 0) {
        let t = e.trim();
        ((n = { id: t, type: `na`, children: [] }), O.set(t, n));
      }
  ...
  ce = t((t, n) => {
    let r = t.flat(),
      i = [],
      a = r.find((e) => e?.type === `column-setting`)?.columns ?? -1;
    for (let t of r) {
      if (
        (typeof a == `number` &&
          a > 0 &&
          t.type !== `column-setting` &&
          typeof t.widthInColumns == `number` &&
          t.widthInColumns > a &&
          e.warn(
            `Block ${t.id} width ${t.widthInColumns} exceeds configured column width ${a}`,
          ),
        (t.label &&= ie(t.label)),
        t.type === `classDef`)
      ) {
      ...
      if (t.type === `applyClass`) {
        se(t.id, t?.styleClass ?? ``);
        continue;
      }
      if (t.type === `applyStyles`) {
        t?.stylesStr && oe(t.id, t?.stylesStr);
        continue;
      }
      if (t.type === `column-setting`) n.columns = t.columns ?? -1;
      else if (t.type === `edge`) {
        let e = (A.get(t.id) ?? 0) + 1;
        (A.set(t.id, e), (t.id = e + `-` + t.id), k.push(t));
      } else {
        ...
        if (
          (e === void 0
            ? O.set(t.id, t)
            : (t.type !== `na` && (e.type = t.type),
              t.label !== t.id && (e.label = t.label)),
          t.children && ce(t.children, t),
          t.type === `space`)
        ) {
          let e = t.width ?? 1;
          for (let n = 0; n < e; n++) {
            let e = s(t);
            ((e.id = e.id + `-` + n), O.set(e.id, e), i.push(e));
          }
  ...
  le = [],
  P = { id: `root`, type: `composite`, children: [], columns: -1 },
  ue = t(() => {
    (e.debug(`Clear called`),
      d(),
      (P = { id: `root`, type: `composite`, children: [], columns: -1 }),
      (O = new Map([[`root`, P]])),
      (le = []),
...
function de(t) {
  switch ((e.debug(`typeStr2Type`, t), t)) {
    case `[]`:
      return `square`;
    case `()`:
      return (e.debug(`we have a round`), `round`);
    case `(())`:
      return `circle`;
    case `>]`:
...
t(pe, `edgeStrToEdgeData`);
var me = 0,
  he = {
    getConfig: t(() => _().block, `getConfig`),
    typeStr2Type: de,
    edgeTypeStr2Type: fe,
    edgeStrToEdgeData: pe,
    getLogger: t(() => e, `getLogger`),
    getBlocksFlat: t(() => [...O.values()], `getBlocksFlat`),
    getBlocks: t(() => le || [], `getBlocks`),
    getEdges: t(() => k, `getEdges`),
    setHierarchy: t((e) => {
      ((P.children = e), ce(e, P), (le = P.children));
    }, `setHierarchy`),
    getBlock: t((e) => O.get(e), `getBlock`),
    setBlock: t((e) => {
      O.set(e.id, e);
    }, `setBlock`),
    getColumns: t((e) => {
    ...
    getClasses: t(function () {
      return N;
    }, `getClasses`),
    clear: ue,
    generateId: t(
      () => (me++, `id-` + Math.random().toString(36).substr(2, 12) + `-` + me),
      `generateId`,
    ),
    setDiagramId: t((e) => {
      re = e;
    }, `setDiagramId`),
    getDiagramId: t(() => re, `getDiagramId`),
  },
  F = t((e, t) => {
    let n = v;
    return m(n(e, `r`), n(e, `g`), n(e, `b`), t);
  }, `fade`),
  ge = t(
    (e) => `.label {
  ...
  .node .cluster {
    // fill: ${F(e.mainBkg, 0.5)};
    fill: ${F(e.clusterBkg, 0.5)};
    stroke: ${F(e.clusterBorder, 0.2)};
...
`,
  ...
  ve = {
    extension: t((t, n, r) => {
      (e.trace(`Making markers for `, r),
        t
          .append(`defs`)
          .append(`marker`)
          .attr(`id`, r + `_` + n + `-extensionStart`)
          .attr(`class`, `marker extension ` + n)
          .attr(`refX`, 18)
          .attr(`refY`, 7)
...
var be = t((t) => {
  ...
  for (let i of t.children) {
    let {
      ...
      x: o,
      y: s,
    } = i.size ?? { width: 0, height: 0, x: 0, y: 0 };
    (e.debug(
      ...
      i.type !== `space` &&
        (t > n && (n = t / (i.widthInColumns ?? 1)), a > r && (r = a)));
  }
  return { width: n, height: r };
}, `getMaxChildSize`);
function R(t, n, r = 0, i = 0) {
  (e.debug(
    ...
    t?.size?.width || (t.size = { width: r, height: i, x: 0, y: 0 }));
  let a = 0,
    o = 0;
  if (t.children?.length > 0) {
    for (let e of t.children) R(e, n);
    let s = be(t);
    ((a = s.width),
      (o = s.height),
      e.debug(
    ...
    for (let n of t.children)
      n.size &&
        (e.debug(
          `abc95 Setting size of children of ${t.id} id=${n.id} ${a} ${o} ${JSON.stringify(n.size)}`,
        ),
        (n.size.width =
          a * (n.widthInColumns ?? 1) + I * ((n.widthInColumns ?? 1) - 1)),
        (n.size.height = o),
        (n.size.x = 0),
        (n.size.y = 0),
        e.debug(
          `abc95 updating size of ${t.id} children child:${n.id} maxWidth:${a} maxHeight:${o}`,
        ));
    for (let e of t.children) R(e, n, a, o);
    let c = t.columns ?? -1,
      l = 0;
    ...
    if (f < r) {
      (e.debug(
        `Detected to small sibling: abc95 ${t.id} siblingWidth ${r} siblingHeight ${i} width ${f}`,
      ),
        (f = r),
        (p = i));
      let n = (r - u * I - I) / u,
        s = (i - d * I - I) / d;
      (e.debug(`Size indata abc88`, t.id, `childWidth`, n, `maxWidth`, a),
        e.debug(`Size indata abc88`, t.id, `childHeight`, s, `maxHeight`, o),
        e.debug(`Size indata abc88 xSize`, u, `padding`, I));
    ...
    if (
      (e.debug(
        `abc95 (finale calc) ${t.id} xSize ${u} ySize ${d} columns ${c}${t.children.length} width=${Math.max(f, t.size?.width || 0)}`,
      ),
      f < (t?.size?.width || 0))
    ) {
      f = t?.size?.width || 0;
    ...
    t.size = { width: f, height: p, x: 0, y: 0 };
  }
  e.debug(
...
function z(t, n) {
  ...
  let r = t.columns ?? -1;
  if (
    (e.debug(`layoutBlocks columns abc95`, t.id, `=>`, r, t),
    t.children && t.children.length > 0)
  ) {
    let i = t?.children[0]?.size?.width ?? 0,
      a = t.children.length * i + (t.children.length - 1) * I;
    ...
    {
      let e = 0,
        t = [...o.keys()].sort((e, t) => e - t);
      for (let n of t) (s.set(n, e), (e += (o.get(n) ?? 0) + I));
    }
    let c = 0;
    e.debug(`abc91 block?.size?.x`, t.id, t?.size?.x);
    let l = t?.size?.x ? t?.size?.x + (-t?.size?.width / 2 || 0) : -I,
      u = 0;
    for (let i of t.children) {
      let a = t;
      if (!i.size) continue;
      let { width: d, height: f } = i.size,
        { px: p, py: m } = L(r, c);
      if (
        (m != u &&
          ((u = m),
          (l = t?.size?.x ? t?.size?.x + (-t?.size?.width / 2 || 0) : -I),
          e.debug(`New row in layout for block`, t.id, ` and child `, i.id, u)),
        e.debug(
          `abc89 layout blocks (child) id: ${i.id} Pos: ${c} (px, py) ${p},${m} (${a?.size?.x},${a?.size?.y}) parent: ${a.id} width: ${d}${I}`,
        ),
        a.size)
      ) {
        let t = d / 2;
        ((i.size.x = l + I + t),
          e.debug(
            `abc91 layout blocks (calc) px, pyid:${i.id} startingPos=X${l} new startingPosX${i.size.x} ${t} padding=${I} width=${d} halfWidth=${t} => x:${i.size.x} y:${i.size.y} ${i.widthInColumns} (width * (child?.w || 1)) / 2 ${(d * (i?.widthInColumns ?? 1)) / 2}`,
          ),
          (l = i.size.x + t));
        let n = s.get(m) ?? 0,
          r = o.get(m) ?? f;
        ((i.size.y = a.size.y - a.size.height / 2 + n + r / 2 + I),
          e.debug(
            `abc88 layout blocks (calc) px, pyid:${i.id}startingPosX${l}${I}${t}=>x:${i.size.x}y:${i.size.y}${i.widthInColumns}(width * (child?.w || 1)) / 2${(d * (i?.widthInColumns ?? 1)) / 2}`,
          ));
      }
      i.children && z(i, n);
      let h = i?.widthInColumns ?? 1;
      (r > 0 && (h = Math.min(h, r - (c % r))),
        (c += h),
        e.debug(`abc88 columnsPos`, i, c));
    }
  }
  e.debug(
...
function xe(t) {
  ...
  if (!n) return;
  (R(n, t, 0, 0), z(n, t), e.debug(`getBlocks`, JSON.stringify(n, null, 2)));
  let { minX: r, minY: i, maxX: a, maxY: o } = B(n),
    s = o - i;
  return { x: r, y: i, width: a - r, height: s };
}
t(xe, `layout`);
var V = t(async (e, t, n, r = !1, i = !1) => {
    let a = t || ``;
  ...
  Se = t((e, t, n, r, i) => {
    (t.arrowTypeStart && we(e, `start`, t.arrowTypeStart, n, r, i),
      t.arrowTypeEnd && we(e, `end`, t.arrowTypeEnd, n, r, i));
  }, `addEdgeMarkers`),
  Ce = {
    arrow_cross: `cross`,
    arrow_point: `point`,
  ...
  Te = t(async (e, t) => {
    ...
    if (i) {
      ...
      let e = n(c).select(`text`).node();
      e && typeof e.getBBox == `function` && (u = e.getBBox());
    }
    (o.attr(`transform`, S(u, i)),
      (H[t.id] = a),
      (t.width = l.width),
      (t.height = l.height));
    let d;
    if (t.startLabelLeft) {
      let r = e.insert(`g`).attr(`class`, `edgeTerminals`),
        a = r.insert(`g`).attr(`class`, `inner`),
        o = await V(a, t.startLabelLeft, t.labelStyle);
      d = o;
      let s = o.getBBox();
      if (i) {
        let e = o.children[0],
      ...
      (a.attr(`transform`, S(s, i)),
        U[t.id] || (U[t.id] = {}),
        (U[t.id].startLeft = r),
        W(d, t.startLabelLeft));
    }
    if (t.startLabelRight) {
      let r = e.insert(`g`).attr(`class`, `edgeTerminals`),
        a = r.insert(`g`).attr(`class`, `inner`),
        o = await V(r, t.startLabelRight, t.labelStyle);
      ...
      (a.attr(`transform`, S(s, i)),
        U[t.id] || (U[t.id] = {}),
        (U[t.id].startRight = r),
        W(d, t.startLabelRight));
    }
    if (t.endLabelLeft) {
      let r = e.insert(`g`).attr(`class`, `edgeTerminals`),
        a = r.insert(`g`).attr(`class`, `inner`),
        o = await V(a, t.endLabelLeft, t.labelStyle);
      d = o;
      let s = o.getBBox();
      if (i) {
        let e = o.children[0],
    ...
    if (t.endLabelRight) {
      let r = e.insert(`g`).attr(`class`, `edgeTerminals`),
        a = r.insert(`g`).attr(`class`, `inner`),
        o = await V(a, t.endLabelRight, t.labelStyle);
      d = o;
      let s = o.getBBox();
      if (i) {
        let e = o.children[0],
...
t(W, `setTerminalWidth`);
var Ee = t((t, n) => {
    e.debug(`Moving label abc88 `, t.id, t.label, H[t.id], n);
    let r = n.updatedPath ? n.updatedPath : n.originalPath,
      { subGraphTitleTotalMargin: i } = C(f());
    if (t.label) {
      let o = H[t.id],
        s = t.x,
        c = t.y;
      if (r) {
        ...
        (e.debug(
          ...
          n.updatedPath && ((s = i.x), (c = i.y)));
      }
      o.attr(`transform`, `translate(${s}, ${c + i / 2})`);
    }
    if (t.startLabelLeft) {
      let e = U[t.id].startLeft,
        n = t.x,
        i = t.y;
      if (r) {
        let e = a.calcTerminalLabelPosition(
  ...
  node        : x:${t.x} y:${t.y} w:${t.width} h:${t.height}`);
    ...
    if (Math.abs(a - n.y) * s > Math.abs(i - n.x) * l) {
      ...
      return (
        ...
        d === 0 && (i.x = n.x),
        u === 0 && (i.y = n.y),
        e.debug(`abc89 topp/bott calc, Q ${u}, q ${t}, R ${d}, r ${c}`, i),
        i
      );
    } else {
      c = r.x < n.x ? n.x - s - i : i - s - n.x;
      let t = (u * c) / d,
        a = r.x < n.x ? r.x + d - c : r.x - d + c,
        o = r.y < n.y ? r.y + t : r.y - t;
      return (
        e.debug(`sides calc abc89, Q ${u}, q ${t}, R ${d}, r ${c}`, {
          _x: a,
          _y: o,
        }),
        c === 0 && ((a = n.x), (o = n.y)),
      ...
      t.forEach((e) => {
        if (!De(n, e) && !a) {
          ...
          (r.forEach((e) => {
            ...
            r.some((e) => e.x === t.x && e.y === t.y) || r.push(t),
            (a = !0));
        } else ((i = e), a || r.push(e));
      }),
      r
  ...
  Ae = t(function (t, n, i, a, o, s, u) {
    ...
    (h?.intersect &&
      m?.intersect &&
      ((d = d.slice(1, i.points.length - 1)),
      d.unshift(m.intersect(d[0])),
      d.push(h.intersect(d[d.length - 1]))),
      i.toCluster &&
        (e.debug(`to cluster abc88`, a[i.toCluster]),
        (d = ke(i.points, a[i.toCluster].node)),
        (p = !0)),
      i.fromCluster &&
        (e.debug(`from cluster abc88`, a[i.fromCluster]),
        (d = ke(d.reverse(), a[i.fromCluster].node).reverse()),
        (p = !0)));
    ...
    let C = t
        ...
        .attr(`d`, b(g))
        .attr(`id`, i.id)
        .attr(`class`, ` ` + S + (i.classes ? ` ` + i.classes : ``))
        .attr(`style`, i.style),
      w = ``;
    ((f().flowchart.arrowMarkerAbsolute || f().state.arrowMarkerAbsolute) &&
      (w = l(!0)),
      Se(C, i, w, u, o));
    let T = {};
    return (p && (T.updatedPath = d), (T.originalPath = i.points), T);
  }, `insertEdge`),
  je = t((e) => {
    let t = new Set();
    for (let n of e)
...
t(Fe, `intersectEllipse`);
var Ie = Fe;
function Le(e, t, n) {
  return Ie(e, t, t, n);
}
t(Le, `intersectCircle`);
var Re = Le;
function ze(e, t, n, r) {
  var i = t.y - e.y,
    a,
...
function He(e, t, n) {
  ...
  for (
    ...
    var d = t[u],
      ...
      p = Be(e, n, { x: c + d.x, y: l + d.y }, { x: c + f.x, y: l + f.y });
    p && a.push(p);
  }
  return a.length
    ? (a.length > 1 &&
...
var K = {
  ...
  q = t(async (e, t, r, i) => {
    let a = f(),
      s,
      c = t.useHtmlLabels || g(a);
    s = r || `node default`;
    let l = e
        .insert(`g`)
        .attr(`class`, s)
        .attr(`id`, t.domId || t.id),
      d = l.insert(`g`).attr(`class`, `label`).attr(`style`, t.labelStyle),
      p;
    p =
      t.labelText === void 0
        ? ``
    ...
    m =
      t.labelType === `markdown`
        ...
        : await V(d, u(o(p), a), t.labelStyle, !1, i);
    let h = m.getBBox(),
      _ = t.padding / 2;
    if (g(a)) {
      let e = m.children[0],
    ...
    return (
      c
        ...
        : d.attr(`transform`, `translate(0, ` + -h.height / 2 + `)`),
      t.centerLabel &&
        d.attr(
          `transform`,
          `translate(` + -h.width / 2 + `, ` + -h.height / 2 + `)`,
      ...
      { shapeSvg: l, bbox: h, halfPadding: _, label: d }
    );
  }, `labelHelper`),
  J = t((e, t) => {
...
var Ue = t(async (t, n) => {
    n.useHtmlLabels || g(f()) || (n.centerLabel = !0);
    let {
      shapeSvg: r,
      bbox: i,
      halfPadding: a,
    } = await q(t, n, `node ` + n.classes, !0);
    ...
    return (
      o
        ...
        .attr(`x`, -i.width / 2 - a)
        .attr(`y`, -i.height / 2 - a)
        .attr(`width`, i.width + n.padding)
        .attr(`height`, i.height + n.padding),
      J(n, o),
  ...
  We = t((e) => (e ? ` ` + e : ``), `formatClass`),
  X = t(
    (e, t) => `${t || `node default`}${We(e.classes)} ${We(e.class)}`,
    `getClassesFromNode`,
  ),
  Ge = t(async (t, n) => {
    let { shapeSvg: r, bbox: i } = await q(t, n, X(n, void 0), !0),
      a = i.width + n.padding + (i.height + n.padding),
      o = [
        { x: a / 2, y: 0 },
        { x: a, y: -a / 2 },
        { x: a / 2, y: -a },
    ...
    return (
      J(
        ...
        n
          ...
          .attr(`style`, t.style)
          .attr(`d`, c)
          .attr(`transform`, `translate(` + -i / 2 + `,` + -(s / 2 + o) + `)`),
      ),
      (t.intersect = function (e) {
        let n = K.rect(t, e),
          r = n.x - t.x;
  ...
  nt = t(async (t, n) => {
    let {
        ...
        bbox: i,
        halfPadding: a,
      } = await q(t, n, `node ` + n.classes + ` ` + n.class, !0),
      o = r.insert(`rect`, `:first-child`),
      s = n.positioned ? n.width : i.width + n.padding,
      c = n.positioned ? n.height : i.height + n.padding,
      l = n.positioned ? -s / 2 : -i.width / 2 - a,
      u = n.positioned ? -c / 2 : -i.height / 2 - a;
    if (
      (o
      ...
      (n.props.borders && (Z(o, n.props.borders, s, c), t.delete(`borders`)),
        t.forEach((t) => {
  ...
  it = t(async (t, n) => {
    ...
    if (
      (i.attr(`width`, 0).attr(`height`, 0),
      r.attr(`class`, `label edgeLabel`),
      n.props)
    ) {
      let t = new Set(Object.keys(n.props));
      (n.props.borders && (Z(i, n.props.borders, 0, 0), t.delete(`borders`)),
        t.forEach((t) => {
          e.warn(`Unknown node property ${t}`);
        }));
    }
...
function Z(n, r, i, a) {
  ...
  (r.includes(`t`) ? (e.debug(`add top border`), s(i)) : c(i),
    r.includes(`r`) ? (e.debug(`add right border`), s(a)) : c(a),
    r.includes(`b`) ? (e.debug(`add bottom border`), s(i)) : c(i),
    r.includes(`l`) ? (e.debug(`add left border`), s(a)) : c(a),
    n.attr(`stroke-dasharray`, o.join(` `)));
}
...
var at = t(async (t, r) => {
    ...
    let a = t
      ...
      o = a.insert(`rect`, `:first-child`),
      s = a.insert(`line`),
      c = a.insert(`g`).attr(`class`, `label`),
      l = r.labelText.flat ? r.labelText.flat() : r.labelText,
      u = ``;
    ((u = typeof l == `object` ? l[0] : l),
      e.info(`Label text abc79`, u, l, typeof l == `object`));
    let d = await V(c, u, r.labelStyle, !0, !0),
      p = { width: 0, height: 0 };
    if (g(f())) {
      let e = d.children[0],
        t = n(d);
    ...
    let m = l.slice(1, l.length),
      h = d.getBBox(),
      _ = await V(c, m.join ? m.join(`<br/>`) : m, r.labelStyle, !0, !0);
    if (g(f())) {
      let e = _.children[0],
        t = n(_);
      ((p = e.getBoundingClientRect()),
    ...
    return (
      n(_).attr(
        `transform`,
        `translate( ` +
          (p.width > h.width ? 0 : (h.width - p.width) / 2) +
          `, ` +
          (h.height + v + 5) +
          `)`,
      ),
      ...
      c.attr(
        `transform`,
        `translate(` + -p.width / 2 + `, ` + (-p.height / 2 - v + 3) + `)`,
      ),
      o
        .attr(`class`, `outer title-state`)
        .attr(`x`, -p.width / 2 - v)
        .attr(`y`, -p.height / 2 - v)
        .attr(`width`, p.width + r.padding)
        .attr(`height`, p.height + r.padding),
      s
        .attr(`class`, `divider`)
        .attr(`x1`, -p.width / 2 - v)
        .attr(`x2`, p.width / 2 + v)
        .attr(`y1`, -p.height / 2 - v + h.height + v)
        .attr(`y2`, -p.height / 2 - v + h.height + v),
      J(r, o),
  ...
  st = t(async (t, n) => {
    ...
    return (
      ...
      (n.intersect = function (t) {
        return (
          e.info(`Circle intersect`, n, i.width / 2 + a, t),
          K.circle(n, i.width / 2 + a, t)
        );
      }),
      r
    );
  ...
  ct = t(async (t, n) => {
    let {
      ...
      c = o.insert(`circle`);
    return (
      o.attr(`class`, n.class),
      s
        .attr(`style`, n.style)
        .attr(`rx`, n.rx)
        .attr(`ry`, n.ry)
        .attr(`r`, i.width / 2 + a + 5)
        .attr(`width`, i.width + n.padding + 10)
        .attr(`height`, i.height + n.padding + 10),
      c
        .attr(`style`, n.style)
        .attr(`rx`, n.rx)
        .attr(`ry`, n.ry)
        ...
        .attr(`width`, i.width + n.padding)
        .attr(`height`, i.height + n.padding),
      e.info(`DoubleCircle main`),
      J(n, s),
      (n.intersect = function (t) {
        return (
          e.info(`DoubleCircle intersect`, n, i.width / 2 + a + 5, t),
          K.circle(n, i.width / 2 + a + 5, t)
        );
      }),
      r
    );
  ...
  ft = {
    ...
    class_box: t(async (e, t) => {
      ...
      t.classData.annotations[0] && ((u += _.height + 4), (l += _.width));
      ...
      t.classData.type !== void 0 &&
        ...
        (g(f())
          ? (v += `&lt;` + t.classData.type + `&gt;`)
          : (v += `<` + t.classData.type + `>`));
      let y = await V(d, v, t.labelStyle, !0, !0);
      ...
      if (g(f())) {
        ...
        ((b = e.getBoundingClientRect()),
          t.attr(`width`, b.width),
          t.attr(`height`, b.height));
      }
      ...
      (t.classData.members.forEach(async (e) => {
        ...
        let a = await V(d, i, r.cssStyle ? r.cssStyle : t.labelStyle, !0, !0),
          o = a.getBBox();
        if (g(f())) {
          let e = a.children[0],
            t = n(a);
  ...
  pt = t(async (e, t, n) => {
    ...
    return (
      ...
      (Q[t.id] = r),
      t.haveCallback &&
        Q[t.id].attr(`class`, Q[t.id].attr(`class`) + ` clickable`),
      r
    );
  }, `insertNode`),
  mt = t((t) => {
...
function ht(e, t, n = !1) {
  let r = e,
    a = `default`;
  ((r?.classes?.length || 0) > 0 && (a = (r?.classes ?? []).join(` `)),
    (a += ` flowchart-label`));
  let o = 0,
    s = ``,
    c;
  ...
  let l = i(r?.styles ?? []),
    u = r.label,
    d = r.size ?? { width: 0, height: 0, x: 0, y: 0 },
    f = t.getDiagramId();
  return {
...
t(ht, `getNodeFromBlock`);
async function gt(e, t, n) {
  let r = ht(t, n, !1);
  if (r.type === `group`) return;
  let i = await pt(e, r, { config: _() }),
    a = i.node().getBBox(),
    o = n.getBlock(r.id);
...
t(gt, `calculateBlockSize`);
async function _t(e, t, n) {
  let r = ht(t, n, !0);
  n.getBlock(r.id).type !== `space` &&
    (await pt(e, r, { config: _() }), (t.intersect = r?.intersect), mt(r));
}
t(_t, `insertBlockPositioned`);
...
t(vt, `calculateBlockSizes`);
async function yt(e, t, n) {
  await $(e, t, n, _t);
}
t(yt, `insertBlocks`);
async function bt(e, t, n, r, i) {
  let a = new T({ multigraph: !0, compound: !0 });
  a.setGraph({
    rankdir: `TB`,
    nodesep: 10,
    ranksep: 10,
      ...
      if (t?.size && o?.size) {
        ...
        (Ae(
          ...
          n.label &&
            ...
            Ee({ ...n, x: c[1].x, y: c[1].y }, { originalPath: c })));
      }
    }
}
t(bt, `insertEdges`);
var xt = {
  ...
  db: he,
  renderer: {
    draw: t(async function (t, r, i, a) {
      let { securityLevel: o, block: s } = _(),
        c = a.db;
      c.setDiagramId(r);
      let l;
      o === `sandbox` && (l = n(`#i` + r));
      let u = n(o === `sandbox` ? l.nodes()[0].contentDocument.body : `body`),
        d = o === `sandbox` ? u.select(`[id="${r}"]`) : n(`[id="${r}"]`);
      ye(d, [`point`, `circle`, `cross`], a.type, r);
      let f = c.getBlocks(),
        m = c.getBlocksFlat(),
        h = c.getEdges(),
      ...
      await vt(g, f, c);
      let v = xe(c);
      if ((await yt(g, f, c), await bt(g, h, m, c, r), v)) {
        let t = v,
          n = Math.max(1, Math.round(0.125 * (t.width / t.height))),
          r = t.height + n + 10,
          i = t.width + 10,
          { useMaxWidth: a } = s;
        (p(d, r, i, !!a),
          e.debug(`Here Bounds`, v, t),
          d.attr(
            `viewBox`,
...
//# sourceMappingURL=blockDiagram-DXYQGD6D-BQLFPN94.js.map
