...
function f(e, t, n, r) {
  ...
  function o(e, r, i, o, s, c) {
    if (e !== i || r !== o) {
      var l = s.push(`translate(`, null, t, null, n);
      c.push({ i: l - 4, x: a(e, i) }, { i: l - 2, x: a(r, o) });
    } else (i || o) && s.push(`translate(` + i + t + o + n);
  }
  function s(e, t, n, o) {
    e === t
      ? t && n.push(i(n) + `rotate(` + t + r)
      : (e - t > 180 ? (t += 360) : t - e > 180 && (e += 360),
        o.push({ i: n.push(i(n) + `rotate(`, null, r) - 2, x: a(e, t) }));
  }
  function c(e, t, n, o) {
    e === t
      ? t && n.push(i(n) + `skewX(` + t + r)
      : o.push({ i: n.push(i(n) + `skewX(`, null, r) - 2, x: a(e, t) });
  }
  function l(e, t, n, r, o, s) {
    if (e !== n || t !== r) {
      var c = o.push(i(o) + `scale(`, null, `,`, null, `)`);
      s.push({ i: c - 4, x: a(e, n) }, { i: c - 2, x: a(t, r) });
    } else (n !== 1 || r !== 1) && o.push(i(o) + `scale(` + n + `,` + r + `)`);
  }
  return function (t, n) {
    var r = [],
      i = [];
...
//# sourceMappingURL=src-DwoQmh2p.js.map
