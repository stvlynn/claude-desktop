...
import { Dt as j, Et as se } from "./workbook-DfQVQ3Vw.js";
import {
  $ as ce,
  B as le,
  F as ue,
...
function be(e) {
  let { children: t, id: n, items: r, strategy: i = Te, disabled: o = !1 } = e,
    {
      active: c,
      dragOverlay: l,
      droppableRects: u,
  ...
  let w = (0, I.useMemo)(
    ...
    [v, m, C.draggable, C.droppable, S, g, y, u, h, i],
  );
  return I.createElement(De.Provider, { value: w }, t);
}
function xe(e) {
...
function Se(e) {
  let {
    ...
    T = m.indexOf(l),
    ee = (0, I.useMemo)(
      () => ({ sortable: { containerId: g, index: T, items: m }, ...a }),
      [g, a, T, m],
    ),
    te = (0, I.useMemo)(() => m.slice(m.indexOf(l)), [m, l]),
    {
      rect: ne,
      node: E,
      isOver: D,
      ...
      resizeObserverConfig: { updateMeasurementsFor: te, ...f },
    }),
    {
      active: k,
      activatorEvent: A,
    ...
    pe = de
      ...
      : null,
    N =
      ge(_) && ge(x) ? s({ id: l, items: m, activeIndex: _, overIndex: x }) : T,
    P = k?.id,
    F = (0, I.useRef)({ activeId: P, items: m, newIndex: N, containerId: g }),
    me = m !== F.current.items,
    he = t({
      active: k,
      containerId: g,
      isDragging: j,
    ...
    _e = xe({ disabled: !he, index: T, node: E, rect: ne });
  return (
    (0, I.useEffect)(() => {
      (M && F.current.newIndex !== N && (F.current.newIndex = N),
        g !== F.current.containerId && (F.current.containerId = g),
        m !== F.current.items && (F.current.items = m));
    }, [M, N, g, m]),
    (0, I.useEffect)(() => {
  ...
  function ve() {
    if (_e || (me && F.current.newIndex === T)) return Me;
    if (!((fe && !c(A)) || !p) && (M || he))
      return i.Transition.toString({ ...p, property: je });
  }
}
function Ce(e, t) {
...
`),
      ...
      (gn = (0, H.forwardRef)(function (
        ...
        let d = (0, H.useRef)(null),
          ...
          j = h ? Jt : Yt,
          se = ie == null ? void 0 : ie + (Jt - j) / 2 + qt,
          le = (0, H.useCallback)(
            (e) => {
              if (((d.current = e), A.setFloating(e), typeof u == `function`)) {
                u(e);
                return;
              }
              u && (u.current = e);
        ...
        if (
          ...
          (0, H.useEffect)(() => {
            e && oe?.();
          }, [e?.height, e?.left, e?.top, e?.width, r, h, oe]),
          !e)
        )
          return null;
        let M = (0, U.jsx)(`div`, {
          ...
          style: { position: ae, left: re ?? 0, top: se ?? 0, width: Wt },
          onMouseDown: (e) => {
            e.stopPropagation();
          },
                    ...
                    ? (0, U.jsxs)(`div`, {
                        ...
                        children: [
                          (0, U.jsx)(`button`, {
                            ...
                            onClick: c,
                            children: (0, U.jsx)(ce, { className: `size-4` }),
                          }),
                          (0, U.jsxs)(`div`, {
        ...
        return n ? (0, Ut.createPortal)(M, n) : M;
      })));
  });
function vn(e, t, n) {
...
function Wn({ trigger: e, actions: t }) {
  return (0, q.jsxs)(x, {
    children: [
      (0, q.jsx)(_, { asChild: !0, children: e }),
      (0, q.jsx)(E, {
        children: (0, q.jsx)(b, {
...
//# sourceMappingURL=popcorn-electron-surface-style-YXPnYoQ0.js.map
