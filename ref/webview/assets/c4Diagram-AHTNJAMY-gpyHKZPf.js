...
import { _ as v, n as y, t as b, u as ee } from "./chunk-5PVQY5BW-MckrTAit.js";
import { a as x, l as S, s as C } from "./chunk-YZCP3GAM-B39030I6.js";
function w(e, t, n, r, i) {
  if (!t[e].width)
    if (n)
      ((t[e].text = v(t[e].text, i, r)),
        (t[e].textLines = t[e].text.split(g.lineBreakRegex).length),
        (t[e].width = i),
        (t[e].height = b(t[e].text, r)));
    else {
      let n = t[e].text.split(g.lineBreakRegex);
      t[e].textLines = n.length;
      let i = 0;
      ((t[e].height = 0), (t[e].width = 0));
      for (let a of n)
        ((t[e].width = Math.max(y(a, r), t[e].width)),
          (i = b(a, r)),
          (t[e].height = t[e].height + i));
    }
}
function T(e, t, n, r, i) {
  let a = new Fe(i);
  a.data.widthLimit = n.data.widthLimit / Math.min(Pe, r.length);
  for (let [o, s] of r.entries()) {
    let r = 0;
    ((s.image = { width: 0, height: 0, Y: 0 }),
      s.sprite &&
        ((s.image.width = 48),
        (s.image.height = 48),
        (s.image.Y = r),
        (r = s.image.Y + s.image.height)));
    let l = s.wrap && Q.wrap,
      u = Re(Q);
    if (
      ((u.fontSize += 2),
      (u.fontWeight = `bold`),
      w(`label`, s, l, u, a.data.widthLimit),
      (s.label.Y = r + 8),
      (r = s.label.Y + s.label.height),
      s.type &&
        s.type.text !== `` &&
        ((s.type.text = `[` + s.type.text + `]`),
        w(`type`, s, l, Re(Q), a.data.widthLimit),
        (s.type.Y = r + 5),
        (r = s.type.Y + s.type.height)),
      s.descr && s.descr.text !== ``)
    ) {
      let e = Re(Q);
      ((e.fontSize -= 2),
        w(`descr`, s, l, e, a.data.widthLimit),
        (s.descr.Y = r + 20),
        (r = s.descr.Y + s.descr.height));
    }
    if (o == 0 || o % Pe === 0) {
      let e = n.data.startx + Q.diagramMarginX,
        t = n.data.stopy + Q.diagramMarginY + r;
      a.setData(e, e, t, t);
    } else {
      let e =
          a.data.stopx === a.data.startx
            ? a.data.startx
            : a.data.stopx + Q.diagramMarginX,
        t = a.data.starty;
      a.setData(e, e, t, t);
    }
    a.name = s.alias;
    let d = i.db.getC4ShapeArray(s.alias),
      f = i.db.getC4ShapeKeys(s.alias);
    (f.length > 0 && Ve(a, e, d, f), (t = s.alias));
    let p = i.db.getBoundaries(t);
    (p.length > 0 && T(e, t, a, p, i),
      s.alias !== `global` && Be(e, s, a),
      (n.data.stopy = Math.max(a.data.stopy + Q.c4ShapeMargin, n.data.stopy)),
      (n.data.stopx = Math.max(a.data.stopx + Q.c4ShapeMargin, n.data.stopx)),
      (je = Math.max(je, n.data.stopx)),
      (Me = Math.max(Me, n.data.stopy)));
  }
}
var E,
  D,
      ...
      var e = a(function (e, t, n, r) {
        ...
        ce = {
          ...
          performAction: a(function (e, t, n, r, i, a, o) {
            ...
            switch (i) {
              ...
              case 19:
                ...
                break;
              case 20:
                (r.setAccDescription(a[s].substring(15)),
                  (this.$ = a[s].substring(15)));
                break;
              case 21:
              ...
              case 23:
                ...
                break;
              case 28:
                (a[s].splice(2, 0, `ENTERPRISE`),
                  r.addPersonOrSystemBoundary(...a[s]),
                  (this.$ = a[s]));
                break;
              case 29:
                (a[s].splice(2, 0, `SYSTEM`),
                  r.addPersonOrSystemBoundary(...a[s]),
                  (this.$ = a[s]));
                break;
              case 30:
                ...
                break;
              case 31:
                (a[s].splice(2, 0, `CONTAINER`),
                  r.addContainerBoundary(...a[s]),
                  (this.$ = a[s]));
                break;
              case 32:
              ...
              case 39:
                ...
                break;
              case 40:
                (r.addPersonOrSystem(`external_person`, ...a[s]),
                  (this.$ = a[s]));
                break;
              case 41:
              ...
              case 43:
                ...
                break;
              case 44:
                (r.addPersonOrSystem(`external_system`, ...a[s]),
                  (this.$ = a[s]));
                break;
              case 45:
                (r.addPersonOrSystem(`external_system_db`, ...a[s]),
                  (this.$ = a[s]));
                break;
              case 46:
                (r.addPersonOrSystem(`external_system_queue`, ...a[s]),
                  (this.$ = a[s]));
                break;
              case 47:
              ...
              case 49:
                ...
                break;
              case 50:
                (r.addContainer(`external_container`, ...a[s]),
                  (this.$ = a[s]));
                break;
              case 51:
                (r.addContainer(`external_container_db`, ...a[s]),
                  (this.$ = a[s]));
                break;
              case 52:
                (r.addContainer(`external_container_queue`, ...a[s]),
                  (this.$ = a[s]));
                break;
              case 53:
              ...
              case 55:
                ...
                break;
              case 56:
                (r.addComponent(`external_component`, ...a[s]),
                  (this.$ = a[s]));
                break;
              case 57:
                (r.addComponent(`external_component_db`, ...a[s]),
                  (this.$ = a[s]));
                break;
              case 58:
                (r.addComponent(`external_component_queue`, ...a[s]),
                  (this.$ = a[s]));
                break;
              case 60:
              ...
              case 68:
                ...
                break;
              case 69:
                (r.updateRelStyle(`update_rel_style`, ...a[s]),
                  (this.$ = a[s]));
                break;
              case 70:
                (r.updateLayoutConfig(`update_layout_config`, ...a[s]),
                  (this.$ = a[s]));
                break;
              case 71:
                this.$ = [a[s]];
          ...
          table: [
            ...
            { 27: [1, 79] },
            e(re, [2, 23]),
            { 35: 80, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 86, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 87, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 88, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 89, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 90, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 91, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 92, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 93, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 94, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 95, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 96, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 97, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 98, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 99, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 100, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 101, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 102, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 103, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 104, 75: 81, 76: G, 77: K, 79: q, 80: J },
            e(Y, [2, 59]),
            { 35: 105, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 106, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 107, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 108, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 109, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 110, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 111, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 112, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 113, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 114, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 115, 75: 81, 76: G, 77: K, 79: q, 80: J },
            {
              20: 116,
              29: 49,
              30: 61,
            ...
            { 12: [1, 118], 33: [1, 117] },
            { 35: 119, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 120, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 121, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 122, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 123, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 124, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 35: 125, 75: 81, 76: G, 77: K, 79: q, 80: J },
            { 14: [1, 126] },
            { 14: [1, 127] },
            { 14: [1, 128] },
            { 14: [1, 129] },
            ...
            e(re, [2, 22]),
            e(Y, [2, 39]),
            e(ie, [2, 71], { 75: 81, 35: 132, 76: G, 77: K, 79: q, 80: J }),
            e(ae, [2, 73]),
            { 78: [1, 133] },
            e(ae, [2, 75]),
            e(ae, [2, 76]),
          ...
          parse: a(function (e) {
            ...
            (g.setInput(e, _.yy),
              (_.yy.lexer = g),
              (_.yy.parser = this),
              g.yylloc === void 0 && (g.yylloc = {}));
            var y = g.yylloc;
            o.push(y);
            var b = g.options && g.options.ranges;
            typeof _.yy.parseError == `function`
...
` +
      ...
      return (a(le, `Parser`), (le.prototype = ce), (ce.Parser = le), new le());
    })()),
    (D.parser = D),
    (O = D),
    (k = []),
    ...
    (H = a(function (e, t, n, r, i, a, o, s, l) {
      if (e == null || t == null || n == null || r == null) return;
      let u = {},
        d = P.find((e) => e.from === t && e.to === n);
      if (
        (d ? (u = d) : P.push(u),
        (u.type = e),
        (u.from = t),
    ...
    (U = a(function (e, t, n, r, i, a, o) {
      if (t === null || n === null) return;
      let s = {},
        l = k.find((e) => e.alias === t);
      if (
        (l && t === l.alias ? (s = l) : ((s.alias = t), k.push(s)),
        n == null ? (s.label = { text: `` }) : (s.label = { text: n }),
        r == null)
      )
        s.descr = { text: `` };
      ...
      ((s.typeC4Shape = { text: e }), (s.parentBoundary = j), (s.wrap = ge()));
    }, `addPersonOrSystem`)),
    (W = a(function (e, t, n, r, i, a, o, s) {
      if (t === null || n === null) return;
      let l = {},
        u = k.find((e) => e.alias === t);
      if (
        (u && t === u.alias ? (l = u) : ((l.alias = t), k.push(l)),
        n == null ? (l.label = { text: `` }) : (l.label = { text: n }),
        r == null)
      )
        l.techn = { text: `` };
      else if (typeof r == `object`) {
      ...
      ((l.wrap = ge()), (l.typeC4Shape = { text: e }), (l.parentBoundary = j));
    }, `addContainer`)),
    (te = a(function (e, t, n, r, i, a, o, s) {
      if (t === null || n === null) return;
      let l = {},
        u = k.find((e) => e.alias === t);
      if (
    ...
    (ne = a(function (e, t, n, r, i) {
      if (e === null || t === null) return;
      let a = {},
        o = N.find((t) => t.alias === e);
      if (
        (o && e === o.alias ? (a = o) : ((a.alias = e), N.push(a)),
      ...
      ((a.parentBoundary = j), (a.wrap = ge()), (M = j), (j = e), A.push(M));
    }, `addPersonOrSystemBoundary`)),
    (re = a(function (e, t, n, r, i) {
      if (e === null || t === null) return;
      let a = {},
        o = N.find((t) => t.alias === e);
      if (
    ...
    (G = a(function (e, t, n, r, i, a, o, s) {
      if (t === null || n === null) return;
      let l = {},
        u = N.find((e) => e.alias === t);
      if (
        (u && t === u.alias ? (l = u) : ((l.alias = t), N.push(l)),
        n == null ? (l.label = { text: `` }) : (l.label = { text: n }),
        r == null)
      )
        l.type = { text: `node` };
    ...
    (K = a(function () {
      ((j = M), A.pop(), (M = A.pop()), A.push(M));
    }, `popBoundaryParseStack`)),
    (q = a(function (e, t, n, r, i, a, o, s, l, u, d) {
      let f = k.find((e) => e.alias === t);
      if (
        !(f === void 0 && ((f = N.find((e) => e.alias === t)), f === void 0))
      ) {
        if (n != null)
          if (typeof n == `object`) {
            let [e, t] = Object.entries(n)[0];
    ...
    (J = a(function (e, t, n, r, i, a, o) {
      let s = P.find((e) => e.from === t && e.to === n);
      if (s !== void 0) {
        if (r != null)
          if (typeof r == `object`) {
            let [e, t] = Object.entries(r)[0];
    ...
    (ce = a(function (e) {
      return e == null ? k : k.filter((t) => t.parentBoundary === e);
    }, `getC4ShapeArray`)),
    (le = a(function (e) {
      return k.find((t) => t.alias === e);
    }, `getC4Shape`)),
    (ue = a(function (e) {
      return Object.keys(ce(e));
    }, `getC4ShapeKeys`)),
    (de = a(function (e) {
      return e == null ? N : N.filter((t) => t.parentBoundary === e);
    }, `getBoundaries`)),
    (fe = de),
    (pe = a(function () {
      return P;
    ...
    (_e = {
      addPersonOrSystem: U,
      addPersonOrSystemBoundary: ne,
      addContainer: W,
      addContainerBoundary: re,
      addComponent: te,
      addDeploymentNode: G,
      popBoundaryParseStack: K,
      addRel: H,
      updateElStyle: q,
      updateRelStyle: J,
      updateLayoutConfig: Y,
      autoWrap: ge,
      setWrap: he,
      getC4ShapeArray: ce,
      getC4Shape: le,
      ...
      getBoundaries: de,
      getBoundarys: fe,
      getCurrentBoundaryParse: oe,
      getParentBoundaryParse: se,
      getRels: pe,
      getTitle: me,
      getC4Type: B,
      getC4ShapeInRow: ie,
      getC4BoundaryInRow: ae,
      setAccTitle: l,
      getAccTitle: _,
      getAccDescription: f,
      setAccDescription: d,
      getConfig: a(() => p().c4, `getConfig`),
      clear: a(function () {
        ((k = []),
          (N = [
            {
    ...
    (ye = a(function (e, t, n, r, i, a) {
      let o = e.append(`image`);
      (o.attr(`width`, t), o.attr(`height`, n), o.attr(`x`, r), o.attr(`y`, i));
      let s = a.startsWith(`data:image/png;base64`) ? a : (0, E.sanitizeUrl)(a);
      o.attr(`xlink:href`, s);
    }, `drawImage`)),
    (be = a((e, t, n, r) => {
      let i = e.append(`g`),
      ...
      for (let e of t) {
        let t = e.textColor ? e.textColor : `#444444`,
          o = e.lineColor ? e.lineColor : `#444444`,
          s = e.offsetX ? parseInt(e.offsetX) : 0,
          l = e.offsetY ? parseInt(e.offsetY) : 0;
        if (a === 0) {
          let t = i.append(`line`);
          (t.attr(`x1`, e.startPoint.x),
            t.attr(`y1`, e.startPoint.y),
            t.attr(`x2`, e.endPoint.x),
            t.attr(`y2`, e.endPoint.y),
            t.attr(`stroke-width`, `1`),
            t.attr(`stroke`, o),
            t.style(`fill`, `none`),
            e.type !== `rel_b` &&
              t.attr(`marker-end`, `url(#` + r + `-arrowhead)`),
            (e.type === `birel` || e.type === `rel_b`) &&
              t.attr(`marker-start`, `url(#` + r + `-arrowend)`),
            (a = -1));
        } else {
          let t = i.append(`path`);
          (t
              ...
              `Mstartx,starty Qcontrolx,controly stopx,stopy `
                ...
                .replaceAll(
                  ...
                  e.startPoint.x +
                    ...
                    (e.endPoint.x - e.startPoint.x) / 4,
                )
                .replaceAll(
                  `controly`,
                  e.startPoint.y + (e.endPoint.y - e.startPoint.y) / 2,
                )
        ...
        (X(n)(
          e.label.text,
          i,
          Math.min(e.startPoint.x, e.endPoint.x) +
            Math.abs(e.endPoint.x - e.startPoint.x) / 2 +
            s,
    ...
    (xe = a(function (e, t, n) {
      let r = e.append(`g`),
        ...
        s = { "stroke-width": 1, "stroke-dasharray": `7.0,7.0` };
    ...
    (Se = a(function (e, t, n) {
      let r = t.bgColor ? t.bgColor : n[t.typeC4Shape.text + `_bg_color`],
        i = t.borderColor
          ? t.borderColor
          : n[t.typeC4Shape.text + `_border_color`],
      ...
      switch (
        ...
        case `person`:
        case `external_person`:
          ye(s, 48, 48, t.x + t.width / 2 - 24, t.y + t.image.Y, o);
          break;
      }
    ...
    (X = (function () {
      ...
      function t(e, t, n, i, a, o, s, l) {
        let { fontSize: u, fontFamily: d, fontWeight: f } = l,
          p = e.split(g.lineBreakRegex);
        for (let e = 0; e < p.length; e++) {
          let o = e * u - (u * (p.length - 1)) / 2,
            l = t
              .append(`text`)
              .attr(`x`, n + a / 2)
              .attr(`y`, i)
    ...
    (Z = {
      ...
      insertArrowHead: Ee,
      insertArrowEnd: De,
      insertArrowFilledHead: Oe,
      insertArrowCrossHead: ke,
      insertDatabaseIcon: Ce,
      insertComputerIcon: we,
      insertClockIcon: Te,
    }),
    (je = 0),
    (Me = 0),
    ...
    (Fe = class {
      ...
      insert(e) {
        ...
        let t =
          ...
          n = t + e.width,
          r = this.nextData.starty + e.margin * 2,
          i = r + e.height;
        ((t >= this.data.widthLimit ||
          n >= this.data.widthLimit ||
          this.nextData.cnt > Ne) &&
          ((t = this.nextData.startx + e.margin + Q.nextLinePaddingX),
          (r = this.nextData.stopy + e.margin * 2),
          (this.nextData.stopx = n = t + e.width),
          (this.nextData.starty = this.nextData.stopy),
          (this.nextData.stopy = i = r + e.height),
          (this.nextData.cnt = 1)),
          (e.x = t),
          (e.y = r),
    ...
    a(w, `calcC4ShapeTextWH`),
    (Be = a(function (e, t, n) {
      ((t.x = n.data.startx),
        (t.y = n.data.starty),
        (t.width = n.data.stopx - n.data.startx),
        (t.height = n.data.stopy - n.data.starty),
        (t.label.y = Q.c4ShapeMargin - 35));
      let r = t.wrap && Q.wrap,
        i = Re(Q);
      ((i.fontSize += 2),
        (i.fontWeight = `bold`),
        w(`label`, t, r, i, y(t.label.text, i)),
        Z.drawBoundary(e, t, Q));
    }, `drawBoundary`)),
    (Ve = a(function (e, t, n, r) {
      let i = 0;
      for (let a of r) {
        i = 0;
        let r = n[a],
          o = Le(Q, r.typeC4Shape.text);
        switch (
          ((o.fontSize -= 2),
          (r.typeC4Shape.width = y(`«` + r.typeC4Shape.text + `»`, o)),
          (r.typeC4Shape.height = o.fontSize + 2),
          (r.typeC4Shape.Y = Q.c4ShapePadding),
          (i = r.typeC4Shape.Y + r.typeC4Shape.height - 4),
        ...
        r.sprite &&
          ...
          (i = r.image.Y + r.image.height));
        let s = r.wrap && Q.wrap,
          l = Q.width - Q.c4ShapePadding * 2,
          u = Le(Q, r.typeC4Shape.text);
        ((u.fontSize += 2),
          (u.fontWeight = `bold`),
          w(`label`, r, s, u, l),
          (r.label.Y = i + 8),
          (i = r.label.Y + r.label.height),
          r.type && r.type.text !== ``
            ? ((r.type.text = `[` + r.type.text + `]`),
              w(`type`, r, s, Le(Q, r.typeC4Shape.text), l),
              (r.type.Y = i + 5),
              (i = r.type.Y + r.type.height))
            : r.techn &&
              r.techn.text !== `` &&
              ((r.techn.text = `[` + r.techn.text + `]`),
              w(`techn`, r, s, Le(Q, r.techn.text), l),
              (r.techn.Y = i + 5),
              (i = r.techn.Y + r.techn.height)));
        let d = i,
          f = r.label.width;
        (r.descr &&
          r.descr.text !== `` &&
          (w(`descr`, r, s, Le(Q, r.typeC4Shape.text), l),
          (r.descr.Y = i + 20),
          (i = r.descr.Y + r.descr.height),
          (f = Math.max(r.label.width, r.descr.width)),
          (d = i - r.descr.textLines * 5)),
          (f += Q.c4ShapePadding),
          (r.width = Math.max(r.width || Q.width, f, Q.width)),
          (r.height = Math.max(r.height || Q.height, d, Q.height)),
          (r.margin = r.margin || Q.c4ShapeMargin),
          e.insert(r),
          Z.drawC4Shape(t, r, Q));
      }
      e.bumpLastMargin(Q.c4ShapeMargin);
    }, `drawC4ShapeArray`)),
    ($ = class {
      static {
        a(this, `Point`);
      ...
      return (
        ...
        n > i && r < a
          ? (p =
              f >= d
                ? new $(n, s + (d * e.width) / 2)
                : new $(o - ((l / u) * e.height) / 2, r + e.height))
          : n < i && r < a
            ? (p =
                f >= d
                  ? new $(n + e.width, s + (d * e.width) / 2)
                  : new $(o + ((l / u) * e.height) / 2, r + e.height))
            : n < i && r > a
              ? (p =
                  f >= d
                    ? new $(n + e.width, s - (d * e.width) / 2)
                    : new $(o + ((e.height / 2) * l) / u, r))
              : n > i &&
                r > a &&
                (p =
                  f >= d
    ...
    (We = a(function (e, t, n, r, i) {
      ...
      for (let e of t) {
        ...
        let t = e.wrap && Q.wrap,
          i = ze(Q);
        r.db.getC4Type() === `C4Dynamic` &&
          (e.label.text = a + `: ` + e.label.text);
        let o = y(e.label.text, i);
        (w(`label`, e, t, i, o),
          e.techn &&
            e.techn.text !== `` &&
            ((o = y(e.techn.text, i)), w(`techn`, e, t, i, o)),
          e.descr &&
            e.descr.text !== `` &&
            ((o = y(e.descr.text, i)), w(`descr`, e, t, i, o)));
        let s = Ue(n(e.from), n(e.to));
        ((e.startPoint = s.startPoint), (e.endPoint = s.endPoint));
      }
      Z.drawRels(e, t, Q, i);
    }, `drawRels`)),
    a(T, `drawInsideBoundary`),
    (Ge = {
      drawPersonOrSystemArray: Ve,
      drawBoundary: Be,
      setConf: Ie,
      draw: a(function (e, n, r, a) {
        Q = p().c4;
        let o = p().securityLevel,
          s;
        o === `sandbox` && (s = t(`#i` + n));
        let l = t(o === `sandbox` ? s.nodes()[0].contentDocument.body : `body`),
          u = a.db;
        (a.db.setWrap(Q.wrap),
          (Ne = u.getC4ShapeInRow()),
          (Pe = u.getC4BoundaryInRow()),
          i.debug(`C:${JSON.stringify(Q, null, 2)}`));
        let d = o === `sandbox` ? l.select(`[id="${n}"]`) : t(`[id="${n}"]`);
        (Z.insertComputerIcon(d, n),
          Z.insertDatabaseIcon(d, n),
          Z.insertClockIcon(d, n));
        let f = new Fe(a);
        (f.setData(
          Q.diagramMarginX,
          Q.diagramMarginX,
          ...
          (f.data.widthLimit = screen.availWidth),
          (je = Q.diagramMarginX),
          (Me = Q.diagramMarginY));
        let h = a.db.getTitle();
        (T(d, ``, f, a.db.getBoundaries(``), a),
          Z.insertArrowHead(d, n),
          Z.insertArrowEnd(d, n),
          Z.insertArrowCrossHead(d, n),
          Z.insertArrowFilledHead(d, n),
          We(d, a.db.getRels(), a.db.getC4Shape, a, n),
          (f.data.stopx = je),
          (f.data.stopy = Me));
        let g = f.data,
          _ = g.stopy - g.starty + 2 * Q.diagramMarginY,
          v = g.stopx - g.startx + 2 * Q.diagramMarginX;
        (h &&
          d
            .append(`text`)
            .text(h)
            .attr(`x`, (g.stopx - g.startx) / 2 - 4 * Q.diagramMarginX)
            .attr(`y`, g.starty + Q.diagramMarginY),
          m(d, _, v, Q.useMaxWidth));
        let y = h ? 60 : 0;
        (d.attr(
          `viewBox`,
          g.startx -
...
`,
      ...
      init: a(({ c4: e, wrap: t }) => {
        (Ge.setConf(e), _e.setWrap(t));
      }, `init`),
    }));
})();
export { Ke as diagram };
//# sourceMappingURL=c4Diagram-AHTNJAMY-gpyHKZPf.js.map
