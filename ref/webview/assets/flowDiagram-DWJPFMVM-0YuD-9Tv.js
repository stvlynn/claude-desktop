...
import { h as r, s as i } from "./chunk-5PVQY5BW-DEldFBPA.js";
import {
  B as a,
  C as o,
  U as s,
...
import { t as _ } from "./channel-BlN9FjG1.js";
import "./dist-BO3qvbGN.js";
import "./chunk-U2HBQHQK-Di_FkPOF.js";
import { t as te } from "./chunk-FMBD7UC4-D9frSjxD.js";
import "./chunk-BSJP7CBP-DNK2-xIh.js";
import "./chunk-ZZ45TVLE-B85K-is4.js";
import { t as ne } from "./chunk-YZCP3GAM-BaYtHc5x.js";
import { t as re } from "./chunk-55IACEB6-DBIditYu.js";
import { t as v } from "./chunk-EDXVE4YY-C5jaZxVP.js";
import "./chunk-X2U36JSP-BczALf5_.js";
import { o as y } from "./chunk-5FUZZQ4R-CaM4fbt9.js";
import "./chunk-ENJZ2VHE-ed8XzF1H.js";
import { r as b, t as x } from "./chunk-336JU56O-Cutebe7h.js";
import { n as S, t as C } from "./chunk-XPW4576I-D84Ovjf9.js";
var w = `flowchart-`,
  T = class {
    constructor() {
...
` +
      ...
      let u = this.edges.find((e) => e.id === t);
      if (u) {
        let e = l;
      ...
      if (
        (f === void 0 &&
          (n === void 0 &&
            ...
            i != null &&
            e.warn(
              `Style applied to unknown node "${t}". This may indicate a typo. The node will be created automatically.`,
            ),
          (f = {
            id: t,
            labelType: `text`,
            domId: w + t + `-` + this.vertexCounter,
            styles: [],
            classes: [],
          }),
          this.vertices.set(t, f)),
        this.vertexCounter++,
        n === void 0
          ? f.text === void 0 && (f.text = t)
          : ((this.config = p()),
            (d = this.sanitizeText(n.text.trim())),
            (f.labelType = n.type),
            d.startsWith(`"`) &&
              d.endsWith(`"`) &&
    ...
    addSingleLink(t, n, r, a) {
      ...
      if (
        (s !== void 0 &&
          ...
          (o.labelType = this.sanitizeNodeLabelType(s.type))),
        r !== void 0 &&
          ((o.type = r.type),
          (o.stroke = r.stroke),
        ...
        let e = this.edges.filter(
          (e) => e.start === o.start && e.end === o.end,
        );
        e.length === 0
          ? (o.id = i(o.start, o.end, { counter: 0, prefix: `L` }))
          : (o.id = i(o.start, o.end, { counter: e.length + 1, prefix: `L` }));
      }
      if (this.edges.length < (this.config.maxEdges ?? 500))
        (e.info(`Pushing edge...`), this.edges.push(o));
      else
...
You have to call mermaid.initialize.`);
    ...
    addLink(t, n, r) {
      ...
      e.info(`addLink`, t, n, i);
      for (let e of t)
        for (let a of n) {
          let o = e === t[t.length - 1],
            s = a === n[0];
          o && s
            ? this.addSingleLink(e, a, r, i)
            : this.addSingleLink(e, a, r, void 0);
        }
    }
    ...
    addClass(e, t) {
      ...
      e.split(`,`).forEach((e) => {
        ...
        (t === void 0 &&
          ((t = { id: e, styles: [], textStyles: [] }), this.classes.set(e, t)),
          n?.forEach((e) => {
            if (/color/.exec(e)) {
    ...
    setLink(e, t, n) {
      (e.split(`,`).forEach((e) => {
        ...
        i !== void 0 &&
          ((i.link = r.formatUrl(t, this.config)), (i.linkTarget = n));
      }),
    ...
    addSubGraph(n, r, i) {
      ...
      return (
        e.info(`Adding`, d.id, d.nodes, d.dir),
    ...
    destructLink(e, t) {
      ...
      if (t) {
        ...
        if (r.type === `arrow_open`) r.type = n.type;
          ...
          if (r.type !== n.type) return { type: `INVALID`, stroke: `INVALID` };
    ...
    getData() {
      ...
      for (let n = r.length - 1; n >= 0; n--) {
        ...
        t.push({
          ...
          parentId: a.get(i.id),
          padding: 8,
          cssCompiledStyles: this.getCompiledStyles(i.classes),
          cssClasses: i.classes.join(` `),
          shape: `rect`,
          dir: i.dir,
          isGroup: !0,
          look: e.look,
      ...
      return (
        s.forEach((t, r) => {
          let { arrowTypeStart: a, arrowTypeEnd: o } = this.destructEdgeType(
              t.type,
            ),
            c = [...(s.defaultStyle ?? [])];
          t.style && c.push(...t.style);
          let l = {
            id: i(t.start, t.end, { counter: r, prefix: `L` }, t.id),
  ...
  E = {
    ...
    draw: t(async function (t, n, i, a) {
      (e.info(`REF0:`), e.info(`Drawing state diagram (v2)`, n));
      let { securityLevel: o, flowchart: s, layout: c } = p();
      (a.db.setDiagramId(n), e.debug(`Before getData: `));
      let l = a.db.getData();
      e.debug(`Data: `, l);
      let u = re(n, o),
        d = a.db.getDirection();
      ((l.type = a.type),
        (l.layoutAlgorithm = x(c)),
      ...
      (r.insertTitle(
        ...
        v(u, f, `flowchart`, s?.useMaxWidth || !1));
    }, `draw`),
  },
  D = (function () {
    var e = t(function (e, t, n, r) {
      ...
      Se = [44, 60, 89, 102, 105, 106, 109, 111, 114, 115, 116],
      Ce = [1, 122],
      we = [1, 123],
      Te = [1, 125],
      Ee = [1, 124],
      De = [44, 60, 62, 74, 89, 102, 105, 106, 109, 111, 114, 115, 116],
      Oe = [1, 134],
      ke = [1, 148],
      Ae = [1, 149],
      je = [1, 150],
      ...
      Ze = [1, 157],
      I = [8, 9, 11],
      L = [8, 9, 10, 11, 14, 44, 60, 89, 105, 106, 109, 111, 114, 115, 116],
      R = [1, 177],
      z = [1, 173],
      B = [1, 174],
      V = [1, 178],
      ...
      $e = [10, 106],
      et = [31, 49, 51, 53, 55, 57, 62, 64, 66, 67, 69, 71, 116, 117, 118],
      G = [1, 248],
      K = [1, 246],
      q = [1, 250],
      J = [1, 244],
      ...
      rt = {
        ...
        performAction: t(function (e, t, n, r, i, a, o) {
          ...
          switch (i) {
            case 2:
              ...
              break;
            case 3:
              ((!Array.isArray(a[s]) || a[s].length > 0) && a[s - 1].push(a[s]),
                (this.$ = a[s - 1]));
              break;
            case 4:
            case 183:
            ...
            case 46:
              (r.addLink(a[s - 2].stmt, a[s], a[s - 1]),
                (this.$ = { stmt: a[s], nodes: a[s].concat(a[s - 2].nodes) }));
              break;
            case 47:
              (r.addLink(a[s - 3].stmt, a[s - 1], a[s - 2]),
                (this.$ = {
            ...
            case 79:
              ...
              break;
            case 80:
              this.$ = { text: a[s - 1].text + `` + a[s], type: a[s - 1].type };
              break;
            case 81:
        ...
        table: [
          ...
          e(a, [2, 10]),
          e(a, [2, 11]),
          { 8: [1, 55], 9: [1, 56], 10: k, 15: 54, 18: 57 },
          e(A, [2, 3]),
          e(A, [2, 4]),
          e(A, [2, 5]),
          e(A, [2, 6]),
          ...
          { 8: j, 9: M, 11: N, 21: 71 },
          { 8: j, 9: M, 11: N, 21: 72 },
          { 8: j, 9: M, 10: [1, 73], 11: N, 21: 74 },
          e(A, [2, 36]),
          { 35: [1, 75] },
          { 37: [1, 76] },
          e(A, [2, 39]),
          e(se, [2, 50], { 18: 77, 39: 78, 10: k, 40: ce }),
          { 10: [1, 80] },
          { 10: [1, 81] },
          { 10: [1, 82] },
          { 10: [1, 83] },
          ...
          e(A, [2, 41]),
          e(A, [2, 42]),
          e(Se, [2, 76], { 73: 117, 62: [1, 119], 74: [1, 118] }),
          { 76: 120, 79: 121, 80: Ce, 81: we, 116: Te, 119: Ee },
          { 75: [1, 126], 77: [1, 127] },
          e(De, [2, 83]),
          e(A, [2, 28]),
          e(A, [2, 29]),
          ...
          { 30: 171, 67: R, 80: z, 81: B, 82: 172, 116: V, 117: H, 118: U },
          { 30: 179, 67: R, 80: z, 81: B, 82: 172, 116: V, 117: H, 118: U },
          {
            30: 181,
            50: [1, 180],
            67: R,
          ...
          { 30: 182, 67: R, 80: z, 81: B, 82: 172, 116: V, 117: H, 118: U },
          { 30: 183, 67: R, 80: z, 81: B, 82: 172, 116: V, 117: H, 118: U },
          { 30: 184, 67: R, 80: z, 81: B, 82: 172, 116: V, 117: H, 118: U },
          { 109: [1, 185] },
          { 30: 186, 67: R, 80: z, 81: B, 82: 172, 116: V, 117: H, 118: U },
          {
            30: 187,
            65: [1, 188],
            67: R,
          ...
          { 30: 189, 67: R, 80: z, 81: B, 82: 172, 116: V, 117: H, 118: U },
          { 30: 190, 67: R, 80: z, 81: B, 82: 172, 116: V, 117: H, 118: U },
          { 30: 191, 67: R, 80: z, 81: B, 82: 172, 116: V, 117: H, 118: U },
          e(F, [2, 182]),
          e(a, [2, 20]),
          e(xe, [2, 25]),
          e(se, [2, 46], { 39: 192, 18: 193, 10: k, 40: ce }),
          e(Se, [2, 73], { 10: [1, 194] }),
          { 10: [1, 195] },
          { 30: 196, 67: R, 80: z, 81: B, 82: 172, 116: V, 117: H, 118: U },
          { 77: [1, 197], 79: 198, 116: Te, 119: Ee },
          e(Qe, [2, 79]),
          e(Qe, [2, 81]),
          e(Qe, [2, 82]),
          e(Qe, [2, 168]),
          e(Qe, [2, 169]),
          { 76: 199, 79: 121, 80: Ce, 81: we, 116: Te, 119: Ee },
          e(De, [2, 84]),
          {
            8: j,
            9: M,
          ...
          { 31: [1, 218], 67: R, 82: 219, 116: V, 117: H, 118: U },
          e(et, [2, 86]),
          e(et, [2, 88]),
          e(et, [2, 89]),
          e(et, [2, 153]),
          ...
          e(et, [2, 155]),
          e(et, [2, 156]),
          { 49: [1, 220], 67: R, 82: 219, 116: V, 117: H, 118: U },
          { 30: 221, 67: R, 80: z, 81: B, 82: 172, 116: V, 117: H, 118: U },
          { 51: [1, 222], 67: R, 82: 219, 116: V, 117: H, 118: U },
          { 53: [1, 223], 67: R, 82: 219, 116: V, 117: H, 118: U },
          { 55: [1, 224], 67: R, 82: 219, 116: V, 117: H, 118: U },
          { 57: [1, 225], 67: R, 82: 219, 116: V, 117: H, 118: U },
          { 60: [1, 226] },
          { 64: [1, 227], 67: R, 82: 219, 116: V, 117: H, 118: U },
          { 66: [1, 228], 67: R, 82: 219, 116: V, 117: H, 118: U },
          { 30: 229, 67: R, 80: z, 81: B, 82: 172, 116: V, 117: H, 118: U },
          { 31: [1, 230], 67: R, 82: 219, 116: V, 117: H, 118: U },
          {
            67: R,
            69: [1, 231],
            71: [1, 232],
          ...
          e(se, [2, 45], { 18: 156, 10: k, 40: Ze }),
          e(se, [2, 47], { 44: Xe }),
          e(Se, [2, 75]),
          e(Se, [2, 74]),
          { 62: [1, 235], 67: R, 82: 219, 116: V, 117: H, 118: U },
          e(Se, [2, 77]),
          e(Qe, [2, 80]),
          { 77: [1, 236], 79: 198, 116: Te, 119: Ee },
          { 30: 237, 67: R, 80: z, 81: B, 82: 172, 116: V, 117: H, 118: U },
          e(Ye, o, { 5: 238 }),
          e(W, [2, 102]),
          e(A, [2, 35]),
          {
          ...
          e(et, [2, 87]),
          e(P, [2, 57]),
          { 51: [1, 263], 67: R, 82: 219, 116: V, 117: H, 118: U },
          e(P, [2, 64]),
          e(P, [2, 59]),
          e(P, [2, 60]),
          e(P, [2, 61]),
          ...
          e(P, [2, 63]),
          e(P, [2, 65]),
          { 66: [1, 265], 67: R, 82: 219, 116: V, 117: H, 118: U },
          e(P, [2, 67]),
          e(P, [2, 68]),
          e(P, [2, 70]),
          e(P, [2, 69]),
          ...
          e(Se, [2, 78]),
          { 31: [1, 266], 67: R, 82: 219, 116: V, 117: H, 118: U },
          {
            6: 11,
            7: 12,
            8: s,
          ...
          e(I, [2, 120]),
          e(P, [2, 58]),
          { 30: 283, 67: R, 80: z, 81: B, 82: 172, 116: V, 117: H, 118: U },
          e(P, [2, 66]),
          e(Ye, o, { 5: 284 }),
          e(nt, [2, 131], {
            108: 270,
          ...
          e(I, [2, 114]),
          { 31: [1, 287], 67: R, 82: 219, 116: V, 117: H, 118: U },
          {
            6: 11,
            7: 12,
            8: s,
          ...
          for (var v, y, b, x, S, C = {}, w, T, E, D; ; ) {
            if (
              ...
              this.defaultActions[b]
                ...
                : ((v ??= re()), (x = s[b] && s[b][v])),
              x === void 0 || !x.length || !x[0])
            ) {
              var O = ``;
              for (w in ((D = []), s[b]))
                this.terminals_[w] &&
                  w > f &&
                  D.push(`'` + this.terminals_[w] + `'`);
              ((O = m.showPosition
                ? `Parse error on line ` +
                  (l + 1) +
                  `:
...
` +
    ...
    return (t(it, `Parser`), (it.prototype = rt), (rt.Parser = it), new it());
  })();
D.parser = D;
var O = D,
  ie = Object.assign({}, O);
...
export { k as diagram };
//# sourceMappingURL=flowDiagram-DWJPFMVM-0YuD-9Tv.js.map
