...
import { t as i } from "./src-CTe_6Jg1.js";
import { i as a, n as o, r as s } from "./chunk-AGHRB4JF-DVNPU_Qo.js";
import {
  A as c,
  C as l,
  E as u,
...
import { n as x, t as S } from "./chunk-426QAEUC-DkGEnnOP.js";
import { r as C, u as w } from "./chunk-5PVQY5BW-MckrTAit.js";
import { i as T, t as E } from "./chunk-U2HBQHQK-BfxUGRAz.js";
function D(e) {
  return e.type === `bar`;
}
function O(e) {
...
function ce() {
  ...
  return ((X.title = l()), K.build(J, X, Y, be));
}
function le() {
  return Y;
}
    ...
    (V = (function () {
      var e = o(function (e, t, n, r) {
        ...
        k = {
          ...
          table: [
            e(t, n, { 3: 1, 4: 2, 7: 4, 5: r, 34: i, 35: a, 36: s }),
            { 1: [3] },
            e(t, n, { 4: 2, 7: 4, 3: 8, 5: r, 34: i, 35: a, 36: s }),
            e(t, n, {
              4: 2,
              7: 4,
              6: 9,
            ...
            e(c, [2, 36]),
            { 1: [2, 1] },
            e(t, n, { 4: 2, 7: 4, 3: 21, 5: r, 34: i, 35: a, 36: s }),
            { 1: [2, 3] },
            e(c, [2, 5]),
            e(t, [2, 7], { 4: 22, 34: i, 35: a, 36: s }),
            {
              11: 23,
              37: 24,
              38: l,
...
` +
      ...
      return (o(A, `Parser`), (A.prototype = k), (k.Parser = A), new A());
    })()),
    (V.parser = V),
    (fe = V),
    o(D, `isBarPlot`),
    o(O, `isBandAxisData`),
    o(k, `isLinearAxisData`),
    (H = class {
      constructor(e) {
        this.parentGroup = e;
      }
      static {
        o(this, `TextDimensionCalculatorWithFont`);
      }
      getMaxDimension(e, t) {
        if (!this.parentGroup)
          return {
    ...
    (Q = !1),
    ($ = !1),
    o(N, `getChartDefaultThemeConfig`),
    o(P, `getChartDefaultConfig`),
    o(F, `getChartDefaultData`),
    o(I, `textSanitizer`),
    o(ee, `setTmpSVGG`),
    o(te, `setOrientation`),
    o(L, `setXAxisTitle`),
    o(R, `setXAxisRangeData`),
    o(ne, `setXAxisBand`),
    o(re, `setYAxisTitle`),
    o(ie, `setYAxisRangeData`),
    o(ae, `setYAxisRangeFromPlotData`),
    o(z, `transformDataWithoutCategory`),
    o(B, `getPlotColorFromPalette`),
    o(oe, `setLineData`),
    o(se, `setBarData`),
    o(ce, `getDrawableElem`),
    o(le, `getChartThemeConfig`),
    o(ue, `getChartConfig`),
    o(de, `getXYChartData`),
    (xe = {
      parser: fe,
      ...
      renderer: {
        draw: o((e, t, n, r) => {
          let i = r.db,
            ...
            c = i.getChartConfig(),
            l = i.getXYChartData().plots[0].data.map((e) => e[1]);
          function u(e) {
            return e === `top` ? `text-before-edge` : `middle`;
          }
          o(u, `getDominantBaseLine`);
          function d(e) {
...
` + e,
          ...
          (_(p, c.height, c.width, !0),
            p.attr(`viewBox`, `0 0 ${c.width} ${c.height}`),
            h.attr(`fill`, s.backgroundColor),
            i.setTmpSVGG(p.append(`g`).attr(`class`, `mermaid-tmp-group`)));
            ...
            switch (e.type) {
              case `rect`:
                if (
                  ...
                  let n = c.showDataLabelOutsideBar;
                  if (c.chartOrientation === `horizontal`) {
                    let r = function (e, t) {
                      let { data: n, label: r } = e;
                      return t * r.length * i <= n.width - a;
                    };
                    o(r, `fitsHorizontally`);
                    let i = 0.7,
                      a = 10,
                      c = e.data
                    ...
                    let i = e.data
                      ...
                      a = i.map((e) => {
                        let { data: t, label: n } = e,
                          i = t.width / (n.length * 0.7);
                        for (; !r(e, i, 10) && i > 0; ) --i;
                        return i;
                      }),
                      c = Math.floor(Math.min(...a)),
                      u = o(
                        (e) => (n ? e.data.y - 10 : e.data.y + 10),
                    ...
                    t.selectAll(`text`)
                      ...
                      .attr(`dominant-baseline`, n ? `auto` : `hanging`)
                      .attr(`fill`, s.dataLabelColor)
                      .attr(`font-size`, `${c}px`)
                      .text((e) => e.label);
                  }
...
//# sourceMappingURL=xychartDiagram-5P7HB3ND-B8nKEa9x.js.map
