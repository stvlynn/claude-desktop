...
import { g as m, o as h, u as g } from "./chunk-5PVQY5BW-Qrvqj614.js";
import { n as _, t as v } from "./chunk-55IACEB6-BFyRP0Hx.js";
import { n as y, t as b } from "./chunk-EDXVE4YY-DlRqzuH1.js";
import { i as x, n as S } from "./chunk-336JU56O-DPgo0D8b.js";
...
` +
              ...
              case P:
                {
                  ...
                  let n = s === `neo`,
                    l = {
                      ...
                      style: re,
                      labelStyle: ``,
                      label: f.sanitizeText(t.description ?? ``, d()),
                      arrowheadStyle: ie,
                      labelpos: ae,
                      labelType: oe,
                      thickness: L,
      ...
      (X = n((e, n, r, i, a, o, s, c) => {
        let l = n.id,
          ...
          m = E(u),
          h = d();
        if ((t.info(`dataFetcher parsedItem`, n, u, m), l !== `root`)) {
          let r = R;
      ...
      (Te = class {
        ...
        addState(
          ...
          if (
            ...
            let e = this.currentDocument.states.get(l);
            if (!e) throw Error(`State not found: ${l}`);
            ((e.note = a), (e.note.text = f.sanitizeText(e.note.text, d())));
          }
          (o &&
        ...
        addRelationObjs(e, t, n = ``) {
          ...
          (this.addState(
            ...
            this.currentDocument.relations.push({
              id1: r,
              id2: a,
              relationTitle: f.sanitizeText(n, d()),
            }));
        }
        addRelation(e, t, n) {
          if (typeof e == `object` && typeof t == `object`)
            ...
            (this.addState(r, i),
              ...
              this.currentDocument.relations.push({
                id1: r,
                id2: a,
                relationTitle: n ? f.sanitizeText(n, d()) : void 0,
              }));
          }
        }
        addDescription(e, t) {
          ...
          n?.descriptions?.push(f.sanitizeText(r, d()));
        }
        cleanupLabel(e) {
...
//# sourceMappingURL=chunk-OYMX7WX6-BZKCrNLI.js.map
