...
function b(e) {
  ...
  t[0] === n
    ? (o = t[1])
    : ((o = l(`relative inline-flex shrink-0 items-center justify-center`, n)),
      (t[0] = n),
      (t[1] = o));
  let c;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = r
        ? (0, S.jsx)(s, { className: `app-brand-logo-shimmer-base size-full` })
        : (0, S.jsx)(g, {
            "aria-hidden": `true`,
...
function E(e) {
  ...
  t[0] === f
    ? (p = t[1])
    : ((p = l(`flex items-center justify-center`, f)), (t[0] = f), (t[1] = p));
  let m;
  t[2] === !1 ? (m = t[3]) : ((m = () => {}), (t[2] = !1), (t[3] = m));
  let h;
  t[4] !== s || t[5] !== o
    ? ((h =
        o || s
  ...
  t[7] === c
    ? (g = t[8])
    : ((g = c ? (0, k.jsx)(b, { className: `size-14` }) : null),
      (t[7] = c),
      (t[8] = g));
  let _;
  t[9] !== !1 || t[10] !== a || t[11] !== u
    ? ((_ = null), (t[9] = !1), (t[10] = a), (t[11] = u), (t[12] = _))
    : (_ = t[12]);
  let v;
  t[13] !== g || t[14] !== _
    ? ((v = (0, k.jsxs)(`div`, {
...
export { g as a, m as c, T as i, A as n, _ as o, b as r, p as s, E as t };
//# sourceMappingURL=app-initial~app-main~remote-conversation-page~pull-requests-page~plugin-detail-page~new-thr~ny8xzqbh-ClcWSvU7.js.map
