...
import { h as r, p as i, r as a } from "./chunk-5PVQY5BW-DEldFBPA.js";
...
import { t as v } from "./chunk-4BX2VUAB-Bbd4mm_a.js";
import { t as y } from "./mermaid-parser.core-CY6PoT-_.js";
import { t as b } from "./chunk-QZHKN3VN-CPaFS3kj.js";
var x = { NORMAL: 0, REVERSE: 1, HIGHLIGHT: 2, MERGE: 3, CHERRY_PICK: 4 },
  ee = p.gitGraph,
  S = t(() => a({ ...ee, ..._().gitGraph }), `getConfig`),
  C = new b(() => {
    let e = S(),
      t = e.mainBranchName,
      n = e.mainBranchOrder;
...
var te = t(function (e) {
  ...
  ie = t(function (t) {
    ...
    let o = S();
    ((r = h.sanitizeText(r, o)),
      (n = h.sanitizeText(n, o)),
      (a = a?.map((e) => h.sanitizeText(e, o))));
    let s = {
    ...
    ((C.records.head = s),
      e.info(`main branch`, o.mainBranchName),
      C.records.commits.has(s.id) && e.warn(`Commit ID ${s.id} already exists`),
      C.records.commits.set(s.id, s),
      C.records.branches.set(C.records.currBranch, s.id),
      e.debug(`in pushCommit ` + s.id));
  }, `commit`),
  ae = t(function (t) {
    let n = t.name,
      r = t.order;
    if (((n = h.sanitizeText(n, S())), C.records.branches.has(n)))
      throw Error(
        `Trying to create an existing branch. (Help: Either use a new name if you want create a new branch or try using "checkout ${n}")`,
      );
    (C.records.branches.set(
      n,
      C.records.head == null ? null : C.records.head.id,
    ),
      C.records.branchConfig.set(n, { name: n, order: r }),
      E(n),
      e.debug(`in createBranch`));
  }, `branch`),
  oe = t((t) => {
    let n = t.branch,
      r = t.id,
      ...
      a = t.tags,
      o = S();
    ((n = h.sanitizeText(n, o)), (r &&= h.sanitizeText(r, o)));
    let s = C.records.branches.get(C.records.currBranch),
      c = C.records.branches.get(n),
      l = s ? C.records.commits.get(s) : void 0,
      u = c ? C.records.commits.get(c) : void 0;
    if (l && u && l.branch === n)
    ...
    ((C.records.head = f),
      C.records.commits.set(f.id, f),
      C.records.branches.set(C.records.currBranch, f.id),
      e.debug(C.records.branches),
      e.debug(`in mergeBranch`));
  }, `merge`),
  se = t(function (t) {
    let n = t.id,
      r = t.targetId,
    ...
    if (
      ((n = h.sanitizeText(n, o)),
      (r = h.sanitizeText(r, o)),
      (i = i?.map((e) => h.sanitizeText(e, o))),
      (a = h.sanitizeText(a, o)),
      !n || !C.records.commits.has(n))
    ) {
      let e = Error(
    ...
    if (!r || !C.records.commits.has(r)) {
      ...
      let l = {
        ...
        tags: i
          ? i.filter(Boolean)
          : [`cherry-pick:${s.id}${s.type === x.MERGE ? `|parent:${a}` : ``}`],
      };
      ((C.records.head = l),
        C.records.commits.set(l.id, l),
        C.records.branches.set(C.records.currBranch, l.id),
        e.debug(C.records.branches),
        e.debug(`in cherryPick`));
    }
  }, `cherryPick`),
  E = t(function (e) {
    if (((e = h.sanitizeText(e, S())), C.records.branches.has(e))) {
      C.records.currBranch = e;
      let t = C.records.branches.get(C.records.currBranch);
      t === void 0 || !t
        ? (C.records.head = null)
        : (C.records.head = C.records.commits.get(t) ?? null);
    } else {
      let t = Error(
...
t(D, `upsert`);
function O(t) {
  let n = t.reduce((e, t) => (e.seq > t.seq ? e : t), t[0]),
    r = ``;
  t.forEach(function (e) {
    e === n ? (r += `	*`) : (r += `	|`);
  });
  let i = [r, n.id, n.seq];
  for (let e in C.records.branches)
    C.records.branches.get(e) === n.id && i.push(e);
  if (
    (e.debug(i.join(` `)),
...
var ce = t(function () {
  ...
  A = {
    ...
    prettyPrint: ce,
    clear: le,
    getBranchesAsObjArray: ue,
    getBranches: de,
    getCommits: fe,
    getCommitsArray: k,
    getCurrentBranch: t(function () {
      return C.records.currBranch;
    }, `getCurrentBranch`),
    getDirection: t(function () {
  ...
  me = t((n, r) => {
    let i = {
      Commit: t((e) => r.commit(he(e)), `Commit`),
      Branch: t((e) => r.branch(ge(e)), `Branch`),
      Merge: t((e) => r.merge(_e(e)), `Merge`),
      Checkout: t((e) => r.checkout(ve(e)), `Checkout`),
      CherryPicking: t((e) => r.cherryPick(ye(e)), `CherryPicking`),
    }[n.$type];
  ...
  ge = t((e) => ({ name: e.name, order: e.order ?? 0 }), `parseBranch`),
  _e = t(
    (e) => ({
      branch: e.branch,
      id: e.id ?? ``,
  ...
  J = t((e) => {
    ...
    return (
      K === `BT`
        ? ((r = t((e, t) => e <= t, `comparisonFunc`)), (i = 1 / 0))
        : ((r = t((e, t) => e >= t, `comparisonFunc`)), (i = 0)),
      e.forEach((e) => {
  ...
  we = t((e, t, n) => {
    ...
    (e.forEach((e) => {
      ...
      (n.parents.length ? ((r = Ee(n)), (i = Math.max(r, i))) : a.push(n),
        De(n, r));
    }),
      (r = i),
      a.forEach((e) => {
  ...
  Ee = t((e) => Te(e) + M, `calculateCommitPosition`),
  De = t((e, t) => {
      ...
      if (
        ...
        K === `TB` || K === `BT`
          ? (o.attr(`x`, n.x - (c.width + 4 * N + 5)).attr(`y`, n.y - 12),
            s.attr(`x`, n.x - (c.width + 4 * N)).attr(`y`, n.y + c.height - 12))
  ...
  Y = t((e, n, r, i) => {
    ...
    (K === `BT` && (l && we(d, n, s), (d = d.reverse())),
      d.forEach((e) => {
        ...
        if (r) {
          let e = Me(t),
            n = t.customType ?? t.type;
          (ke(a, t, c, e, B.get(t.branch)?.index ?? 0, n),
            Ae(o, t, c, s, i),
            je(o, t, c, s));
        }
        (K === `TB` || K === `BT`
          ? V.set(t.id, { x: c.x, y: c.posWithOffset })
          : V.set(t.id, { x: c.posWithOffset, y: c.y }),
          (s = K === `BT` && l ? s + M : s + M + j),
          s > G && (G = s));
      }));
  }, `drawCommits`),
  Fe = t((e, n, r, i, a) => {
    let o = (K === `TB` || K === `BT` ? r.x < i.x : r.y < i.y)
        ? n.branch
        : e.branch,
      s = t((e) => e.branch === o, `isOnBranchToGetCurve`),
      c = t((t) => t.seq > e.seq && t.seq < n.seq, `isBetweenCommits`);
  ...
  Ie = t((e, t, n, r) => {
    ...
    if (o === void 0 || s === void 0)
      throw Error(`Commit positions not found for commits ${t.id} and ${n.id}`);
    let c = Fe(t, n, o, s, r),
      l = ``,
      u = ``,
      d = 0,
      p = 0,
      m = B.get(n.branch)?.index;
    ...
    if (c) {
      ...
      K === `TB`
        ? o.x < s.x
          ? (h = `M ${o.x} ${o.y} L ${n - d} ${o.y} ${u} ${n} ${o.y + p} L ${n} ${s.y - d} ${l} ${n + p} ${s.y} L ${s.x} ${s.y}`)
          : ((m = B.get(t.branch)?.index),
            (h = `M ${o.x} ${o.y} L ${n + d} ${o.y} ${l} ${n} ${o.y + p} L ${n} ${s.y - d} ${u} ${n - p} ${s.y} L ${s.x} ${s.y}`))
        : K === `BT`
          ? o.x < s.x
            ? (h = `M ${o.x} ${o.y} L ${n - d} ${o.y} ${l} ${n} ${o.y - p} L ${n} ${s.y + d} ${u} ${n + p} ${s.y} L ${s.x} ${s.y}`)
            : ((m = B.get(t.branch)?.index),
              (h = `M ${o.x} ${o.y} L ${n + d} ${o.y} ${u} ${n} ${o.y - p} L ${n} ${s.y + d} ${l} ${n - p} ${s.y} L ${s.x} ${s.y}`))
          : o.y < s.y
            ? (h = `M ${o.x} ${o.y} L ${o.x} ${e - d} ${l} ${o.x + p} ${e} L ${s.x - d} ${e} ${u} ${s.x} ${e + p} L ${s.x} ${s.y}`)
            : ((m = B.get(t.branch)?.index),
              (h = `M ${o.x} ${o.y} L ${o.x} ${e + d} ${u} ${o.x + p} ${e} L ${s.x - d} ${e} ${l} ${s.x} ${e - p} L ${s.x} ${s.y}`));
    } else
      ((l = `A 20 20, 0, 0, 0,`),
        (u = `A 20 20, 0, 0, 1,`),
        (d = 20),
        ...
        K === `TB`
          ? (o.x < s.x &&
              (h =
                n.type === x.MERGE && t.id !== n.parents[0]
                  ? `M ${o.x} ${o.y} L ${o.x} ${s.y - d} ${l} ${o.x + p} ${s.y} L ${s.x} ${s.y}`
                  : `M ${o.x} ${o.y} L ${s.x - d} ${o.y} ${u} ${s.x} ${o.y + p} L ${s.x} ${s.y}`),
            o.x > s.x &&
              ((l = `A 20 20, 0, 0, 0,`),
              (u = `A 20 20, 0, 0, 1,`),
              (d = 20),
              ...
              (h =
                n.type === x.MERGE && t.id !== n.parents[0]
                  ? `M ${o.x} ${o.y} L ${o.x} ${s.y - d} ${u} ${o.x - p} ${s.y} L ${s.x} ${s.y}`
                  : `M ${o.x} ${o.y} L ${s.x + d} ${o.y} ${l} ${s.x} ${o.y + p} L ${s.x} ${s.y}`)),
    ...
    e.append(`path`)
      .attr(`d`, h)
      .attr(`class`, `arrow arrow` + z(m, F, a));
  }, `drawArrow`),
  Le = t((e, t) => {
  ...
  Re = t((e, t, n, r) => {
    let { look: i, theme: a, themeVariables: o } = f(),
    ...
    t.forEach((e, t) => {
      ...
      (p.attr(`x1`, 0),
        ...
        K === `TB`
          ? (p.attr(`y1`, H), p.attr(`x1`, o), p.attr(`y2`, G), p.attr(`x2`, o))
          : K === `BT` &&
            (p.attr(`y1`, G),
            p.attr(`x1`, o),
            p.attr(`y2`, H),
      ...
      (i === `neo` && g.attr(`data-look`, `neo`),
        ...
        K === `TB`
          ? (g.attr(`x`, o - v.width / 2 - 10).attr(`y`, 0),
            _.attr(`transform`, `translate(` + (o - v.width / 2 - 5) + `, 0)`),
            l &&
          ...
          : K === `BT`
            ...
            : g.attr(`transform`, `translate(-19, ` + (f - 12 - x / 2) + `)`));
    });
  }, `drawBranches`),
  ze = t(function (e, t, n, r, i) {
    return (
...
`,
      ...
      let c = s.getConfig(),
        l = c.rotateCommitLabel ?? !1;
      U = s.getCommits();
      let u = s.getBranchesAsObjArray();
      K = s.getDirection();
      let d = n(`[id="${i}"]`),
        { look: p, theme: h, themeVariables: g } = f(),
        {
          useGradient: _,
          gradientStart: v,
          gradientStop: y,
      ...
      (u.forEach((e, t) => {
        ...
        let o = n.getBBox();
        ((x = ze(e.name, x, t, o, l)), a.remove(), i.remove(), r.remove());
      }),
        Y(d, U, !1, c),
        c.showBranches && Re(d, u, c, i),
        Le(d, U),
        Y(d, U, !0, c),
        r.insertTitle(
          d,
        ...
        m(void 0, d, c.diagramPadding, c.useMaxWidth));
    }, `draw`),
  },
  Z = 8,
  Q = new Set([`redux`, `redux-dark`, `redux-color`, `redux-dark-color`]),
  $ = new Set([`redux-color`, `redux-dark-color`]),
  Ve = new Set([`neo`, `neo-dark`]),
  He = new Set([`dark`, `redux-dark`, `redux-dark-color`, `neo-dark`]),
  Ue = new Set([
    `redux`,
    `redux-dark`,
    `redux-color`,
  ...
  Ge = t((e) => {
    let { theme: t, themeVariables: n } = _(),
...
//# sourceMappingURL=gitGraphDiagram-UUTBAWPF-D7buGxwW.js.map
