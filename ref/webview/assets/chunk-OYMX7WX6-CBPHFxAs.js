...
import { h as n, o as r } from "./chunk-5PVQY5BW-DEldFBPA.js";
import {
  B as i,
  C as a,
  V as o,
...
import { t as p } from "./chunk-55IACEB6-DBIditYu.js";
import { t as m } from "./chunk-EDXVE4YY-C5jaZxVP.js";
import { r as h } from "./chunk-336JU56O-Cutebe7h.js";
var g = (function () {
      ...
      performAction: t(function (e, t, n, r, i, a, o) {
        ...
        switch (i) {
          ...
          case 24:
            ...
            break;
          case 25:
            this.$ = { stmt: `state`, id: r.getDividerId(), type: `divider` };
            break;
          case 26:
            this.$ = {
              stmt: `state`,
          ...
          case 37:
            ...
            break;
          case 38:
            (r.setDirection(`TB`), (this.$ = { stmt: `dir`, value: `TB` }));
            break;
          case 39:
            (r.setDirection(`BT`), (this.$ = { stmt: `dir`, value: `BT` }));
            break;
          case 40:
            (r.setDirection(`RL`), (this.$ = { stmt: `dir`, value: `RL` }));
            break;
          case 41:
            (r.setDirection(`LR`), (this.$ = { stmt: `dir`, value: `LR` }));
            break;
          case 44:
          case 45:
            this.$ = {
...
var _ = g,
  ...
  pe = {
    ...
    draw: t(async function (t, r, i, a) {
      (e.info(`REF0:`), e.info(`Drawing state diagram (v2)`, r));
      ...
      ((l.type = a.type),
        ...
        u().look === `neo` ? (l.markers = [`barbNeo`]) : (l.markers = [`barb`]),
        (l.diagramId = r),
        await h(l, d));
      try {
        (typeof a.db.getLinks == `function`
          ? a.db.getLinks()
          : new Map()
        ).forEach((t, n) => {
          let r =
          ...
          let i = d.node()?.querySelectorAll(`g`),
            a;
          if (
            (i?.forEach((e) => {
          ...
          let s = document.createElementNS(`http://www.w3.org/2000/svg`, `a`),
            c = t.url.replace(/^"+|"+$/g, ``);
          if (
            (s.setAttributeNS(`http://www.w3.org/1999/xlink`, `xlink:href`, c),
          ...
          (o.replaceChild(s, a),
            s.appendChild(a),
            e.info(`🔗 Wrapped node in <a> tag for:`, r, t.url));
        });
      } catch (t) {
    ...
    (e.trace(`items`, n),
      n.forEach((e) => {
        switch (e.stmt) {
          ...
          case C:
            {
              (X(t, e.state1, r, i, a, o, s, c),
                X(t, e.state2, r, i, a, o, s, c));
              let n = s === `neo`,
                l = {
                  id: `edge` + G,
                  start: e.state1.id,
                  ...
                  style: k,
                  labelStyle: ``,
                  label: d.sanitizeText(e.description ?? ``, u()),
                  arrowheadStyle: A,
                  labelpos: j,
                  labelType: M,
                  thickness: N,
...
var X = t((t, n, r, i, a, o, s, c) => {
    let l = n.id,
      f = r.get(l),
      p = Y(f),
      m = he(f),
      h = u();
    if ((e.info(`dataFetcher parsedItem`, n, f, m), l !== `root`)) {
      let r = P;
      (n.start === !0 ? (r = ee) : n.start === !1 && (r = te),
        n.type !== D && (r = n.type),
        W.get(l) ||
          W.set(l, {
            id: l,
      ...
      (n.description &&
        (Array.isArray(u.description)
          ? ((u.shape = F), u.description.push(n.description))
          : u.description?.length && u.description.length > 0
            ? ((u.shape = F),
              u.description === l
                ? (u.description = [n.description])
                : (u.description = [u.description, n.description]))
            : ((u.shape = P), (u.description = n.description)),
        (u.description = d.sanitizeTextOrArray(u.description, h))),
        u.description?.length === 1 &&
          u.shape === F &&
          (u.type === `group` ? (u.shape = L) : (u.shape = P)),
        !u.type &&
          n.doc &&
          (e.info(`Setting cluster for XCX`, l, q(n)),
          (u.type = `group`),
          (u.isGroup = !0),
          (u.dir = q(n)),
          (u.shape = n.type === O ? I : L),
          (u.cssClasses = `${u.cssClasses} ${le} ${o ? ue : ``}`)));
      let f = {
        labelStyle: ``,
        shape: u.shape,
        label: u.description,
      ...
      if (
        ...
        t &&
          t.id !== `root` &&
          (e.trace(`Setting node `, l, ` to be child of its parent `, t.id),
          (f.parentId = t.id)),
        (f.centerLabel = !0),
        n.note)
      ) {
        ...
        (G++, (r.id = t), (e.parentId = t), J(i, r, c), J(i, e, c), J(i, f, c));
        let o = l,
          d = e.id;
        (n.note.position === `left of` && ((o = e.id), (d = l)),
          a.push({
            id: o + `-` + d,
            start: o,
            end: d,
    ...
    n.doc &&
      (e.trace(`Adding nodes children `), me(n, n.doc, r, i, a, !o, s, c));
  }, `dataFetcher`),
  ge = t(() => {
    (W.clear(), (G = 0));
  }, `reset`),
  ...
  _e = t(() => new Map(), `newClassesList`),
  Q = t(() => ({ relations: [], states: new Map(), documents: {} }), `newDoc`),
  $ = t((e) => JSON.parse(JSON.stringify(e)), `clone`),
  ve = class {
    constructor(e) {
      ((this.version = e),
        (this.nodes = []),
    ...
    docTranslator(e, t, n) {
      ...
      if (i.length > 0 && a.length > 0) {
        let e = { stmt: x, id: r(), type: `divider`, doc: $(a) };
        (i.push($(e)), (t.doc = i));
      }
    ...
    getRootDocV2() {
      return (
        this.docTranslator(
          { id: S, stmt: S },
          { id: S, stmt: S, doc: this.rootDoc },
          !0,
        ),
        { id: S, doc: this.rootDoc }
      );
    }
    addState(
      t,
      ...
      if (
        (i &&
          (e.info(`Setting state description`, l, i),
      ...
      (o &&
        (e.info(`Setting state classes`, l, o),
        (Array.isArray(o) ? o : [o]).forEach((e) =>
          this.setCssClass(l, e.trim()),
        )),
        s &&
          (e.info(`Setting state styles`, l, s),
    ...
    addLink(t, n, r) {
      (this.links.set(t, { url: n, tooltip: r }),
    ...
    setDirection(e) {
      ...
      t ? (t.value = e) : this.rootDoc.unshift({ stmt: b, value: e });
    }
    trimColon(e) {
...
//# sourceMappingURL=chunk-OYMX7WX6-CBPHFxAs.js.map
