...
function u({ mode: e, visible: t, settings: n }) {
  return { ...l(n), [e]: t };
}
function d({
...
function f({ availableAgentModes: e, visibility: t }) {
  return e.filter((e) => {
    switch (e) {
...
function p({ availableAgentModes: e, visibleAgentModes: t }) {
...
var m,
  ...
  g = e(() => {
    (a(),
      (m = { "guardian-approvals": !0, "full-access": !0 }),
      (h = i(`composer-permission-mode-visibility`, m)));
  });
export {
  f as a,
  s as c,
...
//# sourceMappingURL=app-initial~app-main~remote-conversation-page~new-thread-panel-page~onboarding-page~appgen-~d4gukj65-CzTWbFLy.js.map
