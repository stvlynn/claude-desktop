...
import { i as e, o as t, r as n, t as r } from "./src-DwoQmh2p.js";
import { t as i } from "./init-DU5j7PcD.js";
import { h as a } from "./chunk-5PVQY5BW-VrOwugqI.js";
import {
  $ as o,
  A as s,
  F as c,
...
import { t as j } from "./dist-WEF1yh7f.js";
...
function Ke(e, t, n, r, i, a) {
  ...
  function c(t, n, r) {
    let i = Math.abs(n - t) / r,
      a = p(([, , e]) => e).right(o, i);
    if (a === o.length) return e.every(u(t / we, n / we, r));
    if (a === 0) return xe.every(Math.max(u(t, n, r), 1));
...
function Sn(e, t, n, r, i, a, o, s, c, l) {
  ...
  return (
    ...
    (u.domain = function (e) {
      return arguments.length ? f(Array.from(e, xn)) : f().map(bn);
    }),
    (u.ticks = function (t) {
      var n = f();
    ...
    (u.copy = function () {
      return m(u, Sn(e, t, n, r, i, a, o, s, c, l));
    }),
    u
  );
}
  ...
  pi = {
    ...
    renderer: {
      ...
      draw: n(function (t, i, a, o) {
        let l = O().gantt;
        o.db.setDiagramId(i);
        let u = O().securityLevel,
          d;
        u === `sandbox` && (d = r(`#i` + i));
        let f = r(u === `sandbox` ? d.nodes()[0].contentDocument.body : `body`),
          p = u === `sandbox` ? d.nodes()[0].contentDocument : document,
          m = p.getElementById(i);
        (($ = m.parentElement.offsetWidth),
          $ === void 0 && ($ = 1200),
          l.useWidth !== void 0 && ($ = l.useWidth));
        let g = o.db.getTasks(),
          _ = [];
        ...
        if (
          ...
          for (let n of Object.keys(e)) {
            let r = di(e[n], t) + 1;
            ((t += r), (y += r * (l.barHeight + l.barGap)), (v[n] = r));
          }
        } else {
          y += g.length * (l.barHeight + l.barGap);
          for (let e of _) v[e] = g.filter((t) => t.type === e).length;
        }
        m.setAttribute(`viewBox`, `0 0 ` + $ + ` ` + y);
        let b = f.select(`[id="${i}"]`),
          x = Cn()
            .domain([
              h(g, function (e) {
            ...
            .rangeRound([0, $ - l.leftPadding - l.rightPadding]);
        function S(e, t) {
          let n = e.startTime,
            r = t.startTime,
            i = 0;
        ...
        function w(e, t, n, a, s, c, u) {
          ...
          b.append(`g`)
            ...
            .attr(`width`, function () {
              return u - l.rightPadding / 2;
            })
            .attr(`height`, t)
            .attr(`class`, function (e) {
              for (let [t, n] of _.entries())
                if (e.type === n)
                  return `section section` + (t % l.numberSectionStyles);
          ...
          if (
            (f
              ...
              .attr(`y`, function (e, r) {
                return (
                  (r = e.order),
                  e.vert ? l.gridLineStartPadding : r * t + n
                );
              })
              ...
              .attr(`height`, function (e) {
                return e.vert
                  ? g.length * (l.barHeight + l.barGap) + l.barHeight * 2
                  : s;
              })
              ...
              .attr(`class`, function (e) {
                ...
                for (let [t, r] of _.entries())
                  e.type === r && (n = t % l.numberSectionStyles);
                let r = ``;
                return (
                  e.active
                    ? e.crit
            ...
            f
              ...
              .attr(`x`, function (e) {
                ...
                if (
                  (e.milestone &&
                    ((t += 0.5 * (x(e.endTime) - x(e.startTime)) - 0.5 * s),
                    (n = t + s)),
                  e.vert)
                )
              ...
              .attr(`y`, function (e, r) {
                return e.vert
                  ? l.gridLineStartPadding +
                      g.length * (l.barHeight + l.barGap) +
                      60
                  : ((r = e.order),
                    r * t + l.barHeight / 2 + (l.fontSize / 2 - 2) + n);
              })
              .attr(`text-height`, s)
              .attr(`class`, function (e) {
                let t = x(e.startTime),
                ...
                let a = 0;
                for (let [t, n] of _.entries())
                  e.type === n && (a = t % l.numberSectionStyles);
                let o = ``;
                return (
                  e.active &&
        ...
        n(w, `drawRects`);
        function T(t, n, r, a, s, c, u, d) {
          if (u.length === 0 && d.length === 0) return;
          let f, p;
          for (let { startTime: e, endTime: t } of c)
            ((f === void 0 || e < f) && (f = e),
              (p === void 0 || t > p) && (p = t));
          if (!f || !p) return;
          ...
          b.append(`g`)
            ...
            .attr(`y`, l.gridLineStartPadding)
            .attr(
              `width`,
              (e) => x(e.end.endOf(`day`)) - x(e.start.startOf(`day`)),
            )
            .attr(`height`, s - n - l.gridLineStartPadding)
        ...
        function D(t, n, r, i) {
          let a = o.db.getDateFormat(),
            s = o.db.getAxisFormat(),
            c;
          c = s || (a === `D` ? `%d` : (l.axisFormat ?? `%Y-%m-%d`));
          let u = Ln(x)
              .tickSize(-i + n + l.gridLineStartPadding)
              .tickFormat(vn(c)),
            d =
              /^([1-9]\d*)(millisecond|second|minute|hour|day|week|month)$/.exec(
                o.db.getTickInterval() || l.tickInterval,
              );
          if (d !== null) {
            ...
            if (isNaN(t) || t <= 0)
              ...
              if (c > fi)
                e.warn(
                  `The tick interval "${t}${n}" would generate ${c} ticks, which exceeds the maximum allowed (${fi}). This may indicate an invalid date or time range. Skipping custom tick interval.`,
                );
              else
                switch (n) {
                  case `millisecond`:
        ...
        function A(e, t) {
          ...
          b.append(`g`)
            ...
            .attr(`font-size`, l.sectionFontSize)
            .attr(`class`, function (e) {
              for (let [t, n] of _.entries())
                if (e[0] === n)
                  return (
                    `sectionTitle sectionTitle` + (t % l.numberSectionStyles)
                  );
              return `sectionTitle`;
            });
        }
        ...
        function j(e, t, n, r) {
          ...
          (c
            .attr(`x1`, x(s) + e)
            .attr(`x2`, x(s) + e)
            .attr(`y1`, l.titleTopMargin)
            .attr(`y2`, r - l.titleTopMargin)
            .attr(`class`, `today`),
            i !== `` && c.attr(`style`, i.replace(/,/g, `;`)));
        }
        n(j, `drawToday`);
        function te(e) {
          let t = {},
...
//# sourceMappingURL=ganttDiagram-T4ZO3ILL-bUMNCv-k.js.map
