    ...
    (a(),
      ...
      (E = (function () {
        ...
        return (
          ...
          (e.prototype.page = function (e, t, n, r, a) {
            ...
            return (
              ...
              t !== null && (o.name = t),
              this.normalize(i(i({}, this.baseEvent()), o))
            );
          }),
          (e.prototype.screen = function (e, t, n, r, a) {
          ...
          (e.prototype.alias = function (e, t, n, r) {
            ...
            return (
              ...
              e === void 0
                ? this.normalize(i(i({}, a), this.baseEvent()))
                : this.normalize(i(i({}, this.baseEvent()), a))
            );
          }),
          ...
          (e.prototype.normalize = function (e) {
            var t = Object.keys(e.integrations ?? {}).reduce(function (t, n) {
              var r;
              return i(i({}, t), ((r = {}), (r[n] = !!e.integrations?.[n]), r));
            }, {});
            e.options = p(e.options || {}, function (e, t) {
              return t !== void 0;
            });
            var r = i(i({}, t), e.options?.integrations),
      ...
      (Q = (function (e) {
        ...
        return (
          ...
          (n.prototype.flushOne = function (e) {
            return t(this, void 0, void 0, function () {
              var t, n, r, i, a, o, c, l, u, d, c, f, p, m, h;
                ...
                switch (s.label) {
                  case 0:
                    ...
                    (e.attempts > 1 && this.emit(`delivery_retry`, e),
                      ...
                      (s.label = 1));
                  case 1:
                    return i < a.length ? ((o = a[i]), [4, we(e, o)]) : [3, 4];
                  case 2:
                    ((c = s.sent()),
                      c instanceof K && (e = c),
                      this.emit(`message_enriched`, e, o),
                      (s.label = 3));
                  case 3:
                    return (i++, [3, 1]);
                  case 4:
...
//# sourceMappingURL=esm-Bs7-NtHW.js.map
