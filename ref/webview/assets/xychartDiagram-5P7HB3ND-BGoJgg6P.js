...
import { A as r, E as i, N as a } from "./runtime.worker-B4oXRaGJ.js";
import {
  B as o,
  C as s,
  E as c,
...
import { t as v } from "./chunk-426QAEUC-CPad0Vrm.js";
import "./dist-WEF1yh7f.js";
import { t as y } from "./chunk-U2HBQHQK-ByHLWhPg.js";
var b = (function () {
  var e = t(function (e, t, n, r) {
      for (n ||= {}, r = e.length; r--; n[e[r]] = t);
      return n;
    }, `o`),
    n = [1, 10, 12, 14, 16, 18, 19, 21, 23],
    r = [2, 6],
    i = [1, 3],
    a = [1, 5],
    o = [1, 6],
    ...
    k = {
      ...
      table: [
        e(n, r, { 3: 1, 4: 2, 7: 4, 5: i, 34: a, 35: o, 36: s }),
        { 1: [3] },
        e(n, r, { 4: 2, 7: 4, 3: 8, 5: i, 34: a, 35: o, 36: s }),
        e(n, r, {
          4: 2,
          7: 4,
          6: 9,
        ...
        e(c, [2, 36]),
        { 1: [2, 1] },
        e(n, r, { 4: 2, 7: 4, 3: 21, 5: i, 34: a, 35: o, 36: s }),
        { 1: [2, 3] },
        e(c, [2, 5]),
        e(n, [2, 7], { 4: 22, 34: a, 35: o, 36: s }),
        {
          11: 23,
          37: 24,
          38: l,
...
var T = class {
  ...
  O = class {
    ...
    recalculateOuterPaddingToDrawBar() {
      (E * this.getTickDistance() > this.outerPadding * 2 &&
        (this.outerPadding = Math.floor((E * this.getTickDistance()) / 2)),
        this.recalculateScale());
    }
  ...
  k = class extends O {
    ...
    constructor(e, t, n, r, i) {
      (super(e, r, i, t),
        (this.categories = n),
        (this.scale = a().domain(this.categories).range(this.getRange())));
    }
    setRange(e) {
      super.setRange(e);
    }
  ...
  A = class extends O {
    ...
    constructor(e, t, n, i, a) {
      (super(e, i, a, t),
        (this.domain = n),
        (this.scale = r().domain(this.domain).range(this.getRange())));
    }
    getTickValues() {
    ...
    recalculateScale() {
      ...
      (this.axisPosition === `left` && e.reverse(),
        (this.scale = r().domain(e).range(this.getRange())));
    }
    getScaleValue(e) {
      return this.scale(e);
    }
...
function j(e, t, n, r) {
  let i = new T(r);
  return C(e)
    ? new k(t, n, e.categories, e.title, i)
    : new A(t, n, [e.min, e.max], e.title, i);
}
t(j, `getAxis`);
var M = class {
  constructor(e, t, n, r) {
...
function N(e, t, n, r) {
  return new M(new T(r), e, t, n);
}
t(N, `getChartTitleComponent`);
var ee = class {
    constructor(e, t, n, r, i) {
      ((this.plotData = e),
        (this.xAxis = t),
...
var ie = class {
    ...
    calculateVerticalSpace() {
      ...
      ((e -= o.width),
        ...
        (o = this.componentStore.xAxis.calculateSpace({ width: e, height: t })),
        (t -= o.height),
        this.componentStore.yAxis.setAxisPosition(`left`),
        (o = this.componentStore.yAxis.calculateSpace({ width: e, height: t })),
        (n = o.width),
        (e -= o.width),
        e > 0 && ((i += e), (e = 0)),
        t > 0 && ((a += t), (t = 0)),
        ...
        this.chartData.plots.some((e) => S(e)) &&
    ...
    calculateHorizontalSpace() {
      ...
      ((e -= s.width),
        ...
        (s = this.componentStore.xAxis.calculateSpace({ width: e, height: t })),
        (e -= s.width),
        (r = s.width),
        this.componentStore.yAxis.setAxisPosition(`top`),
        (s = this.componentStore.yAxis.calculateSpace({ width: e, height: t })),
        (t -= s.height),
        (i = n + s.height),
        e > 0 && ((a += e), (e = 0)),
        t > 0 && ((o += t), (t = 0)),
  ...
  ae = class {
    ...
    static build(e, t, n, r) {
      return new ie(e, t, n, r).getDrawableElement();
    }
  },
  P = 0,
  F,
  ...
  L = H(),
  R = W(),
  z = L.plotColorPalette.split(`,`).map((e) => e.trim()),
  B = !1,
  V = !1;
function H() {
  let e = c(),
    t = _();
  return n(e.xyChart, t.themeVariables.xyChart);
}
t(H, `getChartDefaultThemeConfig`);
function U() {
  let e = _();
  return n(h.xyChart, e.xyChart);
}
t(U, `getChartDefaultConfig`);
function W() {
  return {
...
t(q, `setOrientation`);
function J(e) {
  R.xAxis.title = G(e.text);
}
t(J, `setXAxisTitle`);
function Y(e, t) {
  ((R.xAxis = { type: `linear`, title: R.xAxis.title, min: e, max: t }),
    (B = !0));
}
t(Y, `setXAxisRangeData`);
function X(e) {
  ((R.xAxis = {
    type: `band`,
    title: R.xAxis.title,
    categories: e.map((e) => G(e.text)),
  }),
    (B = !0));
}
t(X, `setXAxisBand`);
function oe(e) {
  R.yAxis.title = G(e.text);
}
t(oe, `setYAxisTitle`);
function se(e, t) {
  ((R.yAxis = { type: `linear`, title: R.yAxis.title, min: e, max: t }),
    (V = !0));
}
t(se, `setYAxisRangeData`);
function ce(e) {
  let t = Math.min(...e),
    n = Math.max(...e),
    r = w(R.yAxis) ? R.yAxis.min : 1 / 0,
    i = w(R.yAxis) ? R.yAxis.max : -1 / 0;
  R.yAxis = {
    type: `linear`,
    title: R.yAxis.title,
    min: Math.min(r, t),
...
t(ce, `setYAxisRangeFromPlotData`);
function Z(e) {
  let t = [];
  if (e.length === 0) return t;
  if (!B) {
    let t = w(R.xAxis) ? R.xAxis.min : 1 / 0,
      n = w(R.xAxis) ? R.xAxis.max : -1 / 0;
    Y(Math.min(t, 1), Math.max(n, e.length));
  }
  if (
    (V || ce(e),
    C(R.xAxis) && (t = R.xAxis.categories.map((t, n) => [t, e[n]])),
    w(R.xAxis))
  ) {
    let n = R.xAxis.min,
      r = R.xAxis.max,
...
function le(e, t) {
  let n = Z(t);
  (R.plots.push({ type: `line`, strokeFill: Q(P), strokeWidth: 2, data: n }),
    P++);
}
t(le, `setLineData`);
function $(e, t) {
  let n = Z(t);
  (R.plots.push({ type: `bar`, fill: Q(P), data: n }), P++);
}
t($, `setBarData`);
function ue() {
  if (R.plots.length === 0)
    throw Error(`No Plot to render, please provide a plot with some data`);
  return ((R.title = s()), ae.build(I, R, L, F));
}
t(ue, `getDrawableElem`);
function de() {
  return L;
}
t(de, `getChartThemeConfig`);
function fe() {
  return I;
}
t(fe, `getChartConfig`);
...
var me = {
  ...
  db: {
    ...
    setXAxisBand: X,
    setYAxisTitle: oe,
    setYAxisRangeData: se,
    setLineData: le,
    setBarData: $,
    setTmpSVGG: K,
    getChartThemeConfig: de,
    getChartConfig: fe,
    getXYChartData: pe,
  },
  renderer: {
    draw: t((n, r, i, a) => {
      ...
      (t(f, `getTextTransformation`),
        e.debug(
          `Rendering xychart chart
` + n,
        ));
      let p = v(r),
        h = p.append(`g`).attr(`class`, `main`),
        g = h
          .append(`rect`)
          .attr(`width`, c.width)
          .attr(`height`, c.height)
          .attr(`class`, `background`);
      (m(p, c.height, c.width, !0),
      ...
      function b(e) {
        ...
        for (let [r] of e.entries()) {
          ...
          (r > 0 && y[n] && (i = y[n]),
            (n += e[r]),
            (t = y[n]),
            (t ||= y[n] = i.append(`g`).attr(`class`, e[r])));
        }
        return t;
      }
      t(b, `getGroup`);
            ...
            if (
              ...
              if (c.chartOrientation === `horizontal`) {
                ...
                let a = 0.7,
                  ...
                  d = Math.floor(Math.min(...u)),
                  f = t(
                    (e) =>
                      r
                        ? e.data.x + e.data.width + 10
                        : e.data.x + e.data.width - 10,
                ...
                n.selectAll(`text`)
                  ...
                  .attr(`text-anchor`, r ? `start` : `end`)
                  .attr(`dominant-baseline`, `middle`)
                  .attr(`fill`, s.dataLabelColor)
                  .attr(`font-size`, `${d}px`)
                  .text((e) => e.label);
              } else {
                ...
                let a = e.data
                    ...
                    .filter((e) => e.data.width > 0 && e.data.height > 0),
                  o = a.map((e) => {
                    let { data: t, label: n } = e,
                      r = t.width / (n.length * 0.7);
                    for (; !i(e, r, 10) && r > 0; ) --r;
                    return r;
                  }),
                  c = Math.floor(Math.min(...o)),
                  u = t(
                    (e) => (r ? e.data.y - 10 : e.data.y + 10),
                ...
                n.selectAll(`text`)
                  ...
                  .attr(`dominant-baseline`, r ? `auto` : `hanging`)
                  .attr(`fill`, s.dataLabelColor)
                  .attr(`font-size`, `${c}px`)
                  .text((e) => e.label);
              }
...
//# sourceMappingURL=xychartDiagram-5P7HB3ND-BGoJgg6P.js.map
