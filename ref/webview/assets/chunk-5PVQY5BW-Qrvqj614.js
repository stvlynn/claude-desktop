...
import { a as ue, o as d } from "./_baseFor-BRFGaW29.js";
import { n as de, t as fe } from "./merge-DKsDTUx2.js";
import { n as pe, t as me } from "./src-BpCf56JJ.js";
import { t as he } from "./dist-D71-f2X0.js";
import { i as f, n as p, r as ge } from "./chunk-AGHRB4JF-GvfWLS3X.js";
import {
  A as _e,
  L as ve,
  f as ye,
...
function _(e, t) {
  return e ? (M[`curve${e.charAt(0).toUpperCase() + e.slice(1)}`] ?? t) : t;
}
function v(e, t) {
  let n = e.trim();
  if (n) return t.securityLevel === `loose` ? n : (0, j.sanitizeUrl)(n);
}
function y(e, t) {
  ...
  Te = e(() => {
    (_e(),
      ...
      (M = {
        ...
        curveBumpY: u,
        curveBundle: se,
        curveCardinalClosed: r,
        curveCardinalOpen: re,
        curveCardinal: s,
        curveCatmullRomClosed: i,
        curveCatmullRomOpen: ne,
        curveCatmullRom: te,
        curveLinear: ce,
        curveLinearClosed: t,
        curveMonotoneX: ee,
...
`,
      ...
      p(S, `calcTerminalLabelPosition`),
      p(C, `getStylesFromArray`),
      (V = 0),
      (H = p(
      ...
      (G = p(function (e, t) {
        let n = t.text.replace(g.lineBreakRegex, ` `),
          [, r] = Z(t.fontSize),
          i = e.append(`text`);
        (i.attr(`x`, t.x),
          i.attr(`y`, t.y),
      ...
      (Ce = {
        ...
        interpolateToCurve: _,
        calcLabelPosition: x,
        calcCardinalityPosition: B,
        calcTerminalLabelPosition: S,
        formatUrl: v,
        getStylesFromArray: C,
        generateId: H,
        random: U,
        runFunc: L,
        entityDecode: xe,
        insertTitle: Se,
        isLabelCoordinateInPath: A,
        parseFontSize: Z,
        InitIDGenerator: Y,
      }),
      (we = p(function (e) {
      ...
      p(k, `handleUndefinedAttr`),
      p(A, `isLabelCoordinateInPath`));
  });
export {
  K as _,
  we as a,
...
//# sourceMappingURL=chunk-5PVQY5BW-Qrvqj614.js.map
