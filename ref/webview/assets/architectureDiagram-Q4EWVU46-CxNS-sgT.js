import { i as e, r as t, t as n } from "./src-DwoQmh2p.js";
import { r, s as i } from "./chunk-5PVQY5BW-VrOwugqI.js";
import "./chunk-K5T4RW27-DGM_cVYA.js";
import { $ as a, it as o } from "./runtime.worker-B4oXRaGJ.js";
...
import {
  ...
  v as _,
  y as v,
} from "./chunk-ICPOFSXX-eMbNr9et.js";
import { t as y } from "./chunk-426QAEUC-CPad0Vrm.js";
import "./dist-WEF1yh7f.js";
import { a as b, i as x, n as S, r as C } from "./chunk-U2HBQHQK-ByHLWhPg.js";
import { t as w } from "./chunk-4BX2VUAB-CjbaQjC5.js";
import { t as T } from "./mermaid-parser.core-prkO3ORs.js";
import { t as E } from "./cytoscape.esm-CPPPPA7s.js";
var D = a((e, t) => {
    (function (n, r) {
      ...
      return (function (e) {
        ...
        function (e, t, n) {
          ...
          ((o.prototype.getSource = function () {
            ...
            (o.prototype.getOtherEndInGraph = function (e, t) {
              for (
                var n = this.getOtherEnd(e), r = t.getGraphManager().getRoot();
                ;
        ...
        function (e, t, n) {
          ...
          function l(e, t, n, o) {
            (n == null && o == null && (o = t),
              r.call(this, o),
              e.graphManager != null && (e = e.graphManager),
              ...
              (this.graphManager = e),
              n != null && t != null
                ? (this.rect = new a(t.x, t.y, n.width, n.height))
                : (this.rect = new a()));
          }
          ...
          ((l.prototype.getEdges = function () {
            ...
            (l.prototype.withChildren = function () {
              ...
              if ((e.add(this), this.child != null))
                for (var r = this.child.getNodes(), i = 0; i < r.length; i++)
                  ((t = r[i]),
                    (n = t.withChildren()),
            ...
            (l.prototype.getNoOfChildren = function () {
              ...
              if (this.child == null) e = 1;
                ...
                for (var n = this.child.getNodes(), r = 0; r < n.length; r++)
                  ((t = n[r]), (e += t.getNoOfChildren()));
              return (e == 0 && (e = 1), e);
            }),
                  ...
                  (this.labelWidth &&
                    (this.labelPosHorizontal == `left`
                      ? ((this.rect.x -= this.labelWidth),
                        this.setWidth(t + this.labelWidth))
        ...
        function (e, t, n) {
          ...
          ((i.MAX_ITERATIONS = 2500),
            ...
            (i.MAX_NODE_DISPLACEMENT = i.MAX_NODE_DISPLACEMENT_INCREMENTAL * 3),
        ...
        function (e, t, n) {
          ...
          function f(e, t, n) {
            (r.call(this, n),
              ...
              (this.isConnected = !1),
              (this.parent = e),
              t != null && t instanceof o
                ? (this.graphManager = t)
                : t != null &&
                  t instanceof Layout &&
                  (this.graphManager = t.graphManager));
          }
          for (var p in ((f.prototype = Object.create(r.prototype)), r))
            f[p] = r[p];
          ((f.prototype.getNodes = function () {
            ...
            (f.prototype.remove = function (e) {
              ...
              if (e instanceof s) {
                ...
                for (
                  var n = t.edges.slice(), r, i = n.length, a = 0;
                  a < i;
                  a++
                )
                  ((r = n[a]),
                    r.isInterGraph
                      ? this.graphManager.remove(r)
                      : r.source.owner.remove(r));
                ...
                var l = r.source.edges.indexOf(r),
                  u = r.target.edges.indexOf(r);
                if (!(l > -1 && u > -1))
                  throw `Source and/or target doesn't know this edge!`;
                (r.source.edges.splice(l, 1),
                  r.target != r.source && r.target.edges.splice(u, 1));
            ...
            (f.prototype.updateLeftTop = function () {
              ...
              return e == i.MAX_VALUE
                ? null
                : ((a =
                    o[0].getParent().paddingLeft == null
                      ? this.margin
            ...
            (f.prototype.updateBounds = function (e) {
              ...
              (t == i.MAX_VALUE &&
                ...
                (d =
                  f[0].getParent().paddingLeft == null
                    ? this.margin
                    : f[0].getParent().paddingLeft),
                (this.left = g.x - d),
                (this.right = g.x + g.width + d),
                (this.top = g.y - d),
                (this.bottom = g.y + g.height + d));
            }),
            ...
            (f.prototype.updateConnected = function () {
              ...
              var t = new d(),
                ...
                a;
              for (
                r.withChildren().forEach(function (e) {
                  (t.push(e), n.add(e));
                });
                t.length !== 0;
                ...
                for (var o = i.length, s = 0; s < o; s++)
                  ((a = i[s].getOtherEndInGraph(r, this)),
                    a != null &&
                      !n.has(a) &&
          ...
          ((a.prototype.addRoot = function () {
            ...
            (a.prototype.add = function (e, t, n, r, i) {
              if (n == null && r == null && i == null) {
                ...
                if (
                  (this.edges.push(n), !(n.source != null && n.target != null))
                )
                  throw `Edge source and/or target is null!`;
                if (
                  !(
                    n.source.edges.indexOf(n) == -1 &&
                    n.target.edges.indexOf(n) == -1
                  )
                )
            ...
            (a.prototype.remove = function (e) {
              if (e instanceof r) {
                ...
                if (
                  !(
                    t == this.rootGraph ||
                    (t.parent != null && t.parent.graphManager == this)
                  )
                )
                ...
                if (
                  !(
                    a.source.edges.indexOf(a) != -1 &&
                    a.target.edges.indexOf(a) != -1
                  )
                )
                  throw `Source and/or target doesn't know this edge!`;
                ...
                if (
                  ...
                  (u = a.target.edges.indexOf(a)),
                  a.target.edges.splice(u, 1),
                  !(
                    a.source.owner != null &&
                    a.source.owner.getGraphManager() != null
                  ))
                )
            ...
            (a.prototype.calcLowestCommonAncestors = function () {
              for (
                var e, t, n, r, i, a = this.getAllEdges(), o = a.length, s = 0;
                s < o;
                s++
              ) {
                if (
            ...
            (a.prototype.calcInclusionTreeDepths = function (e, t) {
              ...
              for (var n, r = e.getNodes(), i = r.length, a = 0; a < i; a++)
                ((n = r[a]),
                  (n.inclusionTreeDepth = t),
                  n.child != null &&
                    this.calcInclusionTreeDepths(n.child, t + 1));
            }),
            (a.prototype.includesInvalidEdge = function () {
              for (var e, t = [], n = this.edges.length, r = 0; r < n; r++)
                ((e = this.edges[r]),
                  this.isOneAncestorOfOther(e.source, e.target) && t.push(e));
        ...
        function (e, t, n) {
          ...
          ((i.calcSeparationAmount = function (e, t, n, r) {
            ...
            (i.getIntersection2 = function (e, t, n) {
              ...
              if (r === a) {
                if (i > o)
                  return ((n[0] = r), (n[1] = c), (n[2] = a), (n[3] = y), !1);
                if (i < o)
                  return ((n[0] = r), (n[1] = d), (n[2] = a), (n[3] = g), !1);
              } else if (i === o) {
                if (r > a)
                  return ((n[0] = s), (n[1] = i), (n[2] = _), (n[3] = o), !1);
                if (r < a)
                  return ((n[0] = l), (n[1] = i), (n[2] = h), (n[3] = o), !1);
              } else {
                ...
                if (
                  (r > a
                    ? i > o
                      ? ((O = this.getCardinalDirection(T, D, 4)),
                        (k = this.getCardinalDirection(E, D, 2)))
                      : ((O = this.getCardinalDirection(-T, D, 3)),
                        (k = this.getCardinalDirection(-E, D, 1)))
                    : i > o
                      ? ((O = this.getCardinalDirection(-T, D, 1)),
                        (k = this.getCardinalDirection(-E, D, 3)))
                      : ((O = this.getCardinalDirection(T, D, 2)),
                        (k = this.getCardinalDirection(E, D, 4))),
                  !C)
                )
                  switch (O) {
                    case 1:
            ...
            (i.doIntersect = function (e, t, n, r) {
              var i = e.x,
                ...
                f = (o - i) * (d - l) - (u - c) * (s - a);
              if (f === 0) return !1;
              var p = ((d - l) * (u - i) + (c - u) * (d - a)) / f,
                m = ((a - s) * (u - i) + (o - i) * (d - a)) / f;
              return 0 < p && p < 1 && 0 < m && m < 1;
            }),
            (i.findCircleLineIntersections = function (e, t, n, r, i, a, o) {
              var s = (n - e) * (n - e) + (r - t) * (r - t),
                c = 2 * ((e - i) * (n - e) + (t - a) * (r - t)),
                l = (e - i) * (e - i) + (t - a) * (t - a) - o * o;
              if (c * c - 4 * s * l >= 0) {
                var u = (-c + Math.sqrt(c * c - 4 * s * l)) / (2 * s),
                  d = (-c - Math.sqrt(c * c - 4 * s * l)) / (2 * s);
        ...
        function (e, t, n) {
          ...
          var a = function (e) {
            ...
            o = function (e, t, n, r) {
              return (
                e === null ? (r.head = t) : (e.next = t),
                n === null ? (r.tail = t) : (n.prev = t),
                (t.prev = e),
                (t.next = n),
                r.length++,
                t
            ...
            s = function (e, t) {
              var n = e.prev,
                r = e.next;
              return (
                n === null ? (t.head = r) : (n.next = r),
                r === null ? (t.tail = n) : (r.prev = n),
                (e.prev = e.next = null),
                t.length--,
                e
              );
        ...
        function (e, t, n) {
          function r(e, t, n) {
            ((this.x = null),
              ...
              e == null && t == null && n == null
                ? ((this.x = 0), (this.y = 0))
                : typeof e == `number` && typeof t == `number` && n == null
                  ? ((this.x = e), (this.y = t))
          ...
          ((r.prototype.getX = function () {
            ...
            (r.prototype.setLocation = function (e, t, n) {
              e.constructor.name == `Point` && t == null && n == null
            ...
            (r.prototype.toString = function () {
              return (
                new r().constructor.name + `[x=` + this.x + `,y=` + this.y + `]`
              );
            }),
            (e.exports = r));
        },
          ...
          ((i.lastID = 0),
            (i.createID = function (e) {
              return i.isPrimitive(e)
                ? e
                : e.uniqueID == null
                  ? ((e.uniqueID = i.getString()), i.lastID++, e.uniqueID)
                  : e.uniqueID;
            }),
        ...
        function (e, t, n) {
          ...
          function f(e) {
            (d.call(this),
              ...
              (this.animationDuringLayout = i.DEFAULT_ANIMATION_DURING_LAYOUT),
          ...
          ((f.RANDOM_SEED = 1),
            ...
            (f.prototype.update2 = function () {
              if (
                ...
                for (
                  ...
                  e[t];
                for (
                  var n = this.graphManager.getRoot().getNodes(), t = 0;
                  t < n.length;
                  t++
                )
                  n[t];
              ...
              if (e == null) this.transform(new l(0, 0));
                ...
                if (n != null) {
                  (t.setWorldOrgX(e.x),
                    ...
                    t.setDeviceOrgX(n.x),
                    t.setDeviceOrgY(n.y));
                  for (var r = this.getAllNodes(), i, a = 0; a < r.length; a++)
                    ((i = r[a]), i.transform(t));
                }
              }
            }),
            ...
            (f.prototype.createBendpointsFromDummyNodes = function () {
              ...
              ((e = e.concat(this.graphManager.getAllEdges())),
                (e = [].concat(r(this.edgeToDummyNodes.keys()), e)));
              for (var t = 0; t < e.length; t++) {
                ...
                if (n.bendpoints.length > 0) {
                  for (
                    ...
                    var o = i[a],
                      s = new l(o.getCenterX(), o.getCenterY()),
                      c = n.bendpoints.get(a);
              ...
              for (l = l.concat(n); !i; ) {
                ...
                for (var o = 0; o < t.length; o++) {
                  var s = t[o],
                    d = t.indexOf(s);
                  (d >= 0 && t.splice(d, 1),
                    s.getNeighborsList().forEach(function (e) {
                      if (n.indexOf(e) < 0) {
                        var t = r.get(e) - 1;
        ...
        function (e, t, n) {
          ...
          for (var u in ((l.prototype = Object.create(i.prototype)), i))
            l[u] = i[u];
          ((l.prototype.initParameters = function () {
            (i.prototype.initParameters.call(this, arguments),
              ...
              for (
                ...
                ((e = l[u]),
                  ...
                  e.isInterGraph &&
                    ((r = e.getSource()),
                    (i = e.getTarget()),
                    (s = e.getSourceInLca().getEstimatedSize()),
                    (c = e.getTargetInLca().getEstimatedSize()),
                    this.useSmartIdealEdgeLengthCalculation &&
                      (e.idealLength += s + c - 2 * o.SIMPLE_NODE_SIZE),
                    (n = e.getLca().getInclusionTreeDepth()),
                    (e.idealLength +=
                      t *
            ...
            (l.prototype.initSpringEmbedder = function () {
              ...
              (this.incremental
                ? (e > a.ADAPTATION_LOWER_NODE_LIMIT &&
            ...
            (l.prototype.calcSpringForces = function () {
              for (var e = this.getAllEdges(), t, n = 0; n < e.length; n++)
            ...
            (l.prototype.calcRepulsionForces = function () {
              ...
              if (this.useFRGridVariant)
                for (
                  ...
                  ((i = s[n]),
                    this.calculateRepulsionForceOfANode(i, c, e, t),
                    c.add(i));
              else
                for (n = 0; n < s.length; n++)
                  for (i = s[n], r = n + 1; r < s.length; r++)
                    ((o = s[r]),
                      i.getOwner() == o.getOwner() &&
                        this.calcRepulsionForce(i, o));
            }),
            ...
            (l.prototype.moveNodes = function () {
              for (var e = this.getAllNodes(), t, n = 0; n < e.length; n++)
                ((t = e[n]), t.move());
            }),
            ...
            (l.prototype.calcRepulsionForce = function (e, t) {
              var n = e.getRect(),
                ...
                h;
              if (n.intersects(r)) {
                (s.calcSeparationAmount(n, r, i, a.DEFAULT_EDGE_LENGTH / 2),
                  (m = 2 * i[0]),
                  (h = 2 * i[1]));
                var g =
                  (e.noOfChildren * t.noOfChildren) /
                  (e.noOfChildren + t.noOfChildren);
                ((e.repulsionForceX -= g * m),
                  (e.repulsionForceY -= g * h),
                  (t.repulsionForceX += g * m),
                  (t.repulsionForceY += g * h));
              } else
                (this.uniformLeafNodeSizes &&
                e.getChild() == null &&
                t.getChild() == null
                  ? ((l = r.getCenterX() - n.getCenterX()),
                    (u = r.getCenterY() - n.getCenterY()))
                  : (s.getIntersection(n, r, o),
                    (l = o[2] - o[0]),
                    (u = o[3] - o[1])),
                  Math.abs(l) < a.MIN_REPULSION_DIST &&
                    (l = c.sign(l) * a.MIN_REPULSION_DIST),
                  Math.abs(u) < a.MIN_REPULSION_DIST &&
                    (u = c.sign(u) * a.MIN_REPULSION_DIST),
                  (d = l * l + u * u),
                  (f = Math.sqrt(d)),
                  (p =
                    ((e.nodeRepulsion / 2 + t.nodeRepulsion / 2) *
                      e.noOfChildren *
                      t.noOfChildren) /
                    d),
                  (m = (p * l) / f),
            ...
            (l.prototype.calcGravitationalForce = function (e) {
              ...
              e.getOwner() == this.graphManager.getRoot()
                ? ((c = t.getEstimatedSize() * this.gravityRangeFactor),
                  (o > c || s > c) &&
                    ((e.gravitationForceX = -this.gravityConstant * i),
                    (e.gravitationForceY = -this.gravityConstant * a)))
                : ((c = t.getEstimatedSize() * this.compoundGravityRangeFactor),
                  (o > c || s > c) &&
                    ((e.gravitationForceX =
                      -this.gravityConstant * i * this.compoundGravityConstant),
                    (e.gravitationForceY =
            ...
            (l.prototype.calcNoOfChildrenForAllNodes = function () {
              for (
                ...
                ((e = t[n]), (e.noOfChildren = e.getNoOfChildren()));
            }),
            (l.prototype.calcGrid = function (e) {
              ...
              ((t = parseInt(
                ...
                (n = parseInt(
                  Math.ceil((e.getBottom() - e.getTop()) / this.repulsionRange),
                )));
              for (var r = Array(t), i = 0; i < t; i++) r[i] = Array(n);
              for (var i = 0; i < t; i++)
                for (var a = 0; a < n; a++) r[i][a] = [];
              return r;
            }),
            (l.prototype.addNodeToGrid = function (e, t, n) {
              ...
              for (var s = r; s <= i; s++)
                for (var c = a; c <= o; c++)
                  (this.grid[s][c].push(e), e.setGridCoordinates(r, i, a, o));
            }),
            ...
            (l.prototype.calculateRepulsionForceOfANode = function (
              ...
              if (
                ...
                e.surrounding = [];
                for (
                  var s, c = this.grid, l = e.startX - 1;
                  l < e.finishX + 2;
                  l++
                )
                  for (var u = e.startY - 1; u < e.finishY + 2; u++)
                    if (
                      !(l < 0 || u < 0 || l >= c.length || u >= c[0].length)
                    ) {
                      for (var d = 0; d < c[l][u].length; d++)
                        if (
                          ((s = c[l][u][d]),
                          !(e.getOwner() != s.getOwner() || e == s) &&
                            !t.has(s) &&
                            !o.has(s))
                        ) {
                          var f =
                              Math.abs(e.getCenterX() - s.getCenterX()) -
                              (e.getWidth() / 2 + s.getWidth() / 2),
                            p =
                              Math.abs(e.getCenterY() - s.getCenterY()) -
                              (e.getHeight() / 2 + s.getHeight() / 2);
                          f <= this.repulsionRange &&
        ...
        function (e, t, n) {
          ...
          ((r.multMat = function (e, t) {
            ...
            (r.normalize = function (e) {
              for (var t = [], n = this.mag(e), r = 0; r < e.length; r++)
                t[r] = e[r] / n;
              return t;
            }),
            ...
            (r.multL = function (e, t, n) {
              ...
              for (var f = 0; f < t.length; f++) {
                for (var p = 0, m = 0; m < t[0].length; m++)
                  p += t[f][m] * a[m];
                r[f] = p;
              }
              return r;
        ...
        function (e, t, n) {
          ...
          e.exports = (function () {
            function e(t, n) {
              ...
              var r = void 0;
              ((r = t instanceof a ? t.size() : t.length),
        ...
        function (e, t, n) {
          ...
          ((r.svd = function (e) {
            ...
            for (
              ...
              if (l < s) {
                this.s[l] = 0;
                for (var u = l; u < this.m; u++)
                  this.s[l] = r.hypot(this.s[l], e[u][l]);
                if (this.s[l] !== 0) {
              ...
              if (
                ...
                for (var g = l; g < this.m; g++) this.U[g][l] = e[g][l];
              if (l < c) {
                n[l] = 0;
                ...
                if (
                  ...
                  for (var b = l + 1; b < this.n; b++)
                    for (var x = l + 1; x < this.m; x++) i[x] += n[b] * e[x][b];
                  for (var S = l + 1; S < this.n; S++)
                    for (var C = -n[S] / n[l + 1], w = l + 1; w < this.m; w++)
                      e[w][S] += C * i[w];
                }
            ...
            if (
              (s < this.n && (this.s[s] = e[s][s]),
              this.m < E && (this.s[E - 1] = 0),
              c + 1 < E && (n[c] = e[c][E - 1]),
              (n[E - 1] = 0),
              a)
            ) {
              ...
              for (var k = s - 1; k >= 0; k--)
                if (this.s[k] !== 0) {
                  for (var A = k + 1; A < t; A++) {
                    for (var j = 0, M = k; M < this.m; M++)
                      j += this.U[M][k] * this.U[M][A];
                    j = -j / this.U[k][k];
                    for (var N = k; N < this.m; N++)
                      this.U[N][A] += j * this.U[N][k];
                  }
                  for (var P = k; P < this.m; P++) this.U[P][k] = -this.U[P][k];
                  this.U[k][k] = 1 + this.U[k][k];
                  for (var F = 0; F < k - 1; F++) this.U[F][k] = 0;
                } else {
                  for (var I = 0; I < this.m; I++) this.U[I][k] = 0;
                  this.U[k][k] = 1;
                }
            }
            if (o)
              for (var L = this.n - 1; L >= 0; L--) {
                if (
                  ...
                  for (var R = L + 1; R < t; R++) {
                    for (var z = 0, B = L + 1; B < this.n; B++)
                      z += this.V[B][L] * this.V[B][R];
                    z = -z / this.V[L + 1][L];
                    for (var V = L + 1; V < this.n; V++)
                      this.V[V][R] += z * this.V[V][L];
                  }
                for (var ee = 0; ee < this.n; ee++) this.V[ee][L] = 0;
                this.V[L][L] = 1;
              }
            for (
              var te = E - 1, H = 0, ne = 2 ** -52, re = 2 ** -966;
              E > 0;
              ...
              for (U = E - 2; U >= -1 && U !== -1; U--)
                if (
                  Math.abs(n[U]) <=
                  re + ne * (Math.abs(this.s[U]) + Math.abs(this.s[U + 1]))
                ) {
                  n[U] = 0;
                  break;
                }
              ...
              switch ((U++, W)) {
                case 1:
                  ...
                  n[E - 2] = 0;
                  for (var q = E - 2; q >= U; q--) {
                    var J = r.hypot(this.s[q], K),
                      Y = this.s[q] / J,
                      ae = K / J;
                    if (
                      ((this.s[q] = J),
                      q !== U &&
                        ((K = -ae * n[q - 1]), (n[q - 1] = Y * n[q - 1])),
                      o)
                    )
                      for (var X = 0; X < this.n; X++)
                        ((J = Y * this.V[X][q] + ae * this.V[X][E - 1]),
                          (this.V[X][E - 1] =
                            -ae * this.V[X][q] + Y * this.V[X][E - 1]),
                          (this.V[X][q] = J));
                  }
                  break;
                case 2:
                  ...
                  for (var Z = U; Z < E; Z++) {
                    ...
                    if (
                      ...
                      for (var ue = 0; ue < this.m; ue++)
                        ((se = ce * this.U[ue][Z] + le * this.U[ue][U - 1]),
                          (this.U[ue][U - 1] =
                            -le * this.U[ue][Z] + ce * this.U[ue][U - 1]),
                          (this.U[ue][Z] = se));
                  }
                  break;
                case 3:
                  var de = Math.max(
                    ...
                    he = this.s[U] / de,
                    ge = n[U] / de,
                    _e = ((pe + fe) * (pe - fe) + me * me) / 2,
                    ve = fe * me * (fe * me),
                    ye = 0;
                  (function (e, t) {
                    return e || t;
                  })(_e !== 0, ve !== 0) &&
                    ((ye = Math.sqrt(_e * _e + ve)),
                    _e < 0 && (ye = -ye),
                    (ye = ve / (_e + ye)));
                  for (
                    var be = (he + fe) * (he - fe) + ye, xe = he * ge, Q = U;
                    Q < E - 1;
                    Q++
                  ) {
                    var $ = r.hypot(be, xe),
                    ...
                    if (
                      (Q !== U && (n[Q - 1] = $),
                      (be = Se * this.s[Q] + Ce * n[Q]),
                      (n[Q] = Se * n[Q] - Ce * this.s[Q]),
                      (xe = Ce * this.s[Q + 1]),
                      (this.s[Q + 1] = Se * this.s[Q + 1]),
                      o)
                    )
                      for (var we = 0; we < this.n; we++)
                        (($ = Se * this.V[we][Q] + Ce * this.V[we][Q + 1]),
                          (this.V[we][Q + 1] =
                            -Ce * this.V[we][Q] + Se * this.V[we][Q + 1]),
                          (this.V[we][Q] = $));
                    if (
                      (($ = r.hypot(be, xe)),
                      (Se = be / $),
                      (Ce = xe / $),
                      (this.s[Q] = $),
                      (be = Se * n[Q] + Ce * this.s[Q + 1]),
                      (this.s[Q + 1] = -Ce * n[Q] + Se * this.s[Q + 1]),
                      (xe = Ce * n[Q + 1]),
                      (n[Q + 1] = Se * n[Q + 1]),
                      a && Q < this.m - 1)
                    )
                      for (var Te = 0; Te < this.m; Te++)
                        (($ = Se * this.U[Te][Q] + Ce * this.U[Te][Q + 1]),
                          (this.U[Te][Q + 1] =
                            -Ce * this.U[Te][Q] + Se * this.U[Te][Q + 1]),
                          (this.U[Te][Q] = $));
                  }
                  ((n[E - 2] = be), (H += 1));
                  break;
                case 4:
                  if (
                    this.s[U] <= 0 &&
                    ((this.s[U] = this.s[U] < 0 ? -this.s[U] : 0), o)
                  )
                    for (var Ee = 0; Ee <= te; Ee++)
                      this.V[Ee][U] = -this.V[Ee][U];
                  for (; U < te && !(this.s[U] >= this.s[U + 1]); ) {
                    ...
                    if (
                      ...
                      for (var Oe = 0; Oe < this.n; Oe++)
                        ((De = this.V[Oe][U + 1]),
                          (this.V[Oe][U + 1] = this.V[Oe][U]),
                          (this.V[Oe][U] = De));
                    if (a && U < this.m - 1)
                      for (var ke = 0; ke < this.m; ke++)
                        ((De = this.U[ke][U + 1]),
                          (this.U[ke][U + 1] = this.U[ke][U]),
                          (this.U[ke][U] = De));
                    U++;
                  }
                  ((H = 0), E--);
            ...
            return (
              r(e, [
                      ...
                      for (var r = 1; r < this.jMax; r++) {
                        ...
                        i =
                          this.sequence1[n - 1] === this.sequence2[r - 1]
                            ...
                            : this.grid[n - 1][r - 1] + this.mismatch_penalty;
                        var a = this.grid[n - 1][r] + this.gap_penalty,
                          o = this.grid[n][r - 1] + this.gap_penalty,
                          s = [i, a, o],
                ...
                },
                {
                  key: `getAllIndexes`,
                  value: function (e, t) {
                    for (var n = [], r = -1; (r = e.indexOf(t, r + 1)) !== -1; )
                      n.push(r);
                    return n;
                  },
                },
  ...
  O = a((e, t) => {
    (function (n, r) {
      typeof e == `object` && typeof t == `object`
        ? (t.exports = r(D()))
        : typeof define == `function` && define.amd
          ? define([`layout-base`], r)
          : typeof e == `object`
            ? (e.coseBase = r(D()))
            : (n.coseBase = r(n.layoutBase));
    })(e, function (e) {
      return (() => {
        var t = {
            45: (e, t, n) => {
            ...
            765: (e, t, n) => {
              var r = n(551).FDLayout,
                ...
                c = n(806),
                l = n(902),
                u = n(551).FDLayoutConstants,
                d = n(551).LayoutConstants,
                f = n(551).Point,
                p = n(551).PointD,
                m = n(551).DimensionD,
                h = n(551).Layout,
              ...
              for (var S in ((x.prototype = Object.create(r.prototype)), r))
                x[S] = r[S];
              ((x.prototype.newGraphManager = function () {
                  ...
                  (r.prototype.initParameters.call(this, arguments),
                    this.isSubLayout ||
                      (c.DEFAULT_EDGE_LENGTH < 10
                        ...
                        : (this.idealEdgeLength = c.DEFAULT_EDGE_LENGTH),
                      (this.useSmartIdealEdgeLengthCalculation =
                        c.DEFAULT_USE_SMART_IDEAL_EDGE_LENGTH_CALCULATION),
                ...
                (x.prototype.layout = function () {
                  return (
                    d.DEFAULT_CREATE_BENDS_AS_NEEDED &&
                ...
                (x.prototype.classicLayout = function () {
                  ...
                  return (
                    Object.keys(this.constraints).length > 0 &&
                      (l.handleConstraints(this),
                      this.initConstraintVariables()),
                    this.initSpringEmbedder(),
                    c.APPLY_LAYOUT && this.runSpringEmbedder(),
                    !0
                  );
                }),
                    ...
                    if (this.growTreeIterations % 10 == 0)
                      if (this.prunedNodesAll.length > 0) {
                        ...
                        (this.graphManager.setAllNodesToApplyGravitation(t),
                          ...
                          c.PURE_INCREMENTAL
                            ? (this.coolingFactor =
                                u.DEFAULT_COOLING_FACTOR_INCREMENTAL / 2)
                            : (this.coolingFactor =
                ...
                (x.prototype.initConstraintVariables = function () {
                  ...
                  for (
                    var t = this.graphManager.getAllNodes(), n = 0;
                    n < t.length;
                    n++
                  ) {
                    var r = t[n];
                  ...
                  var i = function t(n) {
                    for (
                      var r = n.getChild().getNodes(), i, a = 0, o = 0;
                      o < r.length;
                      o++
                    )
                      ((i = r[o]),
                        i.getChild() == null
                          ? e.fixedNodeSet.has(i.id) && (a += 100)
                          : (a += t(i)));
                    return a;
                  };
                  if (this.constraints.fixedNodeConstraint) {
                    ...
                    for (
                      var t = this.graphManager.getAllNodes(), r, n = 0;
                      n < t.length;
                      n++
                    )
                      if (((r = t[n]), r.getChild() != null)) {
                        var a = i(r);
                  ...
                  if (this.constraints.relativePlacementConstraint) {
                    ...
                    if (
                      ...
                      this.fixedNodeSet.forEach(function (t) {
                        (e.fixedNodesOnHorizontal.add(t),
                          e.fixedNodesOnVertical.add(t));
                      }),
                        ...
                        for (
                          ...
                          (this.dummyToNodeForVerticalAlignment.set(
                            ...
                            l[n].forEach(function (t) {
                              (o.set(t, `dummy` + n),
                                e.dummyToNodeForVerticalAlignment
                                  .get(`dummy` + n)
                                  .push(t),
                                e.fixedNodeSet.has(t) &&
                                  e.fixedNodesOnHorizontal.add(`dummy` + n));
                            }));
                        ...
                        for (
                          ...
                          (this.dummyToNodeForHorizontalAlignment.set(
                            ...
                            u[n].forEach(function (t) {
                              (s.set(t, `dummy` + n),
                                e.dummyToNodeForHorizontalAlignment
                                  .get(`dummy` + n)
                                  .push(t),
                                e.fixedNodeSet.has(t) &&
                                  e.fixedNodesOnVertical.add(`dummy` + n));
                            }));
                    }
                    if (c.RELAX_MOVEMENT_ON_CONSTRAINTS)
                      ((this.shuffle = function (e) {
                        var t, n, r;
                        for (r = e.length - 1; r >= (2 * e.length) / 3; r--)
                        ...
                        this.constraints.relativePlacementConstraint.forEach(
                          function (t) {
                            if (t.left) {
                              var n = o.has(t.left) ? o.get(t.left) : t.left,
                                r = o.has(t.right) ? o.get(t.right) : t.right;
                              (e.nodesInRelativeHorizontal.includes(n) ||
                                (e.nodesInRelativeHorizontal.push(n),
                                e.nodeToRelativeConstraintMapHorizontal.set(
                                  n,
                                  [],
                                ),
                                e.dummyToNodeForVerticalAlignment.has(n)
                                  ? e.nodeToTempPositionMapHorizontal.set(
                                      n,
                                      e.idToNodeMap
                                        .get(
                                          e.dummyToNodeForVerticalAlignment.get(
                                            n,
                                          )[0],
                                        )
                                        .getCenterX(),
                                  ...
                                  : e.nodeToTempPositionMapHorizontal.set(
                                      n,
                                      e.idToNodeMap.get(n).getCenterX(),
                                    )),
                                e.nodesInRelativeHorizontal.includes(r) ||
                                  (e.nodesInRelativeHorizontal.push(r),
                                  e.nodeToRelativeConstraintMapHorizontal.set(
                                    r,
                                    [],
                                  ),
                                  e.dummyToNodeForVerticalAlignment.has(r)
                                    ? e.nodeToTempPositionMapHorizontal.set(
                                        r,
                                        e.idToNodeMap
                                          .get(
                                    ...
                                    : e.nodeToTempPositionMapHorizontal.set(
                                        r,
                                        e.idToNodeMap.get(r).getCenterX(),
                                      )),
                                e.nodeToRelativeConstraintMapHorizontal
                                  .get(n)
                                  .push({ right: r, gap: t.gap }),
                                e.nodeToRelativeConstraintMapHorizontal
                                  .get(r)
                                  .push({ left: n, gap: t.gap }));
                            } else {
                              var i = s.has(t.top) ? s.get(t.top) : t.top,
                                a = s.has(t.bottom)
                                  ? s.get(t.bottom)
                                  : t.bottom;
                              (e.nodesInRelativeVertical.includes(i) ||
                                (e.nodesInRelativeVertical.push(i),
                                e.nodeToRelativeConstraintMapVertical.set(
                                  i,
                                  [],
                                ),
                                e.dummyToNodeForHorizontalAlignment.has(i)
                                  ? e.nodeToTempPositionMapVertical.set(
                                      i,
                                      e.idToNodeMap
                                        .get(
                                          e.dummyToNodeForHorizontalAlignment.get(
                                            i,
                                          )[0],
                                        )
                                        .getCenterY(),
                                  ...
                                  : e.nodeToTempPositionMapVertical.set(
                                      i,
                                      e.idToNodeMap.get(i).getCenterY(),
                                    )),
                                e.nodesInRelativeVertical.includes(a) ||
                                  (e.nodesInRelativeVertical.push(a),
                                  e.nodeToRelativeConstraintMapVertical.set(
                                    a,
                                    [],
                                  ),
                                  e.dummyToNodeForHorizontalAlignment.has(a)
                                    ? e.nodeToTempPositionMapVertical.set(
                                        a,
                                        e.idToNodeMap
                                          .get(
                                    ...
                                    : e.nodeToTempPositionMapVertical.set(
                                        a,
                                        e.idToNodeMap.get(a).getCenterY(),
                                      )),
                                e.nodeToRelativeConstraintMapVertical
                                  .get(i)
                                  .push({ bottom: a, gap: t.gap }),
                                e.nodeToRelativeConstraintMapVertical
                                  .get(a)
                                  .push({ top: i, gap: t.gap }));
                            }
                          },
                        ));
                    else {
                      ...
                      this.constraints.relativePlacementConstraint.forEach(
                        function (e) {
                          if (e.left) {
                            var t = o.has(e.left) ? o.get(e.left) : e.left,
                              n = o.has(e.right) ? o.get(e.right) : e.right;
                            (d.has(t) ? d.get(t).push(n) : d.set(t, [n]),
                              d.has(n) ? d.get(n).push(t) : d.set(n, [t]));
                          } else {
                            var r = s.has(e.top) ? s.get(e.top) : e.top,
                              i = s.has(e.bottom) ? s.get(e.bottom) : e.bottom;
                            (f.has(r) ? f.get(r).push(i) : f.set(r, [i]),
                              f.has(i) ? f.get(i).push(r) : f.set(i, [r]));
                          }
                        },
                      );
                      var p = function (e, t) {
                          ...
                          return (
                            e.forEach(function (s, c) {
                              if (!a.has(c)) {
                                ...
                                var l = c;
                                for (
                                  i.push(l), a.add(l), n[o].push(l);
                                  i.length != 0;

                                )
                                  ((l = i.shift()),
                                    t.has(l) && (r[o] = !0),
                                    e.get(l).forEach(function (e) {
                                      a.has(e) ||
                                        (i.push(e), a.add(e), n[o].push(e));
                                    }));
                                o++;
                              }
                            }),
                      ...
                      ((this.componentsOnHorizontal = m.components),
                        (this.fixedComponentsOnHorizontal = m.isFixed));
                      var h = p(f, e.fixedNodesOnVertical);
                      ((this.componentsOnVertical = h.components),
                        (this.fixedComponentsOnVertical = h.isFixed));
                    }
                  }
                }),
                (x.prototype.updateDisplacements = function () {
                  ...
                  if (
                    ...
                    if (this.constraints.alignmentConstraint.vertical)
                      for (
                        var t = this.constraints.alignmentConstraint.vertical,
                          n = 0;
                        n < t.length;
                        n++
                      ) {
                        ...
                        for (
                          var a = r / t[n].length, i = 0;
                          i < t[n].length;
                          i++
                        )
                          this.idToNodeMap.get(t[n][i]).displacementX = a;
                      }
                    if (this.constraints.alignmentConstraint.horizontal)
                      for (
                        var o = this.constraints.alignmentConstraint.horizontal,
                          n = 0;
                        n < o.length;
                        n++
                      ) {
                        ...
                        for (
                          var l = s / o[n].length, i = 0;
                          i < o[n].length;
                          i++
                        )
                          this.idToNodeMap.get(o[n][i]).displacementY = l;
                      }
                  }
                  if (this.constraints.relativePlacementConstraint)
                    if (c.RELAX_MOVEMENT_ON_CONSTRAINTS)
                      (this.totalIterations % 10 == 0 &&
                        ...
                        this.nodesInRelativeHorizontal.forEach(function (t) {
                          if (!e.fixedNodesOnHorizontal.has(t)) {
                            var n = 0;
                            ((n = e.dummyToNodeForVerticalAlignment.has(t)
                              ? e.idToNodeMap.get(
                                  e.dummyToNodeForVerticalAlignment.get(t)[0],
                                ).displacementX
                              : e.idToNodeMap.get(t).displacementX),
                              e.nodeToRelativeConstraintMapHorizontal
                                .get(t)
                                .forEach(function (r) {
                                  if (r.right) {
                                    var i =
                                      e.nodeToTempPositionMapHorizontal.get(
                                        r.right,
                                      ) -
                                      e.nodeToTempPositionMapHorizontal.get(t) -
                                      n;
                                    i < r.gap && (n -= r.gap - i);
                                  } else {
                                    var i =
                              ...
                              e.nodeToTempPositionMapHorizontal.set(
                                t,
                                e.nodeToTempPositionMapHorizontal.get(t) + n,
                              ),
                              e.dummyToNodeForVerticalAlignment.has(t)
                                ? e.dummyToNodeForVerticalAlignment
                                    .get(t)
                                    .forEach(function (t) {
                        ...
                        this.nodesInRelativeVertical.forEach(function (t) {
                          if (!e.fixedNodesOnHorizontal.has(t)) {
                            var n = 0;
                            ((n = e.dummyToNodeForHorizontalAlignment.has(t)
                              ? e.idToNodeMap.get(
                                  e.dummyToNodeForHorizontalAlignment.get(t)[0],
                                ).displacementY
                              : e.idToNodeMap.get(t).displacementY),
                              e.nodeToRelativeConstraintMapVertical
                                .get(t)
                                .forEach(function (r) {
                                  if (r.bottom) {
                                    var i =
                                      e.nodeToTempPositionMapVertical.get(
                                        r.bottom,
                                      ) -
                                      e.nodeToTempPositionMapVertical.get(t) -
                                      n;
                                    i < r.gap && (n -= r.gap - i);
                                  } else {
                                    var i =
                              ...
                              e.nodeToTempPositionMapVertical.set(
                                t,
                                e.nodeToTempPositionMapVertical.get(t) + n,
                              ),
                              e.dummyToNodeForHorizontalAlignment.has(t)
                                ? e.dummyToNodeForHorizontalAlignment
                                    .get(t)
                                    .forEach(function (t) {
                      ...
                      for (
                        ...
                        if (this.fixedComponentsOnHorizontal[n])
                          for (var i = 0; i < u.length; i++)
                            this.dummyToNodeForVerticalAlignment.has(u[i])
                          ...
                          for (var d = 0, f = 0, i = 0; i < u.length; i++)
                            if (
                              this.dummyToNodeForVerticalAlignment.has(u[i])
                            ) {
                              var p = this.dummyToNodeForVerticalAlignment.get(
                                u[i],
                              );
                              ((d +=
                                p.length *
                                this.idToNodeMap.get(p[0]).displacementX),
                                (f += p.length));
                            } else
                              ((d += this.idToNodeMap.get(u[i]).displacementX),
                                f++);
                          for (var m = d / f, i = 0; i < u.length; i++)
                            this.dummyToNodeForVerticalAlignment.has(u[i])
                              ? this.dummyToNodeForVerticalAlignment
                                  .get(u[i])
                                  .forEach(function (t) {
                      ...
                      for (
                        var n = 0;
                        n < this.componentsOnVertical.length;
                        n++
                      ) {
                        var u = this.componentsOnVertical[n];
                        if (this.fixedComponentsOnVertical[n])
                          for (var i = 0; i < u.length; i++)
                            this.dummyToNodeForHorizontalAlignment.has(u[i])
                          ...
                          for (var d = 0, f = 0, i = 0; i < u.length; i++)
                            if (
                              ...
                              ((d += this.idToNodeMap.get(u[i]).displacementY),
                                f++);
                          for (var m = d / f, i = 0; i < u.length; i++)
                            this.dummyToNodeForHorizontalAlignment.has(u[i])
                              ? this.dummyToNodeForHorizontalAlignment
                ...
                (x.prototype.calculateNodesToApplyGravitationTo = function () {
                  var e = [],
                    t,
                    n = this.graphManager.getGraphs(),
                    r = n.length,
                    i;
                  for (i = 0; i < r; i++)
                    ((t = n[i]),
                      t.updateConnected(),
                      t.isConnected || (e = e.concat(t.getNodes())));
                  return e;
                }),
                          ...
                          if (o.length > 1) {
                            ...
                            for (s = 0; s < o.length; s++) {
                              ...
                              (c.getBendpoints().push(new p()),
                                this.createDummyNodesForBendpoints(c));
                            }
                          }
                ...
                (x.prototype.positionNodesRadially = function (e) {
                  for (
                    ...
                    s % n == 0 &&
                      ((a = 0),
                      (i = r),
                      s != 0 && (i += c.DEFAULT_COMPONENT_SEPERATION),
                      (r = 0));
                    var l = e[s],
                      u = h.findCenterOfTree(l);
                    ((t.x = a),
                      (t.y = i),
                      (o = x.radialLayout(l, u, t)),
                      o.y > r && (r = Math.floor(o.y)),
                      (a = Math.floor(o.x + c.DEFAULT_COMPONENT_SEPERATION)));
                  }
                  this.transform(
                    new p(
                      d.WORLD_CENTER_X - o.x / 2,
                      d.WORLD_CENTER_Y - o.y / 2,
                    ),
                  );
                }),
                ...
                (x.branchRadialLayout = function (e, t, n, r, i, a) {
                  ...
                  t != null && d--;
                  for (
                    var f = 0, p = u.length, m, h = e.getEdgesBetween(t);
                    h.length > 1;
                ...
                (x.prototype.groupZeroDegreeMembers = function () {
                  ...
                  for (
                    ...
                    var a = r[i],
                      s = a.getParent();
                    this.getNodeDegreeWithChildren(a) === 0 &&
                      (s.id == null || !this.getToBeTiled(s)) &&
                      n.push(a);
                  }
                ...
                (x.prototype.clearZeroDegreeMembers = function () {
                  ...
                  Object.keys(this.memberGroups).forEach(function (n) {
                    ...
                    if (
                      ...
                      r.setCenter(t[n].centerX, t[n].centerY),
                      (r.labelMarginLeft = 0),
                      (r.labelMarginTop = 0),
                ...
                (x.prototype.adjustLocations = function (e, t, n, r, i, a, o) {
                  ...
                  for (var s = t, c = 0; c < e.rows.length; c++) {
                    ...
                    for (var u = 0, d = 0; d < l.length; d++) {
                      ...
                      ((f.rect.x = t),
                        (f.rect.y = n),
                        (t += f.rect.width + e.horizontalPadding),
                        f.rect.height > u && (u = f.rect.height));
                    }
                    ...
                    Object.keys(e).forEach(function (r) {
                      ...
                      if (
                        ...
                        var a = i.rect.width,
                          o = i.rect.height;
                        (i.labelWidth &&
                          (i.labelPosHorizontal == `left`
                            ? ((i.rect.x -= i.labelWidth),
                              i.setWidth(a + i.labelWidth),
                              (i.labelMarginLeft = i.labelWidth))
                            : i.labelPosHorizontal == `center` &&
                                i.labelWidth > a
                              ? ((i.rect.x -= (i.labelWidth - a) / 2),
                                i.setWidth(i.labelWidth),
                                (i.labelMarginLeft = (i.labelWidth - a) / 2))
                              : i.labelPosHorizontal == `right` &&
                                i.setWidth(a + i.labelWidth)),
                          i.labelHeight &&
                            (i.labelPosVertical == `top`
                              ? ((i.rect.y -= i.labelHeight),
                                i.setHeight(o + i.labelHeight),
                                (i.labelMarginTop = i.labelHeight))
                              : i.labelPosVertical == `center` &&
                                  i.labelHeight > o
                                ? ((i.rect.y -= (i.labelHeight - o) / 2),
                                  i.setHeight(i.labelHeight),
                                  (i.labelMarginTop = (i.labelHeight - o) / 2))
                                : i.labelPosVertical == `bottom` &&
                                  i.setHeight(o + i.labelHeight)));
                      }
                    }));
                }),
                (x.prototype.tileNodes = function (e, t) {
                  var n = this.tileNodesByFavoringDim(e, t, !0),
                    r = this.tileNodesByFavoringDim(e, t, !1),
                ...
                (x.prototype.calcIdealRowWidth = function (e, t) {
                  var n = c.TILING_PADDING_VERTICAL,
                    r = c.TILING_PADDING_HORIZONTAL,
                    i = e.length,
                    a = 0,
                    o = 0,
                    s = 0;
                  e.forEach(function (e) {
                    ((a += e.getWidth()),
                      (o += e.getHeight()),
                      e.getWidth() > s && (s = e.getWidth()));
                  });
                  var l = a / i,
                    u = o / i,
                    d = (n - r) ** 2 + 4 * (l + r) * (u + n) * i,
                    f = (r - n + Math.sqrt(d)) / (2 * (l + r)),
                    p;
                ...
                (x.prototype.tileNodesByFavoringDim = function (e, t, n) {
                  var r = c.TILING_PADDING_VERTICAL,
                    i = c.TILING_PADDING_HORIZONTAL,
                    a = c.TILING_COMPARE_BY,
                    o = {
                      rows: [],
                      rowWidth: [],
                      rowHeight: [],
                  ...
                  for (var f = 0; f < e.length; f++) {
                    ...
                    if (o.rows.length == 0) this.insertNodeToRow(o, p, 0, t);
                      ...
                      this.canAddHorizontal(o, p.rect.width, p.rect.height)
                    ) {
                      var m = o.rows.length - 1;
                      (o.idealRowWidth || (m = this.getShortestRowIndex(o)),
                        this.insertNodeToRow(o, p, m, t));
                ...
                (x.prototype.canAddHorizontal = function (e, t, n) {
                  if (e.idealRowWidth) {
                    ...
                    return (
                      e.rowWidth[r] + t + e.horizontalPadding <= e.idealRowWidth
                    );
                  }
                  ...
                  e.rowHeight[i] < n &&
                    i > 0 &&
                    (o = n + e.verticalPadding - e.rowHeight[i]);
                  var s =
                    e.width - a >= t + e.horizontalPadding
                      ? (e.height + o) / (a + t + e.horizontalPadding)
                      : (e.height + o) / e.width;
                  o = n + e.verticalPadding;
                  var c =
                    e.width < t ? (e.height + o) / t : (e.height + o) / e.width;
                  ...
                  for (var e = [], t = !0, n; t; ) {
                    ...
                    for (var a = 0; a < r.length; a++)
                      if (
                        ((n = r[a]),
                        n.getEdges().length == 1 &&
                          !n.getEdges()[0].isInterGraph &&
                          n.getChild() == null)
                      ) {
                        if (c.PURE_INCREMENTAL) {
                          var o = n.getEdges()[0].getOtherEnd(n),
                            s = new m(
                              n.getCenterX() - o.getCenterX(),
                              n.getCenterY() - o.getCenterY(),
                            );
                          i.push([n, n.getEdges()[0], n.getOwner(), s]);
                        } else i.push([n, n.getEdges()[0], n.getOwner()]);
                        t = !0;
                      }
                    if (t == 1) {
                      for (var l = [], u = 0; u < i.length; u++)
                        i[u][0].getEdges().length == 1 &&
                          (l.push(i[u]), i[u][0].getOwner().remove(i[u][0]));
                      (e.push(l),
                        this.graphManager.resetAllNodes(),
                        this.graphManager.resetAllEdges());
                    }
                ...
                (x.prototype.growTree = function (e) {
                  for (var t = e[e.length - 1], n, r = 0; r < t.length; r++)
                    ((n = t[r]),
                ...
                (x.prototype.findPlaceforPrunedNode = function (e) {
                  ...
                  if (
                    ...
                    r.setCenter(
                      n.getCenterX() + e[3].getWidth(),
                      n.getCenterY() + e[3].getHeight(),
                    );
                  else {
                    var i = n.startX,
                      a = n.finishX,
                    ...
                    if (o > 0)
                      for (var d = i; d <= a; d++)
                        l[0] +=
                          this.grid[d][o - 1].length +
                          this.grid[d][o].length -
                          1;
                    if (a < this.grid.length - 1)
                      for (var d = o; d <= s; d++)
                        l[1] +=
                          this.grid[a + 1][d].length +
                          this.grid[a][d].length -
                          1;
                    if (s < this.grid[0].length - 1)
                      for (var d = i; d <= a; d++)
                        l[2] +=
                          this.grid[d][s + 1].length +
                          this.grid[d][s].length -
                          1;
                    if (i > 0)
                      for (var d = o; d <= s; d++)
                        l[3] +=
                          this.grid[i - 1][d].length +
                          this.grid[i][d].length -
                          1;
                    for (var f = g.MAX_VALUE, p, m, h = 0; h < l.length; h++)
                      l[h] < f
                        ? ((f = l[h]), (p = 1), (m = h))
                        : l[h] == f && p++;
                    if (p == 3 && f == 0)
            ...
            991: (e, t, n) => {
              ...
              ((a.prototype.calculateDisplacement = function () {
                ...
                (a.prototype.propogateDisplacementToChildren = function (e, t) {
                  for (
                    var n = this.getChild().getNodes(), r, i = 0;
                    i < n.length;
                    i++
                  )
                    ((r = n[i]),
                      r.getChild() == null
                        ? ((r.displacementX += e), (r.displacementY += t))
                        : r.propogateDisplacementToChildren(e, t));
                }),
            ...
            902: (e, t, n) => {
              ...
              ((c.handleConstraints = function (e) {
                var t = {};
                ((t.fixedNodeConstraint = e.constraints.fixedNodeConstraint),
                  (t.alignmentConstraint = e.constraints.alignmentConstraint),
                ...
                t.relativePlacementConstraint &&
                  t.relativePlacementConstraint.forEach(function (e) {
                    !e.gap &&
                      e.gap != 0 &&
                      (e.left
                        ? (e.gap =
                            i.DEFAULT_EDGE_LENGTH +
                            n.get(e.left).getWidth() / 2 +
                            n.get(e.right).getWidth() / 2)
                        : (e.gap =
                            i.DEFAULT_EDGE_LENGTH +
                            n.get(e.top).getHeight() / 2 +
                            n.get(e.bottom).getHeight() / 2));
                  });
                var h = function (e, t) {
                    ...
                    (d.forEach(function (e, r) {
                      (e == 0
                        ? (m.push(r),
                          n ||
                            (t == `horizontal`
                              ? f.set(r, c.has(r) ? l[c.get(r)] : i.get(r))
                              : f.set(r, c.has(r) ? u[c.get(r)] : i.get(r))))
                        : f.set(r, -1 / 0),
                        n && p.set(r, new Set([r])));
                    }),
                      n &&
                        o.forEach(function (e) {
                          ...
                          if (
                            ...
                            (r.forEach(function (e) {
                              t == `horizontal`
                                ? (f.set(e, c.has(e) ? l[c.get(e)] : i.get(e)),
                                  (a += f.get(e)))
                                : (f.set(e, c.has(e) ? u[c.get(e)] : i.get(e)),
                                  (a += f.get(e)));
                            }),
                              (a /= r.length),
                              e.forEach(function (e) {
                            ...
                            (e.forEach(function (e) {
                              t == `horizontal`
                                ? (o += c.has(e) ? l[c.get(e)] : i.get(e))
                                : (o += c.has(e) ? u[c.get(e)] : i.get(e));
                            }),
                              (o /= e.length),
                              e.forEach(function (e) {
                                f.set(e, o);
                    ...
                    for (
                      var h = function () {
                        ...
                        e.get(r).forEach(function (e) {
                          ...
                          (d.set(e.id, d.get(e.id) - 1),
                            d.get(e.id) == 0 && m.push(e.id),
                            n && p.set(e.id, s(p.get(r), p.get(e.id))));
                        });
                      };
                      m.length != 0;
                  ...
                  v = function (e) {
                    ...
                    if (
                      (e.forEach(function (e) {
                        e.left
                          ? l[c.get(e.left)] - l[c.get(e.right)] >= 0
                            ? t++
                            : n++
                          : u[c.get(e.top)] - u[c.get(e.bottom)] >= 0
                            ? r++
                            : i++;
                      }),
                      t > n && r > i)
                      ...
                      for (var o = 0; o < c.size; o++) l[o] = -1 * l[o];
                    else if (r > i)
                      for (var s = 0; s < c.size; s++) u[s] = -1 * u[s];
                  },
                  y = function (e) {
                    var t = [],
                      n = new a(),
                    ...
                    return (
                      e.forEach(function (a, o) {
                        if (!r.has(o)) {
                          ...
                          var s = o;
                          for (
                            n.push(s), r.add(s), t[i].push(s);
                            n.length != 0;

                          )
                            ((s = n.shift()),
                              e.get(s).forEach(function (e) {
                                r.has(e.id) ||
                                  (n.push(e.id), r.add(e.id), t[i].push(e.id));
                              }));
                          i++;
                        }
                      }),
                ...
                if (
                  ...
                  if (t.fixedNodeConstraint && t.fixedNodeConstraint.length > 1)
                    (t.fixedNodeConstraint.forEach(function (e, t) {
                      ((S[t] = [e.position.x, e.position.y]),
                        (C[t] = [l[c.get(e.nodeId)], u[c.get(e.nodeId)]]));
                    }),
                      (w = !0));
                  else if (t.alignmentConstraint)
                    (function () {
                      var e = 0;
                      if (t.alignmentConstraint.vertical) {
                        for (
                          var n = t.alignmentConstraint.vertical,
                            i = function (t) {
                              var i = new Set();
                              ...
                              ((o =
                                a.size > 0
                                  ? l[c.get(a.values().next().value)]
                                  : g(i).x),
                                n[t].forEach(function (t) {
                                  ((S[e] = [o, u[c.get(t)]]),
                                    (C[e] = [l[c.get(t)], u[c.get(t)]]),
                                    e++);
                                }));
                            },
                            a = 0;
                      ...
                      if (t.alignmentConstraint.horizontal) {
                        for (
                          var o = t.alignmentConstraint.horizontal,
                            s = function (t) {
                              var n = new Set();
                    ...
                    for (var A = 0, j = 0, M = 0; M < k.length; M++)
                      k[M].length > A && ((A = k[M].length), (j = M));
                    if (A < O.size / 2)
                      (v(t.relativePlacementConstraint), (w = !1), (T = !1));
                    else {
                      var N = new Map(),
                        P = new Map(),
                        F = [];
                        ...
                        D.get(e).forEach(function (t) {
                          t.direction == `horizontal`
                            ? (N.has(e) ? N.get(e).push(t) : N.set(e, [t]),
                              N.has(t.id) || N.set(t.id, []),
                              F.push({ left: e, right: t.id }))
                            : (P.has(e) ? P.get(e).push(t) : P.set(e, [t]),
                              P.has(t.id) || P.set(t.id, []),
                              F.push({ top: e, bottom: t.id }));
                        });
                      }),
                        v(F),
                        (T = !1));
                      var I = _(N, `horizontal`),
                        L = _(P, `vertical`);
                      (k[j].forEach(function (e, t) {
                        ((C[t] = [l[c.get(e)], u[c.get(e)]]),
                          (S[t] = []),
                          I.has(e)
                            ? (S[t][0] = I.get(e))
                            : (S[t][0] = l[c.get(e)]),
                  ...
                  if (w) {
                    for (
                      ...
                      ((z[V] = o.multGamma(z[V])), (B[V] = o.multGamma(B[V])));
                    var ee = o.multMat(z, o.transpose(B)),
                      te = s.svd(ee);
                    R = o.multMat(te.V, o.transpose(te.U));
                    for (var H = 0; H < c.size; H++) {
                      var ne = [l[H], u[H]],
                        re = [R[0][0], R[1][0]],
                        U = [R[0][1], R[1][1]];
                      ((l[H] = o.dotProduct(ne, re)),
                        (u[H] = o.dotProduct(ne, U)));
                    }
                ...
                if (i.ENFORCE_CONSTRAINTS) {
                  if (
                    t.fixedNodeConstraint &&
                    t.fixedNodeConstraint.length > 0
                  ) {
                    var W = { x: 0, y: 0 };
                    (t.fixedNodeConstraint.forEach(function (e, t) {
                      var n = { x: l[c.get(e.nodeId)], y: u[c.get(e.nodeId)] },
                        r = e.position,
                        i = h(r, n);
                      ((W.x += i.x), (W.y += i.y));
                    }),
                      (W.x /= t.fixedNodeConstraint.length),
                      (W.y /= t.fixedNodeConstraint.length),
                      ...
                      t.fixedNodeConstraint.forEach(function (e) {
                        ((l[c.get(e.nodeId)] = e.position.x),
                          (u[c.get(e.nodeId)] = e.position.y));
                      }));
                  }
                  if (t.alignmentConstraint) {
                    if (t.alignmentConstraint.vertical)
                      for (
                        var G = t.alignmentConstraint.vertical,
                          ie = function (e) {
                            var t = new Set();
                    ...
                    if (t.alignmentConstraint.horizontal)
                      for (
                        var q = t.alignmentConstraint.horizontal,
                          J = function (e) {
                            var t = new Set();
                  ...
                  t.relativePlacementConstraint &&
                    (function () {
                      ...
                      if (
                        ...
                        if (t.alignmentConstraint.vertical)
                          for (
                            var f = t.alignmentConstraint.vertical,
                              p = function (t) {
                                (r.set(`dummy` + t, []),
                                  f[t].forEach(function (n) {
                                    (e.set(n, `dummy` + t),
                                      r.get(`dummy` + t).push(n),
                                      E.has(n) && s.add(`dummy` + t));
                                  }),
                        ...
                        if (t.alignmentConstraint.horizontal)
                          for (
                            var h = t.alignmentConstraint.horizontal,
                              g = function (e) {
                                (i.set(`dummy` + e, []),
                                  h[e].forEach(function (t) {
                                    (n.set(t, `dummy` + e),
                                      i.get(`dummy` + e).push(t),
                                      E.has(t) && d.add(`dummy` + e));
                                  }),
                            ...
                            r.direction == `horizontal`
                              ? ((i = e.get(t) ? e.get(t) : t),
                                (a = e.get(r.id)
                                  ...
                                  : r),
                                S.has(i) ? S.get(i).push(a) : S.set(i, [a]),
                                S.has(a.id) || S.set(a.id, []))
                              : ((i = n.get(t) ? n.get(t) : t),
                                (a = n.get(r.id)
                                  ? {
                                      id: n.get(r.id),
                                  ...
                                  : r),
                                C.has(i) ? C.get(i).push(a) : C.set(i, [a]),
                                C.has(a.id) || C.set(a.id, []));
                          });
                        },
                        T = !0,
                        O = !1,
                      ...
                      try {
                        for (
                          var A = D.keys()[Symbol.iterator](), j;
                          !(T = (j = A.next()).done);
                          T = !0
                        ) {
                          var M = j.value;
                      ...
                      (F.forEach(function (e, t) {
                        ...
                        I.forEach(function (e, t) {
                          ((B[t] = []),
                            e.forEach(function (e) {
                              R.get(e).length == 0 && B[t].push(e);
                            }));
                        }));
                      var V = _(S, `horizontal`, s, a, z),
                        ee = _(C, `vertical`, d, o, B),
                        te = function (e) {
                          r.get(e)
                            ? r.get(e).forEach(function (t) {
                                l[c.get(t)] = V.get(e);
                              })
                            : (l[c.get(e)] = V.get(e));
                        },
                      ...
                      try {
                        for (
                          var U = V.keys()[Symbol.iterator](), W;
                          !(H = (W = U.next()).done);
                          H = !0
                        ) {
                          var G = W.value;
                      ...
                      try {
                        for (
                          var Y = ee.keys()[Symbol.iterator](), ae;
                          !(K = (ae = Y.next()).done);
                          K = !0
                        ) {
                          var G = ae.value;
                ...
                for (var ae = 0; ae < d.length; ae++) {
                  var X = d[ae];
                  X.getChild() ?? X.setCenter(l[c.get(X.id)], u[c.get(X.id)]);
                }
              }),
                (e.exports = c));
            },
      ...
      (function (n, r) {
        typeof e == `object` && typeof t == `object`
          ...
          : typeof define == `function` && define.amd
            ? define([`cose-base`], r)
            : typeof e == `object`
              ? (e.cytoscapeFcose = r(O()))
              : (n.cytoscapeFcose = r(n.coseBase));
      })(e, function (e) {
        return (() => {
          var t = {
              658: (e) => {
                ...
                ((a.getTopMostNodes = function (e) {
                  ...
                  (a.connectComponents = function (e, t, n, r) {
                    var a = new i(),
                      ...
                      h = function () {
                        ...
                        var i = n[0],
                          h = e.collection();
                        (h.merge(i).merge(i.descendants().intersection(t)),
                          s.push(i),
                        ...
                        for (
                          var g = function () {
                            ...
                            for (var u = 0; u < l.length; u++) {
                              var d = l[u];
                              ((c = n.intersection(d.union(d.ancestors()))),
                                c != null &&
                                  !o.has(c[0]) &&
                                  c
                                    .union(c.descendants())
                        ...
                        if (
                          ...
                          ((l = s[0]),
                            (u = l.connectedEdges().length),
                            s.forEach(function (e) {
                              e.connectedEdges().length < u &&
                                ((u = e.connectedEdges().length), (l = e));
                            }),
                            p.push(l.id()));
                          var _ = e.collection();
                          (_.merge(s[0]),
                    ...
                    while (!d);
                    return (
                      r && p.length > 0 && r.set(`dummy` + (r.size + 1), p),
                      m
                    );
                  }),
                  (a.relocateComponent = function (e, t, n) {
                    if (!n.fixedNodeConstraint) {
                      ...
                      if (n.quality == `draft`) {
                        ...
                        try {
                          for (
                            var d = t.nodeIndexes[Symbol.iterator](), f;
                            !(c = (f = d.next()).done);
                            c = !0
                          ) {
                            var p = f.value,
                        ...
                        Object.keys(t).forEach(function (e) {
                          var n = t[e],
                            r = n.getRect().x,
                            c = n.getRect().x + n.getRect().width,
                            l = n.getRect().y,
                            u = n.getRect().y + n.getRect().height;
                          (r < i && (i = r),
                            c > a && (a = c),
                            l < o && (o = l),
                            u > s && (s = u));
                  ...
                  (a.calcBoundingBox = function (e, t, n, r) {
                    for (
                      ...
                      var h = f[m];
                      ((c = t[r.get(h.id())] - h.width() / 2),
                        (l = t[r.get(h.id())] + h.width() / 2),
                        (u = n[r.get(h.id())] - h.height() / 2),
                        (d = n[r.get(h.id())] + h.height() / 2),
                        i > c && (i = c),
                        a < l && (a = l),
                        o > u && (o = u),
                        s < d && (s = d));
              ...
              816: (e, t, n) => {
                var r = n(548),
                  ...
                  c = n(140).layoutBase.LayoutConstants,
                  l = n(140).layoutBase.FDLayoutConstants,
                  u = n(140).CoSEConstants;
                e.exports = {
                  coseLayout: function (e, t) {
                    var n = e.cy,
                      ...
                      _ = {};
                    e.randomize &&
                      ((m = t.nodeIndexes), (h = t.xCoords), (g = t.yCoords));
                    var v = function (e) {
                      ...
                      b = r.calcParentsWithoutChildren(n, d),
                      x = function e(t, n, i, c) {
                        for (var l = n.length, u = 0; u < l; u++) {
                          var d = n[u],
                            f = null;
                          d.intersection(b).length == 0 && (f = d.children());
                          var p = void 0,
                            v = d.layoutDimensions({
                              ...
                              if (!d.isParent())
                                p = t.add(
                                  new a(
                                    ...
                                    new s(parseFloat(v.w), parseFloat(v.h)),
                                  ),
                                );
                              else {
                                var x = r.calcBoundingBox(d, h, g, m);
                                p =
                                  d.intersection(b).length == 0
                                    ? t.add(
                                        new a(
                                          i.graphManager,
                                          new o(x.topLeftX, x.topLeftY),
                                          new s(x.width, x.height),
                                        ),
                                      )
                                    : t.add(
                                        new a(
                          ...
                          if (
                            ((p.id = d.data(`id`)),
                            (p.nodeRepulsion = y(c.nodeRepulsion, d)),
                            ...
                            var S = void 0;
                            ((S = i.getGraphManager().add(i.newGraph(), p)),
                              e(S, f, i, c));
                          }
                        }
                      },
                      S = function (t, n, r) {
                        for (var i = 0, a = 0, o = 0; o < r.length; o++) {
                          ...
                          if (
                            ...
                            d &&
                            c !== d &&
                            c.getEdgesBetween(d).length == 0
                          ) {
                            var f = n.add(t.newEdge(), c, d);
                            ((f.id = s.id()),
                              (f.idealLength = y(e.idealEdgeLength, s)),
                              (f.edgeElasticity = y(e.edgeElasticity, s)),
                              (i += f.idealLength),
                              a++);
                          }
                        }
                        e.idealEdgeLength != null &&
                          (a > 0
                            ? (u.DEFAULT_EDGE_LENGTH = l.DEFAULT_EDGE_LENGTH =
                                i / a)
                            : v(e.idealEdgeLength)
                              ? (u.DEFAULT_EDGE_LENGTH = l.DEFAULT_EDGE_LENGTH =
                                  50)
                              : (u.DEFAULT_EDGE_LENGTH = l.DEFAULT_EDGE_LENGTH =
                                  e.idealEdgeLength),
                          (u.MIN_REPULSION_DIST = l.MIN_REPULSION_DIST =
                            l.DEFAULT_EDGE_LENGTH / 10),
                          (u.DEFAULT_RADIAL_SEPARATION =
                    ...
                    (e.nestingFactor != null &&
                      (u.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR =
                        l.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR =
                          e.nestingFactor),
                      e.gravity != null &&
                        (u.DEFAULT_GRAVITY_STRENGTH =
                          l.DEFAULT_GRAVITY_STRENGTH =
                            e.gravity),
                      e.numIter != null &&
                        (u.MAX_ITERATIONS = l.MAX_ITERATIONS = e.numIter),
                      e.gravityRange != null &&
                        (u.DEFAULT_GRAVITY_RANGE_FACTOR =
                          l.DEFAULT_GRAVITY_RANGE_FACTOR =
                            e.gravityRange),
                      e.gravityCompound != null &&
                        (u.DEFAULT_COMPOUND_GRAVITY_STRENGTH =
                          l.DEFAULT_COMPOUND_GRAVITY_STRENGTH =
                            e.gravityCompound),
                      e.gravityRangeCompound != null &&
                        (u.DEFAULT_COMPOUND_GRAVITY_RANGE_FACTOR =
                          l.DEFAULT_COMPOUND_GRAVITY_RANGE_FACTOR =
                            e.gravityRangeCompound),
                      e.initialEnergyOnIncremental != null &&
                        (u.DEFAULT_COOLING_FACTOR_INCREMENTAL =
                          l.DEFAULT_COOLING_FACTOR_INCREMENTAL =
                            e.initialEnergyOnIncremental),
                      e.tilingCompareBy != null &&
                        (u.TILING_COMPARE_BY = e.tilingCompareBy),
                      e.quality == `proof` ? (c.QUALITY = 2) : (c.QUALITY = 0),
                      ...
                      (u.DEFAULT_INCREMENTAL =
                        ...
                        c.DEFAULT_INCREMENTAL =
                          !e.randomize),
                      (u.ANIMATE = l.ANIMATE = c.ANIMATE = e.animate),
                      (u.TILE = e.tile),
                      (u.TILING_PADDING_VERTICAL =
                        typeof e.tilingPaddingVertical == `function`
                          ? e.tilingPaddingVertical.call()
                          : e.tilingPaddingVertical),
                      (u.TILING_PADDING_HORIZONTAL =
                        typeof e.tilingPaddingHorizontal == `function`
                      ...
                      (u.DEFAULT_INCREMENTAL =
                        ...
                        c.DEFAULT_INCREMENTAL =
                          !0),
                      (u.PURE_INCREMENTAL = !e.randomize),
                      (c.DEFAULT_UNIFORM_LEAF_NODE_SIZES =
                        e.uniformNodeDimensions),
                      e.step == `transformed` &&
                        ((u.TRANSFORM_ON_CONSTRAINT_HANDLING = !0),
                        (u.ENFORCE_CONSTRAINTS = !1),
                        (u.APPLY_LAYOUT = !1)),
                      e.step == `enforced` &&
                        ((u.TRANSFORM_ON_CONSTRAINT_HANDLING = !1),
                        (u.ENFORCE_CONSTRAINTS = !0),
                        (u.APPLY_LAYOUT = !1)),
                      e.step == `cose` &&
                        ((u.TRANSFORM_ON_CONSTRAINT_HANDLING = !1),
                        (u.ENFORCE_CONSTRAINTS = !1),
                      ...
                      e.relativePlacementConstraint
                        ? (u.TREE_REDUCTION_ON_INCREMENTAL = !1)
                        : (u.TREE_REDUCTION_ON_INCREMENTAL = !0));
                    var w = new i(),
                      T = w.newGraphManager();
                    return (
                      x(T.addRoot(), r.getTopMostNodes(f), w, e),
                      S(w, T, p),
                      C(w, e),
                      w.runLayout(),
                      _
                        ...
                        value: function () {
                          ...
                          if (
                            ...
                            if (f) {
                              ...
                              if (
                                ((l = o.connectComponents(n, t.eles, p)),
                                        ...
                                        if (
                                          ...
                                          if (t.quality == `draft`) {
                                            var u = r.get(c.id()),
                                              ...
                                              p = [];
                                            if (c.isParent()) {
                                              var m = o.calcBoundingBox(
                                                c,
                                                i[n].xCoords,
                                                i[n].yCoords,
                                                r,
                                              );
                                              (f.push(m.topLeftX + m.width / 2),
                                                f.push(
                                                  m.topLeftY + m.height / 2,
                                                ));
                                            } else
                                              (f.push(i[n].xCoords[u]),
                                                f.push(i[n].yCoords[u]));
                                            if (l.isParent()) {
                                              var h = o.calcBoundingBox(
                                                l,
                                                i[n].xCoords,
                                                i[n].yCoords,
                                                r,
                                              );
                                              (p.push(h.topLeftX + h.width / 2),
                                                p.push(
                                                  h.topLeftY + h.height / 2,
                                                ));
                                            } else
                                              (p.push(i[n].xCoords[d]),
                                                p.push(i[n].yCoords[d]));
                                            s.edges.push({
                                              startX: f[0],
                                              startY: f[1],
                                              endX: p[0],
                              ...
                              t.quality == `default` || t.quality == `proof`
                                ? (a.push(c(t, i[0])),
                                  o.relocateComponent(u[0], a[0], t))
                                : o.relocateComponent(u[0], i[0], t);
                            }
                          var A = function (e, n) {
                            if (
                              t.quality == `default` ||
                              ...
                              return (
                                ...
                                t.nodeDimensionsIncludeLabels &&
                                  (o.labelWidth &&
                                    (o.labelPosHorizontal == `left`
                                      ? (r.x += o.labelWidth / 2)
                                      : o.labelPosHorizontal == `right` &&
                                        (r.x -= o.labelWidth / 2)),
                                  o.labelHeight &&
                                    (o.labelPosVertical == `top`
                                      ? (r.y += o.labelHeight / 2)
                                      : o.labelPosVertical == `bottom` &&
                                        (r.y -= o.labelHeight / 2))),
                                (r ??= {
                                  x: e.position(`x`),
                                  y: e.position(`y`),
                          ...
                          if (
                            ...
                            var j = o.calcParentsWithoutChildren(n, r),
                  ...
                  spectralLayout: function (e) {
                    var t = e.cy,
                      ...
                      D = function (e, t, n) {
                        ...
                        for (r[a] = e, c[e] = 0; a >= i; ) {
                          o = r[i++];
                          for (var m = d[o], _ = 0; _ < m.length; _++)
                            ((s = l.get(m[_])),
                              c[s] == b && ((c[s] = c[o] + 1), (r[++a] = s)));
                          g[o][t] = c[o] * w;
                        }
                        if (n) {
                          for (var v = 0; v < y; v++)
                      ...
                      O = function (e) {
                        ...
                        for (var a = 0; a < y; a++)
                          for (var o = 0; o < T; o++) g[a][o] *= g[a][o];
                        for (var s = 0; s < T; s++) _[s] = [];
                        for (var c = 0; c < T; c++)
                          for (var l = 0; l < T; l++) _[c][l] = g[m[l]][c];
                      },
                      k = function () {
                        for (
                          var e = a.svd(_),
                      ...
                      A = function () {
                        ...
                        for (var c = 0, l = x, u = x, d = void 0; ; ) {
                          ...
                          if (
                            ((n = i.multGamma(i.multL(i.multGamma(a), g, v))),
                            (e = i.dotProduct(a, n)),
                            (n = i.normalize(n)),
                            (l = i.dotProduct(a, n)),
                            (d = Math.abs(l / u)),
                        ...
                        for (c = 0, u = x; ; ) {
                          ...
                          if (
                            ...
                            (r = i.multGamma(i.multL(i.multGamma(o), g, v))),
                            (t = i.dotProduct(o, r)),
                            (r = i.normalize(r)),
                            (l = i.dotProduct(o, r)),
                            (d = Math.abs(l / u)),
                        ...
                        ((f = i.multCons(a, Math.sqrt(Math.abs(e)))),
                          (p = i.multCons(o, Math.sqrt(Math.abs(t)))));
                      };
                    (r.connectComponents(t, n, r.getTopMostNodes(o), c),
                      s.forEach(function (e) {
                        r.connectComponents(
                          t,
                          n,
                    ...
                    for (var j = 0, M = 0; M < o.length; M++)
                      o[M].isParent() || l.set(o[M].id(), j++);
                    var N = !0,
                      P = !1,
                      F = void 0;
                    try {
                      for (
                        var I = c.keys()[Symbol.iterator](), L;
                        !(N = (L = I.next()).done);
                        N = !0
                      ) {
                        var R = L.value;
                    ...
                    var B = function (e) {
                        ...
                        c.get(e).forEach(function (i) {
                          ((r = t.getElementById(i).isParent() ? u.get(i) : i),
                            d[n].push(r),
                            d[l.get(r)].push(e));
                        });
                      },
                    ...
                    try {
                      for (
                        var H = c.keys()[Symbol.iterator](), ne;
                        !(V = (ne = H.next()).done);
                        V = !0
                      ) {
                        var re = ne.value;
                    ...
                    if (y > 2) {
                      ...
                      return (
                        e.quality == `draft` || e.step == `all`
                          ? (O(C),
                            k(),
                            A(),
                            (U = { nodeIndexes: l, xCoords: f, yCoords: p }))
                          : (l.forEach(function (e, n) {
                              (f.push(t.getElementById(n).position(`x`)),
  ...
  A = { L: `left`, R: `right`, T: `top`, B: `bottom` },
  j = {
    L: t((e) => `${e},${e / 2} 0,${e} 0,0`, `L`),
    R: t((e) => `0,${e / 2} ${e},0 ${e},${e}`, `R`),
    T: t((e) => `0,0 ${e},0 ${e / 2},${e}`, `T`),
    B: t((e) => `${e / 2},0 ${e},${e} 0,${e}`, `B`),
  },
  M = {
    L: t((e, t) => e - t + 2, `L`),
    R: t((e, t) => e - 2, `R`),
  ...
  re = t((e) => e.data(), `edgeData`),
  U = t((e) => e.data(), `nodeData`),
  W = g.architecture,
  G = class {
    constructor() {
      ((this.nodes = {}),
          ...
          n = Object.entries(this.nodes).reduce(
            (t, [n, r]) => (
              (t[n] = r.edges.reduce((t, r) => {
                ...
                if (r.lhsId === n) {
                  let e = B(r.lhsDir, r.rhsDir);
                  e && (t[e] = r.rhsId);
                } else {
                  let e = B(r.rhsDir, r.lhsDir);
                  e && (t[e] = r.lhsId);
                }
                return t;
              }, {})),
...
`,
  ...
  ae = t(async function (e, t, n, r) {
    let a = n.getConfigField(`padding`),
      o = n.getConfigField(`iconSize`),
      s = o / 2,
      c = o / 6,
      l = c / 2;
    await Promise.all(
      t.edges().map(async (t) => {
        let {
          ...
          { x: y, y: b } = t[0].sourceEndpoint(),
          { x, y: C } = t[0].midpoint(),
          { x: w, y: T } = t[0].targetEndpoint(),
          E = a + 4;
        if (
          (f &&
            (F(u) ? (y += u === `L` ? -E : E) : (b += u === `T` ? -E : E + 18)),
          _ &&
            (F(m) ? (w += m === `L` ? -E : E) : (T += m === `T` ? -E : E + 18)),
          !f &&
            n.getNode(o)?.type === `junction` &&
            (F(u) ? (y += u === `L` ? s : -s) : (b += u === `T` ? s : -s)),
          !_ &&
            n.getNode(p)?.type === `junction` &&
            (F(m) ? (w += m === `L` ? s : -s) : (T += m === `T` ? s : -s)),
          ...
          if (
            (t
              .insert(`path`)
              .attr(`d`, `M ${y},${b} L ${x},${C} L${w},${T} `)
              .attr(`class`, `edge`)
              .attr(`id`, `${r}-${i(o, p, { prefix: `L` })}`),
            d)
          ) {
            let e = F(u) ? M[u](y, c) : y - l,
              n = I(u) ? M[u](b, c) : b - l;
            t.insert(`polygon`)
              .attr(`points`, j[u](c))
          ...
          if (v) {
            ...
            if (
              ...
              r.attr(`transform`, `translate(` + x + `, ` + C + `)`);
            else if (e === `Y`)
              r.attr(
                `transform`,
                `translate(` + x + `, ` + C + `) rotate(-90)`,
              );
            else if (e === `XY`) {
              let e = B(u, m);
              if (e && R(e)) {
      ...
      t.nodes().map(async (t) => {
        ...
        if (s.type === `group`) {
          ...
          if (s.icon) {
            let e = p.append(`g`);
            (e.html(
              `<g>${await C(s.icon, { height: i, width: i, fallbackPrefix: Y.prefix })}</g>`,
            ),
              e.attr(
                `transform`,
                `translate(` + (m + o + 1) + `, ` + (g + o + 1) + `)`,
              ),
              (m += i),
              (g += a / 2 - 1 - 2));
          }
  ...
  oe = t(async function (e, t, n, r) {
    ...
    for (let a of n) {
      ...
      if (a.icon)
        s.html(
          `<g>${await C(a.icon, { height: o, width: o, fallbackPrefix: Y.prefix })}</g>`,
        );
      else if (a.iconText) {
        s.html(
          `<g>${await C(`blank`, { height: o, width: o, fallbackPrefix: Y.prefix })}</g>`,
        );
        let e = s
            .append(`g`)
...
(x([{ name: Y.prefix, icons: Y }]), E.use(k.default));
function se(e, t, n) {
  e.forEach((e) => {
    t.add({
      group: `nodes`,
...
function de(e, t) {
  e.forEach((e) => {
    let {
      ...
      d = L(e.lhsDir, e.rhsDir) ? `segments` : `straight`,
      f = {
        id: `${n}-${r}`,
        label: u,
        source: n,
...
function fe(e, n, r) {
  let i = t(
      (e, t) =>
        Object.entries(e).reduce((e, [n, i]) => {
          let a = 0,
            o = Object.entries(i);
          if (o.length === 1) return ((e[n] = o[0][1]), e);
...
function pe(e, n) {
  let r = [],
    i = t((e) => `${e[0]},${e[1]}`, `posToStr`),
    a = t((e) => e.split(`,`).map((e) => parseInt(e)), `strToPos`);
  return (
    e.forEach((e) => {
      let t = Object.fromEntries(Object.entries(e).map(([e, t]) => [i(t), e])),
        o = [i([0, 0])],
        s = {},
            ...
            Object.entries(c).forEach(([e, a]) => {
              ...
              d &&
                ...
                r.push({
                  [A[e]]: d,
                  [A[N(e)]]: l,
                  gap: 1.5 * n.getConfigField(`iconSize`),
                }));
            });
          }
        }
...
t(pe, `getRelativeConstraints`);
function me(r, i, a, o, s, { spatialMaps: c, groupAlignments: l }) {
  return new Promise((u) => {
    ...
    (d.remove(), ue(a, f), se(r, f, s), ce(i, f, s), de(o, f));
    let p = fe(s, c, l),
      m = pe(c, s),
      h = f.layout({
        name: `fcose`,
    ...
    (h.one(`layoutstop`, () => {
      ...
      (t(e, `getSegmentWeights`), f.startBatch());
...
//# sourceMappingURL=architectureDiagram-Q4EWVU46-CxNS-sgT.js.map
