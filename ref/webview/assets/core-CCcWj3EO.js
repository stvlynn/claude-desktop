...
var t = e((e, t) => {
  ...
  var C = /\b\B/,
    ...
    L = F(`/\\*`, `\\*/`),
    R = F(`#`, `$`),
    z = { scope: `number`, begin: E, relevance: 0 },
    te = { scope: `number`, begin: D, relevance: 0 },
    ne = { scope: `number`, begin: O, relevance: 0 },
    re = {
      scope: `regexp`,
      begin: /\/(?=[^/\n]*\/)/,
      end: /\/[gimuy]*/,
    ...
    ae = { scope: `title`, begin: T, relevance: 0 },
    oe = { begin: `\\.\\s*` + T, relevance: 0 },
    B = Object.freeze({
      __proto__: null,
      APOS_STRING_MODE: M,
      BACKSLASH_ESCAPE: j,
  ...
  function ve(e) {
    if (Array.isArray(e.begin)) {
      ...
      if (typeof e.beginScope != `object` || e.beginScope === null)
        throw (U(`beginScope must be object`), K);
      (q(e, e.begin, { key: `beginScope` }),
        (e.begin = S(e.begin, { joinWith: `` })));
    }
  }
  function ye(e) {
    if (Array.isArray(e.end)) {
      if (e.skip || e.excludeEnd || e.returnEnd)
        throw (
          U(`skip, excludeEnd, returnEnd not compatible with endScope: {}`),
          K
        );
      if (typeof e.endScope != `object` || e.endScope === null)
        throw (U(`endScope must be object`), K);
  ...
  function Se(e) {
    ...
    function o(n, r) {
      ...
      return (
        ...
        (s ||= /\w+/),
        (n.keywords &&= V(n.keywords, e.case_insensitive)),
    ...
    if (
      ((e.compilerExtensions ||= []), e.contains && e.contains.includes(`self`))
    )
      throw Error(
...
https://github.com/highlightjs/highlight.js/issues/2277`,
      ...
      function v(e, n, i, a) {
        ...
        function d() {
          ...
          let t = k.keywordPatternRe.exec(N),
            n = ``;
          for (; t; ) {
        ...
        function f() {
          ...
          if (typeof k.subLanguage == `string`) {
            ...
            ((e = v(k.subLanguage, N, !0, A[k.subLanguage])),
              (A[k.subLanguage] = e._top));
          } else e = x(N, k.subLanguage.length ? k.subLanguage : null);
          (k.relevance > 0 && (P += e.relevance),
            j.__addSublanguage(e._emitter, e.language));
        }
        function p() {
        ...
        function g(e, t) {
          return (
            e.scope &&
              ...
              j.openNode(E.classNameAliases[e.scope] || e.scope),
            e.beginScope &&
              (e.beginScope._wrap
                ? (m(
                    N,
        ...
        function S(e) {
          ...
          do
            (k.scope && j.closeNode(),
              !k.skip && !k.subLanguage && (P += k.relevance),
              (k = k.parent));
          while (k !== i.parent);
...
`),
        ...
        let E = M(e);
        if (!E)
          throw (U(s.replace(`{}`, e)), Error(`Unknown language: "` + e + `"`));
        let D = Se(E),
          O = ``,
          k = a || D,
          A = {},
        ...
        try {
          if (E.__emitTokens) E.__emitTokens(n, j);
            ...
            for (k.matcher.considerAll(); ; ) {
              (I++,
                L ? (L = !1) : k.matcher.considerAll(),
                (k.matcher.lastIndex = F));
      ...
      function C(e) {
        ...
        if (u(n)) return;
        if (
          (R(`before:highlightElement`, { el: e, language: n }),
        ...
        t = e;
        let r = t.textContent,
          i = n ? p(r, { language: n, ignoreIllegals: !0 }) : x(r);
        ((e.innerHTML = i.value),
          ...
          R(`after:highlightElement`, { el: e, result: i, text: r }));
      }
      function w(e) {
        l = X(l, e);
      }
...
export { t };
//# sourceMappingURL=core-CCcWj3EO.js.map
