...
import { n as Ge, t as Ke } from "./page-search-input-Fp7_sG04.js";
import {
  n as qe,
  t as Je,
} from "./infinite-scroll-pagination-spinner-CqKOYMC4.js";
import { n as Ye, t as Xe } from "./segmented-toggle-WuxzI5uh.js";
import { n as Ze, t as Qe } from "./settings-empty-state-CM9NvhM7.js";
import { n as $e, t as et } from "./esm-DEcyN8Xi.js";
import { a as tt, r as nt } from "./cloud-preferences-CNWGV-Sh.js";
function rt(e) {
  let t = (0, st.c)(42),
    { environment: n } = e,
    r;
...
`)
  ...
  if (t[6] !== n || t[7] !== c || t[8] !== o || t[9] !== i) {
    ...
    t[15] === p
      ? (m = t[16])
      : ((m = (0, W.jsx)(O, { label: f, valueAlignment: `end`, children: p })),
        (t[15] = p),
        (t[16] = m));
    let h;
    ...
    t[21] === v
      ? (y = t[22])
      : ((y = (0, W.jsx)(O, { label: _, valueAlignment: `end`, children: v })),
        (t[21] = v),
        (t[22] = y));
    let b;
    t[23] === n.created_at
    ...
    t[28] === C
      ? (w = t[29])
      : ((w = (0, W.jsx)(O, { label: x, valueAlignment: `end`, children: C })),
        (t[28] = C),
        (t[29] = w));
    let T;
    ...
    t[33] === E
      ? (D = t[34])
      : ((D = (0, W.jsx)(O, { label: T, valueAlignment: `end`, children: E })),
        (t[33] = E),
        (t[34] = D));
    let k;
    (t[35] !== g ||
...
function lt(e) {
  ...
  t[5] === c
    ? (u = t[6])
    : ((u = (0, G.jsx)(Re, { title: c, subtitle: l })), (t[5] = c), (t[6] = u));
  let d;
  ...
  t[19] !== s || t[20] !== g || t[21] !== u
    ? ((_ = (0, G.jsxs)(ze, { as: `form`, onSubmit: s, children: [u, g] })),
      (t[19] = s),
      (t[20] = g),
      (t[21] = u),
      (t[22] = _))
  ...
  return (
    t[23] !== o || t[24] !== i || t[25] !== _
      ? ((v = (0, G.jsx)(je, { open: i, onOpenChange: o, children: _ })),
        (t[23] = o),
        (t[24] = i),
        (t[25] = _),
        (t[26] = v))
...
function ut(e) {
  ...
  let h;
  t[16] !== o || t[17] !== m
    ? ((h = (0, G.jsxs)(ze, { as: `form`, onSubmit: o, children: [c, m] })),
      (t[16] = o),
      (t[17] = m),
      (t[18] = h))
    : (h = t[18]);
  ...
  return (
    t[19] !== a || t[20] !== r || t[21] !== h
      ? ((g = (0, G.jsx)(je, { open: r, onOpenChange: a, children: h })),
        (t[19] = a),
        (t[20] = r),
        (t[21] = h),
        (t[22] = g))
    ...
    t[13] !== s || t[14] !== l
      ? ((u = (0, q.jsxs)(U, {
          children: [
            a,
            (0, q.jsx)(U.Content, {
              children: (0, q.jsxs)(H, { children: [s, l] }),
            }),
          ],
        })),
        (t[13] = s),
...
function Wt(e) {
  ...
  let d;
  t[7] !== r || t[8] !== a || t[9] !== u
    ? ((d = (0, J.jsx)(w, { description: r, label: a, control: u })),
      (t[7] = r),
      (t[8] = a),
      (t[9] = u),
      (t[10] = d))
...
function Gt(e) {
  ...
  let d;
  t[8] !== r || t[9] !== u
    ? ((d = (0, J.jsx)(w, { description: r, label: s, control: u })),
      (t[8] = r),
      (t[9] = u),
      (t[10] = d))
    : (d = t[10]);
...
var Kt,
  J,
  qt = e(() => {
    ((Kt = r()), L(), I(), We(), D(), Be(), Vt(), gt(), (J = n()));
  });
function Jt(e, t, n) {
  return F.safeGet(`/wham/environments/search`, {
    parameters: {
...
function Zt() {
  return F.safeGet(`/wham/machines`);
}
async function Qt() {
  let { connectors: e } = await F.safeGet(`/aip/connectors/product_specific`, {
    ...
    n = await Promise.all(
      t.map((e) =>
        F.safeGet(`/aip/connectors/{connector_id}/link`, {
...
function $t(e, t) {
  return F.safeGet(`/wham/github/repositories/search/all-installations`, {
    parameters: { query: { query: e, limit: 20, connector_id: t } },
  });
}
function en(e) {
  return F.safePost(`/wham/environments`, { requestBody: e });
}
function tn({ environmentId: e, requestBody: t }) {
  return F.safePatch(`/wham/environments/{environment_id}`, {
    parameters: { path: { environment_id: e } },
    requestBody: t,
  });
}
function nn(e) {
  return F.safeDelete(`/wham/environments/{environment_id}`, {
    parameters: { path: { environment_id: e } },
  });
}
function rn(e) {
  return F.safePost(`/wham/environments/{environment_id}/reset-cache`, {
    parameters: { path: { environment_id: e } },
  });
}
...
function Sn(e) {
  ...
  let u = De(c, 200),
    [f, p] = (0, Tn.useState)(null),
    m = l(mn),
    h;
  t[2] !== m.data || t[3] !== i || t[4] !== f
    ? ((h =
        m.data?.find((e) => e.id === (f ?? i))?.id ?? m.data?.[0]?.id ?? null),
      (t[2] = m.data),
      (t[3] = i),
      (t[4] = f),
      (t[5] = h))
  ...
  let g = h,
    _;
  t[6] !== g || t[7] !== u
    ? ((_ = { connectorId: g, query: u }), (t[6] = g), (t[7] = u), (t[8] = _))
    : (_ = t[8]);
  let v = d(hn, _),
    y;
          ...
          children: [
            m.isError
              ...
              : m.data?.length === 0
                ...
                : m.data != null && m.data.length > 1
                  ? (0, Y.jsxs)(Y.Fragment, {
                      children: [
                        (0, Y.jsxs)(V.Section, {
                          children: [
                            (0, Y.jsx)(V.SectionLabel, {
                              children: (0, Y.jsx)(z, {
...
function An(e) {
  let t = (0, Mn.c)(35),
    ...
    h = j(`2664309699`),
    g;
  t[0] === u ? (g = t[1]) : ((g = Ce(u) || ye(u)), (t[0] = u), (t[1] = g));
  let _ = g,
    v = n ?? void 0,
    y;
  t[2] !== a || t[3] !== v
    ? ((y = Et(v, a)), (t[2] = a), (t[3] = v), (t[4] = y))
    : (y = t[4]);
  let b;
  t[5] !== f ||
  t[6] !== n ||
  ...
  let x;
  t[13] !== y || t[14] !== b
    ? ((x = { defaultValues: y, onSubmit: b }),
      (t[13] = y),
      (t[14] = b),
      (t[15] = x))
    : (x = t[15]);
  let S = $e(x),
    C = f.isPending || p.isPending,
    T;
  t[16] === S
    ? (T = t[17])
    : ((T = (e) => {
        (e.preventDefault(), S.handleSubmit());
      }),
      (t[16] = S),
      (t[17] = T));
  let E;
  ...
  t[27] !== _
    ? ((E = (e) => {
        ...
        return (0, X.jsxs)(X.Fragment, {
          children: [
            ...
            (0, X.jsx)(_t, { form: S, isPending: C }),
            (0, X.jsx)(Ht, { form: S, isPending: C }),
            (0, X.jsx)(vt, { form: S, isPending: C }),
            (0, X.jsx)(bt, {
              form: S,
              isPending: C,
            ...
            _ ? (0, X.jsx)(St, { form: S, isPending: C }) : null,
            (0, X.jsxs)(`div`, {
    ...
    : (E = t[28]);
  let D;
  t[29] !== S.Subscribe || t[30] !== E
    ? ((D = (0, X.jsx)(S.Subscribe, { selector: jn, children: E })),
      (t[29] = S.Subscribe),
      (t[30] = E),
      (t[31] = D))
    : (D = t[31]);
...
function Pn(e) {
  let t = (0, Ln.c)(36),
    ...
    [c, u] = (0, Rn.useState)(``),
    d;
  t[0] === c ? (d = t[1]) : ((d = c.trim()), (t[0] = c), (t[1] = d));
  let f = De(d, 200),
    m;
  t[2] === f ? (m = t[3]) : ((m = un(f)), (t[2] = f), (t[3] = m));
  let {
      data: h,
      fetchNextPage: g,
      hasNextPage: _,
  ...
  if (
    ...
    ((C = `flex flex-col gap-3`),
      ...
      (t[18] = T),
      (t[19] = E));
  } else ((C = t[17]), (T = t[18]), (E = t[19]));
  let D;
  t[20] !== h || t[21] !== g || t[22] !== _ || t[23] !== v || t[24] !== y
    ? ((D =
        h == null
          ? null
          : (0, Z.jsx)(Je, {
  ...
  let k;
  return (
    t[30] !== C || t[31] !== T || t[32] !== E || t[33] !== D || t[34] !== O
      ? ((k = (0, Z.jsxs)(`div`, { className: C, children: [T, E, D, O] })),
        (t[30] = C),
        (t[31] = T),
        (t[32] = E),
        (t[33] = D),
...
function In(e) {
  ...
  t[15] === n.is_pinned
    ? (v = t[16])
    : ((v = n.is_pinned
        ? (0, Z.jsx)(Le, { className: `icon-xs` })
        : (0, Z.jsx)(_, { className: `icon-xs` })),
      (t[15] = n.is_pinned),
      (t[16] = v));
  let y;
  t[17] !== r || t[18] !== o || t[19] !== p || t[20] !== g || t[21] !== v
    ? ((y = (0, Z.jsx)(M, {
        "aria-label": p,
        color: `ghost`,
        disabled: g,
  ...
  let x;
  t[23] !== h || t[24] !== y
    ? ((x = (0, Z.jsx)(`span`, { className: h, children: y })),
      (t[23] = h),
      (t[24] = y),
      (t[25] = x))
    : (x = t[25]);
  let S;
  t[26] !== p || t[27] !== x
    ? ((S = (0, Z.jsx)(re, { tooltipContent: p, children: x })),
      (t[26] = p),
      (t[27] = x),
      (t[28] = S))
    : (S = t[28]);
  let C;
  t[29] !== m || t[30] !== S
    ? ((C = (0, Z.jsxs)(Z.Fragment, { children: [m, S] })),
      (t[29] = m),
      (t[30] = S),
      (t[31] = C))
    : (C = t[31]);
...
function Bn() {
  ...
  if (o.length === 0) {
    ...
    e[4] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsx)(He, { slug: `cloud-environments` })), (e[4] = t))
      : (t = e[4]);
    let n;
    e[5] === i
      ? (n = e[6])
    ...
    e[8] === n
      ? (a = e[9])
      : ((a = (0, Q.jsx)(M, { color: `primary`, onClick: n, children: r })),
        (e[8] = n),
        (e[9] = a));
    let o;
    e[10] === i
    ...
    return (
      e[12] !== a || e[13] !== o
        ? ((s = (0, Q.jsx)(me, { title: t, action: a, children: o })),
          (e[12] = a),
          (e[13] = o),
          (e[14] = s))
        : (s = e[14]),
  ...
  if (s) {
    ...
    return (
      e[20] !== t || e[21] !== r
        ? ((a = (0, Q.jsx)(me, { backSlot: t, title: n, children: r })),
          (e[20] = t),
          (e[21] = r),
          (e[22] = a))
        : (a = e[22]),
  ...
  return (
    e[40] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((d = (0, Q.jsx)(N, { to: $, replace: !0 })), (e[40] = d))
      : (d = e[40]),
    d
  );
}
...
function Hn(e) {
  ...
  if (f.isPending || f.isError) {
    ...
    return (
      t[5] !== e || t[6] !== i
        ? ((a = (0, Q.jsx)(me, { backSlot: e, title: n, children: i })),
          (t[5] = e),
          (t[6] = i),
          (t[7] = a))
        : (a = t[7]),
  ...
  let x = f.data,
    ...
    T;
  t[8] !== x.creator || t[9] !== u
    ? ((T = u != null && x.creator.id.includes(u)),
      (t[8] = x.creator),
      (t[9] = u),
      (t[10] = T))
    : (T = t[10]);
  let E = C && T,
    D = C && (x.cache_settings?.post_setup_cache_enabled ?? !0),
    O;
  t[11] !== x.is_pinned || t[12] !== c
    ? ((O = x.is_pinned
        ? c.formatMessage({
  ...
  t[30] === r
    ? (j = t[31])
    : ((j = (0, Q.jsx)(Wn, { onClick: r })), (t[30] = r), (t[31] = j));
  let ie = x.description || void 0,
    N;
  t[32] === x
    ? (N = t[33])
    : ((N = (0, Q.jsx)(rt, { environment: x })), (t[32] = x), (t[33] = N));
  let ae = g === `delete`,
    oe;
  t[34] !== p || t[35] !== x.id || t[36] !== c || t[37] !== i || t[38] !== o
    ? ((oe = () => {
        p.mutate(x.id, {
          onSuccess: () => {
            (o.get(P).success(
  ...
  t[40] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((se = (e) => y(e ? `delete` : null)), (t[40] = se))
    : (se = t[40]);
  let ce;
  t[41] !== p.isPending || t[42] !== x.label || t[43] !== ae || t[44] !== oe
    ? ((ce = (0, Q.jsx)(lt, {
      ...
      (t[45] = ce))
    : (ce = t[45]);
  let le = g === `reset-cache`,
    F;
  t[46] !== x.id || t[47] !== c || t[48] !== m || t[49] !== o
    ? ((F = () => {
        m.mutate(x.id, {
          onSuccess: () => {
            (y(null),
  ...
  t[51] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((I = (e) => y(e ? `reset-cache` : null)), (t[51] = I))
    : (I = t[51]);
  let L;
  t[52] !== m.isPending || t[53] !== le || t[54] !== F
    ? ((L = (0, Q.jsx)(ut, {
...
function Un(e) {
  ...
  if (i.isError) {
    ...
    return (
      t[0] === e
        ? (r = t[1])
        : ((r = (0, Q.jsx)(N, { to: e, replace: !0 })), (t[0] = e), (t[1] = r)),
      r
    );
  }
  if (i.isPending) {
  ...
  if (i.data.permissions?.can_write !== !0) {
    ...
    return (
      t[8] === e
        ? (r = t[9])
        : ((r = (0, Q.jsx)(N, { to: e, replace: !0 })), (t[8] = e), (t[9] = r)),
      r
    );
  }
  let a;
  ...
  return (
    t[16] !== a || t[17] !== s
      ? ((c = (0, Q.jsx)(me, { backSlot: a, title: o, children: s })),
        (t[16] = a),
        (t[17] = s),
        (t[18] = c))
      : (c = t[18]),
...
function Wn(e) {
  let t = (0, Gn.c)(4),
    ...
    i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Q.jsx)(Ee, { className: `icon-xs` })),
      (i = (0, Q.jsx)(z, {
...
//# sourceMappingURL=cloud-environments-settings-page-C8x5EwUe.js.map
