...
import { c as t, l as n, t as r } from "./dist-Dcs2yc8m.js";
import { n as i, t as a } from "./src-CTe_6Jg1.js";
import { i as o, n as s, r as c } from "./chunk-AGHRB4JF-DVNPU_Qo.js";
import {
  $ as l,
  A as u,
  C as d,
...
import { g as _, s as v, u as y } from "./chunk-5PVQY5BW-MckrTAit.js";
import { i as b } from "./chunk-U2HBQHQK-BfxUGRAz.js";
import { n as x, t as S } from "./chunk-FMBD7UC4-DCr6uaVv.js";
import { r as C } from "./chunk-BSJP7CBP-CrJpo2xF.js";
import { r as w } from "./chunk-ZZ45TVLE-DzHSn4eK.js";
import { l as T, t as oe } from "./chunk-YZCP3GAM-B39030I6.js";
import { n as se, t as ce } from "./chunk-55IACEB6-C7TKde_g.js";
import { n as le, t as E } from "./chunk-EDXVE4YY-BWFoBgdE.js";
import { n as D } from "./chunk-X2U36JSP-sSeN7Tix.js";
import { i as O, s as k } from "./chunk-5FUZZQ4R-B3jI2rZu.js";
import { n as A } from "./chunk-ENJZ2VHE-Hl7g56sN.js";
import { i as ue, n as de, t as fe } from "./chunk-336JU56O-DNhqwrXr.js";
import { n as pe, r as me, t as he } from "./chunk-XPW4576I-C68fwtjN.js";
var ge, _e, ve, j, M, N, ye, P, F;
e(() => {
  (x(),
    pe(),
    T(),
    ...
    (_e = class {
      ...
      sanitizeText(e) {
        return ie.sanitizeText(e, this.config);
      }
      ...
      lookUpDomId(e) {
        for (let t of this.vertices.values())
          if (t.id === e)
            return this.diagramId ? `${this.diagramId}-${t.domId}` : t.domId;
        return this.diagramId ? `${this.diagramId}-${e}` : e;
      }
      addVertex(e, t, n, r, i, a, s = {}, c) {
...
` +
        ...
        if (u) {
          let e = l;
          (e?.animate !== void 0 && (u.animate = e.animate),
            e?.animation !== void 0 && (u.animation = e.animation),
            e?.curve !== void 0 && (u.interpolate = e.curve));
          return;
        }
        let d,
        ...
        if (
          ...
          f.props === void 0
            ? (f.props = s)
            : s !== void 0 && Object.assign(f.props, s),
          l !== void 0)
        ) {
          if (l.shape) {
            if (l.shape !== l.shape.toLowerCase() || l.shape.includes(`_`))
              throw Error(
                `No such shape: ${l.shape}. Shape names should be lowercase.`,
              );
            if (!k(l.shape)) throw Error(`No such shape: ${l.shape}.`);
            f.type = l?.shape;
          }
          (l?.label &&
            ((f.text = l?.label),
            (f.labelType = this.sanitizeNodeLabelType(l?.labelType))),
            l?.icon &&
              ((f.icon = l?.icon),
              !l.label?.trim() && f.text === e && (f.text = ``)),
            l?.form && (f.form = l?.form),
            l?.pos && (f.pos = l?.pos),
            l?.img &&
              ((f.img = l?.img),
              !l.label?.trim() && f.text === e && (f.text = ``)),
            l?.constraint && (f.constraint = l.constraint),
            l.w && (f.assetWidth = Number(l.w)),
            l.h && (f.assetHeight = Number(l.h)));
        }
      }
      addSingleLink(e, t, n, r) {
        ...
        o.info(`abc78 Got edge...`, i);
        let a = n.text;
        if (
          (a !== void 0 &&
            ((i.text = this.sanitizeText(a.text.trim())),
            i.text.startsWith(`"`) &&
              i.text.endsWith(`"`) &&
              (i.text = i.text.substring(1, i.text.length - 1)),
            (i.labelType = this.sanitizeNodeLabelType(a.type))),
          n !== void 0 &&
            ((i.type = n.type),
            (i.stroke = n.stroke),
            (i.length = n.length > 10 ? 10 : n.length)),
          r && !this.edges.some((e) => e.id === r))
        )
          ((i.id = r), (i.isUserDefinedId = !0));
        else {
          let e = this.edges.filter(
            (e) => e.start === i.start && e.end === i.end,
          );
          e.length === 0
            ? (i.id = v(i.start, i.end, { counter: 0, prefix: `L` }))
        ...
        if (this.edges.length < (this.config.maxEdges ?? 500))
          (o.info(`Pushing edge...`), this.edges.push(i));
        else
...
You have to call mermaid.initialize.`);
      ...
      setClickFun(e, t, n) {
        if (h().securityLevel !== `loose` || t === void 0) return;
        let r = [];
        if (typeof n == `string`) {
          r = n.split(/,(?=(?:(?:[^"]*"){2})*[^"]*$)/);
      ...
      setLink(e, t, n) {
        (e.split(`,`).forEach((e) => {
          ...
          r !== void 0 &&
            ((r.link = _.formatUrl(t, this.config)), (r.linkTarget = n));
        }),
      ...
      addSubGraph(e, t, n) {
        ...
        let a = s((e) => {
            ...
            return {
              nodeList: e.filter(function (e) {
                let i = typeof e;
                return e.stmt && e.stmt === `dir`
                  ? ((r = e.value), !1)
                  : e.trim() === ``
                    ? !1
                    : i in t
                      ? t[i].hasOwnProperty(e)
                        ? !1
                        : (t[i][e] = !0)
                      : n.includes(e)
                        ? !1
        ...
        if (
          ((l ??= u.inheritDir
            ? (this.getDirection() ?? h().direction ?? void 0)
            : void 0),
          this.version === `gen-1`)
        )
          for (let e = 0; e < c.length; e++) c[e] = this.lookUpDomId(c[e]);
        ((r ??= `subGraph` + this.subCount),
          (i ||= ``),
      ...
      indexNodes2(e, t) {
        ...
        for (; r < n.length; ) {
          ...
          if (t >= 0) {
            ...
            if (n.result) return { result: !0, count: i + n.count };
            i += n.count;
          }
          r += 1;
        }
      ...
      destructEndLink(e) {
        ...
        switch (t.slice(-1)) {
          case `x`:
            ((r = `arrow_cross`),
              t.startsWith(`x`) && ((r = `double_` + r), (n = n.slice(1))));
            break;
          case `>`:
            ((r = `arrow_point`),
              t.startsWith(`<`) && ((r = `double_` + r), (n = n.slice(1))));
            break;
          case `o`:
            ((r = `arrow_circle`),
              t.startsWith(`o`) && ((r = `double_` + r), (n = n.slice(1))));
            break;
        }
        let i = `normal`,
          a = n.length - 1;
        (n.startsWith(`=`) && (i = `thick`),
          n.startsWith(`~`) && (i = `invisible`));
        let o = this.countChar(`.`, n);
        return (
          o && ((i = `dotted`), (a = o)),
          { type: r, stroke: i, length: a }
        );
      }
      destructLink(e, t) {
        let n = this.destructEndLink(e),
          r;
        if (t) {
          if (((r = this.destructStartLink(t)), r.stroke !== n.stroke))
          ...
          return (
            r.type === `double_arrow` && (r.type = `double_arrow_point`),
            (r.length = n.length),
            r
          );
        }
      ...
      destructEdgeType(e) {
        ...
        return { arrowTypeStart: t, arrowTypeEnd: n };
      }
      addNodeFromVertex(e, t, n, r, i, a) {
        let o = n.get(e.id),
          s = r.get(e.id) ?? !1,
          c = this.findNode(t, e.id);
        if (c)
          ((c.cssStyles = e.styles),
            (c.cssCompiledStyles = this.getCompiledStyles(e.classes)),
            (c.cssClasses = e.classes.join(` `)));
        else {
          let n = {
            id: e.id,
            label: e.text,
          ...
          s
            ? t.push({ ...n, isGroup: !0, shape: `rect` })
            : t.push({ ...n, isGroup: !1, shape: this.getTypeFromVertex(e) });
        }
      }
      getCompiledStyles(e) {
        let t = [];
      ...
      getData() {
        ...
        return (
          o.forEach((t, r) => {
            let { arrowTypeStart: i, arrowTypeEnd: a } = this.destructEdgeType(
                t.type,
              ),
              s = [...(o.defaultStyle ?? [])];
            t.style && s.push(...t.style);
            let c = {
              id: v(t.start, t.end, { counter: r, prefix: `L` }, t.id),
              ...
              arrowTypeStart:
                t?.stroke === `invisible` || t?.type === `arrow_open`
                  ? `none`
                  : i,
              arrowTypeEnd:
                t?.stroke === `invisible` || t?.type === `arrow_open`
          ...
          { nodes: t, edges: n, other: {}, config: e }
        );
      }
      defaultConfig() {
        return ae.flowchart;
    ...
    (ve = {
      ...
      draw: s(async function (e, t, n, r) {
        (o.info(`REF0:`), o.info(`Drawing state diagram (v2)`, t));
        let { securityLevel: i, flowchart: a, layout: s } = h();
        (r.db.setDiagramId(t), o.debug(`Before getData: `));
        let c = r.db.getData();
        o.debug(`Data: `, c);
        let l = ce(t, i),
          u = r.db.getDirection();
        ((c.type = r.type),
          (c.layoutAlgorithm = fe(s)),
          ...
          (c.direction = u),
          (c.nodeSpacing = a?.nodeSpacing || 50),
          (c.rankSpacing = a?.rankSpacing || 50),
        ...
        (_.insertTitle(
          ...
          le(l, d, `flowchart`, a?.useMaxWidth || !1));
      }, `draw`),
    }),
    (j = (function () {
      var e = s(function (e, t, n, r) {
        ...
        N = [1, 99],
        ye = [1, 90],
        P = [8, 9, 10, 11, 40, 75, 77, 78],
        F = [8, 9, 10, 11, 40, 46, 75, 77, 78],
        I = [
        ...
        xe = [44, 60, 89, 102, 105, 106, 109, 111, 114, 115, 116],
        Se = [1, 122],
        Ce = [1, 123],
        we = [1, 125],
        Te = [1, 124],
        Ee = [44, 60, 62, 74, 89, 102, 105, 106, 109, 111, 114, 115, 116],
        De = [1, 134],
        Oe = [1, 148],
        ke = [1, 149],
        Ae = [1, 150],
        ...
        Xe = [1, 157],
        L = [8, 9, 11],
        R = [8, 9, 10, 11, 14, 44, 60, 89, 105, 106, 109, 111, 114, 115, 116],
        z = [1, 177],
        B = [1, 173],
        V = [1, 174],
        H = [1, 178],
        ...
        rt = {
          ...
          performAction: s(function (e, t, n, r, i, a, o) {
            ...
            switch (i) {
              case 2:
                ...
                break;
              case 3:
                ((!Array.isArray(a[s]) || a[s].length > 0) &&
                  a[s - 1].push(a[s]),
                  (this.$ = a[s - 1]));
                break;
              case 4:
              ...
              case 45:
                (r.addVertex(
                  ...
                  r.addLink(a[s - 3].stmt, a[s - 1], a[s - 2]),
                  (this.$ = {
                    stmt: a[s - 1],
                ...
                break;
              case 46:
                (r.addLink(a[s - 2].stmt, a[s], a[s - 1]),
                  (this.$ = {
                    stmt: a[s],
              ...
              case 56:
                ((this.$ = a[s - 3]),
                  r.addVertex(a[s - 3], a[s - 1], `square`));
                break;
              case 57:
                ((this.$ = a[s - 3]),
                  r.addVertex(a[s - 3], a[s - 1], `doublecircle`));
                break;
              case 58:
                ((this.$ = a[s - 5]),
                  r.addVertex(a[s - 5], a[s - 2], `circle`));
                break;
              case 59:
                ((this.$ = a[s - 3]),
                  r.addVertex(a[s - 3], a[s - 1], `ellipse`));
                break;
              case 60:
                ((this.$ = a[s - 3]),
                  r.addVertex(a[s - 3], a[s - 1], `stadium`));
                break;
              case 61:
                ((this.$ = a[s - 3]),
                  r.addVertex(a[s - 3], a[s - 1], `subroutine`));
                break;
              case 62:
                ((this.$ = a[s - 7]),
                  r.addVertex(
                    ...
                    void 0,
                    void 0,
                    Object.fromEntries([[a[s - 5], a[s - 3]]]),
                  ));
                break;
              case 63:
                ((this.$ = a[s - 3]),
                  r.addVertex(a[s - 3], a[s - 1], `cylinder`));
                break;
              case 64:
              ...
              case 65:
                ((this.$ = a[s - 3]),
                  r.addVertex(a[s - 3], a[s - 1], `diamond`));
                break;
              case 66:
                ((this.$ = a[s - 5]),
                  r.addVertex(a[s - 5], a[s - 2], `hexagon`));
                break;
              case 67:
              ...
              case 68:
                ((this.$ = a[s - 3]),
                  r.addVertex(a[s - 3], a[s - 1], `trapezoid`));
                break;
              case 69:
                ((this.$ = a[s - 3]),
                  r.addVertex(a[s - 3], a[s - 1], `inv_trapezoid`));
                break;
              case 70:
                ((this.$ = a[s - 3]),
                  r.addVertex(a[s - 3], a[s - 1], `lean_right`));
                break;
              case 71:
                ((this.$ = a[s - 3]),
                  r.addVertex(a[s - 3], a[s - 1], `lean_left`));
                break;
              case 72:
              ...
              case 80:
                ...
                break;
              case 81:
                this.$ = { text: a[s], type: `string` };
                break;
              case 82:
                this.$ = { text: a[s], type: `markdown` };
                break;
              case 83:
                var c = r.destructLink(a[s]);
                this.$ = { type: c.type, stroke: c.stroke, length: c.length };
                break;
              case 84:
                var c = r.destructLink(a[s]);
                this.$ = {
              ...
              case 116:
                ((this.$ = a[s - 3]),
                  r.setClickEvent(a[s - 3], a[s - 2]),
                  r.setTooltip(a[s - 3], a[s]));
                break;
              case 109:
                ((this.$ = a[s - 2]),
              ...
              case 110:
                ((this.$ = a[s - 4]),
                  r.setClickEvent(a[s - 4], a[s - 3], a[s - 2]),
                  r.setTooltip(a[s - 4], a[s]));
                break;
              case 111:
              ...
              case 114:
                ((this.$ = a[s - 6]),
                  r.setLink(a[s - 6], a[s - 4], a[s]),
                  r.setTooltip(a[s - 6], a[s - 2]));
                break;
              case 117:
              ...
              case 120:
                ((this.$ = a[s - 5]),
                  r.setLink(a[s - 5], a[s - 4], a[s]),
                  r.setTooltip(a[s - 5], a[s - 2]));
                break;
              case 121:
                ((this.$ = a[s - 4]),
                  r.addVertex(a[s - 2], void 0, void 0, a[s]));
                break;
              case 122:
          ...
          table: [
            ...
            e(i, [2, 10]),
            e(i, [2, 11]),
            { 8: [1, 55], 9: [1, 56], 10: E, 15: 54, 18: 57 },
            e(D, [2, 3]),
            e(D, [2, 4]),
            e(D, [2, 5]),
            e(D, [2, 6]),
            ...
            { 8: O, 9: k, 11: A, 21: 71 },
            { 8: O, 9: k, 11: A, 21: 72 },
            { 8: O, 9: k, 10: [1, 73], 11: A, 21: 74 },
            e(D, [2, 36]),
            { 35: [1, 75] },
            { 37: [1, 76] },
            e(D, [2, 39]),
            e(ue, [2, 50], { 18: 77, 39: 78, 10: E, 40: de }),
            { 10: [1, 80] },
            { 10: [1, 81] },
            { 10: [1, 82] },
            { 10: [1, 83] },
            ...
            e(D, [2, 41]),
            e(D, [2, 42]),
            e(xe, [2, 76], { 73: 117, 62: [1, 119], 74: [1, 118] }),
            { 76: 120, 79: 121, 80: Se, 81: Ce, 116: we, 119: Te },
            { 75: [1, 126], 77: [1, 127] },
            e(Ee, [2, 83]),
            e(D, [2, 28]),
            e(D, [2, 29]),
            ...
            { 30: 171, 67: z, 80: B, 81: V, 82: 172, 116: H, 117: U, 118: W },
            { 30: 179, 67: z, 80: B, 81: V, 82: 172, 116: H, 117: U, 118: W },
            {
              30: 181,
              50: [1, 180],
              67: z,
            ...
            { 30: 182, 67: z, 80: B, 81: V, 82: 172, 116: H, 117: U, 118: W },
            { 30: 183, 67: z, 80: B, 81: V, 82: 172, 116: H, 117: U, 118: W },
            { 30: 184, 67: z, 80: B, 81: V, 82: 172, 116: H, 117: U, 118: W },
            { 109: [1, 185] },
            { 30: 186, 67: z, 80: B, 81: V, 82: 172, 116: H, 117: U, 118: W },
            {
              30: 187,
              65: [1, 188],
              67: z,
            ...
            { 30: 189, 67: z, 80: B, 81: V, 82: 172, 116: H, 117: U, 118: W },
            { 30: 190, 67: z, 80: B, 81: V, 82: 172, 116: H, 117: U, 118: W },
            { 30: 191, 67: z, 80: B, 81: V, 82: 172, 116: H, 117: U, 118: W },
            e(I, [2, 182]),
            e(i, [2, 20]),
            e(be, [2, 25]),
            e(ue, [2, 46], { 39: 192, 18: 193, 10: E, 40: de }),
            e(xe, [2, 73], { 10: [1, 194] }),
            { 10: [1, 195] },
            { 30: 196, 67: z, 80: B, 81: V, 82: 172, 116: H, 117: U, 118: W },
            { 77: [1, 197], 79: 198, 116: we, 119: Te },
            e(Ze, [2, 79]),
            e(Ze, [2, 81]),
            e(Ze, [2, 82]),
            e(Ze, [2, 168]),
            e(Ze, [2, 169]),
            { 76: 199, 79: 121, 80: Se, 81: Ce, 116: we, 119: Te },
            e(Ee, [2, 84]),
            {
              8: O,
              9: k,
            ...
            { 31: [1, 218], 67: z, 82: 219, 116: H, 117: U, 118: W },
            e($e, [2, 86]),
            e($e, [2, 88]),
            e($e, [2, 89]),
            e($e, [2, 153]),
            ...
            e($e, [2, 155]),
            e($e, [2, 156]),
            { 49: [1, 220], 67: z, 82: 219, 116: H, 117: U, 118: W },
            { 30: 221, 67: z, 80: B, 81: V, 82: 172, 116: H, 117: U, 118: W },
            { 51: [1, 222], 67: z, 82: 219, 116: H, 117: U, 118: W },
            { 53: [1, 223], 67: z, 82: 219, 116: H, 117: U, 118: W },
            { 55: [1, 224], 67: z, 82: 219, 116: H, 117: U, 118: W },
            { 57: [1, 225], 67: z, 82: 219, 116: H, 117: U, 118: W },
            { 60: [1, 226] },
            { 64: [1, 227], 67: z, 82: 219, 116: H, 117: U, 118: W },
            { 66: [1, 228], 67: z, 82: 219, 116: H, 117: U, 118: W },
            { 30: 229, 67: z, 80: B, 81: V, 82: 172, 116: H, 117: U, 118: W },
            { 31: [1, 230], 67: z, 82: 219, 116: H, 117: U, 118: W },
            {
              67: z,
              69: [1, 231],
              71: [1, 232],
            ...
            e(ue, [2, 45], { 18: 156, 10: E, 40: Xe }),
            e(ue, [2, 47], { 44: Ye }),
            e(xe, [2, 75]),
            e(xe, [2, 74]),
            { 62: [1, 235], 67: z, 82: 219, 116: H, 117: U, 118: W },
            e(xe, [2, 77]),
            e(Ze, [2, 80]),
            { 77: [1, 236], 79: 198, 116: we, 119: Te },
            { 30: 237, 67: z, 80: B, 81: V, 82: 172, 116: H, 117: U, 118: W },
            e(Je, a, { 5: 238 }),
            e(G, [2, 102]),
            e(D, [2, 35]),
            {
            ...
            e($e, [2, 87]),
            e(F, [2, 57]),
            { 51: [1, 263], 67: z, 82: 219, 116: H, 117: U, 118: W },
            e(F, [2, 64]),
            e(F, [2, 59]),
            e(F, [2, 60]),
            e(F, [2, 61]),
            ...
            e(F, [2, 63]),
            e(F, [2, 65]),
            { 66: [1, 265], 67: z, 82: 219, 116: H, 117: U, 118: W },
            e(F, [2, 67]),
            e(F, [2, 68]),
            e(F, [2, 70]),
            e(F, [2, 69]),
            ...
            e(xe, [2, 78]),
            { 31: [1, 266], 67: z, 82: 219, 116: H, 117: U, 118: W },
            {
              6: 11,
              7: 12,
              8: o,
            ...
            e(L, [2, 120]),
            e(F, [2, 58]),
            { 30: 283, 67: z, 80: B, 81: V, 82: 172, 116: H, 117: U, 118: W },
            e(F, [2, 66]),
            e(Je, a, { 5: 284 }),
            e(nt, [2, 131], {
              108: 270,
            ...
            e(L, [2, 114]),
            { 31: [1, 287], 67: z, 82: 219, 116: H, 117: U, 118: W },
            {
              6: 11,
              7: 12,
              8: o,
          ...
          parse: s(function (e) {
            var t = this,
              ...
              f = 2,
              ee = 1,
              te = a.slice.call(arguments, 1),
              p = Object.create(this.lexer),
              m = { yy: {} };
            for (var ne in this.yy)
              Object.prototype.hasOwnProperty.call(this.yy, ne) &&
                (m.yy[ne] = this.yy[ne]);
            (p.setInput(e, m.yy),
              (m.yy.lexer = p),
              (m.yy.parser = this),
              p.yylloc === void 0 && (p.yylloc = {}));
            var re = p.yylloc;
            a.push(re);
            var h = p.options && p.options.ranges;
...
` +
          ...
          conditions: {
            shapeDataEndBracket: {
              rules: [
                21, 24, 78, 81, 83, 85, 89, 91, 95, 96, 109, 111, 113, 115,
              ],
              inclusive: !1,
            },
            shapeDataStr: {
              rules: [
                9, 10, 21, 24, 78, 81, 83, 85, 89, 91, 95, 96, 109, 111, 113,
                115,
              ],
              inclusive: !1,
            },
            shapeData: {
              rules: [
                8, 11, 12, 21, 24, 78, 81, 83, 85, 89, 91, 95, 96, 109, 111,
                113, 115,
              ],
              inclusive: !1,
            },
            ...
            callbackname: {
              rules: [
                14, 15, 16, 21, 24, 78, 81, 83, 85, 89, 91, 95, 96, 109, 111,
                113, 115,
              ],
              inclusive: !1,
            },
            ...
            trapText: {
              rules: [
                21, 24, 78, 81, 83, 85, 89, 91, 92, 93, 94, 95, 96, 109, 111,
                113, 115,
              ],
              inclusive: !1,
            },
            ...
            text: {
              rules: [
                21, 24, 78, 81, 82, 83, 84, 85, 88, 89, 90, 91, 95, 96, 108,
            ...
            acc_descr_multiline: {
              rules: [
                5, 6, 21, 24, 78, 81, 83, 85, 89, 91, 95, 96, 109, 111, 113,
                115,
              ],
              inclusive: !1,
            },
            ...
            INITIAL: {
              rules: [
                ...
                87, 89, 91, 95, 96, 97, 98, 99, 100, 101, 102, 103, 104, 105,
                106, 107, 109, 111, 113, 115, 117, 118, 119, 120,
              ],
              inclusive: !0,
            },
          },
      ...
      return (s(it, `Parser`), (it.prototype = rt), (rt.Parser = it), new it());
    })()),
    (j.parser = j),
    (M = j),
    (N = Object.assign({}, M)),
...
`,
  ...
  .labelBkg {
    background-color: ${P(e.edgeLabelBackground, 0.5)};
    // background-color:
  }
...
`,
      ...
      init: s((e) => {
        ((e.flowchart ||= {}),
          e.layout && m({ layout: e.layout }),
          (e.flowchart.arrowMarkerAbsolute = e.arrowMarkerAbsolute),
          m({ flowchart: { arrowMarkerAbsolute: e.arrowMarkerAbsolute } }));
      }, `init`),
    }));
})();
export { F as diagram };
//# sourceMappingURL=flowDiagram-DWJPFMVM-DkBvy4JX.js.map
