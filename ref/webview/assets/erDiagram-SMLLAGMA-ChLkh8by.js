import { i as e, n as t, r as n, t as r } from "./src-DUJGKvUX.js";
import { h as i, s as a } from "./chunk-5PVQY5BW-DEldFBPA.js";
import {
  B as o,
  C as s,
  V as c,
...
import { t as h } from "./channel-BlN9FjG1.js";
...
import { t as g } from "./chunk-55IACEB6-DBIditYu.js";
import { t as _ } from "./chunk-EDXVE4YY-C5jaZxVP.js";
import "./chunk-X2U36JSP-BczALf5_.js";
import "./chunk-5FUZZQ4R-CaM4fbt9.js";
import "./chunk-ENJZ2VHE-ed8XzF1H.js";
import { r as v, t as y } from "./chunk-336JU56O-Cutebe7h.js";
var b = (function () {
  var e = n(function (e, t, n, r) {
    ...
    Y = {
      ...
      performAction: n(function (e, t, n, r, i, a, o) {
        ...
        switch (i) {
          ...
          case 8:
            (r.addEntity(a[s - 4]),
              r.addEntity(a[s - 2]),
              r.addRelationship(a[s - 4], a[s], a[s - 2], a[s - 3]));
            break;
          case 9:
            (r.addEntity(a[s - 8]),
              r.addEntity(a[s - 4]),
              r.addRelationship(a[s - 8], a[s], a[s - 4], a[s - 5]),
              r.setClass([a[s - 8]], a[s - 6]),
              r.setClass([a[s - 4]], a[s - 2]));
            break;
          case 10:
            (r.addEntity(a[s - 6]),
              r.addEntity(a[s - 2]),
              r.addRelationship(a[s - 6], a[s], a[s - 2], a[s - 3]),
              r.setClass([a[s - 6]], a[s - 4]));
            break;
          case 11:
            (r.addEntity(a[s - 6]),
              r.addEntity(a[s - 4]),
              r.addRelationship(a[s - 6], a[s], a[s - 4], a[s - 5]),
              r.setClass([a[s - 4]], a[s - 2]));
            break;
          case 12:
          ...
          case 13:
            (r.addEntity(a[s - 5]),
              r.addAttributes(a[s - 5], a[s - 1]),
              r.setClass([a[s - 5]], a[s - 3]));
            break;
          case 14:
            r.addEntity(a[s - 2]);
            break;
          ...
          case 17:
            ...
            break;
          case 18:
            (r.addEntity(a[s - 6], a[s - 4]),
              r.addAttributes(a[s - 6], a[s - 1]));
            break;
          case 19:
            (r.addEntity(a[s - 8], a[s - 6]),
              r.addAttributes(a[s - 8], a[s - 1]),
              r.setClass([a[s - 8]], a[s - 3]));
            break;
          case 20:
          ...
          case 60:
            ...
            break;
          case 61:
            this.$ = { type: a[s - 1], name: a[s] };
            break;
          case 62:
            this.$ = { type: a[s - 2], name: a[s - 1], keys: a[s] };
            break;
          case 63:
            this.$ = { type: a[s - 2], name: a[s - 1], comment: a[s] };
            break;
          case 64:
            this.$ = {
              type: a[s - 3],
      ...
      table: [
        ...
        { 16: 48, 40: T, 41: E },
        e(t, [2, 4]),
        { 11: 49, 40: f, 48: h, 50: g, 51: _, 52: v },
        { 16: 50, 40: T, 41: E },
        { 18: 51, 19: [1, 52], 53: 53, 54: 54, 58: D },
        { 11: 56, 40: f, 48: h, 50: g, 51: _, 52: v },
        ...
        e(t, [2, 25]),
        e(t, [2, 26]),
        { 13: k, 38: 60, 41: A, 42: j, 45: 62, 46: 63, 48: M, 49: N },
        e(P, [2, 37]),
        e(P, [2, 38]),
        { 16: 68, 40: T, 41: E, 42: j },
        { 13: k, 38: 69, 41: A, 42: j, 45: 62, 46: 63, 48: M, 49: N },
        { 13: [1, 70], 15: [1, 71] },
        e(t, [2, 17], {
          63: 35,
          12: 72,
        ...
        { 19: [1, 74] },
        e(t, [2, 14]),
        { 18: 75, 19: [2, 59], 53: 53, 54: 54, 58: D },
        { 55: 76, 58: [1, 77] },
        { 58: [2, 65] },
        { 21: [1, 78] },
        { 63: 79, 65: y, 66: b, 67: x, 68: S, 69: C },
        e(F, [2, 77]),
        e(F, [2, 78]),
        { 6: I, 10: L, 39: 80, 42: R, 47: z },
        { 40: [1, 85], 41: [1, 86] },
        e(B, [2, 43], { 46: 87, 13: k, 41: A, 48: M, 49: N }),
        e(V, [2, 45]),
        e(V, [2, 50]),
        e(V, [2, 51]),
        e(V, [2, 52]),
        e(V, [2, 53]),
        e(t, [2, 41], { 42: j }),
        { 6: I, 10: L, 39: 88, 42: R, 47: z },
        { 14: 89, 40: H, 50: U, 72: W },
        { 16: 93, 40: T, 41: E },
        { 11: 94, 40: f, 48: h, 50: g, 51: _, 52: v },
        { 18: 95, 19: [1, 96], 53: 53, 54: 54, 58: D },
        e(t, [2, 12]),
        { 19: [2, 60] },
        e(G, [2, 61], { 56: 97, 57: 98, 59: 99, 61: K, 62: q }),
        e([19, 58, 61, 62], [2, 66]),
        e(t, [2, 22], { 15: [1, 103], 17: [1, 102] }),
        e([40, 48, 50, 51, 52], [2, 71]),
        e(t, [2, 36]),
        { 13: k, 41: A, 45: 104, 46: 63, 48: M, 49: N },
        e(t, [2, 47]),
        e(t, [2, 48]),
        e(t, [2, 49]),
        e(P, [2, 39]),
        ...
        { 19: [1, 108] },
        e(t, [2, 15]),
        e(G, [2, 62], { 57: 109, 60: [1, 110], 62: q }),
        e(G, [2, 63]),
        e(J, [2, 67]),
        e(G, [2, 70]),
        e(J, [2, 69]),
        { 18: 111, 19: [1, 112], 53: 53, 54: 54, 58: D },
        { 16: 113, 40: T, 41: E },
        e(B, [2, 44], { 46: 87, 13: k, 41: A, 48: M, 49: N }),
        { 14: 114, 40: H, 50: U, 72: W },
        { 16: 115, 40: T, 41: E },
        { 14: 116, 40: H, 50: U, 72: W },
        e(t, [2, 13]),
        e(G, [2, 64]),
        { 59: 117, 61: K },
        { 19: [1, 118] },
        e(t, [2, 20]),
        e(t, [2, 23], { 17: [1, 119], 42: j }),
        e(t, [2, 11]),
        { 13: [1, 120], 42: j },
        e(t, [2, 10]),
        e(J, [2, 68]),
        e(t, [2, 18]),
        { 18: 121, 19: [1, 122], 53: 53, 54: 54, 58: D },
        { 14: 123, 40: H, 50: U, 72: W },
        { 19: [1, 124] },
        e(t, [2, 21]),
        e(t, [2, 9]),
        e(t, [2, 19]),
...
` +
  ...
  return (n(X, `Parser`), (X.prototype = Y), (Y.Parser = X), new X());
})();
b.parser = b;
var x = b,
  S = class {
    constructor() {
      ((this.entities = new Map()),
        ...
        (this.setAccTitle = c),
        (this.getAccTitle = m),
        (this.setAccDescription = o),
        (this.getAccDescription = u),
        (this.setDiagramTitle = l),
        (this.getDiagramTitle = s),
        (this.getConfig = n(() => f().er, `getConfig`)),
        this.clear(),
      ...
      return (
        this.entities.has(t)
          ? !this.entities.get(t)?.alias &&
            n &&
            ((this.entities.get(t).alias = n),
            e.info(`Add alias '${n}' to entity '${t}'`))
          : (this.entities.set(t, {
    ...
    addAttributes(t, n) {
      let r = this.addEntity(t),
        i;
      for (i = n.length - 1; i >= 0; i--)
        (n[i].keys || (n[i].keys = []),
          n[i].comment || (n[i].comment = ``),
          r.attributes.push(n[i]),
          e.debug(`Added attribute `, n[i].name));
    }
    addRelationship(t, n, r, i) {
      let a = this.entities.get(t),
        o = this.entities.get(r);
      if (!a || !o) return;
      let s = { entityA: a.id, roleA: n, entityB: o.id, relSpec: i };
      (this.relationships.push(s), e.debug(`Added new relationship :`, s));
    }
    getRelationships() {
    ...
    addClass(e, t) {
      e.forEach((e) => {
        ...
        (n === void 0 &&
          ((n = { id: e, styles: [], textStyles: [] }), this.classes.set(e, n)),
          t &&
    ...
    getData() {
      ...
      for (let t of this.entities.keys()) {
        ...
        n &&
          ((n.cssCompiledStyles = this.getCompiledStyles(
            n.cssClasses.split(` `),
          )),
          (n.colorIndex = r++),
          e.push(n));
      ...
      for (let e of this.relationships) {
        let r = {
          id: a(e.entityA, e.entityB, { prefix: `id`, counter: i++ }),
          type: `normal`,
          curve: `basis`,
          start: e.entityA,
          end: e.entityB,
      ...
      return { nodes: e, edges: t, other: {}, config: n, direction: `TB` };
    }
  },
  C = {};
t(C, { draw: () => w });
var w = n(async function (t, n, a, o) {
    (e.info(`REF0:`), e.info(`Drawing er diagram (unified)`, n));
    let { securityLevel: s, er: c, layout: l } = f(),
      u = o.db.getData(),
      d = g(n, s);
    ((u.type = o.type),
      (u.layoutAlgorithm = y(l)),
      (u.config.flowchart.nodeSpacing = c?.nodeSpacing || 140),
      (u.config.flowchart.rankSpacing = c?.rankSpacing || 80),
      (u.direction = o.db.getDirection()));
    let { config: p } = u,
      { look: m } = p;
    (m === `neo`
      ? (u.markers = [
      ...
      (u.diagramId = n),
      await v(u, d),
      u.layoutAlgorithm === `elk` && d.select(`.edges`).lower());
    let h = d.selectAll(`[id*="-background"]`);
    (Array.from(h).length > 0 &&
      h.each(function () {
        let e = r(this),
          t = e.attr(`id`).replace(`-background`, ``),
          n = d.select(`#${CSS.escape(t)}`);
        if (!n.empty()) {
      ...
      _(d, 8, `erDiagram`, c?.useMaxWidth ?? !0));
  }, `draw`),
  T = n((e, t) => {
    let n = h;
    return p(n(e, `r`), n(e, `g`), n(e, `b`), t);
  }, `fade`),
  E = new Set([`redux-color`, `redux-dark-color`]),
  D = n((e) => {
  ...
  .labelBkg {
    background-color: ${E.has(n) && r ? r : T(e.tertiaryColor, 0.5)};
  }
  ...
  [data-look=neo].labelBkg {
    background-color: ${T(e.tertiaryColor, 0.5)};
  }
`;
    }, `getStyles`),
  };
export { O as diagram };
//# sourceMappingURL=erDiagram-SMLLAGMA-ChLkh8by.js.map
