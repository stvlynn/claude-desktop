...
import { i as r, l as i, n as a } from "./chunk-5PVQY5BW-VrOwugqI.js";
import {
  L as o,
  R as s,
  b as c,
...
import { n as m, r as h } from "./chunk-U2HBQHQK-ByHLWhPg.js";
import { n as g, t as _ } from "./chunk-ZZ45TVLE-H5Mby50a.js";
import { a as v, i as y, r as b, t as x } from "./chunk-X2U36JSP-CwaTz5Mi.js";
import { t as S } from "./rough.esm-BDP__8iH.js";
var C = t(async (e, t, a) => {
    let s,
      u = t.useHtmlLabels || l(c()?.htmlLabels);
    s = a || `node default`;
    let d = e
        .insert(`g`)
        .attr(`class`, s)
        .attr(`id`, t.domId || t.id),
      f = d.insert(`g`).attr(`class`, `label`).attr(`style`, i(t.labelStyle)),
      p;
    p =
      t.label === void 0
        ? ``
    ...
    return (
      u
        ...
        : f.attr(`transform`, `translate(0, ` + -y.height / 2 + `)`),
      t.centerLabel &&
        f.attr(
          `transform`,
          `translate(` + -y.width / 2 + `, ` + -y.height / 2 + `)`,
      ...
      { shapeSvg: d, bbox: y, halfPadding: b, label: f }
    );
  }, `labelHelper`),
  w = t(async (e, t, i) => {
    let a = i.useHtmlLabels ?? f(c()),
      s = e
        .insert(`g`)
        .attr(`class`, `label`)
    ...
    return (
      a
        ...
        : s.attr(`transform`, `translate(0, ` + -u.height / 2 + `)`),
      i.centerLabel &&
        s.attr(
          `transform`,
          `translate(` + -u.width / 2 + `, ` + -u.height / 2 + `)`,
      ...
      { shapeSvg: e, bbox: u, halfPadding: d, label: s }
    );
  }, `insertLabel`),
  T = t((e, t) => {
...
function A(e) {
  let n = Array.from(e.childNodes).filter((e) => e.tagName === `path`),
    ...
    i = n
      ...
      .join(` `);
  r.setAttribute(`d`, i);
  let a = n.find((e) => e.getAttribute(`fill`) !== `none`),
    o = n.find((e) => e.getAttribute(`stroke`) !== `none`),
    s = t((e, t) => e?.getAttribute(t) ?? void 0, `getAttr`);
  if (a) {
...
var j = t((e, t) => {
  ...
  P = t(async (t, r) => {
    ...
    let i = c(),
      { themeVariables: a, handDrawnSeed: o } = i,
      { clusterBkg: s, clusterBorder: l } = a,
      {
        labelStyles: u,
        nodeStyles: d,
        borderStyles: p,
      ...
      _ = t
        .insert(`g`)
        .attr(`class`, `cluster ` + r.cssClasses)
        .attr(`id`, r.domId)
        .attr(`data-look`, r.look),
      b = f(i),
      x = _.insert(`g`).attr(`class`, `cluster-label `),
      C;
    C =
      r.labelType === `markdown`
        ? await m(x, r.label, {
            style: r.labelStyle,
            useHtmlLabels: b,
            isNode: !0,
    ...
    if (f(i)) {
      ...
      ((w = e.getBoundingClientRect()),
        t.attr(`width`, w.width),
        t.attr(`height`, w.height));
    }
    let T = r.width <= w.width + r.padding ? w.width + r.padding : r.width;
    r.width <= w.width + r.padding
      ? (r.diff = (T - r.width) / 2 - r.padding)
      : (r.diff = -r.padding);
    let E = r.height,
      D = r.x - T / 2,
      O = r.y - E / 2;
    ...
    if (r.look === `handDrawn`) {
      ...
      ((k = _.insert(
        () => (e.debug(`Rough node insert CXC`, i), i),
        `:first-child`,
      )),
        k.select(`path:nth-child(2)`).attr(`style`, p.join(`;`)),
        k.select(`path`).attr(`style`, h.join(`;`).replace(`fill`, `stroke`)));
    } else
      ((k = _.insert(`rect`, `:first-child`)),
        k
          .attr(`style`, d)
          .attr(`rx`, r.rx)
          .attr(`ry`, r.ry)
    ...
    if (
      (x.attr(
        `transform`,
        `translate(${r.x - w.width / 2}, ${r.y - r.height / 2 + A})`,
      ),
      u)
    ) {
      let e = x.select(`span`);
    ...
    return (
      ...
      (r.width = P.width),
      (r.height = P.height),
      (r.offsetY = w.height - r.padding / 2),
      (r.intersect = function (e) {
        return j(r, e);
      }),
      { cluster: _, labelBBox: w }
    );
  }, `rect`),
  F = {
    rect: P,
    squareRect: P,
    roundedWithTitle: t(async (e, t) => {
      let r = c(),
        ...
        p = d.insert(`g`, `:first-child`),
        m = d.insert(`g`).attr(`class`, `cluster-label`),
        h = d.append(`rect`),
        g = await M(m, t.label, t.labelStyle, void 0, !0),
        _ = g.getBBox();
      if (f(r)) {
        let e = g.children[0],
          t = n(g);
      ...
      return (
        m.attr(
          `transform`,
          `translate(${t.x - _.width / 2}, ${T + 1 - (f(r) ? 0 : 3)})`,
        ),
    ...
    kanbanSection: t(async (t, r) => {
      ...
      if (r.look === `handDrawn`) {
        ...
        ((k = _.insert(
          ...
          k
            .select(`path`)
            .attr(`style`, h.join(`;`).replace(`fill`, `stroke`)));
      } else
        ((k = _.insert(`rect`, `:first-child`)),
          k
            .attr(`style`, d)
...
function G(t, n) {
  ...
  let s = t
    ...
    { cssStyles: c } = n,
    l = S.svg(s),
    u = v(n, { fill: `black`, stroke: `none`, fillStyle: `solid` });
  n.look !== `handDrawn` && (u.roughness = 0);
  let d = l.circle(0, 0, 2, u),
    f = s.insert(() => d, `:first-child`);
  return (
    f.attr(`class`, `anchor`).attr(`style`, i(c)),
    T(n, f),
...
async function oe(e, n) {
  ...
  let a = n.padding ?? 0,
    o = n.look === `neo` ? 16 : a,
    s = n.look === `neo` ? 12 : a,
    c = t((e) => e + s, `calcTotalHeight`),
    l = t((e) => {
      let t = e / 2;
      return [t / (2.5 + e / 50), t];
    }, `calcEllipseRadius`),
    { shapeSvg: u, bbox: d } = await C(e, n, E(n)),
    f = c(n?.height ? n?.height : d.height),
    [p, m] = l(f),
    h = ae(f, p, m),
    g = (n?.width ? n?.width : d.width) + o * 2 + h - h,
    _ = f,
    { cssStyles: b } = n,
    x = [
      { x: g / 2, y: -_ / 2 },
  ...
  let k = D(x),
    A = w.path(k, O),
    j = u.insert(() => A, `:first-child`);
  return (
    j.attr(`class`, `basic label-container outer-path`),
    b && n.look !== `handDrawn` && j.selectAll(`path`).attr(`style`, b),
    i && n.look !== `handDrawn` && j.selectAll(`path`).attr(`style`, i),
    j.attr(`transform`, `translate(${p / 2}, 0)`),
    T(n, j),
...
async function ce(e, t) {
  ...
  let i = t.padding ?? 0,
    a = t.look === `neo` ? 28 : i,
    o = t.look === `neo` ? 24 : i,
    { shapeSvg: s, bbox: c } = await C(e, t, E(t)),
    l = (t?.width ?? c.width) + (t.look === `neo` ? a * 2 : a + se),
    u = (t?.height ?? c.height) + (t.look === `neo` ? o * 2 : o),
    d = l,
    f = -u,
    p = [
      { x: 0 + se, y: f },
  ...
  if (t.look === `handDrawn`) {
    ...
    ((m = s
      ...
      .attr(`transform`, `translate(${-l / 2}, ${u / 2})`)),
      h && m.attr(`style`, h));
  } else m = q(s, l, u, p);
  return (
    r && m.attr(`style`, r),
...
async function ue(t, n, r) {
  ...
  n.labelStyle = a;
  let { shapeSvg: s, bbox: c, halfPadding: l } = await C(t, n, E(n)),
    u = r?.padding ?? l,
  ...
  if (n.look === `handDrawn`) {
    let e = S.svg(s),
      t = v(n, {}),
      r = e.circle(0, 0, d * 2, t);
    ((f = s.insert(() => r, `:first-child`)),
      f.attr(`class`, `basic label-container`).attr(`style`, i(p)));
  } else
    f = s
  ...
  return (
    ...
    (n.intersect = function (t) {
      return (e.info(`Circle intersect`, n, d, t), W.circle(n, d, t));
    }),
    s
  );
}
...
function fe(t, n) {
  ...
  return (
    ...
    (n.intersect = function (t) {
      return (
        e.info(`crossedCircle intersect`, n, { radius: o, point: t }),
        W.circle(n, o, t)
      );
    }),
    a
...
async function pe(e, t) {
  let { labelStyles: n, nodeStyles: r } = y(t);
  t.labelStyle = n;
  let { shapeSvg: i, bbox: a, label: o } = await C(e, t, E(t)),
    s = t.look === `neo` ? 18 : (t.padding ?? 0),
    c = t.look === `neo` ? 12 : (t.padding ?? 0),
    l = a.width + s,
    u = a.height + c,
    d = Math.max(5, u * 0.1),
    { cssStyles: f } = t,
    ...
    m = [
      ...
      ...J(l / 2, -u / 2, d, 20, -90, 0),
      { x: -l / 2 - d, y: -d },
      ...J(l / 2 + l * 0.1, -d, d, 20, -180, -270),
      ...J(l / 2 + l * 0.1, d, d, 20, -90, -180),
      { x: -l / 2 - d, y: u / 2 },
      ...J(l / 2, u / 2, d, 20, 0, 90),
      { x: -l / 2, y: u / 2 + d },
      { x: l / 2, y: u / 2 + d },
...
async function me(e, t) {
  ...
  let { shapeSvg: i, bbox: a, label: o } = await C(e, t, E(t)),
    s = t.look === `neo` ? 18 : (t.padding ?? 0),
    c = t.look === `neo` ? 12 : (t.padding ?? 0),
    l = a.width + (t.look === `neo` ? s * 2 : s),
    u = a.height + (t.look === `neo` ? c * 2 : c),
    d = Math.max(5, u * 0.1),
    { cssStyles: f } = t,
    p = [
      ...Y(l / 2, -u / 2, d, 20, -90, 0),
  ...
  return (
    ...
    o.attr(
      `transform`,
      `translate(${-l / 2 + (t.padding ?? 0) / 2 - (a.x - (a.left ?? 0))},${-u / 2 + (t.padding ?? 0) / 2 - (a.y - (a.top ?? 0))})`,
    ),
    T(t, O),
    (t.intersect = function (e) {
      return W.polygon(t, m, e);
...
async function he(e, t) {
  ...
  let b = D(p).replace(`Z`, ``),
    ...
    k = D(h),
    A = g.path(k, { ..._ }),
    j = i.insert(`g`, `:first-child`);
  return (
    j.insert(() => A, `:first-child`).attr(`stroke-opacity`, 0),
    j.insert(() => x, `:first-child`),
    j.insert(() => O, `:first-child`),
    j.attr(`class`, `text`),
    f && t.look !== `handDrawn` && j.selectAll(`path`).attr(`style`, f),
    r && t.look !== `handDrawn` && j.selectAll(`path`).attr(`style`, r),
    j.attr(`transform`, `translate(${d - d / 4}, 0)`),
    o.attr(
      `transform`,
      `translate(${-l / 2 + (t.padding ?? 0) / 2 - (a.x - (a.left ?? 0))},${-u / 2 + (t.padding ?? 0) / 2 - (a.y - (a.top ?? 0))})`,
    ),
...
async function ge(e, t) {
  ...
  let i = t.padding ?? 0,
    ...
    o = t.look === `neo` ? 12 : i,
    { shapeSvg: s, bbox: c } = await C(e, t, E(t)),
    l = Math.max(20, (c.width + a * 2) * 1.25, t?.width ?? 0),
    u = Math.max(5, c.height + o * 2, t?.height ?? 0),
    d = u / 2,
    { cssStyles: f } = t,
    p = S.svg(s),
    m = v(t, {});
  ...
  let h = l,
    ...
    w = D(x),
    O = p.path(w, m),
    A = s.insert(() => O, `:first-child`);
  return (
    A.attr(`class`, `basic label-container outer-path`),
    f && t.look !== `handDrawn` && A.selectChildren(`path`).attr(`style`, f),
    r && t.look !== `handDrawn` && A.selectChildren(`path`).attr(`style`, r),
    A.attr(`transform`, `translate(${-l / 2}, ${-u / 2})`),
    T(t, A),
    (t.intersect = function (e) {
...
async function Se(e, t) {
  ...
  if (t.width || t.height) {
    let e = t.width ?? 0;
    ((t.width = (t.width ?? 0) - s), t.width < xe && (t.width = xe));
    let n = e / 2 / (2.5 + e / 50);
    ((t.height = (t.height ?? 0) - o - n * 3),
      t.height < be && (t.height = be));
  }
  let { shapeSvg: c, bbox: l, label: u } = await C(e, t, E(t)),
  ...
  if (t.look === `handDrawn`) {
    let e = S.svg(c),
      ...
      i = v(t, {}),
      a = e.path(n, i),
      o = e.path(r, v(t, { fill: `none` }));
    ((h = c.insert(() => o, `:first-child`)),
      (h = c.insert(() => a, `:first-child`)),
      h.attr(`class`, `basic label-container`),
      g && h.attr(`style`, g));
  } else {
    let e = _e(0, 0, d, m, f, p);
    h = c
...
async function Ce(e, t) {
  let { labelStyles: n, nodeStyles: r } = y(t);
  t.labelStyle = n;
  let i = t.look === `neo` ? 16 : (t.padding ?? 0),
    a = t.look === `neo` ? 16 : (t.padding ?? 0),
    { shapeSvg: o, bbox: s, label: c } = await C(e, t, E(t)),
    l = s.width + i,
    u = s.height + a,
    d = u * 0.2,
    f = -l / 2,
  ...
  let _ = [
    ...
    x = o.insert(() => b, `:first-child`);
  return (
    x.attr(`class`, `basic label-container outer-path`),
    m && t.look !== `handDrawn` && x.selectAll(`path`).attr(`style`, m),
    r && t.look !== `handDrawn` && x.selectAll(`path`).attr(`style`, r),
    c.attr(
      `transform`,
      `translate(${f + (t.padding ?? 0) / 2 - (s.x - (s.left ?? 0))}, ${p + d + (t.padding ?? 0) / 2 - (s.y - (s.top ?? 0))})`,
    ),
    T(t, x),
    (t.intersect = function (e) {
      return W.rect(t, e);
...
async function we(t, n) {
  let { labelStyles: r, nodeStyles: a } = y(n),
    o = n.look === `neo` ? 12 : 5;
  n.labelStyle = r;
  let s = n.padding ?? 0,
    c = n.look === `neo` ? 16 : s,
    { shapeSvg: l, bbox: u } = await C(t, n, E(n)),
  ...
  if (n.look === `handDrawn`) {
    let e = S.svg(l),
      t = v(n, { roughness: 0.2, strokeWidth: 2.5 }),
      r = v(n, { roughness: 0.2, strokeWidth: 1.5 }),
      a = e.circle(0, 0, d * 2, t),
      o = e.circle(0, 0, f * 2, r);
    ((p = l.insert(`g`, `:first-child`)),
      p.attr(`class`, i(n.cssClasses)).attr(`style`, i(m)),
    ...
    let e = p.insert(`circle`, `:first-child`),
      t = p.insert(`circle`);
    (p.attr(`class`, `basic label-container`).attr(`style`, a),
      e
  ...
  return (
    T(n, p),
    (n.intersect = function (t) {
      return (e.info(`DoubleCircle intersect`, n, d, t), W.circle(n, d, t));
    }),
    l
  );
}
...
function Te(t, n, { config: { themeVariables: r } }) {
  ...
  return (
    ...
    (n.intersect = function (t) {
      return (
        e.info(`filledCircle intersect`, n, { radius: 7, point: t }),
        W.circle(n, 7, t)
      );
    }),
    o
...
async function Oe(t, n) {
  ...
  (n.width || n.height) &&
    ...
    (n.width = (n?.width ?? 0) - o - o / 2),
    n.width < De && (n.width = De));
  let { shapeSvg: s, bbox: c, label: l } = await C(t, n, E(n)),
    u = (n?.width ? n?.width : c.width) + (o ?? 0),
    d = n?.height ? n?.height : u + c.height,
    f = d,
    p = [
      { x: 0, y: -d },
      { x: f, y: -d },
  ...
  return (
    m && n.look !== `handDrawn` && x.selectChildren(`path`).attr(`style`, m),
    ...
    l.attr(
      `transform`,
      `translate(${-c.width / 2 - (c.x - (c.left ?? 0))}, ${-d / 2 + (n.padding ?? 0) / 2 + (c.y - (c.top ?? 0))})`,
    ),
    (n.intersect = function (t) {
...
function ke(e, t, { dir: n, config: { state: r, themeVariables: i } }) {
  ...
  let u = (-1 * c) / 2,
    d = (-1 * l) / 2,
    f = S.svg(o),
    p = v(t, { stroke: i.lineColor, fill: i.lineColor });
...
async function Ae(t, n) {
  ...
  (n.width || n.height) &&
    ((n.height = (n?.height ?? 0) - o * 2),
    n.height < 10 && (n.height = 10),
    (n.width = (n?.width ?? 0) - a * 2),
    n.width < 15 && (n.width = 15));
  let { shapeSvg: s, bbox: c } = await C(t, n, E(n)),
    l = (n?.width ? n?.width : Math.max(15, c.width)) + a * 2,
    u = (n?.height ? n?.height : Math.max(10, c.height)) + o * 2,
    d = u / 2,
    { cssStyles: f } = n,
    p = S.svg(s),
    m = v(n, {});
  ...
  let h = [
    ...
    g = D(h),
    _ = p.path(g, m),
    b = s.insert(() => _, `:first-child`);
  return (
    b.attr(`class`, `basic label-container outer-path`),
    f && n.look !== `handDrawn` && b.selectChildren(`path`).attr(`style`, f),
    i && n.look !== `handDrawn` && b.selectChildren(`path`).attr(`style`, i),
    T(n, b),
    (n.intersect = function (t) {
      return (
        e.info(`Pill intersect`, n, { radius: d, point: t }),
        W.polygon(n, h, t)
      );
    }),
    s
...
async function Me(e, t) {
  ...
  let { shapeSvg: c, bbox: l } = await C(e, t, E(t)),
    u = (t?.height ? t?.height : l.height) + o,
    d = u / i,
    f = (t?.width ? t?.width : l.width) + 2 * d + s,
    p = [
      { x: d, y: 0 },
      { x: f - d, y: 0 },
      { x: f, y: -u / 2 },
  ...
  if (t.look === `handDrawn`) {
    ...
    ((m = c
      .insert(() => i, `:first-child`)
      .attr(`transform`, `translate(${-f / 2}, ${u / 2})`)),
      h && m.attr(`style`, h));
  } else m = q(c, f, u, p);
  return (
    r && m.attr(`style`, r),
...
async function Ne(t, n) {
  ...
  let { shapeSvg: a } = await C(t, n, E(n)),
    o = Math.max(30, n?.width ?? 0),
...
async function Pe(t, n, { config: { themeVariables: r, flowchart: i } }) {
  ...
  let { shapeSvg: u, bbox: d, label: f } = await C(t, n, `icon-shape default`),
    p = n.pos === `t`,
    m = c,
    g = c,
    { nodeBorder: _ } = r,
    ...
    D = n.label ? 8 : 0,
    O = S.svg(u),
    k = v(n, { stroke: `none`, fill: `none` });
  n.look !== `handDrawn` && ((k.roughness = 0), (k.fillStyle = `solid`));
  let A = O.rectangle(w, E, g, m, k),
    j = Math.max(g, d.width),
    M = m + d.height + D,
  ...
  if (n.icon) {
    let e = u.append(`g`);
    e.html(
      `<g>${await h(n.icon, { height: c, width: c, fallbackPrefix: `` })}</g>`,
    );
    ...
    (e.attr(
      `transform`,
      `translate(${-r / 2 - a},${p ? d.height / 2 + D / 2 - i / 2 - o : -d.height / 2 - D / 2 - i / 2 - o})`,
    ),
      e.attr(`style`, `color: ${b.get(`stroke`) ?? _};`));
  }
  return (
    f.attr(
      `transform`,
    ...
    P.attr(
      `transform`,
      `translate(0,${p ? d.height / 2 + D / 2 : -d.height / 2 - D / 2})`,
    ),
    T(n, F),
    (n.intersect = function (t) {
      ...
      return (
        (o = p
          ? [
              ...
              { x: r + d.width / 2, y: i - a / 2 },
              { x: r + d.width / 2, y: i - a / 2 + d.height + D },
              { x: r + g / 2, y: i - a / 2 + d.height + D },
              { x: r + g / 2, y: i + a / 2 },
              { x: r - g / 2, y: i + a / 2 },
              { x: r - g / 2, y: i - a / 2 + d.height + D },
              { x: r - d.width / 2, y: i - a / 2 + d.height + D },
...
async function Fe(t, n, { config: { themeVariables: r, flowchart: i } }) {
  ...
  return (
    ...
    D.attr(`style`, `color: ${b.get(`stroke`) ?? g};`),
    f.attr(
      `transform`,
...
async function Ie(t, n, { config: { themeVariables: r, flowchart: i } }) {
  ...
  let {
      ...
      halfPadding: f,
      label: p,
    } = await C(t, n, `icon-shape default`),
    m = n.pos === `t`,
    g = c + f * 2,
    _ = c + f * 2,
    { nodeBorder: b, mainBkg: w } = r,
    { stylesMap: E } = x(n),
    D = -_ / 2,
    O = -g / 2,
    k = n.label ? 8 : 0,
  ...
  let M = A.path(N(D, O, _, g, 5), j),
    P = Math.max(_, d.width),
    F = g + d.height + k,
    ...
    ee = u.insert(() => M, `:first-child`).attr(`class`, `icon-shape2`),
    te = u.insert(() => I);
  if (n.icon) {
    let e = u.append(`g`);
    e.html(
    ...
    (e.attr(
      ...
      e.attr(`style`, `color: ${E.get(`stroke`) ?? b};`));
  }
  return (
    p.attr(
      `transform`,
      `translate(${-d.width / 2 - (d.x - (d.left ?? 0))},${m ? -F / 2 : F / 2 - d.height})`,
    ),
    ee.attr(
      `transform`,
      ...
      return (
        (o = m
          ? [
              { x: r - d.width / 2, y: i - a / 2 },
              { x: r + d.width / 2, y: i - a / 2 },
              { x: r + d.width / 2, y: i - a / 2 + d.height + k },
              { x: r + _ / 2, y: i - a / 2 + d.height + k },
              { x: r + _ / 2, y: i + a / 2 },
              { x: r - _ / 2, y: i + a / 2 },
              { x: r - _ / 2, y: i - a / 2 + d.height + k },
              { x: r - d.width / 2, y: i - a / 2 + d.height + k },
...
async function Re(t, n, { config: { flowchart: r } }) {
  ...
  let { shapeSvg: f, bbox: p, label: m } = await C(t, n, `image-shape default`),
    h = n.pos === `t`,
    g = -u / 2,
    _ = -d / 2,
    b = n.label ? 8 : 0,
  ...
  let E = x.rectangle(g, _, u, d, w),
    D = Math.max(u, p.width),
    O = d + p.height + b,
    k = x.rectangle(-D / 2, -O / 2, D, O, {
      ...w,
      fill: `none`,
      stroke: `none`,
    }),
    A = f.insert(() => E, `:first-child`),
    j = f.insert(() => k);
  if (n.img) {
  ...
  return (
    m.attr(
      `transform`,
      `translate(${-p.width / 2 - (p.x - (p.left ?? 0))},${h ? -d / 2 - p.height / 2 - b / 2 : d / 2 - p.height / 2 + b / 2})`,
    ),
    A.attr(
      `transform`,
      `translate(0,${h ? p.height / 2 + b / 2 : -p.height / 2 - b / 2})`,
    ),
    T(n, j),
    (n.intersect = function (t) {
      if ((e.info(`iconSquare intersect`, n, t), !n.label)) return W.rect(n, t);
      ...
      return (
        (o = h
          ? [
              ...
              { x: r + p.width / 2, y: i - a / 2 },
              { x: r + p.width / 2, y: i - a / 2 + p.height + b },
              { x: r + u / 2, y: i - a / 2 + p.height + b },
              { x: r + u / 2, y: i + a / 2 },
              { x: r - u / 2, y: i + a / 2 },
              { x: r - u / 2, y: i - a / 2 + p.height + b },
              { x: r - p.width / 2, y: i - a / 2 + p.height + b },
...
async function ze(e, t) {
  ...
  let i = t.padding ?? 0,
    ...
    o = t.look === `neo` ? i * 2 : i,
    { shapeSvg: s, bbox: c } = await C(e, t, E(t)),
    l = Math.max(c.width + (o ?? 0) * 2, t?.width ?? 0),
    u = Math.max(c.height + (a ?? 0) * 2, t?.height ?? 0),
    d = [
      { x: 0, y: 0 },
      { x: l, y: 0 },
      { x: l + (3 * u) / 6, y: -u },
...
async function Be(e, t, n) {
  let { labelStyles: r, nodeStyles: a } = y(t);
  t.labelStyle = r;
  let { shapeSvg: o, bbox: s } = await C(e, t, E(t)),
  ...
  if ((n?.rx && n.ry && ((p = n.rx), (m = n.ry)), t.look === `handDrawn`)) {
    let e = S.svg(o),
      n = v(t, {}),
      r =
        p || m ? e.path(N(u, d, c, l, p || 0), n) : e.rectangle(u, d, c, l, n);
    ((f = o.insert(() => r, `:first-child`)),
      f.attr(`class`, `basic label-container`).attr(`style`, i(h)));
  } else
...
async function He(e, t) {
  ...
  if (t.look === `handDrawn`) {
    ...
    ((f = s
      .insert(() => i, `:first-child`)
      .attr(`transform`, `translate(${-u / 2}, ${l / 2})`)),
      p && f.attr(`style`, p));
  } else f = q(s, u, l, d);
  return (
    r && f.attr(`style`, r),
...
async function Xe(e, t) {
  ...
  if (t.width || t.height) {
    let e = t.width ?? 0;
    ((t.width = (t.width ?? 0) - o), t.width < Ye && (t.width = Ye));
    let n = e / 2 / (2.5 + e / 50);
    ((t.height = (t.height ?? 0) - s - n * 3),
      t.height < Je && (t.height = Je));
  }
  let { shapeSvg: c, bbox: l, label: u } = await C(e, t, E(t)),
  ...
  if (t.look === `handDrawn`) {
    let e = S.svg(c),
      ...
      a = e.path(n, i),
      o = e.path(r, i);
    (c.insert(() => o, `:first-child`).attr(`class`, `line`),
      (g = c.insert(() => a, `:first-child`)),
      g.attr(`class`, `basic label-container`),
      _ && g.attr(`style`, _));
  } else {
    let e = Ge(0, 0, d, m, f, p, h);
    g = c
      .insert(`path`, `:first-child`)
      .attr(`d`, e)
      .attr(`class`, `basic label-container outer-path`)
...
async function Ze(e, t) {
  ...
  let i = t.padding ?? 0,
    ...
    o = t.look === `neo` ? 12 : i;
  (t.width || t.height) &&
    ((t.width = ((t.width ?? 0) * 10) / 11 - a * 2),
    t.width < 10 && (t.width = 10),
    (t.height = (t?.height ?? 0) - o * 2),
    t.height < 10 && (t.height = 10));
  let { shapeSvg: s, bbox: c, label: l } = await C(e, t, E(t)),
    u = (t?.width ? t?.width : c.width) + (a ?? 0) * 2,
    d = (t?.height ? t?.height : c.height) + (o ?? 0) * 2,
    f = t.look === `neo` ? d / 4 : d / 8,
    p = d + f,
    { cssStyles: m } = t,
    h = S.svg(s),
    g = v(t, {});
  ...
  let _ = [
      { x: -u / 2 - (u / 2) * 0.1, y: -p / 2 },
      { x: -u / 2 - (u / 2) * 0.1, y: p / 2 },
      ...O(-u / 2 - (u / 2) * 0.1, p / 2, u / 2 + (u / 2) * 0.1, p / 2, f, 0.8),
      { x: u / 2 + (u / 2) * 0.1, y: -p / 2 },
      { x: -u / 2 - (u / 2) * 0.1, y: -p / 2 },
      { x: -u / 2, y: -p / 2 },
      { x: -u / 2, y: (p / 2) * 1.1 },
    ...
    x = s.insert(() => b, `:first-child`);
  return (
    x.attr(`class`, `basic label-container outer-path`),
    m && t.look !== `handDrawn` && x.selectAll(`path`).attr(`style`, m),
    r && t.look !== `handDrawn` && x.selectAll(`path`).attr(`style`, r),
    x.attr(`transform`, `translate(0,${-f / 2})`),
    l.attr(
      `transform`,
      `translate(${-u / 2 + (t.padding ?? 0) + ((u / 2) * 0.1) / 2 - (c.x - (c.left ?? 0))},${-d / 2 + (t.padding ?? 0) - f / 2 - (c.y - (c.top ?? 0))})`,
    ),
    T(t, x),
    (t.intersect = function (e) {
...
async function Qe(e, t) {
  ...
  let i = t.padding ?? 0,
    ...
    s = t.look === `neo` ? 10 : 5;
  (t.width || t.height) &&
    ((t.width = Math.max((t?.width ?? 0) - a * 2 - 2 * s, 10)),
    (t.height = Math.max((t?.height ?? 0) - o * 2 - 2 * s, 10)));
  let { shapeSvg: c, bbox: l, label: u } = await C(e, t, E(t)),
    d = (t?.width ? t?.width : l.width) + a * 2 + 2 * s,
    f = (t?.height ? t?.height : l.height) + o * 2 + 2 * s,
    p = d - 2 * s,
    m = f - 2 * s,
    h = -p / 2,
    g = -m / 2,
  ...
  return (
    ...
    _ && t.look !== `handDrawn` && P.selectAll(`path`).attr(`style`, _),
    r && t.look !== `handDrawn` && P.selectAll(`path`).attr(`style`, r),
    u.attr(
      `transform`,
      `translate(${-(l.width / 2) - s - (l.x - (l.left ?? 0))}, ${-(l.height / 2) + s - (l.y - (l.top ?? 0))})`,
    ),
    T(t, P),
    (t.intersect = function (e) {
...
async function $e(e, t) {
  ...
  (t.width || t.height) &&
    ((u = !1),
    (t.width = (t?.width ?? 0) - c * 2),
    (t.height = (t?.height ?? 0) - l * 3));
  let d = Math.max(a.width, t?.width ?? 0) + c * 2,
    f = Math.max(a.height, t?.height ?? 0) + l * 3,
    p = t.look === `neo` ? f / 4 : f / 8,
    m = f + (u ? p / 2 : -p / 2),
    h = -d / 2,
    g = -m / 2,
    { cssStyles: _ } = t,
    b = O(h - 10, g + m + 10, h + d - 10, g + m + 10, p, 0.8),
    x = b?.[b.length - 1],
    w = [
      { x: h - 10, y: g + 10 },
      { x: h - 10, y: g + m + 10 },
  ...
  let M = D(w),
    ...
    P = D(k),
    F = A.path(P, j),
    I = i.insert(() => N, `:first-child`);
  return (
    I.insert(() => F),
    I.attr(`class`, `basic label-container outer-path`),
    _ && t.look !== `handDrawn` && I.selectAll(`path`).attr(`style`, _),
    r && t.look !== `handDrawn` && I.selectAll(`path`).attr(`style`, r),
    I.attr(`transform`, `translate(0,${-p / 2})`),
    o.attr(
      `transform`,
      `translate(${-(a.width / 2) - 10 - (a.x - (a.left ?? 0))}, ${-(a.height / 2) + 10 - p / 2 - (a.y - (a.top ?? 0))})`,
    ),
    T(t, I),
    (t.intersect = function (e) {
      return W.polygon(t, w, e);
...
async function et(e, t, { config: { themeVariables: n } }) {
  ...
  let { shapeSvg: a, bbox: o, label: s } = await C(e, t, E(t)),
    ...
    { cssStyles: m } = t,
    h = S.svg(a),
    g = v(t, { fill: n.noteBkgColor, stroke: n.noteBorderColor });
  t.look !== `handDrawn` && ((g.roughness = 0), (g.fillStyle = `solid`));
  let _ = h.rectangle(u, d, c, l, g),
    b = a.insert(() => _, `:first-child`);
  return (
    b.attr(`class`, `basic label-container outer-path`),
    s.attr(`class`, `label noteLabel`),
...
async function nt(e, t) {
  ...
  let { shapeSvg: i, bbox: a } = await C(e, t, E(t)),
    o = a.width + (t.padding ?? 0) + (a.height + (t.padding ?? 0)),
    s = 0.5,
    c = [
      { x: o / 2, y: 0 },
      { x: o, y: -o / 2 },
...
async function rt(e, t) {
  ...
  let i = t.padding ?? 0,
    a = t.look === `neo` ? 21 : (i ?? 0),
    o = t.look === `neo` ? 12 : (i ?? 0),
    { shapeSvg: s, bbox: c, label: l } = await C(e, t, E(t)),
    u = (t?.width ?? c.width) + (t.look === `neo` ? a * 2 : a),
    d = (t?.height ?? c.height) + (t.look === `neo` ? o * 2 : o),
    f = -u / 2,
    p = -d / 2,
    m = p / 2,
    h = [
  ...
  let x = D(h),
    w = _.path(x, b),
    O = s.insert(() => w, `:first-child`);
  return (
    O.attr(`class`, `basic label-container outer-path`),
    g && t.look !== `handDrawn` && O.selectAll(`path`).attr(`style`, g),
    r && t.look !== `handDrawn` && O.selectAll(`path`).attr(`style`, r),
    O.attr(`transform`, `translate(${-m / 2},0)`),
    l.attr(
      `transform`,
      `translate(${-m / 2 - c.width / 2 - (c.x - (c.left ?? 0))}, ${-(c.height / 2) - (c.y - (c.top ?? 0))})`,
    ),
    T(t, O),
    (t.intersect = function (e) {
      return W.polygon(t, h, e);
...
async function it(t, r) {
  ...
  let s = t
    ...
    l = s.insert(`g`),
    u = s.insert(`g`).attr(`class`, `label`).attr(`style`, a),
    d = r.description,
    p = r.label,
    m = await M(u, p, r.labelStyle, !0, !0),
    h = { width: 0, height: 0 };
  if (f(c())) {
    let e = m.children[0],
      t = n(m);
  ...
  ((h = x.getBoundingClientRect()),
    C.attr(`width`, h.width),
    C.attr(`height`, h.height));
  let w = (r.padding || 0) / 2;
  (n(b).attr(
    `transform`,
    `translate( ` +
    ...
    u.attr(
      `transform`,
      `translate(` + -h.width / 2 + `, ` + (-h.height / 2 - w + 3) + `)`,
    ));
  let E = h.width + (r.padding || 0),
    D = h.height + (r.padding || 0),
    O = -h.width / 2 - w,
    k = -h.height / 2 - w,
    A,
    j;
  if (r.look === `handDrawn`) {
    let t = S.svg(s),
      n = v(r, {}),
      i = t.path(N(O, k, E, D, r.rx || 0), n),
      a = t.line(
        -h.width / 2 - w,
        -h.height / 2 - w + _.height + w,
        h.width / 2 + w,
        -h.height / 2 - w + _.height + w,
        n,
      );
    ((j = s.insert(
      () => (e.debug(`Rough node insert CXC`, i), a),
      `:first-child`,
    )),
      (A = s.insert(
        () => (e.debug(`Rough node insert CXC`, i), i),
    ...
    ((A = l.insert(`rect`, `:first-child`)),
      (j = l.insert(`line`)),
      A.attr(`class`, `outer title-state`)
        .attr(`style`, a)
        .attr(`x`, -h.width / 2 - w)
        .attr(`y`, -h.height / 2 - w)
        .attr(`width`, h.width + (r.padding || 0))
        .attr(`height`, h.height + (r.padding || 0)),
      j
        .attr(`class`, `divider`)
        .attr(`x1`, -h.width / 2 - w)
        .attr(`x2`, h.width / 2 + w)
        .attr(`y1`, -h.height / 2 - w + _.height + w)
        .attr(`y2`, -h.height / 2 - w + _.height + w));
  return (
    T(r, A),
    (r.intersect = function (e) {
      return W.rect(r, e);
...
async function ot(e, t) {
  ...
  let a = t.look === `neo` ? 16 : (t.padding ?? 0),
    ...
    { shapeSvg: s, bbox: c, label: l } = await C(e, t, E(t)),
    u = (t?.width ?? c.width) + a * 2 + (t.look === `neo` ? Z : Z * 2),
  ...
  return (
    D.attr(`class`, `basic label-container outer-path`).attr(`style`, i(g)),
    r && t.look !== `handDrawn` && D.selectAll(`path`).attr(`style`, r),
    g && t.look !== `handDrawn` && D.selectAll(`path`).attr(`style`, r),
    l.attr(
      `transform`,
...
async function st(e, t) {
  ...
  (t.width || t.height) &&
    ...
    (t.height = Math.max((t?.height ?? 0) / 1.5 - o * 2, 10)));
  let { shapeSvg: s, bbox: c, label: l } = await C(e, t, E(t)),
    u = (t?.width ? t?.width : c.width) + a * 2,
    d = ((t?.height ? t?.height : c.height) + o * 2) * 1.5,
    f = u,
    p = d / 1.5,
    m = -f / 2,
    h = -p / 2,
  ...
  return (
    ...
    k.attr(`transform`, `translate(0, ${p / 4})`),
    l.attr(
      `transform`,
      `translate(${-f / 2 + (t.padding ?? 0) - (c.x - (c.left ?? 0))}, ${-p / 4 + (t.padding ?? 0) - (c.y - (c.top ?? 0))})`,
    ),
    T(t, k),
    (t.intersect = function (e) {
      return W.polygon(t, x, e);
...
async function lt(e, t) {
  ...
  let i = t.padding ?? 0,
    ...
    o = t.look === `neo` ? 12 : i,
    { shapeSvg: s, bbox: c } = await C(e, t, E(t)),
    l = c.height + (t.look === `neo` ? o * 2 : o),
    u = c.width + l / 4 + (t.look === `neo` ? a * 2 : a),
    d = l / 2,
    { cssStyles: f } = t,
    p = S.svg(s),
    m = v(t, {});
...
function dt(e, t, { config: { themeVariables: n } }) {
  ...
  t.labelStyle = r;
  let { cssStyles: a } = t,
    { lineColor: o, stateBorder: s, nodeBorder: c, nodeShadow: l } = n;
  ((t.width || t.height) &&
  ...
  let p = d.circle(0, 0, t.width, { ...f, stroke: o, strokeWidth: 2 }),
    m = s ?? c,
    h = ((t.width ?? 0) * 5) / 14,
    g = d.circle(0, 0, h, {
      ...f,
  ...
  if (
    (_.insert(() => g),
    t.look !== `handDrawn` && _.attr(`class`, `outer-path`),
    a && _.selectAll(`path`).attr(`style`, a),
    i && _.selectAll(`path`).attr(`style`, i),
    t.width < 25 && l && t.look !== `handDrawn`)
  ) {
...
async function mt(e, t) {
  ...
  let a = t?.padding ?? 8,
    o = t.look === `neo` ? 28 : a,
    s = t.look === `neo` ? 12 : a,
    { shapeSvg: c, bbox: l } = await C(e, t, E(t)),
    u = (t?.width ?? l.width) + 2 * pt + o,
  ...
  if (t.look === `handDrawn`) {
    let e = S.svg(c),
      ...
      a = e.line(m + pt, h, m + pt, h + p, n),
      o = e.line(m + pt + f, h, m + pt + f, h + p, n);
    (c.insert(() => a, `:first-child`), c.insert(() => o, `:first-child`));
    let s = c.insert(() => r, `:first-child`),
      { cssStyles: l } = t;
    (s.attr(`class`, `basic label-container`).attr(`style`, i(l)), T(t, s));
  } else {
    let e = q(c, f, p, g);
...
async function gt(e, t) {
  ...
  (t.width || t.height) &&
    ...
    (t.width = Math.max(
      (t?.width ?? 0) - a * 2 - ht * (t.height + o * 2),
      10,
    )));
  let { shapeSvg: s, bbox: c } = await C(e, t, E(t)),
    l = (t?.height ? t?.height : c.height) + o * 2,
    u = ht * l,
    d = ht * l,
    f = (t?.width ? t?.width : c.width) + a * 2 + u - u,
    p = l,
    m = -f / 2,
    h = -p / 2,
    { cssStyles: g } = t,
  ...
  let O = D(x),
    k = _.path(O, b),
    A = D(w),
    j = _.path(A, { ...b, fillStyle: `solid` }),
    M = s.insert(() => j, `:first-child`);
  return (
    M.insert(() => k, `:first-child`),
    M.attr(`class`, `basic label-container outer-path`),
    g && t.look !== `handDrawn` && M.selectAll(`path`).attr(`style`, g),
...
async function _t(e, t) {
  ...
  let g = [
      { x: -s / 2 - (s / 2) * 0.1, y: f / 2 },
      ...O(-s / 2 - (s / 2) * 0.1, f / 2, s / 2 + (s / 2) * 0.1, f / 2, l, 0.8),
      { x: s / 2 + (s / 2) * 0.1, y: -f / 2 },
      { x: -s / 2 - (s / 2) * 0.1, y: -f / 2 },
    ],
    _ = -s / 2 + (s / 2) * 0.1,
    ...
    x = [
      ...
      { x: _ + s, y: b + c - d },
      { x: _ + s, y: (b + c) * 0.9 },
      ...O(_ + s, (b + c) * 1.25, _ + s - u, (b + c) * 1.3, -c * 0.02, 0.5),
    ],
    w = D(g),
    k = m.path(w, h),
    A = D(x),
    j = m.path(A, { ...h, fillStyle: `solid` }),
...
async function wt(e, t) {
  ...
  if (t.width || t.height) {
    let e = t.height ?? 0;
    ((t.height = (t.height ?? 0) - o), t.height < St && (t.height = St));
    let n = e / 2 / (2.5 + e / 50);
    ((t.width = (t.width ?? 0) - o - n * 3), t.width < Ct && (t.width = Ct));
  }
  let { shapeSvg: s, bbox: c, label: l } = await C(e, t, E(t)),
  ...
  if (t.look === `handDrawn`) {
    let e = S.svg(s),
      ...
      r = xt(0, 0, p, u, f, d),
      i = e.path(n, v(t, {})),
      a = e.path(r, v(t, { fill: `none` }));
    ((h = s.insert(() => a, `:first-child`)),
      (h = s.insert(() => i, `:first-child`)),
      h.attr(`class`, `basic label-container`),
      m && h.attr(`style`, m));
  } else {
...
async function Et(e, t) {
  ...
  let { shapeSvg: s, bbox: c } = await C(e, t, E(t)),
    l = (t?.width ? t?.width : c.width) + a * 2,
    u = (t?.height ? t?.height : c.height) + o * 2,
    { cssStyles: d } = t,
    f = S.svg(s),
    p = v(t, {});
  t.look !== `handDrawn` && ((p.roughness = 0), (p.fillStyle = `solid`));
...
async function kt(t, n) {
  ...
  let { shapeSvg: s, bbox: u, label: d } = await C(t, n, E(n)),
    f = l(c().flowchart?.htmlLabels),
    p = (n?.width ? n?.width : u.width) + o,
    m = n?.height ? n?.height : p + u.height,
    h = m,
    g = [
      { x: 0, y: 0 },
      { x: h, y: 0 },
  ...
  let w = D(g),
    ...
    k = s
      ...
      .attr(`transform`, `translate(${-m / 2}, ${m / 2})`)
      .attr(`class`, `outer-path`);
  return (
    ...
    d.attr(
      `transform`,
      `translate(${-u.width / 2 - (u.x - (u.left ?? 0))}, ${m / 2 - (u.height + (n.padding ?? 0) / (f ? 2 : 1) - (u.y - (u.top ?? 0)))})`,
    ),
    (n.intersect = function (t) {
...
async function At(e, t) {
  ...
  (t.width || t.height) &&
    ...
    t.height < 10 && (t.height = 10));
  let { shapeSvg: c, bbox: l, label: u } = await C(e, t, E(t)),
    d = (t?.width ? t?.width : l.width) + (a ?? 0) * 2,
    f = (t?.height ? t?.height : l.height) + (o ?? 0) * 2,
    p = t.look === `neo` ? f / 4 : f / 8,
    m = f + (s ? p : -p),
    { cssStyles: h } = t,
    g = 14 - d,
  ...
  let w = [
      { x: -d / 2 - _, y: m / 2 },
      ...O(-d / 2 - _, m / 2, d / 2 + _, m / 2, p, 0.8),
      { x: d / 2 + _, y: -m / 2 },
      { x: -d / 2 - _, y: -m / 2 },
    ],
    k = D(w),
    A = b.path(k, x),
    j = c.insert(() => A, `:first-child`);
  return (
    j.attr(`class`, `basic label-container outer-path`),
    h && t.look !== `handDrawn` && j.selectAll(`path`).attr(`style`, h),
    r && t.look !== `handDrawn` && j.selectAll(`path`).attr(`style`, r),
    j.attr(`transform`, `translate(0,${-p / 2})`),
    u.attr(
      `transform`,
      `translate(${-d / 2 + (t.padding ?? 0) - (l.x - (l.left ?? 0))},${-f / 2 + (t.padding ?? 0) - p - (l.y - (l.top ?? 0))})`,
    ),
    T(t, j),
    (t.intersect = function (e) {
      return W.polygon(t, w, e);
...
async function jt(e, t) {
  ...
  return (
    ...
    p && t.look !== `handDrawn` && x.selectAll(`path`).attr(`style`, p),
    r && t.look !== `handDrawn` && x.selectAll(`path`).attr(`style`, r),
    T(t, x),
    (t.intersect = function (e) {
      return W.polygon(t, g, e);
...
async function Mt(e, t) {
  ...
  (t.width || t.height) &&
    ((t.width = Math.max((t?.width ?? 0) - i * 2 - Q, 10)),
    (t.height = Math.max((t?.height ?? 0) - a * 2 - Q, 10)));
  let { shapeSvg: o, bbox: s, label: c } = await C(e, t, E(t)),
    l = (t?.width ? t?.width : s.width) + i * 2 + Q,
    u = (t?.height ? t?.height : s.height) + a * 2 + Q,
    d = l - Q,
    f = u - Q,
    p = -d / 2,
    m = -f / 2,
  ...
  return (
    ...
    c.attr(
      `transform`,
      `translate(${-(s.width / 2) + Q / 2 - (s.x - (s.left ?? 0))}, ${-(s.height / 2) + Q / 2 - (s.y - (s.top ?? 0))})`,
    ),
    T(t, D),
    (t.intersect = function (e) {
...
async function Ft(e, t) {
  ...
  let { theme: i, themeVariables: o } = p(),
    { rowEven: s, rowOdd: c, nodeBorder: u, borderColorArray: d } = o;
  if (t.look === `handDrawn`) {
    let { themeVariables: n } = p(),
      { background: r } = n;
    await Ft(e, {
      ...t,
      id: t.id + `-background`,
  ...
  let m = f.er?.diagramPadding ?? 10,
    h = f.er?.entityPadding ?? 6,
    { cssStyles: g } = t,
    { labelStyles: _, nodeStyles: b } = y(t);
  if (r.attributes.length === 0 && t.label) {
    ...
    a(t.label, f) + n.labelPaddingX * 2 < f.er.minEntityWidth &&
      (t.width = f.er.minEntityWidth);
    let o = await Be(e, t, n);
    if (i != null && Nt.has(i)) {
  ...
  let C = e
      ...
      .attr(`class`, x)
      .attr(`id`, t.domId || t.id),
    w = await It(C, t.label ?? ``, f, 0, 0, [`name`], _);
  w.height += h;
  let D = 0,
    O = [],
    k = [],
  ...
  let z = Math.max(ee.width + m * 2, t?.width || 0, te),
    B = Math.max((ne ?? 0) + w.height, t?.height || 0),
    V = -z / 2,
    H = -B / 2;
  if (
    (C.selectAll(`g:not(:first-child)`).each((e, t, r) => {
      let i = n(r[t]),
        a = i.attr(`transform`),
        o = 0,
        s = 0;
      ...
      i.attr(
        `transform`,
        `translate(${V + m / 2 + o}, ${s + H + w.height + h / 2})`,
      );
    }),
    C.select(`.name`).attr(
      `transform`,
      `translate(` + -w.width / 2 + `, ` + (H + h / 2) + `)`,
    ),
    i != null && Nt.has(i))
  ) {
    let e = r.colorIndex ?? 0;
  ...
  if ((T(t, ie), b && t.look !== `handDrawn`))
    if (i != null && Pt.has(i)) C.selectAll(`path`).attr(`style`, b);
    else {
      let e = b
        .split(`;`)
      ...
      (C.selectAll(`path`).attr(`style`, e ?? ``),
        C.selectAll(`.row-rect-even path`).attr(`style`, b));
    }
  return (
    (t.intersect = function (e) {
      return W.rect(t, e);
...
t(Ft, `erBox`);
async function It(e, t, r, i = 0, o = 0, s = [], c = ``) {
  let d = e
    .insert(`g`)
    .attr(`class`, `label ${s.join(` `)}`)
    .attr(`transform`, `translate(${i}, ${o})`)
    .attr(`style`, c);
  t !== u(t) &&
    ((t = u(t)), (t = t.replaceAll(`<`, `&lt;`).replaceAll(`>`, `&gt;`)));
  let f = d
    .node()
    .appendChild(
      await m(
        d,
        t,
        { width: a(t, r) + 100, style: c, useHtmlLabels: r.htmlLabels },
        r,
      ),
    );
...
t(Rt, `textHelper`);
async function zt(e, i, o, c = []) {
  let u = e.insert(`g`).attr(`class`, `label`).attr(`style`, c.join(`; `)),
    f = p(),
    h = `useHtmlLabels` in i ? i.useHtmlLabels : (l(f.htmlLabels) ?? !0),
    g = ``;
  ((g = `text` in i ? i.text : i.label),
    !h && g.startsWith(`\\`) && (g = g.substring(1)),
    d(g) && (h = !0));
  let _ = await m(
      u,
      s(r(g)),
      { width: a(g, f) + 50, classes: `markdown-node-label`, useHtmlLabels: h },
      f,
    ),
    v,
    y = 1;
  if (h) {
    ...
    (c.includes(`font-weight: bolder`) &&
      n(_).selectAll(`tspan`).attr(`font-weight`, ``),
      (y = _.children.length));
    let e = _.children[0];
  ...
  return (
    u.attr(`transform`, `translate(0,` + (-v.height / (2 * y) + o) + `)`),
    v.height
  );
}
t(zt, `addText`);
async function Bt(e, t) {
  let r = c(),
    { themeVariables: i } = r,
    { useGradient: a } = i,
    o = r.class.padding ?? 12,
    s = o,
    u = t.useHtmlLabels ?? l(r.htmlLabels) ?? !0,
    d = t;
  ((d.annotations = d.annotations ?? []),
    (d.members = d.members ?? []),
    (d.methods = d.methods ?? []));
  let { shapeSvg: f, bbox: p } = await Rt(e, t, r, u, s),
    { labelStyles: m, nodeStyles: h } = y(t);
  ...
  let _ =
    ...
    x = v(t, {});
  t.look !== `handDrawn` && ((x.roughness = 0), (x.fillStyle = `solid`));
  let C = Math.max(t.width ?? 0, p.width),
    w = Math.max(t.height ?? 0, p.height),
    E = (t.height ?? 0) > p.height;
  d.members.length === 0 && d.methods.length === 0
    ? (w += s)
    : d.members.length > 0 && d.methods.length === 0 && (w += s * 2);
  let D = -C / 2,
    O = -w / 2,
    k = _ ? o * 2 : d.members.length === 0 && d.methods.length === 0 ? -o : 0;
  E && (k = o * 2);
  let A = b.rectangle(
      D - o,
      O -
        o -
        (_ ? o : d.members.length === 0 && d.methods.length === 0 ? -o / 2 : 0),
      C + 2 * o,
      w + 2 * o + k,
      x,
    ),
  ...
  let M = j.node().getBBox(),
    N =
      f.select(`.annotation-group`).node().getBBox().height - (_ ? o / 2 : 0) ||
      0,
    P = f.select(`.label-group`).node().getBBox().height - (_ ? o / 2 : 0) || 0,
    F =
      f.select(`.members-group`).node().getBBox().height - (_ ? o / 2 : 0) || 0,
    I =
      (N +
        P +
        O +
  ...
  if (
    ...
    let e = N + P + O + o,
      n = b.line(M.x, e, M.x + M.width, e + 0.001, x);
    f.insert(() => n)
  ...
  if (
    (d.look !== `handDrawn` && f.selectAll(`path`).attr(`style`, g),
    j.select(`:nth-child(2)`).attr(`style`, g),
    f.selectAll(`.divider`).select(`path`).attr(`style`, g),
    t.labelStyle
      ? f.selectAll(`span`).attr(`style`, t.labelStyle)
      : f.selectAll(`span`).attr(`style`, g),
    !u)
  ) {
...
async function Vt(e, t) {
  ...
  let a = t,
    ...
    l = E(t),
    { themeVariables: u } = c(),
    { borderColorArray: d, requirementEdgeLabelBackground: f } = u,
    p = e
      .insert(`g`)
      .attr(`class`, l)
      .attr(`id`, t.domId ?? t.id),
    m;
  m = s
    ? await $(p, `&lt;&lt;${a.type}&gt;&gt;`, 0, t.labelStyle)
    : await $(p, `&lt;&lt;Element&gt;&gt;`, 0, t.labelStyle);
  let h = m,
    g = await $(p, a.name, h, t.labelStyle + `; font-weight: bold;`);
  if (((h += g + 20), s)) {
    let e = await $(
      p,
    ...
    ((h += e),
      await $(p, `${o.docRef ? `Doc Ref: ${o.docRef}` : ``}`, h, t.labelStyle));
  }
  let _ = (p.node()?.getBBox().width ?? 200) + 20,
    b = (p.node()?.getBBox().height ?? 200) + 20,
    x = -_ / 2,
    C = -b / 2,
    w = S.svg(p),
    D = v(t, {});
  t.look !== `handDrawn` && ((D.roughness = 0), (D.fillStyle = `solid`));
  let O = w.rectangle(x, C, _, b, D),
    k = p.insert(() => O, `:first-child`);
  if (
    (k.attr(`class`, `basic label-container outer-path`).attr(`style`, i),
    d?.length)
  ) {
...
async function $(e, t, i, o = ``) {
  if (t === ``) return 0;
  let l = e.insert(`g`).attr(`class`, `label`).attr(`style`, o),
    u = c(),
    d = u.htmlLabels ?? !0,
    f = await m(
      l,
  ...
  return (
    l.attr(`transform`, `translate(${-p.width / 2},${-p.height / 2 + i})`),
    p.height
  );
}
t($, `addText`);
...
async function Ut(e, t, { config: n }) {
  ...
  let f = {
    ...
    m;
  d
    ? ({ label: p, bbox: m } = await w(d, (`ticket` in t && t.ticket) || ``, f))
    : ({ label: p, bbox: m } = await w(
        o,
        (`ticket` in t && t.ticket) || ``,
        f,
      ));
  let { label: h, bbox: g } = await w(
    o,
  ...
  t.width = a;
  let _ = t?.width || 0,
    b = Math.max(m.height, g.height) / 2,
    x = Math.max(s.height + 20, t?.height || 0) + b,
    D = -_ / 2,
    O = -x / 2;
  (c.attr(
    `transform`,
    `translate(` + (l - _ / 2) + `, ` + (-b - s.height / 2) + `)`,
  ),
    p.attr(
      `transform`,
      `translate(` + (l - _ / 2) + `, ` + (-b + s.height / 2) + `)`,
  ...
  if (t.look === `handDrawn`) {
    let e = S.svg(o),
      n = v(t, {}),
      r =
        A || j ? e.path(N(D, O, _, x, A || 0), n) : e.rectangle(D, O, _, x, n);
...
async function Wt(t, n) {
  let { labelStyles: r, nodeStyles: a } = y(n);
  n.labelStyle = r;
  let { shapeSvg: o, bbox: s, halfPadding: c, label: l } = await C(t, n, E(n)),
    u = s.width + 10 * c,
    d = s.height + 8 * c,
    f = 0.15 * u,
    { cssStyles: p } = n,
  ...
  if (n.look === `handDrawn`) {
    let e = S.svg(o),
      t = v(n, {}),
      r = e.path(x, t);
    ((b = o.insert(() => r, `:first-child`)),
      b.attr(`class`, `basic label-container`).attr(`style`, i(p)));
  } else
    b = o
      .insert(`path`, `:first-child`)
      .attr(`class`, `basic label-container`)
      ...
      .attr(`d`, x);
  return (
    b.attr(`transform`, `translate(${-g / 2}, ${-_ / 2})`),
    T(n, b),
    (n.calcIntersect = function (e, t) {
      return W.rect(e, t);
    }),
...
async function Gt(t, n) {
  ...
  if (n.look === `handDrawn`) {
    ...
    ((_ = o.insert(() => r, `:first-child`)),
      _.attr(`class`, `basic label-container`).attr(`style`, i(g)));
  } else
    _ = o
      .insert(`path`, `:first-child`)
      .attr(`class`, `basic label-container`)
  ...
  tn = t((t) => {
    ...
    return (
      t.clusterNode
        ...
        : n.attr(`transform`, `translate(` + t.x + `, ` + t.y + `)`),
      r
    );
  }, `positionNode`);
export {
...
//# sourceMappingURL=chunk-5FUZZQ4R-DJxxCeBl.js.map
