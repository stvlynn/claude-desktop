...
e(() => {
  ((t = `Codex Dark`),
    ...
    (i = [
      ...
      { scope: `comment markup.link`, settings: { foreground: `#999999` } },
      {
        scope: [`string`, `constant.other.symbol`],
        settings: { foreground: `#85df7b` },
      },
      {
        scope: [
      ...
      },
      {
        ...
        settings: { foreground: `#6DCBF4` },
      },
      { scope: `constant`, settings: { foreground: `#FA994C` } },
      {
        scope: `punctuation.definition.constant`,
        settings: { foreground: `#FA994C` },
      },
      { scope: `constant.language`, settings: { foreground: `#6DCBF4` } },
      { scope: `variable.other.constant`, settings: { foreground: `#FA994C` } },
      { scope: `keyword`, settings: { foreground: `#F67576` } },
      { scope: `keyword.control`, settings: { foreground: `#F67576` } },
      {
        scope: [`storage`, `storage.type`, `storage.modifier`],
        settings: { foreground: `#F67576` },
      },
      { scope: `token.storage`, settings: { foreground: `#F67576` } },
      {
        scope: [
      ...
      { scope: `keyword.operator.delete`, settings: { foreground: `#F67576` } },
      {
      ...
      { scope: `variable.language`, settings: { foreground: `#FA994C` } },
      {
        scope: `variable.parameter.function`,
        settings: { foreground: `#999999` },
      },
      { scope: `function.parameter`, settings: { foreground: `#999999` } },
      { scope: `variable.parameter`, settings: { foreground: `#999999` } },
      {
      ...
      },
      {
        ...
        settings: { foreground: `#B06DFF` },
      },
      {
        scope: `keyword.other.special-method`,
        settings: { foreground: `#B06DFF` },
      },
      { scope: `entity.name.function`, settings: { foreground: `#B06DFF` } },
      {
      ...
      { scope: `entity.name.namespace`, settings: { foreground: `#FA994C` } },
      ...
      { scope: `punctuation`, settings: { foreground: `#999999` } },
      {
      ...
      { scope: `punctuation.terminator`, settings: { foreground: `#999999` } },
      { scope: `meta.brace`, settings: { foreground: `#999999` } },
      { scope: `meta.brace.square`, settings: { foreground: `#999999` } },
      { scope: `meta.brace.round`, settings: { foreground: `#999999` } },
      { scope: `function.brace`, settings: { foreground: `#999999` } },
      {
        scope: [
      ...
      { scope: `keyword.operator.module`, settings: { foreground: `#F67576` } },
      {
      ...
      { scope: `support.constant.math`, settings: { foreground: `#FA994C` } },
      {
        scope: `support.constant.property.math`,
        settings: { foreground: `#FA994C` },
      },
      { scope: `support.constant.json`, settings: { foreground: `#FA994C` } },
      { scope: `support.type.object.dom`, settings: { foreground: `#6DCBF4` } },
      {
      ...
      { scope: `meta.property.object`, settings: { foreground: `#FA994C` } },
      {
      ...
      { scope: `variable.interpolation`, settings: { foreground: `#FA994C` } },
      {
        scope: [
      ...
      { scope: `support.type.primitive`, settings: { foreground: `#B06DFF` } },
      {
      ...
      { scope: `support.type.python`, settings: { foreground: `#6DCBF4` } },
      {
      ...
      { scope: `variable.language.rust`, settings: { foreground: `#F67576` } },
      {
      ...
      { scope: `variable.c`, settings: { foreground: `#999999` } },
      {
        scope: [
      ...
      { scope: `source.java`, settings: { foreground: `#F67576` } },
      {
        scope: [
      ...
      { scope: `meta.method.java`, settings: { foreground: `#B06DFF` } },
      {
        scope: [
      ...
      { scope: `import.storage.java`, settings: { foreground: `#FA994C` } },
      { scope: `token.package.keyword`, settings: { foreground: `#F67576` } },
      { scope: `token.package`, settings: { foreground: `#999999` } },
      { scope: `token.storage.type.java`, settings: { foreground: `#FA994C` } },
      {
      ...
      { scope: `entity.name.package.go`, settings: { foreground: `#FA994C` } },
      {
        scope: [
      ...
      { scope: `storage.type.haskell`, settings: { foreground: `#FA994C` } },
      { scope: `storage.type.cs`, settings: { foreground: `#FA994C` } },
      {
        scope: `entity.name.variable.local.cs`,
        settings: { foreground: `#F67576` },
      },
      { scope: `entity.name.label.cs`, settings: { foreground: `#FA994C` } },
      {
        scope: [
      ...
      { scope: `support.constant.edge`, settings: { foreground: `#F67576` } },
      {
        scope: `support.type.prelude.elm`,
        settings: { foreground: `#6DCBF4` },
      },
      { scope: `support.constant.elm`, settings: { foreground: `#FA994C` } },
      { scope: `entity.global.clojure`, settings: { foreground: `#FA994C` } },
      { scope: `meta.symbol.clojure`, settings: { foreground: `#F67576` } },
      {
      ...
      { scope: `meta.method.groovy`, settings: { foreground: `#B06DFF` } },
      {
      ...
      { scope: `source.makefile`, settings: { foreground: `#FA994C` } },
      { scope: `source.ini`, settings: { foreground: `#85df7b` } },
      {
      ...
      { scope: `entity.name.function.xi`, settings: { foreground: `#FA994C` } },
      { scope: `entity.name.class.xi`, settings: { foreground: `#6DCBF4` } },
      {
        scope: `constant.character.character-class.regexp.xi`,
        settings: { foreground: `#F67576` },
      },
      { scope: `constant.regexp.xi`, settings: { foreground: `#F67576` } },
      { scope: `keyword.control.xi`, settings: { foreground: `#6DCBF4` } },
      { scope: `invalid.xi`, settings: { foreground: `#999999` } },
      {
      ...
      { scope: `constant.character.xi`, settings: { foreground: `#B06DFF` } },
      { scope: `accent.xi`, settings: { foreground: `#B06DFF` } },
      { scope: `wikiword.xi`, settings: { foreground: `#FA994C` } },
      {
      ...
      },
      {
        ...
        settings: { foreground: `#6DCBF4`, fontStyle: `normal` },
      },
      {
        scope: `entity.other.attribute-name.id`,
        settings: { foreground: `#B06DFF`, fontStyle: `normal` },
      },
      {
        scope: [
      ...
      { scope: `meta.selector`, settings: { foreground: `#F67576` } },
      { scope: `selector.sass`, settings: { foreground: `#F67576` } },
      { scope: `rgb-value`, settings: { foreground: `#6DCBF4` } },
      {
        scope: `inline-color-decoration rgb-value`,
        settings: { foreground: `#FA994C` },
      },
      { scope: `less rgb-value`, settings: { foreground: `#FA994C` } },
      { scope: `control.elements`, settings: { foreground: `#FA994C` } },
      { scope: `keyword.operator.less`, settings: { foreground: `#FA994C` } },
      ...
      { scope: `meta.tag`, settings: { foreground: `#999999` } },
      {
        scope: `invalid.illegal.bad-ampersand.html`,
        settings: { foreground: `#999999` },
      },
      { scope: `markup.heading`, settings: { foreground: `#F67576` } },
      {
        scope: [
      ...
      { scope: `markup.heading.setext`, settings: { foreground: `#999999` } },
      {
        scope: [
      ...
      },
      {
        ...
        settings: { foreground: `#F67576`, fontStyle: `italic` },
      },
      { scope: `emphasis md`, settings: { foreground: `#F67576` } },
      ...
      { scope: `markup.quote.markdown`, settings: { foreground: `#999999` } },
      { scope: `keyword.other.unit`, settings: { foreground: `#F67576` } },
      { scope: `markup.changed.diff`, settings: { foreground: `#FA994C` } },
      {
        scope: [
      ...
      { scope: `markup.inserted.diff`, settings: { foreground: `#85df7b` } },
      { scope: `markup.deleted.diff`, settings: { foreground: `#F67576` } },
      { scope: `string.regexp`, settings: { foreground: `#3D8DFF` } },
      {
      ...
      { scope: `block.scope.end`, settings: { foreground: `#999999` } },
      { scope: `block.scope.begin`, settings: { foreground: `#999999` } },
      { scope: `token.info-token`, settings: { foreground: `#B06DFF` } },
      { scope: `token.warn-token`, settings: { foreground: `#FA994C` } },
      { scope: `token.error-token`, settings: { foreground: `#f44747` } },
      { scope: `token.debug-token`, settings: { foreground: `#F67576` } },
...
//# sourceMappingURL=codex-dark-Damjq4jC.js.map
