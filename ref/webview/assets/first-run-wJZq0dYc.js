...
import {
  n as z,
  t as B,
} from "./app-initial~app-main~first-run~new-thread-panel-page-BZcGQjmi.js";
import {
  i as V,
  n as ce,
  r as le,
...
function U() {
  ...
  e[0] !== u || e[1] !== n || e[2] !== t
    ? ((d = async () => {
        (await A(t, i.NUX_2025_09_15, !0),
          n === `2025-09-15-full-chatgpt-auth`
            ? await A(t, i.NUX_2025_09_15_FULL_CHATGPT_AUTH_VIEWED, !0)
            : n === `2025-09-15-apikey-auth` &&
              (await A(t, i.NUX_2025_09_15_APIKEY_AUTH_VIEWED, !0)),
          u(`/`));
      }),
      (e[0] = u),
      (e[1] = n),
  ...
  let f = d,
    p;
  return (
    e[4] !== s || e[5] !== l || e[6] !== c || e[7] !== f
      ? ((p = (0, X.jsx)(W, {
          initialStep: l,
          onAccept: f,
          hasCloudAccess: s,
          isUsingCopilotAuth: c,
        })),
        (e[4] = s),
        (e[5] = l),
        (e[6] = c),
...
function W(e) {
  ...
  t[21] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((M = { type: `spring`, duration: 0.6, bounce: 0 }), (t[21] = M))
    : (M = t[21]);
  let P;
  ...
  let K;
  t[58] !== F || t[59] !== G
    ? ((K = (0, X.jsxs)(ne, { transition: M, children: [F, G] })),
      (t[58] = F),
      (t[59] = G),
      (t[60] = K))
    : (K = t[60]);
        ...
        return n === `intro`
          ...
          : n === `cloud`
            ? (0, X.jsxs)(`div`, {
                ...
                children: [
                  (0, X.jsx)(L, { className: `size-8` }),
                  (0, X.jsxs)(`div`, {
                    className: `flex w-full items-center justify-between gap-4`,
                    children: [
                      (0, X.jsx)(h, { className: `size-4` }),
                      (0, X.jsxs)(`div`, {
...
//# sourceMappingURL=first-run-wJZq0dYc.js.map
