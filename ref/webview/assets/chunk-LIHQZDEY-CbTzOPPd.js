...
import {
  ...
  v as u,
  y as d,
} from "./chunk-K5T4RW27-B7ZoXjZA.js";
function f(e) {
...
function p(e = t) {
  let i = u(n(e), c),
    a = u(d({ shared: i }), r, v);
  return (i.ServiceRegistry.register(a), f(a), { shared: i, Treemap: a });
}
var m,
  h,
  g,
  ...
  y = e(() => {
    (a(),
      ...
      o(f, `registerValidationChecks`),
      (_ = class {
        static {
          o(this, `TreemapValidator`);
        }
        checkSingleRoot(e, t) {
          let n;
      ...
      (v = {
        parser: {
          ...
          ValueConverter: o(() => new g(), `ValueConverter`),
        },
        validation: { TreemapValidator: o(() => new _(), `TreemapValidator`) },
      }),
      o(p, `createTreemapServices`));
  });
export { p as n, y as r, v as t };
//# sourceMappingURL=chunk-LIHQZDEY-CbTzOPPd.js.map
