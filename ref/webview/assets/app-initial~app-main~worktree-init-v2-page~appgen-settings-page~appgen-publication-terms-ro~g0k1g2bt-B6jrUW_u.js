...
function je(e) {
  let t = n(c(e));
  return `${Ne}${encodeURI(t).replaceAll(`#`, `%23`).replaceAll(`?`, `%3F`)}`;
}
var Me,
  Ne,
  Pe = e(() => {
    ...
    if (u) {
      ...
      return (
        c[2] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((o = (0, X.createElement)(Fe(e, t, n, r, i, a))), (c[2] = o))
          : (o = c[2]),
        o
      );
    }
...
function ze({
  ...
  let s = (e) => {
    ...
    if (
      ...
      return { url: t, isCustomPath: !!i };
    let o = g(t),
      s = a(o);
    if (Ge.test(o) && !s) return { url: o, isCustomPath: !1 };
    let c = r(o),
      l = i && !c ? Be(o, i) : o;
    if (r(l)) {
      let e = window.location.protocol;
      return e === `http:` || e === `https:`
        ? { url: Ae(l), isCustomPath: !!i }
        : { url: ke(l), isCustomPath: !!i };
    }
    return { url: l, isCustomPath: !!i };
  };
  if (e === `large`) {
    let e = n || t || null;
    if (!e) return { url: null, useCurrentColorMask: !1 };
    let { url: r, isCustomPath: i } = s(e);
    return { url: r, useCurrentColorMask: !!r && i && Le(r) };
  }
  let c = o ? t || null : t || n || null;
  if (!c) return { url: null, useCurrentColorMask: !1 };
  let { url: l, isCustomPath: u } = s(c);
  return { url: l, useCurrentColorMask: !!l && u && Le(l) };
}
function Be(e, t) {
  let n = g(t).replace(/\/+$/, ``),
    r = n.lastIndexOf(`/`);
  return g(ae(r >= 0 ? n.slice(0, r) : ``, e.startsWith(`/`) ? e.slice(1) : e));
}
function J() {
  if (typeof document > `u`) return !1;
  let e = document.querySelector(Z);
...
var Y,
  ...
  qe = e(() => {
    ((Y = s()),
      ...
      ie(),
      (Ge = /^[a-zA-Z][a-zA-Z0-9+.-]*:/),
      (Z = `[data-codex-window-type="electron"]`),
      (Ke = {
        "gh-address-comments": H,
        "buildkite-fix-ci": L,
        "sentry-observability": K,
        "linear-implement-ticket": f,
        "figma-implement-design": O,
        "skill-creator": Ve,
      }));
  });
function Je({ label: e, path: t, plugins: n }) {
  let r = e.trim().toLowerCase();
  if (t != null && t.length > 0) {
    let e = n.find((e) => p(e.plugin.id) === t);
    if (e != null) return e;
  }
  return n.find(
    (e) =>
...
function et({ alias: e, plugin: t, description: n }) {
  return {
    kind: `plugin`,
    name: e.label,
    displayName: e.label,
...
function nt({ alias: e, mentionPath: t, mentionDisplayName: n, plugins: r }) {
  return (
    n === e.label && r.some((n) => e.isMentionPlugin(n) && t === p(n.plugin.id))
  );
}
function rt({ mentionPath: e, mentionDisplayName: t, plugins: n }) {
  return (
    it.find((r) =>
      nt({ alias: r, mentionPath: e, mentionDisplayName: t, plugins: n }),
    )?.label ?? null
  );
}
var Q,
...
//# sourceMappingURL=app-initial~app-main~worktree-init-v2-page~appgen-settings-page~appgen-publication-terms-ro~g0k1g2bt-B6jrUW_u.js.map
