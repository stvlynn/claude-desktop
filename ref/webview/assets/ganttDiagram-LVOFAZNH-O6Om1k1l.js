...
import { i as S, n as C, o as w, r as T } from "./chunk-AGHRB4JF-DIvkCYtW.js";
import {
  B as E,
  C as D,
  V as O,
...
import { i as ie, n as ae, r as oe, t as se } from "./src-BpCf56JJ.js";
import { t as ce } from "./dist-D71-f2X0.js";
import { g as le, u as ue } from "./chunk-S3R3BYOJ-BHdYahbs.js";
var de = n((e, t) => {
    (function (n, r) {
...
` +
    ...
    (bt = {
      ...
      renderer: {
        setConf: _t,
        draw: C(function (e, t, n, u) {
          let d = M().gantt,
            f = M().securityLevel,
            p;
          f === `sandbox` && (p = ae(`#i` + t));
          let h = ae(
              f === `sandbox` ? p.nodes()[0].contentDocument.body : `body`,
            ),
            g = f === `sandbox` ? p.nodes()[0].contentDocument : document,
            v = g.getElementById(t);
          (($ = v.parentElement.offsetWidth),
            $ === void 0 && ($ = 1200),
            d.useWidth !== void 0 && ($ = d.useWidth));
          let w = u.db.getTasks(),
            T = [];
          ...
          let E = {},
            D = 2 * d.topPadding;
          if (
            u.db.getDisplayMode() === `compact` ||
            d.displayMode === `compact`
          ) {
            let e = {};
            for (let t of w)
              e[t.section] === void 0
            ...
            for (let n of Object.keys(e)) {
              let r = yt(e[n], t) + 1;
              ((t += r), (D += r * (d.barHeight + d.barGap)), (E[n] = r));
            }
          } else {
            D += w.length * (d.barHeight + d.barGap);
            for (let e of T) E[e] = w.filter((t) => t.type === e).length;
          }
          v.setAttribute(`viewBox`, `0 0 ` + $ + ` ` + D);
          let O = h.select(`[id="${t}"]`),
            k = c()
              .domain([
                a(w, function (e) {
              ...
              .rangeRound([0, $ - d.leftPadding - d.rightPadding]);
          function A(e, t) {
            let n = e.startTime,
              r = t.startTime,
              i = 0;
          ...
          (C(A, `taskCompare`),
            w.sort(A),
            j(w, $, D),
            ee(O, D, $, d.useMaxWidth),
            O.append(`text`)
              .text(u.db.getDiagramTitle())
              .attr(`x`, $ / 2)
              .attr(`y`, d.titleTopMargin)
          ...
          function j(e, t, n) {
            let a = d.barHeight,
              ...
              l = r()
                ...
                .range([`#00B9FA`, `#F95002`])
                .interpolate(i);
            (re(o, s, c, t, n, e, u.db.getExcludes(), u.db.getIncludes()),
              se(c, s, t, n),
              te(e, o, s, c, a, l, t, n),
              ce(o, s, c, a, l),
              le(c, s, t, n));
          ...
          function te(e, n, r, i, a, o, s) {
            ...
            O.append(`g`)
              ...
              .attr(`width`, function () {
                return s - d.rightPadding / 2;
              })
              .attr(`height`, n)
              .attr(`class`, function (e) {
                for (let [t, n] of T.entries())
                  if (e.type === n)
                    return `section section` + (t % d.numberSectionStyles);
                return `section section0`;
              })
              .enter();
            let l = O.append(`g`).selectAll(`rect`).data(e).enter(),
              f = u.db.getLinks();
            if (
              (l
                .append(`rect`)
                ...
                .attr(`y`, function (e, t) {
                  return (
                    (t = e.order),
                    e.vert ? d.gridLineStartPadding : t * n + r
                  );
                })
                ...
                .attr(`height`, function (e) {
                  return e.vert
                    ? w.length * (d.barHeight + d.barGap) + d.barHeight * 2
                    : a;
                })
                ...
                .attr(`class`, function (e) {
                  ...
                  for (let [t, r] of T.entries())
                    e.type === r && (n = t % d.numberSectionStyles);
                  let r = ``;
                  return (
                    e.active
                      ? e.crit
              ...
              l
                ...
                .attr(`y`, function (e, t) {
                  return e.vert
                    ? d.gridLineStartPadding +
                        w.length * (d.barHeight + d.barGap) +
                        60
                    : ((t = e.order),
                      t * n + d.barHeight / 2 + (d.fontSize / 2 - 2) + r);
                })
                .attr(`text-height`, a)
                .attr(`class`, function (e) {
                  let t = k(e.startTime),
                  ...
                  let o = 0;
                  for (let [t, n] of T.entries())
                    e.type === n && (o = t % d.numberSectionStyles);
                  let c = ``;
                  return (
                    e.active &&
          ...
          function re(e, t, n, r, i, a, o, s) {
            if (o.length === 0 && s.length === 0) return;
            let c, l;
            for (let { startTime: e, endTime: t } of a)
              ((c === void 0 || e < c) && (c = e),
                (l === void 0 || t > l) && (l = t));
            if (!c || !l) return;
            if ((0, P.default)(l).diff((0, P.default)(c), `year`) > 5) {
              S.warn(
                `The difference between the min and max time is more than 5 years. This will cause performance issues. Skipping drawing exclude days.`,
              );
              return;
            }
            let f = u.db.getDateFormat(),
              p = [],
              m = null,
              h = (0, P.default)(c);
            for (; h.valueOf() <= l; )
              (u.db.isInvalidDate(h, f, o, s)
                ? m
                  ? (m.end = h)
                  : (m = { start: h, end: h })
                : (m &&= (p.push(m), null)),
            ...
            O.append(`g`)
              ...
              .attr(`y`, d.gridLineStartPadding)
              .attr(
                `width`,
                (e) => k(e.end.endOf(`day`)) - k(e.start.startOf(`day`)),
              )
              .attr(`height`, i - t - d.gridLineStartPadding)
          ...
          function se(e, t, n, r) {
            let i = u.db.getDateFormat(),
              a = u.db.getAxisFormat(),
              o;
            o = a || (i === `D` ? `%d` : (d.axisFormat ?? `%Y-%m-%d`));
            let c = oe(k)
                .tickSize(-r + t + d.gridLineStartPadding)
                .tickFormat(_(o)),
              f =
                /^([1-9]\d*)(millisecond|second|minute|hour|day|week|month)$/.exec(
                  u.db.getTickInterval() || d.tickInterval,
                );
            if (f !== null) {
              let e = f[1],
                t = f[2],
                n = u.db.getWeekday() || d.weekday;
              switch (t) {
                case `millisecond`:
                  c.ticks(b.every(e));
                  break;
            ...
            O.append(`g`)
              ...
              .append(function (e) {
                let t = e[0].split(ne.lineBreakRegex),
                  n = -(t.length - 1) / 2,
                  r = g.createElementNS(`http://www.w3.org/2000/svg`, `text`);
                r.setAttribute(`dy`, n + `em`);
                for (let [e, n] of t.entries()) {
                  let t = g.createElementNS(
              ...
              .attr(`font-size`, d.sectionFontSize)
              .attr(`class`, function (e) {
                for (let [t, n] of T.entries())
                  if (e[0] === n)
                    return (
                      `sectionTitle sectionTitle` + (t % d.numberSectionStyles)
                    );
                return `sectionTitle`;
              });
          }
          ...
          function le(e, t, n, r) {
            ...
            (s
              .attr(`x1`, k(o) + e)
              .attr(`x2`, k(o) + e)
              .attr(`y1`, d.titleTopMargin)
              .attr(`y2`, r - d.titleTopMargin)
              .attr(`class`, `today`),
...
//# sourceMappingURL=ganttDiagram-LVOFAZNH-O6Om1k1l.js.map
