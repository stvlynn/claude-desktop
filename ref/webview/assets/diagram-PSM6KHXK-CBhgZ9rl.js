...
import { a as r, n as i } from "./src-BhkLFyc4.js";
...
import { n as y, t as b } from "./src-CTe_6Jg1.js";
import { n as x, t as S } from "./chunk-EXTU4WIE-_aHv87Z4.js";
import { r as C, u as w } from "./chunk-S3R3BYOJ-BBYtiirL.js";
import { n as T, t as E } from "./chunk-4BX2VUAB-fqlOQUw2.js";
import { n as D, t as O } from "./mermaid-parser.core-C7uxoPQv.js";
import { n as k, t as A } from "./chunk-QN33PNHL-nPLgaaqy.js";
import { a as j, n as M, r as N } from "./chunk-ATLVNIR6-CqT90CcJ.js";
function P(e) {
  if (!e.length) return [];
  let t = [],
    n = [];
  ...
  (S(),
    ...
    (H = {
      draw: o((e, s, c, l) => {
        ...
        try {
          let e = d.valueFormat || `,`;
          if (e === `$0,0`) E = o((e) => `$` + t(`,`)(e), `valueFormat`);
          else if (e.startsWith(`$`) && e.includes(`,`)) {
            let n = /\.\d+/.exec(e),
              r = n ? n[0] : ``;
            E = o((e) => `$` + t(`,` + r)(e), `valueFormat`);
          } else if (e.startsWith(`$`)) {
            let n = e.substring(1);
            E = o((e) => `$` + t(n || ``)(e), `valueFormat`);
          } else E = t(e);
        } catch (e) {
          (a.error(`Error creating format function:`, e), (E = t(`,`)));
        }
        let D = n().range([
            `transparent`,
            g.cScale0,
...
export { W as diagram };
//# sourceMappingURL=diagram-PSM6KHXK-CBhgZ9rl.js.map
