...
import { $ as r, it as i } from "./runtime.worker-1YasDKq2.js";
import { t as a } from "./cytoscape.esm-CPPPPA7s.js";
var o = r((e, t) => {
    (function (n, r) {
        ...
        function (e, t, n) {
          ...
          function l() {
            (i.call(this),
              ...
              (this.springConstant = a.DEFAULT_SPRING_STRENGTH),
              (this.repulsionConstant = a.DEFAULT_REPULSION_STRENGTH),
            ...
            (l.prototype.calcIdealEdgeLengths = function () {
              for (
                var e,
                  ...
                  i,
                  s,
                  c = this.getGraphManager().getAllEdges(),
                  l = 0;
                l < c.length;
                l++
              )
                ((e = c[l]),
                  ...
                  e.isInterGraph &&
                    ((n = e.getSource()),
                    (r = e.getTarget()),
                    (i = e.getSourceInLca().getEstimatedSize()),
                    (s = e.getTargetInLca().getEstimatedSize()),
                    this.useSmartIdealEdgeLengthCalculation &&
                      (e.idealLength += i + s - 2 * o.SIMPLE_NODE_SIZE),
                    (t = e.getLca().getInclusionTreeDepth()),
                    (e.idealLength +=
                      a.DEFAULT_EDGE_LENGTH *
            ...
            (l.prototype.calcRepulsionForce = function (e, t) {
              ...
              if (n.intersects(r)) {
                ...
                t.getChild() == null
                  ...
                  (f = Math.sqrt(d)),
                  (p =
                    (this.repulsionConstant * e.noOfChildren * t.noOfChildren) /
                    d),
                  (m = (p * l) / f),
                  (h = (p * u) / f),
                  (e.repulsionForceX -= m),
      ...
      return (function (e) {
        ...
        function (e, t, n) {
          var r = n(0).FDLayout,
            ...
            s = n(2),
            c = n(1),
            l = n(0).FDLayoutConstants,
            u = n(0).LayoutConstants,
            d = n(0).Point,
            f = n(0).PointD,
            p = n(0).Layout,
            m = n(0).Integer,
          ...
          for (var y in ((v.prototype = Object.create(r.prototype)), r))
            v[y] = r[y];
          ((v.prototype.newGraphManager = function () {
              ...
              (r.prototype.initParameters.call(this, arguments),
                this.isSubLayout ||
                  ...
                  (this.maxCoolingCycle =
                    this.maxIterations / l.CONVERGENCE_CHECK_PERIOD),
                  (this.finalTemperature =
                    l.CONVERGENCE_CHECK_PERIOD / this.maxIterations),
                  (this.coolingAdjuster = 1)));
            }),
            (v.prototype.layout = function () {
              return (
                u.DEFAULT_CREATE_BENDS_AS_NEEDED &&
            ...
            (v.prototype.positionNodesRadially = function (e) {
              for (
                ...
                s % n == 0 &&
                  ...
                  (r = 0));
                var l = e[s],
                  m = p.findCenterOfTree(l);
                ((t.x = a),
                  (t.y = i),
                  (o = v.radialLayout(l, m, t)),
                  o.y > r && (r = Math.floor(o.y)),
                  (a = Math.floor(o.x + c.DEFAULT_COMPONENT_SEPERATION)));
              }
              this.transform(
                new f(u.WORLD_CENTER_X - o.x / 2, u.WORLD_CENTER_Y - o.y / 2),
              );
            }),
            ...
            (v.branchRadialLayout = function (e, t, n, r, i, a) {
              ...
              t != null && d--;
              for (
                var f = 0, p = u.length, m, g = e.getEdgesBetween(t);
                g.length > 1;
            ...
            (v.prototype.adjustLocations = function (e, t, n, r, i) {
              ...
              for (var a = t, o = 0; o < e.rows.length; o++) {
                ...
                for (var c = 0, l = 0; l < s.length; l++) {
                  ...
                  ((u.rect.x = t),
                    (u.rect.y = n),
                    (t += u.rect.width + e.horizontalPadding),
                    u.rect.height > c && (c = u.rect.height));
                }
            ...
            (v.prototype.tileNodes = function (e, t) {
              ...
              e.sort(function (e, t) {
                return e.rect.width * e.rect.height >
                  ...
                  ? -1
                  : e.rect.width * e.rect.height < t.rect.width * t.rect.height
                    ? 1
                    : 0;
              });
            ...
            (v.prototype.canAddHorizontal = function (e, t, n) {
              ...
              e.rowHeight[r] < n &&
                r > 0 &&
                (a = n + e.verticalPadding - e.rowHeight[r]);
              var o =
                e.width - i >= t + e.horizontalPadding
                  ? (e.height + a) / (i + t + e.horizontalPadding)
                  : (e.height + a) / e.width;
              a = n + e.verticalPadding;
              var s =
                e.width < t ? (e.height + a) / t : (e.height + a) / e.width;
                ...
                for (var a = 0; a < r.length; a++)
                  ((n = r[a]),
                    n.getEdges().length == 1 &&
                      ...
                      n.getChild() == null &&
                      (i.push([n, n.getEdges()[0], n.getOwner()]), (t = !0)));
                if (t == 1) {
                  for (var o = [], s = 0; s < i.length; s++)
                    i[s][0].getEdges().length == 1 &&
            ...
            (v.prototype.findPlaceforPrunedNode = function (e) {
              ...
              if (o > 0)
                for (var u = i; u <= a; u++)
                  c[0] +=
                    this.grid[u][o - 1].length + this.grid[u][o].length - 1;
              if (a < this.grid.length - 1)
                for (var u = o; u <= s; u++)
                  c[1] +=
                    this.grid[a + 1][u].length + this.grid[a][u].length - 1;
              if (s < this.grid[0].length - 1)
                for (var u = i; u <= a; u++)
                  c[2] +=
                    this.grid[u][s + 1].length + this.grid[u][s].length - 1;
              if (i > 0)
                for (var u = o; u <= s; u++)
                  c[3] +=
                    this.grid[i - 1][u].length + this.grid[i][u].length - 1;
              for (var d = m.MAX_VALUE, f, p, h = 0; h < c.length; h++)
                c[h] < d ? ((d = c[h]), (f = 1), (p = h)) : c[h] == d && f++;
              if (f == 3 && d == 0)
                c[0] == 0 && c[1] == 0 && c[2] == 0
                  ? (t = 1)
                  : c[0] == 0 && c[1] == 0 && c[3] == 0
      ...
      (function (n, r) {
        typeof e == `object` && typeof t == `object`
          ...
          : typeof define == `function` && define.amd
            ? define([`cose-base`], r)
            : typeof e == `object`
              ? (e.cytoscapeCoseBilkent = r(s()))
              : (n.cytoscapeCoseBilkent = r(n.coseBase));
      })(e, function (e) {
        return (function (e) {
          var t = {};
          function n(r) {
          ...
          function (e, t, n) {
            var r = n(0).layoutBase.LayoutConstants,
              ...
              o = n(0).CoSELayout,
              s = n(0).CoSENode,
              c = n(0).layoutBase.PointD,
              l = n(0).layoutBase.DimensionD,
              u = {
                ready: function () {},
                stop: function () {},
                quality: `default`,
            ...
            ((f.prototype.run = function () {
              ...
              ((this.root = a.addRoot()),
                this.processChildrenList(
                  this.root,
                  this.getTopMostNodes(s),
                  r,
                ));
              for (var l = 0; l < c.length; l++) {
                var u = c[l],
                  d = this.idToLNode[u.data(`source`)],
                  f = this.idToLNode[u.data(`target`)];
                ...
                h = function a() {
                  ...
                  if (c) {
                    (r.checkLayoutSuccess() &&
                      ...
                      i.options.eles.nodes().positions(m),
                      o(),
                  ...
                  (n.eles.nodes().positions(function (e, t) {
                    if ((typeof e == `number` && (e = t), !e.isParent())) {
                      for (
                        var n = e.id(), r = u[n], i = e;
                        r == null &&
                        ((r =
                          u[i.data(`parent`)] ||
                          u[`DummyCompound_` + i.data(`parent`)]),
                        (u[n] = r),
                        (i = i.parent()[0]),
                        i != null);
              ...
              (f.prototype.processChildrenList = function (e, t, n) {
                for (var r = t.length, i = 0; i < r; i++) {
                  var a = t[i],
                    o = a.children(),
                    u,
                    d = a.layoutDimensions({
                      nodeDimensionsIncludeLabels:
                        this.options.nodeDimensionsIncludeLabels,
                    });
                  if (
                    ((u =
                      a.outerWidth() != null && a.outerHeight() != null
                        ? e.add(
                            new s(
                              n.graphManager,
                              new c(
                              ...
                              new l(parseFloat(d.w), parseFloat(d.h)),
                            ),
                          )
                        : e.add(new s(this.graphManager))),
                    (u.id = a.data(`id`)),
                    (u.paddingLeft = parseInt(a.css(`padding`))),
                    (u.paddingTop = parseInt(a.css(`padding`))),
...
async function m(t, n) {
  ...
  try {
    ...
    let n = await d(t),
      ...
      i = p(n);
    return (
      e.debug(`Layout completed: ${r.length} nodes, ${i.length} edges`),
      { nodes: r, edges: i }
    );
  } catch (t) {
...
var g = t(
  async (
    ...
    let p = f.insert(`g`).attr(`class`, `subgraphs`),
      h = f.insert(`g`).attr(`class`, `edgePaths`),
...
export { g as render };
//# sourceMappingURL=cose-bilkent-S5V4N54A-yFxFJPDP.js.map
