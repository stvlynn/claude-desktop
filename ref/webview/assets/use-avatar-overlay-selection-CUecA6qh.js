...
import { i as u, r as d } from "./custom-avatars-query-tr8cLFBL.js";
import { n as f, t as p } from "./use-avatar-options-CMZnWjwp.js";
function m(e) {
...
function H() {
  let e = (0, U.c)(3),
    { avatarOptions: n, isFetching: r } = f(),
    { selectedAvatar: i, selectedAvatarId: a } = c(n),
    o = s(i, a),
    { isFetching: l } = t(u, a ?? i.id),
    d = o && (r || l) ? null : i,
    p;
  return (
    e[0] !== a || e[1] !== d
...
//# sourceMappingURL=use-avatar-overlay-selection-CUecA6qh.js.map
