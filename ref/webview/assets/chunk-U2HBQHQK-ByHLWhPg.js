...
import { i as r } from "./chunk-5PVQY5BW-VrOwugqI.js";
import {
  L as i,
  P as a,
  k as o,
...
const l = Object.freeze({ left: 0, top: 0, width: 16, height: 16 }),
  u = Object.freeze({ rotate: 0, vFlip: !1, hFlip: !1 }),
  d = Object.freeze({ ...l, ...u }),
  f = Object.freeze({ ...d, body: ``, hidden: !1 }),
  p = Object.freeze({ width: null, height: null }),
  m = Object.freeze({ ...p, ...u }),
  h = (e, t, n, r = ``) => {
    let i = e.split(`:`);
    if (e.slice(0, 1) === `@`) {
...
const de = (e) => e === `unset` || e === `undefined` || e === `none`;
function fe(e, t) {
  let n = { ...d, ...e },
    r = { ...m, ...t },
  ...
  [n, r].forEach((e) => {
    ...
    (o % 2 == 1 &&
      ...
      t.length && (a = ue(a, `<g transform="` + t.join(` `) + `">`, `</g>`)));
  });
  let o = r.width,
    s = r.height,
    c = i.width,
    ...
    f;
  o === null
    ? ((f = s === null ? `1em` : s === `auto` ? l : s), (u = se(f, c / l)))
    : ((u = o === `auto` ? c : o),
      (f = s === null ? se(u, l / c) : s === `auto` ? l : s));
  let p = {},
    h = (e, t) => {
      de(t) || (p[e] = t.toString());
    };
...
function ge(e, t = me) {
  let n = [],
    r;
  for (; (r = pe.exec(e)); ) n.push(r[1]);
  if (!n.length) return e;
  let i = `suffix` + ((Math.random() * 16777216) | Date.now()).toString(16);
  return (
    n.forEach((n) => {
      let r = typeof t == `function` ? t(n) : t + (he++).toString(),
        a = n.replace(/[.*+?^${}()|[\]\\]/g, `\\$&`);
      e = e.replace(
        RegExp(`([#;"])(` + a + `)([")]|\\.[a-z])`, `g`),
        `$1` + r + i + `$3`,
...
var x = {
  ...
  Oe = b(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/)
    .replace(/bull/g, C)
    .getRegex(),
  E = `address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul`,
  D = /<!--(?:-?>|[\s\S]*?(?:-->|$))/,
  ke = b(
  ...
  Re = /[^\s\p{P}\p{S}]/u,
  ze = b(/^((?![*_])punctSpace)/, `u`)
    .replace(/punctSpace/g, A)
    .getRegex(),
  Be = /(?!~)[\p{P}\p{S}]/u,
  Ve = /(?!~)[\s\p{P}\p{S}]/u,
  He = /(?:[^\s\p{P}\p{S}]|~)/u,
  Ue = b(/link|code|html/, `g`)
    .replace(
      `link`,
      /\[(?:[^\[\]`]|(?<!`)(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/,
    )
    ...
    .replace(`html`, /<(?! )[^<>]*?>/)
    .getRegex(),
  We = /^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,
  Ge = b(We, `u`).replace(/punct/g, k).getRegex(),
  Ke = b(We, `u`).replace(/punct/g, Be).getRegex(),
  qe = `^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)`,
  Je = b(qe, `gu`)
  ...
  rt = b(/^!?\[(ref)\](?:\[\])?/)
    .replace(`ref`, T)
    .getRegex(),
  it = b(`reflink|nolink(?!\\()`, `g`)
    .replace(`reflink`, nt)
    .replace(`nolink`, rt)
    .getRegex(),
  at = /[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,
  M = {
    _backpedal: y,
    anyPunctuation: Ze,
    autolink: Qe,
  ...
  P = { normal: O, gfm: Me, pedantic: Ne },
  F = { normal: M, gfm: N, breaks: st, pedantic: ot },
  ct = { "&": `&amp;`, "<": `&lt;`, ">": `&gt;`, '"': `&quot;`, "'": `&#39;` },
  lt = (e) => ct[e];
function I(e, t) {
  if (t) {
    if (x.escapeTest.test(e)) return e.replace(x.escapeReplace, lt);
  } else if (x.escapeTestNoEncode.test(e))
    return e.replace(x.escapeReplaceNoEncode, lt);
  return e;
}
function ut(e) {
  try {
...
`),
          ...
          let f = null,
            p;
          (this.options.gfm &&
            ((f = this.rules.other.listIsTask.exec(s)),
            f &&
              ((p = f[0] !== `[ ] `),
              (s = s.replace(this.rules.other.listReplaceTask, ``)))),
            i.items.push({
              type: `list_item`,
              raw: r,
              task: !!f,
...
`
  ...
  z = class e {
    ...
    constructor(e) {
      ...
      let t = { other: x, block: P.normal, inline: F.normal };
      (this.options.pedantic
        ? ((t.block = P.pedantic), (t.inline = F.pedantic))
        : this.options.gfm &&
          ((t.block = P.gfm),
          this.options.breaks ? (t.inline = F.breaks) : (t.inline = F.gfm)),
...
`,
    ...
    blockTokens(e, t = [], n = !1) {
      for (
        this.options.pedantic &&
        (e = e.replace(x.tabCharGlobal, `    `).replace(x.spaceLine, ``));
        e;
...
` + r.text),
  ...
  B = class {
    ...
    code({ text: e, lang: t, escaped: n }) {
      let r = (t || ``).match(x.notSpaceStart)?.[0],
        i =
          e.replace(x.endingNewline, ``) +
          `
`;
      return r
          ...
          if (e.hooks) {
            ...
            for (let n in e.hooks) {
              ...
              let r = n,
                i = e.hooks[r],
                a = t[r];
              U.passThroughHooks.has(n)
                ? (t[r] = (e) => {
                    if (
                      this.defaults.async &&
                      U.passThroughHooksRespectAsync.has(n)
                    )
                      return (async () => {
    ...
    parseMarkdown(e) {
      return (t, n) => {
        ...
        if ((i.hooks && ((i.hooks.options = i), (i.hooks.block = e)), i.async))
          return (async () => {
            let n = i.hooks ? await i.hooks.preprocess(t) : t,
              r = await (
                i.hooks ? await i.hooks.provideLexer() : e ? z.lex : z.lexInline
              )(n, i),
        ...
        try {
          ...
          let n = (i.hooks ? i.hooks.provideLexer() : e ? z.lex : z.lexInline)(
            t,
            i,
          );
          ...
          let r = (
            i.hooks ? i.hooks.provideParser() : e ? H.parse : H.parseInline
          )(n, i);
...
Please report this to https://github.com/markedjs/marked.`),
          ...
          let e =
            `<p>An error occurred:</p><pre>` + I(n.message + ``, !0) + `</pre>`;
...
var gt = {
  ...
  vt = t((t) => {
    for (let n of t) {
      ...
      if ((e.debug(`Registering icon pack:`, n.name), `loader` in n))
        _t.set(n.name, n.loader);
      else if (`icons` in n) K.set(n.name, n.icons);
      else
        throw (
          e.error(`Invalid icon loader:`, n),
          Error(
  ...
  xt = t(async (t, n, r) => {
    let a;
    try {
      a = await yt(t, n?.fallbackPrefix);
    } catch (t) {
      (e.error(t), (a = gt));
    }
    let o = fe(a, n);
    return i(_e(ge(o.body), { ...o.attributes, ...r }), c());
  }, `getIconSVG`);
function St(e, { markdownAutoWrap: t }) {
  return ht(
    e
      .replace(
        /<br\/>/g,
...
t(wt, `markdownToLines`);
function Tt(e) {
  return e ? `<p>${e.replace(/\\n|\n/g, `<br />`)}</p>` : ``;
}
t(Tt, `nonMarkdownToHTML`);
function Et(n, { markdownAutoWrap: r } = {}) {
  let i = G.lexer(n);
  function a(t) {
    return t.type === `text`
      ? r === !1
        ...
        : t.text.replace(/\n */g, `<br/>`)
      : t.type === `strong`
        ? `<strong>${t.tokens?.map(a).join(``)}</strong>`
        : t.type === `em`
          ? `<em>${t.tokens?.map(a).join(``)}</em>`
          : t.type === `paragraph`
            ? `<p>${t.tokens?.map(a).join(``)}</p>`
            : t.type === `space`
              ? ``
              : t.type === `html`
                ? `${t.text}`
                : t.type === `escape`
                  ? t.text
                  : (e.warn(`Unsupported markdown: ${t.type}`), t.raw);
  }
...
t(Dt, `splitTextToChars`);
function Ot(e, t) {
  return q(e, [], Dt(t.content), t.type);
}
t(Ot, `splitWordToFitWidth`);
function q(e, t, n, r) {
  if (n.length === 0)
    return [
...
t(Y, `applyStyle`);
var X = 16384;
async function At(e, t, n, r, l = !1, u = c()) {
  let d = e.append(`foreignObject`);
  (d.attr(`width`, `${Math.min(10 * n, X)}px`),
    d.attr(`height`, `${Math.min(10 * n, X)}px`));
...
`,
  ...
  (h.html(p),
    ...
    n !== 1 / 0 &&
      (f.style(`max-width`, n + `px`), f.style(`text-align`, `center`)),
...
t(jt, `computeWidthOfText`);
function Mt(e, t, n) {
  let r = e.append(`text`),
    i = Z(r, 1, t);
  $(i, [{ content: n, type: `normal` }]);
  let a = i.node()?.getBoundingClientRect();
  return (a && r.remove(), a);
}
t(Mt, `computeDimensionOfText`);
function Nt(e, n, r, i = !1, a = !1) {
  let o = 1.1,
    s = n.append(`g`),
    c = s
      .insert(`rect`)
  ...
  let u = 0;
  for (let n of r) {
    let r = t((t) => jt(s, o, t) <= e, `checkWidth`),
      i = r(n) ? [n] : kt(n, r);
    ...
    (e, r, a) => (
      n.push(
        (async () => {
          let n = `${r}:${a}`;
          return (await bt(n))
            ? await xt(n, void 0, { class: `label-icon` })
...
var Ft = t(
  async (
    ...
    if (
      (e.debug(`XYZ createText`, i, a, s, c, l, d, `addSvgBackground: `, p), l)
    ) {
      let e = await Pt(r(u ? Et(i, m) : Tt(i)), m),
        n = i.replace(/\\\\/g, `\\`);
      return await At(
        t,
        {
      ...
      let e = r(i.replace(/<br\s*\/?>/g, `<br/>`)),
        o = Nt(
          f,
          t,
          u ? wt(e.replace(`<br>`, `<br/>`), m) : Ct(e),
          i ? p : !1,
          !d,
        );
      if (d) {
        ...
        let t = a
          ...
          .replace(/fill:[^;]+;?/g, ``)
          .replace(/color:/g, `fill:`);
        n(o).select(`text`).attr(`style`, t);
      }
      return (
        s
          ? n(o).selectAll(`tspan.text-outer-tspan`).classed(`title-row`, !0)
          : n(o).selectAll(`tspan.text-outer-tspan`).classed(`row`, !0),
        o
      );
    }
  },
...
export { gt as a, vt as i, Ft as n, ht as o, xt as r, Mt as t };
//# sourceMappingURL=chunk-U2HBQHQK-ByHLWhPg.js.map
