...
import { C as r, S as i } from "./lodash-osfEN9vD.js";
import { c as a, l as o, t as s } from "./dist-Dcs2yc8m.js";
import { n as c, t as l } from "./src-CTe_6Jg1.js";
import { i as u, n as d, r as f } from "./chunk-AGHRB4JF-DVNPU_Qo.js";
import {
  A as p,
  D as m,
  R as h,
...
import { c as S, g as C, i as w, u as T } from "./chunk-5PVQY5BW-MckrTAit.js";
import { i as ee, n as E } from "./chunk-U2HBQHQK-BfxUGRAz.js";
import { n as D, t as O } from "./chunk-FMBD7UC4-DCr6uaVv.js";
import { n as te, r as k, t as A } from "./chunk-BSJP7CBP-CrJpo2xF.js";
import { n as ne, r as re, t as ie } from "./chunk-ZZ45TVLE-DzHSn4eK.js";
import { n as ae, t as oe } from "./graphlib-ichArG6F.js";
function se(e) {
  switch ((u.debug(`typeStr2Type`, e), e)) {
    case `[]`:
      return `square`;
    case `()`:
      return (u.debug(`we have a round`), `round`);
    case `(())`:
      return `circle`;
    case `>]`:
...
function j(e, t, n = 0, r = 0) {
  ...
  if (e.children?.length > 0) {
    ...
    for (let n of e.children) j(n, t, i, a);
    let s = e.columns ?? -1,
      c = 0;
    ...
    if (f < n) {
      ...
      let t = (n - l * G - G) / l,
        o = (r - d * G - G) / d;
      (u.debug(`Size indata abc88`, e.id, `childWidth`, t, `maxWidth`, i),
        u.debug(`Size indata abc88`, e.id, `childHeight`, o, `maxHeight`, a),
        u.debug(`Size indata abc88 xSize`, l, `padding`, G));
    ...
    if (
      (u.debug(
        `abc95 (finale calc) ${e.id} xSize ${l} ySize ${d} columns ${s}${e.children.length} width=${Math.max(f, e.size?.width || 0)}`,
      ),
      f < (e?.size?.width || 0))
    ) {
      f = e?.size?.width || 0;
      ...
      if (t > 0) {
        let n = (f - t * G - G) / t;
        u.debug(`abc95 (growing to fit) width`, e.id, f, e.size?.width, n);
...
function de(e, t) {
  ...
  if (
    ...
    {
      let e = 0,
        t = [...a.keys()].sort((e, t) => e - t);
      for (let n of t) (o.set(n, e), (e += (a.get(n) ?? 0) + G));
    }
    let s = 0;
    u.debug(`abc91 block?.size?.x`, e.id, e?.size?.x);
    let c = e?.size?.x ? e?.size?.x + (-e?.size?.width / 2 || 0) : -G,
      l = 0;
    for (let r of e.children) {
      let i = e;
      if (!r.size) continue;
      let { width: d, height: f } = r.size,
        { px: p, py: m } = ue(n, s);
      if (
        (m != l &&
          ((l = m),
          (c = e?.size?.x ? e?.size?.x + (-e?.size?.width / 2 || 0) : -G),
          u.debug(`New row in layout for block`, e.id, ` and child `, r.id, l)),
        u.debug(
          `abc89 layout blocks (child) id: ${r.id} Pos: ${s} (px, py) ${p},${m} (${i?.size?.x},${i?.size?.y}) parent: ${i.id} width: ${d}${G}`,
        ),
        i.size)
      ) {
        let e = d / 2;
        ((r.size.x = c + G + e),
          u.debug(
            `abc91 layout blocks (calc) px, pyid:${r.id} startingPos=X${c} new startingPosX${r.size.x} ${e} padding=${G} width=${d} halfWidth=${e} => x:${r.size.x} y:${r.size.y} ${r.widthInColumns} (width * (child?.w || 1)) / 2 ${(d * (r?.widthInColumns ?? 1)) / 2}`,
          ),
          (c = r.size.x + e));
        let t = o.get(m) ?? 0,
          n = a.get(m) ?? f;
        ((r.size.y = i.size.y - i.size.height / 2 + t + n / 2 + G),
          u.debug(
            `abc88 layout blocks (calc) px, pyid:${r.id}startingPosX${c}${G}${e}=>x:${r.size.x}y:${r.size.y}${r.widthInColumns}(width * (child?.w || 1)) / 2${(d * (r?.widthInColumns ?? 1)) / 2}`,
          ));
      }
      r.children && de(r, t);
      let h = r?.widthInColumns ?? 1;
      (n > 0 && (h = Math.min(h, n - (s % n))),
        (s += h),
        u.debug(`abc88 columnsPos`, r, s));
    }
  }
  u.debug(
  ...
  if (e.children)
    for (let a of e.children)
      ({
        ...
        maxX: r,
        maxY: i,
      } = fe(a, { minX: t, minY: n, maxX: r, maxY: i }));
  return { minX: t, minY: n, maxX: r, maxY: i };
}
function pe(e) {
  let t = e.getBlock(`root`);
  if (!t) return;
  (j(t, e, 0, 0), de(t, e), u.debug(`getBlocks`, JSON.stringify(t, null, 2)));
  let { minX: n, minY: r, maxX: i, maxY: a } = fe(t),
    o = a - r;
...
function P(e, t, n, r) {
  ...
  (t.includes(`t`) ? (u.debug(`add top border`), a(n)) : o(n),
    t.includes(`r`) ? (u.debug(`add right border`), a(r)) : o(r),
    t.includes(`b`) ? (u.debug(`add bottom border`), a(n)) : o(n),
    t.includes(`l`) ? (u.debug(`add left border`), a(r)) : o(r),
...
function be(e, t, n = !1) {
  ...
  return {
    ...
    intersect: void 0,
    type: r.type,
    padding: s ?? x()?.block?.padding ?? 0,
  };
}
async function xe(e, t, n) {
  let r = be(t, n, !1);
  if (r.type === `group`) return;
  let i = await jt(e, r, { config: x() }),
    a = i.node().getBBox(),
    o = n.getBlock(r.id);
...
async function Se(e, t, n) {
  ...
  n.getBlock(r.id).type !== `space` &&
    (await jt(e, r, { config: x() }), (t.intersect = r?.intersect), Mt(r));
}
...
async function Te(e, t, n, r, i) {
  let a = new ae({ multigraph: !0, compound: !0 });
  a.setGraph({
    rankdir: `TB`,
    nodesep: 10,
    ranksep: 10,
  ...
  (D(),
    ...
    (I = (function () {
      var e = d(function (e, t, n, r) {
        ...
        c = [1, 18],
        l = [8, 30],
        u = [8, 10, 21, 28, 29, 30, 31, 39, 43, 46],
        f = [1, 23],
        p = [1, 24],
        ...
        _ = {
          ...
          performAction: d(function (e, t, n, r, i, a, o) {
            var s = a.length - 1;
            switch (i) {
              case 4:
              ...
              switch (T[0]) {
                ...
                case 2:
                  ...
                  (O &&
                    ...
                    i.push(E.$),
                    a.push(E._$),
                    (te = o[n[n.length - 2]][n[n.length - 1]]),
                    n.push(te));
                  break;
                case 3:
                  return !0;
...
` +
          ...
          options: {},
          performAction: d(function (e, t, n, r) {
            switch (n) {
              case 0:
      ...
      return (d(v, `Parser`), (v.prototype = _), (_.Parser = v), new v());
    })()),
    (I.parser = I),
    (Ee = I),
    (L = new Map()),
    ...
    (B = new Map()),
    (V = ``),
    (Me = d((e) => y.sanitizeText(e, je), `sanitizeText`)),
    (Ne = d(function (e, t = ``) {
      let n = B.get(e);
      (n || ((n = { id: e, styles: [], textStyles: [] }), B.set(e, n)),
        t?.split(Ae).forEach((e) => {
          let t = e.replace(/([^;]*);/, `$1`).trim();
          if (RegExp(De).exec(e)) {
            let e = t.replace(Oe, ke).replace(De, Oe);
            n.textStyles.push(e);
          }
          n.styles.push(t);
        }));
      ...
      for (let e of n) {
        ...
        if (e.type === `column-setting`) t.columns = e.columns ?? -1;
          ...
          if (
            ...
            for (let n = 0; n < t; n++) {
              let t = i(e);
              ((t.id = t.id + `-` + n), L.set(t.id, t), r.push(t));
            }
    ...
    d(se, `typeStr2Type`),
    d(ce, `edgeTypeStr2Type`),
    d(le, `edgeStrToEdgeData`),
    (Re = 0),
    (ze = {
      getConfig: d(() => x().block, `getConfig`),
      typeStr2Type: se,
      edgeTypeStr2Type: ce,
      edgeStrToEdgeData: le,
      getLogger: d(() => u, `getLogger`),
      getBlocksFlat: d(() => [...L.values()], `getBlocksFlat`),
      getBlocks: d(() => H || [], `getBlocks`),
      getEdges: d(() => R, `getEdges`),
      setHierarchy: d((e) => {
        ((U.children = e), Ie(e, U), (H = U.children));
      }, `setHierarchy`),
      getBlock: d((e) => L.get(e), `getBlock`),
      setBlock: d((e) => {
        L.set(e.id, e);
      }, `setBlock`),
      getColumns: d((e) => {
...
`,
    ...
    (We = d((e) => {
      ...
      for (let r of e.children) {
        ...
        (u.debug(
          ...
          r.type !== `space` &&
            (e > t && (t = e / (r.widthInColumns ?? 1)), i > n && (n = i)));
      }
    ...
    (Je = d(async (e, t) => {
      let n = _(),
        r = b(n),
        i = e.insert(`g`).attr(`class`, `edgeLabel`),
        a = i.insert(`g`).attr(`class`, `label`),
      ...
      if (r) {
        ...
        let e = c(s).select(`text`).node();
        e && typeof e.getBBox == `function` && (u = e.getBBox());
      }
      (a.attr(`transform`, A(u, r)),
        (q[t.id] = i),
        (t.width = l.width),
        (t.height = l.height));
      let d;
      if (t.startLabelLeft) {
        let n = e.insert(`g`).attr(`class`, `edgeTerminals`),
          ...
          a = await K(i, t.startLabelLeft, t.labelStyle);
        d = a;
        let o = a.getBBox();
        if (r) {
          let e = a.children[0],
        ...
        (i.attr(`transform`, A(o, r)),
          J[t.id] || (J[t.id] = {}),
          (J[t.id].startLeft = n),
          M(d, t.startLabelLeft));
      }
      if (t.startLabelRight) {
        let n = e.insert(`g`).attr(`class`, `edgeTerminals`),
          i = n.insert(`g`).attr(`class`, `inner`),
          a = await K(n, t.startLabelRight, t.labelStyle);
        ...
        (i.attr(`transform`, A(o, r)),
          J[t.id] || (J[t.id] = {}),
          (J[t.id].startRight = n),
          M(d, t.startLabelRight));
      }
      if (t.endLabelLeft) {
        let n = e.insert(`g`).attr(`class`, `edgeTerminals`),
          i = n.insert(`g`).attr(`class`, `inner`),
          a = await K(i, t.endLabelLeft, t.labelStyle);
        d = a;
        let o = a.getBBox();
        if (r) {
          let e = a.children[0],
      ...
      if (t.endLabelRight) {
        let n = e.insert(`g`).attr(`class`, `edgeTerminals`),
          i = n.insert(`g`).attr(`class`, `inner`),
          a = await K(i, t.endLabelRight, t.labelStyle);
        d = a;
        let o = a.getBBox();
        if (r) {
          let e = a.children[0],
    ...
    d(M, `setTerminalWidth`),
    (Ye = d((e, t) => {
      u.debug(`Moving label abc88 `, e.id, e.label, q[e.id], t);
      let n = t.updatedPath ? t.updatedPath : t.originalPath,
        { subGraphTitleTotalMargin: r } = ne(_());
      if (e.label) {
        let i = q[e.id],
          a = e.x,
          o = e.y;
  ...
  node        : x:${e.x} y:${e.y} w:${e.width} h:${e.height}`);
      ...
      if (Math.abs(i - t.y) * o > Math.abs(r - t.x) * c) {
        ...
        return (
          ...
          d === 0 && (r.x = t.x),
          l === 0 && (r.y = t.y),
          u.debug(`abc89 topp/bott calc, Q ${l}, q ${e}, R ${d}, r ${s}`, r),
          r
        );
      } else {
    ...
    (Qe = d((e, t) => {
      u.debug(`abc88 cutPathAtIntersect`, e, t);
      let n = [],
        r = e[0],
        i = !1;
      return (
    ...
    ($e = d(function (e, r, i, a, o, s, c) {
      let l = i.points;
      u.debug(`abc88 InsertEdge: edge=`, i, `e=`, r);
      let d = !1,
        f = s.node(r.v);
      var p = s.node(r.w);
      (p?.intersect &&
        f?.intersect &&
        ((l = l.slice(1, i.points.length - 1)),
        l.unshift(f.intersect(l[0])),
        l.push(p.intersect(l[l.length - 1]))),
        i.toCluster &&
          (u.debug(`to cluster abc88`, a[i.toCluster]),
          (l = Qe(i.points, a[i.toCluster].node)),
          (d = !0)),
        i.fromCluster &&
          (u.debug(`from cluster abc88`, a[i.fromCluster]),
          (l = Qe(l.reverse(), a[i.fromCluster].node).reverse()),
          (d = !0)));
      let h = l.filter((e) => !Number.isNaN(e.y)),
        g = n;
    ...
    d(me, `intersectNode`),
    (nt = me),
    d(he, `intersectEllipse`),
    (rt = he),
    d(ge, `intersectCircle`),
    (it = ge),
    d(_e, `intersectLine`),
    d(ve, `sameSign`),
    (at = _e),
    (ot = ye),
    d(ye, `intersectPolygon`),
    (Y = {
      node: nt,
      circle: it,
      ellipse: rt,
    ...
    (X = d(async (e, t, n, r) => {
      let i = _(),
        a,
        o = t.useHtmlLabels || b(i);
      a = n || `node default`;
      let s = e
          .insert(`g`)
          .attr(`class`, a)
          .attr(`id`, t.domId || t.id),
        l = s.insert(`g`).attr(`class`, `label`).attr(`style`, t.labelStyle),
        u;
      u =
        t.labelText === void 0
          ? ``
      ...
      d =
        t.labelType === `markdown`
          ...
          : await K(l, h(w(u), i), t.labelStyle, !1, r);
      let f = d.getBBox(),
        p = t.padding / 2;
      if (b(i)) {
        let e = d.children[0],
      ...
      return (
        o
          ...
          : l.attr(`transform`, `translate(0, ` + -f.height / 2 + `)`),
        t.centerLabel &&
          l.attr(
            `transform`,
            `translate(` + -f.width / 2 + `, ` + -f.height / 2 + `)`,
        ...
        { shapeSvg: s, bbox: f, halfPadding: p, label: l }
      );
    }, `labelHelper`)),
    (Z = d((e, t) => {
    ...
    d(N, `insertPolygonShape`),
    (st = d(async (e, t) => {
      t.useHtmlLabels || b(_()) || (t.centerLabel = !0);
      let {
        shapeSvg: n,
        bbox: r,
        halfPadding: i,
    ...
    (lt = d(async (e, t) => {
      ...
      return (
        ...
        Z(t, o),
        (t.intersect = function (e) {
          return (u.warn(`Intersect called`), Y.polygon(t, a, e));
        }),
        n
      );
    }, `question`)),
    ...
    (bt = d(async (e, t) => {
      let {
        ...
        l = t.positioned ? -s / 2 : -r.height / 2 - i;
      if (
        (a
        ...
        (t.props.borders && (P(a, t.props.borders, o, s), e.delete(`borders`)),
          e.forEach((e) => {
            u.warn(`Unknown node property ${e}`);
          }));
      }
      return (
        Z(t, a),
    ...
    (Ct = d(async (e, t) => {
      ...
      let r = e
        ...
        a = r.insert(`line`),
        o = r.insert(`g`).attr(`class`, `label`),
        s = t.labelText.flat ? t.labelText.flat() : t.labelText,
        l = ``;
      ((l = typeof s == `object` ? s[0] : s),
        u.info(`Label text abc79`, l, s, typeof s == `object`));
      let d = await K(o, l, t.labelStyle, !0, !0),
        f = { width: 0, height: 0 };
      if (b(_())) {
        let e = d.children[0],
          t = c(d);
      ...
      u.info(`Text 2`, s);
      let p = s.slice(1, s.length),
        m = d.getBBox(),
        h = await K(o, p.join ? p.join(`<br/>`) : p, t.labelStyle, !0, !0);
      if (b(_())) {
        let e = h.children[0],
          t = c(h);
        ((f = e.getBoundingClientRect()),
      ...
      return (
        ...
        a
          ...
          .attr(`x1`, -f.width / 2 - g)
          .attr(`x2`, f.width / 2 + g)
          .attr(`y1`, -f.height / 2 - g + m.height + g)
          .attr(`y2`, -f.height / 2 - g + m.height + g),
        Z(t, i),
        (t.intersect = function (e) {
          return Y.rect(t, e);
        }),
    ...
    (Tt = d(async (e, t) => {
      ...
      return (
        ...
        (t.intersect = function (e) {
          return (
            u.info(`Circle intersect`, t, r.width / 2 + i, e),
    ...
    (Et = d(async (e, t) => {
      ...
      return (
        ...
        s
          ...
          .attr(`width`, r.width + t.padding)
          .attr(`height`, r.height + t.padding),
        u.info(`DoubleCircle main`),
        Z(t, o),
        (t.intersect = function (e) {
          return (
            u.info(`DoubleCircle intersect`, t, r.width / 2 + i + 5, e),
      ...
      class_box: d(async (e, t) => {
        ...
        t.classData.type !== void 0 &&
          ...
          (b(_())
            ? (g += `&lt;` + t.classData.type + `&gt;`)
            : (g += `<` + t.classData.type + `>`));
        let v = await K(d, g, t.labelStyle, !0, !0);
        c(v).attr(`class`, `classTitle`);
        let y = v.getBBox();
        if (b(_())) {
          let e = v.children[0],
            t = c(v);
        ...
        ((u += y.height + 4), y.width > l && (l = y.width));
        let x = [];
        (t.classData.members.forEach(async (e) => {
          let n = e.getDisplayDetails(),
            r = n.displayText;
          b(_()) && (r = r.replace(/</g, `&lt;`).replace(/>/g, `&gt;`));
          let i = await K(d, r, n.cssStyle ? n.cssStyle : t.labelStyle, !0, !0),
            a = i.getBBox();
          if (b(_())) {
            let e = i.children[0],
              t = c(i);
          ...
          (a.width > l && (l = a.width), (u += a.height + 4), x.push(i));
        }),
          (u += 8));
        let S = [];
        if (
          (t.classData.methods.forEach(async (e) => {
            ...
            let i = await K(
                d,
                r,
                n.cssStyle ? n.cssStyle : t.labelStyle,
                !0,
                !0,
              ),
              a = i.getBBox();
    ...
    d(be, `getNodeFromBlock`),
    d(xe, `calculateBlockSize`),
    d(Se, `insertBlockPositioned`),
    d(F, `performOperations`),
    d(Ce, `calculateBlockSizes`),
    d(we, `insertBlocks`),
    d(Te, `insertEdges`),
    (Nt = {
      parser: Ee,
      db: ze,
      renderer: {
        draw: d(async function (e, t, n, r) {
          let { securityLevel: i, block: a } = x(),
            o = r.db;
          o.setDiagramId(t);
          let s;
          i === `sandbox` && (s = c(`#i` + t));
          let l = c(
              i === `sandbox` ? s.nodes()[0].contentDocument.body : `body`,
            ),
            d = i === `sandbox` ? l.select(`[id="${t}"]`) : c(`[id="${t}"]`);
          Ue(d, [`point`, `circle`, `cross`], r.type, t);
          let f = o.getBlocks(),
            p = o.getBlocksFlat(),
            m = o.getEdges(),
          ...
          await Ce(h, f, o);
          let g = pe(o);
          if ((await we(h, f, o), await Te(h, m, p, o, t), g)) {
            let e = g,
...
//# sourceMappingURL=blockDiagram-DXYQGD6D-B8DDITsf.js.map
