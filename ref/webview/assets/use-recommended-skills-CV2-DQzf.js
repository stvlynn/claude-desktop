...
function m(e) {
  ...
  t[0] === r
    ? (_ = t[1])
    : ((_ = n(`recommended-skills`, { hostId: r, refresh: !1 })),
      (t[0] = r),
      (t[1] = _));
  let v = _,
    y;
  ...
  t[4] === o
    ? (b = t[5])
    : ((b = { enabled: o, staleTime: l.FIVE_MINUTES }), (t[4] = o), (t[5] = b));
  let x;
  t[6] !== y || t[7] !== b
    ? ((x = { params: y, queryConfig: b }), (t[6] = y), (t[7] = b), (t[8] = x))
    : (x = t[8]);
  let S = c(`recommended-skills`, x),
    C = S.data?.error ?? (S.error ? String(S.error.message ?? S.error) : null),
    w = u(`install-recommended-skill`),
    T;
  t[9] !== r || t[10] !== d || t[11] !== v
    ? ((T = async () => {
        let e = await s(`recommended-skills`, {
  ...
  t[13] !== r || t[14] !== S.data?.skills || t[15] !== d || t[16] !== v
    ? ((O = async (e) => {
        ...
        if (t) return t;
        let n = await s(`recommended-skills`, {
...
//# sourceMappingURL=use-recommended-skills-CV2-DQzf.js.map
