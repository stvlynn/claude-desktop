...
import { a as i, o as a, s as o, t as s } from "./dist-Dcs2yc8m.js";
import {
  K as c,
  L as l,
  b as u,
...
import { n as p, t as m } from "./chunk-EXTU4WIE-_aHv87Z4.js";
import { u as h } from "./chunk-S3R3BYOJ-BBYtiirL.js";
import { i as g } from "./chunk-JA3XYJ7Z-DXPUiutJ.js";
import { n as _, t as v } from "./chunk-FMBD7UC4-Cl8oprFb.js";
import { n as y } from "./chunk-CVBHYZKI-CCA47Th3.js";
import { n as b } from "./chunk-ATLVNIR6-CqT90CcJ.js";
import { a as x, i as S, l as C, o as w } from "./chunk-JZLCHNYA-BB0008aK.js";
import { n as T, r as E, t as D } from "./chunk-MI3HLSF2-lTgkCAOX.js";
...
` +
    ...
    (B = {
      ...
      getType: n((e, n) => {
        switch ((t.debug(`In get type`, e, n), e)) {
          case `[`:
            return z.RECT;
          case `(`:
            return n === `)` ? z.ROUNDED_RECT : z.CLOUD;
          case `((`:
            return z.CIRCLE;
          case `)`:
            return z.CLOUD;
      ...
      getLogger: n(() => t, `getLogger`),
      getElementById: n((e) => N[e], `getElementById`),
    }),
    (V = {
      draw: n(async (e, n, r, i) => {
        t.debug(
...
` + e,
        ...
        let f = s.append(`g`);
        f.attr(`class`, `items`);
        let m = a.nodes.filter((e) => e.isGroup),
          h = 0,
          g = [],
          _ = 25;
        for (let e of m) {
        ...
        for (let e of m) {
          ...
          let n = o?.kanban?.sectionWidth || 200,
            r = (-n * 3) / 2 + _,
            i = r,
            s = a.nodes.filter((t) => t.parentId === e.id);
          for (let t of s) {
            if (t.isGroup)
              throw Error(
            ...
            let r = (await w(f, t, { config: o })).node().getBBox();
            ((t.y = i + r.height / 2),
              await C(t),
              (i = t.y + r.height / 2 + 10 / 2));
          }
          let c = t.cluster.select(`rect`),
            l = Math.max(i - r + 30, 50) + (_ - 25);
          c.attr(`height`, l);
        }
        c(
          void 0,
    ...
    (H = n((e) => {
      ...
      let r = n((t, n) => (e.darkMode ? i(t, n) : a(t, n)), `adjuster`);
...
export { U as diagram };
//# sourceMappingURL=kanban-definition-3W4ZIXB7-CDDyRlIL.js.map
