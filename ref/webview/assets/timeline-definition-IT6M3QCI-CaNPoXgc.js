...
import { i as n, n as r, r as i, t as a } from "./chunk-AGHRB4JF-DJZonIPK.js";
import { a as o, o as s, s as c, t as l } from "./dist-Dcs2yc8m.js";
import {
  K as u,
  a as d,
  b as f,
  ...
  e.each(function () {
    ...
    for (let s = 0; s < n.length; s++)
      ((r = n[n.length - 1 - s]),
        i.push(r),
        c.text(i.join(` `).trim()),
        (c.node().getComputedTextLength() > t || r === `<br>`) &&
          (i.pop(),
          c.text(i.join(` `).trim()),
          (i = r === `<br>` ? [``] : [r]),
          (c = e
...
` +
      ...
      return (r(d, `Parser`), (d.prototype = u), (u.Parser = d), new d());
    })()),
    (v.parser = v),
    (y = v),
    (b = {}),
    ...
    (E = r(() => m, `getCommonDb`)),
    (D = r(function () {
      ((C.length = 0), (w.length = 0), (x = ``), (T.length = 0), d());
    }, `clear`)),
    (O = r(function (e) {
      ((x = e), C.push(e));
    }, `addSection`)),
    ...
    (M = r(function (e) {
      T.find((e) => e.id === S - 1).events.push(e);
    }, `addEvent`)),
    (N = r(function (e) {
      let t = { section: x, type: x, description: e, task: e, classes: [] };
      w.push(t);
    }, `addTaskOrg`)),
    (P = r(function () {
      let e = r(function (e) {
        ...
        t = !0;
      for (let [n, r] of T.entries()) (e(n), (t &&= r.processed));
      return t;
    }, `compileTasks`)),
    (F = {
      clear: D,
    ...
    (X = r(function (e, t, n, r) {
      ...
      let o = a.append(`g`),
        ...
        c = s
          ...
          .node()
          .getBBox(),
        l = r.fontSize?.replace ? r.fontSize.replace(`px`, ``) : r.fontSize;
      return (
        (t.height = c.height + l * 1.1 * 0.5 + t.padding),
    ...
    (Q = {
      ...
      drawLabel: V,
      drawTask: W,
      drawBackgroundRect: G,
      getTextObj: K,
      getNoteRect: q,
      initGraphics: Y,
      drawNode: X,
      getVirtualNodeHeight: Z,
    }),
    (te = r(function (e, t, r, i) {
      let a = f(),
        o = a.timeline?.leftMargin ?? 50;
      n.debug(`timeline`, i.db);
      let s = a.securityLevel,
        c;
      s === `sandbox` && (c = h(`#i` + t));
      let l = h(
        s === `sandbox` ? c.nodes()[0].contentDocument.body : `body`,
      ).select(`#` + t);
      l.append(`g`);
      let d = i.db.getTasks(),
        p = i.db.getCommonDb().getDiagramTitle();
      (n.debug(`task`, d), Q.initGraphics(l));
      let m = i.db.getSections();
      n.debug(`sections`, m);
      let g = 0,
        _ = 0,
        v = 0,
      ...
      m.forEach(function (e) {
        let t = {
          ...
          r = Q.getVirtualNodeHeight(l, t, a);
        (n.debug(`sectionHeight before draw`, r), (g = Math.max(g, r + 20)));
      });
      let w = 0,
        T = 0;
      n.debug(`tasks.length`, d.length);
      for (let [e, t] of d.entries()) {
        let r = {
          ...
          i = Q.getVirtualNodeHeight(l, r, a);
        (n.debug(`taskHeight before draw`, i),
          (_ = Math.max(_, i + 20)),
          (w = Math.max(w, t.events.length)));
        let o = 0;
        for (let e of t.events) {
          ...
          o += Q.getVirtualNodeHeight(l, n, a);
        }
        (t.events.length > 0 && (o += (t.events.length - 1) * 10),
          (T = Math.max(T, o)));
      }
      (n.debug(`maxSectionHeight before draw`, g),
        n.debug(`maxTaskHeight before draw`, _),
        m && m.length > 0
          ? m.forEach((e) => {
              let t = d.filter((t) => t.section === e),
                r = {
                  number: S,
                  descr: e,
                  section: S,
              ...
              n.debug(`sectionNode`, r);
              let i = l.append(`g`),
                o = Q.drawNode(i, r, S, a);
              (n.debug(`sectionNode output`, o),
                i.attr(`transform`, `translate(${b}, ${y})`),
                (x += g + 50),
                t.length > 0 && $(l, t, S, b, x, _, a, w, T, g, !1),
                (b += 200 * Math.max(t.length, 1)),
                (x = y),
                S++);
            })
          : ((C = !1), $(l, d, S, b, x, _, a, w, T, g, !0)));
      ...
      (n.debug(`bounds`, E),
        ...
        u(void 0, l, a.timeline?.padding ?? 50, a.timeline?.useMaxWidth ?? !1));
    }, `draw`)),
    ($ = r(function (e, t, r, i, a, o, s, c, l, u, d) {
      for (let c of t) {
        let t = {
          descr: c.task,
          section: r,
        ...
        let u = e.append(`g`).attr(`class`, `taskWrapper`),
          f = Q.drawNode(u, t, r, s).height;
        if (
          (n.debug(`taskHeight after draw`, f),
...
//# sourceMappingURL=timeline-definition-IT6M3QCI-CaNPoXgc.js.map
