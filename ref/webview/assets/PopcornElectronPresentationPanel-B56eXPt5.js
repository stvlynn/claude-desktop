...
import { a as ee, o as te } from "./workbook-C3Zy6Twd.js";
import {
  $ as ne,
  A as h,
  C as re,
...
import { n as _e, t as ve } from "./PopcornPageNumberNavigation-Cr5rDVih.js";
import {
  dn as ye,
  un as M,
...
function fn(e) {
  let t = on({
    ...
    n = Se(e.camera, e.viewportX, e.viewportY);
...
var pn,
  ...
  hn,
  gn = e(() => {
    (P(), (pn = 48), (mn = 0.1), (hn = 0.05));
  }),
  _n,
  vn,
  yn = e(() => {
    ((_n = t(n())), (vn = (0, _n.createContext)(null)));
  });
...
function yr({
  ...
  let ie = jn(e),
    ...
    E = te && p?.annotation != null && p.annotation.enabled !== !1,
    D = ne && p?.drawing != null && p.drawing.enabled !== !1,
  ...
  let ge = (0, X.useRef)(null),
    ...
    [Se, P] = (0, X.useState)(null),
    Ce = (0, X.useRef)(null);
  Ce.current = Se;
  let [we, F] = (0, X.useState)([]),
    Oe = (0, X.useRef)([]);
  Oe.current = we;
  let Ae = (0, X.useRef)(null),
    ...
    He = (0, X.useCallback)(
      (e) => {
        (Fe(e), p?.annotation?.onDismiss?.(e));
      },
      [Fe, p?.annotation],
    ),
    Ue = (0, X.useCallback)((e) => {
      P((t) => {
        let n = typeof e == `function` ? e(t) : e;
        return ((Ce.current = n), n);
      });
    }, []),
    L = (0, X.useSyncExternalStore)(
      (e) => t.subscribeToCameraChanges(e),
      () => t.getCamera(),
      () => t.getCamera(),
    ),
    R = (0, X.useSyncExternalStore)(
      (e) => t.subscribeToLayoutChanges(e),
      () => t.getLayoutSnapshot(),
      () => t.getLayoutSnapshot(),
    ),
    Ke = R.viewportInsets,
    Je = Tr(R.width, R.height, L, g.selectedSlideFrame, Ke) ?? g.slideRect,
    z = Je === g.slideRect ? g : { ...g, slideRect: Je },
    B = g.slideIds[g.selectedSlideIdx] ?? `slide-${g.selectedSlideIdx}`,
    V = g.slideLabels[g.selectedSlideIdx] ?? `Slide ${g.selectedSlideIdx + 1}`,
    Ye = (0, X.useMemo)(() => Er(z), [z]),
    Xe = (0, X.useMemo)(() => $n({ snapshot: g }), [g]),
    Ze = (0, X.useMemo)(() => {
      let e = z.slideRect;
      return e
    ...
    Qe = (0, X.useMemo)(
      () => (O?.target ? ir(O.target, z.slideRect) : null),
      [O?.target, z.slideRect],
    ),
    $e = (0, X.useMemo)(
      () => (O?.target ? ar(O.target, z.slideRect) : null),
      [O?.target, z.slideRect],
    ),
    et = Qe ?? $e,
    nt = (0, X.useMemo)(
    ...
    H = (0, X.useMemo)(() => {
      if (!nt || !M) return null;
      let e = er({ snapshot: g, frame: nt, anchorPoint: M.current });
      return e ? ir(e, z.slideRect) : null;
    }, [M, nt, g, z.slideRect]),
    it = (0, X.useMemo)(
      () =>
        nt
          ? dr(g.selectedSlideElementTargets, nt).flatMap((e) => {
          ...
          : [],
      [nt, g.selectedSlideElementTargets],
    ),
    ot = (0, X.useMemo)(
      () =>
    ...
    st = (0, X.useMemo)(
      () =>
        _e && g.hoveredElementId
          ? (g.selectedSlideElementTargets.find(
              (e) => e.id === g.hoveredElementId,
            ) ?? null)
          : null,
      [_e, g.hoveredElementId, g.selectedSlideElementTargets],
    ),
    lt = (0, X.useMemo)(
      () =>
        H ||
        ...
        (!E || !c
          ...
          : st
            ...
            : null),
      [Qe, E, st, c, H, B, V, g.selectedSlideIdx, z.slideRect],
    ),
    {
      annotations: ut,
    ...
    } = Ne(p?.annotation?.handleRef, {
      onDismissAnnotation: He,
      onDismissAllAnnotations: I,
    }),
    ht = (0, X.useMemo)(
      () => ut.filter((e) => e.target.slideId === B),
      [B, ut],
    ),
    gt = (0, X.useMemo)(
      () =>
        ht.map((e) => ({ annotation: e, bounds: ir(e.target, z.slideRect) })),
      [ht, z.slideRect],
    ),
    _t = (0, X.useMemo)(
      () =>
        me == null || O?.mode === `edit`
          ? null
          : (gt.find(({ annotation: e }) => e.annotationId === me) ?? null),
      [O?.mode, me, gt],
    ),
    vt = (0, X.useMemo)(() => (H ? it : ot), [ot, it, H]),
    { drawings: yt, addPendingDrawing: U } = De(p?.drawing?.handleRef),
    bt = (0, X.useMemo)(
      () => yt.filter((e) => e.target.slideId === B),
      [B, yt],
    ),
    W = (0, X.useMemo)(
      () =>
  ...
  ((0, X.useEffect)(
    ...
    (0, X.useEffect)(() => {
      g.selectedSlideFrame &&
        ...
        e.setViewportCamera(L);
    }, [L, e, t, g.selectedSlideFrame]),
    (0, X.useEffect)(() => {
      let e = _.current;
      !g.selectedSlideFrame ||
        !e ||
    ...
    }, [a, L, g.selectedSlideFrame, g.textEditState, g.textLayoutBlocks, W]),
    (0, X.useEffect)(() => {
  ...
  let G = (0, X.useCallback)(() => {
    ...
    K = (0, X.useCallback)(() => {
      (je.current?.(), (je.current = null), Ue(null));
    }, [Ue]),
    q = (0, X.useCallback)(() => {
      ((Ae.current = null), (Oe.current = []), F([]));
    }, []),
    xt = (0, X.useCallback)(() => {
      ((j.current = !1), k(null), N(null), G());
    }, [G]),
    J = (0, X.useCallback)(() => {
      let e = he.current;
    ...
    Ct = (0, X.useCallback)(
      (e) => {
        e == null ||
          ...
          !D ||
          !u ||
          ((Ae.current = B), (Oe.current = [...Oe.current, e]), F(Oe.current));
      },
      [B, D, u],
    ),
    wt = (0, X.useCallback)(
    ...
    Et = (e = `saved`, t = `button`) => {
      ...
      (dt(r),
        ...
        p?.annotation?.onSubmitted?.(r, e, t, { annotationMode: c }),
        xt());
    },
    Dt = () => {
      O?.mode === `edit` &&
        (mt(O.annotationId), A((e) => (e === O.annotationId ? null : e)), xt());
    };
  ((0, X.useEffect)(() => {
    (E || (O?.mode !== `edit` && k(null)),
      (!E || !c) && (N(null), (ye.current = null)));
  }, [E, O?.mode, c]),
    (0, X.useEffect)(() => {
      if (D && u) {
        (k(null),
    ...
    (0, X.useEffect)(() => {
      O &&
        O.target.slideId !== B &&
        (A(null), N(null), (ye.current = null), k(null));
    }, [O, B]),
    (0, X.useEffect)(
      () => () => {
        K();
    ...
    (0, X.useEffect)(() => {
      Ae.current == null || Ae.current === B || q();
    }, [q, B]),
    (0, X.useEffect)(() => {
      let e = _.current,
        t = se.current,
        n = D && u ? `crosshair` : E && c && !O ? be : ``;
      return (
        e && (e.style.cursor = n),
        t && (t.style.cursor = n),
        () => {
    ...
    (0, X.useEffect)(() => {
      ...
      c &&
        ...
        z.slideRect &&
          g.selectedSlideFrame &&
          (c.save(),
          c.translate(z.slideRect.left, z.slideRect.top),
          c.scale(z.slideRect.scale, z.slideRect.scale),
          W?.drawOverlay(c),
          c.restore()));
    }, [
      R.height,
  ...
  let Ot = (t) => {
    ...
    kt = (t) => {
      (fe(!1), _.current?.focus());
      let n = Cr(t, _.current, L, g, Ke);
      if ((Ot(n), D && u)) {
        if (!n) return;
        (Dr(t, y),
          (je.current = () => {
          ...
          Ue({ color: rt, strokeWidth: 3, points: [n] }),
          t.preventDefault(),
          t.stopPropagation());
        return;
      }
      ...
      if (E && c) {
        ...
        if ((r != null && i === `replace` && k(null), !n)) {
          (r != null && i !== `replace` && J(), (ye.current = null), N(null));
          return;
        }
        let a = sr(g.selectedSlideElementTargets, n, L.k);
      ...
      if (!a) {
        ...
        let i = sr(g.selectedSlideElementTargets, n, L.k);
      ...
      let o = g.primarySelectedElementId
        ...
        l = g.selectedElementIds.length === 1 && o ? lr([o], n, L.k) : null,
        d = l ? null : fr(s, n, L.k),
        f = !l && !d && !!o?.canRotate && pr(s, n, L.k),
        p = l
          ? l.endpoint === `from`
            ? `connector-from`
            : `connector-to`
        ...
        m =
          l?.elementId ??
          (p === `move`
            ? sr(g.selectedSlideElementTargets, n, L.k)
            : g.primarySelectedElementId);
      if (!m) {
    ...
    At = (t) => {
      ...
      if (E && c) {
        ...
        if (r != null && n) {
          ...
          (e && he.current && ((j.current = !1), k(null)),
            N(e ? { start: r.start, current: n } : null),
            t.preventDefault(),
            t.stopPropagation());
        }
        if (!n) {
      ...
      if (!a) {
        ...
        let r = n ? sr(g.selectedSlideElementTargets, n, L.k) : null;
      ...
      let r = g.primarySelectedElementId
        ...
        o = g.selectedElementIds.length === 1 && r ? lr([r], n, L.k) : null;
      if (o) {
      ...
      if (s) {
        (e.setHoveredElementId(g.primarySelectedElementId),
          (t.currentTarget.style.cursor = qe(s) ?? ``));
        return;
      }
      if (i && r?.canRotate && pr(i, n, L.k)) {
        (e.setHoveredElementId(g.primarySelectedElementId),
      ...
      let l = sr(g.selectedSlideElementTargets, n, L.k);
    ...
    jt = (t, n) => {
      if (D && u) {
        if (y.current != null && y.current !== t.pointerId) return;
        Ot(Cr(t, _.current, L, g, Ke));
        let e = Ce.current;
        (Or(t, y), (je.current = null), Ue(null), n && Ct(e));
        return;
      }
      if (E && c) {
        if (y.current != null && y.current !== t.pointerId) return;
        (Ot(Cr(t, _.current, L, g, Ke)), Or(t, y));
        let r = ye.current;
        if (((ye.current = null), N(null), !n || !r)) return;
        let i = Cr(t, _.current, L, g, Ke);
        if (!i) return;
        let a = ur(r.start, i),
      ...
      let r = b.current;
      if (!r) return;
      if ((Ot(Cr(t, _.current, L, g, Ke)), Or(t, y), r === `text`)) {
    ...
    Mt = (t) => {
      ...
      if (!a) return;
      let n = wr(t.clientX, t.clientY, _.current, L, g, Ke);
      n &&
    ...
    Pt = (t) => {
      if (
        ...
        if (t.key === `/` && !t.metaKey && !t.ctrlKey && !t.altKey) {
          let e = !!Ye;
          (fe(e), e && t.preventDefault());
          return;
        }
        if (t.key === `Escape` && de) {
          (fe(!1), t.preventDefault());
          return;
        }
        if (
          t.key === `Enter` &&
    ...
    Y = E && !c && !u && !O && !g.textEditState?.activeBlockId;
  return (0, Z.jsx)(`div`, {
    ref: ae,
    ...
    children: (0, Z.jsxs)(`div`, {
      ...
      children: [
        (0, Z.jsx)(`canvas`, {
          ...
          className: m(`absolute inset-0 h-full w-full select-none`),
        }),
        (0, Z.jsx)(`canvas`, {
          ref: oe,
        ...
        (0, Z.jsx)(`canvas`, {
          ...
          onPointerLeave: (t) => {
            y.current ??
              (Ot(null),
              e.setHoveredElementId(null),
              (t.currentTarget.style.cursor = D && u ? `crosshair` : ``));
          },
        ...
        Y && Ye && Xe
          ? (0, Z.jsx)(Ge, {
              ...
              onClick: (e) => {
                (p?.annotation?.onStart?.(e, { annotationMode: c }),
                  (j.current = !1),
                  k({ mode: `create`, target: Xe, body: `` }));
              },
            })
          : null,
        $e
...
function Kr({
  ...
  ((0, Q.useEffect)(() => {
    ...
    (0, Q.useEffect)(() => {
      !D || !E || (C.clearElementSelection(), C.setHoveredElementId(null));
    }, [C, E, D]),
    (0, Q.useEffect)(() => {
      if (!de) return;
      let e = (e) => {
  ...
  let [he, ge] = (0, Q.useState)(() =>
    ...
    [P, Ce] = (0, Q.useState)(() => w.slideIds),
    [F, Te] = (0, Q.useState)(null),
    ...
    Ve = (0, Q.useRef)([]),
    I = (0, Q.useRef)(null),
    He = (0, Q.useRef)(new Set()),
    Ue = (0, Q.useRef)(M),
    L = (0, Q.useRef)(xe),
    We = (0, Q.useRef)(P),
    Ge = a(s(u, { activationConstraint: { distance: 4 } })),
    R = (0, Q.useMemo)(() => [ye], []),
    qe = n === `left`,
    Je = n === `bottom`,
    z = g === `codex`,
  ...
  let U = (0, Q.useCallback)(
    ...
    xt = (0, Q.useCallback)((e, t, n) => {
      ((Ve.current[e] = n),
        n && I.current && L.current[t] == null && I.current.observe(n));
    }, []),
    J = (0, Q.useCallback)(
      (e, t = `default`, n) => {
        let r = Vr(e, t);
          ...
          ? (0, $.jsxs)(l, {
              ...
              children: [
                (0, $.jsx)(Ke, {
                  ...
                  strategy: B,
                  children: (0, $.jsxs)(`div`, {
                    className: m(`flex min-w-full justify-[safe_center]`, r),
                    children: [
                      P.map((r, i) => {
                        let a = M[r] ?? null;
                        return (0, $.jsx)(
                          mi,
                          {
                            slideId: r,
                            index: i,
                            snapshotIndex: nt[r] ?? -1,
                            label: tt[r] ?? `Slide ${i + 1}`,
                            thumbnail: a,
                            isSelected: r === H,
                            canDelete: P.length > 1,
                            onSelectSlide: pt,
                            onDeleteSlide: ht,
                            renderSlideThumbnailOverlay: ne,
      ...
      [F, vt, ht, P, R, W, G, bt, _t, ae, gt, ne, H, pt, Ge, nt, tt, M],
    );
  return (0, $.jsx)(`div`, {
    className: m(
      ...
      children: [
        (0, $.jsx)(ie, {
          ...
          centeredContent: lt
            ...
            : null,
          actions: (0, $.jsxs)(`div`, {
            className: m(`flex items-center`, z ? `gap-1` : `gap-2`),
            children: [
              v?.annotation && ue
                ? (0, $.jsx)(we, {
                    active: de,
                    onClick: () => {
                      let e = !de;
                      (e && (v?.annotation?.onModeEnabled?.(), O(!1)), fe(e));
                    },
        ...
        (0, $.jsx)(`div`, {
          ...
          children: (0, $.jsxs)(`div`, {
            ...
            className: m(
              ...
              V && `popcorn-presentation-editor-shell--small-stacked`,
              Je
                ? `flex-col`
                : qe || Ye
                  ? `flex-row`
              ...
              st
                ...
                : (0, $.jsxs)(`div`, {
                    className: m(
                      ...
                      Ye && `popcorn-presentation-main-panel--codex-responsive`,
                    ),
                    children: [
                      (0, $.jsx)(`div`, {
    ...
    (d(),
      ...
      (pi = (0, Q.memo)(function ({
        ...
        return (0, $.jsxs)(`button`, {
          ...
          children: [
            (0, $.jsx)(`div`, {
              className: m(`text-token-text-primary`, h, te),
              style: ie,
              children: t + 1,
            }),
            (0, $.jsxs)(`div`, {
              ...
              children: [
                r
                  ? (0, $.jsx)(`img`, {
                      src: r,
                      alt: ``,
                      className: m(`block`, ne),
                      style: re,
                      draggable: !1,
                    })
                  : (0, $.jsx)(`div`, {
                      className: m(ne, `animate-pulse bg-gray-200`),
      ...
      (hi = (0, Q.memo)(function ({
        ...
        return (0, $.jsxs)(`button`, {
          ...
          children: [
            (0, $.jsx)(`div`, {
              "aria-hidden": `true`,
              className: m(`text-token-text-primary invisible`, o, i),
              style: c,
              children: `00`,
            }),
            (0, $.jsx)(`div`, {
...
function _i({
  ...
  let y = I({ initialCrdtState: o, externalCrdtUpdates: t }),
    b = (0, Si.useRef)(s),
    x = (0, Si.useRef)(null),
    S = A(
      void 0,
...
var Si, Ci;
e(() => {
  (te(), p(), (Si = t(n())), gi(), Yt(), re(), V(), et(), (Ci = r()));
})();
export { _i as PopcornElectronPresentationPanel };
//# sourceMappingURL=PopcornElectronPresentationPanel-B56eXPt5.js.map
