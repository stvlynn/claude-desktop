const __vite__mapDeps = (
  ...
  m = __vite__mapDeps,
  d = m.f ||
    (m.f = ["./docx-preview-G1XqxLZP.js", "./rolldown-runtime-Czos8NxU.js"]),
) => i.map((i) => d[i]);
...
import { i as ke, r as Ae, t as z } from "./artifact-analytics-DlC6JvjK.js";
import {
  a as je,
  n as B,
  r as Me,
} from "./artifact-annotation-comment-0LjA3Ml-.js";
import { n as V, t as Ne } from "./artifact-preview-status-jgtoNhXT.js";
var H = e(() => {});
...
`),
    ...
    (Zt = p(
      async () => {
        let { renderAsync: e } = await import(`./docx-preview-G1XqxLZP.js`);
...
//# sourceMappingURL=docx-preview-panel-BsZXEpj7.js.map
