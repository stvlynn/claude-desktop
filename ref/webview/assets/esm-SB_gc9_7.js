      ...
      (E = (function () {
        ...
        return (
          ...
          (e.prototype.normalize = function (e) {
            var n = Object.keys(e.integrations ?? {}).reduce(function (t, n) {
              var r;
            ...
            var r = s(s({}, n), e.options?.integrations),
      ...
      (Q = (function (e) {
        ...
        return (
                  ...
                  case 0:
                    return (
                      ...
                      t.type === `destination` && t.name !== `Segment.io`
                        ? (t.load(e, r).catch(i), [3, 4])
                        : [3, 1]
                    );
                  case 1:
                    return (n.trys.push([1, 3, , 4]), [4, t.load(e, r)]);
                  case 2:
                    return (n.sent(), [3, 4]);
                  case 3:
                    return ((a = n.sent()), i(a), [3, 4]);
                  case 4:
                    return [2];
                }
              });
            ...
            return i(this, void 0, void 0, function () {
              ...
              return n(this, function (n) {
                switch (n.label) {
                  ...
                  case 1:
                    (n.sent(), (t = Date.now()), (n.label = 2));
                  case 2:
                    return (n.trys.push([2, 4, , 5]), [4, this.flushOne(e)]);
                  case 3:
                    return (
                      (e = n.sent()),
                      (r = Date.now() - t),
                ...
                switch (n.label) {
                  case 0:
                    if (this.queue.length === 0 || ((e = this.queue.pop()), !e))
                      return [2, []];
                    ((e.attempts = this.queue.getAttempts(e)), (n.label = 1));
                  case 1:
                    return (n.trys.push([1, 3, , 4]), [4, this.deliver(e)]);
                  case 2:
                    return ((e = n.sent()), this.emit(`flush`, e, !0), [3, 4]);
                  case 3:
                    return (
                      (t = n.sent()),
                      (r = this.enqueuRetry(t, e)),
                      r ||
          ...
          (t.prototype.flushOne = function (e) {
            return i(this, void 0, void 0, function () {
              var t, r, i, a, o, s, c, l, u, d, c, f, p, m, h;
              return n(this, function (n) {
                switch (n.label) {
                  case 0:
                    ...
                    (e.attempts > 1 && this.emit(`delivery_retry`, e),
                      ...
                      (n.label = 1));
                  case 1:
                    return a < o.length ? ((s = o[a]), [4, we(e, s)]) : [3, 4];
                  case 2:
                    ((c = n.sent()),
                      c instanceof K && (e = c),
    ...
    return n(this, function (n) {
      switch (n.label) {
        ...
        case 3:
          ((o = n.sent()), (n.label = 4));
        case 4:
          return a?.callback ? [4, de(o, a.callback, $(i, a.timeout))] : [3, 6];
        case 5:
          ((o = n.sent()), (n.label = 6));
        case 6:
...
//# sourceMappingURL=esm-SB_gc9_7.js.map
