...
import { n as t, t as n } from "./rough.esm-BmcJJgrn.js";
import { n as r, r as i } from "./chunk-AGHRB4JF-DVNPU_Qo.js";
import {
  A as a,
  C as o,
  G as s,
...
import { n as g, t as _ } from "./chunk-426QAEUC-DkGEnnOP.js";
import { p as v, u as y } from "./chunk-5PVQY5BW-MckrTAit.js";
var b, x, S, C, w, T, E, D, O, k, A, j, M, N, P, F, I, L, R, z, B, V, H, U, W;
e(() => {
  (_(),
    y(),
    a(),
      ...
      var e = r(function (e, t, n, r) {
        ...
        h = {
          ...
          table: [
            ...
            { 1: [2, 1] },
            { 4: 6, 6: [1, 7], 7: [1, 8], 8: t },
            { 6: n, 7: [1, 10], 9: 9, 12: 11, 13: i, 14: a },
            e(o, [2, 3]),
            { 1: [2, 2] },
            e(o, [2, 4]),
            e(o, [2, 5]),
            { 1: [2, 6], 6: n, 12: 15, 13: i, 14: a },
            { 6: n, 9: 16, 12: 11, 13: i, 14: a },
            { 6: s, 7: c, 10: 17, 11: l },
            e(u, [2, 18], { 14: [1, 21] }),
            e(u, [2, 16]),
            e(u, [2, 17]),
            { 6: s, 7: c, 10: 22, 11: l },
            { 1: [2, 7], 6: n, 12: 15, 13: i, 14: a },
            e(d, [2, 14], { 7: f, 11: p }),
            e(m, [2, 8]),
            e(m, [2, 9]),
            e(m, [2, 10]),
...
` +
      ...
      return (r(g, `Parser`), (g.prototype = h), (h.Parser = g), new g());
    })()),
    (b.parser = b),
    (x = b),
    (S = class {
      ...
      addNode(e, t) {
        let n = m.sanitizeText(t, f());
        if (!this.root) {
          ((this.root = { text: n, children: [] }),
            (this.stack = [{ level: 0, node: this.root }]),
            s(n));
          return;
        }
        this.baseLevel ??= e;
        let r = e - this.baseLevel + 1;
        for (
          r <= 0 && (r = 1);
          this.stack.length > 1 && this.stack[this.stack.length - 1].level >= r;

        )
          this.stack.pop();
        let i = this.stack[this.stack.length - 1].node,
          a = { text: n, children: [] };
        (i.children.push(a), this.stack.push({ level: r, node: a }));
      }
      getAccTitle() {
        return h();
      }
    ...
    (j = r((e, t, n) => {
      let r = e.node().getBBox(),
        i = r.width + t * 2,
        a = r.height + t * 2;
      (p(e, a, i, n), e.attr(`viewBox`, `${r.x - t} ${r.y - t} ${i} ${a}`));
    }, `applyPaddedViewBox`)),
    (M = r((e, t, r, i) => {
      let a = i.db.getRoot();
      if (!a) return;
      let o = f(),
        { look: s, handDrawnSeed: c, themeVariables: l } = o,
        u = v(o.fontSize)[0] ?? C,
        d = s === `handDrawn`,
        p = a.children ?? [],
        m = o.ishikawa?.diagramPadding ?? 20,
        h = o.ishikawa?.useMaxWidth ?? !1,
        _ = g(t),
        y = _.append(`g`).attr(`class`, `ishikawa`),
        b = d ? n.svg(_.node()) : void 0,
        x = b
          ? {
              roughSvg: b,
              seed: c ?? 0,
      ...
      let T = 0,
        E = w,
        D = d ? void 0 : U(y, T, E, T, E, `ishikawa-spine`);
      if ((P(y, T, E, a.text, u, x), !p.length)) {
        (d && U(y, T, E, T, E, `ishikawa-spine`, x), j(_, m, h));
        return;
      }
      T -= 20;
      let O = p.filter((e, t) => t % 2 == 0),
        k = p.filter((e, t) => t % 2 == 1),
        A = N(O),
        M = N(k),
        F = A.total + M.total,
        I = w,
      ...
      if (F > 0) {
        let e = w * 2,
          t = w * 0.3;
        ((I = Math.max(t, e * (A.total / F))),
          (L = Math.max(t, e * (M.total / F))));
      }
      let z = u * 2;
      ((I = Math.max(I, A.max * z)),
        (L = Math.max(L, M.max * z)),
        (E = Math.max(I, w)),
        D && D.attr(`y1`, E).attr(`y2`, E),
        y
          .select(`.ishikawa-head-group`)
          .attr(`transform`, `translate(0,${E})`));
      let B = Math.ceil(p.length / 2);
      for (let e = 0; e < B; e++) {
        let t = y.append(`g`).attr(`class`, `ishikawa-pair`);
        for (let [n, r, i] of [
          [p[e * 2], -1, I],
          [p[e * 2 + 1], 1, L],
        ])
        ...
        T = t
          .selectAll(`text`)
          .nodes()
          .reduce((e, t) => Math.min(e, t.getBBox().x), 1 / 0);
      }
      if (d) U(y, T, E, 0, E, `ishikawa-spine`, x);
      else {
        D.attr(`x1`, T);
        let e = `url(#${S})`;
        y.selectAll(`line.ishikawa-branch, line.ishikawa-sub-branch`).attr(
          `marker-start`,
          e,
        );
      }
    ...
    (N = r((e) => {
      let t = r(
        (e) => e.children.reduce((e, n) => e + 1 + t(n), 0),
        `countDescendants`,
      );
      return e.reduce(
        (e, n) => {
    ...
    (P = r((e, t, n, r, i, a) => {
      let o = Math.max(6, Math.floor(110 / (i * 0.6))),
        s = e
          .append(`g`)
          .attr(`class`, `ishikawa-head-group`)
          .attr(`transform`, `translate(${t},${n})`),
        c = V(s, B(r, o), 0, 0, `ishikawa-head-label`, `start`, i),
        l = c.node().getBBox(),
        u = Math.max(60, l.width + 6),
        d = Math.max(40, l.height * 2 + 40),
        f = `M 0 ${-d / 2} L 0 ${d / 2} Q ${u * 2.4} 0 0 ${-d / 2} Z`;
      if (a) {
        ...
        s.insert(`path`, `:first-child`)
          .attr(`class`, `ishikawa-head`)
          .attr(`d`, f);
      c.attr(
        `transform`,
        `translate(${(u - l.width) / 2 - l.x + 3},${-l.y - l.height / 2})`,
      );
    }, `drawHead`)),
    (F = r((e, t) => {
      let n = [],
        ...
        a = r((e, r, o) => {
          ...
          for (let e of s) {
            ...
            (n.push({
              ...
              o % 2 == 0
                ? (i.push(t), s.length && a(s, t, o + 1))
                : (s.length && a(s, t, o + 1), i.push(t)));
          }
        }, `walk`);
      return (a(e, -1, 2), { entries: n, yOrder: i });
    }, `flattenTree`)),
    (I = r((e, t, n, r, i, a, o) => {
      let s = e.append(`g`).attr(`class`, `ishikawa-label-group`),
        c = V(s, t, n, r + 11 * i, `ishikawa-label cause`, `middle`, a)
          .node()
          .getBBox();
      if (o) {
        let e = o.roughSvg.rectangle(
          c.x - 20,
          c.y - 2,
          c.width + 40,
          c.height + 4,
    ...
    (L = r((e, t, n, r, i, a) => {
      ...
      let s = r / o,
        ...
        d = t,
        f = n,
        p = `M ${d} ${f} L ${d - s * 6 * 2 + l} ${f - c * 6 * 2 + u} L ${d - s * 6 * 2 - l} ${f - c * 6 * 2 - u} Z`,
        m = a.roughSvg.path(p, {
          roughness: 1,
          seed: a.seed,
          fill: a.lineColor,
    ...
    (R = r((e, t, n, r, i, a, o, s) => {
      let c = t.children ?? [],
        ...
        p = r + d;
      if (
        (U(e, n, r, f, p, `ishikawa-branch`, s),
        s && L(e, n, r, n - f, r - p, s),
        I(e, t.text, f, p, i, o, s),
        !c.length)
      )
        return;
      let { entries: m, yOrder: h } = F(c, i),
        g = m.length,
        _ = Array(g);
      for (let [e, t] of h.entries()) _[t] = r + d * ((e + 1) / (g + 1));
      let v = new Map();
      v.set(-1, {
        x0: n,
        y0: r,
      ...
      let y = -k,
        b = A * i,
        x = i < 0 ? `ishikawa-label up` : `ishikawa-label down`;
      for (let [t, n] of m.entries()) {
        let r = _[t],
          i = v.get(n.parentIndex),
          a = e.append(`g`).attr(`class`, `ishikawa-sub-group`),
          c = 0,
          l = 0,
          u = 0;
        if (n.depth % 2 == 0) {
          let e = i.y1 - i.y0;
          ((c = H(i.x0, i.x1, e ? (r - i.y0) / e : 0.5)),
            (l = r),
            (u = c - (n.childCount > 0 ? E + n.childCount * D : T)),
            U(a, c, r, u, r, `ishikawa-sub-branch`, s),
            s && L(a, c, r, 1, 0, s),
            V(a, n.text, u, r, `ishikawa-label align`, `end`, o));
        } else {
          let e = i.childrenDrawn++;
          ((c = H(i.x0, i.x1, (i.childCount - e) / (i.childCount + 1))),
            (l = i.y0),
            (u = c + y * ((r - l) / b)),
            U(a, c, l, u, r, `ishikawa-sub-branch`, s),
            s && L(a, c, l, c - u, l - r, s),
            V(a, n.text, u, r, x, `end`, o));
        }
        n.childCount > 0 &&
          v.set(t, {
            x0: c,
...
export { W as diagram };
//# sourceMappingURL=ishikawaDiagram-UXIWVN3A-BT5D3Jbq.js.map
