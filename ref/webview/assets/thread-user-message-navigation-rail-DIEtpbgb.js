...
function Ee(e) {
  ...
  if (t[0] !== n) {
    ...
    if (e.length === 0) {
      ...
      (t[4] === e
        ? (n = t[5])
        : ((n = (0, Z.jsx)(je, { label: e })), (t[4] = e), (t[5] = n)),
        (o = n));
    }
    let s;
    t[6] === n.isHeartbeat
    ...
    (t[10] !== s || t[11] !== c
      ...
      : (l = t[12]),
      (r = (0, Z.jsxs)(`div`, {
        "data-thread-user-message-navigation-tooltip-preview": !0,
        ...
        children: [
          ...
          a.length > 0
            ? (0, Z.jsx)(`div`, {
                className: `mt-1 line-clamp-3 text-token-description-foreground`,
                children: a,
              })
            : null,
          i.outputs.length > 0
            ? (0, Z.jsxs)(`div`, {
                className: `mt-2 flex min-w-0 items-center gap-3 text-token-description-foreground`,
                children: [
                  i.outputs.slice(0, Pe).map(De),
                  i.outputs.length > Pe
                    ? (0, Z.jsx)(`span`, {
                        ...
                        children: (0, Z.jsx)(T, {
                          ...
                          values: { count: i.outputs.length - Pe },
                        }),
                      })
                    : null,
                ],
...
function De(e, t) {
  return (0, Z.jsx)(Oe, { output: e }, `${e.type}:${e.label ?? t}`);
}
function Oe(e) {
  let t = (0, Me.c)(9),
    { output: n } = e,
  ...
  let i;
  t[2] === n ? (i = t[3]) : ((i = Ae(n)), (t[2] = n), (t[3] = i));
  let a;
  t[4] === i
    ? (a = t[5])
    : ((a = (0, Z.jsx)(`span`, {
...
function ke(e) {
  switch (e.type) {
    ...
    case `commit`:
      return (0, Z.jsx)(u, { className: `icon-sm shrink-0` });
    case `file`:
      return (0, Ne.createElement)(U(e.label ?? void 0), {
        className: `icon-sm shrink-0`,
      });
    case `google-drive`:
      return (0, Z.jsx)(k, { className: `icon-sm shrink-0` });
    case `image`:
      return (0, Z.jsx)(d, { className: `icon-sm shrink-0` });
    case `pull-request`:
      return (0, Z.jsx)(ie, { className: `icon-sm shrink-0` });
    case `review`:
      return (0, Z.jsx)(Y, { className: `icon-sm shrink-0` });
    case `website`:
      return (0, Z.jsx)(L, { className: `icon-sm shrink-0` });
  }
}
function Ae(e) {
...
function je(e) {
  ...
  if (t[0] !== n) {
    ...
    for (; i < n.length; ) {
      ...
      if (t == null) break;
      i = t.end;
      let r = f(t.label).trim(),
        o = le(t.path),
        s,
        c = r,
        l;
      if (j(o) || O(o)) ((s = I(r) ?? H), (c = ye(r)));
      else if (r.startsWith(`$`))
        ((s = W()),
          (c = m(
            r.startsWith(`$[`) && r.endsWith(`]`) ? r.slice(2, -1) : r.slice(1),
          )));
      else {
        let e = B(o);
        if (e == null) continue;
        let t = R(e);
        ((s = (t == null ? null : I(t.appId)) ?? (0, Z.jsx)(G, { href: e })),
          (l = e));
      }
      (e.push(n.slice(a, t.start)),
        e.push(
          (0, Z.jsx)(
            Se,
            { className: `first:pl-0`, icon: s, text: c, title: l },
            t.start,
          ),
        ),
        (a = t.end));
    ...
    (e.push(n.slice(a)),
      (r = (0, Z.jsx)(Z.Fragment, { children: e })),
      (t[0] = n),
      (t[1] = r));
  } else r = t[1];
  return r;
...
var Me,
  ...
  Be = e(() => {
    ((Ie = `_marker_fmcrx_1`),
      (Le = `_row_fmcrx_22`),
      (Re = `_railList_fmcrx_47`),
      (ze = { marker: Ie, row: Le, railList: Re }));
  });
function Ve(e) {
  let t = (0, Ze.c)(3),
    { items: n, onRevealItem: r } = e;
  if (n.length < tt) return null;
  let i;
  return (
    t[0] !== n || t[1] !== r
      ? ((i = (0, $.jsx)(He, { items: n, onRevealItem: r })),
        (t[0] = n),
        (t[1] = r),
        (t[2] = i))
      : (i = t[2]),
...
function He(e) {
  ...
  t[0] === c
    ? (l = t[1])
    : ((l = () => new Set(c == null ? [] : [c])), (t[0] = c), (t[1] = l));
  let [u, ee] = (0, Q.useState)(l),
    [te, re] = (0, Q.useState)(!1),
    [d, ie] = (0, Q.useState)(null),
    [f, p] = (0, Q.useState)(null),
    [m, h] = (0, Q.useState)(!1),
    [g, se] = (0, Q.useState)(!1),
    [_, le] = (0, Q.useState)(null),
    ue = (0, Q.useRef)(null),
    v = (0, Q.useRef)(null),
    y = (0, Q.useRef)(!1),
    b = (0, Q.useId)(),
  ...
  t[2] === n
    ? (fe = t[3])
    : ((fe = n.map(Ue).join(`\0`)), (t[2] = n), (t[3] = fe));
  let C = fe,
    me;
  t[4] !== u || t[5] !== n || t[6] !== c
    ? ((me = n.find((e) => u.has(e.id))?.id ?? c),
      (t[4] = u),
      (t[5] = n),
      (t[6] = c),
      (t[7] = me))
  ...
  t[8] === w
    ? (he = t[9])
    : ((he = () => {
        v.current ?? Ge(ue.current, w);
      }),
      (t[8] = w),
      (t[9] = he));
  let ge = (0, Q.useEffectEvent)(he),
    T;
  t[10] !== i || t[11] !== r || t[12] !== S
    ? ((T = async (e, t) => {
        let n = i();
        if (n == null) return;
        let a = We(n, e.id);
        if (a == null && r != null) {
          (await r(e), (a = We(n, e.id)), Je(a, S));
          return;
        }
        (a?.scrollIntoView({ behavior: t, block: `start` }), Je(a, S));
      }),
      (t[10] = i),
      (t[11] = r),
      (t[12] = S),
  ...
  let E = pe(T),
    D;
  t[14] !== E || t[15] !== s
    ? ((D = (e) => (s.logProductEvent(ae, {}), E(e, `smooth`))),
      (t[14] = E),
      (t[15] = s),
      (t[16] = D))
    : (D = t[16]);
  ...
  t[19] !== i || t[20] !== ge
    ? ((A = () => {
        ...
        let n = null,
          r = () => {
            n ??= window.requestAnimationFrame(() => {
              ((n = null), le(e.parentElement));
              let r = e.getBoundingClientRect(),
                i = t.getBoundingClientRect(),
                a = e.offsetWidth > 0 ? r.width / e.offsetWidth : 1;
              (se((i.left - r.left) / (a > 0 ? a : 1) >= et + nt), ge());
            });
          },
        ...
        return (
          o.observe(e.firstElementChild ?? e, {
            attributes: !0,
    ...
    : (A = t[21]);
  let j;
  (t[22] === i ? (j = t[23]) : ((j = [i]), (t[22] = i), (t[23] = j)),
    (0, Q.useEffect)(A, j));
  let M, N;
  (t[24] !== i || t[25] !== C
    ? ((M = () => {
        ...
        let t = new Set(),
          n = new Map(),
          r = new Set(),
          a = C.length === 0 ? [] : C.split(`\0`),
          o = new Set(a),
          s = () => {
            let e = a.findIndex((e) => t.has(e));
            if (e === -1) return;
            let n = (0, Qe.default)(a, (e) => t.has(e)),
              r = new Set(a.slice(e, n + 1));
            ee((e) =>
              e.size === r.size && [...e].every((e) => r.has(e)) ? e : r,
            );
          },
          c = new IntersectionObserver(
            ...
            { root: e, rootMargin: `-${rt}px 0px 0px 0px` },
          ),
          l = () => {
            let i = new Set();
  ...
  let F;
  if (
    (t[31] !== w || t[32] !== g || t[33] !== d
      ? ((F = [w, g, d]), (t[31] = w), (t[32] = g), (t[33] = d), (t[34] = F))
      : (F = t[34]),
    (0, Q.useLayoutEffect)(P, F),
    !g || _ == null || typeof document > `u`)
  )
    return null;
  let I;
  t[35] === x
  ...
  t[39] === S
    ? (z = t[40])
    : ((z = S ? { duration: 0 } : { duration: 0.15, ease: [0.23, 1, 0.32, 1] }),
      (t[39] = S),
      (t[40] = z));
  let B;
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((B = (e) => {
        (!e && v.current != null) || (h(e), e || p(null));
      }),
      (t[41] = B))
    : (B = t[41]);
  let xe = f?.button,
  ...
  t[42] === Se
    ? (V = t[43])
    : ((V = (0, $.jsx)(Ee, { item: Se })), (t[42] = Se), (t[43] = V));
  let Ce = d == null ? void 0 : !0,
    H;
  ...
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((W = () => {
      ...
      (we = () => {
        (re(!1), v.current ?? p(null));
      }),
      (t[47] = W),
      (t[48] = we))
    : ((W = t[47]), (we = t[48]));
  let G;
  t[49] !== k || t[50] !== E || t[51] !== n
    ? ((G = (e) => {
        let t = v.current;
        if (t == null) {
          let t = qe(
          ...
          t != null && p((e) => (e?.item.id === t.item.id ? e : t));
          return;
        }
        ...
        let r = e.currentTarget.getBoundingClientRect(),
          i = qe(
            ...
            document.elementFromPoint(
              r.left + r.width / 2,
              Math.max(r.top, Math.min(e.clientY, r.bottom - 1)),
            ),
          );
        i == null ||
          i.item.id === t.itemId ||
          ((v.current = { ...t, itemId: i.item.id }),
          ie(i.item.id),
          p(i),
          (y.current = !0),
          E(i.item, `instant`));
    ...
    ? ((K = n.map((e, t) =>
        (0, $.jsx)(
          `button`,
          {
            ...
            "data-scrub-target": d === e.id ? !0 : void 0,
            "aria-current": u.has(e.id) ? `true` : void 0,
            "aria-describedby": m && f?.item.id === e.id ? b : void 0,
            ...
            onClick: (t) => {
              ...
              (p({ button: t.currentTarget, item: e }), h(!0), ye(e));
            },
            onFocus: (t) => {
              (p({ button: t.currentTarget, item: e }), h(!0));
            },
            children: (0, $.jsx)(`span`, {
              className: `flex h-0.5 w-[30px] items-center`,
              children: (0, $.jsx)(`span`, {
                className: ve(
                  ze.marker,
                  ...
                  u.has(e.id) && d !== e.id && `bg-token-foreground opacity-60`,
                  d === e.id && `bg-token-foreground opacity-100`,
                ),
              }),
            }),
          },
  ...
  t[62] === K
    ? (q = t[63])
    : ((q = (0, $.jsx)(`div`, { className: `flex flex-col`, children: K })),
      (t[62] = K),
      (t[63] = q));
  let J;
  t[64] !== k || t[65] !== Ce || t[66] !== U || t[67] !== G || t[68] !== q
    ? ((J = (0, $.jsx)(`div`, {
        ref: ue,
        ...
        onPointerCancelCapture: k,
        onPointerDownCapture: U,
        onPointerEnter: W,
        onPointerLeave: we,
        onPointerMove: G,
        onPointerUpCapture: k,
        children: q,
      })),
      (t[64] = k),
      (t[65] = Ce),
...
function We(e, t) {
  return e.querySelector(`[data-content-search-unit-key="${Xe(t)}"]`);
}
function Ge(e, t) {
  if (e == null) return;
  let n = Ke(e, t);
...
function Ke(e, t) {
  return t == null || e == null
    ? null
    : e.querySelector(
        `[data-thread-user-message-navigation-item-id="${Xe(t)}"]`,
      );
}
function qe(e, t, n) {
...
function Je(e, t) {
  (
    ...
    [
      { backgroundColor: at },
      { backgroundColor: at, offset: 0.35 },
      { backgroundColor: ot },
    ],
  ...
  return e.some((e) =>
    [...e.addedNodes, ...e.removedNodes].some(
      (e) =>
        ...
        (e.matches(it) || e.querySelector(it) != null),
    ),
  );
}
function Xe(e) {
...
var Ze, Qe, Q, $e, $, et, tt, nt, rt, it, at, ot;
e(() => {
  ((Ze = r()),
    _(),
    E(),
    ...
    (nt = 36),
    (rt = 16),
    (it = `[data-turn-key], [data-content-search-turn-key]`),
    (at = `color-mix(in srgb, var(--color-token-foreground) 14%, transparent)`),
    (ot = `color-mix(in srgb, var(--color-token-foreground) 5%, transparent)`));
})();
export { Ve as ThreadUserMessageNavigationRail };
//# sourceMappingURL=thread-user-message-navigation-rail-DIEtpbgb.js.map
