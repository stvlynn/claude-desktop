...
function oe({ accountStructure: e, plan: t, workspaceName: n }) {
  let r = P(n);
  return r != null && e?.toLowerCase() === `workspace` ? r : v(t);
}
function se({ accountName: e, displayName: t, username: n }) {
  return t ?? n ?? e ?? null;
}
function b(e) {
  let t = e.trim();
...
function le({ dailyUsage: e, todayIso: t, view: n }) {
  let r = k({
    columnCount: w(t),
    dailyUsage: e,
    startDateIso: T(t),
...
function ue({ dailyUsage: e, todayIso: t }) {
  let n = M(A(t), -175);
  return E(
...
function de({ dailyUsage: e, todayIso: t }) {
  return O(C({ dailyUsage: e, todayIso: t }));
}
function fe(e = new Date()) {
...
function ye(e) {
  let t = (0, X.c)(13),
    { accountId: r, enabled: i, userId: o } = e,
    s = ne(Z),
    l;
  t[0] === s
    ? (l = t[1])
    : ((l = s.get(Q, ee.SIX_HOURS)), (t[0] = s), (t[1] = l));
  let u = l,
    d;
  t[2] !== r || t[3] !== o
    ? ((d = W({ accountId: r, userId: o })), (t[2] = r), (t[3] = o), (t[4] = d))
    : (d = t[4]);
  let f = i && !0,
    p;
  t[5] !== r || t[6] !== o
    ? ((p = async () => {
        let e = r != null,
          t = o != null;
        (!e || !t) &&
          n.warning(`profile_usage_query_started_without_identity`, {
        ...
        try {
          ...
          let i = r;
          throw (
            n.warning(`profile_usage_query_failed`, {
              safe: {
                errorCode: i instanceof c ? (i.errorCode ?? null) : null,
                hasAccountId: e,
                hasUserId: t,
                status: i instanceof c ? i.status : null,
              },
              sensitive: {},
            }),
            i
    ...
    t[3] !== i || t[4] !== s
      ? ((c = {
          ...
          onSuccess: (e, t) => {
            ...
            n != null && i.setQueryData(s, { ...n, username: b(t) || null });
          },
        }),
        (t[3] = i),
        (t[4] = s),
...
async function G(e) {
  let t = Oe();
  return (
    await l.getInstance().post(`/wham/profiles/me/photo`, te(await De(e, t)), {
...
//# sourceMappingURL=app-initial~app-main~onboarding-page~profile-CFRY9Eda.js.map
