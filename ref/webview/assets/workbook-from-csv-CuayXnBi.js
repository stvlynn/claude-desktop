...
import { c as t, n, o as r, r as i } from "./address-utils-CrPpzw-e.js";
function a(e) {
  return ((e ?? u).trim().replace(f, ``).trim() || u).slice(0, d);
}
function o(e, i) {
  let o = s(i?.separator),
    l = t(i?.anchor ?? `A1`),
...
var u, d, f;
e(() => {
  (i(), (u = `CSV import`), (d = 31), (f = /\\|\/|\?|\*|\[|\]|:/g));
})();
export { o as planCsvImport, a as sanitizeSheetName };
//# sourceMappingURL=workbook-from-csv-CuayXnBi.js.map
