...
import { i as S, n as C, r as w, t as T } from "./src-CTe_6Jg1.js";
import { t as E } from "./dist-CD74BDfk.js";
import { i as D, n as O, o as k, r as A } from "./chunk-AGHRB4JF-DVNPU_Qo.js";
import {
  A as j,
  C as M,
  G as ee,
...
import { g as ce, u as le } from "./chunk-5PVQY5BW-MckrTAit.js";
var ue = n((e, t) => {
    (function (n, r) {
...
` +
    ...
    (Tt = {
      ...
      renderer: {
        setConf: St,
        draw: O(function (e, t, n, s) {
          let c = N().gantt;
          s.db.setDiagramId(t);
          let l = N().securityLevel,
            h;
          l === `sandbox` && (h = C(`#i` + t));
          let v = C(
          ...
          ((Q = x.parentElement.offsetWidth),
            Q === void 0 && (Q = 1200),
            c.useWidth !== void 0 && (Q = c.useWidth));
          let T = s.db.getTasks(),
            E = [];
          ...
          if (
            ...
            for (let n of Object.keys(e)) {
              let r = wt(e[n], t) + 1;
              ((t += r), (A += r * (c.barHeight + c.barGap)), (k[n] = r));
            }
          } else {
            A += T.length * (c.barHeight + c.barGap);
            for (let e of E) k[e] = T.filter((t) => t.type === e).length;
          }
          x.setAttribute(`viewBox`, `0 0 ` + Q + ` ` + A);
          let j = v.select(`[id="${t}"]`),
            M = u()
              .domain([
                a(T, function (e) {
              ...
              .rangeRound([0, Q - c.leftPadding - c.rightPadding]);
          function ee(e, t) {
            let n = e.startTime,
              r = t.startTime,
              i = 0;
            ...
            if (
              (d
                ...
                .attr(`height`, function (e) {
                  return e.vert
                    ? T.length * (c.barHeight + c.barGap) + c.barHeight * 2
                    : a;
                })
          ...
          function re(e, n, r, i, a, o, l, u) {
            ...
            let p = s.db.getDateFormat(),
              m = [],
              h = null,
              g = (0, F.default)(d);
            for (; g.valueOf() <= f; )
              (s.db.isInvalidDate(g, p, l, u)
                ? h
                  ? (h.end = g)
                  : (h = { start: g, end: g })
                : (h &&= (m.push(h), null)),
            ...
            j.append(`g`)
              ...
              .attr(`height`, a - n - c.gridLineStartPadding)
          ...
          function se(e, t, n, r) {
            ...
            if (u !== null) {
              ...
              if (isNaN(e) || e <= 0)
                D.warn(
                  `Invalid tick interval value: "${u[1]}". Skipping custom tick interval.`,
                );
              else {
                let t = u[2],
                ...
                if (o > $)
                  D.warn(
                    `The tick interval "${e}${t}" would generate ${o} ticks, which exceeds the maximum allowed (${$}). This may indicate an invalid date or time range. Skipping custom tick interval.`,
                  );
                else
                  switch (t) {
                    case `millisecond`:
...
//# sourceMappingURL=ganttDiagram-T4ZO3ILL-C66qF7V9.js.map
