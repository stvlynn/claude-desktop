...
import { D as n } from "./runtime.worker-B4oXRaGJ.js";
import {
  B as r,
  C as i,
  V as a,
...
import { t as f } from "./chunk-FMBD7UC4-BvMbe0V6.js";
import { a as p, n as m, o as h, s as g } from "./chunk-YZCP3GAM-YM2CBvV6.js";
var _ = (function () {
...
var v = _,
  ...
  S = [],
  C = e(function () {
    ((b.length = 0), (x.length = 0), (y = ``), (S.length = 0), c());
  }, `clear`),
  w = e(function (e) {
    ((y = e), b.push(e));
  }, `addSection`),
  ...
  j = {
    getConfig: e(() => l().journey, `getConfig`),
    clear: C,
    setDiagramTitle: o,
    getDiagramTitle: i,
    setAccTitle: a,
...
`,
  ...
  R = e(function (e, t, n) {
    ...
    ((i.x = t.x),
      (i.y = t.y),
      (i.fill = t.fill),
      (i.width = n.width * t.taskCount + n.diagramMarginX * (t.taskCount - 1)),
      (i.height = n.height),
  ...
  B = e(function (e, t, n, r) {
    ...
    (z++,
      a
        ...
        .attr(`stroke`, `#666`),
      P(a, { cx: i, cy: 300 + (5 - t.score) * 30, score: t.score }));
    let o = g();
    ((o.x = t.x),
      (o.y = t.y),
      (o.fill = t.fill),
  ...
  U = {
    ...
    drawLabel: L,
    drawTask: B,
    drawBackgroundRect: V,
    initGraphics: e(function (e, t) {
      ((z = -1),
        e
          .append(`defs`)
          .append(`marker`)
...
var J = l().journey,
  ...
  ee = e(function (e, n, r, i) {
    ...
    U.initGraphics(m, n);
    let h = i.db.getTasks(),
      g = i.db.getDiagramTitle(),
      _ = i.db.getActors();
    for (let e in G) delete G[e];
    let v = 0;
    (_.forEach((e) => {
      ((G[e] = {
        color: J.actorColours[v % J.actorColours.length],
        position: v,
      }),
        v++);
    }),
      q(m),
      (Y = J.leftMargin + K),
      X.insert(0, 0, Y, Object.keys(G).length * 50),
      te(m, h, 0, n));
    let y = X.getBounds();
    g &&
      m
        ...
        .attr(`fill`, o)
        .attr(`font-family`, c);
    let b = y.stopy - y.starty + 2 * J.diagramMarginY,
      x = Y + y.stopx + 2 * J.diagramMarginX;
    (u(m, b, x, J.useMaxWidth),
      m
        .append(`line`)
        .attr(`x1`, Y)
        .attr(`y1`, J.height * 4)
    ...
    let S = g ? 70 : 0;
    (m.attr(`viewBox`, `${y.startx} -25 ${x} ${b + S}`),
      m.attr(`preserveAspectRatio`, `xMinYMin meet`),
      m.attr(`height`, b + S + 25));
  }, `draw`),
  X = {
    ...
    updateBounds: e(function (t, n, r, i) {
      ...
      (e(c, `updateFn`), this.sequenceItems.forEach(c()));
    }, `updateBounds`),
  ...
  te = e(function (e, t, n, r) {
    ...
    for (let [n, l] of t.entries()) {
      if (a !== l.section) {
        ((c = Z[s % Z.length]), (d = s % Z.length), (u = Q[s % Q.length]));
        let r = 0,
          o = l.section;
        ...
        (U.drawSection(e, f, i), (a = l.section), s++);
      }
      let f = l.people.reduce((e, t) => (G[t] && (e[t] = G[t]), e), {});
      ((l.x = n * i.taskMargin + n * i.width + Y),
        (l.y = o),
        (l.width = i.diagramMarginX),
        (l.height = i.diagramMarginY),
        (l.colour = u),
        (l.fill = c),
        (l.num = d),
        (l.actors = f),
        U.drawTask(e, l, i, r),
        X.insert(l.x, l.y, l.x + l.width + i.taskMargin, 450));
    }
  }, `drawTasks`),
  $ = { setConf: W, draw: ee },
  ne = {
...
//# sourceMappingURL=journeyDiagram-VCZTEJTY-DY37cAR_.js.map
