            ...
            if (o)
              for (var F = this.n - 1; F >= 0; F--) {
                if (
                  ...
                  for (var I = F + 1; I < t; I++) {
                    for (var L = 0, R = F + 1; R < this.n; R++)
                      L += this.V[R][F] * this.V[R][I];
                    L = -L / this.V[F + 1][F];
                    for (var z = F + 1; z < this.n; z++)
                      this.V[z][I] += L * this.V[z][F];
                  }
                for (var B = 0; B < this.n; B++) this.V[B][F] = 0;
                this.V[F][F] = 1;
              }
            for (
              var ne = E - 1, V = 0, re = 2 ** -52, ie = 2 ** -966;
              E > 0;
              ...
              for (H = E - 2; H >= -1 && H !== -1; H--)
                if (
                  Math.abs(n[H]) <=
                  ie + re * (Math.abs(this.s[H]) + Math.abs(this.s[H + 1]))
                ) {
                  n[H] = 0;
                  break;
                }
              ...
              switch ((H++, U)) {
                case 1:
                  ...
                  n[E - 2] = 0;
                  for (var K = E - 2; K >= H; K--) {
                    var oe = r.hypot(this.s[K], G),
                      q = this.s[K] / oe,
                      se = G / oe;
                    if (
                      ((this.s[K] = oe),
                      K !== H &&
                        ((G = -se * n[K - 1]), (n[K - 1] = q * n[K - 1])),
                      o)
                    )
                      for (var J = 0; J < this.n; J++)
                        ((oe = q * this.V[J][K] + se * this.V[J][E - 1]),
                          (this.V[J][E - 1] =
                            -se * this.V[J][K] + q * this.V[J][E - 1]),
                          (this.V[J][K] = oe));
                  }
                  break;
                case 2:
                  ...
                  for (var Y = H; Y < E; Y++) {
                    ...
                    if (
                      ...
                      for (var fe = 0; fe < this.m; fe++)
                        ((le = ue * this.U[fe][Y] + de * this.U[fe][H - 1]),
                          (this.U[fe][H - 1] =
                            -de * this.U[fe][Y] + ue * this.U[fe][H - 1]),
                          (this.U[fe][Y] = le));
                  }
                  break;
                case 3:
                  var pe = Math.max(
                    ...
                    _e = this.s[H] / pe,
                    ve = n[H] / pe,
                    ye = ((he + me) * (he - me) + ge * ge) / 2,
                    be = me * ge * (me * ge),
                    xe = 0;
                  (function (e, t) {
                    return e || t;
                  })(ye !== 0, be !== 0) &&
                    ((xe = Math.sqrt(ye * ye + be)),
                    ye < 0 && (xe = -xe),
                    (xe = be / (ye + xe)));
                  for (
                    var Se = (_e + me) * (_e - me) + xe, Ce = _e * ve, X = H;
                    X < E - 1;
                    X++
                  ) {
                    var Z = r.hypot(Se, Ce),
                    ...
                    if (
                      ...
                      (n[X] = Q * n[X] - $ * this.s[X]),
                      (Ce = $ * this.s[X + 1]),
                      (this.s[X + 1] = Q * this.s[X + 1]),
                      o)
                    )
                      for (var we = 0; we < this.n; we++)
                        ((Z = Q * this.V[we][X] + $ * this.V[we][X + 1]),
                          (this.V[we][X + 1] =
                            -$ * this.V[we][X] + Q * this.V[we][X + 1]),
                          (this.V[we][X] = Z));
                    if (
                      ((Z = r.hypot(Se, Ce)),
                      (Q = Se / Z),
                      ...
                      (this.s[X] = Z),
                      (Se = Q * n[X] + $ * this.s[X + 1]),
                      (this.s[X + 1] = -$ * n[X] + Q * this.s[X + 1]),
                      (Ce = $ * n[X + 1]),
                      (n[X + 1] = Q * n[X + 1]),
                      a && X < this.m - 1)
                    )
                      for (var Te = 0; Te < this.m; Te++)
                        ((Z = Q * this.U[Te][X] + $ * this.U[Te][X + 1]),
                          (this.U[Te][X + 1] =
                            -$ * this.U[Te][X] + Q * this.U[Te][X + 1]),
                          (this.U[Te][X] = Z));
                  }
                  ((n[E - 2] = Se), (V += 1));
                  break;
                case 4:
                  if (
                    this.s[H] <= 0 &&
                    ((this.s[H] = this.s[H] < 0 ? -this.s[H] : 0), o)
                  )
                    for (var Ee = 0; Ee <= ne; Ee++)
                      this.V[Ee][H] = -this.V[Ee][H];
                  for (; H < ne && !(this.s[H] >= this.s[H + 1]); ) {
                    ...
                    if (
                      ...
                      for (var Oe = 0; Oe < this.n; Oe++)
                        ((De = this.V[Oe][H + 1]),
                          (this.V[Oe][H + 1] = this.V[Oe][H]),
                          (this.V[Oe][H] = De));
                    if (a && H < this.m - 1)
                      for (var ke = 0; ke < this.m; ke++)
                        ((De = this.U[ke][H + 1]),
                          (this.U[ke][H + 1] = this.U[ke][H]),
                          (this.U[ke][H] = De));
                    H++;
                  }
                  ((V = 0), E--);
  ...
  n = e((e, n) => {
    (function (r, i) {
      typeof e == `object` && typeof n == `object`
        ? (n.exports = i(t()))
        : typeof define == `function` && define.amd
          ? define([`layout-base`], i)
          : typeof e == `object`
            ? (e.coseBase = i(t()))
            : (r.coseBase = i(r.layoutBase));
    })(e, function (e) {
      return (() => {
        var t = {
            45: (e, t, n) => {
                ...
                if (
                        ...
                        D.get(e).forEach(function (t) {
                          t.direction == `horizontal`
                            ? (N.has(e) ? N.get(e).push(t) : N.set(e, [t]),
                              ...
                              ee.push({ left: e, right: t.id }))
                            : (P.has(e) ? P.get(e).push(t) : P.set(e, [t]),
                              P.has(t.id) || P.set(t.id, []),
                              ee.push({ top: e, bottom: t.id }));
                        });
                      }),
                        v(ee),
                        (T = !1));
                      var te = _(N, `horizontal`),
                        F = _(P, `vertical`);
                  ...
                  if (w) {
                    for (
                      ...
                      ((L[z] = o.multGamma(L[z])), (R[z] = o.multGamma(R[z])));
                    var B = o.multMat(L, o.transpose(R)),
                      ne = s.svd(B);
                    ...
                    for (var V = 0; V < c.size; V++) {
                      var re = [l[V], u[V]],
                        ie = [I[0][0], I[1][0]],
                        H = [I[0][1], I[1][1]];
                      ((l[V] = o.dotProduct(re, ie)),
                        (u[V] = o.dotProduct(re, H)));
                    }
                ...
                if (i.ENFORCE_CONSTRAINTS) {
                  if (
                    ...
                    (t.fixedNodeConstraint.forEach(function (e, t) {
                      ...
                      (U.x /= t.fixedNodeConstraint.length),
                      (U.y /= t.fixedNodeConstraint.length),
                  ...
                  if (t.alignmentConstraint) {
                    if (t.alignmentConstraint.vertical)
                      for (
                        var W = t.alignmentConstraint.vertical,
                          ae = function (e) {
                            var t = new Set();
                    ...
                    if (t.alignmentConstraint.horizontal)
                      for (
                        var K = t.alignmentConstraint.horizontal,
                          oe = function (e) {
                            var t = new Set();
                  ...
                  t.relativePlacementConstraint &&
                    (function () {
                      ...
                      var z = _(S, `horizontal`, s, a, L),
                        B = _(C, `vertical`, d, o, R),
                        ne = function (e) {
                          r.get(e)
                      ...
                      try {
                        for (
                          var H = z.keys()[Symbol.iterator](), U;
                          !(V = (U = H.next()).done);
                          V = !0
                        ) {
                          var W = U.value;
                      ...
                      try {
                        for (
                          var q = B.keys()[Symbol.iterator](), se;
                          !(G = (se = q.next()).done);
                          G = !0
                        ) {
                          var W = se.value;
    ...
    (function (r, i) {
      typeof e == `object` && typeof t == `object`
        ...
        : typeof define == `function` && define.amd
          ? define([`cose-base`], i)
          : typeof e == `object`
            ? (e.cytoscapeFcose = i(n()))
            : (r.cytoscapeFcose = i(r.coseBase));
    })(e, function (e) {
      return (() => {
        var t = {
            658: (e) => {
                        ...
                        var g = function () {
                          ...
                          for (var u = 0; u < l.length; u++) {
                            ...
                            ((c = n.intersection(d.union(d.ancestors()))),
                              c != null &&
                                !o.has(c[0]) &&
                                c.union(c.descendants()).forEach(function (e) {
                                  (a.push(e),
                                    o.add(e),
                                    r.merge(e),
                                    n.has(e) && s.push(e));
                  ...
                  var v = function (e) {
                    ...
                    S = function (t, n, r) {
                      ...
                      e.idealEdgeLength != null &&
                        ...
                        (u.DEFAULT_RADIAL_SEPARATION = l.DEFAULT_EDGE_LENGTH));
                    },
                    C = function (e, t) {
                      (t.fixedNodeConstraint &&
                  ...
                  (e.nestingFactor != null &&
                    (u.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR =
                      l.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR =
                        e.nestingFactor),
                    e.gravity != null &&
                      (u.DEFAULT_GRAVITY_STRENGTH = l.DEFAULT_GRAVITY_STRENGTH =
                        e.gravity),
                    e.numIter != null &&
                      ...
                      value: function () {
                          ...
                          t.alignmentConstraint &&
                            ...
                            t.alignmentConstraint.horizontal &&
                              (!Array.isArray(
                                ...
                                t.alignmentConstraint.horizontal.length == 0) &&
                        ...
                        if (
                          ...
                          if (f) {
                            ...
                            if (
                              (u.push({ x: O.x1 + O.w / 2, y: O.y1 + O.h / 2 }),
                              t.randomize)
                            ) {
                              var k = s(t);
                              i.push(k);
            ...
            657: (e, t, n) => {
              ...
              e.exports = {
                spectralLayout: function (e) {
                  ...
                  try {
                    for (
                      var te = c.keys()[Symbol.iterator](), F;
                      !(N = (F = te.next()).done);
                      N = !0
                    ) {
                      var I = F.value;
                  ...
                  try {
                    for (
                      var V = c.keys()[Symbol.iterator](), re;
                      !(z = (re = V.next()).done);
                      z = !0
                    ) {
                      var ie = re.value;
                    ...
                    return (
                      e.quality == `draft` || e.step == `all`
                        ? (O(C),
                          k(),
                          A(),
                          (H = { nodeIndexes: l, xCoords: f, yCoords: p }))
                        : (l.forEach(function (e, n) {
...
export { r as t };
//# sourceMappingURL=cytoscape-fcose-w_4iexyA.js.map
