...
import { t as _ } from "./chunk-FMBD7UC4-D9frSjxD.js";
import { t as v } from "./chunk-YZCP3GAM-BaYtHc5x.js";
import { t as y } from "./chunk-55IACEB6-DBIditYu.js";
import { t as b } from "./chunk-EDXVE4YY-C5jaZxVP.js";
import { r as x, t as S } from "./chunk-336JU56O-Cutebe7h.js";
var C = (function () {
  var e = t(function (e, t, n, r) {
    ...
    R = [13, 60, 86, 100, 102, 103],
    z = [13, 60, 73, 74, 86, 100, 102, 103],
    ne = [13, 60, 68, 69, 70, 71, 72, 86, 100, 102, 103],
    B = [1, 102],
    V = [1, 120],
    H = [1, 116],
    U = [1, 112],
    ...
    ie = [1, 150],
    ae = [1, 8, 9, 61],
    Q = [1, 8, 9, 22, 50, 60, 61, 82, 86, 87, 88, 89, 90],
    oe = {
      ...
      table: [
        ...
        { 39: [1, 65] },
        e(F, [2, 43], { 39: [1, 67], 44: [1, 66], 46: [1, 68] }),
        e(O, [2, 61]),
        e(O, [2, 62]),
        ...
        e(O, [2, 60]),
        { 67: 93, 73: ee, 74: P },
        e(R, [2, 79], { 66: 94, 68: k, 69: A, 70: j, 71: M, 72: N }),
        e(z, [2, 80]),
        e(z, [2, 81]),
        e(z, [2, 82]),
        e(z, [2, 83]),
        ...
        e(ne, [2, 85]),
        e(ne, [2, 86]),
        { 8: [1, 96], 24: 97, 30: 98, 40: 95, 43: 23, 48: s, 54: u, 56: d },
        { 16: 99, 60: p, 86: C, 100: w, 102: T },
        { 41: [1, 101], 45: 100, 51: B },
        ...
        e(R, [2, 78], { 66: 134, 68: k, 69: A, 70: j, 71: M, 72: N }),
        e(R, [2, 77]),
        { 41: [1, 135] },
        ...
        e(O, [2, 34]),
        { 41: [1, 156] },
        { 24: 97, 30: 98, 40: 157, 41: [2, 38], 43: 23, 48: s, 54: u, 56: d },
        { 24: 97, 30: 98, 40: 158, 41: [2, 41], 43: 23, 48: s, 54: u, 56: d },
        { 45: 159, 51: B },
        e(F, [2, 45]),
        { 41: [2, 58] },
        e(F, [2, 48], { 39: [1, 160] }),
...
` +
  ...
  return (t($, `Parser`), ($.prototype = oe), (oe.Parser = $), new $());
})();
C.parser = C;
var w = C,
  T = [`#`, `+`, `~`, `-`, ``],
    ...
    parseMember(e) {
      ...
      if (this.memberType === `method`) {
        ...
        if (n) {
          let e = n[1] ? n[1].trim() : ``;
          if (
            (T.includes(e) && (this.visibility = e),
            (this.id = n[2]),
        ...
        let n = e.length,
          r = e.substring(0, 1),
          i = e.substring(n - 1);
        (T.includes(r) && (this.visibility = r),
          /[$*]/.exec(i) && (t = i),
          (this.id = e.substring(
            this.visibility === `` ? 0 : 1,
            t === `` ? n : n - 1,
      ...
      ((this.classifier = t),
        (this.id = this.id.startsWith(` `)
          ...
          : this.id.trim()),
        (this.text =
          `${this.visibility ? `\\` + this.visibility : ``}${m(this.id)}${this.memberType === `method` ? `(${m(this.parameters)})${this.returnType ? ` : ` + m(this.returnType) : ``}` : ``}`
            .replaceAll(`<`, `&lt;`)
            .replaceAll(`>`, `&gt;`)),
  ...
  D = `classId-`,
  O = 0,
  k = t((e) => h.sanitizeText(e, p()), `sanitizeText`),
  A = class {
    constructor() {
      ((this.relations = []),
        ...
        (this.getConfig = t(() => p().class, `getConfig`)),
    ...
    addRelation(t) {
      ...
      !n.includes(t.relation.type2)
        ...
        (t.relationTitle1 = h.sanitizeText(t.relationTitle1.trim(), p())),
        (t.relationTitle2 = h.sanitizeText(t.relationTitle2.trim(), p())),
    ...
    addMember(e, t) {
      ...
      if (typeof t == `string`) {
        ...
        e.startsWith(`<<`) && e.endsWith(`>>`)
          ? r.annotations.push(k(e.substring(2, e.length - 2)))
          : e.indexOf(`)`) > 0
            ? r.methods.push(new E(e, `method`))
            : e && r.members.push(new E(e, `attribute`));
      }
    }
    addMembers(e, t) {
    ...
    cleanupLabel(e) {
      return (e.startsWith(`:`) && (e = e.substring(1)), k(e.trim()));
    }
    setCssClass(e, t) {
      e.split(`,`).forEach((e) => {
        let n = e;
    ...
    setTooltip(e, t) {
      e.split(`,`).forEach((e) => {
        t !== void 0 && (this.classes.get(e).tooltip = k(t));
      });
    }
    getTooltip(e, t) {
    ...
    setCssStyle(e, t) {
      ...
      if (!(!t || !n))
        for (let e of t)
          e.includes(`,`) ? n.styles.push(...e.split(`,`)) : n.styles.push(e);
    }
    getArrowMarker(e) {
      let t;
      switch (e) {
    ...
    getData() {
      ...
      for (let e of this.relations) {
        r++;
        let a = {
          id: i(e.id1, e.id2, { prefix: `id`, counter: r }),
          start: e.id1,
          end: e.id2,
          type: `normal`,
          label: e.title,
...
`,
  ...
  M = {
    ...
    draw: t(async function (t, n, i, a) {
      ...
      let { securityLevel: o, state: s, layout: c } = p();
      a.db.setDiagramId(n);
      let l = a.db.getData(),
        u = y(n, o);
      ((l.type = a.type),
        (l.layoutAlgorithm = S(c)),
        ...
        b(u, 8, `classDiagram`, s?.useMaxWidth ?? !0));
    }, `draw`),
    getDir: t((e, t = `TB`) => {
      if (!e.doc) return t;
      let n = t;
...
//# sourceMappingURL=chunk-4TB4RGXK-dwuD3qB1.js.map
