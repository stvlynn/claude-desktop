...
import { n as oe, t as T } from "./artifact-preview-status-jgtoNhXT.js";
function E(e) {
  let t = z.safeParse(e);
  if (!t.success)
    throw Error(`Notebook must be a JSON object with a cells array`);
  return { cells: t.data.cells.map(se), title: O(t.data.metadata, `title`) };
}
function se(e) {
  let t = D(e.source),
    n = e.id ?? null,
...
var M,
  ...
  B = e(() => {
    (u(),
      ...
      (R = t({
        cell_type: o(),
        execution_count: i().int().nullable().optional(),
        id: o().optional(),
        metadata: F.optional(),
        outputs: l(L).optional(),
        source: I,
      }).passthrough()),
      (z = t({ cells: l(R), metadata: F.optional() }).passthrough()));
  });
function V(e) {
...
function fe(e) {
  ...
  let g;
  t[13] !== i || t[14] !== a
    ? ((g = (0, $.jsx)(te, { hostId: i, path: a })),
      (t[13] = i),
      (t[14] = a),
      (t[15] = g))
    : (g = t[15]);
  let _;
  t[16] !== r || t[17] !== h || t[18] !== g
    ? ((_ = (0, $.jsxs)(`div`, {
...
function ge(e) {
  ...
  return (
    t[22] !== d || t[23] !== m
      ? ((h = (0, $.jsxs)($.Fragment, { children: [d, m] })),
        (t[22] = d),
        (t[23] = m),
        (t[24] = h))
      : (h = t[24]),
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, $.jsxs)(`summary`, {
        ...
        children: [
          ...
          (0, $.jsx)(g, { className: `icon-2xs shrink-0` }),
          (0, $.jsx)(`span`, {
            children: (0, $.jsx)(C, {
...
//# sourceMappingURL=notebook-preview-panel-Bk0oKCgu.js.map
