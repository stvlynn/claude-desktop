...
import "./chunk-5PVQY5BW-DEldFBPA.js";
import {
  $ as n,
  K as r,
  L as i,
...
import { t as l } from "./chunk-426QAEUC-DSM9qwar.js";
import "./dist-BO3qvbGN.js";
import "./chunk-U2HBQHQK-Di_FkPOF.js";
import { t as u } from "./chunk-FMBD7UC4-D9frSjxD.js";
import "./chunk-ZZ45TVLE-B85K-is4.js";
import "./chunk-X2U36JSP-BczALf5_.js";
import { a as d, c as f, i as p } from "./chunk-5FUZZQ4R-CaM4fbt9.js";
import { n as m, t as h } from "./chunk-XPW4576I-D84Ovjf9.js";
var g = (function () {
        ...
        switch (i) {
          ...
          case 20:
            (r.getLogger().trace(`Node: `, a[s - 1].id),
              r.addNode(0, a[s - 1].id, a[s - 1].descr, a[s - 1].type, a[s]));
            break;
          case 21:
...
` +
  ...
  return (t(S, `Parser`), (S.prototype = x), (x.Parser = S), new S());
})();
g.parser = g;
var _ = g,
  v = [],
  ...
  C = t((e) => {
    ...
    for (let e = v.length - 1; e >= 0; e--)
      if ((v[e].level === t && !n && (n = v[e]), v[e].level < t))
        throw Error(
  ...
  T = t(function () {
    ...
    for (let e of n) {
      ...
      t.push(n);
      let a = v.filter((t) => t.parentId === e.id);
      for (let n of a) {
        let a = {
          id: n.id,
          parentId: e.id,
    ...
    return { nodes: t, edges: e, other: {}, config: o() };
  }, `getData`),
  E = t((e, t, n, r, a) => {
    let c = o(),
      l = c.mindmap?.padding ?? s.mindmap.padding;
    switch (r) {
      case D.ROUNDED_RECT:
      case D.RECT:
      case D.HEXAGON:
    ...
    let u = {
      ...
      level: e,
      label: i(n, c),
      width: c.mindmap?.maxNodeWidth ?? s.mindmap.maxNodeWidth,
      padding: l,
      isGroup: !1,
    };
    if (a !== void 0) {
...
` +
      ...
      (t?.shape && t.shape === `kanbanItem` && (u.shape = t?.shape),
        t?.label && (u.label = t?.label),
        t?.icon && (u.icon = t?.icon.toString()),
        t?.assigned && (u.assigned = t?.assigned.toString()),
        t?.ticket && (u.ticket = t?.ticket.toString()),
        t?.priority && (u.priority = t?.priority));
    }
    let d = C(e);
    (d ? (u.parentId = d.id || `kbn` + b++) : y.push(u), v.push(u));
  }, `addNode`),
  D = {
    DEFAULT: 0,
    NO_BORDER: 0,
  ...
  O = {
    ...
    getType: t((t, n) => {
      switch ((e.debug(`In get type`, t, n), t)) {
        case `[`:
          return D.RECT;
        case `(`:
          return n === `)` ? D.ROUNDED_RECT : D.CLOUD;
        case `((`:
          return D.CIRCLE;
        case `)`:
          return D.CLOUD;
    ...
    decorateNode: t((e) => {
      ...
      let t = o(),
        n = v[v.length - 1];
      (e.icon && (n.icon = i(e.icon, t)),
        e.class && (n.cssClasses = i(e.class, t)));
    }, `decorateNode`),
    type2Str: t((e) => {
      switch (e) {
        case D.DEFAULT:
    ...
    getElementById: t((e) => x[e], `getElementById`),
  },
  k = {
    draw: t(async (t, n, i, a) => {
      e.debug(
...
` + t,
      ...
      u.htmlLabels = !1;
      let m = l(n);
      for (let e of c.nodes) e.domId = `${n}-${e.id}`;
      let h = m.append(`g`);
      h.attr(`class`, `sections`);
      let g = m.append(`g`);
      g.attr(`class`, `items`);
      let _ = c.nodes.filter((e) => e.isGroup),
        v = 0,
        y = [],
        b = 25;
      for (let e of _) {
        ...
        ((v += 1),
          ...
          (e.rx = 5),
          (e.ry = 5),
          (e.cssClasses = e.cssClasses + ` section-` + v));
        let n = await p(h, e);
      ...
      for (let e of _) {
        let t = y[x];
        x += 1;
        let n = u?.kanban?.sectionWidth || 200,
          r = (-n * 3) / 2 + b,
          i = r,
          a = c.nodes.filter((t) => t.parentId === e.id);
        for (let t of a) {
          if (t.isGroup)
            throw Error(
          ...
          let r = (await d(g, t, { config: u })).node().getBBox();
          ((t.y = i + r.height / 2),
            await f(t),
            (i = t.y + r.height / 2 + 10 / 2));
        }
        let o = t.cluster.select(`rect`),
          s = Math.max(i - r + 30, 50) + (b - 25);
        o.attr(`height`, s);
      }
      r(
        void 0,
        m,
        u.mindmap?.padding ?? s.kanban.padding,
        u.mindmap?.useMaxWidth ?? s.kanban.useMaxWidth,
      );
    }, `draw`),
  },
  A = t((e) => {
    ...
    let i = t((t, r) => (e.darkMode ? a(t, r) : n(t, r)), `adjuster`);
    for (let t = 0; t < e.THEME_COLOR_LIMIT; t++) {
      let n = `` + (17 - 3 * t);
      r += `
...
export { j as diagram };
//# sourceMappingURL=kanban-definition-6JOO6SKY-o31w_Pvs.js.map
