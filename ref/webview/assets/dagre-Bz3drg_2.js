...
import {
  ...
  x as te,
  y as T,
} from "./runtime.worker-1YasDKq2.js";
import { t as E } from "./graphlib-BnZ9Pn5Q.js";
var ne = class {
  constructor() {
    var e = {};
...
function oe(e, t) {
  ...
  var n = ce(e, t || ae);
  return w(
    s(se(n.graph, n.buckets, n.zeroIdx), function (t) {
...
function se(e, t, n) {
  for (var r = [], i = t[t.length - 1], a = t[0], o; e.nodeCount(); ) {
    for (; (o = a.dequeue()); ) D(e, t, n, o);
    for (; (o = i.dequeue()); ) D(e, t, n, o);
    if (e.nodeCount()) {
      for (var s = t.length - 2; s > 0; --s)
        if (((o = t[s].dequeue()), o)) {
          r = r.concat(D(e, t, n, o, !0));
          break;
        }
    }
  }
...
function D(e, t, n, i, a) {
  ...
  return (
    r(e.inEdges(i.v), function (r) {
      var i = e.edge(r),
        s = e.node(r.v);
      (a && o.push({ v: r.v, w: r.w }), (s.out -= i), O(t, n, s));
    }),
...
function le(e) {
  r(e.graph().acyclicer === `greedy` ? oe(e, t(e)) : ue(e), function (t) {
    var n = e.edge(t);
    (e.removeEdge(t),
...
function A(e) {
  var t = new E({ multigraph: e.isMultigraph() }).setGraph(e.graph());
  return (
    r(e.nodes(), function (n) {
  ...
  function t(n) {
    ...
    if (
      ...
      for (var o = a.minRank, s = a.maxRank + 1; o < s; ++o)
        (F(e, `borderLeft`, `_bl`, n, a, o),
          F(e, `borderRight`, `_br`, n, a, o));
    }
  }
  r(e.children(), t);
}
...
function Ce(e) {
  (r(e.nodes(), function (t) {
    ...
    r(e.edges(), function (t) {
      var n = e.edge(t);
      (r(n.points, I), Object.prototype.hasOwnProperty.call(n, `y`) && I(n));
    }));
}
function I(e) {
  e.y = -e.y;
...
function we(e) {
  (r(e.nodes(), function (t) {
    ...
    r(e.edges(), function (t) {
      var n = e.edge(t);
      (r(n.points, L), Object.prototype.hasOwnProperty.call(n, `x`) && L(n));
    }));
}
function L(e) {
  var t = e.x;
...
(e(1), e(1), (je.CycleException = V));
function je(e) {
  var t = {},
    n = {},
    i = [];
  function a(o) {
    if (Object.prototype.hasOwnProperty.call(n, o)) throw new V();
  ...
  if ((r(e.sinks(), a), c(t) !== e.nodeCount())) throw new V();
  return i;
}
function V() {}
V.prototype = Error();
...
function J(e, t, n, i, a) {
  ...
  return (
    ...
    r(e.neighbors(i), function (r) {
      Object.prototype.hasOwnProperty.call(t, r) || (n = J(e, t, n, r, i));
    }),
    (s.low = o),
    (s.lim = n++),
  ...
  return (
    ...
    u(
      a(t.edges(), function (t) {
        return l === Re(e, e.node(t.v), c) && l !== Re(e, e.node(t.w), c);
      }),
      function (e) {
        return z(t, e);
      },
...
function $e(e) {
  ...
  function o(n) {
    _(t, n) || ((t[n] = !0), i[e.node(n).rank].push(n), r(e.successors(n), o));
  }
  return (
    r(
      h(n, function (t) {
...
function tt(e, t) {
  ...
  return (
    r(e, function (e, t) {
      ...
      f(e.barycenter) || ((r.barycenter = e.barycenter), (r.weight = e.weight));
    }),
    r(t.edges(), function (e) {
      var t = n[e.v],
        r = n[e.w];
      !f(t) && !f(r) && (r.indegree++, t.out.push(n[e.w]));
    }),
    nt(
      a(n, function (e) {
        return !e.indegree;
...
function nt(e) {
  ...
  function n(e) {
    return function (t) {
      t.merged ||
        ((f(t.barycenter) || f(e.barycenter) || t.barycenter >= e.barycenter) &&
          rt(e, t));
    };
  }
  function i(t) {
  ...
  return s(
    ...
    function (e) {
      return x(e, [`vs`, `i`, `barycenter`, `weight`]);
    },
  );
}
function rt(e, t) {
...
function at(e, t, n) {
  for (var r; t.length && (r = T(t)).i <= n; ) (t.pop(), e.push(r.vs), n++);
  return n;
}
function ot(e) {
  return function (t, n) {
...
function st(e, t, n, i) {
  ...
  ct(f, u);
  var p = it(f, i);
  if (c && ((p.vs = w([c, p.vs, l])), e.predecessors(c).length)) {
    var m = e.node(e.predecessors(c)[0]),
      h = e.node(e.predecessors(l)[0]);
    (Object.prototype.hasOwnProperty.call(p, `barycenter`) ||
      ((p.barycenter = 0), (p.weight = 0)),
      (p.barycenter =
        (p.barycenter * p.weight + m.order + h.order) / (p.weight + 2)),
      (p.weight += 2));
  }
  return p;
}
...
function ut(e) {
  var t = P(e),
    n = Z(e, y(1, t + 1), `inEdges`),
    r = Z(e, y(t - 1, -1, -1), `outEdges`),
    i = $e(e);
  ft(e, i);
  for (var a = 1 / 0, s, c = 0, l = 0; l < 4; ++c, ++l) {
    (dt(c % 2 ? n : r, c % 4 >= 2), (i = M(e)));
    var u = Ze(e, i);
    u < a && ((l = 0), (s = o(i)), (a = u));
  }
  ft(e, s);
  ...
  function a(t, i) {
    ...
    return (
      r(i, function (t, l) {
        ...
        (u || t === c) &&
          (r(i.slice(o, l + 1), function (t) {
            r(e.predecessors(t), function (r) {
              var i = e.node(r),
                o = i.order;
              (o < a || d < o) && !(i.dummy && e.node(t).dummy) && yt(n, r, t);
            });
          }),
          (o = l + 1),
          (a = d));
      ...
      ((c = t[i]),
        e.node(c).dummy &&
          r(e.predecessors(c), function (t) {
            var r = e.node(t);
            r.dummy && (r.order < o || r.order > s) && yt(n, t, c);
          }));
    });
  }
  function o(t, n) {
...
function Ut(e) {
  var n = new E({ multigraph: !0, compound: !0 }),
    i = $(e.graph());
  return (
    n.setGraph(t({}, It, Q(i, Ft), x(i, Lt))),
    r(e.nodes(), function (t) {
      var r = $(e.node(t));
      (n.setNode(t, l(Q(r, Rt), zt)), n.setParent(t, e.parent(t)));
    }),
    r(e.edges(), function (r) {
      var i = $(e.edge(r));
      n.setEdge(r, t({}, Vt, Q(i, Bt), x(i, Ht)));
    }),
    n
  );
}
  ...
  (r(e.nodes(), function (t) {
    if (e.children(t).length) {
      var n = e.node(t),
        ...
        a = e.node(T(n.borderLeft)),
        o = e.node(T(n.borderRight));
...
export { Mt as t };
//# sourceMappingURL=dagre-Bz3drg_2.js.map
