...
function _(e) {
  ...
  let V = R
    ...
    H;
  t[10] === V ? (H = t[11]) : ((H = s(V)), (t[10] = V), (t[11] = H));
  let U;
  t[12] !== P ||
  t[13] !== n ||
  t[14] !== f ||
  ...
  t[26] === o
    ? (q = t[27])
    : ((q = s(`mx-auto w-full max-w-[var(--thread-content-max-width)]`, o)),
      (t[26] = o),
      (t[27] = q));
  let J;
  t[28] !== i || t[29] !== q
...
function b(e) {
  let t = (0, x.c)(11),
    ...
    d = c === `vertical` ? `hidden lg:block lg:self-start` : `w-full`,
    f;
  t[0] !== r ||
  t[1] !== n ||
  t[2] !== o ||
...
//# sourceMappingURL=sectioned-page-BgyNiIIs.js.map
