...
import { a as s, o as c, s as l, t as u } from "./esm-SB_gc9_7.js";
function d(e, t) {
  return (
    (t ||= {}),
      ...
      switch (e.label) {
        case 0:
          ((s = Z(t, { clone: !0, traverse: !1 }).rawEvent()),
            ...
            (e.label = 1));
        case 1:
          return c < l.length ? ((u = l[c]), [4, a(s, u)]) : [3, 4];
        case 2:
...
//# sourceMappingURL=middleware-CcPovR3s.js.map
