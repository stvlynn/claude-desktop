...
import { i as n, n as r, r as i } from "./chunk-AGHRB4JF-DJZonIPK.js";
import {
  B as a,
  C as o,
  L as s,
...
import { n as v, t as y } from "./src-CTe_6Jg1.js";
function b(e) {
...
function L() {
  let { themeVariables: e, quadrantChart: t } = p();
  return (
    t && H.setConfig(t),
    H.setThemeConfig({
    ...
    (R = (function () {
      var e = r(function (e, t, n, r) {
        ...
        fe = {
          ...
          table: [
            { 18: t, 26: 1, 27: 2, 28: n, 55: i, 56: a, 57: o },
            { 1: [3] },
            { 18: t, 26: 8, 27: 2, 28: n, 55: i, 56: a, 57: o },
            { 18: t, 26: 9, 27: 2, 28: n, 55: i, 56: a, 57: o },
            e(s, [2, 33], { 29: 10 }),
            e(c, [2, 61]),
            e(c, [2, 62]),
            e(c, [2, 63]),
...
` +
      ...
      return (r(pe, `Parser`), (pe.prototype = fe), (fe.Parser = pe), new pe());
    })()),
    (R.parser = R),
    (z = R),
    (B = c()),
    (ee = class {
      ...
      getDefaultConfig() {
        return {
          ...
          showYAxis: !0,
          showTitle: !0,
          chartHeight: h.quadrantChart?.chartWidth || 500,
          chartWidth: h.quadrantChart?.chartHeight || 500,
          titlePadding: h.quadrantChart?.titlePadding || 10,
          titleFontSize: h.quadrantChart?.titleFontSize || 20,
          quadrantPadding: h.quadrantChart?.quadrantPadding || 5,
          xAxisLabelPadding: h.quadrantChart?.xAxisLabelPadding || 5,
          yAxisLabelPadding: h.quadrantChart?.yAxisLabelPadding || 5,
          xAxisLabelFontSize: h.quadrantChart?.xAxisLabelFontSize || 16,
          yAxisLabelFontSize: h.quadrantChart?.yAxisLabelFontSize || 16,
          quadrantLabelFontSize: h.quadrantChart?.quadrantLabelFontSize || 16,
          quadrantTextTopPadding: h.quadrantChart?.quadrantTextTopPadding || 5,
          pointTextPadding: h.quadrantChart?.pointTextPadding || 5,
          pointLabelFontSize: h.quadrantChart?.pointLabelFontSize || 12,
          pointRadius: h.quadrantChart?.pointRadius || 5,
          xAxisPosition: h.quadrantChart?.xAxisPosition || `top`,
          yAxisPosition: h.quadrantChart?.yAxisPosition || `left`,
          quadrantInternalBorderStrokeWidth:
            h.quadrantChart?.quadrantInternalBorderStrokeWidth || 1,
          quadrantExternalBorderStrokeWidth:
            h.quadrantChart?.quadrantExternalBorderStrokeWidth || 2,
        };
      }
      ...
      setConfig(e) {
        (n.trace(`setConfig called with: `, e),
          (this.config = { ...this.config, ...e }));
      }
      setThemeConfig(e) {
        (n.trace(`setThemeConfig called with: `, e),
    ...
    r(b, `validateHexCode`),
    r(x, `validateNumber`),
    r(S, `validateSizeInPixels`),
    (te = p()),
    r(C, `textSanitizer`),
    (H = new ee()),
    r(w, `setQuadrant1Text`),
    r(T, `setQuadrant2Text`),
    r(E, `setQuadrant3Text`),
    r(D, `setQuadrant4Text`),
    r(O, `setXAxisLeftText`),
    r(k, `setXAxisRightText`),
    r(A, `setYAxisTopText`),
    r(j, `setYAxisBottomText`),
    r(M, `parseStyles`),
    r(N, `addPoint`),
    r(P, `addClass`),
    r(F, `setWidth`),
...
` + e,
          ...
          u === `sandbox` && (d = v(`#i` + t));
          let f = v(
              u === `sandbox` ? d.nodes()[0].contentDocument.body : `body`,
            ).select(`[id="${t}"]`),
            h = f.append(`g`).attr(`class`, `main`),
            g = l.quadrantChart?.chartWidth ?? 500,
            _ = l.quadrantChart?.chartHeight ?? 500;
          (m(f, _, g, l.quadrantChart?.useMaxWidth ?? !0),
            f.attr(`viewBox`, `0 0 ` + g + ` ` + _),
            a.db.setHeight(_),
            a.db.setWidth(g));
          let y = a.db.getQuadrantData(),
            b = h.append(`g`).attr(`class`, `quadrants`),
            x = h.append(`g`).attr(`class`, `border`),
            S = h.append(`g`).attr(`class`, `data-points`),
            C = h.append(`g`).attr(`class`, `labels`),
            w = h.append(`g`).attr(`class`, `title`);
          (y.title &&
            w
              .append(`text`)
              .attr(`x`, 0)
              ...
              .attr(`dominant-baseline`, o(y.title.horizontalPos))
              .attr(`text-anchor`, s(y.title.verticalPos))
              .attr(`transform`, c(y.title))
              .text(y.title.text),
            y.borderLines &&
              x
                .selectAll(`line`)
          ...
          (T.append(`rect`)
            ...
            T.append(`text`)
              ...
              .attr(`dominant-baseline`, (e) => o(e.text.horizontalPos))
              .attr(`text-anchor`, (e) => s(e.text.verticalPos))
              .attr(`transform`, (e) => c(e.text))
              .text((e) => e.text.text),
            C.selectAll(`g.label`)
              .data(y.axisLabels)
              .enter()
              ...
              .attr(`dominant-baseline`, (e) => o(e.horizontalPos))
              .attr(`text-anchor`, (e) => s(e.verticalPos))
              .attr(`transform`, (e) => c(e)));
...
//# sourceMappingURL=quadrantDiagram-AYHSOK5B-BzeqrmeH.js.map
