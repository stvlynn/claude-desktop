...
import { i as S, n as C, o as w, r as T } from "./chunk-AGHRB4JF-DJZonIPK.js";
import {
  B as E,
  C as D,
  V as O,
...
import { i as ie, n as ae, r as oe, t as se } from "./src-CTe_6Jg1.js";
import { t as ce } from "./dist-CD74BDfk.js";
import { g as le, u as ue } from "./chunk-S3R3BYOJ-BBYtiirL.js";
var de = n((e, t) => {
    (function (n, r) {
...
` +
      ...
      return (C(O, `Parser`), (O.prototype = D), (D.Parser = O), new O());
    })()),
    (F.parser = F),
    (ye = F),
    N.default.extend(ge.default),
    N.default.extend(_e.default),
    N.default.extend(ve.default),
    (be = { friday: 5, saturday: 6 }),
    (I = ``),
    (L = ``),
    (R = void 0),
    (z = ``),
    ...
    (G = ``),
    (K = ``),
    (xe = [`active`, `done`, `crit`, `milestone`, `vert`]),
    (q = []),
    (J = !1),
    (Se = !1),
    (Ce = `sunday`),
    ...
    (Qe = C(function (e, t, n, r) {
      if (!n.length || e.manualEndTime) return;
      let i;
      ((i =
        e.startTime instanceof Date
          ? (0, N.default)(e.startTime)
          : (0, N.default)(e.startTime, t, !0)),
        (i = i.add(1, `d`)));
      let a;
      a =
        e.endTime instanceof Date
          ? (0, N.default)(e.endTime)
          : (0, N.default)(e.endTime, t, !0);
      let [o, s] = $e(i, a, t, n, r);
      ((e.endTime = o.toDate()), (e.renderEndTime = s));
    }, `checkTaskDates`)),
    ($e = C(function (e, t, n, r, i) {
      let a = !1,
        o = null;
      for (; e <= t; )
        (a || (o = t.toDate()),
    ...
    (et = C(function (e, t, n) {
      ...
      let i = (0, N.default)(n, t.trim(), !0);
      if (i.isValid()) return i.toDate();
      {
        (S.debug(`Invalid date:` + n), S.debug(`With date format:` + t.trim()));
        let e = new Date(n);
        if (
          e === void 0 ||
          isNaN(e.getTime()) ||
    ...
    (rt = 0),
    (X = C(function (e) {
      return e === void 0 ? ((rt += 1), `task` + rt) : e;
    }, `parseId`)),
    (it = C(function (e, t) {
      let n;
      ...
      switch (r.length) {
        case 1:
          ((i.id = X()), (i.startTime = e.endTime), (a = r[0]));
          break;
        case 2:
          ((i.id = X()), (i.startTime = et(void 0, I, r[0])), (a = r[1]));
          break;
        case 3:
          ((i.id = X(r[0])), (i.startTime = et(void 0, I, r[1])), (a = r[2]));
          break;
        default:
      }
      return (
        a &&
          ((i.endTime = nt(i.startTime, I, a, J)),
          (i.manualEndTime = (0, N.default)(a, `YYYY-MM-DD`, !0).isValid()),
          Qe(i, I, V, B)),
        i
      );
    }, `compileData`)),
      ...
      let e = C(function (e) {
          ...
          switch (Z[e].raw.startTime.type) {
            case `prevTaskEnd`:
              ...
              break;
            case `getStartDate`:
              ((n = et(void 0, I, Z[e].raw.startTime.startData)),
                n && (Z[e].startTime = n));
              break;
          }
          return (
            Z[e].startTime &&
              ((Z[e].endTime = nt(Z[e].startTime, I, Z[e].raw.endTime.data, J)),
              Z[e].endTime &&
                ((Z[e].processed = !0),
                (Z[e].manualEndTime = (0, N.default)(
    ...
    (ft = C(function (e, t) {
      let n = t;
      (M().securityLevel !== `loose` && (n = (0, he.sanitizeUrl)(t)),
    ...
    (mt = C(function (e, t, n) {
      if (M().securityLevel !== `loose` || t === void 0) return;
      let r = [];
      if (typeof n == `string`) {
        r = n.split(/,(?=(?:(?:[^"]*"){2})*[^"]*$)/);
    ...
    (gt = {
      getConfig: C(() => M().gantt, `getConfig`),
      clear: Te,
      setDateFormat: Me,
      getDateFormat: ze,
      enableInclusiveEndDates: Ne,
      endDatesAreInclusive: Pe,
      enableTopAxis: Fe,
      topAxisEnabled: Ie,
      setAxisFormat: Ee,
      getAxisFormat: De,
      ...
      setExcludes: He,
      getExcludes: Ue,
      setClickEvent: C(function (e, t, n) {
        (e.split(`,`).forEach(function (e) {
          mt(e, t, n);
        }),
          pt(e, `clickable`));
    ...
    (bt = {
      ...
      renderer: {
        setConf: _t,
        draw: C(function (e, t, n, s) {
          let c = M().gantt,
            l = M().securityLevel,
            h;
          l === `sandbox` && (h = ae(`#i` + t));
          let v = ae(
              l === `sandbox` ? h.nodes()[0].contentDocument.body : `body`,
            ),
            b = l === `sandbox` ? h.nodes()[0].contentDocument : document,
            x = b.getElementById(t);
          (($ = x.parentElement.offsetWidth),
            $ === void 0 && ($ = 1200),
            c.useWidth !== void 0 && ($ = c.useWidth));
          let w = s.db.getTasks(),
            T = [];
          for (let e of w) T.push(e.type);
          T = ue(T);
          let E = {},
            D = 2 * c.topPadding;
          if (
            s.db.getDisplayMode() === `compact` ||
            c.displayMode === `compact`
          ) {
            let e = {};
            for (let t of w)
              e[t.section] === void 0
            ...
            for (let n of Object.keys(e)) {
              let r = yt(e[n], t) + 1;
              ((t += r), (D += r * (c.barHeight + c.barGap)), (E[n] = r));
            }
          } else {
            D += w.length * (c.barHeight + c.barGap);
            for (let e of T) E[e] = w.filter((t) => t.type === e).length;
          }
          x.setAttribute(`viewBox`, `0 0 ` + $ + ` ` + D);
          let O = v.select(`[id="${t}"]`),
            k = u()
              .domain([
                a(w, function (e) {
              ...
              .rangeRound([0, $ - c.leftPadding - c.rightPadding]);
          function A(e, t) {
            let n = e.startTime,
              r = t.startTime,
              i = 0;
          ...
          (C(A, `taskCompare`),
            w.sort(A),
            j(w, $, D),
            ee(O, D, $, c.useMaxWidth),
            O.append(`text`)
              .text(s.db.getDiagramTitle())
              .attr(`x`, $ / 2)
              .attr(`y`, c.titleTopMargin)
          ...
          function j(e, t, n) {
            let a = c.barHeight,
              ...
              d = r()
                ...
                .range([`#00B9FA`, `#F95002`])
                .interpolate(i);
            (re(o, l, u, t, n, e, s.db.getExcludes(), s.db.getIncludes()),
              se(u, l, t, n),
              te(e, o, l, u, a, d, t, n),
              ce(o, l, u, a, d),
              le(u, l, t, n));
          ...
          function te(e, n, r, i, a, o, l) {
            ...
            O.append(`g`)
              ...
              .attr(`width`, function () {
                return l - c.rightPadding / 2;
              })
              .attr(`height`, n)
              .attr(`class`, function (e) {
                for (let [t, n] of T.entries())
                  if (e.type === n)
                    return `section section` + (t % c.numberSectionStyles);
                return `section section0`;
              })
              .enter();
            let d = O.append(`g`).selectAll(`rect`).data(e).enter(),
              f = s.db.getLinks();
            if (
              (d
                .append(`rect`)
                ...
                .attr(`y`, function (e, t) {
                  return (
                    (t = e.order),
                    e.vert ? c.gridLineStartPadding : t * n + r
                  );
                })
                .attr(`width`, function (e) {
                  return e.milestone
                    ...
                    : e.vert
                      ? 0.08 * a
                      : k(e.renderEndTime || e.endTime) - k(e.startTime);
                })
                .attr(`height`, function (e) {
                  return e.vert
                    ? w.length * (c.barHeight + c.barGap) + c.barHeight * 2
                    : a;
                })
                ...
                .attr(`class`, function (e) {
                  ...
                  let n = 0;
                  for (let [t, r] of T.entries())
                    e.type === r && (n = t % c.numberSectionStyles);
                  let r = ``;
                  return (
                    e.active
                      ? e.crit
              ...
              d
                ...
                .attr(`x`, function (e) {
                  let t = k(e.startTime),
                    n = k(e.renderEndTime || e.endTime);
                  if (
                    (e.milestone &&
                      ((t += 0.5 * (k(e.endTime) - k(e.startTime)) - 0.5 * a),
                      (n = t + a)),
                    e.vert)
                  )
                    return k(e.startTime) + i;
                  let r = this.getBBox().width;
                  return r > n - t
                    ? n + r + 1.5 * c.leftPadding > l
                      ? t + i - 5
                      : n + i + 5
                    : (n - t) / 2 + t + i;
                })
                .attr(`y`, function (e, t) {
                  return e.vert
                    ? c.gridLineStartPadding +
                        w.length * (c.barHeight + c.barGap) +
                        60
                    : ((t = e.order),
                      t * n + c.barHeight / 2 + (c.fontSize / 2 - 2) + r);
                })
                .attr(`text-height`, a)
                .attr(`class`, function (e) {
                  let t = k(e.startTime),
                  ...
                  let o = 0;
                  for (let [t, n] of T.entries())
                    e.type === n && (o = t % c.numberSectionStyles);
                  let s = ``;
                  return (
                    e.active &&
                      (s = e.crit ? `activeCritText` + o : `activeText` + o),
                    e.done
                      ? (s = e.crit
                          ? s + ` doneCritText` + o
                          : s + ` doneText` + o)
                      : e.crit && (s = s + ` critText` + o),
                    e.milestone && (s += ` milestoneText`),
                    e.vert && (s += ` vertText`),
                    r > n - t
                      ? n + r + 1.5 * c.leftPadding > l
                        ? i +
                        ...
                        : i +
                          ...
                          ` width-` +
                          r
                      : i + ` taskText taskText` + o + ` ` + s + ` width-` + r
                  );
                }),
          ...
          function re(e, t, n, r, i, a, o, l) {
            ...
            for (let { startTime: e, endTime: t } of a)
              ((u === void 0 || e < u) && (u = e),
                (d === void 0 || t > d) && (d = t));
            if (!u || !d) return;
            if ((0, P.default)(d).diff((0, P.default)(u), `year`) > 5) {
              S.warn(
                `The difference between the min and max time is more than 5 years. This will cause performance issues. Skipping drawing exclude days.`,
              );
              return;
            }
            let f = s.db.getDateFormat(),
              p = [],
              m = null,
              h = (0, P.default)(u);
            for (; h.valueOf() <= d; )
              (s.db.isInvalidDate(h, f, o, l)
                ? m
                  ? (m.end = h)
                  : (m = { start: h, end: h })
                : (m &&= (p.push(m), null)),
            ...
            O.append(`g`)
              ...
              .attr(`x`, (e) => k(e.start.startOf(`day`)) + n)
              .attr(`y`, c.gridLineStartPadding)
              .attr(
                `width`,
                (e) => k(e.end.endOf(`day`)) - k(e.start.startOf(`day`)),
              )
              .attr(`height`, i - t - c.gridLineStartPadding)
              .attr(`transform-origin`, function (t, r) {
                return (
                  (k(t.start) + n + 0.5 * (k(t.end) - k(t.start))).toString() +
                  `px ` +
                  (r * e + 0.5 * i).toString() +
                  `px`
                );
          ...
          C(re, `drawExcludeDays`);
          function se(e, t, n, r) {
            let i = s.db.getDateFormat(),
              a = s.db.getAxisFormat(),
              o;
            o = a || (i === `D` ? `%d` : (c.axisFormat ?? `%Y-%m-%d`));
            let l = oe(k)
                .tickSize(-r + t + c.gridLineStartPadding)
                .tickFormat(_(o)),
              u =
                /^([1-9]\d*)(millisecond|second|minute|hour|day|week|month)$/.exec(
                  s.db.getTickInterval() || c.tickInterval,
                );
            if (u !== null) {
              let e = u[1],
                t = u[2],
                n = s.db.getWeekday() || c.weekday;
              switch (t) {
                case `millisecond`:
                  l.ticks(f.every(e));
                  break;
          ...
          function ce(e, t) {
            let n = 0,
              r = Object.keys(E).map((e) => [e, E[e]]);
            O.append(`g`)
              .selectAll(`text`)
              .data(r)
              .enter()
              .append(function (e) {
                let t = e[0].split(ne.lineBreakRegex),
                  n = -(t.length - 1) / 2,
                  r = b.createElementNS(`http://www.w3.org/2000/svg`, `text`);
                r.setAttribute(`dy`, n + `em`);
                for (let [e, n] of t.entries()) {
                  let t = b.createElementNS(
              ...
              .attr(`font-size`, c.sectionFontSize)
              .attr(`class`, function (e) {
                for (let [t, n] of T.entries())
                  if (e[0] === n)
                    return (
                      `sectionTitle sectionTitle` + (t % c.numberSectionStyles)
                    );
                return `sectionTitle`;
              });
          }
          ...
          function le(e, t, n, r) {
            ...
            (l
              .attr(`x1`, k(o) + e)
              .attr(`x2`, k(o) + e)
              .attr(`y1`, c.titleTopMargin)
              .attr(`y2`, r - c.titleTopMargin)
              .attr(`class`, `today`),
...
//# sourceMappingURL=ganttDiagram-LVOFAZNH-Drr2wFg7.js.map
