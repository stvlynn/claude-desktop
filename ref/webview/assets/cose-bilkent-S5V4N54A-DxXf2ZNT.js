...
import { n as s, t as c } from "./cytoscape.esm-KEBVOvFd.js";
import { t as l } from "./cytoscape-cose-bilkent-CZ_nfQWZ.js";
function u(e, t) {
  e.forEach((e) => {
    let n = {
      id: e.id,
...
async function h(e, t) {
  ...
  try {
    ...
    let t = await f(e),
      ...
      i = m(t);
    return (
      n.debug(`Layout completed: ${r.length} nodes, ${i.length} edges`),
      { nodes: r, edges: i }
    );
  } catch (e) {
...
e(() => {
  (i(),
    ...
    r(u, `addNodes`),
    r(d, `addEdges`),
    r(f, `createCytoscapeInstance`),
    r(p, `extractPositionedNodes`),
    r(m, `extractPositionedEdges`),
    r(h, `executeCoseBilkentLayout`),
    r(g, `validateLayoutData`),
    (v = r(
      async (
        e,
        t,
...
export { v as render };
//# sourceMappingURL=cose-bilkent-S5V4N54A-DxXf2ZNT.js.map
