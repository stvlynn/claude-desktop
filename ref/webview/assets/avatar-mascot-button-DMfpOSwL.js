...
import { n as m, t as h } from "./codex-avatar-83UFBqwH.js";
function g(e) {
  let t = (0, y.c)(23),
    {
      ariaLabel: n,
...
function _(e) {
  ...
  t[28] === f
    ? (q = t[29])
    : ((q = f ? void 0 : { scale: 0.94 }), (t[28] = f), (t[29] = q));
  let J;
  t[30] !== M ||
  t[31] !== E ||
  t[32] !== n.ariaLabel ||
...
var y,
  ...
  T = e(() => {
    ((y = r()),
      ...
      (w = l(`avatar-mascot-notification-badge-corner`, `top-end`)));
  });
export { T as n, g as t };
//# sourceMappingURL=avatar-mascot-button-DMfpOSwL.js.map
