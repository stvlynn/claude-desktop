...
import { t as u } from "./chunk-55IACEB6-DBIditYu.js";
import { t as d } from "./chunk-EDXVE4YY-C5jaZxVP.js";
import "./chunk-X2U36JSP-BczALf5_.js";
import "./chunk-5FUZZQ4R-CaM4fbt9.js";
import "./chunk-ENJZ2VHE-ed8XzF1H.js";
import { r as f, t as p } from "./chunk-336JU56O-Cutebe7h.js";
const m = [];
...
var S = x,
  ...
  T = class {
    ...
    addNode(t, n, i, a) {
      e.info(`addNode`, t, n, i, a);
      let c = !1;
      this.nodes.length === 0
        ? ((this.baseLevel = t), (t = 0), (c = !0))
        : this.baseLevel !== void 0 && ((t -= this.baseLevel), (c = !1));
      let l = o(),
        u = l.mindmap?.padding ?? s.mindmap.padding;
      switch (a) {
      ...
      let d = {
          ...
          type: a,
          children: [],
          width: l.mindmap?.maxNodeWidth ?? s.mindmap.maxNodeWidth,
          padding: u,
          isRoot: c,
        },
        f = this.getParent(t);
      if (f) (f.children.push(d), this.nodes.push(d));
      else if (c) this.nodes.push(d);
      else
        throw Error(
    ...
    decorateNode(e) {
      ...
      (e.icon && (n.icon = r(e.icon, t)), e.class && (n.class = r(e.class, t)));
    }
    type2Str(e) {
      switch (e) {
    ...
    assignSections(e, t) {
      if ((e.level === 0 ? (e.section = void 0) : (e.section = t), e.children))
        for (let [n, r] of e.children.entries()) {
          let i = e.level === 0 ? n % (C - 1) : t;
    ...
    getData() {
      let t = this.getMindmap(),
        ...
        r = i().layout !== void 0,
        a = n;
      if ((r || (a.layout = `cose-bilkent`), !t))
        return { nodes: [], edges: [], config: a };
      (e.debug(`getData: mindmapRoot`, t, n), this.assignSections(t));
      let s = [],
        c = [];
      (this.flattenNodes(t, s),
        this.generateEdges(t, c),
        e.debug(`getData: processed ${s.length} nodes and ${c.length} edges`));
      let l = new Map();
      for (let e of s)
        l.set(e.id, {
          shape: e.shape,
...
` + t,
      ...
      let a = i.db,
        o = a.getData(),
        c = u(n, o.config.securityLevel);
      if (
        ((o.type = i.type),
        (o.layoutAlgorithm = p(o.config.layout, { fallback: `cose-bilkent` })),
        (o.diagramId = n),
        !a.getMindmap())
      )
        return;
      (o.nodes.forEach((e) => {
        ...
        await f(o, c));
      let { themeVariables: m } = l(),
        { useGradient: h, gradientStart: g, gradientStop: _ } = m;
      if (h && g && _) {
        let e = c.attr(`id`),
          t = c
            .append(`defs`)
      ...
      d(
        c,
        o.config.mindmap?.padding ?? s.mindmap.padding,
        `mindmapDiagram`,
        o.config.mindmap?.useMaxWidth ?? s.mindmap.useMaxWidth,
      );
    }, `draw`),
  },
  D = t((e) => {
    let { theme: t, look: r } = e,
      i = ``;
    ...
    for (let n = 0; n < e.THEME_COLOR_LIMIT; n++) {
      let a = `` + (r === `neo` ? Math.max(10 - (n - 1) * 2, 2) : 17 - 3 * n);
      i += `
...
export { k as diagram };
//# sourceMappingURL=mindmap-definition-QFDTVHPH-CD_nG-Fd.js.map
