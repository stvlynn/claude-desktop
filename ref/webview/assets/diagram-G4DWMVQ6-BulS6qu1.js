...
import { i as s, n as c, r as l } from "./chunk-AGHRB4JF-DVNPU_Qo.js";
import {
  A as u,
  C as d,
  E as f,
...
import { n as S, t as C } from "./chunk-426QAEUC-DkGEnnOP.js";
import { r as w, u as T } from "./chunk-5PVQY5BW-MckrTAit.js";
import { n as E, t as D } from "./chunk-4BX2VUAB-NwVKKZxX.js";
import { n as O, t as k } from "./mermaid-parser.core-DurnYtle.js";
import { n as A, t as j } from "./chunk-EDXVE4YY-BWFoBgdE.js";
import { a as M, n as N, r as P } from "./chunk-X2U36JSP-sSeN7Tix.js";
function F(e) {
  if (!e.length) return [];
  let t = [],
    n = [];
  ...
  (C(),
    ...
    (U = {
      draw: c((e, o, l, u) => {
        ...
        try {
          let e = f.valueFormat || `,`;
          if (e === `$0,0`) E = c((e) => `$` + t(`,`)(e), `valueFormat`);
          else if (e.startsWith(`$`) && e.includes(`,`)) {
            let n = /\.\d+/.exec(e),
              r = n ? n[0] : ``;
            E = c((e) => `$` + t(`,` + r)(e), `valueFormat`);
          } else if (e.startsWith(`$`)) {
            let n = e.substring(1);
            E = c((e) => `$` + t(n || ``)(e), `valueFormat`);
          } else E = t(e);
        } catch (e) {
          (s.error(`Error creating format function:`, e), (E = t(`,`)));
        }
        let D = n().range([
            `transparent`,
            g.cScale0,
...
export { G as diagram };
//# sourceMappingURL=diagram-G4DWMVQ6-BulS6qu1.js.map
