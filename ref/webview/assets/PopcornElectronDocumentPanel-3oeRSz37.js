...
import { C as Pe, o as Fe, w as Ie } from "./document-1gFz5aiQ.js";
import {
  A as Le,
  C as Re,
  D as ze,
...
import { n as gt, t as _t } from "./PopcornPageNumberNavigation-2i17P54k.js";
var vt,
  yt,
  bt = e(() => {
    (_(),
      (vt = class {
        ...
        add(e = {}) {
          let t = new yt({
            ...
            tetherId: e.tetherId ?? ``,
            targetId: e.targetId ?? ``,
            type: e.type ?? s.CONTENT_REFERENCE_TYPE_UNSPECIFIED,
            ...e,
          });
...
var Qn = e(() => {});
function $n(e) {
  return e.type === h.ELEMENT_TYPE_TABLE || e.table
    ? `table`
    : e.type === h.ELEMENT_TYPE_CHART ||
        e.type === h.ELEMENT_TYPE_CHART_REFERENCE ||
        e.chartReference
      ? `chart`
      : e.type === h.ELEMENT_TYPE_IMAGE ||
          e.type === h.ELEMENT_TYPE_IMAGE_REFERENCE ||
          e.imageReference ||
          e.image
        ? `image`
        : e.type === h.ELEMENT_TYPE_SHAPE || e.shape
          ? `shape`
          : e.type === h.ELEMENT_TYPE_GROUP || (e.children?.length ?? 0) > 0
            ? `group`
            : `text`;
}
function er(e, t) {
...
function Hi(e) {
  return e.type === h.ELEMENT_TYPE_TEXT || e.type === h.ELEMENT_TYPE_TEXT_GROUP;
}
function Ui(e) {
  let t = new Map();
      ...
      paragraphs: [
        {
          ...
          textStyle: {
            alignment: d.ALIGNMENT_TYPE_CENTER,
            fontSize: 1e3,
...
function eo(e) {
  switch (e) {
    case c.COLOR_TYPE_UNSPECIFIED:
      return `unspecified`;
    case c.COLOR_TYPE_RGB:
      return `rgb`;
    case c.COLOR_TYPE_SCHEME:
      return `scheme`;
    case c.COLOR_TYPE_SYSTEM:
      return `system`;
    default:
      return `unknown`;
  }
...
function no(e) {
  switch (e) {
    case p.LINE_STYLE_UNSPECIFIED:
      return `unspecified`;
    case p.LINE_STYLE_SOLID:
      return `solid`;
    case p.LINE_STYLE_DASHED:
      return `dashed`;
    case p.LINE_STYLE_DOTTED:
      return `dotted`;
    case p.LINE_STYLE_DASH_DOT:
      return `dash-dot`;
    case p.LINE_STYLE_DASH_DOT_DOT:
      return `dash-dot-dot`;
    default:
      return `unknown`;
  }
...
function mo(e, t, n, r) {
  ...
  let i = an({ ...Na(e), type: h.ELEMENT_TYPE_TABLE }),
    a = S(i, t, n, {
      paragraphSpacingUnit: `twips`,
      explicitRowHeightBehavior: `atLeast`,
      autoRowMinimumHeightPx: 0,
  ...
  jo = e(() => {
    (u(),
      ...
      (Ao = class extends E {
        type = `text`;
        constructor(e, t) {
          (super(e, { ...(t ?? {}), type: h.ELEMENT_TYPE_TEXT }),
            (this.data.type = h.ELEMENT_TYPE_TEXT));
        }
        get id() {
          return this.data.id;
        }
...
function ts(e) {
  switch (e) {
    case `wholeTable`:
      return m.CONDITION_WHOLE_TABLE;
    case `firstRow`:
      return m.CONDITION_FIRST_ROW;
    case `lastRow`:
      return m.CONDITION_LAST_ROW;
    case `firstCol`:
      return m.CONDITION_FIRST_COLUMN;
    case `lastCol`:
      return m.CONDITION_LAST_COLUMN;
    case `band1Horz`:
      return m.CONDITION_BANDED_ROW_ODD;
    case `band2Horz`:
      return m.CONDITION_BANDED_ROW_EVEN;
    case `band1Vert`:
      return m.CONDITION_BANDED_COLUMN_ODD;
    case `band2Vert`:
      return m.CONDITION_BANDED_COLUMN_EVEN;
    case `nwCell`:
      return m.CONDITION_TOP_LEFT_CELL;
    case `neCell`:
      return m.CONDITION_TOP_RIGHT_CELL;
    case `swCell`:
      return m.CONDITION_BOTTOM_LEFT_CELL;
    case `seCell`:
      return m.CONDITION_BOTTOM_RIGHT_CELL;
    default:
      return;
  }
}
...
function os(e) {
  switch (e) {
    case `left`:
      return d.ALIGNMENT_TYPE_LEFT;
    case `center`:
      return d.ALIGNMENT_TYPE_CENTER;
    case `right`:
      return d.ALIGNMENT_TYPE_RIGHT;
    default:
      return;
  }
}
...
function Vs(e, t, n) {
  ...
  return {
    ...
    distanceBottomEmu: s === void 0 ? void 0 : N(s),
...
function Ks(e) {
  return e === `none`
    ? l.ELEMENT_WRAP_TYPE_NONE
    : e === `tight`
      ? l.ELEMENT_WRAP_TYPE_TIGHT
      : e === `through`
        ? l.ELEMENT_WRAP_TYPE_THROUGH
        : e === `topAndBottom`
          ? l.ELEMENT_WRAP_TYPE_TOP_AND_BOTTOM
          : l.ELEMENT_WRAP_TYPE_SQUARE;
}
var qs = e(() => {
  (u(), x());
});
    ...
    (u(),
      ...
      (bc = class e {
        ...
        #v(e) {
          let t = e.findIndex(
            (e) =>
              e.type === h.ELEMENT_TYPE_TEXT ||
              e.type === h.ELEMENT_TYPE_TEXT_GROUP,
          );
          return t >= 0
            ? {
                bodyElement: e[t],
        ...
        #y(e, t, n, r, i) {
          ...
          if (e.type === h.ELEMENT_TYPE_TABLE || e.table) {
            r.add({ proto: e });
            return;
          }
          if (
          ...
          if (e.type === h.ELEMENT_TYPE_SHAPE || e.shape !== void 0) {
            t.add({ proto: e });
            return;
          }
          (e.type === h.ELEMENT_TYPE_GROUP || (e.children?.length ?? 0) > 0) &&
...
function Ec(e) {
  for (let t of e)
    if (
      t &&
      (!(
        t.type === h.ELEMENT_TYPE_TEXT || t.type === h.ELEMENT_TYPE_TEXT_GROUP
      ) ||
        Tc(t))
    )
      return !0;
...
function dl() {
  return new Worker(
    new URL(
      `` + new URL(`runtime.worker-1YasDKq2.js`, import.meta.url).href,
      `` + import.meta.url,
    ),
...
function fu({
  ...
  return (
    ...
    S
      ? (0, mu.jsx)(`section`, {
          className: i(`no-drag h-full min-h-0 bg-token-bg-primary`, e),
...
var pu, mu;
e(() => {
  (Jc(), a(), (pu = t(r())), uu(), wl(), ll(), Re(), (mu = n()));
})();
export { fu as PopcornElectronDocumentPanel };
//# sourceMappingURL=PopcornElectronDocumentPanel-3oeRSz37.js.map
