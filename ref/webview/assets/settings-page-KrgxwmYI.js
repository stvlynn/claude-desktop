...
import { n as on, t as sn } from "./filter-D8U2GooJ.js";
import { n as cn, t as ln } from "./dock-n80HVZhX.js";
import {
  n as un,
  t as dn,
} from "./experimental-feature-visibility-Bvp90zWX.js";
import { n as fn, t as pn } from "./settings-host-dropdown-BH50x2Qx.js";
var mn,
  hn,
  gn = e(() => {
    (t(i()),
...
function wn(e, t, n) {
  ...
  let c = null;
  for (let e of r) {
    let r = Math.max(ue(e, t), ...n.map((t) => ue(e, t)));
...
function Tn(e, t) {
  let n = t.map((t) => Math.max(0, ...e.map((e) => ue(e, t))));
...
function En(e, t) {
  ...
  let i = {
    ...
    panelLabel: e.formatMessage(rn(t.sectionSlug)),
...
function kn(e) {
  let t = (0, Bn.c)(95),
    ...
    h = _e(),
    ee = oe(qn),
    [te, g] = (0, Vn.useState)(!1),
    [_, ne] = (0, Vn.useState)(``),
    v = f && te,
    y = ee && p && !v,
    b;
  t[0] !== _ || t[1] !== y
    ? ((b = y && _.trim().length > 0), (t[0] = _), (t[1] = y), (t[2] = b))
    : (b = t[2]);
  let x = b,
    S,
    C;
  t[3] !== h || t[4] !== _ || t[5] !== m || t[6] !== n
    ? ((S = Cn({
        intl: h,
        query: _,
        targets: m,
  ...
  t[9] === w
    ? (T = t[10])
    : ((T = w.length === 0 ? [] : w.split(`\0`)), (t[9] = w), (t[10] = T));
  let re = T,
    E = y && _.length > 0,
    D;
  t[11] !== i || t[12] !== S
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (M = t[20]);
  let ae = M,
    N = v ? Yn.collapsed : Yn.expanded,
    P;
  t[21] !== N.message || t[22] !== h
    ? ((P = h.formatMessage(N.message)),
      (t[21] = N.message),
      (t[22] = h),
      (t[23] = P))
    : (P = t[23]);
  ...
  if (
    ...
    (t[51] === a
      ? (W = t[52])
      : ((W = Re(`flex min-h-0 flex-1 flex-col select-none px-row-x`, a)),
        (t[51] = a),
        (t[52] = W)),
      t[53] === h
        ? (G = t[54])
        : ((G = h.formatMessage({
          ...
          (t[53] = h),
          (t[54] = G)),
      (z = `flex min-h-0 flex-1 flex-col`),
      t[55] !== I || t[56] !== f || t[57] !== F || t[58] !== N.message
        ? ((B = f
            ? (0, Q.jsx)(`div`, {
                className: `mb-2 shrink-0`,
                children: (0, Q.jsx)(q, {
                  tooltipContent: (0, Q.jsx)(Z, { ...N.message }),
                  children: (0, Q.jsx)(Qt, {
                    "aria-label": F,
                    fullWidth: !1,
                    icon: I,
      ...
      t[63] !== v || t[64] !== d
        ? ((H =
            d != null && !v
              ? (0, Q.jsx)(`div`, { className: `mb-4 shrink-0`, children: d })
              : null),
          (t[63] = v),
          (t[64] = d),
          (t[65] = H))
        : (H = t[65]),
      t[66] !== k || t[67] !== _ || t[68] !== y
        ? ((U = y
            ? (0, Q.jsx)(In, {
                onKeyDown: k.getInputProps().onKeyDown,
                searchQuery: _,
                onQueryChange: (e) => {
                  (k.setHighlightedIndex(-1), ne(e));
                },
              })
            : null),
          (t[66] = k),
          ...
          (t[69] = U))
        : (U = t[69]));
    let c = v ? `flex flex-col gap-2` : `flex flex-col gap-4`;
    (t[70] === c
      ? (L = t[71])
      : ((L = Re(`min-h-0 flex-1 overflow-y-auto pb-2`, c)),
        (t[70] = c),
        (t[71] = L)),
      (R = x
        ? (0, Q.jsx)(Ln, {
                  ...
                  return (0, Q.jsx)(
                    q,
                    {
                      ...
                      children: (0, Q.jsx)(Qt, {
                        ...
                        label: (0, Q.jsx)(nn, { slug: e.slug }),
                        trailing:
                          !v && e.externalUrl != null
                            ? (0, Q.jsx)(Ge, {
    ...
    ((L = t[42]),
      ...
      (G = t[50]));
  let K;
  t[72] !== f || t[73] !== v || t[74] !== h || t[75] !== x
    ? ((K = x
        ? null
        : (0, Q.jsx)(q, {
            tooltipContent: v ? (0, Q.jsx)(Z, { ...Un.chatSettings }) : ae,
            side: `right`,
            sideOffset: 12,
            children: (0, Q.jsx)(Qt, {
  ...
  t[77] === l
    ...
    : ((J =
      ...
      (t[78] = J));
  let Y;
  t[79] !== L || t[80] !== R || t[81] !== K || t[82] !== J
    ? ((Y = (0, Q.jsxs)(`div`, { className: L, children: [R, K, J] })),
      (t[79] = L),
      (t[80] = R),
      (t[81] = K),
      (t[82] = J),
  ...
  t[88] !== U ||
  t[89] !== Y
    ? ((X = (0, Q.jsxs)(`div`, { className: z, children: [B, V, H, U, Y] })),
      (t[84] = z),
      (t[85] = B),
      (t[86] = V),
      (t[87] = H),
    ...
    ? ((p =
        r.length > 0
          ? (0, Q.jsx)(`button`, {
              ...
              type: `button`,
              children: (0, Q.jsx)(he, { className: `icon-2xs` }),
            })
          : null),
      (t[14] = a),
      (t[15] = i),
...
var Bn,
  ...
  Xn = e(() => {
    ((Bn = r()),
      ...
      (Yn = {
        collapsed: { icon: f, message: Un.expandSidebar },
...
function $n(e) {
  let t = (0, rr.c)(11),
    ...
    a = r?.platform === `darwin`,
    { data: o } = u(tt, e.selectedHostId),
    s;
  t[0] === o
    ? (s = t[1])
    : ((s = o === void 0 ? [] : o), (t[0] = o), (t[1] = s));
  let c = s,
    l;
  t[2] === c
    ? (l = t[3])
    : ((l = c.filter(un).flatMap(nr)), (t[2] = c), (t[3] = l));
  let d = l,
    f;
  t[4] === n.locale
    ? (f = t[5])
    : ((f = [{ locale: w, language: `en` }, ...M().map(tr)].flatMap((e) => {
        let { language: t, locale: r } = e;
        return [E(r, r), E(t, n.locale)];
      })),
      (t[4] = n.locale),
      (t[5] = f));
  let p = f,
    m;
  return (
    t[6] !== d || t[7] !== a || t[8] !== i || t[9] !== p
      ? ((m = ir.map((e) =>
          e.sectionSlug === `appearance` && !i
...
var rr,
  ...
  or = e(() => {
    ((rr = r()),
      ...
      ot(),
      dn(),
      (ir = Ut.map((e) => ({ messages: Zn[e] ?? [], sectionSlug: e }))),
      (ar = [
...
function sr(e = null, t = !0, n = we) {
  ...
  let s = oe(Fe),
    c = l(Ft),
    u = B(),
    { isProfileVisible: d, isProfileVisibilityLoading: f } = Gt(),
    { isUsageSettingsVisible: p, isUsageSettingsAccessLoading: m } = Xt(),
    h = Xe({ hostId: n }),
    ee = t && !o.isLoading && !o.allowed,
    te =
      t &&
      !a.isLoading &&
    ...
    g = t && (h.available || o.available || ee),
    _ = t && (a.available || o.available || te),
    ne = Ht.filter((e) => {
  ...
  if (b && !(!t && !lr.includes(y.slug)))
    switch (y.slug) {
      ...
      case `codex-micro`:
        ...
        break;
      case `computer-use`:
        S = h.isLoading || o.isLoading;
        break;
      case `browser-use`:
        S = a.isLoading || o.isLoading || u;
        break;
      case `local-environments`:
      case `worktrees`:
      case `environments`:
  ...
  return {
    ...
    visibleSettingsSections: ne,
  };
}
function cr(e) {
  return e == null ? null : (Ht.find((t) => t.slug === e) ?? null);
}
var lr,
  ur,
  dr = e(() => {
...
function fr() {
  let e = (0, gr.c)(78),
    ...
    r = de(),
    i = L(),
    a = W(`/settings/:section/*`)?.params.section ?? null,
    {
      connectedRemoteConnections: o,
    ...
    f = xe(u).kind === `local`,
    {
      activeSettingsSection: p,
      shouldRedirectToVisibleSettingsSection: ee,
      shouldRenderRouteContent: te,
      visibleSettingsSections: g,
    } = sr(a, f, u),
    ne = h(),
    v = l(Ee),
    y = l(ie),
    b;
  e[0] !== v || e[1] !== r
    ? ((b = () => hr(r, v)), (e[0] = v), (e[1] = r), (e[2] = b))
    : (b = e[2]);
  let x = b,
    S;
  e[3] === u
    ? (S = e[4])
    : ((S = { selectedHostId: u }), (e[3] = u), (e[4] = S));
  let C = $n(S),
    w;
  e[5] !== o || e[6] !== n || e[7] !== s || e[8] !== u || e[9] !== d
    ? ((w =
        o != null && o.length > 0 && s != null
          ? (0, $.jsx)(pn, {
              align: `start`,
              connectedRemoteConnections: o,
  ...
  let j = A,
    M;
  e[18] !== i.state || e[19] !== r || e[20] !== t
    ? ((M = (e) => {
        (e === `profile` && fe(t, pe, { source: `settings_page` }),
          r(`/settings/${e}`, { replace: !0, state: i.state }));
      }),
      (e[18] = i.state),
      (e[19] = r),
      (e[20] = t),
  ...
  e[27] === t.query
    ? (z = e[28])
    : ((z = () => {
        t.query.invalidate(At, { exact: !0 }).catch(pr);
      }),
      (e[27] = t.query),
      (e[28] = z));
  let B;
  (e[29] === t ? (B = e[30]) : ((B = [t]), (e[29] = t), (e[30] = B)),
    (0, _r.useEffect)(z, B));
  let V, oe;
  if (
    (e[31] !== v || e[32] !== r
  ...
  if (ne) {
    ...
    e[46] === i.hash
      ? (n = e[47])
      : ((n = i.hash.slice(1) || null), (e[46] = i.hash), (e[47] = n));
    let r;
    e[48] !== i.key || e[49] !== j || e[50] !== n
      ? ((r = (0, $.jsx)(`div`, {
  ...
  e[66] === i.hash
    ? (J = e[67])
    : ((J = i.hash.slice(1) || null), (e[66] = i.hash), (e[67] = J));
  let Y;
  e[68] !== i.key || e[69] !== j || e[70] !== J
    ? ((Y = (0, $.jsx)(Ie, { navigationKey: i.key, targetId: J, children: j })),
      (e[68] = i.key),
      (e[69] = j),
      (e[70] = J),
      (e[71] = Y))
...
//# sourceMappingURL=settings-page-KrgxwmYI.js.map
