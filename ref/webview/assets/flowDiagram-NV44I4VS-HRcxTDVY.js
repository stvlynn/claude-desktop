...
import { c as i, l as a, t as o } from "./dist-Dcs2yc8m.js";
import {
  B as s,
  C as c,
  U as l,
...
import { n as h, t as ie } from "./src-CTe_6Jg1.js";
import { g, s as _, u as v } from "./chunk-S3R3BYOJ-BBYtiirL.js";
import { i as y } from "./chunk-JA3XYJ7Z-DXPUiutJ.js";
import { n as b, t as x } from "./chunk-FMBD7UC4-Cl8oprFb.js";
import { n as S } from "./chunk-HN2XXSSU-BJwKN-er.js";
import { n as C } from "./chunk-CVBHYZKI-CCA47Th3.js";
import { n as w, t as T } from "./chunk-55IACEB6-W9i3ByIr.js";
import { n as E, t as ae } from "./chunk-QN33PNHL-nPLgaaqy.js";
import { n as oe } from "./chunk-ATLVNIR6-CqT90CcJ.js";
import { i as se, s as D } from "./chunk-JZLCHNYA-BB0008aK.js";
import { n as O } from "./chunk-QXUST7PY-bOMzPJkM.js";
import { i as k, n as A, t as j } from "./chunk-N4CR4FBY-D4A2k-Kw.js";
import { n as ce, r as le, t as ue } from "./chunk-MI3HLSF2-lTgkCAOX.js";
var de, fe, pe, M, N, P, me, he, ge;
e(() => {
  (b(),
    ce(),
    w(),
...
` +
        ...
        if (l) {
          let e = c;
          (e?.animate !== void 0 && (l.animate = e.animate),
            e?.animation !== void 0 && (l.animation = e.animation),
            e?.curve !== void 0 && (l.interpolate = e.curve));
          return;
        }
        let u,
        ...
        if (
          ...
          if (c.shape) {
            ...
            if (!D(c.shape)) throw Error(`No such shape: ${c.shape}.`);
            d.type = c?.shape;
          }
      ...
      addSingleLink(e, n, r, i) {
        ...
        if (
          (o !== void 0 &&
            ((a.text = this.sanitizeText(o.text.trim())),
            a.text.startsWith(`"`) &&
              a.text.endsWith(`"`) &&
          ...
          r !== void 0 &&
            ((a.type = r.type),
            (a.stroke = r.stroke),
            (a.length = r.length > 10 ? 10 : r.length)),
          i && !this.edges.some((e) => e.id === i))
        )
          ((a.id = i), (a.isUserDefinedId = !0));
        else {
          let e = this.edges.filter(
            (e) => e.start === a.start && e.end === a.end,
          );
          e.length === 0
            ? (a.id = _(a.start, a.end, { counter: 0, prefix: `L` }))
            : (a.id = _(a.start, a.end, {
                counter: e.length + 1,
                prefix: `L`,
              }));
        }
        if (this.edges.length < (this.config.maxEdges ?? 500))
          (t.info(`Pushing edge...`), this.edges.push(a));
        else
...
You have to call mermaid.initialize.`);
      ...
      addLink(e, n, r) {
        ...
        for (let t of e)
          for (let a of n) {
            let o = t === e[e.length - 1],
              s = a === n[0];
            o && s
              ? this.addSingleLink(t, a, r, i)
              : this.addSingleLink(t, a, r, void 0);
          }
      }
      ...
      setLink(e, t, n) {
        (e.split(`,`).forEach((e) => {
          ...
          r !== void 0 &&
            ((r.link = g.formatUrl(t, this.config)), (r.linkTarget = n));
        }),
          ...
          h(e)
            ...
            .on(`mouseout`, (e) => {
              (t.transition().duration(500).style(`opacity`, 0),
                h(e.currentTarget).classed(`hover`, !1));
            }));
      }
      clear(e = `gen-2`) {
        ((this.vertices = new Map()),
      ...
      addSubGraph(e, r, i) {
        ...
        if (
          ((l ??= u.inheritDir
            ? (this.getDirection() ?? f().direction ?? void 0)
            : void 0),
          this.version === `gen-1`)
        )
          for (let e = 0; e < c.length; e++) c[e] = this.lookUpDomId(c[e]);
        ((a ??= `subGraph` + this.subCount),
          (o ||= ``),
        ...
        return (
          t.info(`Adding`, d.id, d.nodes, d.dir),
      ...
      getData() {
        ...
        return (
          o.forEach((t, r) => {
            ...
            let c = {
              id: _(t.start, t.end, { counter: r, prefix: `L` }, t.id),
    ...
    (pe = {
      ...
      draw: n(async function (e, n, r, i) {
        (t.info(`REF0:`), t.info(`Drawing state diagram (v2)`, n));
        let { securityLevel: a, flowchart: o, layout: s } = f(),
          c;
        a === `sandbox` && (c = h(`#i` + n));
        let l = a === `sandbox` ? c.nodes()[0].contentDocument : document;
        t.debug(`Before getData: `);
        let u = i.db.getData();
        t.debug(`Data: `, u);
        let d = T(n, a),
          ee = i.db.getDirection();
        ((u.type = i.type),
          (u.layoutAlgorithm = j(s)),
          u.layoutAlgorithm === `dagre` &&
            s === `elk` &&
            t.warn(
              "flowchart-elk was moved to an external package in Mermaid v11. Please refer [release notes](https://github.com/mermaid-js/mermaid/releases/tag/v11.0.0) for more details. This diagram will be rendered using `dagre` layout as a fallback.",
            ),
          (u.direction = ee),
          (u.nodeSpacing = o?.nodeSpacing || 50),
          (u.rankSpacing = o?.rankSpacing || 50),
          (u.markers = [`point`, `circle`, `cross`]),
          (u.diagramId = n),
          t.debug(`REF1:`, u),
          await k(u, d));
        let te = u.config.flowchart?.diagramPadding ?? 8;
        (g.insertTitle(
          d,
          `flowchartTitleText`,
          o?.titleTopMargin || 0,
          ...
          E(d, te, `flowchart`, o?.useMaxWidth || !1));
        for (let e of u.nodes) {
          let t = h(`#${n} [id="${e.id}"]`);
          if (!t || !e.link) continue;
          let r = l.createElementNS(`http://www.w3.org/2000/svg`, `a`);
          (r.setAttributeNS(
            `http://www.w3.org/2000/svg`,
            `class`,
            e.cssClasses,
          ),
            r.setAttributeNS(`http://www.w3.org/2000/svg`, `rel`, `noopener`),
            a === `sandbox`
              ? r.setAttributeNS(`http://www.w3.org/2000/svg`, `target`, `_top`)
              : e.linkTarget &&
                r.setAttributeNS(
                  `http://www.w3.org/2000/svg`,
                  `target`,
    ...
    (M = (function () {
      var e = n(function (e, t, n, r) {
        ...
        Ce = [1, 124],
        we = [1, 123],
        Te = [44, 60, 62, 74, 89, 102, 105, 106, 109, 111, 114, 115, 116],
        Ee = [1, 133],
        De = [1, 147],
        Oe = [1, 148],
        ke = [1, 149],
        ...
        Ze = [10, 106],
        Qe = [31, 49, 51, 53, 55, 57, 62, 64, 66, 67, 69, 71, 116, 117, 118],
        K = [1, 247],
        q = [1, 245],
        J = [1, 249],
        Y = [1, 243],
        ...
        nt = {
          ...
          table: [
            ...
            e(a, [2, 10]),
            e(a, [2, 11]),
            { 8: [1, 54], 9: [1, 55], 10: D, 15: 53, 18: 56 },
            e(O, [2, 3]),
            e(O, [2, 4]),
            e(O, [2, 5]),
            e(O, [2, 6]),
            ...
            { 8: k, 9: A, 11: j, 21: 70 },
            { 8: k, 9: A, 11: j, 21: 71 },
            { 8: k, 9: A, 10: [1, 72], 11: j, 21: 73 },
            e(O, [2, 36]),
            { 35: [1, 74] },
            { 37: [1, 75] },
            e(O, [2, 39]),
            e(ce, [2, 50], { 18: 76, 39: 77, 10: D, 40: le }),
            { 10: [1, 79] },
            { 10: [1, 80] },
            { 10: [1, 81] },
            { 10: [1, 82] },
            ...
            e(O, [2, 41]),
            e(O, [2, 42]),
            e(be, [2, 76], { 73: 116, 62: [1, 118], 74: [1, 117] }),
            { 76: 119, 79: 120, 80: xe, 81: Se, 116: Ce, 119: we },
            { 75: [1, 125], 77: [1, 126] },
            e(Te, [2, 83]),
            e(O, [2, 28]),
            e(O, [2, 29]),
            ...
            { 30: 170, 67: z, 80: B, 81: V, 82: 171, 116: H, 117: U, 118: W },
            { 30: 178, 67: z, 80: B, 81: V, 82: 171, 116: H, 117: U, 118: W },
            {
              30: 180,
              50: [1, 179],
              67: z,
            ...
            { 30: 181, 67: z, 80: B, 81: V, 82: 171, 116: H, 117: U, 118: W },
            { 30: 182, 67: z, 80: B, 81: V, 82: 171, 116: H, 117: U, 118: W },
            { 30: 183, 67: z, 80: B, 81: V, 82: 171, 116: H, 117: U, 118: W },
            { 109: [1, 184] },
            { 30: 185, 67: z, 80: B, 81: V, 82: 171, 116: H, 117: U, 118: W },
            {
              30: 186,
              65: [1, 187],
              67: z,
            ...
            { 30: 188, 67: z, 80: B, 81: V, 82: 171, 116: H, 117: U, 118: W },
            { 30: 189, 67: z, 80: B, 81: V, 82: 171, 116: H, 117: U, 118: W },
            { 30: 190, 67: z, 80: B, 81: V, 82: 171, 116: H, 117: U, 118: W },
            e(I, [2, 182]),
            e(a, [2, 20]),
            e(ye, [2, 25]),
            e(ce, [2, 46], { 39: 191, 18: 192, 10: D, 40: le }),
            e(be, [2, 73], { 10: [1, 193] }),
            { 10: [1, 194] },
            { 30: 195, 67: z, 80: B, 81: V, 82: 171, 116: H, 117: U, 118: W },
            { 77: [1, 196], 79: 197, 116: Ce, 119: we },
            e(Xe, [2, 79]),
            e(Xe, [2, 81]),
            e(Xe, [2, 82]),
            e(Xe, [2, 168]),
            e(Xe, [2, 169]),
            { 76: 198, 79: 120, 80: xe, 81: Se, 116: Ce, 119: we },
            e(Te, [2, 84]),
            {
              8: k,
              9: A,
            ...
            { 31: [1, 217], 67: z, 82: 218, 116: H, 117: U, 118: W },
            e(Qe, [2, 86]),
            e(Qe, [2, 88]),
            e(Qe, [2, 89]),
            e(Qe, [2, 153]),
            ...
            e(Qe, [2, 155]),
            e(Qe, [2, 156]),
            { 49: [1, 219], 67: z, 82: 218, 116: H, 117: U, 118: W },
            { 30: 220, 67: z, 80: B, 81: V, 82: 171, 116: H, 117: U, 118: W },
            { 51: [1, 221], 67: z, 82: 218, 116: H, 117: U, 118: W },
            { 53: [1, 222], 67: z, 82: 218, 116: H, 117: U, 118: W },
            { 55: [1, 223], 67: z, 82: 218, 116: H, 117: U, 118: W },
            { 57: [1, 224], 67: z, 82: 218, 116: H, 117: U, 118: W },
            { 60: [1, 225] },
            { 64: [1, 226], 67: z, 82: 218, 116: H, 117: U, 118: W },
            { 66: [1, 227], 67: z, 82: 218, 116: H, 117: U, 118: W },
            { 30: 228, 67: z, 80: B, 81: V, 82: 171, 116: H, 117: U, 118: W },
            { 31: [1, 229], 67: z, 82: 218, 116: H, 117: U, 118: W },
            {
              67: z,
              69: [1, 230],
              71: [1, 231],
            ...
            e(ce, [2, 45], { 18: 155, 10: D, 40: Ye }),
            e(ce, [2, 47], { 44: Je }),
            e(be, [2, 75]),
            e(be, [2, 74]),
            { 62: [1, 234], 67: z, 82: 218, 116: H, 117: U, 118: W },
            e(be, [2, 77]),
            e(Xe, [2, 80]),
            { 77: [1, 235], 79: 197, 116: Ce, 119: we },
            { 30: 236, 67: z, 80: B, 81: V, 82: 171, 116: H, 117: U, 118: W },
            e(qe, o, { 5: 237 }),
            e(G, [2, 102]),
            e(O, [2, 35]),
            {
            ...
            e(Qe, [2, 87]),
            e(F, [2, 57]),
            { 51: [1, 262], 67: z, 82: 218, 116: H, 117: U, 118: W },
            e(F, [2, 64]),
            e(F, [2, 59]),
            e(F, [2, 60]),
            e(F, [2, 61]),
            ...
            e(F, [2, 63]),
            e(F, [2, 65]),
            { 66: [1, 264], 67: z, 82: 218, 116: H, 117: U, 118: W },
            e(F, [2, 67]),
            e(F, [2, 68]),
            e(F, [2, 70]),
            e(F, [2, 69]),
            ...
            e(be, [2, 78]),
            { 31: [1, 265], 67: z, 82: 218, 116: H, 117: U, 118: W },
            {
              6: 11,
              7: 12,
              8: s,
            ...
            e(L, [2, 120]),
            e(F, [2, 58]),
            { 30: 282, 67: z, 80: B, 81: V, 82: 171, 116: H, 117: U, 118: W },
            e(F, [2, 66]),
            e(qe, o, { 5: 283 }),
            e(tt, [2, 131], {
              108: 269,
            ...
            e(L, [2, 114]),
            { 31: [1, 286], 67: z, 82: 218, 116: H, 117: U, 118: W },
            {
              6: 11,
              7: 12,
              8: s,
            ...
            for (var _, v, y, b, x, S = {}, C, w, T, E; ; ) {
              if (
                ...
                this.defaultActions[y]
                  ...
                  : ((_ ??= g()), (b = s[y] && s[y][_])),
                b === void 0 || !b.length || !b[0])
              ) {
                var ae = ``;
                for (C in ((E = []), s[y]))
                  this.terminals_[C] &&
                    C > ee &&
                    E.push(`'` + this.terminals_[C] + `'`);
                ((ae = p.showPosition
                  ? `Parse error on line ` +
                    (l + 1) +
                    `:
...
` +
          ...
          conditions: {
            ...
            shapeDataStr: {
              rules: [
                9, 10, 21, 24, 77, 80, 82, 84, 88, 90, 94, 95, 108, 110, 112,
                114,
              ],
              inclusive: !1,
            },
            ...
            callbackname: {
              rules: [
                14, 15, 16, 21, 24, 77, 80, 82, 84, 88, 90, 94, 95, 108, 110,
                112, 114,
              ],
              inclusive: !1,
            },
            ...
            trapText: {
              rules: [
                21, 24, 77, 80, 82, 84, 88, 90, 91, 92, 93, 94, 95, 108, 110,
                112, 114,
              ],
              inclusive: !1,
            },
            ...
            INITIAL: {
              rules: [
                ...
                88, 90, 94, 95, 96, 97, 98, 99, 100, 101, 102, 103, 104, 105,
                106, 108, 110, 112, 114, 116, 117, 118, 119,
              ],
              inclusive: !0,
            },
          },
      ...
      return (n(rt, `Parser`), (rt.prototype = nt), (nt.Parser = rt), new rt());
    })()),
    (M.parser = M),
    (N = M),
    (P = Object.assign({}, N)),
...
`,
  ...
  .labelBkg {
    background-color: ${he(e.edgeLabelBackground, 0.5)};
    // background-color:
  }
...
//# sourceMappingURL=flowDiagram-NV44I4VS-HRcxTDVY.js.map
