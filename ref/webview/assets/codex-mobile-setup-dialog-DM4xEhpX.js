...
import { n as it, t as at } from "./segmented-toggle-WuxzI5uh.js";
import { n as ot, t as st } from "./use-home-directory-BQI_zVh8.js";
import { a as ct, o as lt } from "./plugin-detail-page-utils-DPpf121-.js";
var ut,
  dt = e(() => {
    (Fe(),
      (ut = Me(`electron:codex-mobile-setup-step-debug-override`, `auto`)));
  }),
  ft,
  pt = e(() => {
    ft =
...
function Vt(e) {
  ...
  t[0] === s
    ? (c = t[1])
    : ((c = U(`flex w-full flex-col gap-2 text-center`, s)),
      (t[0] = s),
      (t[1] = c));
  let l =
      o === `dialog`
...
function Yt(e) {
  ...
  t[0] === n
    ? (i = t[1])
    : ((i = U(`justify-center`, n)), (t[0] = n), (t[1] = i));
  let a;
...
function Qt() {
  ...
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = { hostId: H }), (e[0] = a))
    : (a = e[0]);
  let o = je(a).available,
    s = fe(l.keepRemoteControlAwakeWhilePluggedIn),
    u = f(Je, H),
    m = d(qe),
    h;
  e[1] === t.query
    ? (h = e[2])
    : ((h = t.query.snapshot(qe)), (e[1] = t.query), (e[2] = h));
  let g = h,
    _;
  ...
  let v = ke(H, _),
    y;
  e[4] !== r || e[5] !== v.availablePlugins
    ? ((y = en(v.availablePlugins, rn, r)),
      (e[4] = r),
      (e[5] = v.availablePlugins),
      (e[6] = y))
    : (y = e[6]);
  let b = y,
    x = b?.plugin.installed === !0 && b.plugin.enabled,
    S;
  e[7] !== r || e[8] !== v.availablePlugins
    ? ((S = $t(v.availablePlugins, r)),
      (e[7] = r),
      (e[8] = v.availablePlugins),
      (e[9] = S))
    : (S = e[9]);
  let C = S,
    w;
  e[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = { hostId: H }), (e[10] = w))
    : (w = e[10]);
  let { pendingPluginId: T, setPluginEnabled: E } = Te(w),
    D;
  e[11] === v.forceReload
    ? (D = e[12])
    : ((D = { forceReloadPlugins: v.forceReload, hostId: H }),
      (e[11] = v.forceReload),
      (e[12] = D));
  let {
      closePluginInstall: O,
      connectRequiredApp: ee,
      handleRequiredAppConnected: k,
      handleRequiredAppOAuthStarted: A,
      installPlugin: ne,
      isInstalling: j,
      openPluginInstall: M,
      session: ie,
  ...
  e[13] === g
    ...
    : ((ae = {
      ...
      (e[14] = ae));
  let N = p(ae),
    oe = n === `macOS` && x && u && m.data?.enabled != null,
    P;
  e[15] !== b ||
  e[16] !== m.data?.enabled ||
  e[17] !== M ||
  ...
  e[19] !== N
    ? ((P = (e) => {
        if (b != null) {
          ...
          E({ enabled: e, pluginDisplayName: Le(b), pluginId: b.plugin.id });
        }
      }),
      (e[15] = b),
      (e[16] = m.data?.enabled),
  ...
  let se = P,
    ce;
  e[21] !== C || e[22] !== M || e[23] !== E
    ? ((ce = (e) => {
        if (C != null) {
          if (!C.plugin.installed) {
            e && M(C);
            return;
          }
          E({ enabled: e, pluginDisplayName: Le(C), pluginId: C.plugin.id });
        }
      }),
      (e[21] = C),
      (e[22] = M),
    ...
    : (ce = e[24]);
  let le = ce,
    ue = C?.plugin.installed === !0 && C.plugin.enabled,
    F = v.isLoading || C == null || j || T === C.plugin.id,
    de = v.isLoading || b == null || j || N.isPending || T === b.plugin.id,
    I = s ?? !1,
    me = m.data?.enabled ?? !1,
    L = !x || m.isLoading || N.isPending,
    R;
  e[25] === t
    ? (R = e[26])
    : ((R = (e) => {
        pe(t, l.keepRemoteControlAwakeWhilePluggedIn, e);
      }),
      (e[25] = t),
      (e[26] = R));
  let z;
  ...
  e[37] !== B
    ? ((V = (0, nn.jsx)(Ke, {
        ...
        onInstall: ne,
        onRequiredAppConnected: k,
        onRequiredAppOAuthStarted: A,
        onOpenChange: B,
        session: ie,
      })),
      (e[31] = ee),
  ...
  return (
    ...
    e[53] !== V
      ? ((ge = {
          chromeExtensionEnabled: ue,
          chromeExtensionToggleDisabled: F,
          computerUseEnabled: x,
          computerUseToggleDisabled: de,
          keepComputerAwake: I,
          keepComputerAwakeToggleDisabled: !1,
          lockedComputerUseEnabled: me,
          lockedComputerUseToggleDisabled: L,
          onChromeExtensionEnabledChange: le,
          onComputerUseEnabledChange: se,
          onKeepComputerAwakeChange: R,
          onLockedComputerUseEnabledChange: z,
          pluginInstallModal: V,
          showChromeExtensionSetup: i,
          showComputerUseSetup: o,
...
function ln(e) {
  ...
  t[0] === i
    ...
    : ((c =
        i === `page`
          ? (0, K.jsx)(S, { className: `size-11 text-token-foreground` })
          : void 0),
      (t[0] = i),
      (t[1] = c));
  let l, u;
  ...
  t[4] === d
    ? (f = t[5])
    : ((f = U(`flex w-full flex-col`, d)), (t[4] = d), (t[5] = f));
  let p;
    ...
    ? ((p = s.showKeepComputerAwake
        ? (0, K.jsx)(dn, {
            icon: s.keepComputerAwake
              ? (0, K.jsx)(ve, { className: `icon-base` })
  ...
  t[31] !== i
    ? ((h = s.showChromeExtensionSetup
        ? (0, K.jsx)(dn, {
            icon: (0, K.jsx)(Be, { className: `icon-base` }),
            variant: i,
            title: (0, K.jsx)(z, {
  ...
  t[38] === _
    ? (v = t[39])
    : ((v = U(`justify-center`, _)), (t[38] = _), (t[39] = v));
  let y;
  ...
  let T;
  return (
    t[55] !== s.pluginInstallModal || t[56] !== w
      ? ((T = (0, K.jsxs)(K.Fragment, { children: [w, s.pluginInstallModal] })),
...
function Nr(e) {
  ...
  t[5] === r
    ? (_ = t[6])
    : ((_ = U(`size-full shrink-0 object-contain`, r)), (t[5] = r), (t[6] = _));
  let v = _;
  if (a || c === u) {
    let e;
    t[7] === r
      ? (e = t[8])
      : ((e = U(`cursor-interaction overflow-hidden`, r)),
        (t[7] = r),
        (t[8] = e));
    let a;
    t[9] !== v || t[10] !== d
  ...
  t[17] === r
    ? (y = t[18])
    : ((y = U(`cursor-interaction overflow-hidden`, r)),
      (t[17] = r),
      (t[18] = y));
  let b;
  t[19] === g
...
function Qr(e) {
  ...
  t[0] === i
    ? (a = t[1])
    : ((a = U(`relative overflow-hidden bg-token-main-surface-primary`, i)),
      (t[0] = i),
      (t[1] = a));
  let o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
...
function ei(e) {
  ...
  t[1] === u
    ? (d = t[2])
    : ((d = U(`relative overflow-hidden bg-token-main-surface-primary`, u)),
      (t[1] = u),
      (t[2] = d));
  let f;
  t[3] === i
  ...
  t[7] === m
    ? (h = t[8])
    : ((h = U(`pointer-events-auto aspect-square`, m)), (t[7] = m), (t[8] = h));
  let g;
  t[9] !== r || t[10] !== h
    ? ((g = (0, Y.jsx)(`div`, {
...
function Ti(e) {
  let t = (0, Li.c)(82),
    ...
    [g, v] = (0, Ri.useState)(!1),
    [y, x] = (0, Ri.useState)(`phone`),
    S = c ? (n ?? y) : `phone`,
    [C] = (0, Ri.useState)(Ei),
    w;
  t[0] !== s || t[1] !== C
    ? ((w = { hostId: s, openId: C }), (t[0] = s), (t[1] = C), (t[2] = w))
    : (w = t[2]);
  let T = f(le, w),
    E = d && !p,
    D = E && T.error == null ? (T.data ?? null) : null,
    O = D?.manualPairingCode ?? null,
    ee = E && D == null && (T.error == null || T.isFetching),
    k = !d || D?.pairingCode != null,
    A = S === `phone` && !d && !p,
    te = E && S === `computer` && !ee,
    j;
  t[3] !== n || t[4] !== i
  ...
  if (p) {
    ...
    let e = D?.pairingCode,
      n;
    (t[21] !== pe || t[22] !== F || t[23] !== m || t[24] !== l || t[25] !== e
      ? ((n = (0, X.jsx)(Jr, {
          ariaLabel: F,
          centerLogoAriaLabel: pe,
          pairingCode: e,
          platform: m,
          size: l,
        })),
    ...
    (t[27] === T.error
      ? (e = t[28])
      : ((e = (0, X.jsx)(Ii, { error: T.error })),
        (t[27] = T.error),
        (t[28] = e)),
      (L = e));
  } else if (d) {
    let e;
    (t[29] !== O || t[30] !== T.error || t[31] !== l
      ? ((e = (0, X.jsx)(ki, {
          error: T.error,
          manualPairingCode: O,
          size: l,
  ...
  let B = l === `compact` ? null : `mt-3`,
    he;
  t[34] === B
    ? (he = t[35])
    : ((he = U(`flex w-full flex-col items-center gap-4`, B)),
      (t[34] = B),
      (t[35] = he));
  let V;
  t[36] !== u || t[37] !== p || t[38] !== M || t[39] !== S || t[40] !== c
    ? ((V =
        c && !p
          ? (0, X.jsx)(`div`, {
      ...
      (t[41] = V))
    : (V = t[41]);
  let ge = l === `compact` ? `bg-transparent` : `bg-token-bg-primary`,
    _e = A ? null : `justify-center`,
    ve =
      S === `computer`
        ? l === `compact`
  ...
  t[60] !== se
              ...
              S === `phone` && k
                ? (0, X.jsx)(ae, {
                    ...
                    children: (0, X.jsx)(N, {
                      ...
                      onClick: () => v(!0),
                      size: `icon`,
                      children: (0, X.jsx)(_, { className: `icon-xs` }),
                    }),
                  })
                : null,
              (0, X.jsx)(ae, {
                ...
                children: (0, X.jsx)(N, {
                  ...
                  children: (0, X.jsx)(b, {
                    className: U(
                      `icon-xs`,
                      T.isFetching ? `animate-spin` : null,
                    ),
                  }),
                }),
              }),
    ...
    : (xe = t[61]);
  let Se;
  t[62] !== ye || t[63] !== W || t[64] !== be || t[65] !== xe
    ? ((Se = (0, X.jsxs)(`div`, { className: ye, children: [W, be, xe] })),
      (t[62] = ye),
      (t[63] = W),
      (t[64] = be),
      (t[65] = xe),
  ...
  t[67] === te
    ? (Ce = t[68])
    : ((Ce = te ? (0, X.jsx)(Fi, {}) : null), (t[67] = te), (t[68] = Ce));
  let we;
  t[69] !== pe ||
  t[70] !== u ||
  t[71] !== g ||
    ...
    ? ((we =
        D?.pairingCode == null
          ...
          : (0, X.jsxs)(nt, {
              ...
              dialogCloseLabel: u.formatMessage({
  ...
  let Te;
  return (
    t[76] !== he || t[77] !== V || t[78] !== Se || t[79] !== Ce || t[80] !== we
      ? ((Te = (0, X.jsxs)(`div`, {
          className: he,
          children: [V, Se, Ce, we],
        })),
...
function Oi(e) {
  let t = (0, Li.c)(3),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, X.jsx)(O, { className: `size-7 text-token-text-secondary` })),
      (t[0] = r))
    : (r = t[0]);
  let i;
  return (
...
function Bi(e) {
  ...
  t[6] === f
    ? (p = t[7])
    : ((p = U(`flex flex-wrap items-center justify-center gap-3`, f)),
      (t[6] = f),
      (t[7] = p));
  let m;
  t[8] !== n || t[9] !== a || t[10] !== o
  ...
  t[12] === h
    ? (g = t[13])
    : ((g = U(`justify-center`, h)), (t[12] = h), (t[13] = g));
  let _;
...
function Wi(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = U(`flex flex-col`, r)), (t[0] = r), (t[1] = i));
  let a;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Z.jsx)(Ki, {
        icon: (0, Z.jsx)(_e, { "aria-hidden": !0, className: `size-5` }),
        title: (0, Z.jsx)(z, {
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Z.jsx)(Ki, {
        icon: (0, Z.jsx)(Re, { "aria-hidden": !0, className: `size-5` }),
        title: (0, Z.jsx)(z, {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Z.jsx)(Ki, {
        icon: (0, Z.jsx)(w, { "aria-hidden": !0, className: `size-5` }),
        title: (0, Z.jsx)(z, {
...
function sa(e) {
  let t = (0, la.c)(31),
    ...
    v;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = { "aria-describedby": void 0 }), (t[0] = v))
    : (v = t[0]);
  let y;
  t[1] !== g || t[2] !== _ || t[3] !== f
    ? ((y = ca(g, _, f)), (t[1] = g), (t[2] = _), (t[3] = f), (t[4] = y))
    : (y = t[4]);
  let b;
  t[5] === y
    ? (b = t[6])
    : ((b = (0, ua.jsx)(rt, { className: `sr-only`, children: y })),
      (t[5] = y),
      (t[6] = b));
  let x;
  t[7] !== h || t[8] !== f
    ...
    : (x = t[9]);
  let S;
  t[10] !== i || t[11] !== h || t[12] !== f
    ? ((S = () => {
        (F(h, me, { action: `finish_setup`, step: f, surface: `dialog` }),
          i(!1));
      }),
      (t[10] = i),
      (t[11] = h),
  ...
  t[24] !== p
    ? ((C = (0, ua.jsx)(Qi, {
        hostId: n,
        onAllowHost: r,
        onContinueOnChatGPT: x,
        onFinishSetup: S,
        onSkip: a,
        onStartSetup: o,
        setupInProgress: d,
        showAllowHostError: m,
        showStartSetupError: u,
        step: f,
        variant: `dialog`,
        waitingHeading: p,
...
var la,
  ua,
  da = e(() => {
    ((la = i()), M(), o(), L(), tt(), Ie(), k(), ee(), B(), oa(), (ua = r()));
  });
export {
  oa as a,
  It as c,
...
//# sourceMappingURL=codex-mobile-setup-dialog-DM4xEhpX.js.map
