...
import {
  ...
  r as ee,
  t as te,
} from "./chunk-AGHRB4JF-GvfWLS3X.js";
function p(e) {
  return function (t) {
...
function ae() {
  ...
  let {
    ...
    ut = null,
    dt = m({}, [`audio`, `video`, `img`, `source`, `image`, `track`]),
    ft = null,
    pt = m({}, [
      `alt`,
      `class`,
    ...
    H = null,
    gt = m({}, [mt, ht, z], ve),
    _t = m({}, [`mi`, `mo`, `mn`, `ms`, `mtext`]),
    vt = m({}, [`annotation-xml`]),
    yt = m({}, [`title`, `style`, `font`, `a`, `script`]),
    U = null,
    bt = [`application/xhtml+xml`, `text/html`],
    W = null,
    G = null,
    ...
    q = function () {
      ...
      if (!(G && G === e)) {
        if (
          ...
          (e = h(e)),
          (U =
            bt.indexOf(e.PARSER_MEDIA_TYPE) === -1
              ? `text/html`
              : e.PARSER_MEDIA_TYPE),
          (W = U === `application/xhtml+xml` ? ve : _e),
          (w = b(e, `ALLOWED_TAGS`) ? m({}, e.ALLOWED_TAGS, W) : Qe),
          (T = b(e, `ALLOWED_ATTR`) ? m({}, e.ALLOWED_ATTR, W) : E),
          (H = b(e, `ALLOWED_NAMESPACES`)
            ? m({}, e.ALLOWED_NAMESPACES, ve)
            : gt),
          (ft = b(e, `ADD_URI_SAFE_ATTR`)
            ? m(h(pt), e.ADD_URI_SAFE_ATTR, W)
            : pt),
          (ut = b(e, `ADD_DATA_URI_TAGS`)
            ? m(h(dt), e.ADD_DATA_URI_TAGS, W)
            : dt),
          (R = b(e, `FORBID_CONTENTS`) ? m({}, e.FORBID_CONTENTS, W) : lt),
          (O = b(e, `FORBID_TAGS`) ? m({}, e.FORBID_TAGS, W) : h({})),
          ($e = b(e, `FORBID_ATTR`) ? m({}, e.FORBID_ATTR, W) : h({})),
          (L = b(e, `USE_PROFILES`) ? e.USE_PROFILES : !1),
          ...
          (B = e.NAMESPACE || z),
          (_t = e.MATHML_TEXT_INTEGRATION_POINTS || _t),
          (vt = e.HTML_INTEGRATION_POINTS || vt),
          ...
          L &&
            ((w = m({}, Ae)),
            (T = le(null)),
            L.html === !0 && (m(w, we), m(T, je)),
            L.svg === !0 && (m(w, Te), m(T, Me), m(T, Pe)),
            L.svgFilters === !0 && (m(w, Ee), m(T, Me), m(T, Pe)),
            L.mathMl === !0 && (m(w, Oe), m(T, Ne), m(T, Pe))),
          b(e, `ADD_TAGS`) || (k.tagCheck = null),
          b(e, `ADD_ATTR`) || (k.attributeCheck = null),
          e.ADD_TAGS &&
            (typeof e.ADD_TAGS == `function`
              ? (k.tagCheck = e.ADD_TAGS)
              : (w === Qe && (w = h(w)), m(w, e.ADD_TAGS, W))),
          e.ADD_ATTR &&
            (typeof e.ADD_ATTR == `function`
              ? (k.attributeCheck = e.ADD_ATTR)
              : (T === E && (T = h(T)), m(T, e.ADD_ATTR, W))),
          e.ADD_URI_SAFE_ATTR && m(ft, e.ADD_URI_SAFE_ATTR, W),
          e.FORBID_CONTENTS &&
            (R === lt && (R = h(R)), m(R, e.FORBID_CONTENTS, W)),
          e.ADD_FORBID_CONTENTS &&
            (R === lt && (R = h(R)), m(R, e.ADD_FORBID_CONTENTS, W)),
          ct && (w[`#text`] = !0),
          P && m(w, [`html`, `head`, `body`]),
          w.table && (m(w, [`tbody`]), delete O.tbody),
          ...
          : e.namespaceURI === mt
            ? t.namespaceURI === z
              ...
              : t.namespaceURI === ht
                ...
                : !!St[n]
            : e.namespaceURI === z
              ? (t.namespaceURI === ht && !vt[r]) ||
                (t.namespaceURI === mt && !_t[r])
                ? !1
                : !St[n] && (yt[n] || !J[n])
              : !!(U === `application/xhtml+xml` && H[e.namespaceURI])
        : !1;
    },
    Y = function (e) {
    ...
    wt = function (e) {
      ...
      if (B === z)
        try {
          t = new f().parseFromString(i, U);
        } catch {}
      if (!t || !t.documentElement) {
        t = y.createDocument(B, `template`, null);
        try {
          t.documentElement.innerHTML = V ? _ : i;
        } catch {}
      }
      let a = t.body || t.documentElement;
      return (
        e && r && a.insertBefore(n.createTextNode(r), a.childNodes[0] || null),
        B === z ? Fe.call(t, P ? `html` : `body`)[0] : P ? t.documentElement : a
      );
    },
    Tt = function (e) {
      return ue.call(
  ...
  let Dt = function (e) {
      let n = null;
      if ((Q(S.beforeSanitizeElements, e, null), Z(e))) return (Y(e), !0);
      let r = W(e.nodeName);
      if (
        (Q(S.uponSanitizeElement, e, { tagName: r, allowedTags: w }),
        (tt &&
          e.hasChildNodes() &&
      ...
      return (e instanceof c && !Ct(e)) ||
        ...
        : (N &&
          ...
          Q(S.afterSanitizeElements, e, null),
          !1);
    },
    Ot = function (e, t, r) {
      if ($e[t] || (ot && (t === `id` || t === `name`) && (r in n || r in K)))
        return !1;
      if (
        !(A && !$e[t] && x(Ve, t)) &&
        !(et && x(Ue, t)) &&
    ...
    At = function (e) {
      Q(S.beforeSanitizeAttributes, e, null);
      let { attributes: n } = e;
      if (!n || Z(e)) return;
      let r = {
          attrName: ``,
      ...
      for (; i--; ) {
        ...
        if (
          ...
          switch (ee.getAttributeType(d, c)) {
            case `TrustedHTML`:
              u = g.createHTML(u);
              break;
        ...
        if (u !== l)
          try {
            (o ? e.setAttributeNS(o, a, u) : e.setAttribute(a, u),
              Z(e) ? Y(e) : me(t.removed));
          } catch {
            X(a, e);
          }
      }
      Q(S.afterSanitizeAttributes, e, null);
    },
    jt = function e(t) {
      let n = null,
        r = Tt(t);
      for (Q(S.beforeSanitizeShadowDOM, t, null); (n = r.nextNode()); )
        (Q(S.uponSanitizeShadowNode, n, null),
          Dt(n),
          At(n),
          n.content instanceof a && e(n.content));
      Q(S.afterSanitizeShadowDOM, t, null);
    };
  return (
    (t.sanitize = function (e) {
      ...
      if ((nt || q(n), (t.removed = []), typeof e == `string` && (I = !1), I)) {
        ...
        if (!F && !N && !P && e.indexOf(`<`) === -1)
          return g && at ? g.createHTML(e) : e;
        if (((i = wt(e)), !i)) return F ? null : at ? _ : ``;
      }
      i && rt && Y(i.firstChild);
      let u = Tt(I ? e : i);
      for (; (c = u.nextNode()); )
        (Dt(c), At(c), c.content instanceof a && jt(c.content));
      if (I) return e;
      if (F) {
        if (it)
...
` +
        ...
        g && at ? g.createHTML(d) : d
      );
    }),
    (t.setConfig = function () {
      (q(arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}),
        (nt = !0));
    }),
...
var oe,
  ...
  Ye = e(() => {
    (({
      ...
      (fe = p(Array.prototype.forEach)),
      (pe = p(Array.prototype.lastIndexOf)),
      (me = p(Array.prototype.pop)),
      (he = p(Array.prototype.push)),
      (ge = p(Array.prototype.splice)),
      (_e = p(String.prototype.toLowerCase)),
      (ve = p(String.prototype.toString)),
      (ye = p(String.prototype.match)),
      (be = p(String.prototype.replace)),
      (xe = p(String.prototype.indexOf)),
      (Se = p(String.prototype.trim)),
      (b = p(Object.prototype.hasOwnProperty)),
      (x = p(RegExp.prototype.test)),
      (Ce = ne(TypeError)),
      (we = v(
...
`,
      ...
      ($e = f((e, t, n) => {
        (E[e] && d.warn(`Detector with key ${e} already exists. Overwriting.`),
          (E[e] = { detector: t, loader: n }),
          d.debug(`Detector with key ${e} added${n ? ` with loader` : ``}`));
      }, `addDetector`)),
      (k = f((e) => E[e].loader, `getDiagramLoader`)),
      (et = f((e, t, { depth: n = 2, clobber: r = !1 } = {}) => {
      ...
      (M = `#f2f2f2`),
      (N = f(
        (e, t) => (t ? s(e, { s: -40, l: 10 }) : s(e, { s: -40, l: -10 })),
        `mkBorder`,
      )),
      (tt = class {
        static {
        ...
        updateColors() {
          if (
            ...
            (this.activationBorderColor =
              this.activationBorderColor || r(this.secondaryColor, 10)),
            ...
            (this.activeTaskBkgColor =
              this.activeTaskBkgColor || o(this.primaryColor, 23)),
            ...
            this.darkMode
              ? ((this.rowOdd = this.rowOdd || r(this.mainBkg, 5) || `#ffffff`),
                (this.rowEven = this.rowEven || r(this.mainBkg, 10)))
              : ((this.rowOdd =
                  this.rowOdd || o(this.mainBkg, 75) || `#ffffff`),
            ...
            for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
              this[`cScale` + e] = r(this[`cScale` + e], 75);
          else
            for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
              this[`cScale` + e] = r(this[`cScale` + e], 25);
          for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
            this[`cScaleInv` + e] =
              this[`cScaleInv` + e] || a(this[`cScale` + e]);
          for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
            this.darkMode
              ? (this[`cScalePeer` + e] =
                  this[`cScalePeer` + e] || o(this[`cScale` + e], 10))
              : (this[`cScalePeer` + e] =
                  this[`cScalePeer` + e] || r(this[`cScale` + e], 10));
          ...
          for (let t = 0; t < 5; t++)
            ((this[`surface` + t] =
              this[`surface` + t] ||
              s(this.mainBkg, { h: 180, s: -15, l: e * (5 + t * 3) })),
              (this[`surfacePeer` + t] =
                this[`surfacePeer` + t] ||
                s(this.mainBkg, { h: 180, s: -15, l: e * (8 + t * 3) })));
          ((this.classText = this.classText || this.textColor),
            ...
            (this.pie10 =
              this.pie10 || s(this.primaryColor, { h: 60, l: -20 })),
            (this.pie11 =
              this.pie11 || s(this.primaryColor, { h: -60, l: -20 })),
            (this.pie12 =
              this.pie12 || s(this.primaryColor, { h: 120, l: -10 })),
            ...
            (this.venn3 = this.venn3 ?? s(this.tertiaryColor, { l: -30 })),
            (this.venn4 =
              this.venn4 ?? s(this.primaryColor, { h: 60, l: -30 })),
            (this.venn5 =
              this.venn5 ?? s(this.primaryColor, { h: -60, l: -30 })),
            (this.venn6 =
              this.venn6 ?? s(this.secondaryColor, { h: 60, l: -30 })),
            (this.venn7 =
              this.venn7 ?? s(this.primaryColor, { h: 120, l: -30 })),
            (this.venn8 =
              this.venn8 ?? s(this.secondaryColor, { h: 120, l: -30 })),
            ...
            (this.quadrantPointFill =
              this.quadrantPointFill || c(this.quadrant1Fill)
                ? o(this.quadrant1Fill)
                : r(this.quadrant1Fill)),
            ...
            this.darkMode
              ...
              : ((this.git0 = r(this.git0, 25)),
                (this.git1 = r(this.git1, 25)),
                (this.git2 = r(this.git2, 25)),
                (this.git3 = r(this.git3, 25)),
                (this.git4 = r(this.git4, 25)),
                (this.git5 = r(this.git5, 25)),
                (this.git6 = r(this.git6, 25)),
                (this.git7 = r(this.git7, 25))),
      ...
      (nt = class {
        ...
        constructor() {
          ((this.background = `#333`),
            ...
            (this.darkTextColor = o(a(`#323D47`), 10)),
            (this.lineColor = `calculated`),
            (this.border1 = `#ccc`),
            (this.border2 = i(255, 255, 255, 0.25)),
            ...
            (this.sectionBkgColor = r(`#EAE8D9`, 30)),
            (this.altSectionBkgColor = `calculated`),
            (this.sectionBkgColor2 = `#EAE8D9`),
            (this.excludeBkgColor = r(this.sectionBkgColor, 10)),
            (this.taskBorderColor = i(255, 255, 255, 70)),
            (this.taskBkgColor = `calculated`),
            (this.taskTextColor = `calculated`),
            (this.taskTextLightColor = `calculated`),
            (this.taskTextOutsideColor = `calculated`),
            (this.taskTextClickableColor = `#003163`),
            (this.activeTaskBorderColor = i(255, 255, 255, 50)),
        ...
        updateColors() {
          ((this.secondBkg = o(this.mainBkg, 16)),
            ...
            (this.cScale10 = this.cScale10 || s(this.primaryColor, { h: 300 })),
            (this.cScale11 =
              this.cScale11 || s(this.primaryColor, { h: 330 })));
          for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
            this[`cScaleInv` + e] =
              this[`cScaleInv` + e] || a(this[`cScale` + e]);
          for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
          ...
          for (let e = 0; e < 8; e++)
            this[`venn` + (e + 1)] =
              this[`venn` + (e + 1)] ?? o(this[`cScale` + e], 30);
          ((this.vennTitleTextColor =
            this.vennTitleTextColor ?? this.titleColor),
            (this.vennSetTextColor = this.vennSetTextColor ?? this.textColor),
            (this.quadrant1Fill = this.quadrant1Fill || this.primaryColor),
            ...
            (this.git3 = o(this.pie4 || s(this.primaryColor, { h: -30 }), 20)),
            (this.git4 = o(this.pie5 || s(this.primaryColor, { h: -60 }), 20)),
            (this.git5 = o(this.pie6 || s(this.primaryColor, { h: -90 }), 10)),
            (this.git6 = o(this.pie7 || s(this.primaryColor, { h: 60 }), 10)),
            (this.git7 = o(this.pie8 || s(this.primaryColor, { h: 120 }), 20)),
            (this.gitInv0 = this.gitInv0 || a(this.git0)),
            (this.gitInv1 = this.gitInv1 || a(this.git1)),
            (this.gitInv2 = this.gitInv2 || a(this.git2)),
            (this.gitInv3 = this.gitInv3 || a(this.git3)),
            ...
            (this.commitLabelFontSize = this.commitLabelFontSize || `10px`),
            (this.attributeBackgroundColorOdd =
              this.attributeBackgroundColorOdd || o(this.background, 12)),
            (this.attributeBackgroundColorEven =
              this.attributeBackgroundColorEven || o(this.background, 2)),
      ...
      (F = class {
        ...
        constructor() {
          ((this.background = `#f4f4f4`),
            ...
            (this.sectionBkgColor = i(102, 102, 255, 0.49)),
        ...
        updateColors() {
          ((this.cScale0 = this.cScale0 || this.primaryColor),
            ...
            (this.cScale10 = this.cScale10 || s(this.primaryColor, { h: 300 })),
            (this.cScale11 = this.cScale11 || s(this.primaryColor, { h: 330 })),
            (this.cScalePeer1 = this.cScalePeer1 || r(this.secondaryColor, 45)),
            (this.cScalePeer2 = this.cScalePeer2 || r(this.tertiaryColor, 40)));
          for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
            ((this[`cScale` + e] = r(this[`cScale` + e], 10)),
              (this[`cScalePeer` + e] =
                this[`cScalePeer` + e] || r(this[`cScale` + e], 25)));
          for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
            this[`cScaleInv` + e] =
          ...
          if (
            ...
            ((this.cScaleLabel0 = this.cScaleLabel0 || a(this.labelTextColor)),
              (this.cScaleLabel3 =
                this.cScaleLabel3 || a(this.labelTextColor)));
            for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
              this[`cScaleLabel` + e] =
          ...
          ((this.nodeBkg = this.mainBkg),
            ...
            (this.archEdgeArrowColor = this.lineColor),
            (this.rowOdd =
              this.rowOdd || o(this.primaryColor, 75) || `#ffffff`),
            ...
            (this.pie10 =
              this.pie10 || s(this.primaryColor, { h: 60, l: -40 })),
            (this.pie11 =
              this.pie11 || s(this.primaryColor, { h: -90, l: -40 })),
            (this.pie12 =
              this.pie12 || s(this.primaryColor, { h: 120, l: -30 })),
            (this.pieTitleTextSize = this.pieTitleTextSize || `25px`),
            (this.pieTitleTextColor =
              this.pieTitleTextColor || this.taskTextDarkColor),
            (this.pieSectionTextSize = this.pieSectionTextSize || `17px`),
            ...
            (this.venn1 = this.venn1 ?? s(this.primaryColor, { l: -30 })),
            (this.venn2 = this.venn2 ?? s(this.secondaryColor, { l: -30 })),
            (this.venn3 = this.venn3 ?? s(this.tertiaryColor, { l: -40 })),
            (this.venn4 =
              this.venn4 ?? s(this.primaryColor, { h: 60, l: -30 })),
            (this.venn5 =
              this.venn5 ?? s(this.primaryColor, { h: -60, l: -30 })),
            ...
            this.darkMode
              ...
              : ((this.git0 = r(this.git0, 25)),
                ...
                (this.git6 = r(this.git6, 25)),
                (this.git7 = r(this.git7, 25))),
            (this.gitInv0 = this.gitInv0 || r(a(this.git0), 25)),
            (this.gitInv1 = this.gitInv1 || a(this.git1)),
            (this.gitInv2 = this.gitInv2 || a(this.git2)),
            (this.gitInv3 = this.gitInv3 || a(this.git3)),
            (this.gitInv4 = this.gitInv4 || a(this.git4)),
      ...
      (at = class {
        ...
        updateColors() {
          ((this.actorBorder = r(this.mainBkg, 20)),
            (this.actorBkg = this.mainBkg),
            (this.labelBoxBkgColor = this.actorBkg),
            (this.labelTextColor = this.actorTextColor),
            (this.loopTextColor = this.actorTextColor),
          ...
          ((this.nodeBkg = this.mainBkg),
            ...
            (this.pie9 = this.pie9 || s(this.primaryColor, { h: 120, l: 0 })),
            (this.pie10 =
              this.pie10 || s(this.primaryColor, { h: 60, l: -50 })),
            (this.pie11 =
              this.pie11 || s(this.primaryColor, { h: -60, l: -50 })),
            (this.pie12 =
              this.pie12 || s(this.primaryColor, { h: 120, l: -50 })),
            (this.pieTitleTextSize = this.pieTitleTextSize || `25px`),
            (this.pieTitleTextColor =
              this.pieTitleTextColor || this.taskTextDarkColor),
            (this.pieSectionTextSize = this.pieSectionTextSize || `17px`),
      ...
      (st = class {
        ...
        updateColors() {
          ...
          ((this.nodeBkg = this.mainBkg),
            ...
            (this.taskBorderColor = r(this.contrast, 10)),
            ...
            (this.critBorderColor = r(this.critBkgColor, 10)),
          ...
          ((this.vennTitleTextColor =
            ...
            (this.relationLabelColor =
              this.relationLabelColor || this.actorTextColor),
            (this.git0 = r(this.pie1, 25) || this.primaryColor),
      ...
      (I = class {
        ...
        updateColors() {
          ...
          if (
            ...
            (this.activeTaskBkgColor = this.activeTaskBkgColor || o(e, 23)),
            (this.gridColor = this.gridColor || `lightgrey`),
            (this.doneTaskBkgColor = this.doneTaskBkgColor || `lightgrey`),
            (this.doneTaskBorderColor = this.doneTaskBorderColor || `grey`),
            (this.critBorderColor = this.critBorderColor || `#ff8888`),
            ...
            (this.taskTextOutsideColor =
              this.taskTextOutsideColor || this.textColor),
            (this.vertLineColor =
              this.vertLineColor || this.primaryBorderColor),
            (this.taskTextLightColor =
              this.taskTextLightColor || this.textColor),
            (this.taskTextColor = this.taskTextColor || this.primaryTextColor),
            (this.taskTextDarkColor = this.taskTextDarkColor || this.textColor),
            ...
            (this.cScale3 = this.cScale3 || s(e, { h: 30 })),
            (this.cScale4 = this.cScale4 || s(e, { h: 60 })),
            (this.cScale5 = this.cScale5 || s(e, { h: 90 })),
            (this.cScale6 = this.cScale6 || s(e, { h: 120 })),
            (this.cScale7 = this.cScale7 || s(e, { h: 150 })),
            (this.cScale8 = this.cScale8 || s(e, { h: 210, l: 150 })),
            (this.cScale9 = this.cScale9 || s(e, { h: 270 })),
            (this.cScale10 = this.cScale10 || s(e, { h: 300 })),
            (this.cScale11 = this.cScale11 || s(e, { h: 330 })),
            this.darkMode)
          )
            for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
              this[`cScale` + e] = r(this[`cScale` + e], 75);
          ...
          for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
            this[`cScaleLabel` + e] =
              this[`cScaleLabel` + e] || this.scaleLabelColor;
          let i = this.darkMode ? -4 : -1;
          for (let e = 0; e < 5; e++)
            ((this[`surface` + e] =
              this[`surface` + e] ||
              s(this.mainBkg, { h: 180, s: -15, l: i * (5 + e * 3) })),
              (this[`surfacePeer` + e] =
                this[`surfacePeer` + e] ||
                s(this.mainBkg, { h: 180, s: -15, l: i * (8 + e * 3) })));
          ((this.classText = this.classText || this.textColor),
            (this.fillType0 = this.fillType0 || e),
            (this.fillType1 = this.fillType1 || t),
            (this.fillType2 = this.fillType2 || s(e, { h: 64 })),
            (this.fillType3 = this.fillType3 || s(t, { h: 64 })),
            (this.fillType4 = this.fillType4 || s(e, { h: -64 })),
            (this.fillType5 = this.fillType5 || s(t, { h: -64 })),
            (this.fillType6 = this.fillType6 || s(e, { h: 128 })),
            (this.fillType7 = this.fillType7 || s(t, { h: 128 })),
            (this.pie1 = this.pie1 || e),
            (this.pie2 = this.pie2 || t),
            (this.pie3 = this.pie3 || n),
            (this.pie4 = this.pie4 || s(e, { l: -10 })),
            (this.pie5 = this.pie5 || s(t, { l: -10 })),
            (this.pie6 = this.pie6 || s(n, { l: -10 })),
            (this.pie7 = this.pie7 || s(e, { h: 60, l: -10 })),
            (this.pie8 = this.pie8 || s(e, { h: -60, l: -10 })),
            (this.pie9 = this.pie9 || s(e, { h: 120, l: 0 })),
            (this.pie10 = this.pie10 || s(e, { h: 60, l: -20 })),
            (this.pie11 = this.pie11 || s(e, { h: -60, l: -20 })),
            (this.pie12 = this.pie12 || s(e, { h: 120, l: -10 })),
            (this.pieTitleTextSize = this.pieTitleTextSize || `25px`),
            (this.pieTitleTextColor =
              this.pieTitleTextColor || this.taskTextDarkColor),
            (this.pieSectionTextSize = this.pieSectionTextSize || `17px`),
            ...
            (this.quadrant2Fill =
              this.quadrant2Fill || s(e, { r: 5, g: 5, b: 5 })),
            (this.quadrant3Fill =
              this.quadrant3Fill || s(e, { r: 10, g: 10, b: 10 })),
            (this.quadrant4Fill =
              this.quadrant4Fill || s(e, { r: 15, g: 15, b: 15 })),
            (this.quadrant1TextFill =
              this.quadrant1TextFill || this.primaryTextColor),
            (this.quadrant2TextFill =
              this.quadrant2TextFill ||
            ...
            (this.git3 = this.git3 || s(e, { h: -30 })),
            (this.git4 = this.git4 || s(e, { h: -60 })),
            (this.git5 = this.git5 || s(e, { h: -90 })),
            (this.git6 = this.git6 || s(e, { h: 60 })),
            (this.git7 = this.git7 || s(e, { h: 120 })),
            this.darkMode
              ? ((this.git0 = o(this.git0, 25)),
                (this.git1 = o(this.git1, 25)),
                (this.git2 = o(this.git2, 25)),
      ...
      (ut = class {
        ...
        constructor() {
          ((this.background = `#ffffff`),
            ...
            (this.radius = 12),
            (this.strokeWidth = 2),
            (this.primaryBorderColor = N(`#28253D`, this.darkMode)),
      ...
      (z = class {
        ...
        updateColors() {
          ...
          this.scaleLabelColor = this.scaleLabelColor || this.labelTextColor;
          for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
            this[`cScaleLabel` + e] = r(this[`cScale` + e], 75);
          let e = this.darkMode ? -4 : -1;
          for (let t = 0; t < 5; t++)
            ((this[`surface` + t] =
              this[`surface` + t] ||
      ...
      (V = {
        ...
        neutral: { getThemeVariables: ct },
        neo: { getThemeVariables: L },
        "neo-dark": { getThemeVariables: lt },
        redux: { getThemeVariables: dt },
        "redux-dark": { getThemeVariables: pt },
        "redux-color": { getThemeVariables: ht },
        "redux-dark-color": { getThemeVariables: B },
      }),
      (H = {
        flowchart: {
          useMaxWidth: !0,
      ...
      (gt = {
        ...
        themeCSS: void 0,
        themeVariables: V.default.getThemeVariables(),
        sequence: {
          ...H.sequence,
        ...
        gantt: { ...H.gantt, tickInterval: void 0, useWidth: void 0 },
        c4: {
          ...H.c4,
          useWidth: void 0,
          ...
          flowchart: { ...H.flowchart, inheritDir: !1 },
        ...
        pie: { ...H.pie, useWidth: 984 },
        xyChart: { ...H.xyChart, useWidth: void 0 },
        requirement: { ...H.requirement, useWidth: void 0 },
        packet: { ...H.packet },
        treeView: { ...H.treeView, useWidth: void 0 },
        radar: { ...H.radar },
        ishikawa: { ...H.ishikawa },
        treemap: {
          useMaxWidth: !0,
      ...
      (U = f((e) => {
        if (
          (d.debug(`sanitizeDirective called with`, e),
          !(typeof e != `object` || !e))
        ) {
          if (Array.isArray(e)) {
            e.forEach((e) => U(e));
          ...
          for (let t of Object.keys(e)) {
            ...
            if (typeof e[t] == `object`) {
              (d.debug(`sanitizing object`, t), U(e[t]));
              continue;
            }
            for (let n of [`themeCSS`, `fontFamily`, `altFontFamily`])
              t.includes(n) &&
                (d.debug(`sanitizing css option`, t), (e[t] = bt(e[t])));
          }
          if (e.themeVariables)
      ...
      (St = f((e, t) => {
        let n = A({}, e),
          r = {};
        for (let e of t) (Et(e), (r = A(r, e)));
        if (((n = A(n, r)), r.theme && r.theme in V)) {
          let e = A(A({}, xt).themeVariables || {}, r.themeVariables);
          n.theme &&
            n.theme in V &&
            (n.themeVariables = V[n.theme].getThemeVariables(e));
        }
        return ((J = n), jt(J), J);
      }, `updateCurrentConfig`)),
      (Ct = f(
        (e) => (
          ...
          e.theme &&
            V[e.theme] &&
            (K.themeVariables = V[e.theme].getThemeVariables(e.themeVariables)),
          St(K, q),
          K
        ),
        `setSiteConfig`,
      ...
      (X = f((e) => ((K = A(K, e)), St(K, q), K), `updateSiteConfig`)),
      (wt = f(() => A({}, K), `getSiteConfig`)),
      (Tt = f((e) => (jt(e), A(J, e), Z()), `setConfig`)),
      (Z = f(() => A({}, J), `getConfig`)),
      (Et = f((e) => {
        e &&
          ([`secure`, ...(K.secure ?? [])].forEach((t) => {
            Object.hasOwn(e, t) &&
              (d.debug(`Denied attempt to modify a secure key ${t}`, e[t]),
              delete e[t]);
          }),
      ...
      (kt = {}),
      (At = f((e) => {
        kt[e] || (d.warn(Ot[e]), (kt[e] = !0));
      }, `issueWarning`)),
      (jt = f((e) => {
        e &&
          (e.lazyLoadedDiagrams || e.loadExternalDiagramsAtStartup) &&
          At(`LAZY_LOAD_DEPRECATED`);
      }, `checkConfig`)),
      (Mt = f(() => {
        let e = {};
        xt && (e = A(e, xt));
        for (let t of q) e = A(e, t);
        return e;
      }, `getUserDefinedConfig`)),
      (Nt = f(
        (e) => (
          e.flowchart?.htmlLabels != null &&
            At(`FLOWCHART_HTML_LABELS_DEPRECATED`),
          G(e.htmlLabels ?? e.flowchart?.htmlLabels ?? !0)
        ),
      ...
      f(Xe, `setupDompurifyHooks`),
      (Lt = f((e) => (It(), C.sanitize(e)), `removeScript`)),
      (Rt = f((e, t) => {
        if (Nt(t)) {
      ...
      ($ = f(
        (e, t) =>
          e &&
          ((e = t.dompurifyConfig
            ? C.sanitize(Rt(e, t), t.dompurifyConfig).toString()
            : C.sanitize(Rt(e, t), { FORBID_TAGS: [`style`] }).toString()),
          e),
        `sanitizeText`,
      )),
      (zt = f(
        (e, t) =>
          typeof e == `string` ? $(e, t) : e.flat().map((e) => $(e, t)),
        `sanitizeTextOrArray`,
      )),
      (Bt = f((e) => Pt.test(e), `hasBreaks`)),
      (Vt = f((e) => e.split(Pt), `splitBreaks`)),
      (Ht = f((e) => e.replace(/#br#/g, `<br/>`), `placeholderToBreak`)),
      (Ut = f((e) => e.replace(Pt, `#br#`), `breakToPlaceholder`)),
      (Wt = f((e) => {
        let t = ``;
        return (
          e &&
      ...
      (qt = f(function (e) {
        ...
        for (let e = 0; e < t.length; e++) {
          ...
          if (r === `,` && e > 0 && e + 1 < t.length) {
            let i = t[e - 1],
              a = t[e + 1];
            Yt(i, a) && ((r = i + `,` + a), e++, n.pop());
          }
          n.push(Xt(r));
        }
        return n.join(``);
      }, `parseGenericTypes`)),
      (Jt = f((e, t) => Math.max(0, e.split(t).length - 1), `countOccurrence`)),
      (Yt = f((e, t) => {
        let n = Jt(e, `~`),
          r = Jt(t, `~`);
        return n === 1 && r === 1;
      ...
      (Zt = f(() => window.MathMLElement !== void 0, `isMathMLSupported`)),
      (Qt = /\$\$(.*)\$\$/g),
      ($t = f((e) => (e.match(Qt)?.length ?? 0) > 0, `hasKatex`)),
      (en = f(async (e, t) => {
        let n = document.createElement(`div`);
        ((n.innerHTML = await nn(e, t)),
          (n.id = `katex-temp`),
      ...
      (tn = f(async (e, t) => {
        if (!$t(e)) return e;
        if (!(Zt() || t.legacyMathML || t.forceLegacyMathML))
          return e.replace(Qt, `MathML is unsupported in this environment.`);
        {
          let { default: r } = await n(
              async () => {
                let { default: e } = await import(`./katex-CsTj3p0I.js`);
                return { default: e };
              },
              __vite__mapDeps([
            ...
            i =
              t.forceLegacyMathML || (!Zt() && t.legacyMathML)
                ? `htmlAndMathml`
                : `mathml`;
          return e
            .split(Pt)
      ...
      (nn = f(async (e, t) => $(await tn(e, t), t), `renderKatexSanitized`)),
      (rn = {
        getRows: Ft,
        sanitizeText: $,
        sanitizeTextOrArray: zt,
        hasBreaks: Bt,
        splitBreaks: Vt,
        lineBreakRegex: Pt,
        removeScript: Lt,
      ...
      (sn = f(function (e, t, n, r) {
        an(e, on(t, n, r));
      }, `configureSvgSize`)),
      (cn = f(function (e, t, n, r) {
        let i = t.node().getBBox(),
          a = i.width,
          o = i.height;
        d.info(`SVG bounds: ${a}x${o}`, i);
        let s = 0,
          c = 0;
        (d.info(`Graph bounds: ${s}x${c}`, e),
          (s = a + n * 2),
          (c = o + n * 2),
          d.info(`Calculated bounds: ${s}x${c}`),
          sn(t, c, s, r));
        let l = `${i.x - n} ${i.y - n} ${i.width + 2 * n} ${i.height + 2 * n}`;
        t.attr(`viewBox`, l);
      }, `setupGraphViewbox`)),
      (ln = {}),
      (un = f((e, t, n, r) => {
...
`,
      ...
      (Sn = f(() => gn, `getAccDescription`)),
      (Cn = f((e) => {
        hn = _n(e);
      }, `setDiagramTitle`)),
      (wn = f(() => hn, `getDiagramTitle`)),
      (Tn = d),
      (En = u),
      (Dn = Z),
      (On = Tt),
      (kn = W),
      (An = f((e) => $(e, Dn()), `sanitizeText`)),
      (jn = cn),
      (Mn = f(() => pn, `getCommonDb`)),
      (Nn = {}),
      (Pn = f((e, t, n) => {
        (Nn[e] &&
          Tn.warn(`Diagram with id ${e} already registered. Overwriting.`),
          (Nn[e] = t),
          n && $e(e, n),
          dn(e, t.styles),
          t.injectUtils?.(Tn, En, Dn, An, jn, Mn(), () => {}));
      }, `registerDiagram`)),
      (Fn = f((e) => {
...
//# sourceMappingURL=chunk-ICPOFSXX-CPupJSsJ.js.map
