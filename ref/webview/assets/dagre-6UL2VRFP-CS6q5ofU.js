...
import { U as t, k as n, t as r, v as i } from "./lodash-CsD3b1ni.js";
import { i as a, n as o, r as s } from "./chunk-AGHRB4JF-DIvkCYtW.js";
import { b as c, k as l } from "./chunk-ABZYJK2D-Ugtemmk_.js";
import { u } from "./chunk-S3R3BYOJ-BHdYahbs.js";
import { i as d } from "./chunk-JA3XYJ7Z-Co-9Jc82.js";
import { n as f } from "./chunk-HN2XXSSU-BPyoUjyB.js";
import { n as p, t as ee } from "./chunk-CVBHYZKI-ucg-Wr6h.js";
import { n as m, r as h, t as g } from "./graphlib-CITVmEAN.js";
import { n as _ } from "./chunk-ATLVNIR6-DShFhP4G.js";
import {
  a as v,
  d as te,
  i as y,
  ...
  t as C,
  u as w,
} from "./chunk-JZLCHNYA-Dn_DumwI.js";
import {
  a as T,
  i as E,
  n as D,
  ...
  r as k,
  t as A,
} from "./chunk-QXUST7PY-Db24C-B7.js";
import { n as j, t as M } from "./dagre-Cj5HkGwU.js";
function N(e) {
  var n = {
    options: {
  ...
  return (i(e.graph()) || (n.value = t(e.graph())), n);
}
function P(e) {
  return n(e.nodes(), function (t) {
    var n = e.node(t),
      r = e.parent(t),
      a = { v: t };
    ...
    (Y = o((e, t) => {
      ...
      for (let r of n)
        if (
          ...
          let i = new m({ multigraph: !0, compound: !0 })
            .setGraph({
              rankdir: n,
              nodesep: 50,
              ranksep: 50,
...
Parent cluster`,
          ...
          if (
            ...
            let l = await Q(p, o.graph, n, r, t.node(e), s),
              u = l.elem;
            (te(o, u),
              (o.diff = l.diff || 0),
              a.info(
            ...
            t.children(e).length > 0
              ...
              : (a.trace(
                ...
                await S(p, t.node(e), { config: s, dir: c }));
        }),
      ),
        await o(async () => {
      ...
      let m = 0,
        { subGraphTitleTotalMargin: h } = ee(s);
      return (
        await Promise.all(
        ...
        t.edges().forEach(function (e) {
          ...
          (a.info(`Edge ` + e.v + ` -> ` + e.w + `: ` + JSON.stringify(i), i),
            i.points.forEach((e) => (e.y += h / 2)),
            O(i, k(d, i, L, n, t.node(e.v), t.node(e.w), r)));
        }),
        t.nodes().forEach(function (e) {
          let n = t.node(e);
          (a.info(e, n.type, n.diff), n.isGroup && (m = n.diff));
        }),
        a.warn(`Returning from recursive render XAX`, l, m),
        { elem: l, diff: m }
      );
    }, `recursiveRender`)),
    ($ = o(async (e, t) => {
      let n = new m({ multigraph: !0, compound: !0 })
          .setGraph({
            rankdir: e.direction,
            nodesep:
...
export { $ as render };
//# sourceMappingURL=dagre-6UL2VRFP-CS6q5ofU.js.map
