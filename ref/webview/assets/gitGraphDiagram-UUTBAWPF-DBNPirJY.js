...
import { i as r, n as i, r as a } from "./chunk-AGHRB4JF-GvfWLS3X.js";
import {
  A as o,
  C as s,
  G as c,
...
import { g as y, m as b, r as x, u as ee } from "./chunk-5PVQY5BW-Qrvqj614.js";
import { n as te, t as ne } from "./chunk-4BX2VUAB-DAnoPJdG.js";
import { n as re, t as ie } from "./mermaid-parser.core-Bn4SD_xl.js";
import { n as ae, t as oe } from "./chunk-QZHKN3VN-DG77T4sv.js";
function S() {
  return b({ length: 7 });
}
function se(e, t) {
...
function w(e) {
  let t = e.reduce((e, t) => (e.seq > t.seq ? e : t), e[0]),
    n = ``;
  e.forEach(function (e) {
    e === t ? (n += `	*`) : (n += `	|`);
  });
  let i = [n, t.id, t.seq];
  for (let e in D.records.branches)
    D.records.branches.get(e) === t.id && i.push(e);
  if (
    (r.debug(i.join(` `)),
...
e(() => {
  (ne(),
    ...
    ie(),
    n(),
    (T = { NORMAL: 0, REVERSE: 1, HIGHLIGHT: 2, MERGE: 3, CHERRY_PICK: 4 }),
    (ce = h.gitGraph),
    (E = i(() => x({ ...ce, ...v().gitGraph }), `getConfig`)),
    (D = new oe(() => {
      let e = E(),
        t = e.mainBranchName,
        n = e.mainBranchOrder;
    ...
    (fe = i(function (e) {
      ...
      let o = E();
      ((n = g.sanitizeText(n, o)),
        (t = g.sanitizeText(t, o)),
        (a = a?.map((e) => g.sanitizeText(e, o))));
      let s = {
      ...
      ((D.records.head = s),
        r.info(`main branch`, o.mainBranchName),
        D.records.commits.has(s.id) &&
          r.warn(`Commit ID ${s.id} already exists`),
        D.records.commits.set(s.id, s),
        D.records.branches.set(D.records.currBranch, s.id),
        r.debug(`in pushCommit ` + s.id));
    }, `commit`)),
    (pe = i(function (e) {
      let t = e.name,
        n = e.order;
      if (((t = g.sanitizeText(t, E())), D.records.branches.has(t)))
        throw Error(
      ...
      (D.records.branches.set(
        ...
        D.records.branchConfig.set(t, { name: t, order: n }),
        O(t),
        r.debug(`in createBranch`));
    }, `branch`)),
    (me = i((e) => {
      let t = e.branch,
        n = e.id,
        ...
        a = e.tags,
        o = E();
      ((t = g.sanitizeText(t, o)), (n &&= g.sanitizeText(n, o)));
      let s = D.records.branches.get(D.records.currBranch),
        c = D.records.branches.get(t),
        l = s ? D.records.commits.get(s) : void 0,
        u = c ? D.records.commits.get(c) : void 0;
      if (l && u && l.branch === t)
        throw Error(`Cannot merge branch '${t}' into itself.`);
      ...
      ((D.records.head = f),
        ...
        r.debug(D.records.branches),
        r.debug(`in mergeBranch`));
    }, `merge`)),
    (he = i(function (e) {
      let t = e.id,
        n = e.targetId,
      ...
      if (
        ((t = g.sanitizeText(t, o)),
        (n = g.sanitizeText(n, o)),
        (i = i?.map((e) => g.sanitizeText(e, o))),
        (a = g.sanitizeText(a, o)),
      ...
      if (!n || !D.records.commits.has(n)) {
        ...
        let l = {
          ...
          tags: i
            ? i.filter(Boolean)
            : [
                `cherry-pick:${s.id}${s.type === T.MERGE ? `|parent:${a}` : ``}`,
              ],
        };
        ((D.records.head = l),
          D.records.commits.set(l.id, l),
          D.records.branches.set(D.records.currBranch, l.id),
          r.debug(D.records.branches),
          r.debug(`in cherryPick`));
      }
    }, `cherryPick`)),
    (O = i(function (e) {
      if (((e = g.sanitizeText(e, E())), D.records.branches.has(e))) {
    ...
    (ve = i(function () {
      return [...D.records.branchConfig.values()]
        .map((e, t) =>
    ...
    (A = {
      ...
      prettyPrint: ge,
      clear: _e,
      getBranchesAsObjArray: ve,
      getBranches: ye,
      getCommits: be,
      getCommitsArray: k,
      getCurrentBranch: i(function () {
        return D.records.currBranch;
      }, `getCurrentBranch`),
      getDirection: i(function () {
    ...
    (xe = i((e, t) => {
      (te(e, t), e.dir && t.setDirection(e.dir));
      for (let n of e.statements) Se(n, t);
    }, `populate`)),
    (Se = i((e, t) => {
      let n = {
        Commit: i((e) => t.commit(Ce(e)), `Commit`),
        Branch: i((e) => t.branch(we(e)), `Branch`),
        Merge: i((e) => t.merge(Te(e)), `Merge`),
        Checkout: i((e) => t.checkout(Ee(e)), `Checkout`),
        CherryPicking: i((e) => t.cherryPick(De(e)), `CherryPicking`),
      }[e.$type];
      n ? n(e) : r.error(`Unknown statement type: ${e.$type}`);
    }, `parseStatement`)),
    (Ce = i(
      (e) => ({
        id: e.id,
    ...
    (we = i((e) => ({ name: e.name, order: e.order ?? 0 }), `parseBranch`)),
    (Te = i(
      (e) => ({
        branch: e.branch,
        id: e.id ?? ``,
    ...
    (P = 2),
    (F = 8),
    (I = new Set([`redux`, `redux-dark`, `redux-color`, `redux-dark-color`])),
    (L = 12),
    (R = new Set([`redux-color`, `redux-dark-color`])),
    (ke = new Set([`dark`, `redux-dark`, `redux-dark-color`, `neo-dark`])),
    (z = i(
      (e, t, n = !1) => (n && e > 0 ? ((e - 1) % (t - 1)) + 1 : e % t),
      `calcColorIndex`,
    )),
    (B = new Map()),
    (V = new Map()),
    ...
    (J = i((e) => {
      ...
      return (
        K === `BT`
          ? ((n = i((e, t) => e <= t, `comparisonFunc`)), (r = 1 / 0))
          : ((n = i((e, t) => e >= t, `comparisonFunc`)), (r = 0)),
        e.forEach((e) => {
    ...
    (Me = i((e, t, n) => {
      ...
      (e.forEach((e) => {
        ...
        (n.parents.length ? ((r = Pe(n)), (i = Math.max(r, i))) : a.push(n),
          Fe(n, r));
      }),
        (r = i),
        a.forEach((e) => {
    ...
    (Pe = i((e) => Ne(e) + M, `calculateCommitPosition`)),
    (Fe = i((e, t) => {
      let n = B.get(e.branch);
      if (!n) throw Error(`Branch not found for commit ${e.id}`);
      let r = n.pos,
        i = t + j;
      return (V.set(e.id, { x: r, y: i }), { x: r, y: i });
    }, `setCommitPosition`)),
    (Ie = i((e, t, n) => {
    ...
    (Le = i((e, t, n, r, i, a) => {
      ...
      if (a === T.HIGHLIGHT)
        (e
          ...
          .attr(
            `class`,
            `commit ${t.id} commit-highlight${z(i, F, c)} ${r}-outer`,
          ),
          e
            .append(`rect`)
            .attr(`x`, n.x - 6 + (s ? 2 : 0))
            ...
            .attr(`width`, s ? 8 : 12)
            .attr(`height`, s ? 8 : 12)
            .attr(`class`, `commit ${t.id} commit${z(i, F, c)} ${r}-inner`));
      else if (a === T.CHERRY_PICK)
        (e
          .append(`circle`)
          .attr(`cx`, n.x)
          .attr(`cy`, n.y)
        ...
        if (
          ...
          o.attr(`cy`, n.y),
          o.attr(`r`, s ? 7 : 10),
          o.attr(`class`, `commit ${t.id} commit${z(i, F, c)}`),
          a === T.MERGE)
        ) {
          ...
          (a.attr(`cx`, n.x),
            a.attr(`cy`, n.y),
            a.attr(`r`, s ? 5 : 6),
            a.attr(`class`, `commit ${r} ${t.id} commit${z(i, F, c)}`));
        }
        if (a === T.REVERSE) {
          let a = e.append(`path`),
            o = s ? 4 : 5;
          a.attr(
            `d`,
            `M ${n.x - o},${n.y - o}L${n.x + o},${n.y + o}M${n.x - o},${n.y + o}L${n.x + o},${n.y - o}`,
          ).attr(`class`, `commit ${r} ${t.id} commit${z(i, F, c)}`);
        }
      }
    }, `drawCommitBullet`)),
    (Re = i((e, t, n, r, i) => {
      if (
        t.type !== T.CHERRY_PICK &&
        ((t.customId && t.type === T.MERGE) || t.type !== T.MERGE) &&
        i.showCommitLabel
      ) {
        let a = e.append(`g`),
          o = a.insert(`rect`).attr(`class`, `commit-label-bkg`),
          s = a
            .append(`text`)
            .attr(`x`, r)
            .attr(`y`, n.y + 25)
        ...
        if (
          c &&
          (o
            .attr(`x`, n.posWithOffset - c.width / 2 - P)
            .attr(`y`, n.y + 13.5)
            .attr(`width`, c.width + 2 * P)
            .attr(`height`, c.height + 2 * P),
          K === `TB` || K === `BT`
            ? (o.attr(`x`, n.x - (c.width + 4 * N + 5)).attr(`y`, n.y - 12),
              s
                .attr(`x`, n.x - (c.width + 4 * N))
                .attr(`y`, n.y + c.height - 12))
            : s.attr(`x`, n.posWithOffset - c.width / 2),
          i.rotateCommitLabel)
        )
          if (K === `TB` || K === `BT`)
            (s.attr(`transform`, `rotate(-45, ` + n.x + `, ` + n.y + `)`),
    ...
    (He = i((e, t, n) => {
      let r = K === `BT` && n ? t : t + j,
        i = B.get(e.branch)?.pos,
        a = K === `TB` || K === `BT` ? B.get(e.branch)?.pos : r;
    ...
    (Y = i((e, t, n, r) => {
      let a = e.append(`g`).attr(`class`, `commit-bullets`),
        o = e.append(`g`).attr(`class`, `commit-labels`),
        s = K === `TB` || K === `BT` ? H : 0,
        c = [...t.keys()],
        l = r.parallelCommits ?? !1,
        u = i((e, n) => {
          let r = t.get(e)?.seq,
            i = t.get(n)?.seq;
        ...
        d = c.sort(u);
      (K === `BT` && (l && Me(d, t, s), (d = d.reverse())),
        d.forEach((e) => {
          let i = t.get(e);
          if (!i) throw Error(`Commit not found for key ${e}`);
          l && (s = Ve(i, K, s, V));
          let c = He(i, s, l);
          if (n) {
            let e = Be(i),
              t = i.customType ?? i.type;
            (Le(a, i, c, e, B.get(i.branch)?.index ?? 0, t),
              Re(o, i, c, s, r),
              ze(o, i, c, s));
          }
          (K === `TB` || K === `BT`
            ? V.set(i.id, { x: c.x, y: c.posWithOffset })
            : V.set(i.id, { x: c.posWithOffset, y: c.y }),
            (s = K === `BT` && l ? s + M : s + M + j),
            s > G && (G = s));
        }));
    }, `drawCommits`)),
    (Ue = i((e, t, n, r, a) => {
      let o = (K === `TB` || K === `BT` ? n.x < r.x : n.y < r.y)
          ? t.branch
          : e.branch,
        s = i((e) => e.branch === o, `isOnBranchToGetCurve`),
        c = i((n) => n.seq > e.seq && n.seq < t.seq, `isBetweenCommits`);
    ...
    (X = i((e, t, n = 0) => {
      ...
      return n > 5
        ? r
        : W.every((e) => Math.abs(e - r) >= 10)
          ? (W.push(r), r)
          : X(e, t - Math.abs(e - t) / 5, n + 1);
    }, `findLane`)),
    (Z = i((e, t, n, r) => {
      let { theme: i } = m(),
        a = R.has(i ?? ``),
      ...
      let c = Ue(t, n, o, s, r),
        ...
        d = 0,
        f = 0,
        p = B.get(n.branch)?.index;
      n.type === T.MERGE &&
        t.id !== n.parents[0] &&
        (p = B.get(t.branch)?.index);
      let h;
      if (c) {
        ((l = `A 10 10, 0, 0, 0,`),
          (u = `A 10 10, 0, 0, 1,`),
          (d = 10),
          (f = 10));
        let e = o.y < s.y ? X(o.y, s.y) : X(s.y, o.y),
          n = o.x < s.x ? X(o.x, s.x) : X(s.x, o.x);
        K === `TB`
          ? o.x < s.x
            ? (h = `M ${o.x} ${o.y} L ${n - d} ${o.y} ${u} ${n} ${o.y + f} L ${n} ${s.y - d} ${l} ${n + f} ${s.y} L ${s.x} ${s.y}`)
            : ((p = B.get(t.branch)?.index),
              (h = `M ${o.x} ${o.y} L ${n + d} ${o.y} ${l} ${n} ${o.y + f} L ${n} ${s.y - d} ${u} ${n - f} ${s.y} L ${s.x} ${s.y}`))
          : K === `BT`
            ? o.x < s.x
              ? (h = `M ${o.x} ${o.y} L ${n - d} ${o.y} ${l} ${n} ${o.y - f} L ${n} ${s.y + d} ${u} ${n + f} ${s.y} L ${s.x} ${s.y}`)
              : ((p = B.get(t.branch)?.index),
                (h = `M ${o.x} ${o.y} L ${n + d} ${o.y} ${u} ${n} ${o.y - f} L ${n} ${s.y + d} ${l} ${n - f} ${s.y} L ${s.x} ${s.y}`))
            : o.y < s.y
              ? (h = `M ${o.x} ${o.y} L ${o.x} ${e - d} ${l} ${o.x + f} ${e} L ${s.x - d} ${e} ${u} ${s.x} ${e + f} L ${s.x} ${s.y}`)
              : ((p = B.get(t.branch)?.index),
                (h = `M ${o.x} ${o.y} L ${o.x} ${e + d} ${u} ${o.x + f} ${e} L ${s.x - d} ${e} ${l} ${s.x} ${e - f} L ${s.x} ${s.y}`));
      } else
        ((l = `A 20 20, 0, 0, 0,`),
          (u = `A 20 20, 0, 0, 1,`),
          (d = 20),
          ...
          K === `TB`
            ? (o.x < s.x &&
                (h =
                  n.type === T.MERGE && t.id !== n.parents[0]
                    ? `M ${o.x} ${o.y} L ${o.x} ${s.y - d} ${l} ${o.x + f} ${s.y} L ${s.x} ${s.y}`
                    : `M ${o.x} ${o.y} L ${s.x - d} ${o.y} ${u} ${s.x} ${o.y + f} L ${s.x} ${s.y}`),
              o.x > s.x &&
                ((l = `A 20 20, 0, 0, 0,`),
                (u = `A 20 20, 0, 0, 1,`),
                (d = 20),
                ...
                (h =
                  n.type === T.MERGE && t.id !== n.parents[0]
                    ? `M ${o.x} ${o.y} L ${o.x} ${s.y - d} ${u} ${o.x - f} ${s.y} L ${s.x} ${s.y}`
                    : `M ${o.x} ${o.y} L ${s.x + d} ${o.y} ${l} ${s.x} ${o.y + f} L ${s.x} ${s.y}`)),
              o.x === s.x && (h = `M ${o.x} ${o.y} L ${s.x} ${s.y}`))
            : K === `BT`
              ? (o.x < s.x &&
                  (h =
                    n.type === T.MERGE && t.id !== n.parents[0]
                ...
                o.y > s.y &&
                  (h =
                    n.type === T.MERGE && t.id !== n.parents[0]
                      ? `M ${o.x} ${o.y} L ${s.x - d} ${o.y} ${l} ${s.x} ${o.y - f} L ${s.x} ${s.y}`
                      : `M ${o.x} ${o.y} L ${o.x} ${s.y + d} ${u} ${o.x + f} ${s.y} L ${s.x} ${s.y}`),
                o.y === s.y && (h = `M ${o.x} ${o.y} L ${s.x} ${s.y}`)));
      if (h === void 0) throw Error(`Line definition not found`);
      e.append(`path`)
        .attr(`d`, h)
        .attr(`class`, `arrow arrow` + z(p, F, a));
    }, `drawArrow`)),
    (We = i((e, t) => {
    ...
    (Ge = i((e, t, n, r) => {
      let { look: i, theme: a, themeVariables: o } = m(),
        { dropShadow: s, THEME_COLOR_LIMIT: c } = o,
        l = I.has(a ?? ``),
        u = R.has(a ?? ``),
        d = e.append(`g`);
      t.forEach((e, t) => {
        ...
        let f = K === `TB` || K === `BT` ? o : l ? o + L / 2 + 1 : o - 2,
          p = d.append(`line`);
        (p.attr(`x1`, 0),
          p.attr(`y1`, f),
          p.attr(`x2`, G),
          p.attr(`y2`, f),
          p.attr(`class`, `branch branch` + a),
          K === `TB`
            ? (p.attr(`y1`, H),
              p.attr(`x1`, o),
              p.attr(`y2`, G),
        ...
        let v = h.getBBox(),
          ...
          b = l ? 16 : 0,
          x = l ? L : 0;
        (i === `neo` && g.attr(`data-look`, `neo`),
          g
            .attr(`class`, `branchLabelBkg label` + a)
            .attr(
              `style`,
              i === `neo` ? `filter:${l ? `url(#${r}-drop-shadow)` : s}` : ``,
            )
            .attr(`rx`, y)
            .attr(`ry`, y)
            .attr(`x`, -v.width - 4 - (n.rotateCommitLabel === !0 ? 30 : 0))
            .attr(`y`, -v.height / 2 + 10)
            .attr(`width`, v.width + 18 + b)
            .attr(`height`, v.height + 4 + x),
          _.attr(
            `transform`,
            `translate(` +
              (-v.width - 14 - (n.rotateCommitLabel === !0 ? 30 : 0) + b / 2) +
              `, ` +
              (f - v.height / 2 - 2) +
              `)`,
          ),
          K === `TB`
            ? (g.attr(`x`, o - v.width / 2 - 10).attr(`y`, 0),
              _.attr(
                `transform`,
                `translate(` + (o - v.width / 2 - 5) + `, 0)`,
              ),
              l &&
                (g.attr(`transform`, `translate(${-b / 2 - 3}, ${-x - 10})`),
                _.attr(
                  `transform`,
                  `translate(` +
                    (o - v.width / 2 - 5) +
            ...
            : K === `BT`
              ? (g.attr(`x`, o - v.width / 2 - 10).attr(`y`, G),
                _.attr(
                  `transform`,
                  `translate(` + (o - v.width / 2 - 5) + `, ` + G + `)`,
                ),
                l &&
                  (g.attr(`transform`, `translate(${-b / 2 - 3}, ${x + 10})`),
                  _.attr(
              ...
              : g.attr(
                  `transform`,
                  `translate(-19, ` + (f - 12 - x / 2) + `)`,
                ));
      });
    }, `drawBranches`)),
    (Ke = i(function (e, t, n, r, i) {
      return (
        B.set(e, { pos: t, index: n }),
        (t += 50 + (i ? 40 : 0) + (K === `TB` || K === `BT` ? r.width / 2 : 0)),
        t
      );
    }, `setBranchPosition`)),
    (qe = {
      draw: i(function (e, n, i, a) {
        (Ae(),
          r.debug(
...
`,
        ...
        let s = o.getConfig(),
          c = s.rotateCommitLabel ?? !1;
        U = o.getCommits();
        let l = o.getBranchesAsObjArray();
        K = o.getDirection();
        let d = t(`[id="${n}"]`),
          { look: f, theme: p, themeVariables: h } = m(),
          {
            useGradient: g,
            gradientStart: _,
            gradientStop: v,
        ...
        (l.forEach((e, t) => {
          let n = q(e.name),
            ...
            a = i.insert(`g`).attr(`class`, `label branch-label`);
          a.node()?.appendChild(n);
          let o = n.getBBox();
          ((x = Ke(e.name, x, t, o, c)), a.remove(), i.remove(), r.remove());
        }),
          Y(d, U, !1, s),
          s.showBranches && Ge(d, l, s, n),
          We(d, U),
          Y(d, U, !0, s),
          y.insertTitle(
            d,
          ...
          u(void 0, d, s.diagramPadding, s.useMaxWidth));
      }, `draw`),
    }),
    (Q = 8),
    ($ = new Set([`redux`, `redux-dark`, `redux-color`, `redux-dark-color`])),
    (Je = new Set([`redux-color`, `redux-dark-color`])),
    (Ye = new Set([`neo`, `neo-dark`])),
    (Xe = new Set([`dark`, `redux-dark`, `redux-dark-color`, `neo-dark`])),
    (Ze = new Set([
      `redux`,
      `redux-dark`,
      `redux-color`,
    ...
    ($e = i((e) => {
      let { theme: t, themeVariables: n } = v(),
        { borderColorArray: r } = n,
        i = $.has(t);
      if (Ye.has(t)) {
        let t = ``;
        ...
        .label${a}  { fill: ${Xe.has(t) ? e.mainBkg : r[o]}; stroke: ${r[o]};  stroke-width: ${e.strokeWidth}; }
        .arrow${a} { stroke: ${r[o]}; }
        `;
          }
        return n;
    ...
    (et = i(
      (e) =>
        `${Array.from({ length: e.THEME_COLOR_LIMIT }, (e, t) => t).map((t) => {
          let n = t % Q;
          return `
...
`)}`,
  ...
  .commit-label-bkg { font-size: ${e.commitLabelFontSize}; fill: ${n ? `transparent` : e.commitLabelBackground}; opacity: ${n ? `` : 0.5};  }
...
//# sourceMappingURL=gitGraphDiagram-UUTBAWPF-DBNPirJY.js.map
