...
import { n as fe, t as pe } from "./permission-request-model-FfJwWzP9.js";
function g({
  axis: e,
  debounce: t,
  initialSize: n = !0,
  ...
  let o = new AbortController(),
    ...
    u = new ResizeObserver((n) => {
      n.forEach((n) => {
        ...
        if (((l = !1), d))
          if (!t)
            r({ width: i, height: u, previousWidth: s, previousHeight: c }, n);
          else {
            ...
            requestAnimationFrame(() => {
              e.aborted ||
                r(
                  { width: i, height: u, previousWidth: s, previousHeight: c },
                  n,
                );
            });
          }
...
function me(e) {
  if (e == null) return y;
  if (e.kind === `first-awake`) return b;
  if (e.isLoading)
    return {
      ...
      fallbackBodyMessage: v.runningFallbackBody,
      iconClassName: `icon-xs shrink-0 text-token-text-secondary`,
      iconType: `spinner`,
      labelMessage: v.running,
      mascotState: `running`,
    };
  switch (e.level) {
    case `warning`:
  ...
  he = e(() => {
    (p(),
      ...
      (y = {
        badgeBackgroundColor: `var(--color-token-activity-bar-badge-background)`,
        badgeForegroundColor: `var(--color-token-activity-bar-badge-foreground)`,
        fallbackBodyMessage: v.info,
        iconClassName: `icon-xs shrink-0 text-token-text-secondary`,
        iconType: `clock`,
        labelMessage: v.info,
        mascotState: `idle`,
      }),
      (b = { ...y, mascotState: `waving` }));
  });
function ge(
  e,
  t,
  ...
  switch (e?.type) {
    case `userInput`:
      return e.isOnboardingDynamicInput === !0 ? null : ye(e, t);
    case `approval`:
      return e.item.type === `exec` ? x(e.item, t) : S(e.item, t);
...
function xe({
  ...
  return {
    ...
    showInNotificationTray:
      !c || s === `waiting` || s === `failed` || l != null,
    sortAtMs: h(e)?.turnStartedAtMs ?? e.updatedAt,
    status: s,
    subtitle: l,
    title: le(e) ?? r.formatMessage(W.newThread),
    turnKey: String(ee(e)),
    updatedAtMs: e.updatedAt,
    waitingRequest: ge(u, r, {
      includeMcpElicitationCancelAction: n,
  ...
  let t = e.resumeState === `needs_resume` ? e.threadRuntimeStatus : null,
    n =
      e.resumeState === `needs_resume`
        ? t?.type === `active`
        : e.resumeState === `resuming` || h(e)?.status === `inProgress`,
    r =
      e.resumeState === `needs_resume`
...
function je() {
  ...
  return (
    e[4] !== r || e[5] !== a
      ? ((o = { mascotWidthPx: r, setMascotWidthPx: a }),
        (e[4] = r),
        (e[5] = a),
        (e[6] = o))
      : (o = e[6]),
...
var K,
  ...
  Ne = e(() => {
    ((K = n()),
      ...
      (Y = 80),
      (X = 224),
      (Z = u(`avatar-overlay-mascot-width-px`, null)));
  });
function Pe(e) {
  let t = (0, Q.c)(4),
...
//# sourceMappingURL=avatar-overlay-pill-dismiss-button-Br8FWkZZ.js.map
