...
import { a as t, o as n, s as r, t as i } from "./dist-CPJPVGOt.js";
...
import { n as p, t as m } from "./chunk-426QAEUC-DxNwCBET.js";
import { u as h } from "./chunk-5PVQY5BW-Qrvqj614.js";
import { i as g } from "./chunk-U2HBQHQK-DvR2_n0Q.js";
import { n as _, t as v } from "./chunk-FMBD7UC4-DiCLsQbr.js";
import { r as y } from "./chunk-ZZ45TVLE-DPQKb5AH.js";
import { n as b } from "./chunk-X2U36JSP-BmpNIx8t.js";
import { a as x, i as S, l as C, o as w } from "./chunk-5FUZZQ4R-B8ooWnWH.js";
import { n as T, r as E, t as D } from "./chunk-XPW4576I-0hF9oWgW.js";
var O, k, A, j, M, N, P, F, I, L, R, z, B, V, H, U;
e(() => {
  (m(),
    _(),
    T(),
    ...
    (O = (function () {
      var e = o(function (e, t, n, r) {
        ...
        m = [1, 31],
        h = [6, 7, 11, 24],
        g = [1, 6, 13, 16, 17, 20, 23],
        _ = [1, 35],
        v = [1, 36],
        y = [1, 6, 7, 11, 13, 16, 17, 20, 23],
        b = [1, 38],
        x = {
          ...
          performAction: o(function (e, t, n, r, i, a, o) {
            ...
            switch (i) {
              ...
              case 12:
                ...
                break;
              case 15:
                (r.getLogger().info(`Node: `, a[s - 1].id),
                  r.addNode(
                    a[s - 2].length,
                    a[s - 1].id,
                    a[s - 1].descr,
              ...
              case 19:
                ...
                break;
              case 20:
                (r.getLogger().trace(`Node: `, a[s - 1].id),
                  r.addNode(
                    0,
                    a[s - 1].id,
                    a[s - 1].descr,
...
` +
      ...
      return (o(S, `Parser`), (S.prototype = x), (x.Parser = S), new S());
    })()),
    (O.parser = O),
    (k = O),
    (A = []),
    ...
    (F = o((e) => {
      ...
      for (let e = A.length - 1; e >= 0; e--)
        if ((A[e].level === t && !n && (n = A[e]), A[e].level < t))
          throw Error(
    ...
    (L = o(function () {
      ...
      for (let e of n) {
        ...
        t.push(n);
        let i = A.filter((t) => t.parentId === e.id);
        for (let n of i) {
          let i = {
            id: n.id,
            parentId: e.id,
      ...
      return { nodes: t, edges: e, other: {}, config: u() };
    }, `getData`)),
    (R = o((e, t, n, r, i) => {
      let a = u(),
        o = a.mindmap?.padding ?? d.mindmap.padding;
      switch (r) {
        case z.ROUNDED_RECT:
        case z.RECT:
        case z.HEXAGON:
      ...
      let s = {
        ...
        level: e,
        label: l(n, a),
        width: a.mindmap?.maxNodeWidth ?? d.mindmap.maxNodeWidth,
        padding: o,
        isGroup: !1,
      };
      if (i !== void 0) {
...
` +
        ...
        if (
          t.shape &&
          (t.shape !== t.shape.toLowerCase() || t.shape.includes(`_`))
        )
          throw Error(
            `No such shape: ${t.shape}. Shape names should be lowercase.`,
          );
        (t?.shape && t.shape === `kanbanItem` && (s.shape = t?.shape),
          t?.label && (s.label = t?.label),
          t?.icon && (s.icon = t?.icon.toString()),
          t?.assigned && (s.assigned = t?.assigned.toString()),
          t?.ticket && (s.ticket = t?.ticket.toString()),
          t?.priority && (s.priority = t?.priority));
      }
      let c = F(e);
      (c ? (s.parentId = c.id || `kbn` + M++) : j.push(s), A.push(s));
    }, `addNode`)),
    (z = {
      DEFAULT: 0,
      NO_BORDER: 0,
    ...
    (B = {
      ...
      nodeType: z,
      getType: o((e, t) => {
        switch ((a.debug(`In get type`, e, t), e)) {
          case `[`:
            return z.RECT;
          case `(`:
            return t === `)` ? z.ROUNDED_RECT : z.CLOUD;
          case `((`:
            return z.CIRCLE;
          case `)`:
            return z.CLOUD;
      ...
      decorateNode: o((e) => {
        ...
        let t = u(),
          n = A[A.length - 1];
        (e.icon && (n.icon = l(e.icon, t)),
          e.class && (n.cssClasses = l(e.class, t)));
      }, `decorateNode`),
      type2Str: o((e) => {
        switch (e) {
          case z.DEFAULT:
      ...
      getElementById: o((e) => N[e], `getElementById`),
    }),
    (V = {
      draw: o(async (e, t, n, r) => {
        a.debug(
...
` + e,
        ...
        o.htmlLabels = !1;
        let s = p(t);
        for (let e of i.nodes) e.domId = `${t}-${e.id}`;
        let c = s.append(`g`);
        c.attr(`class`, `sections`);
        let l = s.append(`g`);
        l.attr(`class`, `items`);
        let m = i.nodes.filter((e) => e.isGroup),
          h = 0,
          g = [],
          _ = 25;
        for (let e of m) {
          ...
          ((h += 1),
            ...
            (e.rx = 5),
            (e.ry = 5),
            (e.cssClasses = e.cssClasses + ` section-` + h));
          let n = await x(c, e);
          ((_ = Math.max(_, n?.labelBBox?.height)), g.push(n));
        }
        let v = 0;
        for (let e of m) {
          let t = g[v];
          v += 1;
          let n = o?.kanban?.sectionWidth || 200,
            r = (-n * 3) / 2 + _,
            a = r,
            s = i.nodes.filter((t) => t.parentId === e.id);
          for (let t of s) {
            if (t.isGroup)
              throw Error(
            ...
            let r = (await w(l, t, { config: o })).node().getBBox();
            ((t.y = a + r.height / 2),
              await C(t),
              (a = t.y + r.height / 2 + 10 / 2));
          }
          let c = t.cluster.select(`rect`),
            u = Math.max(a - r + 30, 50) + (_ - 25);
          c.attr(`height`, u);
        }
        f(
          void 0,
          s,
          o.mindmap?.padding ?? d.kanban.padding,
          o.mindmap?.useMaxWidth ?? d.kanban.useMaxWidth,
        );
      }, `draw`),
    }),
    (H = o((e) => {
      ...
      for (let i = 0; i < e.THEME_COLOR_LIMIT; i++)
        ((e[`lineColor` + i] = e[`lineColor` + i] || e[`cScaleInv` + i]),
          r(e[`lineColor` + i])
            ? (e[`lineColor` + i] = n(e[`lineColor` + i], 20))
            : (e[`lineColor` + i] = t(e[`lineColor` + i], 20)));
      let a = o((r, i) => (e.darkMode ? t(r, i) : n(r, i)), `adjuster`);
    ...
    .section-${t - 1} rect, .section-${t - 1} path, .section-${t - 1} circle, .section-${t - 1} polygon, .section-${t - 1} path  {
      fill: ${a(e[`cScale` + t], 10)};
      stroke: ${a(e[`cScale` + t], 10)};
...
export { U as diagram };
//# sourceMappingURL=kanban-definition-6JOO6SKY-CkaCpUwV.js.map
