...
import { C as Pe, o as Fe, w as Ie } from "./document-Cpom6Lb8.js";
import {
  A as Le,
  C as Re,
  D as ze,
...
import { n as gt, t as _t } from "./PopcornPageNumberNavigation-Cr5rDVih.js";
var vt,
  yt,
  bt = e(() => {
    (_(),
...
function fu({
  ...
  return (
    ...
    S
      ? (0, mu.jsx)(`section`, {
          className: a(`no-drag h-full min-h-0 bg-token-bg-primary`, e),
...
var pu, mu;
e(() => {
  (Jc(), i(), (pu = t(n())), uu(), wl(), ll(), Re(), (mu = r()));
})();
export { fu as PopcornElectronDocumentPanel };
//# sourceMappingURL=PopcornElectronDocumentPanel-BJYIlWEb.js.map
