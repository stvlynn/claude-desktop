...
import { i, n as a, r as o } from "./chunk-AGHRB4JF-DJZonIPK.js";
import {
  B as s,
  C as c,
  L as l,
...
import { t as b } from "./src-CTe_6Jg1.js";
import { n as x, t as S } from "./chunk-EXTU4WIE-_aHv87Z4.js";
import { r as C, u as w } from "./chunk-S3R3BYOJ-BBYtiirL.js";
import { i as T, t as E } from "./chunk-JA3XYJ7Z-DXPUiutJ.js";
function D(e) {
  return e.type === `bar`;
}
function O(e) {
...
function A(e, t, n, r) {
  let i = new H(r);
  return O(e)
    ? new pe(t, n, e.categories, e.title, i)
    : new me(t, n, [e.min, e.max], e.title, i);
}
function j(e, t, n, r) {
  return new he(new H(r), e, t, n);
}
function M(e, t, n) {
  return new ve(e, t, n);
}
function N() {
  let e = u(),
    t = y();
  return C(e.xyChart, t.themeVariables.xyChart);
}
function P() {
  let e = y();
  return C(g.xyChart, e.xyChart);
}
function F() {
  return {
...
function te(e) {
  e === `horizontal`
    ? (J.chartOrientation = `horizontal`)
    : (J.chartOrientation = `vertical`);
}
function L(e) {
  X.xAxis.title = I(e.text);
}
function R(e, t) {
  ((X.xAxis = { type: `linear`, title: X.xAxis.title, min: e, max: t }),
    (Q = !0));
}
function ne(e) {
  ((X.xAxis = {
    type: `band`,
    title: X.xAxis.title,
    categories: e.map((e) => I(e.text)),
  }),
    (Q = !0));
}
function re(e) {
  X.yAxis.title = I(e.text);
}
function ie(e, t) {
  ((X.yAxis = { type: `linear`, title: X.yAxis.title, min: e, max: t }),
    ($ = !0));
}
function ae(e) {
  let t = Math.min(...e),
    n = Math.max(...e),
    r = k(X.yAxis) ? X.yAxis.min : 1 / 0,
    i = k(X.yAxis) ? X.yAxis.max : -1 / 0;
  X.yAxis = {
    type: `linear`,
    title: X.yAxis.title,
    min: Math.min(r, t),
...
function z(e) {
  ...
  if (!Q) {
    let t = k(X.xAxis) ? X.xAxis.min : 1 / 0,
      n = k(X.xAxis) ? X.xAxis.max : -1 / 0;
    R(Math.min(t, 1), Math.max(n, e.length));
  }
  if (
    ($ || ae(e),
    O(X.xAxis) && (t = X.xAxis.categories.map((t, n) => [t, e[n]])),
    k(X.xAxis))
  ) {
    let n = X.xAxis.min,
      r = X.xAxis.max,
...
function B(e) {
  return Z[e === 0 ? 0 : e % Z.length];
}
function oe(e, t) {
  let n = z(t);
  (X.plots.push({ type: `line`, strokeFill: B(q), strokeWidth: 2, data: n }),
    q++);
}
function se(e, t) {
  let n = z(t);
  (X.plots.push({ type: `bar`, fill: B(q), data: n }), q++);
}
function ce() {
  if (X.plots.length === 0)
    throw Error(`No Plot to render, please provide a plot with some data`);
  return ((X.title = c()), K.build(J, X, Y, be));
}
function le() {
  return Y;
}
  ...
  (S(),
    ...
    (V = (function () {
      var e = a(function (e, t, n, r) {
        ...
        o = [1, 6],
        s = [1, 7],
        c = [1, 5, 10, 12, 14, 16, 18, 19, 21, 23, 34, 35, 36],
        l = [1, 25],
        u = [1, 26],
        d = [1, 28],
        f = [1, 29],
        ...
        C = [1, 47],
        w = [1, 50],
        T = [1, 10, 12, 14, 16, 18, 19, 21, 23, 34, 35, 36],
        E = [1, 10, 12, 14, 16, 18, 19, 21, 23, 24, 26, 27, 28, 34, 35, 36],
        D = [
        ...
        k = {
          ...
          performAction: a(function (e, t, n, r, i, a, o) {
            ...
            switch (i) {
              ...
              case 9:
                ...
                break;
              case 12:
                r.setLineData({ text: ``, type: `text` }, a[s]);
                break;
              case 13:
                r.setLineData(a[s - 1], a[s]);
                break;
              case 14:
                r.setBarData({ text: ``, type: `text` }, a[s]);
                break;
              case 15:
              ...
              case 23:
                ...
                break;
              case 24:
                r.setXAxisTitle({ type: `text`, text: `` });
                break;
              case 25:
                r.setXAxisBand(a[s]);
                break;
              ...
              case 31:
                ...
                break;
              case 32:
                r.setYAxisTitle({ type: `text`, text: `` });
                break;
              case 33:
          ...
          table: [
            e(t, n, { 3: 1, 4: 2, 7: 4, 5: r, 34: i, 35: o, 36: s }),
            { 1: [3] },
            e(t, n, { 4: 2, 7: 4, 3: 8, 5: r, 34: i, 35: o, 36: s }),
            e(t, n, {
              4: 2,
              7: 4,
              6: 9,
            ...
            e(c, [2, 36]),
            { 1: [2, 1] },
            e(t, n, { 4: 2, 7: 4, 3: 21, 5: r, 34: i, 35: o, 36: s }),
            { 1: [2, 3] },
            e(c, [2, 5]),
            e(t, [2, 7], { 4: 22, 34: i, 35: o, 36: s }),
            {
              11: 23,
              37: 24,
              38: l,
            ...
            e(D, [2, 51]),
            e(T, [2, 10]),
            e(T, [2, 22], { 30: 41, 29: 56, 24: x, 27: S }),
            e(T, [2, 24]),
            e(T, [2, 25]),
            { 31: [1, 57] },
            {
...
` +
      ...
      return (a(A, `Parser`), (A.prototype = k), (k.Parser = A), new A());
    })()),
    (V.parser = V),
    (fe = V),
    a(D, `isBarPlot`),
    a(O, `isBandAxisData`),
    a(k, `isLinearAxisData`),
    (H = class {
      constructor(e) {
        this.parentGroup = e;
      }
      ...
      getMaxDimension(e, t) {
        ...
        for (let i of e) {
          let e = E(r, 1, i),
            a = e ? e.width : i.length * t,
            o = e ? e.height : t;
          ((n.width = Math.max(n.width, a)),
            (n.height = Math.max(n.height, o)));
        }
        return (r.remove(), n);
      }
    }),
    ...
    (G = class {
      ...
      setRange(e) {
        ((this.range = e),
          this.axisPosition === `left` || this.axisPosition === `right`
            ? (this.boundingRect.height = e[1] - e[0])
            : (this.boundingRect.width = e[1] - e[0]),
      ...
      recalculateOuterPaddingToDrawBar() {
        (U * this.getTickDistance() > this.outerPadding * 2 &&
          (this.outerPadding = Math.floor((U * this.getTickDistance()) / 2)),
          this.recalculateScale());
      }
      calculateSpaceIfDrawnHorizontally(e) {
        ...
        if (
          (this.axisConfig.showAxisLine &&
            t > this.axisConfig.axisLineWidth &&
            ((t -= this.axisConfig.axisLineWidth), (this.showAxisLine = !0)),
        ...
        if (
          (this.axisConfig.showTick &&
            t >= this.axisConfig.tickLength &&
            ((this.showTick = !0), (t -= this.axisConfig.tickLength)),
          ...
          let e = this.textDimensionCalculator.getMaxDimension(
            ...
            n = e.height + this.axisConfig.titlePadding * 2;
          ((this.titleTextHeight = e.height),
            n <= t && ((t -= n), (this.showTitle = !0)));
        }
        ((this.boundingRect.width = e.width),
          (this.boundingRect.height = e.height - t));
      }
      calculateSpaceIfDrawnVertical(e) {
        ...
        ((this.boundingRect.width = e.width - t),
          (this.boundingRect.height = e.height));
      }
      calculateSpace(e) {
        return (
          this.axisPosition === `left` || this.axisPosition === `right`
            ? this.calculateSpaceIfDrawnVertical(e)
            : this.calculateSpaceIfDrawnHorizontally(e),
          this.recalculateScale(),
    ...
    (pe = class extends G {
      ...
      constructor(e, t, n, i, a) {
        (super(e, i, a, t),
          (this.categories = n),
          (this.scale = r().domain(this.categories).range(this.getRange())));
      }
      setRange(e) {
        super.setRange(e);
      }
    ...
    (me = class extends G {
      ...
      constructor(e, n, r, i, a) {
        (super(e, i, a, n),
          (this.domain = r),
          (this.scale = t().domain(this.domain).range(this.getRange())));
      }
      getTickValues() {
      ...
      recalculateScale() {
        let e = [...this.domain];
        (this.axisPosition === `left` && e.reverse(),
          (this.scale = t().domain(e).range(this.getRange())));
      }
      getScaleValue(e) {
        return this.scale(e);
      }
    ...
    (he = class {
      ...
      calculateSpace(e) {
        let t = this.textDimensionCalculator.getMaxDimension(
          ...
          r = t.height + 2 * this.chartConfig.titlePadding;
        return (
          t.width <= n &&
            t.height <= r &&
    ...
    (ge = class {
      ...
      getDrawableElement() {
        let e = this.plotData.data.map((e) => [
    ...
    (ve = class {
      ...
      getDrawableElements() {
        ...
        let e = [];
        for (let [t, n] of this.chartData.plots.entries())
          switch (n.type) {
            case `line`:
              {
                let r = new ge(
    ...
    (ye = class {
      ...
      calculateVerticalSpace() {
        let e = this.chartConfig.width,
          t = this.chartConfig.height,
          n = 0,
          r = 0,
          i = Math.floor((e * this.chartConfig.plotReservedSpacePercent) / 100),
          a = Math.floor((t * this.chartConfig.plotReservedSpacePercent) / 100),
          o = this.componentStore.plot.calculateSpace({ width: i, height: a });
        ((e -= o.width),
          (t -= o.height),
          (o = this.componentStore.title.calculateSpace({
          ...
          (o = this.componentStore.xAxis.calculateSpace({
            width: e,
            height: t,
          })),
          (t -= o.height),
          this.componentStore.yAxis.setAxisPosition(`left`),
          (o = this.componentStore.yAxis.calculateSpace({
            width: e,
            height: t,
          })),
          (n = o.width),
          ...
          e > 0 && ((i += e), (e = 0)),
          t > 0 && ((a += t), (t = 0)),
          this.componentStore.plot.calculateSpace({ width: i, height: a }),
          this.componentStore.plot.setBoundingBoxXY({ x: n, y: r }),
          this.componentStore.xAxis.setRange([n, n + i]),
          this.componentStore.xAxis.setBoundingBoxXY({ x: n, y: r + a }),
          this.componentStore.yAxis.setRange([r, r + a]),
          this.componentStore.yAxis.setBoundingBoxXY({ x: 0, y: r }),
          this.chartData.plots.some((e) => D(e)) &&
      ...
      calculateHorizontalSpace() {
        let e = this.chartConfig.width,
          ...
          r = 0,
          i = 0,
          a = Math.floor((e * this.chartConfig.plotReservedSpacePercent) / 100),
          o = Math.floor((t * this.chartConfig.plotReservedSpacePercent) / 100),
          s = this.componentStore.plot.calculateSpace({ width: a, height: o });
        ((e -= s.width),
          (t -= s.height),
          (s = this.componentStore.title.calculateSpace({
            width: this.chartConfig.width,
            height: t,
          })),
          (n = s.height),
          ...
          (s = this.componentStore.xAxis.calculateSpace({
            width: e,
            height: t,
          })),
          (e -= s.width),
          ...
          (s = this.componentStore.yAxis.calculateSpace({
            width: e,
            height: t,
          })),
          (t -= s.height),
          ...
          e > 0 && ((a += e), (e = 0)),
          t > 0 && ((o += t), (t = 0)),
          this.componentStore.plot.calculateSpace({ width: a, height: o }),
          this.componentStore.plot.setBoundingBoxXY({ x: r, y: i }),
          this.componentStore.yAxis.setRange([r, r + a]),
          this.componentStore.yAxis.setBoundingBoxXY({ x: r, y: n }),
          this.componentStore.xAxis.setRange([i, i + o]),
          this.componentStore.xAxis.setBoundingBoxXY({ x: 0, y: i }),
          this.chartData.plots.some((e) => D(e)) &&
            this.componentStore.xAxis.recalculateOuterPaddingToDrawBar());
      }
      calculateSpace() {
      ...
      getDrawableElement() {
        ...
        for (let t of Object.values(this.componentStore))
          e.push(...t.getDrawableElements());
        return e;
      }
    }),
    (K = class {
      ...
      static build(e, t, n, r) {
        return new ye(e, t, n, r).getDrawableElement();
      }
    }),
    (q = 0),
    (J = P()),
    (Y = N()),
    (X = F()),
    (Z = Y.plotColorPalette.split(`,`).map((e) => e.trim())),
    (Q = !1),
    ($ = !1),
    a(N, `getChartDefaultThemeConfig`),
    a(P, `getChartDefaultConfig`),
    a(F, `getChartDefaultData`),
    a(I, `textSanitizer`),
    a(ee, `setTmpSVGG`),
    a(te, `setOrientation`),
    a(L, `setXAxisTitle`),
    a(R, `setXAxisRangeData`),
    a(ne, `setXAxisBand`),
    a(re, `setYAxisTitle`),
    a(ie, `setYAxisRangeData`),
    a(ae, `setYAxisRangeFromPlotData`),
    a(z, `transformDataWithoutCategory`),
    a(B, `getPlotColorFromPalette`),
    a(oe, `setLineData`),
    a(se, `setBarData`),
    a(ce, `getDrawableElem`),
    a(le, `getChartThemeConfig`),
    a(ue, `getChartConfig`),
    a(de, `getXYChartData`),
    (xe = {
      parser: fe,
      db: {
        ...
        setXAxisBand: ne,
        setYAxisTitle: re,
        setYAxisRangeData: ie,
        setLineData: oe,
        setBarData: se,
        setTmpSVGG: ee,
        getChartThemeConfig: le,
        getChartConfig: ue,
        getXYChartData: de,
      },
      renderer: {
        draw: a((e, t, n, r) => {
          let o = r.db,
            s = o.getChartThemeConfig(),
            c = o.getChartConfig(),
            l = o.getXYChartData().plots[0].data.map((e) => e[1]);
          function u(e) {
...
` + e,
          ...
          (h(p, c.height, c.width, !0),
            p.attr(`viewBox`, `0 0 ${c.width} ${c.height}`),
            g.attr(`fill`, s.backgroundColor),
            o.setTmpSVGG(p.append(`g`).attr(`class`, `mermaid-tmp-group`)));
          let _ = o.getDrawableElem(),
            v = {};
          function y(e) {
            let t = m,
              n = ``;
            for (let [r] of e.entries()) {
              ...
              (r > 0 && v[n] && (i = v[n]),
                (n += e[r]),
                (t = v[n]),
                (t ||= v[n] = i.append(`g`).attr(`class`, e[r])));
            }
            return t;
          }
          a(y, `getGroup`);
            ...
            switch (e.type) {
              case `rect`:
                if (
                  (t
                    ...
                    .attr(`fill`, (e) => e.fill)
                    .attr(`stroke`, (e) => e.strokeFill)
                    .attr(`stroke-width`, (e) => e.strokeWidth),
                  c.showDataLabel)
                )
                  if (c.chartOrientation === `horizontal`) {
                    let n = function (e, t) {
                      let { data: n, label: i } = e;
                      return t * i.length * r <= n.width - 10;
                    };
                    a(n, `fitsHorizontally`);
                    let r = 0.7,
                      i = e.data
                        .map((e, t) => ({ data: e, label: l[t].toString() }))
                        .filter((e) => e.data.width > 0 && e.data.height > 0),
                      o = i.map((e) => {
                        let { data: t } = e,
                          r = t.height * 0.7;
                        for (; !n(e, r) && r > 0; ) --r;
                    ...
                    t.selectAll(`text`)
                      ...
                      .enter()
                      .append(`text`)
                      .attr(`x`, (e) => e.data.x + e.data.width - 10)
                      .attr(`y`, (e) => e.data.y + e.data.height / 2)
                    ...
                    let n = function (e, t, n) {
                      let { data: r, label: i } = e,
                        ...
                        s = o - a / 2,
                        c = o + a / 2,
                        l = s >= r.x && c <= r.x + r.width,
                        u = r.y + n + t <= r.y + r.height;
                      return l && u;
                    };
                    a(n, `fitsInBar`);
                    let r = e.data
                        ...
                        .filter((e) => e.data.width > 0 && e.data.height > 0),
                      i = r.map((e) => {
                        let { data: t, label: r } = e,
                          i = t.width / (r.length * 0.7);
                        for (; !n(e, i, 10) && i > 0; ) --i;
                        return i;
                      }),
                      o = Math.floor(Math.min(...i));
                    t.selectAll(`text`)
                      .data(r)
                      .enter()
                      .append(`text`)
                      .attr(`x`, (e) => e.data.x + e.data.width / 2)
                      .attr(`y`, (e) => e.data.y + 10)
              ...
              case `text`:
                t.selectAll(`text`)
                  ...
                  .attr(`dominant-baseline`, (e) => u(e.verticalPos))
                  .attr(`text-anchor`, (e) => d(e.horizontalPos))
                  .attr(`transform`, (e) => f(e))
                  .text((e) => e.text);
                break;
              case `path`:
                t.selectAll(`path`)
                  ...
                  .append(`path`)
                  .attr(`d`, (e) => e.path)
                  .attr(`fill`, (e) => (e.fill ? e.fill : `none`))
                  .attr(`stroke`, (e) => e.strokeFill)
                  .attr(`stroke-width`, (e) => e.strokeWidth);
                break;
            }
...
//# sourceMappingURL=xychartDiagram-PRI3JC2R-R6XqyejF.js.map
