...
import {
  n as Xt,
  t as Zt,
} from "./app-initial~app-main~remote-conversation-page~onboarding-page~settings-page~hotkey-window-t~hw2afr7f-DWOAvpOn.js";
import {
  i as Qt,
  r as $t,
...
import {
  n as en,
  t as tn,
} from "./app-initial~app-main~remote-conversation-page~new-thread-panel-page~settings-page~appgen-li~h99fup20-DznNRiiU.js";
import {
  n as nn,
  r as rn,
  t as an,
} from "./app-initial~app-main~settings-page~open-source-licenses-page~skills-settings~plugins-settin~cxbtmbfc-Bhanoo2P.js";
import { n as on, t as sn } from "./filter-ls_JHxsp.js";
import { n as cn, t as ln } from "./dock-BXG1fB9e.js";
import {
  n as un,
  t as dn,
} from "./experimental-feature-visibility-8-2TesZ9.js";
import { n as fn, t as pn } from "./settings-host-dropdown-D9ctLTpF.js";
var mn,
  hn,
  gn = e(() => {
    (t(s()),
      ...
      (hn = (e) =>
        (0, mn.jsxs)(`svg`, {
          ...
          children: [
            ...
            (0, mn.jsx)(`path`, {
              d: `M8.58801 13.516V11.7015C8.58801 10.9836 9.16985 10.4017 9.88782 10.4017C10.6058 10.4017 11.1876 10.9836 11.1876 11.7015V13.516C11.1874 14.2338 10.6056 14.8158 9.88782 14.8158C9.16999 14.8158 8.58824 14.2338 8.58801 13.516Z`,
              fill: `currentColor`,
            }),
            (0, mn.jsx)(`path`, {
              d: `M18.5996 13.9004C18.5996 11.1307 17.6085 8.45685 16.2334 6.4834C15.5472 5.49865 14.7819 4.7122 14.0273 4.17969C13.2656 3.64217 12.5686 3.40039 12 3.40039C11.4314 3.40039 10.7344 3.64218 9.97266 4.17969C9.21806 4.7122 8.4528 5.49865 7.7666 6.4834C6.39149 8.45685 5.40039 11.1307 5.40039 13.9004C5.40057 17.5937 7.97001 20.5996 12 20.5996C16.03 20.5996 18.5994 17.5937 18.5996 13.9004ZM20.4004 13.9004C20.4002 18.4857 17.1232 22.4004 12 22.4004C6.87675 22.4004 3.5998 18.4857 3.59961 13.9004C3.59961 10.721 4.72971 7.69336 6.29004 5.4541C7.07147 4.33275 7.97761 3.3843 8.93457 2.70898C9.88439 2.03873 10.9396 1.59961 12 1.59961C13.0604 1.59961 14.1156 2.03873 15.0654 2.70898C16.0224 3.3843 16.9285 4.33275 17.71 5.4541C19.2703 7.69336 20.4004 10.721 20.4004 13.9004Z`,
              fill: `currentColor`,
            }),
          ],
        })));
        ...
        (0, _n.jsxs)(`svg`, {
          ...
          children: [
            (0, _n.jsx)(`path`, {
              fillRule: `evenodd`,
              clipRule: `evenodd`,
              d: `M8.23047 10.3784C8.63379 9.96115 9.29028 9.91144 9.75195 10.2632L9.84766 10.3442L12.0068 12.3892L14.2158 10.3403C14.6895 9.90076 15.4237 9.94155 15.8477 10.4077L15.9287 10.5063L17.0166 12.0034L18.2148 10.7671C18.8427 10.1184 19.9888 10.4082 20.1631 11.3511C20.316 12.1792 20.4004 13.0335 20.4004 13.8999C20.4003 18.4853 17.1234 22.3999 12 22.3999C6.87665 22.3999 3.59966 18.4853 3.59961 13.8999C3.59961 13.0365 3.68311 12.1853 3.83496 11.3599L3.87891 11.189C4.13495 10.4302 5.07307 10.1966 5.67188 10.6743L5.79492 10.7876L6.94922 12.0161L8.14844 10.4741L8.23047 10.3784ZM7.90527 13.7212C7.472 14.2789 6.64295 14.3177 6.15918 13.8032L5.43457 13.0327C5.41347 13.3205 5.40039 13.6097 5.40039 13.8999C5.40044 17.5933 7.9699 20.6001 12 20.6001C16.0301 20.6001 18.5996 17.5933 18.5996 13.8999C18.5996 13.5975 18.5844 13.2963 18.5615 12.9966L17.7734 13.812C17.2768 14.3252 16.4368 14.2664 16.0166 13.689L14.9033 12.1577L12.7842 14.1245C12.3397 14.537 11.6511 14.5328 11.2109 14.1157L9.12891 12.1431L7.90527 13.7212Z`,
              fill: `currentColor`,
            }),
            (0, _n.jsx)(`path`, {
              d: `M4.62012 4.01807C4.96189 3.65742 5.53174 3.64225 5.89258 3.98389L8.63574 6.58154C8.99662 6.92326 9.01252 7.49307 8.6709 7.854C8.32913 8.21481 7.75932 8.2299 7.39844 7.88818L4.6543 5.29053C4.29371 4.94878 4.27858 4.3789 4.62012 4.01807Z`,
              fill: `currentColor`,
            }),
            (0, _n.jsx)(`path`, {
              d: `M18.1895 3.98389C18.5503 3.64221 19.1201 3.6574 19.4619 4.01807C19.8035 4.3789 19.7884 4.94876 19.4277 5.29053L16.6836 7.88818C16.3227 8.22977 15.7528 8.21481 15.4111 7.854C15.0696 7.49313 15.0856 6.92327 15.4463 6.58154L18.1895 3.98389Z`,
              fill: `currentColor`,
            }),
            (0, _n.jsx)(`path`, {
              d: `M12.041 1.21045C12.5381 1.21045 12.9414 1.61378 12.9414 2.11084V5.53076C12.9412 6.02768 12.538 6.43018 12.041 6.43018C11.5441 6.43011 11.1408 6.02764 11.1406 5.53076V2.11084C11.1406 1.61382 11.544 1.21052 12.041 1.21045Z`,
              fill: `currentColor`,
            }),
          ],
        })));
      ...
      (xn = (e) =>
        (0, bn.jsxs)(`svg`, {
          ...
          children: [
            ...
            (0, bn.jsx)(`path`, {
              d: `M7.42654 10.6038L9.90146 6.85396C10.1554 6.46917 10.7538 6.7207 10.6565 7.17136L10.3159 8.75002H12.2258C12.5577 8.75002 12.7564 9.11918 12.5736 9.3962L10.0987 13.1461C9.8447 13.5309 9.24637 13.2793 9.34362 12.8287L9.68427 11.25H7.7743C7.44238 11.25 7.24371 10.8809 7.42654 10.6038Z`,
              fill: `currentColor`,
            }),
          ],
        })));
  });
function Cn({ intl: e, query: t, targets: n, visibleSectionSlugs: r }) {
  if (t.trim().length === 0) return [];
  let i = t.trim().split(/\s+/).filter(Boolean),
    a = new Map();
  for (let [e, t] of r.entries()) a.has(t) || a.set(t, e);
  return n
    .flatMap((n) => {
      if (!a.has(n.sectionSlug)) return [];
      let r = wn(En(e, n), t, i);
      return r == null ? [] : [r];
    })
    .sort((e, t) =>
      e.matchPriority === t.matchPriority
        ? e.score === t.score
          ? (a.get(e.sectionSlug) ?? 0) - (a.get(t.sectionSlug) ?? 0)
          : t.score - e.score
        : e.matchPriority - t.matchPriority,
    )
    .map(({ label: e, panelLabel: t, sectionSlug: n }) => ({
      label: e,
      panelLabel: t,
      sectionSlug: n,
    }));
...
function wn(e, t, n) {
  let { messageTexts: r, panelLabel: i, sectionSlug: a } = e,
    o = $e(i, t);
  if (o > 0)
    return {
      label: i,
  ...
  let c = null;
  for (let e of r) {
    let r = Math.max($e(e, t), ...n.map((t) => $e(e, t)));
    r > 0 && (c == null || r > c.score) && (c = { score: r, text: e });
  }
  return {
    label: c == null || /[<{]/u.test(c.text) ? i : c.text,
    matchPriority: 1,
    panelLabel: i,
    score: s,
    sectionSlug: a,
...
function Tn(e, t) {
  let n = t.map((t) => Math.max(0, ...e.map((e) => $e(e, t))));
  return n.length === 0 || n.some((e) => e === 0)
    ? 0
    : n.reduce((e, t) => e + t, 0);
}
function En(e, t) {
  let n = Dn.get(e);
  n ?? ((n = new WeakMap()), Dn.set(e, n));
  let r = n.get(t);
  if (r != null) return r;
  let i = {
    messageTexts: [
      ...t.messages.map((t) => {
        let n = e.messages[t.id];
        return typeof n == `string` ? n : t.defaultMessage;
      }),
      ...(t.terms ?? []),
    ],
    panelLabel: e.formatMessage(St(t.sectionSlug)),
...
function kn(e) {
  let t = (0, Bn.c)(95),
    {
      ...
      onBack: o,
      canCollapse: s,
      groupSettingsSections: c,
      onClearHostFilter: l,
      searchTargets: u,
      sidebarHostSelector: f,
    } = e,
    p = s === void 0 ? !1 : s,
    m = c === void 0 ? !1 : c,
    ee = u === void 0 ? Kn : u,
    h = Ne(),
    g = Fe(qn),
    [te, ne] = (0, Vn.useState)(!1),
    [_, v] = (0, Vn.useState)(``),
    y = p && te,
    b = g && m && !y,
    S;
  t[0] !== _ || t[1] !== b
    ? ((S = b && _.trim().length > 0), (t[0] = _), (t[1] = b), (t[2] = S))
    : (S = t[2]);
  let C = S,
    w,
    T;
  t[3] !== h || t[4] !== _ || t[5] !== ee || t[6] !== n
    ? ((w = Cn({
        intl: h,
        query: _,
        targets: ee,
        visibleSectionSlugs: n.flatMap(Fn),
      })),
      (T = w.map(Pn).join(`\0`)),
      (t[3] = h),
      (t[4] = _),
  ...
  t[9] === E
    ? (D = t[10])
    : ((D = E.length === 0 ? [] : E.split(`\0`)), (t[9] = E), (t[10] = D));
  let re = D,
    O = b && _.length > 0,
    k;
  t[11] !== i || t[12] !== w
  ...
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (j = t[14]);
  let M;
  t[15] !== re || t[16] !== O || t[17] !== k
    ? ((M = {
        items: re,
        isActive: O,
        autoHighlightFirst: !1,
        onSelect: k,
        onEscape: j,
      }),
      (t[15] = re),
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (F = t[20]);
  let oe = F,
    I = y ? Yn.collapsed : Yn.expanded,
    L;
  t[21] !== I.message || t[22] !== h
    ? ((L = h.formatMessage(I.message)),
      (t[21] = I.message),
      (t[22] = h),
      (t[23] = L))
    : (L = t[23]);
  ...
  if (
    ...
    let e = [{ key: `settings`, heading: null, sections: zn(n, Wn) }];
    m && (e = Rn(n, Gn));
    let s = e.flatMap(Mn);
    (t[51] === a
      ? (q = t[52])
      : ((q = ce(`flex min-h-0 flex-1 flex-col select-none px-row-x`, a)),
        (t[51] = a),
        (t[52] = q)),
      t[53] === h
        ? (J = t[54])
        : ((J = h.formatMessage({
          ...
          (t[53] = h),
          (t[54] = J)),
      (H = `flex min-h-0 flex-1 flex-col`),
      t[55] !== z || t[56] !== p || t[57] !== R || t[58] !== I.message
        ? ((U = p
            ? (0, Q.jsx)(`div`, {
                className: `mb-2 shrink-0`,
                children: (0, Q.jsx)(ge, {
                  tooltipContent: (0, Q.jsx)(Z, { ...I.message }),
                  children: (0, Q.jsx)(Nt, {
                    "aria-label": R,
                    fullWidth: !1,
                    icon: z,
      ...
      t[63] !== y || t[64] !== f
        ? ((G =
            f != null && !y
              ? (0, Q.jsx)(`div`, { className: `mb-4 shrink-0`, children: f })
              : null),
          (t[63] = y),
          (t[64] = f),
          (t[65] = G))
        : (G = t[65]),
      t[66] !== N || t[67] !== _ || t[68] !== b
        ? ((K = b
            ? (0, Q.jsx)(In, {
                onKeyDown: N.getInputProps().onKeyDown,
                searchQuery: _,
                onQueryChange: (e) => {
                  (N.setHighlightedIndex(-1), v(e));
                },
              })
            : null),
          (t[66] = N),
          ...
          (t[69] = K))
        : (K = t[69]));
    let c = y ? `flex flex-col gap-2` : `flex flex-col gap-4`;
    (t[70] === c
      ? (B = t[71])
      : ((B = ce(`min-h-0 flex-1 overflow-y-auto pb-2`, c)),
        (t[70] = c),
        (t[71] = B)),
      (V = C
        ? (0, Q.jsx)(Ln, {
              ...
              jt,
              {
                ...
                children: e.sections.map((e) => {
                  let t = e.slug === r,
                    n = !!e.externalUrl,
                    a = !!e.disabled,
                    o = t && e.slug === `pets` ? vn : Hn[e.slug],
                    c = h.formatMessage(St(e.slug)),
                    l = (t) => {
                      if (!a) {
                        if (n && e.externalUrl) {
                          se({
                  ...
                  return (0, Q.jsx)(
                    ge,
                    {
                      ...
                      children: (0, Q.jsx)(Nt, {
                            ...
                            ? (t) => {
                                ...
                                n != null &&
                                  (t.currentTarget
                                    .closest(`nav`)
                                    ?.querySelector(
                                      `[data-settings-panel-slug="${n.slug}"]`,
                                    )
                                    ?.focus(),
                                  i(n.slug));
                              }
                        ...
                        label: (0, Q.jsx)(Ot, { slug: e.slug }),
                        trailing:
                          !y && e.externalUrl != null
                            ? (0, Q.jsx)(ie, {
    ...
    ((B = t[42]),
      ...
      (J = t[50]));
  let Y;
  t[72] !== p || t[73] !== y || t[74] !== h || t[75] !== C
    ? ((Y = C
        ? null
        : (0, Q.jsx)(ge, {
            tooltipContent: y ? (0, Q.jsx)(Z, { ...Un.chatSettings }) : oe,
            side: `right`,
            sideOffset: 12,
            children: (0, Q.jsx)(Nt, {
              "aria-label": h.formatMessage(Un.chatSettings),
              icon: d,
              iconClassName: `icon-sm inline-block align-middle`,
              hideLabel: p ? y : void 0,
              label: (0, Q.jsx)(Z, { ...Un.chatSettings }),
              onClick: An,
              trailing: y
                ? void 0
                : (0, Q.jsx)(ie, {
  ...
  t[77] === l
    ...
    : ((X =
        l == null
          ? null
          : (0, Q.jsxs)(`div`, {
              className: `shrink-0 px-row-x pb-2 text-sm text-token-text-secondary`,
              children: [
                (0, Q.jsx)(`button`, {
                  type: `button`,
      ...
      (t[78] = X));
  let le;
  t[79] !== B || t[80] !== V || t[81] !== Y || t[82] !== X
    ? ((le = (0, Q.jsxs)(`div`, { className: B, children: [V, Y, X] })),
      (t[79] = B),
      (t[80] = V),
      (t[81] = Y),
      (t[82] = X),
  ...
  t[88] !== K ||
  t[89] !== le
    ? ((ue = (0, Q.jsxs)(`div`, { className: H, children: [U, W, G, K, le] })),
      (t[84] = H),
      (t[85] = U),
      (t[86] = W),
      (t[87] = G),
...
function Mn(e) {
  return e.sections.filter(Nn);
}
function Nn(e) {
  return !e.disabled && e.externalUrl == null;
}
function Pn(e) {
  return e.sectionSlug;
}
function Fn(e) {
  return e.disabled || e.externalUrl != null ? [] : [e.slug];
}
function In(e) {
  let t = (0, Bn.c)(21),
    { onKeyDown: n, searchQuery: r, onQueryChange: i } = e,
    a = Ne(),
    o = (0, Vn.useRef)(null),
    s;
  (t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = {
        ...
        onKeyDown: (e) => {
          (e.preventDefault(), o.current?.focus(), o.current?.select());
        },
      }),
      (t[0] = s))
    : (s = t[0]),
  ...
  t[6] === a
    ...
    : ((d = a.formatMessage({
      ...
      (t[7] = d));
  let f;
  t[8] !== n || t[9] !== r || t[10] !== l || t[11] !== u || t[12] !== d
    ? ((f = (0, Q.jsx)(`input`, {
        ref: o,
        "aria-label": l,
    ...
    ? ((p =
        r.length > 0
          ? (0, Q.jsx)(`button`, {
              ...
              type: `button`,
              children: (0, Q.jsx)(X, { className: `icon-2xs` }),
            })
          : null),
      (t[14] = a),
      (t[15] = i),
...
function Ln(e) {
  ...
  if (o.length === 0) {
    ...
    return (
      t[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Q.jsx)(`div`, {
            className: `px-row-x pt-2 text-sm text-token-text-secondary`,
            children: (0, Q.jsx)(Z, {
      ...
      ? ((e = (e, t) => {
          ...
          return (0, Q.jsxs)(
            `div`,
            {
              ...
              children: [
                (0, Q.jsxs)(`div`, {
                  className: `flex items-center gap-2 px-row-x py-1 text-base text-token-text-secondary`,
                  children: [
                    (0, Q.jsx)(i, { className: `icon-sm shrink-0` }),
                    (0, Q.jsx)(`span`, {
                      className: `truncate`,
                      children: e.panelLabel,
                    }),
                  ],
                }),
                (0, Q.jsx)(`button`, {
                  "aria-label": r.formatMessage(
                    {
                      ...
                      description: `Accessible label for a settings search result and its containing panel`,
                    },
                    { destination: e.label, panel: e.panelLabel },
                  ),
                  className: ce(
                    ...
                    t === n && `bg-token-list-hover-background`,
                  ),
...
function Rn(e, t) {
  let n = new Map(e.map((e) => [e.slug, e])),
    r = t.map((e) => ({
      ...e,
      sections: e.slugs.flatMap((e) => {
        let t = n.get(e);
        return t == null ? [] : (n.delete(e), [t]);
      }),
    })),
    i = Array.from(n.values());
  return (
    i.length > 0 && r[r.length - 1]?.sections.push(...i),
    r.filter((e) => e.sections.length > 0)
  );
}
function zn(e, t) {
  let n = new Map(e.map((e) => [e.slug, e]));
  ...
  Xn = e(() => {
    ((Bn = c()),
      ...
      (Hn = {
        ...
        "code-review": mt,
        "cloud-settings": ut,
        "cloud-environments": ut,
        personalization: tn,
        usage: bt,
        "browser-use": Zt,
        "computer-use": it,
        "local-environments": ln,
        worktrees: p,
        environments: ln,
        "mcp-settings": Jt,
        "hooks-settings": rt,
      ...
      (Un = Te({
        collapseSidebar: {
          ...
          description: `Tooltip and accessible label for the button that collapses the settings navigation`,
        },
        expandSidebar: {
          id: `settings.nav.expandSidebar`,
          defaultMessage: `Expand settings navigation`,
          description: `Tooltip and accessible label for the button that expands the settings navigation`,
        },
        chatSettings: {
          id: `settings.nav.chatSettings`,
          defaultMessage: `Chat Settings`,
          description: `Settings navigation item that opens ChatGPT settings in the browser`,
        },
      })),
      (Wn = [
        `general-settings`,
      ...
      (Gn = [
        ...
        },
        {
          ...
          heading: Ae({
            ...
            description: `Heading for integration settings in the settings navigation`,
          }),
          slugs: [
            `appshots`,
            `codex-micro`,
      ...
      (Kn = []),
      (qn = `1785186884`),
      (Jn = `https://chatgpt.com/#settings`),
      (Yn = {
        collapsed: { icon: E, message: Un.expandSidebar },
        expanded: { icon: ne, message: Un.collapseSidebar },
      }));
  }),
  Zn,
  Qn = e(() => {
    Zn = {
      ...
      appearance: [
        {
          ...
          id: `settings-search.literal.03e1f49b9aad`,
        },
        {
        ...
        { defaultMessage: `Ayu`, id: `settings-search.literal.0b05a778be98` },
        {
          ...
          id: `settings-search.literal.0ed21094d832`,
        },
        {
        ...
        },
        {
          ...
          id: `settings-search.literal.2d6f969ad5fe`,
        },
        ...
        },
        {
          ...
          id: `settings-search.literal.49ac21e803f5`,
        },
        {
        ...
        {
          defaultMessage: `Raycast`,
          id: `settings-search.literal.5594d56e9d7b`,
        },
        {
        ...
        },
        {
          ...
          id: `settings-search.literal.60eb93304060`,
        },
        {
        ...
        },
        {
          ...
          id: `settings-search.literal.7b3a05fd9766`,
        },
        {
        ...
        },
        {
          ...
          id: `settings-search.literal.7c276aef66bf`,
        },
        {
        ...
        },
        {
          ...
          id: `settings-search.literal.8142b2b0b8d9`,
        },
        {
          defaultMessage: `Linear`,
          id: `settings-search.literal.87ecc89a3d76`,
        },
        {
        ...
        {
          defaultMessage: `Lobster`,
          id: `settings-search.literal.a5362281bcdf`,
        },
        {
        ...
        },
        {
          ...
          id: `settings-search.literal.f228b0781d88`,
        },
        {
      ...
      "browser-use": [
        ...
        {
          defaultMessage: `Choose what access Codex has on a site`,
        ...
        {
          defaultMessage: `Choose what Codex can do on this site`,
        ...
        { defaultMessage: `Browser`, id: `settings.browserUse.title` },
        {
      ...
      "cloud-environments": [
        { defaultMessage: `Back`, id: `settings.cloudEnvironments.back` },
        {
      ...
      "code-review": [
        ...
        { defaultMessage: `Code review`, id: `settings.codeReview.title` },
      ],
      "computer-use": [
        {
        ...
        { defaultMessage: `Back`, id: `settings.computerUse.chrome.back` },
        {
      ...
      connections: [
        ...
        {
          defaultMessage: `iPhone Pro and Samsung Galaxy devices connected to Codex on a Mac`,
          id: `settings.remoteConnections.details.allowSignedInDevicesDialog.artworkAlt`,
        },
        {
          defaultMessage: `This will allow authorized devices like your phone to discover and control Codex on this SSH connection`,
        ...
        {
          defaultMessage: `Allow Codex apps signed into your account to use this device`,
        ...
        {
          defaultMessage: `Please update the remote Codex device to the latest version`,
        ...
        {
          defaultMessage: `Open your WSL distro and update Codex to {minRequiredVersion} or newer. Currently installed: {currentVersion}`,
        ...
        {
          defaultMessage: `This removes the environment and its remote control threads from Codex. This cannot be undone.`,
      ...
      "general-settings": [
        ...
        { defaultMessage: `Hooks`, id: `externalAgentConfig.itemType.hooks` },
        {
          defaultMessage: `MCP servers`,
        ...
        { defaultMessage: `Skills`, id: `externalAgentConfig.itemType.skills` },
        {
          defaultMessage: `Agents`,
        ...
        {
          defaultMessage: `Choose how quickly Codex runs across chats, subagents, and compaction`,
      ...
      "keyboard-shortcuts": [
        ...
        { defaultMessage: `Archive chat`, id: `codex.command.archiveThread` },
        {
        ...
        { defaultMessage: `Fork chat`, id: `codex.command.forkThread` },
        ...
        { defaultMessage: `New chat`, id: `codex.command.newThread` },
        {
        ...
        { defaultMessage: `Next chat`, id: `codex.command.nextThread` },
        {
        ...
        { defaultMessage: `Wake Pet`, id: `codex.command.openPetOverlay` },
        {
        ...
        { defaultMessage: `Open side chat`, id: `codex.command.openSideChat` },
        ...
        { defaultMessage: `Previous chat`, id: `codex.command.previousThread` },
        { defaultMessage: `New quick chat`, id: `codex.command.quickChat` },
        ...
        { defaultMessage: `Go to chat 1`, id: `codex.command.thread1` },
        { defaultMessage: `Go to chat 2`, id: `codex.command.thread2` },
        { defaultMessage: `Go to chat 3`, id: `codex.command.thread3` },
        { defaultMessage: `Go to chat 4`, id: `codex.command.thread4` },
        { defaultMessage: `Go to chat 5`, id: `codex.command.thread5` },
        { defaultMessage: `Go to chat 6`, id: `codex.command.thread6` },
        { defaultMessage: `Go to chat 7`, id: `codex.command.thread7` },
        { defaultMessage: `Go to chat 8`, id: `codex.command.thread8` },
        { defaultMessage: `Go to chat 9`, id: `codex.command.thread9` },
        {
        ...
        { defaultMessage: `New Chat`, id: `codex.commandMenuTitle.newThread` },
        {
        ...
        },
        {
          ...
          id: `codex.commandMenuTitle.quickChat`,
        },
        {
      ...
      pets: [
        {
          ...
          id: `settings-search.literal.02c1ff6fbe60`,
        },
        {
          defaultMessage: `Small green shoots for new ideas.`,
          id: `settings-search.literal.25973a28efbf`,
        },
        {
          defaultMessage: `Null Signal`,
          id: `settings-search.literal.386bc4b830d3`,
        },
        { defaultMessage: `Dewey`, id: `settings-search.literal.408271b90229` },
        {
          defaultMessage: `A tidy duck for calm workspace days.`,
          id: `settings-search.literal.474e442a465e`,
        },
        {
          defaultMessage: `Stacky`,
          id: `settings-search.literal.545f5490a6c5`,
        },
        {
          defaultMessage: `A sharp-eyed owl for polished work in a blink.`,
          id: `settings-search.literal.62c55e67305b`,
        },
        { defaultMessage: `Seedy`, id: `settings-search.literal.65c71ef17dc2` },
        { defaultMessage: `Codex`, id: `settings-search.literal.662435b85df4` },
        { defaultMessage: `Hoots`, id: `settings-search.literal.71b0f251793f` },
        { defaultMessage: `BSOD`, id: `settings-search.literal.74cc15dabef6` },
        {
          defaultMessage: `A balanced stack for deep work.`,
          id: `settings-search.literal.7660074cf3ec`,
        },
        { defaultMessage: `Rocky`, id: `settings-search.literal.7bc336ee73e2` },
        {
          defaultMessage: `Quiet signal from the void.`,
          id: `settings-search.literal.813212bbccc1`,
        },
        {
          defaultMessage: `A tiny blue-screen gremlin.`,
          id: `settings-search.literal.82015054f4ef`,
        },
        {
          defaultMessage: `A steady rock when the diff gets large.`,
          id: `settings-search.literal.88dab499f326`,
        },
        {
          defaultMessage: `Hot path energy for fast iteration.`,
          id: `settings-search.literal.98866dc53a60`,
        },
        {
          defaultMessage: `Fireball`,
          id: `settings-search.literal.c6c39f74af09`,
        },
        {
      ...
      profile: [
        ...
        { defaultMessage: `Codex user`, id: `profile.nameFallback` },
...
function $n(e) {
  let t = (0, rr.c)(11),
    n = Ne(),
    { data: r } = et(),
    a = r?.isSystemBackdropSupported !== !1,
    o = r?.platform === `darwin`,
    { data: s } = i(ue, e.selectedHostId),
    c;
  t[0] === s
    ? (c = t[1])
  ...
  t[2] === l
    ? (u = t[3])
    : ((u = l.filter(un).flatMap(nr)), (t[2] = l), (t[3] = u));
  let d = u,
    f;
  t[4] === n.locale
    ? (f = t[5])
    : ((f = [{ locale: _t, language: `en` }, ...nt().map(tr)].flatMap((e) => {
        let { language: t, locale: r } = e;
        return [ht(r, r), ht(t, n.locale)];
      })),
      (t[4] = n.locale),
      (t[5] = f));
  let p = f,
    m;
  return (
    t[6] !== d || t[7] !== o || t[8] !== a || t[9] !== p
      ? ((m = ir.map((e) =>
          e.sectionSlug === `appearance` && !a
            ? { ...e, messages: e.messages.filter(er) }
            : e.sectionSlug === `agent`
              ? { ...e, terms: d }
              : e.sectionSlug === `general-settings`
                ? { ...e, messages: e.messages, terms: p }
                : e,
        )),
        (t[6] = d),
        (t[7] = o),
...
function er(e) {
  return !ar.includes(e.id);
}
function tr(e) {
  return { locale: e.locale, language: e.locale };
}
function nr(e) {
  return [
...
var rr,
  ...
  or = e(() => {
    ((rr = c()),
      ...
      z(),
      dn(),
      (ir = zt.map((e) => ({ messages: Zn[e] ?? [], sectionSlug: e }))),
      (ar = [
...
function sr(e = null, t = !0, n = Pe) {
  ...
  let s = Fe(ze),
    c = u(Qt),
    l = Ie(),
    { isProfileVisible: d, isProfileVisibilityLoading: f } = Ht(),
    { isUsageSettingsVisible: p, isUsageSettingsAccessLoading: m } = Ut(),
    ee = le({ hostId: n }),
    h = t && !o.isLoading && !o.allowed,
    g =
      t &&
      !a.isLoading &&
      (a.reason === `statsig-disabled` ||
        a.reason === `config-requirement-disabled` ||
        a.reason === `wsl-disabled`),
    te = t && (ee.available || o.available || h),
    ne = t && (a.available || o.available || g),
    _ = Gt.filter((e) => {
      if (!t && !lr.includes(e.slug)) return !1;
      switch (e.slug) {
        case `appshots`:
          return c;
  ...
  if (b && !(!t && !lr.includes(y.slug)))
    switch (y.slug) {
      ...
      case `codex-micro`:
        ...
        break;
      case `computer-use`:
        S = ee.isLoading || o.isLoading;
        break;
      case `browser-use`:
        S = a.isLoading || o.isLoading || l;
        break;
      case `local-environments`:
      case `worktrees`:
      case `environments`:
  ...
  return {
    activeSettingsSection: v?.slug ?? x,
    shouldRedirectToVisibleSettingsSection: b && !S,
    shouldRenderRouteContent: e !== `import` || !S,
    visibleSettingsSections: _,
  };
}
function cr(e) {
  return e == null ? null : (Gt.find((t) => t.slug === e) ?? null);
}
var lr,
  ur,
  dr = e(() => {
...
function fr() {
  let e = (0, gr.c)(78),
    ...
    i = we(),
    o = Oe(),
    s = ke(`/settings/:section/*`)?.params.section ?? null,
    {
      connectedRemoteConnections: c,
    ...
    p = ye(d).kind === `local`,
    {
      activeSettingsSection: g,
      shouldRedirectToVisibleSettingsSection: te,
      shouldRenderRouteContent: ne,
      visibleSettingsSections: v,
    } = sr(s, p, d),
    y = h(),
    x = u(Ge),
    S = u(_),
    C;
  e[0] !== x || e[1] !== i
    ? ((C = () => hr(i, x)), (e[0] = x), (e[1] = i), (e[2] = C))
    : (C = e[2]);
  let T = C,
    E;
  e[3] === d
    ? (E = e[4])
    : ((E = { selectedHostId: d }), (e[3] = d), (e[4] = E));
  let D = $n(E),
    re;
  e[5] !== c || e[6] !== n || e[7] !== l || e[8] !== d || e[9] !== f
    ? ((re =
        c != null && c.length > 0 && l != null
          ? (0, $.jsx)(pn, {
              align: `start`,
              connectedRemoteConnections: c,
              contentWidth: `sidebar`,
              localIcon: sn,
              localLabel: n.formatMessage({
                id: `settings.hostDropdown.allSettings`,
                defaultMessage: `All settings`,
                description: `Label for showing all settings in the settings sidebar host filter`,
              }),
              onSelectHost: f,
              remoteConnectionHostIds: l,
              selectedHostId: d,
              showConnectedIndicator: !0,
              triggerClassName: `h-7 w-auto max-w-full shrink-0 px-2`,
              triggerColor: `ghost`,
              useRemoteHostColors: !1,
            })
          : null),
      (e[5] = c),
      (e[6] = n),
  ...
  e[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((j = (0, $.jsx)(q, {
        electron: !0,
        children: (0, $.jsx)(`div`, {
          className: `[container-type:inline-size] flex h-token-nav-row shrink-0 items-center justify-end px-row-x empty:hidden`,
          children: (0, $.jsx)(qe, {}),
        }),
      })),
      (e[14] = j))
  ...
  let N = M,
    P;
  e[18] !== o.state || e[19] !== i || e[20] !== t
    ? ((P = (e) => {
        (e === `profile` && xe(t, be, { source: `settings_page` }),
          i(`/settings/${e}`, { replace: !0, state: o.state }));
      }),
      (e[18] = o.state),
      (e[19] = i),
      (e[20] = t),
  ...
  e[27] === t.query
    ? (R = e[28])
    : ((R = () => {
        t.query.invalidate(Tt, { exact: !0 }).catch(pr);
      }),
      (e[27] = t.query),
      (e[28] = R));
  let z;
  (e[29] === t ? (z = e[30]) : ((z = [t]), (e[29] = t), (e[30] = z)),
    (0, _r.useEffect)(R, z));
  let B, V;
  if (
    (e[31] !== x || e[32] !== i
            ...
            e.key === `Escape` &&
              (e.defaultPrevented ||
                (e.target instanceof HTMLElement &&
                  (mr(e.target) ||
                    e.target.closest(`[role="dialog"][data-state="open"]`) !=
                      null)) ||
                hr(i, x));
          };
          return (
  ...
  if (y) {
    ...
    e[46] === o.hash
      ? (n = e[47])
      : ((n = o.hash.slice(1) || null), (e[46] = o.hash), (e[47] = n));
    let r;
    e[48] !== o.key || e[49] !== N || e[50] !== n
      ? ((r = (0, $.jsx)(`div`, {
  ...
  e[56] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((U = ce(
      ...
      (W = (0, $.jsx)(`div`, {
        className: `draggable h-toolbar w-full shrink-0`,
      })),
      (e[56] = U),
      (e[57] = W))
    : ((U = e[56]), (W = e[57]));
  ...
  e[66] === o.hash
    ? (K = e[67])
    : ((K = o.hash.slice(1) || null), (e[66] = o.hash), (e[67] = K));
  let J;
  e[68] !== o.key || e[69] !== N || e[70] !== K
    ? ((J = (0, $.jsx)(nn, { navigationKey: o.key, targetId: K, children: N })),
      (e[68] = o.key),
      (e[69] = N),
      (e[70] = K),
      (e[71] = J))
...
export { fr as SettingsPage };
//# sourceMappingURL=settings-page-Czsl4aZl.js.map
