...
try {
  (function () {
    ...
    e &&
      ...
      (t._sentryDebugIds[e] = "a32cd2b5-418e-452d-b0ba-6c6575012b81"),
      (t._sentryDebugIdIdentifier =
        "sentry-dbid-a32cd2b5-418e-452d-b0ba-6c6575012b81"));
  })();
} catch {}
...
const Is = {
    findInPage(t, e) {
      return N.ipcRenderer.invoke(
        "$eipc_message$_2e859840-2ca2-4c0d-8e99-1a92e89e2e22_$_claude.internal.findInPage_$_FindInPage_$_findInPage",
        t,
        e,
      );
    },
    stopFindInPage() {
      return N.ipcRenderer.invoke(
        "$eipc_message$_2e859840-2ca2-4c0d-8e99-1a92e89e2e22_$_claude.internal.findInPage_$_FindInPage_$_stopFindInPage",
      );
    },
    endFindSession() {
      return N.ipcRenderer.invoke(
        "$eipc_message$_2e859840-2ca2-4c0d-8e99-1a92e89e2e22_$_claude.internal.findInPage_$_FindInPage_$_endFindSession",
      );
    },
    onStepToMatch(t) {
      const e = (n, r) => t(r);
      return (
        N.ipcRenderer.on(
          "$eipc_message$_2e859840-2ca2-4c0d-8e99-1a92e89e2e22_$_claude.internal.findInPage_$_FindInPage_$_stepToMatch",
          e,
        ),
        () => {
          N.ipcRenderer.removeListener(
            "$eipc_message$_2e859840-2ca2-4c0d-8e99-1a92e89e2e22_$_claude.internal.findInPage_$_FindInPage_$_stepToMatch",
            e,
          );
        }
    ...
    onFocusInput(t) {
      ...
      return (
        N.ipcRenderer.on(
          "$eipc_message$_2e859840-2ca2-4c0d-8e99-1a92e89e2e22_$_claude.internal.findInPage_$_FindInPage_$_focusInput",
          e,
        ),
        () => {
          N.ipcRenderer.removeListener(
    ...
    onBlurInput(t) {
      ...
      return (
        N.ipcRenderer.on(
          "$eipc_message$_2e859840-2ca2-4c0d-8e99-1a92e89e2e22_$_claude.internal.findInPage_$_FindInPage_$_blurInput",
          e,
        ),
        () => {
          N.ipcRenderer.removeListener(
  ...
  Ts = (t) => {
    xs() &&
      ((t["claude.internal.findInPage"] =
        t["claude.internal.findInPage"] || {}),
      (t["claude.internal.findInPage"].FindInPage = Is));
  },
  Sr = {};
Ts(Sr);
for (const [t, e] of Object.entries(Sr))
  N.contextBridge.exposeInMainWorld(t, e);
...
const ws = ["debug", "info", "warn", "error", "log", "assert", "trace"],
  Rs = "Sentry Logger ",
  We = {};
function Ee(t) {
...
const y = {
  ...
  X = "?",
  cn = /\(error: (.*)\)/,
  un = /captureMessage|captureException/;
function Ir(...t) {
...
function Tr(t) {
  ...
  return (
    /sentryWrapped/.test(Le(e).function || "") && e.pop(),
    e.reverse(),
    un.test(Le(e).function || "") &&
      (e.pop(), un.test(Le(e).function || "") && e.pop()),
    e.slice(0, xr).map((n) => ({
      ...n,
...
function Ms() {
  ((ut = I.onerror),
    (I.onerror = function (t, e, n, r, s) {
      return (
        j("error", { column: r, error: s, line: n, msg: t, url: e }),
        ut ? ut.apply(this, arguments) : !1
      );
    }),
...
function Fs() {
  ((dt = I.onunhandledrejection),
    (I.onunhandledrejection = function (t) {
      return (j("unhandledrejection", t), dt ? dt.apply(this, arguments) : !0);
    }),
...
function nt(t) {
  return (
    t === null || Ht(t) || (typeof t != "object" && typeof t != "function")
  );
}
function Te(t) {
  return Se(t, "Object");
...
function Or(t, e = {}) {
  ...
  try {
    ...
    const d = Array.isArray(e) ? e : e.keyAttrs,
      l = (!Array.isArray(e) && e.maxStringLength) || Hs;
    for (
      ;
      n &&
      i++ < r &&
...
function Ar(t) {
  if (zt(t))
    return { message: t.message, name: t.name, stack: t.stack, ...hn(t) };
  if (rt(t)) {
    const e = {
      type: t.type,
      target: pn(t.target),
...
function pn(t) {
  try {
    return Bs(t) ? Or(t) : Object.prototype.toString.call(t);
  } catch {
    return "<unknown>";
  }
}
...
function mn(t, e) {
  ...
  for (let r = 0; r < t.length; r++) {
    const s = t[r];
    try {
      Cr(s) ? n.push(wr(s)) : n.push(String(s));
    } catch {
...
function M(t = Gs()) {
  ...
  return (
    lt || (lt = "10000000100040008000" + 1e11),
    lt.replace(/[018]/g, (e) => (e ^ ((Ys() & 15) >> (e / 4))).toString(16))
  );
}
function Dr(t) {
  var e, n;
...
function pe(t, e = {}) {
  if (
    ...
    e.sid && (t.sid = e.sid.length === 32 ? e.sid : M()),
...
class W {
  ...
  update(e) {
    ...
    const n = typeof e == "function" ? e(this) : e,
      r = n instanceof W ? n.getScopeData() : Te(n) ? e : void 0,
      {
        tags: s,
        attributes: i,
        extra: a,
  ...
  clear() {
    return (
      ...
      vn(this, void 0),
      (this._attachments = []),
      this.setPropagationContext({ traceId: yn(), sampleRand: Math.random() }),
      this._notifyScopeListeners(),
      this
    );
  }
...
function ni() {
  return be("defaultCurrentScope", () => new W());
}
function ri() {
  return be("defaultIsolationScope", () => new W());
}
class si {
  constructor(e, n) {
    let r;
...
function he() {
  const t = et(),
    e = tt(t);
  return (e.stack = e.stack || new si(ni(), ri()));
}
function ii(t) {
...
function ui(t) {
  const e = t.getPropagationContext(),
    ...
    i = { trace_id: n, span_id: s || Mr() };
  return (r && (i.parent_span_id = r), i);
}
const di = "sentry.source",
  li = "sentry.sample_rate",
  fi = "sentry.previous_trace_sample_rate",
  pi = "sentry.op",
  hi = "sentry.origin",
  Lr = "sentry.profile_id",
  Fr = "sentry.exclusive_time",
  mi = 0,
  _i = 1,
  gi = "_sentryScope",
  yi = "_sentryIsolationScope";
function vi(t) {
  if (t) {
...
function jr(t) {
  const e = t;
  return { scope: e[gi], isolationScope: vi(e[yi]) };
}
const bi = "sentry-",
  Ei = /^sentry-/;
function Si(t) {
...
function Ci(t) {
  const e = t.getOptions(),
    { host: n } = t.getDsn() || {};
  let r;
  return (e.orgId ? (r = String(e.orgId)) : n && (r = Ni(n)), r);
}
function Oi(t) {
  const e = typeof t == "string" ? wi(t) : Br(t);
  if (!(!e || !Ri(e))) return e;
}
function $i(t) {
...
function Fi(t) {
  if (!(!t || t.code === mi))
    return t.code === _i ? "ok" : t.message || "internal_error";
}
...
function Bi(t) {
  ...
  const e = (n = O()) == null ? void 0 : n.getOptions();
...
function Rn(t, e) {
  ...
  for (const n of e) {
    if (Zi(n)) {
      if (ze(t.description, n)) return (E && wn(t), !0);
      continue;
    }
    if (!n.name && !n.op) continue;
    const r = n.name ? ze(t.description, n.name) : !0,
      s = n.op ? t.op && ze(t.op, n.op) : !0;
    if (r && s) return (E && wn(t), !0);
  }
  return !1;
}
function Ui(t, e) {
...
function Vi(t) {
  ...
  const n = Zr(t),
    ...
    a = (i == null ? void 0 : i.get("sentry.sample_rate")) ?? s[li] ?? s[fi];
  function o(A) {
    return (
  ...
  const u = i == null ? void 0 : i.get("sentry.dsc"),
    d = u && Si(u);
  if (d) return o(d);
  const l = zr(t.spanContext().traceId, e),
    g = s[di],
    p = r.description;
  return (
    g !== "url" && p && (l.transaction = p),
    Bi() &&
      ((l.sampled = String(Li(n))),
      (l.sample_rand =
        (i == null ? void 0 : i.get("sentry.sample_rand")) ??
        ((T = jr(n).scope) == null
          ? void 0
          : T.getPropagationContext().sampleRand.toString()))),
    o(l),
...
function Hr(t, e = 3, n = 100 * 1024) {
  const r = B(t, e);
  return Yi(r) > n ? Hr(t, e - 1, n) : r;
}
function St(t, e, n = 1 / 0, r = 1 / 0, s = Ji()) {
  const [i, a] = s;
  if (
    e == null ||
...
class we {
  constructor(e) {
    ((this._state = ft), (this._handlers = []), this._runExecutor(e));
  }
  then(e, n) {
    return new we((r, s) => {
      (this._handlers.push([
  ...
  _executeHandlers() {
    if (this._state === ft) return;
    const e = this._handlers.slice();
    ((this._handlers = []),
      e.forEach((n) => {
        n[0] ||
          (this._state === On && n[1](this._value),
          this._state === $n && n[2](this._value),
          (n[0] = !0));
      }));
  }
  _runExecutor(e) {
...
function xt(t, e, n, r) {
  ...
  return (
    ...
    $e(i) ? i.then((a) => xt(a, e, n, r + 1)) : xt(i, e, n, r + 1)
  );
}
function oa(t, e) {
  const {
  ...
  (ca(t, e), r && la(t, r), fa(t, n), ua(t, s), da(t, i));
}
function qe(t, e) {
  const {
    extra: n,
...
function la(t, e) {
  ((t.contexts = { trace: Ai(e), ...t.contexts }),
    (t.sdkProcessingMetadata = {
      dynamicSamplingContext: Vi(e),
      ...t.sdkProcessingMetadata,
    }));
  const n = Zr(e),
    r = Jt(n).description;
...
function pa(t) {
  ...
  const r = e ? Object.keys(e) : [],
    s = n ? Object.keys(n) : [];
  if (G && r.length === An && s.length === Dn) return G;
  ((An = r.length), (Dn = s.length), (G = {}), z || (z = {}));
  const i = (a, o) => {
    for (const c of a) {
      const u = o[c],
        d = z == null ? void 0 : z[c];
      if (d && G && u) ((G[d[0]] = u), z && (z[c] = [d[0], u]));
      else if (u) {
        const l = t(c);
        for (let g = l.length - 1; g >= 0; g--) {
          const p = l[g],
            T = p == null ? void 0 : p.filename;
          if (T && G && z) {
            ((G[T] = u), (z[c] = [T, u]));
            break;
          }
...
function ha(t, e, n, r, s, i) {
  ...
  (ma(c, t),
    ...
    e.type === void 0 && _a(c, t.stackParser));
  const d = ba(r, n.captureContext);
  ...
  (p.length && (n.attachments = p), oa(c, g));
  const T = [...l, ...g.eventProcessors];
  return aa(T, c, n).then(
    (C) => (C && ga(C), typeof a == "number" && a > 0 ? va(C, a, o) : C),
  );
}
function ma(t, e) {
  var o, c;
  ...
  ((t.environment = t.environment || n || Kt),
    ...
    !t.dist && s && (t.dist = s));
  const a = t.request;
  (a != null && a.url && i && (a.url = vt(a.url, i)),
    i &&
      ((c = (o = t.exception) == null ? void 0 : o.values) == null ||
        c.forEach((u) => {
          u.value && (u.value = vt(u.value, i));
        })));
}
function _a(t, e) {
  var r, s;
...
function Jr(t, e) {
  ...
  const r = t.getOptions(),
    s = Oa(n, r._metadata, r.tunnel, t.getDsn());
  (Kr().set(t, []), t.emit("flushLogs"), t.sendEnvelope(s));
}
function $a(t) {
  return Kr().get(t);
}
...
function Xr(t, e) {
  ...
  if (n.length === 0) return;
  const r = t.getOptions(),
    s = Da(n, r._metadata, r.tunnel, t.getDsn());
  (Qr().set(t, []), t.emit("flushMetrics"), t.sendEnvelope(s));
}
function Pa(t) {
  return Qr().get(t);
}
...
const Ma = 60 * 1e3;
function La(t, e = Date.now()) {
  const n = parseInt(`${t}`, 10);
  if (!isNaN(n)) return n * 1e3;
  const r = Date.parse(`${t}`);
  return isNaN(r) ? Ma : r - e;
}
function Fa(t, e) {
  return t[e] || t.all || 0;
}
function ja(t, e, n = Date.now()) {
  return Fa(t, e) > n;
}
function Ba(t, { statusCode: e, headers: n }, r = Date.now()) {
  const s = { ...t },
  ...
  else a ? (s.all = r + La(a, r)) : e === 429 && (s.all = r + 60 * 1e3);
  return s;
}
const es = 64;
function ts(t, e, n = en(t.bufferSize || es)) {
  let r = {};
  const s = (a) => n.drain(a);
  function i(a) {
    const o = [];
    if (
      (Nn(a, (l, g) => {
        const p = Cn(g);
        ja(r, p) ? t.recordDroppedEvent("ratelimit_backoff", p) : o.push(l);
      }),
      o.length === 0)
    )
...
const jn = "Not capturing exception because it's already been captured.",
  Bn = "Discarded session because of missing or non-string release",
  rs = Symbol.for("SentryInternalError"),
  ss = Symbol.for("SentryDoNotSendEventError"),
  Ha = 5e3;
function He(t) {
  return { message: t, [rs]: !0 };
}
function pt(t) {
  return { message: t, [ss]: !0 };
}
function Un(t) {
  return !!t && typeof t == "object" && rs in t;
}
function Zn(t) {
...
class Va {
  constructor(e) {
    ...
    if (
      ...
      (this._hooks = {}),
      (this._eventProcessors = []),
      (this._promiseBuffer = en(
        ((r = e.transportOptions) == null ? void 0 : r.bufferSize) ?? es,
      )),
      e.dsn
        ? (this._dsn = Oi(e.dsn))
      ...
      const a = Ta(this._dsn, e.tunnel, e._metadata ? e._metadata.sdk : void 0);
    ...
    ((this._options.enableLogs =
      ...
      this._options.enableLogs &&
        zn(this, "afterCaptureLog", "flushLogs", Ya, Jr),
      (this._options.enableMetrics ??
        ((i = this._options._experiments) == null ? void 0 : i.enableMetrics) ??
        !0) &&
        zn(this, "afterCaptureMetric", "flushMetrics", Ga, Xr));
  }
  captureException(e, n, r) {
    const s = M();
    if (_n(e)) return (E && y.log(jn), s);
  ...
  addIntegration(e) {
    ...
    (Yr(this, e, this._integrations), n || Fn(this, [e]));
  }
  sendEvent(e, n = {}) {
    this.emit("beforeSendEvent", e, n);
    let r = ia(e, this._dsn, this._options._metadata, this._options.tunnel);
    for (const s of n.attachments || []) r = Ki(r, ea(s));
    this.sendEnvelope(r).then((s) => this.emit("afterSendEvent", e, s));
  }
  sendSession(e) {
    const { release: n, environment: r = Kt } = this._options;
    if ("aggregates" in e) {
      const i = e.attrs || {};
      if (!i.release && !n) {
        E && y.warn(Bn);
    ...
    const s = sa(e, this._dsn, this._options._metadata, this._options.tunnel);
    this.sendEnvelope(s);
  }
  ...
  _setupIntegrations() {
    ...
    ((this._integrations = Na(this, e)), Fn(this, e));
  }
  ...
  _prepareEvent(e, n, r, s) {
    ...
    return (
      ...
      ha(i, e, n, r, this, s).then((o) => {
        if (o === null) return o;
        (this.emit("postprocessEvent", o, n),
          (o.contexts = { trace: ui(r), ...o.contexts }));
        const c = Hi(this, r);
        return (
  ...
  _captureEvent(e, n = {}, r = Z(), s = de()) {
    return (
      E &&
        It(e) &&
        y.log(`Captured error event \`${ns(e)[0] || "<unknown>"}\``),
      this._processEvent(e, n, r, s).then(
        (i) => i.event_id,
        (i) => {
          E &&
            (Zn(i) ? y.log(i.message) : Un(i) ? y.warn(i.message) : y.warn(i));
        },
      )
    );
  }
  _processEvent(e, n, r, s) {
    ...
    return this._prepareEvent(e, n, r, s)
      .then((p) => {
        if (p === null)
          throw (
            ...
            pt("An event processor returned `null`, will not send event.")
          );
      ...
      .then((p) => {
        ...
        if ((c && T && this._updateSessionFromEvent(T, p), o)) {
          const Me =
              ((C = p.sdkProcessingMetadata) == null
                ? void 0
                : C.spanCountBeforeProcessing) || 0,
            ot = p.spans ? p.spans.length : 0,
            on = Me - ot;
          on > 0 && this.recordDroppedEvent("before_send", "span", on);
        }
        const A = p.transaction_info;
        if (o && A && p.transaction !== e.transaction) {
          const Me = "custom";
          p.transaction_info = { ...A, source: Me };
        }
...
Reason: ${p}`));
  ...
  _process(e, n) {
    (this._numProcessing++,
      this._promiseBuffer.add(e).then(
        ...
        (r) => (
          this._numProcessing--,
          r === Qt && this.recordDroppedEvent("queue_overflow", n),
          r
        ),
      ));
  }
  ...
  _flushOutcomes() {
    ...
    const n = Ua(e, this._options.tunnel && Pe(this._dsn));
    this.sendEnvelope(n);
  }
}
function Hn(t) {
...
function qa(t, e, n, r) {
  ...
  let c = n;
  if (It(c) && s) return s(c, r);
  if (is(c)) {
    if (a || o) {
      const u = Za(c);
      if (o != null && o.length && Rn(u, o)) return null;
      if (a) {
        const d = a(u);
        d ? (c = De(n, za(d))) : Tn();
      }
...
function Ga(t) {
  let e = 0;
  return (t.name && (e += t.name.length * 2), (e += 8), e + as(t.attributes));
}
function Ya(t) {
  let e = 0;
  return (t.message && (e += t.message.length * 2), e + as(t.attributes));
}
function as(t) {
  if (!t) return 0;
  let e = 0;
...
function ae(t, e) {
  const n = O(),
    r = de();
  if (!n) return;
  const { beforeBreadcrumb: s = null, maxBreadcrumbs: i = eo } = n.getOptions();
  if (i <= 0) return;
  ...
  ao = (t = {}) => {
    ...
    return {
      ...
      processEvent(n, r, s) {
        ...
        return co(n, e) ? null : n;
      },
    };
  },
  oo = (t = {}) => ({ ...ao(t), name: "InboundFilters" });
function Gn(t = {}, e = {}) {
  return {
...
function co(t, e) {
  if (t.type) {
    if (t.type === "transaction" && lo(t, e.ignoreTransactions))
      return (
        E &&
...
function uo(t, e) {
  return e != null && e.length ? ns(t).some((n) => st(n, e)) : !1;
}
function lo(t, e) {
...
function Tt(t, e, n, r, s, i, a, o) {
  ...
  if (ee(r[s], Error)) {
    ...
    const u = t(e, r[s]),
      d = c.length;
    (Jn(u, s, d, o), (c = Tt(t, e, n, r[s], s, [u, ...c], u, d)));
  }
  return (
    ...
    P(I, "fetch", function (n) {
      return function (...r) {
        ...
        return (
          ...
          n.apply(I, r).then(
            async (c) => (
              j("fetch", { ...o, endTimestamp: V() * 1e3, response: c }),
              c
            ),
            (c) => {
              if (
                (j("fetch", { ...o, endTimestamp: V() * 1e3, error: c }),
                zt(c) &&
                  c.stack === void 0 &&
    ...
    if (a) {
      ...
      if (a[1]) {
        ...
        if ((d[A - 1] === "." && A--, A > 0)) {
          ...
          const C = c.indexOf(".Module");
          C > 0 && ((d = d.slice(C + 1)), (c = c.slice(0, C)));
        }
        l = void 0;
      }
      (u && ((l = c), (g = u)),
...
const Fo = "sentry-electron-renderer-id";
function jo(t) {
  var n;
  const e = Lo(t);
...
function ds(t = O()) {
  ...
  const n = t.getOptions().ipcNamespace,
    r = jo(n);
  return (je.set(t, r), r.sendRendererStart(), r);
}
const w = I;
let Nt = 0;
function ls() {
...
function me(t, e = {}) {
    ...
    try {
      ...
      throw (
        ...
        ci((a) => {
          (a.addEventProcessor(
            (o) => (
              e.mechanism && (bt(o, void 0), fe(o, e.mechanism)),
  ...
  ($r(r, t), ie(t, "__sentry_wrapped__", r));
  try {
...
function Zo(t, e, n, r) {
  const s = O(),
    ...
    a = Xo(e),
    o = { __serialized__: Hr(e, i) };
  if (a) return { exception: { values: [tn(t, a)] }, extra: o };
  const c = {
    exception: {
      values: [
        {
...
function mt(t, e) {
  return { exception: { values: [tn(t, e)] } };
}
function nn(t, e) {
...
const zo = /Minified React error #\d+;/i;
function Ho(t) {
  return t && zo.test(t.message) ? 1 : 0;
}
function Vo(t) {
...
function rn(t, e, n, r, s) {
  let i;
  if (Nr(e) && e.error) return mt(t, e.error);
  if (fn(e) || js(e)) {
    const a = e;
  ...
  return zt(e)
    ...
    : Te(e) || rt(e)
      ...
      : ((i = Ct(t, e, n, r)), bt(i, `${e}`), fe(i, { synthetic: !0 }), i);
}
function Ct(t, e, n, r) {
  const s = {};
  if (r && n) {
...
function Jo(t, { isUnhandledRejection: e }) {
  ...
  return Nr(t)
    ...
    : rt(t)
      ? `Event \`${Ko(t)}\` (type=${t.type}) captured as ${r}`
...
class Qo extends Va {
  constructor(e) {
    var d;
    const n = ec(e),
      r = w.SENTRY_SDK_SOURCE || Ao();
    (Qa(n, "browser", ["browser"], r),
      (d = n._metadata) != null &&
        d.sdk &&
    ...
    (w.document &&
      ...
      w.document.addEventListener("visibilitychange", () => {
        w.document.visibilityState === "hidden" &&
          (i && this._flushOutcomes(), a && Jr(this), u && Xr(this));
      }),
      s && this.on("beforeSendSession", Xa));
  }
  eventFromException(e, n) {
    return Go(this._options.stackParser, e, n, this._options.attachStacktrace);
  }
...
const tc = typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__,
  $ = I,
  nc = 1e3;
let tr, Ot, $t;
function rc(t) {
...
function sc() {
  ...
  ($.document.addEventListener("click", e, !1),
    ...
    ["EventTarget", "Node"].forEach((n) => {
      var i, a;
      const s = (i = $[n]) == null ? void 0 : i.prototype;
...
function ic(t) {
  ...
  try {
    if (!t.target || t.target._sentryId !== $t) return !1;
  } catch {}
  return !0;
}
function ac(t, e) {
...
function nr(t, e = !1) {
  return (n) => {
    ...
    const r = oc(n);
    if (ac(n.type, r)) return;
    (ie(n, "_sentryCaptured", !0),
      r && !r._sentryId && ie(r, "_sentryId", M()));
    const s = n.type === "keypress" ? "input" : n.type;
    (ic(n) ||
      (t({ event: n, name: s, global: e }),
      (Ot = n.type),
      ($t = r ? r._sentryId : void 0)),
      clearTimeout(tr),
      (tr = $.setTimeout(() => {
        (($t = void 0), (Ot = void 0));
      }, nc)));
  ...
  function t(e) {
    return function (...n) {
      ...
      if (r) {
        ...
        j("history", { from: s, to: i });
      }
      return e.apply(this, n);
    };
  }
  (P($.history, "pushState", t), P($.history, "replaceState", t));
}
function uc(t) {
  try {
        ...
        (n.setRequestHeader = new Proxy(n.setRequestHeader, {
          apply(u, d, l) {
            const [g, p] = l,
              T = d[xe];
            return (
              T && H(g) && H(p) && (T.request_headers[g.toLowerCase()] = p),
              u.apply(d, l)
            );
          },
        })),
...
function _c(t, e = dc("fetch")) {
  ...
  return ts(t, s, en(t.bufferSize || mc));
}
...
const vc = /^\s*at (\S+?)(?::(\d+))(?::(\d+))\s*$/i,
  ...
  kc = (t) => {
    ...
    if (r) {
      ...
      const [i, a] = ms(r[1] || X, r[2]);
      return At(a, i, r[3] ? +r[3] : void 0, r[4] ? +r[4] : void 0);
    }
  },
  hs = [gc, kc],
  xc =
    /^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:[-a-z]+)?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js)|\/[\w\-. /=]+)(?::(\d+))?(?::(\d+))?\s*$/i,
  Ic = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i,
  Tc = (t) => {
    const e = xc.exec(t);
    if (e) {
      ...
      return (
        ([s, r] = ms(s, r)),
        At(r, s, e[4] ? +e[4] : void 0, e[5] ? +e[5] : void 0)
      );
    }
  },
  wc = [yc, Tc],
    ...
    return {
      ...
      setup(n) {
        (e.console && go(Pc(n)),
          ...
          e.fetch && No(Lc(n)),
          e.history && ps(Fc(n)),
          e.sentry && n.on("beforeSendEvent", Ac(n)));
      },
    };
  },
  $c = Oc;
...
function Dc(t, e) {
  return function (r) {
    ...
    try {
      const u = r.event,
        d = jc(u) ? u.target : u;
      ((s = Or(d, { keyAttrs: a, maxStringLength: o })), (i = Ws(d)));
    } catch {
      s = "<unknown>";
    }
...
function Mc(t) {
  return function (n) {
    ...
    const { method: a, url: o, status_code: c, body: u } = i,
      ...
      g = { category: "xhr", data: d, type: "http", level: us(c) };
...
const Bc = [
  ...
  Zc = (t = {}) => {
    ...
    return {
      name: Uc,
      setupOnce() {
        (e.setTimeout && P(w, "setTimeout", rr),
          e.setInterval && P(w, "setInterval", rr),
          e.requestAnimationFrame && P(w, "requestAnimationFrame", Hc),
          e.XMLHttpRequest &&
            "XMLHttpRequest" in w &&
            P(XMLHttpRequest.prototype, "send", Vc));
        const n = e.eventTarget;
        n && (Array.isArray(n) ? n : Bc).forEach((s) => Wc(s, e));
      },
    };
  },
  zc = Zc;
  ...
  (i = r == null ? void 0 : r.hasOwnProperty) != null &&
    ...
    (P(r, "addEventListener", function (a) {
      return function (o, c, u) {
        ...
        return (
          e.unregisterOriginalCallbacks && Gc(this, o, c),
          a.apply(this, [
            o,
            me(c, {
              mechanism: {
...
const Yc = () => ({
    ...
    setupOnce() {
      ...
      (Pn({ ignoreDuration: !0 }),
        Mn(),
        ps(({ from: t, to: e }) => {
          t !== void 0 && t !== e && (Pn({ ignoreDuration: !0 }), Mn());
        }));
    },
  }),
  Jc = "GlobalHandlers",
  Kc = (t = {}) => {
    ...
    return {
      ...
      setup(n) {
        (e.onerror && (Qc(n), sr("onerror")),
          e.onunhandledrejection && (eu(n), sr("onunhandledrejection")));
      },
    };
  },
  Xc = Kc;
function Qc(t) {
  Ps((e) => {
    const { stackParser: n, attachStacktrace: r } = _s();
    if (O() !== t || ls()) return;
    const { msg: s, url: i, line: a, column: o, error: c } = e,
      u = ru(rn(n, c || s, void 0, r, !1), i, a, o);
    ((u.level = "error"),
      Wr(u, {
        originalException: c,
        mechanism: {
...
function sr(t) {
  at && y.log(`Global Handler attached: ${t}`);
}
function _s() {
  const t = O();
  return (
...
function gs(t) {
  return [oo(), ro(), zc(), $c(), Xc(), du(), So(), iu(), Yc()];
}
function pu(t = {}) {
  const e = !t.skipBrowserExtensionCheck && lu();
  let n = t.defaultIntegrations == null ? gs() : t.defaultIntegrations;
  const r = {
    ...t,
    enabled: e ? !1 : t.enabled,
    stackParser: Ds(t.stackParser || Nc),
    integrations: Ra({ integrations: t.integrations, defaultIntegrations: n }),
    transport: t.transport || _c,
  };
  return Ja(Qo, r);
}
function _t() {
...
function _u(t) {
  ...
  return ts(
    t,
    async (n) => (e || (e = ds()), e.sendEnvelope(n.body), { statusCode: 200 }),
  );
}
const gu = 50,
  [, yu] = hs,
...
function Eu(t) {
  return [...gs().filter((e) => e.name !== "BrowserSession"), mu()];
}
function Su(t = {}, e = pu) {
...
If init has been called in the preload and contextIsolation is disabled, is not required to call init in the renderer`);
  ...
  ((window.__SENTRY__RENDERER_INIT__ = !0),
    ...
    t.defaultIntegrations === void 0 && (t.defaultIntegrations = Eu()),
    t.stackParser === void 0 && (t.stackParser = bu),
    t.ipcNamespace === void 0 && (t.ipcNamespace = "sentry-ipc"),
    t.dsn === void 0 && (t.dsn = "https://12345@dummy.dsn/12345"),
    t.transport === void 0 && (t.transport = _u),
...
const ys = {
    getInitialLocale() {
      const t = N.ipcRenderer.sendSync(
  ...
  Iu = (t) => {
    xu() &&
      ...
      (t["claude.hybrid"].DesktopIntl = ys));
  },
  vs = {};
Iu(vs);
...
const v = Object.freeze({ status: "aborted" }),
  Ie = (t) => ({ status: "dirty", value: t }),
  F = (t) => ({ status: "valid", value: t }),
  or = (t) => t.status === "aborted",
  cr = (t) => t.status === "dirty",
  _e = (t) => t.status === "valid",
...
class k {
  ...
  brand() {
    return new Ku({ typeName: b.ZodBranded, type: this, ...S(this._def) });
  }
  catch(e) {
    const n = typeof e == "function" ? e : () => e;
    return new jt({
...
const Nu = /^c[^\s-]{8,}$/i,
  Cu = /^[0-9a-z]+$/,
  Ou = /^[0-9A-HJKMNP-TV-Z]{26}$/i,
  $u =
    /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i,
  Au = /^[a-z0-9_-]{21}$/i,
  Du = /^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_]*$/,
  Pu =
...
const Fu =
  ...
  zu = /^([0-9a-zA-Z-_]{4})*(([0-9a-zA-Z-_]{2}(==)?)|([0-9a-zA-Z-_]{3}(=)?))?$/,
  bs =
...
dr.create = (t) => new dr({ typeName: b.ZodSymbol, ...S(t) });
class lr extends k {
  _parse(e) {
...
lr.create = (t) => new lr({ typeName: b.ZodUndefined, ...S(t) });
class fr extends k {
  _parse(e) {
...
fr.create = (t) => new fr({ typeName: b.ZodNull, ...S(t) });
class pr extends k {
  constructor() {
...
pr.create = (t) => new pr({ typeName: b.ZodAny, ...S(t) });
class hr extends k {
  constructor() {
...
hr.create = (t) => new hr({ typeName: b.ZodUnknown, ...S(t) });
class ne extends k {
  _parse(e) {
    const n = this._getOrReturnCtx(e);
    return (
...
mr.create = (t) => new mr({ typeName: b.ZodVoid, ...S(t) });
class U extends k {
  _parse(e) {
...
class Xe extends k {
  _parse(e) {
    const { status: n, ctx: r } = this._processInputParams(e),
      s = (i, a) => {
        if (or(i) || or(a)) return v;
        const o = Mt(i.value, a.value);
        return o.valid
          ? ((cr(i) || cr(a)) && n.dirty(), { status: n.value, value: o.data })
...
class oe extends k {
  _parse(e) {
    ...
    const i = [...r.data]
      ...
      .filter((a) => !!a);
    return r.common.async
      ? Promise.all(i).then((a) => L.mergeArray(n, a))
      : L.mergeArray(n, i);
  }
  get items() {
...
_r.create = (t, e, n) =>
  new _r({ valueType: e, keyType: t, typeName: b.ZodMap, ...S(n) });
class Oe extends k {
  _parse(e) {
    const { status: n, ctx: r } = this._processInputParams(e);
...
gr.create = (t, e) => new gr({ getter: t, typeName: b.ZodLazy, ...S(e) });
class Lt extends k {
  _parse(e) {
...
Lt.create = (t, e) => new Lt({ value: t, typeName: b.ZodLiteral, ...S(e) });
function Ss(t, e) {
...
yr.create = (t, e) => new yr({ values: t, typeName: b.ZodNativeEnum, ...S(e) });
class Qe extends k {
  unwrap() {
    return this._def.type;
  }
...
vr.create = (t) => new vr({ typeName: b.ZodNaN, ...S(t) });
class Ku extends k {
  _parse(e) {
    const { ctx: n } = this._processInputParams(e),
      r = n.data;
...
class sn extends k {
  ...
  static create(e, n) {
    return new sn({ in: e, out: n, typeName: b.ZodPipeline });
  }
}
class Bt extends k {
  _parse(e) {
...
Bt.create = (t, e) =>
  new Bt({ innerType: t, typeName: b.ZodReadonly, ...S(e) });
var b;
(function (t) {
...
const rd = Object.fromEntries(
  ...
  an = Object.fromEntries(Object.entries(process).filter(([t]) => rd[t]));
an.version = nd().appVersion;
an.env = Er.CI ? { CI: Er.CI } : {};
var sd = {};
const ks = ku(process.argv);
!ks && !sd.CI && Su();
const { locale: id } = ys.getInitialLocale();
N.contextBridge.exposeInMainWorld("process", an);
N.contextBridge.exposeInMainWorld("initialLocale", id);
N.contextBridge.exposeInMainWorld("desktopEssentialTelemetryDisabled", ks);
