...
var c = t.ri(`build-flavor`),
  l = [t.As.Nightly, t.As.InternalAlpha, t.As.PublicBeta, t.As.Prod],
  u = {
    [t.As.Nightly]: { kind: `msix` },
    [t.As.InternalAlpha]: { kind: `msix` },
    [t.As.PublicBeta]: {
      kind: `store`,
...
//# sourceMappingURL=file-based-logger-DZ6052-3.js.map
