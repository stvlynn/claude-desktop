import { r as l, u as V, _ as w, s as C, j as i } from "./main-TllbX7l6.js";
(function () {
  try {
    var e =
      typeof window < "u"
...
try {
  (function () {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = "80c47c4e-1abf-4fff-ac72-0b21876c2b64"),
      (e._sentryDebugIdIdentifier =
        "sentry-dbid-80c47c4e-1abf-4fff-ac72-0b21876c2b64"));
  })();
} catch {}
function F(e, t) {
  var n = e.values,
...
function M(e) {
  var t = V(),
    ...
    c = o === void 0 ? a : o,
    g = e.ignoreTag,
    x = { id: d, description: f, defaultMessage: L },
    p = n(x, u, { ignoreTag: g });
  return typeof m == "function"
    ? m(Array.isArray(p) ? p : [p])
    : c
      ? l.createElement(c, null, p)
      : l.createElement(l.Fragment, null, p);
}
      ...
      t &&
        (e === "default"
          ...
          : e === "lg"
            ...
            : e === "sm" && (a = a.replace("px-3", "pl-2 pr-2.5 gap-1"))),
      n &&
        (e === "default"
          ? (a = a.replace("px-4", "pl-3 pr-2 gap-1"))
          : e === "lg"
            ? (a = a.replace("px-5", "pl-3.5 pr-2.5 gap-1"))
            : e === "sm" && (a = a.replace("px-3", "pl-2.5 pr-2 gap-1"))),
      a
    );
  },
  b = l.forwardRef(
    (
      ...
      const p = v(S(t), I(n, !!L, !!u), s && "!rounded-full", e),
        y = i.jsxs(i.Fragment, { children: [L, o, u] });
      if (a) {
        const { style: T, "aria-label": _, rel: E } = g;
        return i.jsx("a", {
          href: a,
          target: f || "_self",
          rel: E,
...
function B({ width: e = 16, height: t = 16, style: n }) {
  return i.jsx("svg", {
    width: e,
    height: t,
    style: n,
...
var N;
const r =
  (N = globalThis["claude.internal.ui"]) == null ? void 0 : N.AboutWindow;
var j;
(j = globalThis["claude.internal.ui"]) == null || j.QuickWindow;
var k;
(k = globalThis["claude.internal.ui"]) == null || k.MainWindowTitleBar;
function $({ className: e }) {
  const [t, n] = l.useState("");
  l.useEffect(() => {
    (async () => {
      var L;
      const f = await ((L = r == null ? void 0 : r.getAppName) == null
        ? void 0
        : L.call(r));
      f && n(f);
    })();
  ...
  return i.jsxs("h2", {
    ...
    style: { maxWidth: "95%" },
    children: [a, " ", i.jsx("em", { children: "for " }), s],
  });
}
function D() {
  const [e, t] = l.useState(null),
    [n, s] = l.useState(!1),
    d =
      (e == null ? void 0 : e.commitHash) && e.commitHash !== "unknown"
        ? e.commitHash.slice(0, 6)
        : "Unknown",
    f = `${process.version} (${d})`,
    L = l.useCallback(() => {
      var o;
      (o = r == null ? void 0 : r.openHelp) == null || o.call(r);
    }, []),
    u = l.useCallback(() => {
      var o;
      (o = r == null ? void 0 : r.getSupport) == null || o.call(r);
    }, []),
    m = l.useCallback(async () => {
      var o;
      try {
        const g =
          `${await ((o = r == null ? void 0 : r.getAppName) == null ? void 0 : o.call(r))} ${process.version} (${d}) ${(e == null ? void 0 : e.commitTimestamp) || ""}`.trim();
  ...
  return (
    l.useEffect(() => {
      var o;
      (o = r == null ? void 0 : r.getBuildProps) == null ||
        o
          .call(r)
          .then((c) => {
            t(c);
    ...
    i.jsxs("div", {
      className: "flex flex-col items-center w-full h-full pt-16 nc-drag",
      children: [
        i.jsx(B, { width: 84, height: 84 }),
        i.jsx($, { className: "mt-4" }),
        i.jsx("h3", {
          className:
          ...
          children: n
            ? i.jsx(h, {
                ...
                id: "mCXNyEdJat",
                description:
                  "Message shown briefly after copying version to clipboard",
              })
            : i.jsx(h, {
                defaultMessage: "Version {version}",
                id: "S3k5yXss2r",
                description:
                  "Version number display in the About window. {version} is the application version number",
                values: { version: f },
              }),
        }),
        i.jsxs("div", {
          ...
          children: [
            ...
            i.jsx(b, {
              ...
              children: i.jsx(h, {
                ...
                description:
                  "Label for the Get support button in the About window",
              }),
            }),
          ],
        }),
