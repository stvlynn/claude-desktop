...
try {
  (function () {
    ...
    r &&
      ...
      (t._sentryDebugIds[r] = "baf12470-9af2-4790-95ef-6bad6edc44ba"),
      (t._sentryDebugIdIdentifier =
        "sentry-dbid-baf12470-9af2-4790-95ef-6bad6edc44ba"));
  })();
} catch {}
(function () {
...
` + l[p].replace(" at new ", " at ");
  ...
  function lm(e, n, i, s, l, c, p, g, _) {
    ((Dr = !1), (Ri = null), am.apply(um, arguments));
  }
  ...
  var Et = typeof Object.is == "function" ? Object.is : ag;
  function Xr(e, n) {
    if (Et(e, n)) return !0;
    if (
      typeof e != "object" ||
...
`,
  ...
  function Pc(e, n, i) {
    if (He.current !== ln) throw Error(o(168));
    (ge(He, n), ge(Qe, i));
  }
  function Rc(e, n, i) {
    var s = e.stateNode;
  ...
  function xa(e, n, i, s) {
    ...
    (typeof c == "object" && c !== null
      ? (l.context = dt(c))
      : ((c = Ke(n) ? Cn : He.current), (l.context = sr(e, c))),
...
` +
  ...
  function Ag(e, n, i) {
    ...
    switch ((ta(n), n.tag)) {
      ...
      case 10:
        return (aa(n.type._context), Ue(n), null);
      case 17:
        return (Ke(n.type) && Ji(), Ue(n), null);
      case 19:
        if ((ve(we), (c = n.memoizedState), c === null)) return (Ue(n), null);
      ...
      case 23:
        return (
          ...
          s && (n.mode & 1) !== 0
            ? (at & 1073741824) !== 0 &&
              (Ue(n), n.subtreeFlags & 6 && (n.flags |= 8192))
            : Ue(n),
          null
        );
      case 24:
  ...
  function Uf(e, n, i) {
    ...
    switch (i.tag) {
      ...
      case 22:
        i.mode & 1
          ? ((je = (s = je) || i.memoizedState !== null), pn(e, n, i), (je = s))
          : pn(e, n, i);
        break;
      default:
        pn(e, n, i);
    ...
    switch (e.tag) {
      ...
      case 22:
        if (
          ...
          e.mode & 1 ? ((je = (I = je) || R), xt(n, e), (je = I)) : xt(n, e),
          At(e),
          s & 8192)
        ) {
          if (
  ...
  function $f(e, n, i) {
    for (var s = (e.mode & 1) !== 0; B !== null; ) {
      ...
      if (l.tag === 22 && s) {
        ...
        if (!p) {
          var g = l.alternate,
            _ = (g !== null && g.memoizedState !== null) || je;
          g = Eo;
          var I = je;
          if (((Eo = p), (je = _) && !I))
            for (B = l; B !== null; )
  ...
  ((Ul = function (e) {
    ...
    (kl = Va),
    (Cl = Mn));
  var Zg = { usingClientEntryPoint: !1, Events: [Jr, ir, Zi, Il, Nl, Va] },
    pi = {
...
var ih = $($({}, Jp), { textComponent: ze.Fragment }),
  A0 = { key: 42 },
  D0 = function (t) {
    return ze.isValidElement(t) ? ze.createElement(ze.Fragment, A0, t) : t;
  },
  M0 = function (t) {
    var r;
    return (r = ze.Children.map(t, D0)) !== null && r !== void 0 ? r : [];
  };
function F0(t) {
  return function (r) {
...
var Qu =
  typeof window < "u" && !window.__REACT_INTL_BYPASS_GLOBAL_CONTEXT__
    ? window.__REACT_INTL_CONTEXT__ ||
      (window.__REACT_INTL_CONTEXT__ = ze.createContext(null))
...
var G0 = (function (t) {
  ...
  return (
    ...
    (r.prototype.render = function () {
      return (
        rh(this.state.intl),
        ze.createElement(z0, { value: this.state.intl }, this.props.children)
      );
    }),
...
function V0(t) {
  const [r, o] = ze.useState(window.initialLocale),
    [a, u] = ze.useState(window.initialMessages);
  return (
    ze.useEffect(() => {
      var f;
...
window.attachReactToElement = uh;
...
const W0 = ["debug", "info", "warn", "error", "log", "assert", "trace"],
  X0 = "Sentry Logger ",
  qo = {};
function Nr(t) {
...
function yh(t, r = {}) {
  ...
  try {
    ...
    const v = Array.isArray(r) ? r : r.keyAttrs,
      T = (!Array.isArray(r) && r.maxStringLength) || lv;
    for (
      ;
      o &&
      f++ < a &&
...
function Bd(t) {
  try {
    return ov(t) ? yh(t) : Object.prototype.toString.call(t);
  } catch {
    return "<unknown>";
  }
}
...
function jd(t, r) {
  ...
  for (let a = 0; a < t.length; a++) {
    const u = t[a];
    try {
      gh(u) ? o.push(ph(u)) : o.push(String(u));
    } catch {
...
function lt(t = pv()) {
  ...
  return (
    ...
    mu.replace(/[018]/g, (r) => (r ^ ((hv() & 15) >> (r / 4))).toString(16))
  );
}
function Eh(t) {
  var r, o;
...
function wr() {
  const t = ts(),
    r = ns(t);
  return (r.stack = r.stack || new Tv(Sv(), wv()));
}
function xv(t) {
...
function Cv(t) {
  const r = t.getPropagationContext(),
    ...
    f = { trace_id: o, span_id: u || wh() };
  return (a && (f.parent_span_id = a), f);
}
const Pv = "sentry.source",
  Rv = "sentry.sample_rate",
  Lv = "sentry.previous_trace_sample_rate",
  Ov = "sentry.op",
  Av = "sentry.origin",
...
function Ih(t) {
  const r = t;
  return { scope: r[Fv], isolationScope: Hv(r[bv]) };
}
const Bv = "sentry-",
  Uv = /^sentry-/;
function jv(t) {
...
function Qv(t) {
  const r = t.getOptions(),
    { host: o } = t.getDsn() || {};
  let a;
  return (r.orgId ? (a = String(r.orgId)) : o && (a = Yv(o)), a);
}
function Kv(t) {
  const r = typeof t == "string" ? Wv(t) : Nh(t);
  if (!(!r || !Xv(r))) return r;
}
function qv(t) {
...
function r_(t) {
  if (!(!t || t.code === Dv))
    return t.code === Mv ? "ok" : t.message || "internal_error";
}
const i_ = "_sentryRootSpan";
function Ch(t) {
  return t[i_] || t;
}
function Zd() {
...
function c_(t) {
  ...
  const o = Ch(t),
    ...
    d = (f == null ? void 0 : f.get("sentry.sample_rate")) ?? u[Rv] ?? u[Lv];
  function h(M) {
    return (
...
function Rh(t, r = 3, o = 100 * 1024) {
  const a = Ft(t, r);
  return h_(a) > o ? Rh(t, r - 1, o) : a;
}
function Mu(t, r, o = 1 / 0, a = 1 / 0, u = m_()) {
  const [f, d] = u;
  if (
    r == null ||
...
function N_(t, r) {
  ...
  (k_(t, r), a && R_(t, a), L_(t, o), C_(t, u), P_(t, f));
}
function Zo(t, r) {
  const {
    extra: o,
...
function R_(t, r) {
  ((t.contexts = { trace: Zv(r), ...t.contexts }),
    (t.sdkProcessingMetadata = {
      dynamicSamplingContext: c_(r),
      ...t.sdkProcessingMetadata,
    }));
  const o = Ch(r),
    a = ol(o).description;
...
function A_(t, r, o, a, u, f) {
  ...
  (D_(m, t),
    ...
    r.type === void 0 && M_(m, t.stackParser));
  const v = B_(a, o.captureContext);
  ...
  (k.length && (o.attachments = k), N_(m, N));
  const D = [...T, ...N.eventProcessors];
  return I_(D, m, o).then(
    (H) => (H && F_(H), typeof d == "number" && d > 0 ? H_(H, d, h) : H),
  );
}
function D_(t, r) {
  var h, m;
...
function $_(t) {
  return `${z_(t)}${t.projectId}/envelope/`;
}
function G_(t, r) {
  const o = { sentry_version: j_ };
  return (
...
function Fh(t, r) {
  ...
  const a = t.getOptions(),
    u = K_(o, a._metadata, a.tunnel, t.getDsn());
  (bh().set(t, []), t.emit("flushLogs"), t.sendEnvelope(u));
}
function q_(t) {
  return bh().get(t);
}
...
function Hh(t, r) {
  ...
  if (o.length === 0) return;
  const a = t.getOptions(),
    u = J_(o, a._metadata, a.tunnel, t.getDsn());
  (Bh().set(t, []), t.emit("flushMetrics"), t.sendEnvelope(u));
}
function eE(t) {
  return Bh().get(t);
}
...
const tE = 60 * 1e3;
function nE(t, r = Date.now()) {
  const o = parseInt(`${t}`, 10);
  if (!isNaN(o)) return o * 1e3;
  const a = Date.parse(`${t}`);
  return isNaN(a) ? tE : a - r;
}
function rE(t, r) {
  return t[r] || t.all || 0;
}
function iE(t, r, o = Date.now()) {
  return rE(t, r) > o;
}
function oE(t, { statusCode: r, headers: o }, a = Date.now()) {
  const u = { ...t },
  ...
  else d ? (u.all = a + nE(d, a)) : r === 429 && (u.all = a + 60 * 1e3);
  return u;
}
const Uh = 64;
function jh(t, r, o = ll(t.bufferSize || Uh)) {
  ...
  function f(d) {
    ...
    if (
      (tp(d, (T, N) => {
        const k = np(N);
        iE(a, k) ? t.recordDroppedEvent("ratelimit_backoff", k) : h.push(T);
      }),
      h.length === 0)
    )
...
class cE {
  constructor(r) {
    ...
    if (
      ...
      (this._promiseBuffer = ll(
        ((a = r.transportOptions) == null ? void 0 : a.bufferSize) ?? Uh,
      )),
      r.dsn
        ? (this._dsn = Kv(r.dsn))
      ...
      const d = V_(this._dsn, r.tunnel, r._metadata ? r._metadata.sdk : void 0);
    ...
    ((this._options.enableLogs =
      ...
      this._options.enableLogs &&
        mp(this, "afterCaptureLog", "flushLogs", hE, Fh),
      (this._options.enableMetrics ??
        ((f = this._options._experiments) == null ? void 0 : f.enableMetrics) ??
        !0) &&
        mp(this, "afterCaptureMetric", "flushMetrics", pE, Hh));
  }
  ...
  sendEvent(r, o = {}) {
    ...
    let a = x_(r, this._dsn, this._options._metadata, this._options.tunnel);
    for (const u of o.attachments || []) a = g_(a, __(u));
  ...
  sendSession(r) {
    ...
    const u = T_(r, this._dsn, this._options._metadata, this._options.tunnel);
    this.sendEnvelope(u);
  }
  ...
  _setupIntegrations() {
    ...
    ((this._integrations = Y_(this, r)), cp(this, r));
  }
  ...
  _prepareEvent(r, o, a, u) {
    ...
    return (
      ...
      A_(f, r, o, a, this, u).then((h) => {
        if (h === null) return h;
        (this.emit("postprocessEvent", h, o),
          (h.contexts = { trace: Cv(a), ...h.contexts }));
        const m = l_(this, a);
        return (
...
Reason: ${k}`));
  ...
  _flushOutcomes() {
    ...
    const o = sE(r, this._options.tunnel && Ni(this._dsn));
    this.sendEnvelope(o);
  }
}
function gp(t) {
...
function Gn(t, r) {
  const o = $e(),
    a = Xn();
  if (!o) return;
  const { beforeBreadcrumb: u = null, maxBreadcrumbs: f = _E } = o.getOptions();
  if (f <= 0) return;
  ...
  IE = (t = {}) => {
    ...
    return {
      ...
      processEvent(o, a, u) {
        ...
        return kE(o, r) ? null : o;
      },
    };
  },
  NE = (t = {}) => ({ ...IE(t), name: "InboundFilters" });
function Ep(t = {}, r = {}) {
  return {
...
function kE(t, r) {
  if (t.type) {
    if (t.type === "transaction" && PE(t, r.ignoreTransactions))
      return (
        Z &&
...
function KE(t) {
  ...
  try {
    ...
    if (uv(r)) return new Headers(r.headers);
  } catch {}
}
function qE() {
  return "npm";
...
const nS = "sentry-electron-renderer-id";
function rS(t) {
  var o;
  const r = tS(t);
...
function Tr(t, r = {}) {
  ...
  (vh(a, t), $n(t, "__sentry_wrapped__", a));
  try {
      ...
      values: [
        {
          ...
          value: hS(r, { isUnhandledRejection: a }),
        },
      ],
    },
    extra: h,
...
function dl(t, r, o, a, u) {
  let f;
  if (mh(r) && r.error) return _u(t, r.error);
  if (Hd(r) || iv(r)) {
    const d = r;
  ...
  return Zu(r)
    ? _u(t, r)
    : yi(r) || is(r)
      ? ((f = sS(t, r, o, u)), Er(f, { synthetic: !0 }), f)
...
class yS extends cE {
  constructor(r) {
    var v;
    const o = vS(r),
      a = Ce.SENTRY_SDK_SOURCE || qE();
    (vE(o, "browser", ["browser"], a),
      (v = o._metadata) != null &&
        v.sdk &&
    ...
    (Ce.document &&
      ...
      Ce.document.addEventListener("visibilitychange", () => {
        Ce.document.visibilityState === "hidden" &&
          (f && this._flushOutcomes(), d && Fh(this), y && Hh(this));
      }),
      u && this.on("beforeSendSession", yE));
  }
  eventFromException(r, o) {
    return dS(this._options.stackParser, r, o, this._options.attachStacktrace);
  }
...
const _S = typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__,
  Xe = he,
  ES = 1e3;
let kp, Gu, Vu;
function SS(t) {
...
function DS(t, r = CS("fetch")) {
  ...
  return jh(t, u, ll(t.bufferSize || AS));
}
    ...
    return {
      ...
      setup(o) {
        (r.console && ME(JS(o)),
          ...
          r.fetch && XE(t1(o)),
          r.history && Jh(n1(o)),
          r.sentry && o.on("beforeSendEvent", qS(o)));
      },
    };
  },
  KS = QS;
...
function ZS(t, r) {
  return function (a) {
    ...
    try {
      const y = a.event,
        v = r1(y) ? y.target : y;
      ((u = yh(v, { keyAttrs: d, maxStringLength: h })), (f = fv(v)));
    } catch {
      u = "<unknown>";
    }
    ...
    return {
      ...
      setupOnce() {
        (r.setTimeout && ut(Ce, "setTimeout", Pp),
          ...
          r.requestAnimationFrame && ut(Ce, "requestAnimationFrame", u1),
          r.XMLHttpRequest &&
            "XMLHttpRequest" in Ce &&
            ut(XMLHttpRequest.prototype, "send", l1));
        const o = r.eventTarget;
        o && (Array.isArray(o) ? o : i1).forEach((u) => c1(u, r));
      },
    };
  },
  a1 = s1;
  ...
  (f = a == null ? void 0 : a.hasOwnProperty) != null &&
    ...
    (ut(a, "addEventListener", function (d) {
      return function (h, m, y) {
        ...
        return (
          r.unregisterOriginalCallbacks && d1(this, h, m),
          d.apply(this, [
            h,
            Tr(m, {
              mechanism: {
...
const p1 = () => ({
  ...
  m1 = (t = {}) => {
    ...
    return {
      ...
      setup(o) {
        (r.onerror && (y1(o), Rp("onerror")),
          r.onunhandledrejection && (v1(o), Rp("onunhandledrejection")));
      },
    };
  },
  g1 = m1;
function y1(t) {
  ev((r) => {
    const { stackParser: o, attachStacktrace: a } = nm();
    if ($e() !== t || qh()) return;
    const { msg: u, url: f, line: d, column: h, error: m } = r,
      y = S1(dl(o, m || u, void 0, a, !1), f, d, h);
    ((y.level = "error"),
      Oh(y, {
        originalException: m,
        mechanism: {
...
function rm(t) {
  return [NE(), wE(), a1(), KS(), g1(), C1(), UE(), T1(), p1()];
}
function L1(t = {}) {
  const r = !t.skipBrowserExtensionCheck && P1();
  let o = t.defaultIntegrations == null ? rm() : t.defaultIntegrations;
  const a = {
    ...t,
    enabled: r ? !1 : t.enabled,
    stackParser: J0(t.stackParser || XS),
    integrations: X_({ integrations: t.integrations, defaultIntegrations: o }),
    transport: t.transport || DS,
  };
  return mE(yS, a);
}
function Eu() {
...
function B1(t) {
  return [...rm().filter((r) => r.name !== "BrowserSession"), A1()];
}
function U1(t = {}, r = L1) {
...
If init has been called in the preload and contextIsolation is disabled, is not required to call init in the renderer`);
  ...
  ((window.__SENTRY__RENDERER_INIT__ = !0),
    ...
    t.defaultIntegrations === void 0 && (t.defaultIntegrations = B1()),
    t.stackParser === void 0 && (t.stackParser = H1),
    t.ipcNamespace === void 0 && (t.ipcNamespace = "sentry-ipc"),
    t.dsn === void 0 && (t.dsn = "https://12345@dummy.dsn/12345"),
    t.transport === void 0 && (t.transport = D1),
...
const im = window.matchMedia("(prefers-color-scheme: dark)"),
  j1 = im.matches ? "darkTheme" : "";
document.body.className = j1;
im.addEventListener("change", (t) => {
  document.body.className = t.matches ? "darkTheme" : "";
});
const z1 = "modulepreload",
  $1 = function (t, r) {
...
uh(
  ...
  G1(() => import("./AboutWindow-DJTf96rn.js"), [], import.meta.url),
);
export { es as _, Su as j, ze as r, b0 as s, oh as u };
