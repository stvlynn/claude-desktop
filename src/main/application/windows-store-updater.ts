...
// Application: Windows Store (UWP/MSIX) desktop updater.
...
} from "../infrastructure/update-version";
import type { WindowsStoreUpdaterOptions } from "../infrastructure/desktop-updater-types";
import type {
  DesktopUpdater,
  UpdateLifecycleState,
} from "../infrastructure/desktop-runtime-types";

const windowsStoreUpdaterLogger = createLazyScopedStructuredLogger(
