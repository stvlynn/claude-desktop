...
import type {
  ...
  RuntimeSchema,
} from "../domain/desktop-setting-schema";
import { desktopSettingDefinitions } from "../domain/desktop-setting-definitions";
...
export function getDefaultDesktopSettingValue(key: string): unknown {
  return getDesktopSettingDefinition(key)?.default;
}
