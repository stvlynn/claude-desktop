...
// Application: MSIX-based Windows desktop updater.
...
import {
  isNodeErrorCode,
  isRecord,
} from "../infrastructure/desktop-runtime-utils";
import { compareBuildVersions } from "../infrastructure/update-version";
import type {
...
const windowsUpdaterLogger =
  createLazyScopedStructuredLogger("windows-updater");
