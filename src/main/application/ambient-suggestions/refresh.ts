...
import type { AmbientAppServerConnection, AmbientStructuredLogger } from "./types";
...
export async function refreshAmbientSuggestions({
  ...
  let connectedAppState = createEmptyAmbientConnectedAppState();
...
export const ensureWorktreeAvailable = undefined as never;
export const invalidateWorktreeStatusForHost = undefined as never;
export const refreshWorktreeStatus = undefined as never;
