...
export type PluginMarketplaceLogDetails = {
  safe?: Record<string, unknown>;
  sensitive?: Record<string, unknown>;
};

export type PluginMarketplaceLogger = {
  info(message: string, details?: PluginMarketplaceLogDetails): void;
  warning(message: string, details?: PluginMarketplaceLogDetails): void;
};
