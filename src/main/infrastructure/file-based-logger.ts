...
// Rotating file-based logger for the Electron main process. Writes log lines to
// day-segmented files under the platform log root directory.
...
export function createFileBasedLogger(
