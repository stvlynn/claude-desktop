...
// Square review/diff glyph used for the thread side-panel Review tab.
import type { SVGProps } from "react";

export type IconProps = SVGProps<SVGSVGElement>;

export function ReviewTabIcon(props: IconProps) {
  return (
    <svg
...
export function initReviewTabIconChunk(): void {}

export default ReviewTabIcon;
