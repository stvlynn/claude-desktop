// @ts-nocheck
// Restored from ref/webview/assets/send-to-cloud-YxjVSBaL.js
// Semantic icon module: named React component with JSX return value.

import type { SVGProps } from "react";
export type IconProps = SVGProps<SVGSVGElement>;

export function initSendToCloudIconChunk(): void {}

export function SendToCloudIcon(props: IconProps) {
  return (
    <svg
      width={20}
      height={20}
...
export default SendToCloudIcon;
