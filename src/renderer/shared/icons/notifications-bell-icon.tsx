...
// Bell outline icon used by notification and onboarding surfaces.

import type { SVGProps } from "react";

export type IconProps = SVGProps<SVGSVGElement>;

export function NotificationsBellIcon(props: IconProps) {
  return (
    <svg
      width={20}
      height={20}
...
export function initNotificationsBellIconChunk(): void {}
