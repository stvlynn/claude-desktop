// @ts-nocheck
// Restored from ref/webview/assets/unselected-circle-RTdsFEKN.js
// Semantic icon module: named React component with JSX return value.

import type { SVGProps } from "react";
export type IconProps = SVGProps<SVGSVGElement>;

export function initUnselectedCircleIconChunk(): void {}

export function UnselectedCircleIcon(props: IconProps) {
  return (
    <svg
      width={20}
      height={21}
...
export default UnselectedCircleIcon;
