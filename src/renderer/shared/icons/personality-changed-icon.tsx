...
// Person-in-a-circle glyph shown beside the "personality changed" synthetic divider.
import type { SVGProps } from "react";

export type PersonalityChangedIconProps = SVGProps<SVGSVGElement>;

export function PersonalityChangedIcon(props: PersonalityChangedIconProps) {
  return (
    <svg
      width={20}
      height={20}
