// @ts-nocheck
// Restored from ref/webview/assets/chunk-X2U36JSP-sSeN7Tix.js
...
export const solidStateFill = chunkAGHRB4JFN((color: string) => {
  const { handDrawnSeed } = _chunkICPOFSXXP();
  return {
    fill: color,
    hachureAngle: 120,
    hachureGap: 4,
...
export const userNodeOverrides = chunkAGHRB4JFN(
  (
    ...
    const { themeVariables, handDrawnSeed } = _chunkICPOFSXXP();
...
export function initMermaidStyleHelpersChunk(): void {}

export const chunkX2U36JSPR = solidStateFill;
export const chunkX2U36JSPI = styles2String;
export const chunkX2U36JSPA = userNodeOverrides;
export const chunkX2U36JSPN = isLabelStyle;
export const chunkX2U36JSPT = compileStyles;
export const initChunkX2U36JSP = initMermaidStyleHelpersChunk;
