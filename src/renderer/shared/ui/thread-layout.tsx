...
export const threadContentClassName = classNames(
...
export function ThreadLayout({
  ...
  return (
    ...
    >
      ...
      <div className={classNames("flex min-h-0 flex-1 flex-col", bodyClassName)}>
...
export const initThreadLayoutChunk = undefined as never;
