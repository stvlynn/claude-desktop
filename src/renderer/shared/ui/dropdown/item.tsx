...
import type { TooltipOpenWhen } from "../tooltip-b/types";
...
export function DropdownItem({
  ...
  const rightIconNode =
    ...
    (RightIcon ? (
      <RightIcon
        className={classNames(rightIconClassName, dropdownItemClasses.icon)}
      />
    ) : null);
  ...
  const label = (
    <span
      ...
      className={classNames("min-w-0", allowWrap ? "whitespace-normal" : "truncate")}
    >
      {itemChildren}
    </span>
  );
