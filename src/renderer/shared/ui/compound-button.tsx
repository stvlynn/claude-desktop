...
// Compound button with a primary action and a secondary dropdown action.
import React, {
...
import { BUTTON_RADIUS_CLASS_NAMES, Button } from "./main-button";
...
export function CompoundButton({
  ...
  const secondaryLabel = secondaryAriaLabel ?? "Secondary action";
  const formattedPrimaryAriaLabel = primaryAriaLabel;
