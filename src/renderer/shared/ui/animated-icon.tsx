...
const animationLoadersByName: Record<AnimatedIconName, AnimationDataLoader> = {
  "analyze-image": () =>
    import("../lib/animations/analyze-image-animation").then(
      ({ analyzeImageAnimation }) => analyzeImageAnimation as LottieData,
    ),
  automation: () =>
    import("../lib/animations/automation").then(
      ({ automation }) => automation as LottieData,
    ),
  browsing: () =>
    import("../lib/animations/browsing-animation").then(
      ({ browsingAnimation }) => browsingAnimation as LottieData,
    ),
  "code-searching": () =>
    import("../lib/animations/code-searching-icon").then(
      ({ codeSearchingIcon }) => codeSearchingIcon as LottieData,
    ),
  "codex-happy-small": () =>
    import("../lib/animations/codex-happy-small").then(
      ({ codexHappySmall }) => codexHappySmall as LottieData,
    ),
  "codex-looking-around": () =>
    import("../lib/animations/codex-looking-around").then(
      ({ codexLookingAround }) => codexLookingAround as LottieData,
    ),
  "edit-files": () =>
    import("../lib/edit-files-animation").then(
      ({ editFilesAnimation }) => editFilesAnimation as LottieData,
    ),
  hello: () =>
    import("../lib/animations/hello").then(({ hello }) => hello as LottieData),
  "internal-knowledge": () =>
    import("../lib/animations/internal-knowledge-icon").then(
      ({ internalKnowledgeIcon }) => internalKnowledgeIcon as LottieData,
    ),
  "list-files": () =>
    import("../lib/animations/list-files-animation").then(
      ({ listFilesAnimation }) => listFilesAnimation as LottieData,
    ),
  loader: () =>
    import("../lib/animations/loader").then(({ loader }) => loader as LottieData),
  "local-context": () =>
    import("../lib/animations/local-context-animation").then(
      ({ localContextAnimation }) => localContextAnimation as LottieData,
    ),
  "run-command": () =>
    import("../lib/run-command-animation").then(
      ({ runCommandAnimation }) => runCommandAnimation as LottieData,
    ),
  searching: () =>
    import("../lib/animations/searching-animation").then(
      ({ searchingAnimation }) => searchingAnimation as LottieData,
    ),
  "to-do": () =>
    import("../lib/animations/to-do-animation").then(
      ({ toDoAnimation }) => toDoAnimation as LottieData,
    ),
  "web-search": () =>
    import("../lib/animations/web-search-icon").then(
