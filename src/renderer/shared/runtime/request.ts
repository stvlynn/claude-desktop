...
class CodexRequestClient {
  ...
  async safeGet<T = unknown>(routePattern: string, options?: RequestOptions) {
    return this.makeRequest("get", routePattern, options) as Promise<T>;
  }
  async safePost<T = unknown>(routePattern: string, options?: RequestOptions) {
    return this.makeRequest("post", routePattern, options) as Promise<T>;
  }
  async safePatch<T = unknown>(routePattern: string, options?: RequestOptions) {
    return this.makeRequest("patch", routePattern, options) as Promise<T>;
  }
  async safeDelete<T = unknown>(routePattern: string, options?: RequestOptions) {
    return this.makeRequest("delete", routePattern, options) as Promise<T>;
  }
