...
import { browserSidebarAvailability } from "../../features/browser/browser-sidebar-availability";
import { multiBrowserTabsEnabledAtom } from "./onboarding-commons-externals.facade";
