...
import { _appScopeG, _appScopeT, appScopeUnderscore } from "./app-scope";
...
function hideToast(store: ScopedToastStore, toastId: string): void {
  store.set<ToastRecord>(toastRecordSignal, toastId, (toast) => ({
    ...toast,
    isShown: false,
  }));
...
function removeToast(store: ScopedToastStore, toastId: string): void {
...
function hideAllToasts(store: ScopedToastStore): void {
