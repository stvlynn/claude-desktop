...
import { appScopeRoot } from "../../features/plugins/eval-control/app-scope";
...
export const initGitBranchQueryRuntime = undefined as never;
export const initGitQueryKeyHelpers = undefined as never;
export const initHostWorkspaceQueries = undefined as never;
export const initOsInfoQueryRuntime = undefined as never;
export const useGitAvailabilityQuery = undefined as never;
