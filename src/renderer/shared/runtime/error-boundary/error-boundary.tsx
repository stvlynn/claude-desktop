...
import { WithWindow } from "../../ui/with-window";
...
export const appUpdateDownloadProgressPercent = undefined as never;
export const appUpdateLifecycleState = undefined as never;
export const isAppUpdateRecoveryActionActive = undefined as never;
// Added to satisfy relative import checks.
export const initializeRendererSentry = undefined as never;
