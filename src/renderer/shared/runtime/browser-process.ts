...
let cachedSetTimeout: SetTimeoutFn | undefined;
let cachedClearTimeout: ClearTimeoutFn | undefined;
function defaultSetTimeout(): TimerHandle {
  throw new Error("setTimeout has not been defined");
}
function defaultClearTimeout(_handle: TimerHandle): void {
  throw new Error("clearTimeout has not been defined");
}
function getSetTimeout(): SetTimeoutFn {
  if (!cachedSetTimeout) {
    cachedSetTimeout =
...
function getClearTimeout(): ClearTimeoutFn {
