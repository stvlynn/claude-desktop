...
// Current mixed facade for compact-window helpers, composer chrome, diff parsing, and shared highlight-theme registration aliases.

export {
  getPatchFileSizeSummary,
  initPatchFileSizeSummaryChunk,
} from "../lib/parse-diff/size";

export {
  initParseDiffRuntimeChunk,
  parseDiff as parseDiffFromUnifiedText,
} from "../lib/parse-diff/index";
...
export {
  ...
  RelativeTime,
} from "../lib/format-relative-date-time";

export {
  initNavigateToLocalConversationRuntimeChunk,
  useNavigateToLocalConversation,
} from "../lib/use-navigate-to-local-conversation";
...
export { MoreHorizontalIcon } from "./local-environment-action-controls-runtime";
