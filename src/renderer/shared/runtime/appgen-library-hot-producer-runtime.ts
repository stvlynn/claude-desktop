...
// Composite appgen-library hot-path producer: semantic exports are split into
// focused modules, with the remaining current runtime aliases in vendor.
export {
  threadComposerContext,
  initThreadComposerContextChunk,
  initThreadComposerFooterChunk,
  ThreadComposerFooter,
} from "../../features/composer/thread-composer-footer";
export {
  initAppShellElementContextChunk,
  AppShellElementContext,
} from "../../features/app-shell/app-shell-element-context";
export {
  createLazyNavigationRailComponent,
  initLazyNavigationRailRuntime,
} from "../lib/lazy-navigation-rail";
export {
  initGitRootQueryRuntime,
  useGitRootQuery,
} from "../../features/github/git-root-query";
export {
...
} from "../../features/remote/remote-connection-runtime";
export {
...
} from "../../features/workspace/workspace-root-display-name";
