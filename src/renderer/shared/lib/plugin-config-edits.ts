...
// Helpers for creating plugin-enablement config edits.
...
export function getBundledPluginAutoInstallDisabledConfigId(
  pluginId: string,
): string | undefined {
...
export function createPluginEnabledConfigEdit({
  pluginId,
  enabled,
}: {
  pluginId: string;
...
export { OPENAI_BUNDLED_SITES_PLUGIN_ID };
