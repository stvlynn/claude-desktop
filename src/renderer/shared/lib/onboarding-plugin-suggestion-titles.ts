...
const CONNECT_MESSAGING_TITLE_MESSAGE = defineMessage({
...
const CONNECT_FILES_TITLE_MESSAGE = defineMessage({
...
const CONNECT_CALENDAR_TITLE_MESSAGE = defineMessage({
