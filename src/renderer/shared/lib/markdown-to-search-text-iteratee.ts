...
// Lodash-style iteratee helpers (baseIteratee, baseMatches, property, etc.).

import { isEqualN, type EqualityCustomizer } from "./deep-equality";
import {
  baseGet,
  castPath,
  hasIn,
...
import type {
  ...
  Predicate,
  PropertyPath,
} from "./markdown-to-search-text-types";
import { isObject, toNumber } from "./markdown-to-search-text-values";
