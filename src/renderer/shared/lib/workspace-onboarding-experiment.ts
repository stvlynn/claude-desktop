...
// Helpers for the workspace onboarding Statsig experiment.
...
export function isWorkspaceOnboardingExperimentAssignment(value: unknown) {
  return (
    typeof value === "object" &&
    value !== null &&
...
export function isDirectFolderPickerArm(value: unknown) {
  return value === "t2_direct_folder_picker";
}

export function isAutoPlaygroundArm(value: unknown) {
  return value === "t3_auto_playground";
}

export function isModalCopyCtaPlaygroundArm(value: unknown) {
  return value === "t4_modal_copy_cta_playground";
}

export function shouldSkipWorkspacePickerForArm(value: unknown) {
  return (
...
export {
  ...
  WORKSPACE_ONBOARDING_ARM_PARAMETER,
};
