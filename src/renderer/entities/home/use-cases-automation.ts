...
// Automation home page use cases.

import { defineMessage } from "react-intl";
import type { HomeUseCaseItem } from "./use-cases-types";

export const AUTOMATION_HOME_USE_CASES: HomeUseCaseItem[] = [
  {
    id: "daily-bug-scan",
...
export function getAutomationHomeUseCases(): HomeUseCaseItem[] {
  return AUTOMATION_HOME_USE_CASES;
}
