...
import { worktreeNewThreadOrchestratorCompatSlotUpperBLowerC as fetchThreadToolAuthMethod } from "../../shared/runtime/current-app-initial/worktree-new-thread-orchestrator-runtime";
