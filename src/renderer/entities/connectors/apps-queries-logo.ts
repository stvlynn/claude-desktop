...
// Connector logo URL parsing and React Query hooks.

import {
  vscodeApiA as useQueryClient,
  vscodeApiU as queryTimings,
  vscodeApiV as useQuery,
} from "../../shared/runtime/vscode-api-runtime";
import { codexRequest } from "../../shared/runtime/codex-request-runtime";
import type { AppConnectApp, ConnectorLogoRequest } from "./apps-queries-types";
...
export function useConnectorLogoDataUrl(
  ...
  return (data as string | null | undefined) ?? undefined;
}
...
export function useAppsWithResolvedLogos({
  ...
  return maybeApps == null
    ...
    : resolveAppLogoUrls({
        apps: maybeApps,
        connectorLogoDataUrlByCacheKey: data as Map<string, string> | undefined,
      });
}
