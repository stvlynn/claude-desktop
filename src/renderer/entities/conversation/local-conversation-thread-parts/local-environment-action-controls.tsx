...
import { CheckMdIcon, initCheckmarkIcon } from "../../../shared/icons/check-md-icon";
import { initPlusIcon, PlusIcon } from "../../../shared/icons/plus-icon";
import {
  initSettingsGearIcon,
  SettingsGearIcon,
} from "../../../shared/icons/settings-gear-icon";
import { once } from "../../../shared/runtime/commonjs-interop";
import {
  initKeyboardShortcutKeycap,
  KeyboardShortcutKeycap,
} from "../../../shared/ui/keyboard-shortcut-keycap";
...
import {
  ...
  useScopedValue,
  useSignalState,
} from "../../../shared/conversations/local-conversation-thread-parts/local-environment-action-controls-runtime";
import {
  initThreadSidePanelTabRegistryChunk,
  registerThreadSidePanelTab,
} from "../../../app-shell/thread-background-processes/index";
import { buildLocalEnvironmentCreateRoute } from "../../../features/environments/local-environment-create-route";
import {
...
} from "../../../features/environments/local-environments-utils/index";
import {
  initUseGitConfigValueChunk,
  useGitConfigValue,
} from "../../../shared/lib/use-git-config-value";
import {
  FormattedMessage,
  initIntlRuntime,
  useIntl,
...
} from "../../../shared/lib/local-environment-action-items";
import {
