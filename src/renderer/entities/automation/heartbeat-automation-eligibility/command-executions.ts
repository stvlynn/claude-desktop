...
import { localConversationTitleSignal } from "../../thread/local-conversation-title-signals";
import { commandExecutionCommand } from "../../../shared/lib/command-execution-command";
import type {
  AppScopeGetter,
