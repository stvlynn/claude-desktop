...
import { _appScopeO, _appScopeT } from "../../shared/boundaries/app-scope";
...
import { SegmentedToggle } from "../../shared/lib/segmented-toggle";
import {
...
function CloudPreferencesSettingsContent() {
  ...
  const branchFormat =
    branchFormatDraft != null && branchFormatDraft.baseline === userPreferences.branch_format
      ? (branchFormatDraft.value ?? "")
      : (userPreferences.branch_format ?? "");
  const toastApi = appScopeStore.get(toastApiSignal) as ToastApi;
