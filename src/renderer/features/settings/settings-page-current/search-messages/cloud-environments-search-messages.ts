...
export const cloudEnvironmentsSearchMessages = [
  {
    defaultMessage: "Back",
  ...
  {
    defaultMessage:
      "Runs after branch checkout whenever Codex reuses a cached container",
  ...
  {
    defaultMessage:
      "Speeds up task startup by saving the container after setup",
  ...
  {
    defaultMessage:
      "Secret names and values are required, and name and domain combinations must be unique. Renaming a global secret requires a new value",
  ...
  {
    defaultMessage:
      "Runs after the repository is cloned; with caching enabled, it runs only for new containers",
  ...
  {
    defaultMessage:
      "Variable names and values are required, and names must be unique",
  ...
  {
    defaultMessage:
      "Directory where the repository is cloned; change this only when setup requires an absolute path",
