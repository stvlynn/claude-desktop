...
export const codeReviewSearchMessages = [
  {
  ...
  {
    defaultMessage:
      "Automatically review your pull requests in Codex-enabled repositories",
  ...
  {
    defaultMessage:
      "Allow credits to be consumed for reviews after rate limits",
  ...
  {
    defaultMessage:
      "Keep looking for findings until Codex stops finding new issues",
