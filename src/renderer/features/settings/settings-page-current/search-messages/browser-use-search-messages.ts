...
export const browserUseSearchMessages = [
  {
  ...
  {
    defaultMessage:
      "Show a save dialog for downloads you start in Codex's browser",
  ...
  {
    defaultMessage:
      "Control camera and microphone permissions in Codex's browser",
