...
import { getStatsigClient as getStatsigClientRaw } from "../../shared/vendor/statsig-current-runtime";
import clsx from "clsx";

import { useAuth } from "../auth/use-auth";
import { useSelectedAccountQuery } from "../../shared/runtime/codex-api";
import {
  isOpenInBrowserEvent,
  openInBrowser,
  openInBrowserFromEvent,
} from "../../shared/runtime/pull-request-actions-runtime";
import { useQueryClient } from "../../shared/runtime/query-client/react-query-context";
import {
  DialogDescription,
  DialogLayout,
  DialogTitle,
} from "../../shared/ui/dialog-layout";
import { addLoginHintToChatGptPurchaseUrl } from "../../shared/lib/format-currency";
import {
  CODEX_TEAM_PURCHASE_URL,
  TEAM_PURCHASE_URL,
  isPaidCodexPlan,
} from "../../shared/lib/plan-management-state";
import { Sku } from "../../shared/lib/skus";
import { useCodexPricingUrl } from "../../shared/lib/use-codex-pricing";
import type { ExternalLinkClickEvent } from "../../shared/lib/external-link/types";
