...
// @ts-nocheck
import { z } from "zod";
import { vscodeApiF, vscodeApiN } from "../../shared/boundaries/vscode-api";
import { createToolErrorResult } from "../../shared/runtime/tool-result-runtime";
import {
  isCodeThemeId,
...
import { resolveChromeTheme as resolveChromeThemeVariablesForMode } from "../../shared/boundaries/onboarding-commons-externals.facade";
