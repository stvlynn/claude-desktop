...
import {
  ...
  summarizeTimeOfDay,
} from "../../../shared/boundaries/onboarding-commons-externals.facade";
...
export const formatScheduleConfigSummary = undefined as never;

export const formatAutomationScheduleSummary = undefined as never;
