...
import { Ln as usageSettingsSignal } from "../../../shared/runtime/thread-context-inputs.facade";
import {
...
export function useAutoTopUpMutations(): {
  ...
  const appScope = (useAppScope(appScopeRoot) as unknown) as AppScopeWithQuery;
