...
import { launcherHotkeyStateQueryKey } from "../../hotkey-window-state";
import { KeyboardIcon } from "../../../shared/icons/keyboard-icon";
...
import { formatAccelerator } from "../../../shared/lib/electron-menu-shortcuts";
import {
  commandKeymapStateQuery,
  getCommandKeybindingOptions,
} from "../../../shared/lib/command-keybindings";
import {
  commandMenuStacksSignal,
  getCommandMenuStackSize,
  getTopCommandMenuItem,
  type CommandMenuStackByScope,
} from "../../../shared/lib/command-menu-state";
import { keyboardEventAccelerator } from "../../../shared/lib/keyboard-event-accelerator";
import { scoreQueryMatch } from "../../../shared/lib/score-query-match";
