...
import { normalizeWorkspacePath } from "../../../shared/runtime/src-l0hb-mz-p";
import { getRepositoryPathFromGitDir } from "../../../shared/lib/worktree-paths";
...
export function groupWorktreesByRepository(
  ...
  for (const worktree of worktrees) {
    const repositoryRoot = getRepositoryPathFromGitDir(worktree.gitDir ?? null);
