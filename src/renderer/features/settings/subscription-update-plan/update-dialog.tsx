...
import { formatPlanPriceParts } from "../../../shared/lib/plan-pricing";
...
type IntlCurrencyFormatter = Parameters<
  typeof formatPlanPriceParts
>[0]["intl"] &
  Parameters<typeof formatCurrency>[0]["intl"];
  ...
  return {
    ...
    body: (
      <div className="flex flex-col text-sm">
        ...
        <div
          className={`flex justify-between gap-4 font-semibold ${preview.amount_due.tax_amount > 0 ? "mt-2" : ""}`}
        >
          <FormattedMessage
