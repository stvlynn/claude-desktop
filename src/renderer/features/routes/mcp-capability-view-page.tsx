...
import { globalMcpAppEntrypointsSignal } from "../plugins/mcp-capability-signals/index";
import type { McpAppEntrypoint } from "../../entities/automation-schedule/types";
import { useSignalValue } from "../../shared/runtime/app-scope-hooks";
import { LargeEmptyState } from "../../shared/lib/large-empty-state";
import { FormattedMessage } from "../../shared/runtime/react-intl";
import { useParams } from "../../shared/runtime/react-router";
