...
import { SpeakerIcon, SpeakerIcon2, SpeakerIcon3 } from "../../shared/icons/speaker";
import { UseRecordingWaveformIcon } from "../../shared/icons/use-recording-waveform-icon";
import { WaveformIcon } from "../../shared/icons/waveform-icon";
