...
import { CommandMenuItem } from "../../shared/ui/command-menu-item";
import { FIRST_FILE_COMMAND_MENU_ITEM_VALUE } from "./thread-command-menu-state";
import { useWorkspaceFileSearch } from "../../shared/lib/use-workspace-file-search";
...
import { DropdownSearchIcon as SearchIcon } from "../../shared/ui/dropdown/index";
