...
import { appServices } from "../../shared/runtime/rpc.facade";
import { Ct as setActiveConversationHostForScope } from "../../shared/runtime/thread-context-inputs.facade";
import { sendAppServerRequest } from "../../shared/runtime/use-host-config.facade";
import { routeScope } from "../../shared/runtime/persisted-signal/index";
import { requestUserInputAutoResolutionState } from "../../shared/runtime/request-user-input-auto-resolution";
import { threadHostIdSignal } from "../../entities/thread/thread-context/index";
type AppScopeGetter = {
