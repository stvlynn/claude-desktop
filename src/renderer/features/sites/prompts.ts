...
import { featureGateSignal } from "../../shared/runtime/feature-gate-runtime";
import {
  createLocalConversationPath,
  normalizeConversationId,
} from "../../shared/runtime/src-l0hb-mz-p";
import { appIntlSignal } from "../../shared/lib/app-intl-signal";
import { parseDirectivesM } from "../../shared/lib/parse-directives";
...
import { createPluginPrefillPrompt } from "../plugin-prefill-prompt";
type AppScopeReader = {
