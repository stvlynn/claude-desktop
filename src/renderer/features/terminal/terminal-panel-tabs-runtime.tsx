...
// Public terminal side-panel tab runtime exports.
export {
...
export { registerTerminalPanelSubscription } from "./terminal-panel-tabs-subscription-runtime";
export { syncTerminalPanelTabs } from "./terminal-panel-tabs-sync-runtime";
