...
import { z } from "zod";
import { appScopeO as readAppScopeStore } from "./eval-control/app-scope";
import { sendHostRequest } from "../../shared/runtime/host-request-runtime";
import { useQuery } from "../../shared/runtime/react-query-hooks";
import { stableHashSegment } from "../../shared/lib/mcp-app-sandbox-runtime";
