...
import { useActiveCollaborationMode } from "../../../../shared/runtime/onboarding-commons-externals.facade";
import { useServiceTierSettings } from "../../../composer/use-service-tier-settings";
import { CheckCircleFilledIcon } from "../../../../shared/icons/check-circle-filled-icon";
import {
  getRecommendedSkillStatsigOverride,
  useRecommendedSkillStatsigOverrides,
} from "../../../plugins/recommended-skill-statsig-overrides";
import { welcomeV2RoleStateAtom } from "../../../../shared/runtime/current-app-initial/onboarding-select-workspace-current-runtime";
import { classNames } from "../../../../shared/lib/class-names";
import { usePermissionsMode } from "../../../../shared/lib/use-permissions-mode";
import { useSetupCodexWizardStepView } from "../../../../shared/lib/setup-codex-wizard-step-view";
import { useIntl } from "../../../../shared/vendor/react-intl";
import {
