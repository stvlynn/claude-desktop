...
import { vscodeApiA, vscodeApiU, vscodeApiV } from "../../shared/runtime/vscode-api";
...
export function useSkills(
  ...
  }) as unknown as UseQueryResult<ListSkillsResponse>;
  const groupedSkills = query.data?.data ?? [];
