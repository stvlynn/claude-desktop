...
import { appScopeRoot, appScopeUnderscore } from "../plugins/eval-control/app-scope";
import { vscodeApiF } from "../../shared/runtime/vscode-api";
import { createParametricAtom } from "../../shared/runtime/onboarding-scope-runtime";
import { formatKeyboardShortcut } from "../../shared/lib/keyboard-shortcuts-runtime";
import type { BrowserSidebarBoundsRect } from "../../shared/lib/browser-sidebar-host-utils";
import {
  getAdoptedWebContentsId,
  getBrowserSidebarAdoptionLease,
  getBrowserSidebarInitiator,
  peekBrowserSidebarSource,
} from "../browser-sidebar-open-source/index";
