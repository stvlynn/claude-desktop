// Restored from ref/webview/assets/browser-device-toolbar-runtime.js
// @ts-nocheck
// Stub barrel for browser device toolbar runtime.

export const browserDeviceToolbarRuntimeStub = undefined as never;
...
export const MAX_BROWSER_DEVICE_HEIGHT = () => null;
export const MAX_BROWSER_DEVICE_WIDTH = () => null;
export const parseBrowserDevicePreset = undefined as never;
export const RESPONSIVE_PRESET_ID = () => null;
