...
import { _appScopeA as useAppScopeQueryValue } from "../../shared/boundaries/app-scope";
import { Or as browserCapabilityQueryOptions } from "../../shared/boundaries/thread-context-inputs.facade";
import {
...
} from "../../shared/boundaries/src-l0hb-mz-p";
...
const BrowserProfileImportDialogModal = React.lazy(async () => {
  const { BrowserProfileImportDialogModal } = await import(
    "../../shared/ui/browser-profile-import-dialog"
  );
  return {
    default:
