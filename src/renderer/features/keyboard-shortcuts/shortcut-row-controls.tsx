...
// Row-level controls for the keyboard shortcuts settings list.
...
import { UndoIcon } from "../../shared/icons/undo-icon";
import type { CaptureMode } from "./keyboard-shortcut-capture-types";
      ...
      ? intl.formatMessage(
          {
            ...
            description:
              "Aria label for adding another shortcut for a command",
          },
          { commandTitle },
        )
      : intl.formatMessage(
