...
import { BugIcon } from "../../../shared/icons/bug-icon";
import { PlayOutlineIcon } from "../../../shared/icons/play-outline-icon";
import { SettingsCogIcon } from "../../../shared/icons/settings-cog-icon";
import type {
  LocalEnvironmentActionIcon as LocalEnvironmentActionIconType,
...
const LOCAL_ENVIRONMENT_ACTION_ICON_COMPONENTS: Record<
  LocalEnvironmentActionIconType,
