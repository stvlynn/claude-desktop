...
import { appScopeO as useAppScopeStore } from "../../../shared/runtime/app-scope";
import { selectedEnvironmentSignal } from "../../../features/composer/composer-view-state";
import type { ScopeStore } from "../../../features/composer/composer-view-state/types";
import { composerPromptScope } from "../../../features/composer/prompt-text";
import { useGitRootQuery } from "../../../features/github/git-root-query";
import { useCodexCloudAccess } from "../../../features/remote/local-remote-selection";
import { useScopedValue, useSignalValue } from "../../../shared/runtime/app-scope-hooks";
import {
  conversationCwdSignal,
  conversationHostIdSignal,
} from "../../../shared/runtime/conversation-state-runtime";
import type { CloudEnvironmentRecord } from "../../../shared/runtime/codex-api/types";
