...
import { ic as composerCommentAttachmentsAtomImpl } from "../../shared/vendor/worktree-new-thread-orchestrator-current-bundle";
import { x as composerCwdOverrideAtomImpl } from "../../shared/vendor/remote-projects-app-shared-current-bundle";
