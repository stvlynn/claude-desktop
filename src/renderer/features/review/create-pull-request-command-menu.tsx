...
import { buildBranchName } from "../../shared/conversations/build-branch-name";
import { BranchNameMiddleTruncation } from "../../shared/ui/branch-name-middle-truncation";
import {
  GitBranchNameField,
  stopEnterKeyPropagation,
} from "../../entities/conversation/git-branch-name-field";
import {
  CreatePullRequestIcon,
  OpenPullRequestExternalIcon,
} from "../../shared/conversations/git-action-icons";
import { useDefaultBranchQuery } from "../../entities/conversation/use-default-branch-query";
